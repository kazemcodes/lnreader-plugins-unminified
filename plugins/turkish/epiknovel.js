...
(() => {
  ...
  // .js/plugins/turkish/epiknovel.js
  var t = function(t2, e2, r2, n2) {
    return new (r2 || (r2 = Promise))((function(i2, a) {
      function o(t3) {
        try {
          s(n2.next(t3));
        } catch (t4) {
    ...
    var r2, n2, i2, a = { label: 0, sent: /* @__PURE__ */ __name(function() {
          ...
          for (; o && (o = 0, c3[0] && (a = 0)), a; ) try {
            ...
            switch (n2 = 0, i2 && (c3 = [2 & c3[0], i2.value]), c3[0]) {
              ...
              case 7:
                ...
                continue;
              default:
                if (!(i2 = a.trys, (i2 = i2.length > 0 && i2[i2.length - 1]) || 6 !== c3[0] && 2 !== c3[0])) {
                  a = 0;
                  continue;
                }
                ...
                if (6 === c3[0] && a.label < i2[1]) {
                  a.label = i2[1], i2 = c3;
                  break;
                }
                if (i2 && a.label < i2[2]) {
                  a.label = i2[2], a.ops.push(c3);
                  break;
                }
  ...
  var r = (init_browser(), __toCommonJS(browser_exports)), n = (init_fetch2(), __toCommonJS(fetch_exports)), i = (function() {
    function i2() {
      this.id = "epiknovel", this.name = "EpikNovel", this.icon = "src/tr/epiknovel/icon.png", this.site = "https://www.epiknovel.com/", this.version = "1.0.0";
    }
    __name(i2, "i");
    return i2.prototype.popularNovels = function(i3) {
      return t(this, void 0, void 0, (function() {
        var t2, a, o, c, s = this;
        return e(this, (function(e2) {
          switch (e2.label) {
            case 0:
              return t2 = this.site + "seri-listesi?Sayfa=" + i3, [4, (0, n.fetchApi)(t2)];
            case 1:
              return [4, e2.sent().text()];
            case 2:
              return a = e2.sent(), o = (0, r.load)(a), c = [], o("div.col-lg-12.col-md-12").each((function(t3, e3) {
                var r2 = o(e3).find("h3").text(), n2 = o(e3).find("img").attr("data-src"), i4 = o(e3).find("h3 > a").attr("href");
                if (i4) {
                  var a2 = { name: r2, cover: n2, path: i4.replace(s.site, "") };
                  c.push(a2);
                }
              })), [2, c];
          }
      ...
      return t(this, void 0, void 0, (function() {
        var t2, a, o, c, s, h = this;
        return e(this, (function(e2) {
          switch (e2.label) {
            case 0:
              return t2 = this.site + i3, [4, (0, n.fetchApi)(t2)];
            case 1:
              return [4, e2.sent().text()];
            case 2:
              return a = e2.sent(), o = (0, r.load)(a), (c = { path: i3, name: o("h1#tables").text().trim() }).cover = o("img.manga-cover").attr("src"), c.summary = o("#wrapper > div.row > div.col-md-9 > div:nth-child(6) > p:nth-child(3)").text().trim(), c.status = o("#wrapper > div.row > div.col-md-9 > div.row > div.col-md-9 > h4:nth-child(3) > a").text().trim(), c.author = o("#NovelInfo > p:nth-child(4)").text().replace(/Publisher:|\s/g, "").trim(), s = [], o("table").find("tr").first().remove(), o("table").find("tr").each((function(t3, e3) {
                var r2 = o(e3).find("td:nth-child(3)").text(), n2 = o(e3).find("td:nth-child(1) > a").text();
                o(e3).find("td:nth-child(1) > span").length > 0 && (n2 = "\u{1F512} " + n2);
                var i4 = o(e3).find(" td:nth-child(1) > a").attr("href");
                i4 && s.push({ name: n2, path: i4.replace(h.site, ""), releaseTime: r2 });
              })), c.chapters = s, [2, c];
          }
        }));
      }));
        ...
        return e(this, (function(e2) {
          switch (e2.label) {
            case 0:
              return t2 = this.site + i3, [4, (0, n.fetchApi)(t2)];
            case 1:
              return [4, (a = e2.sent()).text()];
            case 2:
              return o = e2.sent(), c = (0, r.load)(o), [2, a.url === this.site + "login" ? "Premium Chapter" : c("div#icerik").html() || ""];
          }
        }));
      }));
    }, i2.prototype.searchNovels = function(i3, a) {
      return t(this, void 0, void 0, (function() {
        var t2, o, c, s, h = this;
        return e(this, (function(e2) {
          switch (e2.label) {
            case 0:
              return t2 = this.site + "seri-listesi?q=" + i3 + "&Sayfa=" + a, [4, (0, n.fetchApi)(t2)];
            case 1:
              return [4, e2.sent().text()];
            case 2:
              return o = e2.sent(), c = (0, r.load)(o), s = [], c("div.col-lg-12.col-md-12").each((function(t3, e3) {
                var r2 = c(e3).find("h3").text(), n2 = c(e3).find("img").attr("data-src"), i4 = c(e3).find("h3 > a").attr("href");
                if (i4) {
                  var a2 = { name: r2, cover: n2, path: i4.replace(h.site, "") };
                  s.push(a2);
                }
              })), [2, s];
          }
