...
var LNReaderPlugin = (() => {
  ...
  var e = function(e2, a2, t2, l2) {
    ...
    var t2, l2, s2, i2 = { label: 0, sent: /* @__PURE__ */ __name(function() {
      ...
      return e(this, void 0, void 0, function() {
        ...
        return a(this, function(a2) {
          switch (a2.label) {
            ...
            case 1:
              return s2 = a2.sent(), o2 = { path: t2, name: "", genres: "", summary: "", author: "", artist: "", status: "", chapters: [] }, u3 = false, c = false, v = 0, h = false, p = false, d = false, f = false, m = false, b = false, y = false, g = 0, k = false, w = false, x = [], S = {}, N = this.hideLocked, C = new l.Parser({ onopentag: /* @__PURE__ */ __name(function(a3, t3) {
                var l2;
              ...
              }, "onclosetag") }), C.write(s2), C.end(), x.length && ((null === (j = this.options) || void 0 === j ? void 0 : j.reverseChapters) && x.reverse(), o2.chapters = x), o2.summary = o2.summary.trim(), [2, o2];
          }
        });
      });
