...
var LNReaderPlugin = (() => {
  ...
  var e = function(e2, t2, a2, s2) {
    ...
    var a2, s2, r2, l2 = { label: 0, sent: /* @__PURE__ */ __name(function() {
      ...
      return e(this, void 0, void 0, (function() {
        ...
        return t(this, (function(t2) {
          switch (t2.label) {
            ...
            case 1:
              return r2 = t2.sent(), o2 = { path: a2, name: "", genres: "", summary: "", author: "", artist: "", status: "", chapters: [] }, u3 = false, c = false, v = 0, h = false, p = false, d = false, f = false, m = false, b = false, g = false, k = 0, y = false, w = false, S = [], N = {}, C = this.hideLocked, x = new s.Parser({ onopentag: /* @__PURE__ */ __name(function(t3, a3) {
                var s2;
              ...
              }, "onclosetag") }), x.write(r2), x.end(), S.length && ((null === (j = this.options) || void 0 === j ? void 0 : j.reverseChapters) && S.reverse(), o2.chapters = S), o2.summary = o2.summary.trim(), [2, o2];
          }
        }));
      }));
