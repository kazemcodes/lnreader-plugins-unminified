...
var LNReaderPlugin = (() => {
  ...
  // .js/plugins/turkish/KodeksLibrary[lightnovelwp].js
  var e = function(e2, t2, a2, s2) {
    return new (a2 || (a2 = Promise))((function(r2, l2) {
      function i2(e3) {
        try {
          n2(s2.next(e3));
        } catch (e4) {
      ...
      n2((s2 = s2.apply(e2, t2 || [])).next());
    }));
  }, t = function(e2, t2) {
    var a2, s2, r2, l2 = { label: 0, sent: function() {
      ...
      return function(n2) {
        return (function(o4) {
          ...
          for (; i2 && (i2 = 0, o4[0] && (l2 = 0)), l2; ) try {
            if (a2 = 1, s2 && (r2 = 2 & o4[0] ? s2.return : o4[0] ? s2.throw || ((r2 = s2.return) && r2.call(s2), 0) : s2.next) && !(r2 = r2.call(s2, o4[1])).done) return r2;
            switch (s2 = 0, r2 && (o4 = [2 & o4[0], r2.value]), o4[0]) {
              case 0:
              case 1:
                r2 = o4;
                break;
  ...
  var a = (init_browser(), __toCommonJS(browser_exports)), s = require_lib9(), r = (init_fetch2(), __toCommonJS(fetch_exports)), l = (init_novelStatus(), __toCommonJS(novelStatus_exports)), i = (init_defaultCover(), __toCommonJS(defaultCover_exports)), o = (init_storage2(), __toCommonJS(storage_exports));
  function n(e2, t2) {
    var a2 = e2.match(/(\d+)$/);
  ...
  var u = new ((function() {
    function u2(e2) {
      ...
      this.version = "1.1.".concat(9 + r2), this.options = null !== (a2 = e2.options) && void 0 !== a2 ? a2 : {}, this.filters = e2.filters, (null === (s2 = this.options) || void 0 === s2 ? void 0 : s2.hasLocked) && (this.pluginSettings = { hideLocked: { value: "", label: "Hide locked chapters", type: "Switch" } });
    }
    return u2.prototype.getHostname = function(e2) {
      var t2 = (e2 = e2.split("/")[2]).split(".");
      return t2.pop(), t2.join(".");
    }, u2.prototype.safeFecth = function(a2, s2) {
      return e(this, void 0, void 0, (function() {
        var e2, l2, i2, o2, n2, u3, c, v;
        return t(this, (function(t2) {
          switch (t2.label) {
            case 0:
              return e2 = a2.split("://"), l2 = e2.shift(), i2 = e2[0].replace(/\/\//g, "/"), [4, (0, r.fetchApi)(l2 + "://" + i2)];
            case 1:
              if (!(o2 = t2.sent()).ok && 1 != s2) throw new Error("Could not reach site (" + o2.status + ") try to open in webview.");
              return [4, o2.text()];
            case 2:
              if (n2 = t2.sent(), u3 = null === (v = null === (c = n2.match(/<title>(.*?)<\/title>/)) || void 0 === c ? void 0 : c[1]) || void 0 === v ? void 0 : v.trim(), this.getHostname(a2) != this.getHostname(o2.url) || u3 && ("Bot Verification" == u3 || "You are being redirected..." == u3 || "Un instant..." == u3 || "Just a moment..." == u3 || "Redirecting..." == u3)) throw new Error("Captcha error, please open in webview (or the website has changed url)");
              return [2, n2];
          }
        }));
      }));
      ...
      return (e2.match(/<article([^]*?)<\/article>/g) || []).forEach((function(e3) {
        var a2 = e3.match(/<a href="([^\"]*)".*? title="([^\"]*)"/) || [], r2 = a2[1], l2 = a2[2];
        if (l2 && r2) {
          var o2 = e3.match(/<img [^>]*?src="([^\"]*)"[^>]*?(?: data-src="([^\"]*)")?[^>]*>/) || [], n2 = void 0;
          if (r2.includes(t2.site)) n2 = r2.replace(t2.site, "");
          else {
            var u3 = r2.split("/");
            u3.shift(), u3.shift(), u3.shift(), n2 = u3.join("/");
          }
          s2.push({ name: l2, cover: o2[2] || o2[1] || i.defaultCover, path: n2 });
        }
      })), s2;
    }, u2.prototype.popularNovels = function(a2, s2) {
      return e(this, arguments, void 0, (function(e2, a3) {
        var s3, r2, l2, i2, o2, n2, u3, c, v, h = a3.filters, p = a3.showLatestNovels;
        return t(this, (function(t2) {
          switch (t2.label) {
            case 0:
              for (l2 in s3 = null !== (v = null === (c = this.options) || void 0 === c ? void 0 : c.seriesPath) && void 0 !== v ? v : "/series/", r2 = this.site + s3 + "?page=" + e2, h || (h = this.filters || {}), p && (r2 += "&order=latest"), h) if ("object" == typeof h[l2].value) for (i2 = 0, o2 = h[l2].value; i2 < o2.length; i2++) n2 = o2[i2], r2 += "&".concat(l2, "=").concat(n2);
              else h[l2].value && (r2 += "&".concat(l2, "=").concat(h[l2].value));
      ...
      return e(this, void 0, void 0, (function() {
        var e2, r2, o2, u3, c, v, h, p, d, f, m, b, g, k, y, w, S, N, C, x, j;
        return t(this, (function(t2) {
          switch (t2.label) {
            case 0:
              return e2 = this.site, [4, this.safeFecth(e2 + a2, false)];
            case 1:
              return r2 = t2.sent(), o2 = { path: a2, name: "", genres: "", summary: "", author: "", artist: "", status: "", chapters: [] }, u3 = false, c = false, v = 0, h = false, p = false, d = false, f = false, m = false, b = false, g = false, k = 0, y = false, w = false, S = [], N = {}, C = this.hideLocked, x = new s.Parser({ onopentag: function(t3, a3) {
                var s2;
                !o2.cover && (null === (s2 = a3.class) || void 0 === s2 ? void 0 : s2.includes("ts-post-image")) ? (o2.name = a3.title, o2.cover = a3["data-src"] || a3.src || i.defaultCover) : "genxed" === a3.class || "sertogenre" === a3.class ? u3 = true : u3 && "a" === t3 ? c = true : "div" !== t3 || "entry-content" !== a3.class && "description" !== a3.itemprop ? "spe" === a3.class || "serl" === a3.class ? h = true : h && "span" === t3 ? p = true : "div" === t3 && "sertostat" === a3.class ? (h = true, p = true, m = true) : a3.class && a3.class.includes("eplister") ? b = true : b && "li" === t3 ? g = true : g ? "a" === t3 && void 0 === N.path ? N.path = a3.href.replace(e2, "").trim() : "epl-num" === a3.class ? k = 1 : "epl-title" === a3.class ? k = 2 : "epl-date" === a3.class ? k = 3 : "epl-price" === a3.class && (k = 4) : !v || "div" !== t3 && "script" !== t3 || v++ : v++;
              }, ontext: function(e3) {
                var t3, a3;
                if (u3) c && (o2.genres += e3 + ", ");
                else if (1 === v && e3.trim()) o2.summary += e3;
                else if (h) {
                  if (p) {
                    var s2 = e3.toLowerCase().replace(":", "").trim();
                    if (d) o2.author += e3 || "Unknown";
                      ...
                      case "completado":
                      case "tamamland\u0131":
                        o2.status = l.NovelStatus.Completed;
                        break;
                      case "\u0645\u0633\u062A\u0645\u0631\u0629":
                      case "ongoing":
                      case "en cours":
                      ...
                      case "en progreso":
                      case "devam ediyor":
                        o2.status = l.NovelStatus.Ongoing;
                        break;
                      case "\u0645\u062A\u0648\u0642\u0641\u0629":
                      case "hiatus":
                      case "en pause":
                      ...
                      case "pausado":
                      case "duraklat\u0131ld\u0131":
                        o2.status = l.NovelStatus.OnHiatus;
                        break;
                      default:
                        o2.status = l.NovelStatus.Unknown;
                    }
                    switch (s2) {
                      case "\u0627\u0644\u0643\u0627\u062A\u0628":
                      case "author":
                  ...
                  if (1 === k) e3.includes("\u{1F512}") ? (y = true, w = true) : w && (y = false), n(e3, N);
                  else if (2 === k) N.name = (null === (a3 = null === (t3 = e3.match(RegExp("^".concat(o2.name.replace(/[.*+?^${}()|[\]\\]/g, "\\$&"), "\\s*(.+)")))) || void 0 === t3 ? void 0 : t3[1]) || void 0 === a3 ? void 0 : a3.trim()) || e3.trim(), N.chapterNumber || n(e3, N);
                  else if (3 === k) N.releaseTime = e3;
                  else if (4 === k) {
                ...
                var t3, a3, s2;
                u3 ? c ? c = false : (u3 = false, o2.genres = null === (t3 = o2.genres) || void 0 === t3 ? void 0 : t3.slice(0, -2)) : v ? "p" === e3 ? o2.summary += "\n\n" : "br" === e3 ? o2.summary += "\n" : "div" !== e3 && "script" !== e3 || v-- : h ? p ? "span" === e3 && (p = false, d && o2.author ? d = false : f && o2.artist ? f = false : m && "" !== o2.status && (m = false)) : "div" === e3 && (h = false, o2.author = null === (a3 = o2.author) || void 0 === a3 ? void 0 : a3.trim(), o2.artist = null === (s2 = o2.artist) || void 0 === s2 ? void 0 : s2.trim()) : b && (g ? 1 === k || 2 === k || 3 === k || 4 === k ? k = 0 : "li" === e3 && (g = false, N.chapterNumber || (N.chapterNumber = 0), y && (N.name = "\u{1F512} " + N.name), C && y || S.push(N), N = {}) : "ul" === e3 && (b = false));
              } }), x.write(r2), x.end(), S.length && ((null === (j = this.options) || void 0 === j ? void 0 : j.reverseChapters) && S.reverse(), o2.chapters = S), o2.summary = o2.summary.trim(), [2, o2];
          }
        }));
      }));
    }, u2.prototype.parseChapter = function(s2) {
      return e(this, void 0, void 0, (function() {
        var e2, r2, l2, i2, o2;
        return t(this, (function(t2) {
          switch (t2.label) {
            ...
            case 1:
              ...
              return [2, (null === (o2 = null === (i2 = e2.match(/<div.*?class="epcontent ([^]*?)<div.*?class="?bottomnav/g)) || void 0 === i2 ? void 0 : i2[0].match(/<p[^>]*>([^]*?)<\/p>/g)) || void 0 === o2 ? void 0 : o2.join("\n")) || ""];
          }
        }));
      }));
    }, u2.prototype.searchNovels = function(a2, s2) {
      return e(this, void 0, void 0, (function() {
        var e2, r2;
        return t(this, (function(t2) {
          switch (t2.label) {
  ...
  })())({ id: "kodekslibrary", sourceSite: "https://www.kodekslibrary.com/", sourceName: "Kodeks Library", options: { reverseChapters: true, lang: "Turkish" }, filters: { "genre[]": { type: "Checkbox", label: "Kategori", value: [], options: [{ label: "Aksiyon", value: "aksiyon" }, { label: "B\xFCy\xFC", value: "buyu" }, { label: "Do\u011Fa \xDCst\xFC", value: "doga-ustu" }, { label: "Do\u011Fa\xFCst\xFC", value: "dogaustu" }, { label: "D\xF6v\xFC\u015F Sanatlar\u0131", value: "dovus-sanatlari" }, { label: "Dram", value: "dram" }, { label: "Fantastik", value: "fantastik" }, { label: "Geriye D\xF6n\xFC\u015F", value: "geriye-donus" }, { label: "Gizem", value: "gizem" }, { label: "Kara B\xFCy\xFC", value: "kara-buyu" }, { label: "Korku", value: "korku" }, { label: "Macera", value: "macera" }, { label: "Murim", value: "murim" }, { label: "Okul", value: "okul" }, { label: "Psikolojik", value: "psikolojik" }, { label: "Romantizm", value: "romantizm" }, { label: "Seinen", value: "seinen" }, { label: "Shounen", value: "shounen" }, { label: "Trajedi", value: "trajedi" }] }, "type[]": { type: "Checkbox", label: "T\xFCr", value: [], options: [{ label: "Akademi", value: "akademi" }, { label: "Aksiyon", value: "aksiyon" }, { label: "Dahi", value: "dahi" }, { label: "D\xF6v\xFC\u015F Sanatlar\u0131", value: "dovus-sanatlari" }, { label: "Element", value: "element" }, { label: "Fantastik", value: "fantastik" }, { label: "Geriye D\xF6n\xFC\u015F", value: "geriye-donus" }, { label: "G\xFC\xE7l\xFC Ana Karakter", value: "guclu-ana-karakter" }, { label: "K\u0131l\u0131\xE7 Ustas\u0131", value: "kilic-ustasi" }, { label: "Sava\u015F\xE7\u0131", value: "savasci" }, { label: "Yarat\u0131klar", value: "yaratiklar" }, { label: "Zaman D\xF6ng\xFCs\xFC", value: "zaman-dongusu" }] }, status: { type: "Picker", label: "Durum", value: "", options: [{ label: "Hepsi", value: "" }, { label: "Ongoing", value: "ongoing" }, { label: "Hiatus", value: "hiatus" }, { label: "Completed", value: "completed" }] }, order: { type: "Picker", label: "S\u0131rala", value: "", options: [{ label: "Temizle", value: "" }, { label: "A-Z", value: "title" }, { label: "Z-A", value: "titlereverse" }, { label: "Son G\xFCncellenenler", value: "update" }, { label: "Yeni Eklenenler", value: "latest" }, { label: "Pop\xFCler", value: "popular" }, { label: "Puan", value: "rating" }] } } });
  exports.default = u;
})();
