...
var LNReaderPlugin = (() => {
  ...
  // .js/plugins/turkish/ThNovels[hotnovelpub].js
  init_dirname();
  init_buffer2();
  init_process2();
    ...
    function s(s2) {
      return function(l) {
        return function(s3) {
          ...
          for (; i && (i = 0, s3[0] && (r2 = 0)), r2; ) try {
            if (n2 = 1, a2 && (o2 = 2 & s3[0] ? a2.return : s3[0] ? a2.throw || ((o2 = a2.return) && o2.call(a2), 0) : a2.next) && !(o2 = o2.call(a2, s3[1])).done) return o2;
            switch (a2 = 0, o2 && (s3 = [2 & s3[0], o2.value]), s3[0]) {
              case 0:
              case 1:
                o2 = s3;
                break;
              case 4:
                return r2.label++, { value: s3[1], done: false };
              case 5:
                r2.label++, a2 = s3[1], s3 = [0];
                continue;
              case 7:
                s3 = r2.ops.pop(), r2.trys.pop();
                continue;
              default:
                if (!(o2 = r2.trys, (o2 = o2.length > 0 && o2[o2.length - 1]) || 6 !== s3[0] && 2 !== s3[0])) {
                  r2 = 0;
                  continue;
                }
                ...
                if (6 === s3[0] && r2.label < o2[1]) {
                  r2.label = o2[1], o2 = s3;
                  break;
                }
                if (o2 && r2.label < o2[2]) {
                  r2.label = o2[2], r2.ops.push(s3);
                  break;
                }
  ...
  var n = (init_fetch2(), __toCommonJS(fetch_exports)), a = (init_novelStatus(), __toCommonJS(novelStatus_exports)), o = function() {
    function o2(e2) {
      var t2, n2 = this;
    ...
    __name(o2, "o");
    return o2.prototype.popularNovels = function(a2, o3) {
      return e(this, arguments, void 0, function(e2, a3) {
        var o4, r2, i, s, l, u, c = this, h = a3.filters, p = a3.showLatestNovels;
        return t(this, function(t2) {
          switch (t2.label) {
            case 0:
              return o4 = this.apiSite + "/books/", o4 += p ? "new" : (null === (s = null == h ? void 0 : h.sort) || void 0 === s ? void 0 : s.value) || "hot", (null === (l = null == h ? void 0 : h.category) || void 0 === l ? void 0 : l.value) && (o4 = this.apiSite + "/category/" + h.category.value), o4 += "/?page=" + (e2 - 1) + "&limit=20", [4, (0, n.fetchApi)(o4, { headers: { lang: this.lang } }).then(function(e3) {
                return e3.json();
              })];
            case 1:
      ...
      return e(this, void 0, void 0, function() {
        ...
        return t(this, function(t2) {
          switch (t2.label) {
            case 0:
              return [4, (0, n.fetchApi)(this.apiSite + "/book/" + o3, { headers: { lang: this.lang } }).then(function(e3) {
                return e3.json();
              })];
            case 1:
              return e2 = t2.sent(), r2 = { name: e2.data.book.name, path: o3, cover: this.site + e2.data.book.image, summary: e2.data.book.authorize.description, author: e2.data.book.authorize.name, status: "updating" === e2.data.book.status ? a.NovelStatus.Ongoing : a.NovelStatus.Completed }, (null === (s = e2.data.tags.tags_name) || void 0 === s ? void 0 : s.length) && (r2.genres = e2.data.tags.tags_name.join(",")), (null === (l = e2.data.chapters) || void 0 === l ? void 0 : l.length) && (i = [], e2.data.chapters.forEach(function(e3, t3) {
      ...
      return e(this, void 0, void 0, function() {
        ...
        return t(this, function(t2) {
          switch (t2.label) {
            case 0:
              return [4, (0, n.fetchApi)(this.resolveUrl(a2)).then(function(e3) {
                return e3.text();
              })];
            case 1:
              return e2 = t2.sent(), (o3 = (null === (i = e2.match(/<div id="content-item" ([\s\S]*?)<\/div>/)) || void 0 === i ? void 0 : i[0]) || "") ? [4, (0, n.fetchApi)(this.site + "/server/getContent?slug=" + a2)] : [3, 4];
            case 2:
              return [4, t2.sent().json()];
            case 3:
              (r2 = t2.sent()).data && (o3 += r2.data.map(function(e3) {
                return "<p>" + e3 + "</p>";
    ...
    }, o2.prototype.searchNovels = function(a2) {
      return e(this, void 0, void 0, function() {
        var e2, o3, r2;
        return t(this, function(t2) {
          switch (t2.label) {
            case 0:
              return [4, (0, n.fetchApi)(this.apiSite + "/search", { headers: { "Content-Type": "application/json;charset=utf-8", Referer: this.site, Origin: this.site, lang: this.lang }, method: "POST", body: JSON.stringify({ key_search: a2 }) }).then(function(e3) {
                return e3.json();
              })];
            case 1:
              return e2 = t2.sent(), o3 = [], e2.status && (null === (r2 = e2.data.books) || void 0 === r2 ? void 0 : r2.length) && e2.data.books.forEach(function(e3) {
