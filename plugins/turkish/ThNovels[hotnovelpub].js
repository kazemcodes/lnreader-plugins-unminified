...
var LNReaderPlugin = (() => {
  ...
  var n = (init_fetch2(), __toCommonJS(fetch_exports)), a = (init_filterInputs(), __toCommonJS(filterInputs_exports)), o = (init_novelStatus(), __toCommonJS(novelStatus_exports)), r = new ((function() {
    function a2(e2) {
      var t2, n2 = this;
    ...
    __name(a2, "a");
    return a2.prototype.popularNovels = function(a3, o2) {
      return e(this, arguments, void 0, (function(e2, a4) {
        var o3, r2, i, s, l, u, c = this, h = a4.filters, p = a4.showLatestNovels;
        return t(this, (function(t2) {
          switch (t2.label) {
            case 0:
              return o3 = this.apiSite + "/books/", o3 += p ? "new" : (null === (s = null == h ? void 0 : h.sort) || void 0 === s ? void 0 : s.value) || "hot", (null === (l = null == h ? void 0 : h.category) || void 0 === l ? void 0 : l.value) && (o3 = this.apiSite + "/category/" + h.category.value), o3 += "/?page=" + (e2 - 1) + "&limit=20", [4, (0, n.fetchApi)(o3, { headers: { lang: this.lang } }).then((function(e3) {
                return e3.json();
              }))];
            case 1:
      ...
      return e(this, void 0, void 0, (function() {
        ...
        return t(this, (function(t2) {
          switch (t2.label) {
            ...
            case 1:
              return e2 = t2.sent(), r2 = { name: e2.data.book.name, path: a3, cover: this.site + e2.data.book.image, summary: e2.data.book.authorize.description, author: e2.data.book.authorize.name, status: "updating" === e2.data.book.status ? o.NovelStatus.Ongoing : o.NovelStatus.Completed }, (null === (s = e2.data.tags.tags_name) || void 0 === s ? void 0 : s.length) && (r2.genres = e2.data.tags.tags_name.join(",")), (null === (l = e2.data.chapters) || void 0 === l ? void 0 : l.length) && (i = [], e2.data.chapters.forEach((function(e3, t3) {
      ...
      return e(this, void 0, void 0, (function() {
        ...
        return t(this, (function(t2) {
          switch (t2.label) {
            case 0:
              return [4, (0, n.fetchApi)(this.resolveUrl(a3)).then((function(e3) {
                return e3.text();
              }))];
            case 1:
              return e2 = t2.sent(), (o2 = (null === (i = e2.match(/<div id="content-item" ([\s\S]*?)<\/div>/)) || void 0 === i ? void 0 : i[0]) || "") ? [4, (0, n.fetchApi)(this.site + "/server/getContent?slug=" + a3)] : [3, 4];
            case 2:
              return [4, t2.sent().json()];
            case 3:
              (r2 = t2.sent()).data && (o2 += r2.data.map((function(e3) {
                return "<p>" + e3 + "</p>";
      ...
      return e(this, void 0, void 0, (function() {
        ...
        return t(this, (function(t2) {
          switch (t2.label) {
            case 0:
              return [4, (0, n.fetchApi)(this.apiSite + "/search", { headers: { "Content-Type": "application/json;charset=utf-8", Referer: this.site, Origin: this.site, lang: this.lang }, method: "POST", body: JSON.stringify({ key_search: a3 }) }).then((function(e3) {
                return e3.json();
              }))];
            case 1:
              return e2 = t2.sent(), o2 = [], e2.status && (null === (r2 = e2.data.books) || void 0 === r2 ? void 0 : r2.length) && e2.data.books.forEach((function(e3) {
