...
var LNReaderPlugin = (() => {
  ...
  var e = function() {
    ...
    var a2, l2, n2, r2 = { label: 0, sent: function() {
    ...
    return o2.prototype.parseNovel = function(i2) {
      return t(this, void 0, void 0, (function() {
        ...
        return a(this, (function(a2) {
          switch (a2.label) {
            ...
            case 4:
              for (y = a2.sent(), y = l([b], y, true), m = u.name.toLocaleLowerCase().replace(/\([0-9]+\)/g, "").trim(), g = function(e2) {
              ...
              }, S = 0, w = y; S < w.length; S++) x = w[S], g(x);
      ...
      return t(this, void 0, void 0, (function() {
        ...
        return a(this, (function(h) {
          return (o3 = new URLSearchParams()).append("icerik", l2), u = "".concat(this.site, "arama.html?").concat(o3.toString()), s = function(l3) {
          ...
          }, [2, (0, r.fetchApi)(u).then((function(e2) {
            return e2.text();
          })).then((function(e2) {
            var t2 = (0, n.load)(e2);
            return s(t2);
