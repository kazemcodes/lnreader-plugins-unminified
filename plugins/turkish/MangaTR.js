...
(() => {
  ...
  // .js/plugins/turkish/MangaTR.js
  var e = function() {
    return e = Object.assign || function(e2) {
      for (var t2, a2 = 1, l2 = arguments.length; a2 < l2; a2++) for (var n2 in t2 = arguments[a2]) Object.prototype.hasOwnProperty.call(t2, n2) && (e2[n2] = t2[n2]);
      return e2;
    ...
    if (a2 || 2 === arguments.length) for (var l2, n2 = 0, r2 = t2.length; n2 < r2; n2++) !l2 && n2 in t2 || (l2 || (l2 = Array.prototype.slice.call(t2, 0, n2)), l2[n2] = t2[n2]);
    return e2.concat(l2 || Array.prototype.slice.call(t2));
  };
  Object.defineProperty(exports, "__esModule", { value: true });
  var n = (init_browser(), __toCommonJS(browser_exports)), r = (init_fetch2(), __toCommonJS(fetch_exports)), i = (init_filterInputs(), __toCommonJS(filterInputs_exports)), o = (function() {
    function o2() {
      this.id = "mangatr", this.name = "MangaTR", this.icon = "src/tr/mangatr/icon.png", this.site = "https://manga-tr.com/", this.version = "1.0.0", this.opts = { method: "POST", headers: { "Content-Type": "application/x-www-form-urlencoded", "x-requested-with": "XMLHttpRequest" } }, this.filters = { sort: { value: "views", label: "S\u0131rala", options: [{ label: "Ad\u0131", value: "name" }, { label: "Pop\xFClarite", value: "views" }, { label: "Son G\xFCncelleme", value: "last_update" }], type: i.FilterTypes.Picker }, sort_type: { value: "DESC", label: "S\u0131rala T\xFCr\xFC", options: [{ label: "ASC", value: "ASC" }, { label: "DESC", value: "DESC" }], type: i.FilterTypes.Picker }, status: { value: "", label: "Durum", options: [{ label: "Hepsi", value: "" }, { label: "Yay\u0131nlanmas\u0131 Tamamlanan", value: "1" }, { label: "Devam Eden", value: "2" }], type: i.FilterTypes.Picker }, translation: { value: "", label: "\xC7eviri Durumu", options: [{ label: "Hepsi", value: "" }, { label: "\xC7evirisi Tamamlanan", value: "1" }, { label: "Devam Eden", value: "4" }, { label: "B\u0131rak\u0131lan", value: "2" }, { label: "Olmayan", value: "3" }], type: i.FilterTypes.Picker }, age: { value: "", label: "Yas", options: [{ label: "Hepsi", value: "" }, { label: "+16", value: "16" }, { label: "+18", value: "18" }], type: i.FilterTypes.Picker }, genre: { value: "", label: "T\xFCr", options: [{ label: "Hepsi", value: "" }, { label: "4 Koma", value: "4_Koma" }, { label: "Action", value: "Action" }, { label: "Adventure", value: "Adventure" }, { label: "Aliens", value: "Aliens" }, { label: "Art", value: "Art" }, { label: "Biography", value: "Biography" }, { label: "Bishoujo", value: "Bishoujo" }, { label: "Bishounen", value: "Bishounen" }, { label: "Comedy", value: "Comedy" }, { label: "Crime", value: "Crime" }, { label: "Demons", value: "Demons" }, { label: "Doujinshi", value: "Doujinshi" }, { label: "Drama", value: "Drama" }, { label: "Ecchi", value: "Ecchi" }, { label: "Fantasy", value: "Fantasy" }, { label: "Gore", value: "Gore" }, { label: "Harem", value: "Harem" }, { label: "History", value: "History" }, { label: "Horror", value: "Horror" }, { label: "Isekai", value: "Isekai" }, { label: "Josei", value: "Josei" }, { label: "Magic", value: "Magic" }, { label: "Manhua", value: "Manhua" }, { label: "Manhwa", value: "Manhwa" }, { label: "Martial", value: "Martial" }, { label: "Mecha", value: "Mecha" }, { label: "Military", value: "Military" }, { label: "Miscellaneous", value: "Miscellaneous" }, { label: "Monster", value: "Monster" }, { label: "Musical", value: "Musical" }, { label: "Mystery", value: "Mystery" }, { label: "Novel", value: "Novel" }, { label: "Nudity", value: "Nudity" }, { label: "One Shot", value: "One_Shot" }, { label: "Romance", value: "Romance" }, { label: "Psychological", value: "Psychological" }, { label: "Seinen", value: "Seinen" }, { label: "School", value: "School" }, { label: "Sci fi", value: "Sci_fi" }, { label: "Short", value: "Short" }, { label: "Shoujo", value: "Shoujo" }, { label: "Shoujo Ai", value: "Shoujo_Ai" }, { label: "Shounen", value: "Shounen" }, { label: "Shounen Ai", value: "Shounen_Ai" }, { label: "Slice of life", value: "Slice of life" }, { label: "Supernatural", value: "Supernatural" }, { label: "Space", value: "Space" }, { label: "Sports", value: "Sports" }, { label: "Thriller", value: "Thriller" }, { label: "Tragedy", value: "Tragedy" }, { label: "T\xFCrk\xE7e Novel", value: "T\xFCrk\xE7e Novel" }, { label: "Vampires", value: "Vampires" }, { label: "Violence", value: "Violence" }, { label: "War", value: "War" }, { label: "Webtoon", value: "Webtoon" }, { label: "Western", value: "Western" }], type: i.FilterTypes.Picker } };
    }
    __name(o2, "o");
    return o2.prototype.parseNovel = function(i2) {
      return t(this, void 0, void 0, (function() {
        var t2, o3, u, s, c, h, p, v, b, d, f, y, m, g, S, w, x, A, _ = this;
        return a(this, (function(a2) {
          switch (a2.label) {
            case 0:
              return [4, (0, r.fetchApi)(this.site + i2).then((function(e2) {
                return e2.text();
              }))];
            case 1:
              return t2 = a2.sent(), o3 = (0, n.load)(t2), u = { path: i2, name: o3("#tables").text(), cover: o3("#myCarousel > div.container > div.col-lg-4.col-sm-4 > img").attr("src"), status: o3("#tab1 > table:nth-child(2) > tbody > tr:nth-child(2) > td:nth-last-child(2) > a").text(), chapters: [], author: o3("#tab1 > table:nth-child(3) > tbody > tr:nth-child(2) > td:nth-child(1) > a").map((function(e2, t3) {
                return o3(t3).text();
              })).get().join(","), artist: o3("#tab1 > table:nth-child(3) > tbody > tr:nth-child(2) > td:nth-child(2) > a").map((function(e2, t3) {
                return o3(t3).text();
              })).get().join(","), genres: o3("#tab1 > table:nth-child(3) > tbody > tr:nth-child(2) > td:nth-child(3) > a").map((function(e2, t3) {
                return o3(t3).text();
              })).get().join(",") }, (s = o3("#tab1 > div.well")).children().remove("h3, div"), u.summary = s.text().trim(), c = [], h = i2.split(".html")[0].slice(6), p = "".concat(this.site, "cek/fetch_pages_manga.php?manga_cek=").concat(h), [4, (0, r.fetchApi)(p, e(e({}, this.opts), { body: "page=1" }))];
            case 2:
              return v = a2.sent(), d = n.load, [4, v.text()];
            case 3:
              return b = d.apply(void 0, [a2.sent()]), f = parseInt(null !== (A = b('a[title="Last"]').first().attr("data-page")) && void 0 !== A ? A : "1"), [4, Promise.all(Array.from({ length: f - 1 }, (function(t3, a3) {
                return (0, r.fetchApi)(p, e(e({}, _.opts), { body: "page=".concat(1 + a3 + 1) })).then((function(e2) {
                  return e2.text();
                }));
              }))).then((function(e2) {
            ...
            case 4:
              for (y = a2.sent(), y = l([b], y, true), m = u.name.toLocaleLowerCase().replace(/\([0-9]+\)/g, "").trim(), g = /* @__PURE__ */ __name(function(e2) {
                e2("body > ul > table > tbody > tr").each((function(t3, a3) {
                  var l2, n2 = e2(a3), r2 = n2.find("td:nth-child(1) > a").text(), i3 = r2.toLocaleLowerCase().replace(m, "Ch").trim(), o4 = n2.find("td:nth-child(1) > div").text(), u2 = null !== (l2 = n2.find("td:nth-child(1) > a").attr("href")) && void 0 !== l2 ? l2 : "";
                  "" !== u2 && c.push({ name: "" !== o4 ? "".concat(i3, ": ").concat(o4) : i3, path: u2, chapterNumber: parseFloat(r2.replace(/[^0-9.]/g, "")) });
                }));
              }, "g"), S = 0, w = y; S < w.length; S++) x = w[S], g(x);
              return c.length > 0 && (u.chapters = c.reverse()), [2, u];
          }
        }));
      }));
    }, o2.prototype.popularNovels = function(e2, t2) {
      var a2 = t2.showLatestNovels, l2 = t2.filters, i2 = new URLSearchParams();
      i2.append("page", e2.toString()), 1 == a2 ? (i2.append("sort", "last_update"), i2.append("sort_type", "DESC")) : (i2.append("durum", l2.status.value.toString()), i2.append("ceviri", ""), i2.append("yas", l2.age.value.toString()), i2.append("icerik", "2"), i2.append("tur", l2.genre.value.toString()), i2.append("sort", l2.sort.value.toString()), i2.append("sort_type", l2.sort_type.value.toString()));
      var o3 = "".concat(this.site, "manga-list-sayfala.html?").concat(i2.toString());
      return (0, r.fetchApi)(o3).then((function(e3) {
        return e3.text();
      })).then((function(e3) {
        return (function(e4) {
          return e4("#myCarousel > div.container > div:nth-child(3) > div.col-lg-9.col-md-8 > div.col-md-12").map((function(t3, a3) {
            var l3, n2, r2 = e4(a3);
            return { name: r2.find("#tables").text(), path: null !== (l3 = r2.find("#tables > a").attr("href")) && void 0 !== l3 ? l3 : "", cover: null !== (n2 = r2.find("img.img-thumb").first().attr("src")) && void 0 !== n2 ? n2 : "" };
          })).toArray();
        })((0, n.load)(e3));
      }));
      ...
      return t(this, void 0, void 0, (function() {
        ...
        return a(this, (function(a2) {
          switch (a2.label) {
            case 0:
              return [4, (0, r.fetchApi)(this.site + e2).then((function(e3) {
                return e3.text();
              }))];
            case 1:
              return t2 = a2.sent(), l2 = (0, n.load)(t2), i2 = l2("#well"), [2, null !== (o3 = i2.html()) && void 0 !== o3 ? o3 : ""];
          }
        }));
      }));
    }, o2.prototype.searchNovels = function(l2, i2) {
      return t(this, void 0, void 0, (function() {
        var o3, u, s, c = this;
        return a(this, (function(h) {
          return (o3 = new URLSearchParams()).append("icerik", l2), u = "".concat(this.site, "arama.html?").concat(o3.toString()), s = /* @__PURE__ */ __name(function(l3) {
            return t(c, void 0, void 0, (function() {
              var o4, u2, s2, c2, h2, p, v, b, d, f = this;
              return a(this, (function(y) {
                switch (y.label) {
                  case 0:
                    for (o4 = [], u2 = 0, s2 = 0, c2 = l3("div.char > a + span").toArray(); s2 < c2.length && (h2 = c2[s2], 50 !== o4.length); s2++) "novel" != l3(h2).text().trim().toLowerCase() && "novel" != l3(h2).next().text().trim().toLowerCase() || (50 * (i2 - 1) > u2 ? u2++ : (p = l3(h2).prev(), v = null !== (b = p.attr("manga-slug")) && void 0 !== b ? b : "", o4.push({ name: p.text(), path: null !== (d = p.attr("href")) && void 0 !== d ? d : "", cover: v })));
                    return [4, Promise.all(o4.map((function(l4) {
                      return t(f, void 0, void 0, (function() {
                        var t2, i3, o5, u3;
                        return a(this, (function(a2) {
                          switch (a2.label) {
                            case 0:
                              return t2 = "".concat(this.site, "app/manga/controllers/cont.pop.php"), [4, (0, r.fetchApi)(t2, e(e({}, this.opts), { body: "slug=".concat(l4.cover) }))];
                            case 1:
                              return [4, a2.sent().text()];
                            case 2:
                              return i3 = a2.sent(), o5 = (0, n.load)(i3), u3 = o5("img").first().attr("src"), l4.cover = u3, [2, l4];
                          }
                        }));
                      }));
                    })))];
          ...
          }, "s"), [2, (0, r.fetchApi)(u).then((function(e2) {
            return e2.text();
          })).then((function(e2) {
            var t2 = (0, n.load)(e2);
            return s(t2);
    ...
    }, o2.prototype.resolveUrl = function(e2, t2) {
      return this.site + e2;
    }, o2;
  })();
