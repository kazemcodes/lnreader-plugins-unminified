...
var LNReaderPlugin = function () {
  ...
  function () {
    ...
    __name(Genesis2, "Genesis");
    Genesis2.prototype.parseNovels = function (json) {
      return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
          return [2, json.map(function (novel) {
            return {
    ...
    Genesis2.prototype.popularNovels = function (pageNo_1, _a) {
    ...
    Genesis2.prototype.extractData = function (nodes) {
    ...
    Genesis2.prototype.parseNovel = function (novelPath) {
      return __awaiter(this, void 0, void 0, function () {
    ...
    Genesis2.prototype.populateNovelMetadata = function (novel, data) {
      for (var key in data) {
        var value = data[key];
        if (typeof value === "object" && value !== null && "novel_title" in value) {
          ...
          novel.genres = data[value.genres].map(function (genreId) {
            return data[genreId];
          }).join(", ") || "Unknown Genre";
    ...
    Genesis2.prototype.extractChapters = function (data) {
      var _this = this;
      ...
      for (var key in data) {
        ...
        if (value && typeof value === "object" && chapterKey in value) {
          ...
          var formattedChapters = allChapterIndices.map(function (index) {
            return data[index];
          }).map(function (chapter) {
            return _this.formatChapter(chapter, data);
    ...
    Genesis2.prototype.formatChapter = function (chapter, data) {
      var id = chapter.id,
      ...
      var _a = data,
        ...
        chapterTitle = _a[_c],
        _d = chapter_number,
        chapterNumberVal = _a[_d],
        _e = required_tier,
        requiredTierVal = _a[_e],
        _f = date_created,
        dateCreated = _a[_f];
      if (chapterId && chapterTitle && chapterNumberVal >= 0 && requiredTierVal !== null && dateCreated) {
    ...
    Genesis2.prototype.parseChapter = function (chapterPath) {
      return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            ...
            case 1:
              ...
              for (key in data) {
                mapping = data[key];
                if (mapping && typeof mapping === "object" && contentKey in mapping && notesKey in mapping && footnotesKey in mapping) {
                  content = data[mapping[contentKey]];
                  notes = data[mapping[notesKey]];
                  footnotes = data[mapping[footnotesKey]];
                  return [2, content + (notes ? "<h2>Notes</h2><br>".concat(notes) : "") + (footnotes !== null && footnotes !== void 0 ? footnotes : "")];
                }
              }
              return [2, ""];
          }
    ...
    Genesis2.prototype.searchNovels = function (searchTerm, pageNo) {
      return __awaiter(this, void 0, void 0, function () {
        var url, json;
        return __generator(this, function (_a) {
          switch (_a.label) {
