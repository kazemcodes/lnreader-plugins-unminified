...
(() => {
  ...
  // .js/plugins/vietnamese/lightnovelvn.js
  ...
  var n = (init_browser(), __toCommonJS(browser_exports)), r = (init_fetch2(), __toCommonJS(fetch_exports)), i = (init_novelStatus(), __toCommonJS(novelStatus_exports)), a = (function() {
    function a2() {
      this.id = "lightnovel.vn", this.name = "Light Novel VN", this.version = "1.0.0", this.icon = "src/vi/lightnovelvn/icon.png", this.site = "https://lightnovel.vn";
    }
    __name(a2, "a");
    return a2.prototype.popularNovels = function(i2) {
      return t(this, void 0, void 0, (function() {
        var t2, a3, o, s, c = this;
        return e(this, (function(e2) {
          switch (e2.label) {
            case 0:
              return t2 = "".concat(this.site, "/truyen-hot-ds?page=").concat(i2), [4, (0, r.fetchApi)(t2).then((function(t3) {
                return t3.text();
              }))];
            case 1:
              return a3 = e2.sent(), o = (0, n.load)(a3), s = [], o(".flex.flex-col[itemtype='https://schema.org/Book']").each((function(t3, e3) {
                var n2, r2 = o(e3).find('h3[itemprop="name"] > a').text().trim(), i3 = o(e3).find("noscript").html(), a4 = null === (n2 = null == i3 ? void 0 : i3.match(/srcSet="([^\s]+)/)) || void 0 === n2 ? void 0 : n2[1], u = o(e3).find('h3[itemprop="name"] > a').attr("href");
                u && s.push({ name: r2, cover: a4, path: u.replace(c.site, "") });
              })), [2, s];
          }
        }));
      }));
    }, a2.prototype.parseChapters = function(t2) {
      var e2 = this, n2 = [];
      return t2("ul.chapter-list > li").each((function(r2, i2) {
        var a3 = Number(t2(i2).find("div").first().text()), o = t2(i2).find("a").attr("href"), s = t2(i2).find("a").text().trim();
        o && n2.push({ path: o.replace(e2.site, ""), name: s, chapterNumber: a3 });
      })), n2;
    }, a2.prototype.parseNovel = function(a3) {
      return t(this, void 0, void 0, (function() {
        var t2, o, s, c, u, h, l, p, f;
        return e(this, (function(e2) {
          switch (e2.label) {
            case 0:
              return t2 = this.site + a3, [4, (0, r.fetchApi)(t2).then((function(t3) {
                return t3.text();
              }))];
            case 1:
              return o = e2.sent(), s = (0, n.load)(o), (c = { path: a3, chapters: [], name: "Kh\xF4ng c\xF3 ti\xEAu \u0111\u1EC1", totalPages: 1 }).name = s('h1[itemprop="name"]').text().trim(), c.cover = null === (f = s("header div:nth-child(2) img").attr("srcset")) || void 0 === f ? void 0 : f.split(/\s+/)[0], u = [], s('a[itemprop="genre"]').each((function() {
                u.push(s(this).text());
              })), c.genres = u.join(","), c.status = s("span.font-bold.text-size22:last").text(), "\u0110ang ra" === c.status ? c.status = i.NovelStatus.Ongoing : "Ho\xE0n th\xE0nh" === c.status ? c.status = i.NovelStatus.Completed : c.status = i.NovelStatus.Unknown, c.author = s('a[itemprop="author"] > span').text(), c.summary = s("#bookIntro").text().replace(/\s+/g, " "), [4, (function(t3) {
                return new Promise((function(e3) {
                  return setTimeout(e3, t3);
                }));
              })(1e3)];
            case 2:
              return e2.sent(), h = t2 + "/danh-sach-chuong", [4, (0, r.fetchApi)(h).then((function(t3) {
                return t3.text();
              }))];
            case 3:
              return l = e2.sent(), p = (0, n.load)(l), c.chapters = this.parseChapters(p), p('nav[aria-label="Pagination"] a').each((function(t3, e3) {
                var n2, r2 = e3.attribs.href;
                if (r2) {
                  var i2 = Number(null === (n2 = r2.match(/\?page=(\d+)/)) || void 0 === n2 ? void 0 : n2[1]);
                  i2 && i2 > c.totalPages && (c.totalPages = i2);
                }
              })), [2, c];
          }
        }));
      }));
    }, a2.prototype.parsePage = function(i2, a3) {
      return t(this, void 0, void 0, (function() {
        var t2, o;
        return e(this, (function(e2) {
          switch (e2.label) {
            case 0:
              return t2 = "".concat(this.site).concat(i2, "/danh-sach-chuong?page=").concat(a3), [4, (0, r.fetchApi)(t2).then((function(t3) {
                return t3.text();
              }))];
            case 1:
              return o = e2.sent(), [2, { chapters: this.parseChapters((0, n.load)(o)) }];
          }
        }));
      }));
      ...
      return t(this, void 0, void 0, (function() {
        ...
        return e(this, (function(e2) {
          switch (e2.label) {
            case 0:
              return [4, (0, r.fetchApi)(this.site + i2).then((function(t3) {
                return t3.text();
              }))];
            case 1:
              return t2 = e2.sent(), a3 = (0, n.load)(t2), [2, a3("div.chapter-content").html() || ""];
          }
        }));
      }));
    }, a2.prototype.searchNovels = function(n2, i2) {
      return t(this, void 0, void 0, (function() {
        var t2, a3, o, s, c = this;
        return e(this, (function(e2) {
          switch (e2.label) {
            case 0:
              return i2 > 1 ? [2, []] : (t2 = "".concat(this.site, "/api/book-search"), (a3 = new FormData()).append("keyword", n2), [4, (0, r.fetchApi)(t2, { method: "POST", body: a3 }).then((function(t3) {
                return t3.json();
              }))]);
            case 1:
              return o = e2.sent(), [2, (null === (s = o.data) || void 0 === s ? void 0 : s.map((function(t3) {
                return { name: t3.name, path: "/truyen/" + t3.slug, cover: (c.site + t3.coverUrl).replace("default.jpg", "150.jpg?w=256&q=") };
              }))) || []];
          }
        }));
      }));
