...
(() => {
  ...
  // .js/plugins/vietnamese/Truyenconect.js
  var e = function(e2, t2, n2, a2) {
    ...
    return o2.next = l(0), o2.throw = l(1), o2.return = l(2), "function" == typeof Symbol && (o2[Symbol.iterator] = function() {
      return this;
    }), o2;
    function l(l2) {
      return function(s) {
        return (function(l3) {
          ...
          for (; o2 && (o2 = 0, l3[0] && (i2 = 0)), i2; ) try {
            if (n2 = 1, a2 && (r2 = 2 & l3[0] ? a2.return : l3[0] ? a2.throw || ((r2 = a2.return) && r2.call(a2), 0) : a2.next) && !(r2 = r2.call(a2, l3[1])).done) return r2;
            switch (a2 = 0, r2 && (l3 = [2 & l3[0], r2.value]), l3[0]) {
              case 0:
              case 1:
                r2 = l3;
                break;
              case 4:
                return i2.label++, { value: l3[1], done: false };
              case 5:
                i2.label++, a2 = l3[1], l3 = [0];
                continue;
              case 7:
                l3 = i2.ops.pop(), i2.trys.pop();
                continue;
              default:
                if (!(r2 = i2.trys, (r2 = r2.length > 0 && r2[r2.length - 1]) || 6 !== l3[0] && 2 !== l3[0])) {
                  i2 = 0;
                  continue;
                }
                if (3 === l3[0] && (!r2 || l3[1] > r2[0] && l3[1] < r2[3])) {
                  i2.label = l3[1];
                  break;
                }
                if (6 === l3[0] && i2.label < r2[1]) {
                  i2.label = r2[1], r2 = l3;
                  break;
                }
                if (r2 && i2.label < r2[2]) {
                  i2.label = r2[2], i2.ops.push(l3);
                  break;
                }
  ...
  var n = (init_browser(), __toCommonJS(browser_exports)), a = (init_fetch2(), __toCommonJS(fetch_exports)), r = (init_filterInputs(), __toCommonJS(filterInputs_exports)), i = (init_novelStatus(), __toCommonJS(novelStatus_exports)), o = (function() {
    function o2() {
      this.id = "truyenconect", this.name = "Truyen Conect", this.icon = "src/vi/truyenconect/icon.png", this.customJS = "src/vi/truyenconect/test.js", this.site = "https://truyenconect.com", this.version = "1.0.0", this.filters = { category: { label: "L\u1ECDc theo", value: "", type: r.FilterTypes.Picker, options: [{ label: "", value: "" }, { label: "Th\u1EC3 lo\u1EA1i", value: "the-loai" }, { label: "Truy\u1EC7n d\u1ECBch", value: "truyen-dich" }, { label: "Truy\u1EC7n convert", value: "convert" }] }, genre: { label: "Th\u1EC3 lo\u1EA1i", value: "action", type: r.FilterTypes.Picker, options: [{ label: "Action", value: "action" }, { label: "Adult", value: "adult" }, { label: "Adventure", value: "adventure" }, { label: "Chinese novel", value: "chinese-novel" }, { label: "Chuy\u1EC3n Sinh", value: "chuyen-sinh" }, { label: "English Novel", value: "english-novel" }, { label: "Harem", value: "harem" }, { label: "Ecchi", value: "ecchi" }, { label: "Fantasy", value: "fantasy" }, { label: "Drama", value: "drama" }, { label: "Game", value: "game" }, { label: "Ti\xEAn hi\u1EC7p", value: "tien-hiep" }, { label: "Ki\u1EBFm Hi\u1EC7p", value: "kiem-hiep" }, { label: "Ng\xF4n T\xECnh", value: "ngon-tinh" }, { label: "Isekai", value: "isekai" }, { label: "L\u1ECBch S\u1EED", value: "lich-su" }, { label: "Web Novel", value: "web-novel" }, { label: "Xuy\xEAn kh\xF4ng", value: "xuyen-khong" }, { label: "Tr\u1ECDng sinh", value: "trong-sinh" }, { label: "Trinh th\xE1m", value: "trinh-tham" }, { label: "D\u1ECB gi\u1EDBi", value: "di-gioi" }, { label: "Huy\u1EC1n \u1EA3o", value: "huyen-ao" }, { label: "S\u1EAFc Hi\u1EC7p", value: "sac-hiep" }, { label: "D\u1ECB n\u0103ng", value: "di-nang" }, { label: "Linh d\u1ECB", value: "linh-di" }, { label: "\u0110\xF4 th\u1ECB", value: "do-thi" }, { label: "Comedy", value: "comedy" }, { label: "School Life", value: "school-life" }, { label: "Romance", value: "romance" }, { label: "Martial-arts", value: "martial-arts" }, { label: "Light Novel", value: "light-novel" }, { label: "Huy\u1EC1n huy\u1EC5n", value: "huyen-huyen" }, { label: "K\u1EF3 Huy\u1EC5n", value: "ky-huyen" }, { label: "Khoa Huy\u1EC5n", value: "khoa-huyen" }, { label: "V\xF5ng Du", value: "vong-du" }, { label: "\u0110\u1ED3ng Nh\xE2n", value: "dong-nhan" }] } };
    }
    __name(o2, "o");
    return o2.prototype.sleep = function(n2) {
      return e(this, void 0, void 0, (function() {
        return t(this, (function(e2) {
          return [2, new Promise((function(e3) {
            return setTimeout(e3, n2);
          }))];
        }));
      }));
    }, o2.prototype.parseNovels = function(e2, t2) {
      var n2 = this, a2 = [];
      return e2(t2).each((function(t3, r2) {
        var i2 = e2(r2).find("a").attr("href");
        i2 && a2.push({ name: e2(r2).find("img").attr("alt") || "", path: i2.replace(n2.site, ""), cover: e2(r2).find("img").attr("data-src") });
      })), a2;
    }, o2.prototype.popularNovels = function(r2, i2) {
      return e(this, arguments, void 0, (function(e2, r3) {
        var i3, o3, l, s, u = r3.filters, c = r3.showLatestNovels;
        return t(this, (function(t2) {
          switch (t2.label) {
            case 0:
              return i3 = this.site, o3 = ".c-page__content > .grid9.block .item-thumb.c-image-hover", c ? o3 = ".c-page__content .page-content-listing.item-big_thumbnail .item-thumb.c-image-hover" : (null == u ? void 0 : u.category.value) && (i3 += "/" + u.category.value, o3 = 'table.manga-shortcodes.manga-chapters-listing td[width="10%"]', "the-loai" === u.category.value && (o3 = ".item-thumb.hover-details.c-image-hover", i3 += "/" + u.genre.value), i3 += "?page=" + e2), [4, (0, a.fetchApi)(i3).then((function(e3) {
                return e3.text();
              }))];
            case 1:
              return l = t2.sent(), s = (0, n.load)(l), [2, this.parseNovels(s, o3)];
          }
        }));
      }));
    }, o2.prototype.parseChapters = function(e2) {
      var t2 = this, n2 = [];
      return e2("option").each((function(a2, r2) {
        var i2, o3, l = r2.attribs.value;
        if (l) {
          var s = null === (i2 = l.match(/\/(\d+)-/)) || void 0 === i2 ? void 0 : i2[1];
          s && (l = l.replace(s + "-", "") + "-" + s);
          var u = null === (o3 = l.match(/chuong-(\d+)/)) || void 0 === o3 ? void 0 : o3[1];
          n2.push({ path: l.replace(t2.site, ""), name: e2(r2).text().trim(), chapterNumber: Number(u) || void 0 });
        }
      })), n2.reverse();
    }, o2.prototype.parseVolumes = function(e2) {
      var t2 = [];
      return e2("option").each((function(e3, n2) {
        t2.push({ story: n2.attribs["data-story"], navigation: n2.attribs["data-navigation"], value: n2.attribs.value });
      })), t2;
    }, o2.prototype.getVolumes = function(r2) {
      return e(this, void 0, void 0, (function() {
        var e2, i2, o3, l, s;
        return t(this, (function(t2) {
          switch (t2.label) {
            case 0:
              if (!(e2 = null === (s = r2.match(/-(\d+)$/)) || void 0 === s ? void 0 : s[1])) throw new Error("Kh\xF4ng t\xECm th\u1EA5y ch\u01B0\u01A1ng");
              return i2 = this.site + "/truyen/get-chap-selector?chap=" + e2, [4, (0, a.fetchApi)(i2).then((function(e3) {
                return e3.json();
              }))];
            case 1:
              return o3 = t2.sent(), l = { chapters: this.parseChapters((0, n.load)(o3.chap_selector)) }, o3.eps_selector && (l.volumes = this.parseVolumes((0, n.load)(o3.eps_selector))), [2, l];
          }
        }));
      }));
      ...
      return e(this, void 0, void 0, (function() {
        ...
        return t(this, (function(t2) {
          switch (t2.label) {
            case 0:
              return e2 = this.site + r2, [4, (0, a.fetchApi)(e2)];
            case 1:
              return [4, t2.sent().text()];
            case 2:
              if (o3 = t2.sent(), l = (0, n.load)(o3), (s = { name: l(".post-title > h1").text().trim(), path: r2, chapters: [], totalPages: 1 }).cover = l(".summary_image > a > img").attr("data-src"), l(".post-content_item").each((function() {
                var e3 = l(this).find(".summary-heading > h5").text().trim(), t3 = l(this).find(".summary-content").html();
                if (t3) switch (e3) {
                  case "Th\u1EC3 lo\u1EA1i":
                    s.genres = l(t3).children("a").map((function(e4, t4) {
                      return l(t4).text();
                    })).toArray().join(",");
                    break;
                  case "T\xE1c gi\u1EA3":
                    s.author = l(t3).text().trim();
                    break;
                  case "Ho\u1EA1 s\u0129":
                    s.artist = l(t3).text().trim();
                    break;
                  case "Tr\u1EA1ng th\xE1i":
                    switch (t3.trim()) {
                      case "Full":
                        s.status = i.NovelStatus.Completed;
                        break;
                      case "T\u1EA1m ng\u01B0ng":
                        s.status = i.NovelStatus.OnHiatus;
                        break;
                      case "\u0110ang ti\u1EBFn h\xE0nh":
                        s.status = i.NovelStatus.Ongoing;
                        break;
                      default:
                        s.status = i.NovelStatus.Unknown;
                    }
                }
              })), l(".description-summary > div.summary__content > div").remove(), s.summary = l(".description-summary > div.summary__content").text().trim(), !(u = l("#init-links > a").first().attr("href"))) throw new Error("Kh\xF4ng t\xECm th\u1EA5y truy\u1EC7n");
              return [4, this.sleep(1e3)];
            case 3:
              return t2.sent(), [4, this.getVolumes(u)];
            case 4:
              return (c = t2.sent()).volumes ? (s.totalPages = c.volumes.length, s.chapters = c.chapters) : (s.totalPages = 1, s.chapters = c.chapters), [2, s];
          }
        }));
      }));
    }, o2.prototype.parsePage = function(r2, i2) {
      return e(this, void 0, void 0, (function() {
        var e2, o3, l, s, u, c, h, v, p, m;
        return t(this, (function(t2) {
          switch (t2.label) {
            case 0:
              return e2 = this.site + r2, [4, (0, a.fetchApi)(e2)];
            case 1:
              return [4, t2.sent().text()];
            case 2:
              if (o3 = t2.sent(), l = (0, n.load)(o3), !(s = l("#init-links > a").first().attr("href"))) throw new Error("Kh\xF4ng t\xECm th\u1EA5y truy\u1EC7n");
              return [4, this.sleep(1e3)];
            case 3:
              return t2.sent(), [4, this.getVolumes(s)];
            case 4:
              if (u = t2.sent(), c = Number(i2) - 1, !u.volumes) throw new Error("Kh\xF4ng t\xECm th\u1EA5y truy\u1EC7n");
              if (c >= u.volumes.length) throw new Error("Kh\xF4ng t\xECm th\u1EA5y volume");
              return h = u.volumes[c], v = "dataEpisodes=".concat(h.value, "&datastory=").concat(h.story, "&dataNavigation=").concat(encodeURIComponent(h.navigation)), p = "".concat(this.site, "/truyen/getreadingchapAction?").concat(v), [4, this.sleep(1e3)];
            case 5:
              return t2.sent(), [4, (0, a.fetchApi)(p).then((function(e3) {
                return e3.json();
              }))];
            case 6:
              if ((m = t2.sent()).err) throw new Error(m.html);
              return [2, { chapters: this.parseChapters((0, n.load)(m.html)) }];
          }
        }));
      }));
      ...
      return e(this, void 0, void 0, (function() {
        ...
        return t(this, (function(t2) {
          switch (t2.label) {
            case 0:
              return [4, (0, a.fetchApi)(this.site + r2)];
            case 1:
              return [4, t2.sent().text()];
            case 2:
              return e2 = t2.sent(), i2 = (0, n.load)(e2), [2, i2(".reading-content").html() || ""];
          }
        }));
      }));
    }, o2.prototype.searchNovels = function(r2, i2) {
      return e(this, void 0, void 0, (function() {
        var e2, o3, l, s, u = this;
        return t(this, (function(t2) {
          switch (t2.label) {
            case 0:
              return e2 = "".concat(this.site, "?key=").concat(r2, "&page=").concat(i2), [4, (0, a.fetchApi)(e2)];
            case 1:
              return [4, t2.sent().text()];
            case 2:
              return o3 = t2.sent(), l = (0, n.load)(o3), s = [], l(".tab-thumb.c-image-hover > a").each((function(e3, t3) {
                var n2 = t3.attribs.title, a2 = l(t3).find("img").first().attr("src"), r3 = t3.attribs.href;
                r3 && s.push({ name: n2, path: r3.replace(u.site, ""), cover: a2 });
              })), [2, s];
          }
        }));
      }));
