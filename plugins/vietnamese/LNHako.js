  ...
  var l = (function() {
    ...
    return l2.prototype.parseNovels = function(e2) {
      return (0, t.fetchApi)(e2).then((function(e3) {
        ...
        var t2 = [], a2 = {}, i2 = false, l3 = false, s = new n.Parser({ onopentag: function(e4, n2) {
          var s2, o, r;
      ...
      var l3, s = { path: i2, name: "", author: "", artist: "", summary: "", genres: "", status: "" }, o = [], r = { isDone: false, isStarted: false, onopentag: function(e2) {
        "a" === e2 && (this.isStarted = true);
      }, ontext: function(e2) {
        s.name += e2;
      }, onclosetag: function() {
        this.isStarted && (this.isDone = true);
      } }, u = { newLine: false, ontext: function(e2) {
        this.newLine ? (this.newLine = false, s.summary += "\n" + e2) : s.summary += e2;
      }, onclosetag: function() {
        this.newLine = true;
      } }, h = { ontext: function(e2) {
        s.genres += e2;
      } };
      !(function(e2) {
        e2[e2.Author = 0] = "Author", e2[e2.Artist = 1] = "Artist", e2[e2.Status = 2] = "Status", e2[e2.Unknown = 3] = "Unknown";
      })(l3 || (l3 = {}));
      var c = { isStarted: false, info: l3.Unknown, onopentag: function(e2, t2) {
      ...
      }, onclosetag: function(e2) {
        this.isStarted && (this.isStarted = false), "a" === e2 && this.info === l3.Status && (this.isDone = true);
      } }, v = { currentVolume: "", num: 0, part: 1, isStarted: false, readingTime: false, tempChapter: {}, onopentag: function(e2, t2) {
        var n2;
      ...
      } }, p = { handlers: { Unknown: void 0, GetName: r, GetCover: void 0, GetSummary: u, GetGenres: h, GetInfos: c, GetVolumes: { isStarted: false, isDone: false, isParsingChapterList: false, onopentag: function(e2, t2) {
        var n2;
      ...
      return (0, t.fetchApi)(this.site + i2).then((function(e2) {
        ...
        var t2, i3, l4, r2 = new n.Parser({ onopentag: function(e3, t3) {
          var n2, a2, i4;
