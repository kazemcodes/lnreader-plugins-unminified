...
(() => {
  ...
  // .js/plugins/vietnamese/nettruyen.js
    ...
    function u(u2) {
      return function(s) {
        return (function(u3) {
          ...
          for (; a && (a = 0, u3[0] && (o2 = 0)), o2; ) try {
            if (n2 = 1, r2 && (i2 = 2 & u3[0] ? r2.return : u3[0] ? r2.throw || ((i2 = r2.return) && i2.call(r2), 0) : r2.next) && !(i2 = i2.call(r2, u3[1])).done) return i2;
            switch (r2 = 0, i2 && (u3 = [2 & u3[0], i2.value]), u3[0]) {
              case 0:
              case 1:
                i2 = u3;
                break;
  ...
  var n = (init_fetch2(), __toCommonJS(fetch_exports)), r = (init_novelStatus(), __toCommonJS(novelStatus_exports)), i = (init_browser(), __toCommonJS(browser_exports)), o = (function() {
    function o2() {
      this.id = "nettruyen", this.name = "Nettruyen", this.icon = "src/vi/nettruyen/icon.png", this.site = "https://nettruyen.com.vn", this.version = "1.0.0";
    }
    __name(o2, "o");
    return o2.prototype.parseNovels = function(t2) {
      var e2 = this, n2 = [];
      return t2("#listchuong > ul > li > a.thumb").each((function(r2, i2) {
        var o3 = i2.attribs.href;
        if (o3) {
          var a = i2.attribs.title, u = e2.site + "/" + t2(i2).find("img").first().attr("src");
          n2.push({ path: "/" + o3, name: a, cover: u });
        }
      })), n2;
    }, o2.prototype.popularNovels = function(r2) {
      return t(this, void 0, void 0, (function() {
        var t2, o3;
        return e(this, (function(e2) {
          switch (e2.label) {
            case 0:
              return t2 = "".concat(this.site, "/xem-nhieu/trang-").concat(r2, ".html"), [4, (0, n.fetchApi)(t2).then((function(t3) {
                return t3.text();
              }))];
            case 1:
              return o3 = e2.sent(), [2, this.parseNovels((0, i.load)(o3))];
          }
        }));
      }));
    }, o2.prototype.parseChapters = function(t2) {
      var e2 = [];
      return t2("ul.list-unstyled > li > a").each((function(t3, n2) {
        var r2, i2 = n2.attribs.href;
        if (i2) {
          var o3 = n2.attribs.title;
          e2.push({ path: "/" + i2, name: o3, chapterNumber: Number(null === (r2 = o3.match(/Chương (\d+)/)) || void 0 === r2 ? void 0 : r2[1]) });
        }
      })), e2;
      ...
      return t(this, void 0, void 0, (function() {
        ...
        return e(this, (function(e2) {
          switch (e2.label) {
            case 0:
              return t2 = this.site + o3, [4, (0, n.fetchApi)(t2).then((function(t3) {
                return t3.text();
              }))];
            case 1:
              return a = e2.sent(), u = (0, i.load)(a), (s = { path: o3, name: u(".gioithieutruyen.profile-info > h1").text().trim(), chapters: [], totalPages: Number(u(".phantrang > span:nth-child(2)").text()) || 1 }).cover = this.site + "/" + u(".img-thumb > img").attr("src"), u(".thongtintruyen.note.note-info").each((function(t3, e3) {
                switch (u(e3).find("strong").text().trim()) {
                  case "T\xE1c gi\u1EA3":
                    s.author = u(e3).text().replace(/Tác giả\s+\n?:/, "");
                    break;
                  case "Tr\u1EA1ng th\xE1i":
                    var n2 = u(e3).text();
                    n2.includes("\u0110ang ra") ? s.status = r.NovelStatus.Ongoing : n2.includes("Ho\xE0n th\xE0nh") ? s.status = r.NovelStatus.Completed : s.status = r.NovelStatus.Unknown;
                    break;
                  case "Th\u1EC3 lo\u1EA1i":
                    s.genres = u("a > span").toArray().map((function(t4) {
                      return u(t4).text();
                    })).join(",");
                }
              })), s.summary = u(".gioithieutruyen > .gioithieutruyen").text().trim(), s.chapters = this.parseChapters(u), [2, s];
          }
        }));
      }));
    }, o2.prototype.parsePage = function(r2, o3) {
      return t(this, void 0, void 0, (function() {
        var t2, a, u, s;
        return e(this, (function(e2) {
          switch (e2.label) {
            case 0:
              if (!(t2 = null === (s = r2.match(/-(\d+)\//)) || void 0 === s ? void 0 : s[1])) throw new Error("Cant parse page");
              return a = "".concat(this.site, "/ajax.chuong.php?id=").concat(t2, "&page=").concat(o3, "&url=").concat(r2.replace(/\//g, ""), "&loai=truyendich"), [4, (0, n.fetchApi)(a).then((function(t3) {
                return t3.text();
              }))];
            case 1:
              return u = e2.sent(), [2, { chapters: this.parseChapters((0, i.load)(u)) }];
          }
        }));
      }));
      ...
      return t(this, void 0, void 0, (function() {
        ...
        return e(this, (function(e2) {
          switch (e2.label) {
            case 0:
              return t2 = this.site + r2, [4, (0, n.fetchApi)(t2).then((function(t3) {
                return t3.text();
              }))];
            case 1:
              return o3 = e2.sent(), [2, (0, i.load)(o3)("#noidungchap").html() || ""];
          }
        }));
      }));
    }, o2.prototype.searchNovels = function() {
      return t(this, void 0, void 0, (function() {
