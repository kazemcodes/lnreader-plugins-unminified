...
(() => {
  ...
  // .js/plugins/vietnamese/truyenfull.js
  var t = function(t2, e2, n2, a2) {
      ...
      return function(u) {
        return (function(s3) {
          ...
          for (; o2 && (o2 = 0, s3[0] && (i2 = 0)), i2; ) try {
            if (n2 = 1, a2 && (r2 = 2 & s3[0] ? a2.return : s3[0] ? a2.throw || ((r2 = a2.return) && r2.call(a2), 0) : a2.next) && !(r2 = r2.call(a2, s3[1])).done) return r2;
            switch (a2 = 0, r2 && (s3 = [2 & s3[0], r2.value]), s3[0]) {
              case 0:
              case 1:
                r2 = s3;
                break;
  ...
  var n = (init_browser(), __toCommonJS(browser_exports)), a = (init_fetch2(), __toCommonJS(fetch_exports)), r = (init_novelStatus(), __toCommonJS(novelStatus_exports)), i = (init_filterInputs(), __toCommonJS(filterInputs_exports)), o = (function() {
    function o2() {
      this.id = "truyenfull", this.name = "Truy\u1EC7n Full", this.icon = "src/vi/truyenfull/icon.png", this.site = "https://truyenfull.io", this.version = "1.0.2", this.filters = { status: { type: i.FilterTypes.CheckboxGroup, label: "T\xECnh tr\u1EA1ng", value: [], options: [{ label: "\u0110\xE3 ho\xE0n th\xE0nh", value: "hoan" }] }, sort: { type: i.FilterTypes.Picker, label: "S\u1EAFp x\u1EBFp", value: "", options: [{ label: "Truy\u1EC7n m\u1EDBi c\u1EADp nh\u1EADt", value: "truyen-moi" }, { label: "Truy\u1EC7n hot", value: "truyen-hot" }, { label: "Truy\u1EC7n full", value: "truyen-full" }, { label: "Ti\xEAn hi\u1EC7p hay", value: "tien-hiep-hay" }, { label: "Ki\u1EBFm hi\u1EC7p hay", value: "kiem-hiep-hay" }, { label: "Truy\u1EC7n teen hay", value: "truyen-teen-hay" }, { label: "Ng\xF4n t\xECnh hay", value: "ngon-tinh-hay" }, { label: "Ng\xF4n t\xECnh ng\u01B0\u1EE3c", value: "ngon-tinh-nguoc" }, { label: "Ng\xF4n t\xECnh s\u1EE7ng", value: "ngon-tinh-sung" }, { label: "Ng\xF4n t\xECnh h\xE0i", value: "ngon-tinh-hai" }, { label: "\u0110am m\u1EF9 hay", value: "dam-my-hay" }, { label: "\u0110am m\u1EF9 h\xE0i", value: "dam-my-hai" }, { label: "\u0110am m\u1EF9 h v\u0103n", value: "dam-my-h-van" }, { label: "\u0110am m\u1EF9 s\u1EAFc", value: "dam-my-sac" }] } };
    }
    __name(o2, "o");
    return o2.prototype.parseNovels = function(t2) {
      var e2 = this, n2 = [];
      return t2(".list-truyen .row").each((function(a2, r2) {
        var i2 = t2(r2).find("h3.truyen-title > a").text(), o3 = t2(r2).find("div[data-classname='cover']").attr("data-image"), s = t2(r2).find("h3.truyen-title > a").attr("href");
        s && n2.push({ name: i2, cover: o3, path: s.replace(e2.site, "") });
      })), n2;
    }, o2.prototype.parseChapters = function(t2) {
      var e2 = this;
      return t2("ul.list-chapter > li > a").toArray().map((function(n2) {
        var a2, r2 = n2.attribs.href.replace(e2.site, "");
        return { name: t2(n2).text().trim(), path: r2, chapterNumber: Number(null === (a2 = r2.match(/\/chuong-(\d+)\//)) || void 0 === a2 ? void 0 : a2[1]) };
      }));
    }, o2.prototype.popularNovels = function(r2, i2) {
      return t(this, arguments, void 0, (function(t2, r3) {
        var i3, o3, s, u, l, c, h = r3.filters;
        return e(this, (function(e2) {
          switch (e2.label) {
            case 0:
              if (i3 = this.site + "/danh-sach", h) for ("" !== h.sort.value ? i3 += "/".concat(h.sort.value) : i3 += "/truyen-hot", o3 = 0, s = h.status.value; o3 < s.length; o3++) u = s[o3], i3 += "/".concat(u);
              return i3 += "/trang-".concat(t2), [4, (0, a.fetchApi)(i3)];
            case 1:
              return [4, e2.sent().text()];
            case 2:
              return l = e2.sent(), c = (0, n.load)(l), [2, this.parseNovels(c)];
          }
        }));
      }));
    }, o2.prototype.parseNovel = function(i2) {
      return t(this, void 0, void 0, (function() {
        var t2, o3, s, u, l;
        return e(this, (function(e2) {
          switch (e2.label) {
            case 0:
              return t2 = this.site + i2, [4, (0, a.fetchApi)(t2)];
            case 1:
              return [4, e2.sent().text()];
            case 2:
              return o3 = e2.sent(), s = (0, n.load)(o3), u = 1, s("ul.pagination.pagination-sm > li > a").each((function() {
                var t3, e3 = Number(null === (t3 = this.attribs.href.match(/\/trang-(\d+)\//)) || void 0 === t3 ? void 0 : t3[1]);
                e3 && e3 > u && (u = e3);
              })), (l = { path: i2, name: s("div.book > img").attr("alt") || "Kh\xF4ng c\xF3 ti\xEAu \u0111\u1EC1", chapters: [], totalPages: u }).cover = s("div.book > img").attr("src"), l.summary = s("div.desc-text").text().trim(), l.author = s('h3:contains("T\xE1c gi\u1EA3:")').parent().contents().text().replace("T\xE1c gi\u1EA3:", ""), l.genres = s('h3:contains("Th\u1EC3 lo\u1EA1i")').siblings().map((function(t3, e3) {
                return s(e3).text();
              })).toArray().join(","), l.status = s('h3:contains("Tr\u1EA1ng th\xE1i")').next().text(), "Full" === l.status ? l.status = r.NovelStatus.Completed : "\u0110ang ra" === l.status ? l.status = r.NovelStatus.Ongoing : l.status = r.NovelStatus.Unknown, l.chapters = this.parseChapters(s), [2, l];
          }
        }));
      }));
      ...
      return t(this, void 0, void 0, (function() {
        ...
        return e(this, (function(e2) {
          switch (e2.label) {
            case 0:
              return t2 = "".concat(this.site).concat(r2, "trang-").concat(i2, "/#list-chapter"), [4, (0, a.fetchApi)(t2)];
            case 1:
              return [4, e2.sent().text()];
            case 2:
              return o3 = e2.sent(), s = (0, n.load)(o3), [2, { chapters: this.parseChapters(s) }];
          }
        }));
      }));
        ...
        return e(this, (function(e2) {
          switch (e2.label) {
            ...
            case 1:
              return [4, e2.sent().text()];
            case 2:
              return t2 = e2.sent(), i2 = (0, n.load)(t2), [2, (i2(".chapter-title").html() || "") + (i2("#chapter-c").html() || "")];
          }
        }));
      }));
      ...
      return t(this, void 0, void 0, (function() {
        ...
        return e(this, (function(e2) {
          switch (e2.label) {
            case 0:
              return t2 = "".concat(this.site, "/tim-kiem?tukhoa=").concat(r2, "&page=").concat(i2), [4, (0, a.fetchApi)(t2)];
            case 1:
              return [4, e2.sent().text()];
            case 2:
              return o3 = e2.sent(), s = (0, n.load)(o3), [2, this.parseNovels(s)];
          }
        }));
      }));
    }, o2;
