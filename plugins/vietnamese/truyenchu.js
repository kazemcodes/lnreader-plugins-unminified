...
(() => {
  ...
  // .js/plugins/vietnamese/truyenchu.js
  ...
  var n = (init_browser(), __toCommonJS(browser_exports)), r = (init_fetch2(), __toCommonJS(fetch_exports)), a = (init_novelStatus(), __toCommonJS(novelStatus_exports)), i = (function() {
    function i2() {
      this.id = "truyenchu", this.name = "Truy\u1EC7n Ch\u1EEF", this.icon = "src/vi/truyenchu/icon.png", this.site = "https://truyenchu.vn", this.version = "1.0.0";
    }
    __name(i2, "i");
    return i2.prototype.parseNovels = function(t2) {
      var e2 = this, n2 = [];
      return t2(".list-truyen .row").each((function(r2, a2) {
        var i3 = t2(a2).find("h3.truyen-title > a").text(), o = e2.site + t2(a2).find("div[data-classname='cover']").attr("data-image"), s = t2(a2).find("h3.truyen-title > a").attr("href");
        s && n2.push({ name: i3, cover: o, path: s.replace(e2.site, "") });
      })), n2;
    }, i2.prototype.parseChapters = function(t2) {
      var e2, r2 = this, a2 = null === (e2 = t2.match(/("list_chapter":\s?\\{0}"(.+)\\{0}"),/)) || void 0 === e2 ? void 0 : e2[1];
      if (!a2) throw new Error("Kh\xF4ng t\u1EA3i \u0111\u01B0\u1EE3c ch\u01B0\u01A1ng");
      var i3 = JSON.parse("{".concat(a2, "}")), o = (0, n.load)(i3.list_chapter), s = [];
      return o("ul > li > a").each((function(t3, e3) {
        var n2, a3 = e3.attribs.href.replace(r2.site, "");
        a3 && s.push({ name: e3.attribs.title, path: a3, chapterNumber: Number(null === (n2 = a3.match(/\/chuong-(\d+)/)) || void 0 === n2 ? void 0 : n2[1]) });
      })), s;
      ...
      return t(this, void 0, void 0, (function() {
        ...
        return e(this, (function(e2) {
          switch (e2.label) {
            case 0:
              return t2 = "".concat(this.site, "/danh-sach/truyen-hot?page=").concat(a2), [4, (0, r.fetchApi)(t2)];
            case 1:
              return [4, e2.sent().text()];
            case 2:
              return i3 = e2.sent(), o = (0, n.load)(i3), [2, this.parseNovels(o)];
          }
        }));
      }));
        ...
        return e(this, (function(e2) {
          switch (e2.label) {
            ...
            case 1:
              return [4, e2.sent().text()];
            case 2:
              return o = e2.sent(), s = (0, n.load)(o), c = 1, u = new RegExp("".concat(i3, "\\?page=\\d+"), "g"), null === (l = o.match(u)) || void 0 === l || l.forEach((function(t3) {
                var e3, n2 = Number(null === (e3 = t3.match(/\?page=(\d+)/)) || void 0 === e3 ? void 0 : e3[1]);
                n2 && n2 > c && (c = n2);
              })), (h = { path: i3, name: s("div.book > img").attr("alt") || "Kh\xF4ng c\xF3 ti\xEAu \u0111\u1EC1", chapters: [], totalPages: c }).cover = this.site + s("div.book > img").attr("src"), h.summary = s("div.desc-text").text().trim(), h.author = s('h3:contains("T\xE1c gi\u1EA3:")').parent().contents().text().replace("T\xE1c gi\u1EA3:", ""), h.genres = s('h3:contains("Th\u1EC3 lo\u1EA1i")').siblings().map((function(t3, e3) {
                return s(e3).text();
              })).toArray().join(","), h.status = s('h3:contains("Tr\u1EA1ng th\xE1i")').next().text(), "Full" === h.status ? h.status = a.NovelStatus.Completed : "\u0110ang ra" === h.status ? h.status = a.NovelStatus.Ongoing : h.status = a.NovelStatus.Unknown, h.chapters = this.parseChapters(o), [2, h];
          }
        }));
      }));
    }, i2.prototype.parsePage = function(n2, a2) {
      return t(this, void 0, void 0, (function() {
        var t2, i3;
        return e(this, (function(e2) {
          switch (e2.label) {
            case 0:
              return t2 = "".concat(this.site).concat(n2, "?page=").concat(a2), [4, (0, r.fetchApi)(t2)];
            case 1:
              return [4, e2.sent().text()];
            case 2:
              return i3 = e2.sent(), [2, { chapters: this.parseChapters(i3) }];
          }
        }));
      }));
      ...
      return t(this, void 0, void 0, (function() {
        ...
        return e(this, (function(e2) {
          switch (e2.label) {
            case 0:
              return [4, (0, r.fetchApi)(this.site + a2)];
            case 1:
              return [4, e2.sent().text()];
            case 2:
              return t2 = e2.sent(), i3 = (0, n.load)(t2), [2, (i3(".chapter-title").html() || "") + (i3("#chapter-c").html() || "")];
          }
        }));
      }));
      ...
      return t(this, void 0, void 0, (function() {
        ...
        return e(this, (function(e2) {
          switch (e2.label) {
            case 0:
              return t2 = "".concat(this.site, "/tim-kiem?tukhoa=").concat(a2, "&page=").concat(i3), [4, (0, r.fetchApi)(t2)];
            case 1:
              return [4, e2.sent().text()];
            case 2:
              return o = e2.sent(), s = (0, n.load)(o), [2, this.parseNovels(s)];
          }
        }));
      }));
    }, i2;
