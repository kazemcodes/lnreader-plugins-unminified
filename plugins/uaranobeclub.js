...
var LNReaderPlugin = function () {
  ...
  var UaRanobeClubApi = /** @class */
  function () {
    function UaRanobeClubApi2() {}
    __name(UaRanobeClubApi2, "UaRanobeClubApi");
    UaRanobeClubApi2.fetch = function (query, variables) {
      return __awaiter(this, void 0, void 0, function () {
        var response;
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              return [4, (0, fetch_1.fetchApi)("".concat(UA_RANOBE_URL, "graphql"), {
                method: "POST",
                headers: {
    ...
    UaRanobeClubApi2.fetchChapter = function (slug, writingSlug) {
      return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              ...
              return [4, UaRanobeClubApi2.fetch(query, variables)];
            case 1:
              response = _a.sent();
              return [2, response.data.episodeBySlug.text];
          }
        });
      });
    };
    UaRanobeClubApi2.fetchNovel = function (slug) {
      return __awaiter(this, void 0, void 0, function () {
        var query, variables, response;
        var _a, _b;
        return __generator(this, function (_c) {
          switch (_c.label) {
            ...
            case 1:
              response = _c.sent();
              return [2, (_b = (_a = response === null || response === void 0 ? void 0 : response.data) === null || _a === void 0 ? void 0 : _a.writingBySlug) !== null && _b !== void 0 ? _b : ""];
          }
        });
      });
    };
    UaRanobeClubApi2.fetchListWithNovel = function () {
    ...
    return UaRanobeClubApi2;
  }();
  var UaRanobeClub = /** @class */
  function () {
    function UaRanobeClub2() {
    ...
    __name(UaRanobeClub2, "UaRanobeClub");
    UaRanobeClub2.prototype.popularNovels = function (page) {
      return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
          switch (_b.label) {
            case 0:
              skip = (page - 1) * 10;
              return [4, UaRanobeClubApi.fetchListWithNovel(skip, "")];
            case 1:
              data = _b.sent();
              novelItems = ((_a = data === null || data === void 0 ? void 0 : data.writings) !== null && _a !== void 0 ? _a : []).map(function (_a2) {
    ...
    UaRanobeClub2.prototype.parseNovel = function (novelPath) {
      return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_f) {
          switch (_f.label) {
            case 0:
              ...
              return [4, UaRanobeClubApi.fetchNovel(slug)];
            case 1:
              data = _f.sent();
              chapters = ((_d = (_c = (_b = (_a = data.scanlators) === null || _a === void 0 ? void 0 : _a[0]) === null || _b === void 0 ? void 0 : _b.scanlator) === null || _c === void 0 ? void 0 : _c.episodes) === null || _d === void 0 ? void 0 : _d.map(function (_a2) {
                var title2 = _a2.title,
                  seqTitle = _a2.seqTitle,
                  chapterSlug = _a2.slug,
                  subId = _a2.subId;
                return {
                  name: "".concat(seqTitle, ". ").concat(title2),
                  path: chapterSlug + "#".concat(slug),
                  chapterNumber: parseInt(subId, 10)
                  // Предполагаем, что subId это число
                };
              })) || [];
              sourceNovel = {
                genres: ((_e = data.genres) === null || _e === void 0 ? void 0 : _e.map(function (_a2) {
                  var genre = _a2.genre;
                  return genre.name;
                }).join(",")) || "",
                chapters: chapters,
    ...
    UaRanobeClub2.prototype.parseChapter = function (chapterPath) {
      return __awaiter(this, void 0, void 0, function () {
        var _a, slug, writingSlug, chapterText;
        return __generator(this, function (_b) {
          switch (_b.label) {
            case 0:
              _a = chapterPath.split(UA_RANOBE_URL).join("").split("#"), slug = _a[0], writingSlug = _a[1];
              return [4, UaRanobeClubApi.fetchChapter(slug, writingSlug)];
            case 1:
              chapterText = _b.sent();
    ...
    UaRanobeClub2.prototype.searchNovels = function (searchTerm, page) {
      return __awaiter(this, void 0, void 0, function () {
        var skip, data, novelItems;
        var _a;
        return __generator(this, function (_b) {
          switch (_b.label) {
            case 0:
              skip = (page - 1) * 10;
              return [4, UaRanobeClubApi.fetchListWithNovel(skip, searchTerm)];
            case 1:
              data = _b.sent();
              novelItems = ((_a = data === null || data === void 0 ? void 0 : data.writings) !== null && _a !== void 0 ? _a : []).map(function (_a2) {
                var title2 = _a2.title,
