...
var LNReaderPlugin = function () {
  ...
  function () {
    ...
    __name(PawRead2, "PawRead");
    PawRead2.prototype.parseNovels = function (html) {
      var novels = [];
      var tempNovel = {};
      var state = ParsingState.Idle;
      var parser = new htmlparser2_1.Parser({
        onopentag: /* @__PURE__ */__name(function (name, attribs) {
          if (attribs["class"] && (attribs["class"].includes("list-comic") || attribs["class"].includes("itemBox"))) {
    ...
    PawRead2.prototype.popularNovels = function (page_1, _a) {
        ...
        return __generator(this, function (_c) {
          switch (_c.label) {
            case 0:
              ...
              filterValues = [filters.genre.value, filters.status.value, filters.lang.value].filter(function (value) {
                return value !== "";
              });
    ...
    PawRead2.prototype.parseNovel = function (novelPath) {
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              ...
              return [4, (0, fetch_1.fetchApi)(this.site + novelPath + slash)];
            case 1:
              result = _a.sent();
                ...
                onopentag: /* @__PURE__ */__name(function (name, attribs) {
                  ...
                  switch (name) {
                    case "div":
                      ...
                      if ((_a2 = attribs["class"]) === null || _a2 === void 0 ? void 0 : _a2.includes("item-box")) {
                ...
                ontext: /* @__PURE__ */__name(function (text) {
                  switch (state) {
                    ...
                    case ParsingState.ChapterTime:
                      if (text === null || text === void 0 ? void 0 : text.includes("Advanced")) return;
                      var releaseDate = text.split(".").map(function (x) {
                        return Number(x);
                      });
                  ...
                  switch (name) {
                    case "div":
                      ...
                      if (state === ParsingState.Chapter) {
                        depth--;
                        if (depth < 0) {
                          if (tempChapter.path && tempChapter.name && tempChapter.releaseTime) {
                      ...
                      break;
                    case "p":
                      if (state === ParsingState.Status || state === ParsingState.Author || state === ParsingState.Summary) {
                        state = ParsingState.Idle;
                      }
                      break;
                    case "a":
                      ...
                      break;
                    case "span":
                      if (state === ParsingState.ChapterName || state === ParsingState.ChapterTime) {
                        state = ParsingState.Chapter;
                        depth--;
                      }
                      break;
    ...
    PawRead2.prototype.parseChapter = function (chapterPath) {
      return __awaiter(this, void 0, void 0, function () {
              ...
              parser = new htmlparser2_1.Parser({
                ...
                ontext: /* @__PURE__ */__name(function (data) {
                  if (state === ParsingState.Chapter) {
                    ...
                    if (icontains.some(function (pattern) {
                      return text_1 === null || text_1 === void 0 ? void 0 : text_1.includes(pattern);
                    })) {
    ...
    PawRead2.prototype.searchNovels = function (searchTerm, page) {
      return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              ...
              return [4, (0, fetch_1.fetchApi)("".concat(this.site, "search/?").concat(params.toString()))];
            case 1:
              result = _a.sent();
              return [4, result.text()];
            case 2:
  ...
  (function (ParsingState2) {
    ...
    ParsingState2[ParsingState2["Cover"] = 1] = "Cover";
    ParsingState2[ParsingState2["Genres"] = 2] = "Genres";
    ParsingState2[ParsingState2["Author"] = 3] = "Author";
    ParsingState2[ParsingState2["Status"] = 4] = "Status";
    ParsingState2[ParsingState2["Hidden"] = 5] = "Hidden";
    ParsingState2[ParsingState2["Summary"] = 6] = "Summary";
    ParsingState2[ParsingState2["Stopped"] = 7] = "Stopped";
    ParsingState2[ParsingState2["Chapter"] = 8] = "Chapter";
    ParsingState2[ParsingState2["ChapterName"] = 9] = "ChapterName";
    ParsingState2[ParsingState2["ChapterTime"] = 10] = "ChapterTime";
    ParsingState2[ParsingState2["NovelName"] = 11] = "NovelName";
    ParsingState2[ParsingState2["Novel"] = 12] = "Novel";
