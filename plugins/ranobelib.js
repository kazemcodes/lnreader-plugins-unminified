...
var LNReaderPlugin = function () {
    ...
    "src/lib/fetch.ts": function src_lib_fetchTs() {
      ...
      _fetchText = /* @__PURE__ */__name(/*#__PURE__*/function () {
        var _ref4 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee3(url, init, encoding) {
          var res, arrayBuffer, decoder, _t3;
  ...
  // src/lib/storage.ts
  var _Storage, Storage, _storage, _LocalStorage, LocalStorage, _localStorage, _sessionStorage;
  var init_storage = __esm({
    "src/lib/storage.ts": function src_lib_storageTs() {
      "use strict";

      init_dirname();
      init_buffer2();
      init_process2();
      _Storage = /*#__PURE__*/function () {
        /**
      ...
      _LocalStorage = /*#__PURE__*/function () {
        function _LocalStorage() {
          _classCallCheck(this, _LocalStorage);
          this.db = {};
        }
        return _createClass(_LocalStorage, [{
          key: "get",
          value: function get() {
            return this.db;
          }
      ...
      _sessionStorage = new LocalStorage();
    }
  });
  ...
  var init_storage2 = __esm({
    "src/libs/storage.ts": function src_libs_storageTs() {
      "use strict";
  ...
  function () {
    function RLIB2() {
      ...
      this.resolveUrl = function (path, isNovel) {
        ...
        if (isNovel) return _this.site + "/ru/book/" + path + (ui ? "?" + ui : "");
        var _b = path.split("/"),
          slug = _b[0],
          volume = _b[1],
          number = _b[2],
          branch_id = _b[3];
        var chapterPath = slug + "/read/v" + volume + "/c" + number + (branch_id ? "?bid=" + branch_id : "");
        return _this.site + "/ru/" + chapterPath + (ui ? (branch_id ? "&" : "?") + ui : "");
      };
      this.getUser = function () {
        ...
        if (!((_b = data === null || data === void 0 ? void 0 : data.token) === null || _b === void 0 ? void 0 : _b.access_token)) return;
      ...
      this.filters = {
        ...
        tags: {
          ...
          options: [{
            ...
            label: "\u0412\u043B\u0430\u0434\u044B\u043A\u0430 \u0434\u0435\u043C\u043E\u043D\u043E\u0432",
            value: "349"
          }, {
            label: "\u0412\u043E\u0435\u043D\u043D\u044B\u0435",
            value: "198"
          }, {
            label: "\u0412\u043E\u0441\u043F\u043E\u043C\u0438\u043D\u0430\u043D\u0438\u044F \u0438\u0437 \u0434\u0440\u0443\u0433\u043E\u0433\u043E \u043C\u0438\u0440\u0430",
            value: "310"
          }, {
            label: "\u0412\u044B\u0436\u0438\u0432\u0430\u043D\u0438\u0435",
            value: "212"
            ...
            label: "\u041C\u0435\u0436\u0433\u0430\u043B\u0430\u043A\u0442\u0438\u0447\u0435\u0441\u043A\u0430\u044F \u0432\u043E\u0439\u043D\u0430",
            value: "330"
          }, {
            label: "\u041C\u043E\u043D\u0441\u0442\u0440 \u0414\u0435\u0432\u0443\u0448\u043A\u0438",
            value: "207"
          }, {
            label: "\u041C\u043E\u043D\u0441\u0442\u0440\u044B",
            value: "208"
            ...
            label: "\u041F\u0443\u0442\u0435\u0448\u0435\u0441\u0442\u0432\u0438\u0435 \u0432 \u0434\u0440\u0443\u0433\u043E\u0439 \u043C\u0438\u0440",
            value: "318"
          }, {
            ...
            label: "\u0421\u043A\u0440\u044B\u0442\u0438\u0435 \u043B\u0438\u0447\u043D\u043E\u0441\u0442\u0438",
            value: "315"
          }, {
            label: "\u0421\u0440\u0435\u0434\u043D\u0435\u0432\u0435\u043A\u043E\u0432\u044C\u0435",
            value: "174"
          }, {
            label: "\u0422\u0440\u0430\u0434\u0438\u0446\u0438\u043E\u043D\u043D\u044B\u0435 \u0438\u0433\u0440\u044B",
            value: "203"
          }, {
            label: "\u0423\u043C\u043D\u044B\u0439 \u0413\u0413",
            value: "303"
          }, {
            label: "\u0425\u0430\u0440\u0430\u043A\u0442\u0435\u0440\u043D\u044B\u0439 \u0440\u043E\u0441\u0442",
            value: "332"
          }, {
            label: "\u0425\u0438\u043A\u0438\u043A\u043E\u043C\u043E\u0440\u0438",
            value: "167"
    ...
    __name(RLIB2, "RLIB");
    RLIB2.prototype.popularNovels = function (pageNo_1, _a) {
        ...
        return __generator(this, function (_w) {
          switch (_w.label) {
            case 0:
              ...
              url += "&sort_by=" + (showLatestNovels ? "last_chapter_at" : ((_c = filters === null || filters === void 0 ? void 0 : filters.sort_by) === null || _c === void 0 ? void 0 : _c.value) || "rating_score");
              ...
              if (result.data instanceof Array) {
                result.data.forEach(function (novel) {
                  ...
                  return novels.push({
                    ...
                    cover: ((_a2 = novel.cover) === null || _a2 === void 0 ? void 0 : _a2["default"]) || defaultCover_1.defaultCover,
    ...
    RLIB2.prototype.parseNovel = function (novelPath) {
      return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_l) {
          switch (_l.label) {
            case 0:
              return [4, (0, fetch_1.fetchApi)("".concat(this.apiSite).concat(novelPath, "?fields[]=summary&fields[]=genres&fields[]=tags&fields[]=teams&fields[]=authors&fields[]=status_id&fields[]=artists"), {
                headers: _assign(_assign({}, (_a = this.user) === null || _a === void 0 ? void 0 : _a.token), {
                  "Site-Id": "3"
                })
              }).then(function (res) {
                return res.json();
            ...
            case 1:
              ...
              genres = [data.genres || [], data.tags || []].flat().map(function (genres2) {
                return genres2 === null || genres2 === void 0 ? void 0 : genres2.name;
              }).filter(function (genres2) {
                return genres2;
              });
              if (genres.length) {
                novel.genres = genres.join(", ");
              }
              branch_name = ((_g = data.teams) === null || _g === void 0 ? void 0 : _g.reduce(function (acc, _a2) {
                var _b2;
                var name = _a2.name,
                  details = _a2.details;
                acc[String((_b2 = details === null || details === void 0 ? void 0 : details.branch_id) !== null && _b2 !== void 0 ? _b2 : "0")] = name;
                return acc;
              }, {
                "0": "\u0413\u043B\u0430\u0432\u043D\u0430\u044F \u0441\u0442\u0440\u0430\u043D\u0438\u0446\u0430"
              })) || {
              ...
              return [4, (0, fetch_1.fetchApi)("".concat(this.apiSite).concat(novelPath, "/chapters"), {
                headers: (_h = this.user) === null || _h === void 0 ? void 0 : _h.token
              }).then(function (res) {
                return res.json();
              })];
            case 2:
              ...
              if ((_j = chaptersJSON.data) === null || _j === void 0 ? void 0 : _j.length) {
                chapters = chaptersJSON.data.flatMap(function (chapter) {
                  return chapter.branches.map(function (_a2) {
                    var branch_id = _a2.branch_id,
                      created_at = _a2.created_at;
                ...
                if (chapters.length) {
                  uniquePages = new Set(chapters.map(function (c) {
                    return c.page;
                  }));
                  if (uniquePages.size === 1) {
                    chapters = chapters.map(function (chapter) {
                      return _assign(_assign({}, chapter), {
                        page: void 0
                      });
                    });
    ...
    RLIB2.prototype.parseChapter = function (chapterPath) {
      return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_f) {
          switch (_f.label) {
            case 0:
              ...
              chapterText = "";
              if (!(slug && volume && number)) return [3, 2];
              return [4, (0, fetch_1.fetchApi)(this.apiSite + slug + "/chapter?" + (branch_id ? "branch_id=" + branch_id + "&" : "") + "number=" + number + "&volume=" + volume, {
                headers: (_b = this.user) === null || _b === void 0 ? void 0 : _b.token
              }).then(function (res) {
                return res.json();
              })];
            case 1:
              result = _f.sent();
              chapterText = ((_d = (_c = result === null || result === void 0 ? void 0 : result.data) === null || _c === void 0 ? void 0 : _c.content) === null || _d === void 0 ? void 0 : _d.type) == "doc" ? jsonToHtml(result.data.content.content, result.data.attachments || []) : (_e = result === null || result === void 0 ? void 0 : result.data) === null || _e === void 0 ? void 0 : _e.content;
              _f.label = 2;
            case 2:
    ...
    RLIB2.prototype.searchNovels = function (searchTerm) {
      return __awaiter(this, void 0, void 0, function () {
        var url, result, novels;
        var _a;
      ...
      switch (element.type) {
        ...
        case "image":
          if ((_b = (_a = element.attrs) === null || _a === void 0 ? void 0 : _a.images) === null || _b === void 0 ? void 0 : _b.length) {
            element.attrs.images.forEach(function (_a2) {
              var image = _a2.image;
              var file = images.find(function (f) {
                return f.name == image || f.id == image;
              });
              if (file) {
            ...
            var attrs = Object.entries(element.attrs).filter(function (attr) {
              return attr === null || attr === void 0 ? void 0 : attr[1];
            }).map(function (attr) {
        ...
        case "listItem":
          ...
          break;
        case "blockquote":
          html += "<blockquote>" + (element.content ? jsonToHtml(element.content, images) : "<br>") + "</blockquote>";
          break;
        case "italic":
        ...
        case "bold":
          ...
          break;
        case "underline":
          html += "<u>" + (element.content ? jsonToHtml(element.content, images) : "<br>") + "</u>";
          break;
        case "heading":
          html += "<h2>" + (element.content ? jsonToHtml(element.content, images) : "<br>") + "</h2>";
          break;
        case "text":
          html += element.text;
          break;
        default:
          html += JSON.stringify(element, null, "	");
          break;
      }
    });
    return html;
