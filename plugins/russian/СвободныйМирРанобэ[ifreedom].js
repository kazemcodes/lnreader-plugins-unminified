...
var LNReaderPlugin = (() => {
  ...
  // .js/plugins/russian/СвободныйМирРанобэ[ifreedom].js
  init_dirname();
  init_buffer2();
  init_process2();
  ...
  var l = (init_fetch2(), __toCommonJS(fetch_exports)), n = (init_novelStatus(), __toCommonJS(novelStatus_exports)), r = require_lib6(), i = a(require_dayjs_min()), u = function() {
    ...
    return a2.prototype.parseNovels = function(e2) {
      ...
      return e(this, void 0, void 0, function() {
        var e2, u2, o2, s, c, v, p, b, h, f, d, m, g, y, w, k;
        return t(this, function(t2) {
          switch (t2.label) {
            case 0:
            ...
            case 1:
              return e2 = t2.sent(), u2 = { path: a3, name: "", author: "", summary: "", status: n.NovelStatus.Unknown }, o2 = [], s = [], c = this.site, v = false, p = false, b = false, h = null, f = false, d = false, m = false, g = false, y = false, w = {}, k = new r.Parser({ onopentag: /* @__PURE__ */ __name(function(e3, t3) {
                var a4 = t3.class || "";
                if ("h1" === e3 && (v = true), "div" === e3 && ((a4.includes("block-book-slide-img") || a4.includes("img-ranobe")) && (b = true), ("descr-ranobe" === a4 || "active" === a4 && "\u041E\u043F\u0438\u0441\u0430\u043D\u0438\u0435" === t3["data-name"]) && (p = true)), p && "span" === e3 && a4.includes("open-desc")) {
                  var l2 = t3.onclick;
                  if (l2) {
                    var n2 = l2.match(/innerHTML\s*=\s*'([\s\S]+?)'/);
                    if (n2 && n2[1]) {
                      var r2 = n2[1];
                      r2 = r2.replace(/&lt;br&gt;/gi, "\n").replace(/<br\s*\/?>/gi, "\n").replace(/&quot;/g, '"').replace(/&#039;/g, "'").replace(/&amp;/g, "&"), u2.summary = r2, p = false;
                    }
                  }
                }
                "img" === e3 && b && !u2.cover && (u2.cover = t3.src), "div" === e3 && (a4.includes("data-ranobe") && (f = true, h = null), a4.includes("data-value") && (d = true), a4.includes("book-info-list") && (f = true, h = null), a4.includes("genreslist") && (h = "genre")), f && ("span" === e3 && (a4.includes("dashicons-book") && !a4.includes("book-alt") ? h = "genre" : a4.includes("admin-users") ? h = "author" : a4.includes("megaphone") && (h = "status")), "svg" === e3 && (a4.includes("icon-tabler-tag") ? h = "genre" : a4.includes("mood-edit") || a4.includes("icon-tabler-user") ? h = "author" : (a4.includes("chart-infographic") || a4.includes("megaphone")) && (h = "status"))), "div" !== e3 || "li-ranobe" !== a4 && "chapterinfo" !== a4 || (m = true), "a" === e3 && m && (w.path = t3.href.replace(c, ""), g = true), "div" !== e3 && "span" !== e3 || "li-col2-ranobe" !== a4 && "timechapter" !== a4 || (y = true);
              }, "onopentag"), ontext: /* @__PURE__ */ __name(function(e3) {
                var t3 = e3.trim();
                if (t3) {
                  if (v && (u2.name = t3.replace(/®/g, "").trim()), p && "\u041F\u0440\u043E\u0447\u0435\u0441\u0442\u044C \u043F\u043E\u043B\u043D\u043E\u0441\u0442\u044C\u044E" !== t3 && (u2.summary += t3 + "\n"), h) (d || f && !d) && ("author" === h ? "\u0410\u0432\u0442\u043E\u0440" === t3 || "\u041F\u0435\u0440\u0435\u0432\u043E\u0434\u0447\u0438\u043A" === t3 || "\u041D\u0435 \u0443\u043A\u0430\u0437\u0430\u043D" === t3 || t3.includes("\u041F\u0440\u043E\u0441\u043C\u043E\u0442\u0440\u043E\u0432") || (u2.author = t3) : "status" === h ? t3.includes("\u0421\u0442\u0430\u0442\u0443\u0441") || (u2.status = function(e4) {
                  ...
                  }(t3)) : "genre" === h && "," !== t3 && "\u0416\u0430\u043D\u0440\u044B" !== t3 && s.push(t3));
                  g && (w.name = t3), y && (w.releaseTime = function(e4) {
                    void 0 === e4 && (e4 = "");
                ...
                "h1" === e3 && (v = false), "div" === e3 && (p && (p = false), b && (b = false), d && (d = false)), "a" === e3 && (g = false), "div" !== e3 && "span" !== e3 || !y || (y = false, w.path && o2.push(w), w = {}, m = false);
              }, "onclosetag") }), k.write(e2), k.end(), u2.genres = s.join(","), u2.chapters = o2.reverse(), [2, u2];
          }
        });
      });
