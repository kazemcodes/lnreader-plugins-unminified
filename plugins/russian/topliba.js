...
(() => {
  ...
  var n = (init_filterInputs(), __toCommonJS(filterInputs_exports)), r = (init_fetch2(), __toCommonJS(fetch_exports)), i = (init_browser(), __toCommonJS(browser_exports)), o = (function() {
    function o2() {
      var t2 = this;
      this.id = "TopLiba", this.name = "\u0422\u043E\u043F\u041B\u0438\u0431\u0430", this.site = "https://topliba.com", this.version = "1.0.0", this.icon = "src/ru/topliba/icon.png", this._token = "", this.popularNovels = this.fetchNovels, this.resolveUrl = function(e2, n2) {
        return t2.site + (n2 ? "/books/" + e2 : "/reader/" + e2.split("?")[0]);
      }, this.filters = { sort: { label: "\u0421\u043E\u0440\u0442\u0438\u0440\u043E\u0432\u043A\u0430:", value: "rating", options: [{ label: "\u041F\u043E \u0440\u0435\u0439\u0442\u0438\u043D\u0433\u0443", value: "rating" }, { label: "\u041F\u043E \u043F\u043E\u043F\u0443\u043B\u044F\u0440\u043D\u043E\u0441\u0442\u0438", value: "num_downloads" }, { label: "\u041F\u043E \u0433\u043E\u0434\u0443 \u0432\u044B\u0445\u043E\u0434\u0430", value: "year" }, { label: "\u041F\u043E \u0434\u0430\u0442\u0435 \u0434\u043E\u0431\u0430\u0432\u043B\u0435\u043D\u0438\u044F", value: "date" }, { label: "\u041F\u043E \u043D\u0430\u0437\u0432\u0430\u043D\u0438\u044E", value: "title" }], type: n.FilterTypes.Picker } };
    }
    __name(o2, "o");
    return o2.prototype.fetchNovels = function(n2, i2, o3) {
      return t(this, arguments, void 0, (function(t2, n3, i3) {
        var o4, a, s, l, c, u = this, h = n3.showLatestNovels, p = n3.filters;
        return e(this, (function(e2) {
          switch (e2.label) {
            case 0:
              return o4 = new URLSearchParams({ order_field: h ? "date" : (null === (l = null == p ? void 0 : p.sort) || void 0 === l ? void 0 : l.value) || "rating", p: t2 }), i3 && o4.append("q", i3), [4, (0, r.fetchApi)(this.site + "/?" + o4.toString()).then((function(t3) {
                return t3.text();
              }))];
            case 1:
              return a = e2.sent(), s = [], this._token = null === (c = a.match(/<meta name="_token" content="(.*?)"/)) || void 0 === c ? void 0 : c[1], (a.match(/<img class="cover" data-original=".*>/g) || []).forEach((function(t3) {
                var e3 = t3.match(/data-original=".*covers\/(.*?)_.*title="(.*?)"/) || [], n4 = e3[1], r2 = e3[2];
                n4 && r2 && s.push({ name: r2, cover: u.site + "/covers/" + n4 + ".jpg", path: n4 });
              })), [2, s];
          }
        }));
      }));
    }, o2.prototype.searchNovels = function(n2, r2) {
      return t(this, void 0, void 0, (function() {
        var t2;
        return e(this, (function(e2) {
          return t2 = { showLatestNovels: false, filters: {} }, [2, this.fetchNovels(r2, t2, n2)];
        }));
      }));
      ...
      return t(this, void 0, void 0, (function() {
        ...
        return e(this, (function(e2) {
          switch (e2.label) {
            case 0:
              return [4, (0, r.fetchApi)(this.resolveUrl(n2, true)).then((function(t3) {
                return t3.text();
              }))];
            case 1:
              return t2 = e2.sent(), o3 = (0, i.load)(t2), a = { path: n2, name: o3("div > h1").text().trim(), cover: this.site + "/covers/" + n2 + ".jpg", summary: o3(".description").text().trim(), author: o3(".book-author > a").text().trim(), genres: o3(".book-genres > div > a").map((function(t3, e3) {
                return o3(e3).text();
              })).get().join(",") }, [4, (0, r.fetchApi)(this.resolveUrl(n2)).then((function(t3) {
                return t3.text();
              }))];
            case 2:
              return s = e2.sent(), this._token = (null === (c = s.match(/<meta name="_token" content="(.*?)"/)) || void 0 === c ? void 0 : c[1]) || (null === (u = t2.match(/<meta name="_token" content="(.*?)"/)) || void 0 === u ? void 0 : u[1]) || this._token, l = [], (s.match(/<li class="padding-\d+" data-capter="\d+">([\s\S]*?)</g) || []).forEach((function(t3, e3) {
                var r2 = t3.match(/class="padding-(\d+)" data-capter="(\d+)">([\s\S]*?)</) || [], i2 = r2[1], o4 = r2[2], a2 = r2[3];
                if (i2 && o4 && a2) {
                  var s2 = "0" === i2 ? o4 : i2 + "-" + (parseInt(o4, 10) - 1);
                  l.push({ name: a2.trim(), path: n2 + "?" + s2, releaseTime: null, chapterNumber: e3 + 1 });
                }
              })), a.chapters = l, [2, a];
          }
        }));
      ...
      return t(this, void 0, void 0, (function() {
        ...
        return e(this, (function(e2) {
          switch (e2.label) {
            case 0:
              return t2 = n2.split("?"), i2 = t2[0], o3 = t2[1], this._token ? [3, 2] : [4, (0, r.fetchApi)(this.resolveUrl(i2)).then((function(t3) {
                return t3.text();
              }))];
            case 1:
              a = e2.sent(), this._token = null === (s = a.match(/<meta name="_token" content="(.*?)"/)) || void 0 === s ? void 0 : s[1], e2.label = 2;
            case 2:
              return [4, (0, r.fetchApi)(this.resolveUrl(i2) + "/chapter", { headers: { "Content-Type": "application/x-www-form-urlencoded; charset=UTF-8", Referer: this.resolveUrl(i2), Origin: this.site }, method: "POST", body: new URLSearchParams({ chapter: o3, _token: this._token }).toString() }).then((function(t3) {
                return t3.text();
              }))];
            case 3:
              return [2, e2.sent()];
