...
var LNReaderPlugin = (() => {
  ...
  var n = (init_filterInputs(), __toCommonJS(filterInputs_exports)), r = (init_fetch2(), __toCommonJS(fetch_exports)), i = (init_browser(), __toCommonJS(browser_exports)), o = function() {
    function o2() {
      var t2 = this;
      this.id = "TopLiba", this.name = "\u0422\u043E\u043F\u041B\u0438\u0431\u0430", this.site = "https://topliba.com", this.version = "1.0.1", this.icon = "src/ru/topliba/icon.png", this._token = "", this.resolveUrl = function(e2, n2) {
    ...
    __name(o2, "o");
    return o2.prototype.fetchNovels = function(n2, i2, o3, a) {
      return t(this, void 0, void 0, function() {
        var t2, s, c, l, u, h = this;
        return e(this, function(e2) {
          switch (e2.label) {
            case 0:
              return t2 = new URLSearchParams({ order_field: i2 ? "date" : (null === (l = null == o3 ? void 0 : o3.sort) || void 0 === l ? void 0 : l.value) || "rating", p: n2.toString() }), a && t2.append("q", a), [4, (0, r.fetchApi)(this.site + "/?" + t2.toString()).then(function(t3) {
                return t3.text();
              })];
            case 1:
              return s = e2.sent(), c = [], this._token = null === (u = s.match(/<meta name="_token" content="(.*?)"/)) || void 0 === u ? void 0 : u[1], (s.match(/<img class="cover" data-original=".*>/g) || []).forEach(function(t3) {
                var e3 = t3.match(/data-original=".*covers\/(.*?)_.*title="(.*?)"/) || [], n3 = e3[1], r2 = e3[2];
                n3 && r2 && c.push({ name: r2, cover: h.site + "/covers/" + n3 + ".jpg", path: n3 });
              }), [2, c];
          }
        });
      });
    }, o2.prototype.popularNovels = function(n2, r2) {
      return t(this, arguments, void 0, function(t2, n3) {
        var r3 = n3.showLatestNovels, i2 = n3.filters;
        return e(this, function(e2) {
          return [2, this.fetchNovels(t2, r3, i2)];
        });
      });
    }, o2.prototype.searchNovels = function(n2, r2) {
      return t(this, void 0, void 0, function() {
        return e(this, function(t2) {
          return [2, this.fetchNovels(r2, false, void 0, n2)];
        });
      });
      ...
      return t(this, void 0, void 0, function() {
        ...
        return e(this, function(e2) {
          switch (e2.label) {
            ...
            case 2:
              return s = e2.sent(), this._token = (null === (l = s.match(/<meta name="_token" content="(.*?)"/)) || void 0 === l ? void 0 : l[1]) || (null === (u = t2.match(/<meta name="_token" content="(.*?)"/)) || void 0 === u ? void 0 : u[1]) || this._token, c = [], (s.match(/<li class="padding-\d+" data-capter="\d+">([\s\S]*?)</g) || []).forEach(function(t3, e3) {
                var r2 = t3.match(/class="padding-(\d+)" data-capter="(\d+)">([\s\S]*?)</) || [], i2 = r2[1], o4 = r2[2], a2 = r2[3];
                if (i2 && o4 && a2) {
                  var s2 = "0" === i2 ? o4 : i2 + "-" + (parseInt(o4, 10) - 1);
                  c.push({ name: a2.trim(), path: n2 + "?" + s2, releaseTime: null, chapterNumber: e3 + 1 });
                }
              }), a.chapters = c, [2, a];
          }
        });
