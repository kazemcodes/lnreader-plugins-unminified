...
var LNReaderPlugin = (() => {
  ...
  var l = (init_filterInputs(), __toCommonJS(filterInputs_exports)), a = (init_defaultCover(), __toCommonJS(defaultCover_exports)), n = (init_fetch2(), __toCommonJS(fetch_exports)), o = (init_novelStatus(), __toCommonJS(novelStatus_exports)), r = { 0: o.NovelStatus.Unknown, 1: o.NovelStatus.Ongoing, 2: o.NovelStatus.Completed, 3: o.NovelStatus.OnHiatus, 4: o.NovelStatus.Cancelled }, i = function() {
    function i2() {
      var e2 = this;
      this.id = "neobook", this.name = "Neobook", this.site = "https://neobook.org", this.apiSite = "https://api.neobook.org/", this.version = "1.0.3", this.icon = "src/ru/neobook/icon.png", this.resolveUrl = function(t2, l2) {
    ...
    __name(i2, "i");
    return i2.prototype.fetchNovels = function(l2, o2, r2, i3) {
      return e(this, void 0, void 0, function() {
        var e2, u, s, v, c, p, d, f, h;
        return t(this, function(t2) {
          switch (t2.label) {
            case 0:
              return (e2 = new FormData()).append("version", "4.4"), e2.append("uid", "0"), e2.append("utoken", ""), e2.append("resource", "general"), e2.append("action", "get_bundle"), e2.append("bundle", "bundle_books"), e2.append("target", "feed"), e2.append("page", l2.toString()), e2.append("filter_category_id", (null === (v = null == r2 ? void 0 : r2.category) || void 0 === v ? void 0 : v.value) || "0"), e2.append("filter_completed", "-1"), e2.append("filter_search", i3 || ""), e2.append("filter_tags", (null === (c = null == r2 ? void 0 : r2.tags) || void 0 === c ? void 0 : c.value) || ""), e2.append("filter_sort", o2 ? "new" : (null === (p = null == r2 ? void 0 : r2.sort) || void 0 === p ? void 0 : p.value) || "popular"), e2.append("filter_timeread", (null === (d = null == r2 ? void 0 : r2.timeread) || void 0 === d ? void 0 : d.value) || "0-999999"), [4, (0, n.fetchApi)(this.apiSite, { method: "post", body: e2, referrer: this.site }).then(function(e3) {
                return e3.json();
              })];
            case 1:
              return u = t2.sent().bundle_books, s = [], (null === (f = u.feed) || void 0 === f ? void 0 : f.length) && (null === (h = u.feed) || void 0 === h || h.forEach(function(e3) {
                var t3, l3;
                return s.push({ name: e3.title, cover: (null === (l3 = null === (t3 = null == e3 ? void 0 : e3.attachment) || void 0 === t3 ? void 0 : t3.image) || void 0 === l3 ? void 0 : l3.m) || a.defaultCover, path: e3.token + "/" });
              })), [2, s];
          }
        });
      });
    }, i2.prototype.popularNovels = function(l2, a2) {
      return e(this, arguments, void 0, function(e2, l3) {
        var a3 = l3.showLatestNovels, n2 = l3.filters;
        return t(this, function(t2) {
          return [2, this.fetchNovels(e2, a3, n2)];
        });
      });
    }, i2.prototype.searchNovels = function(l2, a2) {
      return e(this, void 0, void 0, function() {
        return t(this, function(e2) {
          return [2, this.fetchNovels(a2, false, void 0, l2)];
        });
      });
    }, i2.prototype.parseNovel = function(l2) {
      return e(this, void 0, void 0, function() {
        var e2, i3, u, s, v, c, p, d, f, h, b, y;
        return t(this, function(t2) {
          switch (t2.label) {
            case 0:
            ...
            case 1:
              return e2 = t2.sent(), i3 = { path: l2, name: "", cover: a.defaultCover }, (u = e2.match(/var postData = ({.*?});/)) instanceof Array && u[1] && (s = JSON.parse(u[1]), i3.name = s.title, i3.summary = (null === (p = null === (c = s.text) || void 0 === c ? void 0 : c.replace) || void 0 === p ? void 0 : p.call(c, /<br>/g, "\n")) || s.text_fix, i3.author = s.user && s.user.firstname && s.user.lastname ? s.user.firstname + " " + s.user.lastname : (null === (d = s.user) || void 0 === d ? void 0 : d.initials) || "", i3.status = r[s.status || "0"] || o.NovelStatus.Unknown, (null === (h = null === (f = s.attachment) || void 0 === f ? void 0 : f.image) || void 0 === h ? void 0 : h.m) && (i3.cover = s.attachment.image.m), (null === (b = s.tags) || void 0 === b ? void 0 : b.length) && (i3.genres = s.tags.join(",")), v = [], null === (y = s.chapters) || void 0 === y || y.forEach(function(e3, t3) {
