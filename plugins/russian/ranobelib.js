...
var LNReaderPlugin = (() => {
  ...
  var n = (init_filterInputs(), __toCommonJS(filterInputs_exports)), u = (init_defaultCover(), __toCommonJS(defaultCover_exports)), r = (init_fetch2(), __toCommonJS(fetch_exports)), i = (init_novelStatus(), __toCommonJS(novelStatus_exports)), o = (init_storage2(), __toCommonJS(storage_exports)), s = t(require_dayjs_min()), v = { 1: i.NovelStatus.Ongoing, 2: i.NovelStatus.Completed, 3: i.NovelStatus.OnHiatus, 4: i.NovelStatus.Cancelled }, c = { Accept: "application/json", Referer: "https://ranobelib.me", Origin: "https://ranobelib.me/", "Site-Id": "3", "client-time-zone": Intl.DateTimeFormat().resolvedOptions().timeZone || "Europe/Moscow", "User-Agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/142.0.0.0 YaBrowser/25.12.0.0 Safari/537.36" }, b = function() {
    function t2() {
      var l2 = this;
      this.id = "RLIB", this.name = "RanobeLib", this.site = "https://ranobelib.me", this.apiSite = "https://api.cdnlibs.org/api/manga/", this.version = "2.2.4", this.icon = "src/ru/ranobelib/icon.png", this.webStorageUtilized = true, this.imageRequestInit = { headers: e(e({}, c), { Accept: "image/avif,image/webp,image/apng,image/svg+xml,image/*,*/*;q=0.8" }) }, this.resolveUrl = function(e2, a2) {
    ...
    return t2.prototype.popularNovels = function(e2, t3) {
      return l(this, arguments, void 0, function(e3, l2) {
        var t4, n2, i2, o2, s2, v2, c2, b2, d2, p, h, f, g, m, y, _, k, x, S, w, j = l2.showLatestNovels, N = l2.filters;
        ...
        return a(this, function(a2) {
          switch (a2.label) {
            ...
            case 1:
              ...
              }, { 0: "\u0413\u043B\u0430\u0432\u043D\u0430\u044F \u0441\u0442\u0440\u0430\u043D\u0438\u0446\u0430" })) || { 0: "\u0413\u043B\u0430\u0432\u043D\u0430\u044F \u0441\u0442\u0440\u0430\u043D\u0438\u0446\u0430" }, [4, (0, r.fetchApi)("".concat(this.apiSite).concat(t3, "/chapters"), { headers: this.getHeaders() }).then(function(e2) {
                return e2.json();
              })];
            case 2:
      ...
      return l(this, void 0, void 0, function() {
        var l2, t3, n2, u2, i2, o2, s2, v2, c2;
        return a(this, function(a2) {
          switch (a2.label) {
            case 0:
              return l2 = e2.split("/"), t3 = l2[0], n2 = l2[1], u2 = l2[2], i2 = l2[3], o2 = "", t3 && n2 && u2 ? [4, (0, r.fetchApi)(this.apiSite + t3 + "/chapter?" + (i2 ? "branch_id=" + i2 + "&" : "") + "number=" + u2 + "&volume=" + n2, { headers: this.getHeaders() }).then(function(e3) {
                return e3.json();
              })] : [3, 2];
            case 1:
              s2 = a2.sent(), v2 = null === (c2 = null == s2 ? void 0 : s2.data) || void 0 === c2 ? void 0 : c2.content, o2 = "object" == typeof v2 && "doc" === (null == v2 ? void 0 : v2.type) ? d(v2.content, s2.data.attachments || []) : v2 || "", a2.label = 2;
            case 2:
              return [2, o2];
          }
        });
      ...
      return l(this, void 0, void 0, function() {
        ...
        return a(this, function(a2) {
          switch (a2.label) {
            case 0:
              return l2 = this.apiSite + "?site_id[0]=3&q=" + e2, [4, (0, r.fetchApi)(l2, { headers: this.getHeaders() }).then(function(e3) {
                return e3.json();
              })];
            case 1:
