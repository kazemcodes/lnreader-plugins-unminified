...
var LNReaderPlugin = (() => {
  ...
  // .js/plugins/russian/novelOvh.js
  ...
  var r = (init_filterInputs(), __toCommonJS(filterInputs_exports)), o = (init_fetch2(), __toCommonJS(fetch_exports)), a = (init_novelStatus(), __toCommonJS(novelStatus_exports)), i = n(require_dayjs_min()), s = (function() {
    function n2() {
      var e2 = this;
      this.id = "novelovh", this.name = "\u041D\u043E\u0432\u0435\u043B\u041E\u0412\u0425", this.site = "https://novel.ovh", this.apiSite = "https://api.novel.ovh/v2/", this.version = "1.0.3", this.icon = "src/ru/novelovh/icon.png", this.jsonToHtml = function(t2, n3, r2) {
        return void 0 === r2 && (r2 = ""), t2.forEach((function(t3) {
          var o2, a2;
          switch (t3.type) {
            case "image":
              (null === (a2 = null === (o2 = t3.attrs) || void 0 === o2 ? void 0 : o2.pages) || void 0 === a2 ? void 0 : a2[0]) && (r2 += '<img src="'.concat(n3[t3.attrs.pages[0]], '"/>'));
              break;
            case "hardBreak":
              r2 += "<br>";
              break;
            case "horizontalRule":
            case "delimiter":
              r2 += '<h2 style="text-align: center">***</h2>';
              break;
            case "paragraph":
              r2 += "<p>" + (t3.content ? e2.jsonToHtml(t3.content, n3) : "<br>") + "</p>";
              break;
            case "orderedList":
              r2 += "<ol>" + (t3.content ? e2.jsonToHtml(t3.content, n3) : "<br>") + "</ol>";
              break;
            case "listItem":
              r2 += "<li>" + (t3.content ? e2.jsonToHtml(t3.content, n3) : "<br>") + "</li>";
              break;
            case "blockquote":
              r2 += "<blockquote>" + (t3.content ? e2.jsonToHtml(t3.content, n3) : "<br>") + "</blockquote>";
              break;
            case "italic":
              r2 += "<i>" + (t3.content ? e2.jsonToHtml(t3.content, n3) : "<br>") + "</i>";
              break;
            case "bold":
              r2 += "<b>" + (t3.content ? e2.jsonToHtml(t3.content, n3) : "<br>") + "</b>";
              break;
            case "underline":
              r2 += "<u>" + (t3.content ? e2.jsonToHtml(t3.content, n3) : "<br>") + "</u>";
              break;
            case "heading":
              r2 += "<h2>" + (t3.content ? e2.jsonToHtml(t3.content, n3) : "<br>") + "</h2>";
              break;
            case "text":
              r2 += t3.text;
              break;
            default:
              r2 += JSON.stringify(t3, null, "	");
          }
        })), r2;
      }, this.resolveUrl = function(t2) {
    ...
    return n2.prototype.popularNovels = function(n3, r2) {
      return e(this, arguments, void 0, (function(e2, n4) {
        ...
        return t(this, (function(t2) {
          switch (t2.label) {
            case 0:
              return r3 = this.apiSite + "books?page=" + (e2 - 1), r3 += "&sort=" + (l ? "updatedAt" : (null === (s2 = null == u ? void 0 : u.sort) || void 0 === s2 ? void 0 : s2.value) || "averageRating") + ",desc", [4, (0, o.fetchApi)(r3).then((function(e3) {
                return e3.json();
              }))];
            case 1:
              return a2 = t2.sent(), i2 = [], a2.forEach((function(e3) {
                return i2.push({ name: e3.name.ru, cover: e3.poster, path: e3.slug });
              })), [2, i2];
          }
        }));
      }));
      ...
      return e(this, void 0, void 0, (function() {
        var e2, r2, s2, l, u, c, h, p, f, v;
        return t(this, (function(t2) {
          switch (t2.label) {
            case 0:
              return [4, (0, o.fetchApi)(this.site + "/content/" + n3 + "?_data=routes/reader/book/$slug/index").then((function(e3) {
                return e3.json();
              }))];
            case 1:
              return e2 = t2.sent(), r2 = e2.book, s2 = e2.branches, l = e2.chapters, u = { path: n3, name: r2.name.ru, cover: r2.poster, genres: null === (f = null === (p = r2.labels) || void 0 === p ? void 0 : p.map) || void 0 === f ? void 0 : f.call(p, (function(e3) {
                return e3.name;
              })).join(","), summary: r2.description, status: "ONGOING" == r2.status ? a.NovelStatus.Ongoing : a.NovelStatus.Completed }, null === (v = r2.relations) || void 0 === v || v.forEach((function(e3) {
                switch (e3.type) {
                  case "AUTHOR":
                    u.author = e3.publisher.name;
                    break;
                  case "ARTIST":
                    u.artist = e3.publisher.name;
                }
              })), c = {}, s2.length && s2.forEach((function(e3) {
                var t3 = e3.id, n4 = e3.publishers;
                t3 && (null == n4 ? void 0 : n4.length) && (c[t3] = n4[0].name || "\u041D\u0435\u0438\u0437\u0432\u0435\u0441\u0442\u043D\u044B\u0439");
              })), h = [], l.forEach((function(e3, t3) {
                return h.push({ name: e3.title || "\u0422\u043E\u043C " + (e3.volume || 0) + " " + (e3.name || "\u0413\u043B\u0430\u0432\u0430 " + (e3.number || l.length - t3)), path: n3 + "/" + e3.id, releaseTime: (0, i.default)(e3.createdAt).format("LLL"), chapterNumber: l.length - t3, page: c[e3.branchId] || "\u0413\u043B\u0430\u0432\u043D\u0430\u044F \u0441\u0442\u0440\u0430\u043D\u0438\u0446\u0430" });
              })), u.chapters = h.reverse(), [2, u];
          }
        }));
      }));
      ...
      return e(this, void 0, void 0, (function() {
        ...
        return t(this, (function(t2) {
          switch (t2.label) {
            case 0:
              return [4, (0, o.fetchApi)(this.apiSite + "chapters/" + n3.split("/")[1]).then((function(e3) {
                return e3.json();
              }))];
            case 1:
              return e2 = t2.sent(), r2 = Object.fromEntries((null === (a2 = null == e2 ? void 0 : e2.pages) || void 0 === a2 ? void 0 : a2.map((function(e3) {
                return [e3.id, e3.image];
              }))) || []), [2, this.jsonToHtml(e2.content.content || [], r2)];
          }
        }));
      }));
      ...
      return e(this, void 0, void 0, (function() {
        ...
        return t(this, (function(t2) {
          switch (t2.label) {
            case 0:
              return e2 = this.apiSite + "books?type=NOVEL&search=" + n3, [4, (0, o.fetchApi)(e2).then((function(e3) {
                return e3.json();
              }))];
            case 1:
              return r2 = t2.sent(), a2 = [], r2.forEach((function(e3) {
                return a2.push({ name: e3.name.ru, cover: e3.poster, path: e3.slug });
              })), [2, a2];
          }
        }));
      }));
