...
var LNReaderPlugin = (() => {
  ...
  var require_dayjs_min = __commonJS({
    "node_modules/dayjs/dayjs.min.js"(exports4, module) {
      ...
      !function(t2, e2) {
        ...
        "use strict";
        var t2 = 1e3, e2 = 6e4, n2 = 36e5, r2 = "millisecond", i2 = "second", s = "minute", u2 = "hour", a2 = "day", o2 = "week", c = "month", f = "quarter", h = "year", d = "date", l2 = "Invalid Date", $ = /^(\d{4})[-/]?(\d{1,2})?[-/]?(\d{0,2})[Tt\s]*(\d{1,2})?:?(\d{1,2})?:?(\d{1,2})?[.:]?(\d+)?$/, y = /\[([^\]]+)]|Y{1,4}|M{1,4}|D{1,2}|d{1,4}|H{1,2}|h{1,2}|a|A|m{1,2}|s{1,2}|Z{1,2}|SSS/g, M = { name: "en", weekdays: "Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"), months: "January_February_March_April_May_June_July_August_September_October_November_December".split("_"), ordinal: /* @__PURE__ */ __name(function(t3) {
          ...
          var r3 = 12 * (n3.year() - e3.year()) + (n3.month() - e3.month()), i3 = e3.clone().add(r3, c), s2 = n3 - i3 < 0, u3 = e3.clone().add(r3 + (s2 ? -1 : 1), c);
          return +(-(r3 + (n3 - i3) / (s2 ? i3 - u3 : u3 - i3)) || 0);
        }, "t"), a: /* @__PURE__ */ __name(function(t3) {
          return t3 < 0 ? Math.ceil(t3) || 0 : Math.floor(t3);
        }, "a"), p: /* @__PURE__ */ __name(function(t3) {
          return { M: c, y: h, w: o2, d: a2, D: d, h: u2, m: s, s: i2, ms: r2, Q: f }[t3] || String(t3 || "").toLowerCase().replace(/s$/, "");
        ...
        var _ = function() {
          ...
          return m2.parse = function(t3) {
            ...
            var n3, o3 = b.p(t3), f2 = "set" + (this.$u ? "UTC" : ""), l3 = (n3 = {}, n3[a2] = f2 + "Date", n3[d] = f2 + "Date", n3[c] = f2 + "Month", n3[h] = f2 + "FullYear", n3[u2] = f2 + "Hours", n3[s] = f2 + "Minutes", n3[i2] = f2 + "Seconds", n3[r2] = f2 + "Milliseconds", n3)[o3], $2 = o3 === a2 ? this.$D + (e3 - this.$W) : e3;
            if (o3 === c || o3 === h) {
            ...
            if ($2 === a2) return y2(1);
            if ($2 === o2) return y2(7);
            var M3 = (d2 = {}, d2[s] = e2, d2[u2] = n2, d2[i2] = t2, d2)[$2] || 1, m3 = this.$d.getTime() + r3 * M3;
            return b.w(m3, this);
            ...
            var r3 = t3 || "YYYY-MM-DDTHH:mm:ssZ", i3 = b.z(this), s2 = this.$H, u3 = this.$m, a3 = this.$M, o3 = n3.weekdays, c2 = n3.months, f2 = n3.meridiem, h2 = /* @__PURE__ */ __name(function(t4, n4, i4, s3) {
  ...
  // .js/plugins/russian/Bookhamster[ifreedom].js
  init_dirname();
  init_buffer2();
  init_process2();
  var e = function(e2, t2, a2, l2) {
    ...
    return i2.next = u2(0), i2.throw = u2(1), i2.return = u2(2), "function" == typeof Symbol && (i2[Symbol.iterator] = function() {
      return this;
    }), i2;
    function u2(u3) {
      return function(o2) {
        return function(u4) {
          ...
          for (; i2 && (i2 = 0, u4[0] && (r2 = 0)), r2; ) try {
            if (a2 = 1, l2 && (n2 = 2 & u4[0] ? l2.return : u4[0] ? l2.throw || ((n2 = l2.return) && n2.call(l2), 0) : l2.next) && !(n2 = n2.call(l2, u4[1])).done) return n2;
            switch (l2 = 0, n2 && (u4 = [2 & u4[0], n2.value]), u4[0]) {
              case 0:
              case 1:
                n2 = u4;
                break;
              case 4:
                return r2.label++, { value: u4[1], done: false };
              case 5:
                r2.label++, l2 = u4[1], u4 = [0];
                continue;
              case 7:
                u4 = r2.ops.pop(), r2.trys.pop();
                continue;
              default:
                if (!(n2 = r2.trys, (n2 = n2.length > 0 && n2[n2.length - 1]) || 6 !== u4[0] && 2 !== u4[0])) {
                  r2 = 0;
                  continue;
                }
                if (3 === u4[0] && (!n2 || u4[1] > n2[0] && u4[1] < n2[3])) {
                  r2.label = u4[1];
                  break;
                }
                if (6 === u4[0] && r2.label < n2[1]) {
                  r2.label = n2[1], n2 = u4;
                  break;
                }
                if (n2 && r2.label < n2[2]) {
                  r2.label = n2[2], r2.ops.push(u4);
                  break;
                }
  ...
  Object.defineProperty(exports, "__esModule", { value: true }), exports.IfreedomPlugin = void 0;
  var l = (init_fetch2(), __toCommonJS(fetch_exports)), n = (init_novelStatus(), __toCommonJS(novelStatus_exports)), r = require_lib6(), i = a(require_dayjs_min()), u = function() {
    function a2(e2) {
      this.id = e2.id, this.name = e2.sourceName, this.icon = "multisrc/ifreedom/".concat(e2.id.toLowerCase(), "/icon.png"), this.site = e2.sourceSite, this.version = "1.1.1", this.filters = e2.filters;
    }
    __name(a2, "a");
    return a2.prototype.parseNovels = function(e2) {
      var t2 = this;
      return (0, l.fetchApi)(e2).then(function(e3) {
        return e3.text();
      }).then(function(e3) {
        var a3 = [], l2 = {}, n2 = false, i2 = t2.site, u2 = new r.Parser({ onopentag: /* @__PURE__ */ __name(function(e4, t3) {
          var a4 = t3.class || "";
          "div" === e4 && (a4.includes("one-book-home") || a4.includes("item-book-slide")) && (n2 = true), n2 && ("img" === e4 && (l2.cover = t3.src, t3.alt && (l2.name = t3.alt)), "a" === e4 && t3.href && (l2.path = t3.href.replace(i2, ""), t3.title && (l2.name = t3.title)));
        }, "onopentag"), onclosetag: /* @__PURE__ */ __name(function(e4) {
          "div" === e4 && n2 && (n2 = false, l2.path && a3.push(l2), l2 = {});
        }, "onclosetag") });
        return u2.write(e3), u2.end(), a3;
      });
    }, a2.prototype.popularNovels = function(a3, l2) {
      return e(this, arguments, void 0, function(e2, a4) {
        var l3, n2, r2 = a4.filters, i2 = a4.showLatestNovels;
        return t(this, function(t2) {
          return l3 = "".concat(this.site, "/vse-knigi/?sort=").concat(i2 ? "\u041F\u043E \u0434\u0430\u0442\u0435 \u043E\u0431\u043D\u043E\u0432\u043B\u0435\u043D\u0438\u044F" : (null === (n2 = null == r2 ? void 0 : r2.sort) || void 0 === n2 ? void 0 : n2.value) || "\u041F\u043E \u0440\u0435\u0439\u0442\u0438\u043D\u0433\u0443"), Object.entries(r2 || {}).forEach(function(e3) {
            var t3 = e3[0], a5 = e3[1].value;
            Array.isArray(a5) && a5.length && (l3 += "&".concat(t3, "[]=").concat(a5.join("&".concat(t3, "[]="))));
          }), l3 += "&bpage=".concat(e2), [2, this.parseNovels(l3)];
        });
      });
    }, a2.prototype.parseNovel = function(a3) {
      return e(this, void 0, void 0, function() {
        var e2, u2, o2, s, c, v, b, h, p, f, d, m, g, y, k, w;
        return t(this, function(t2) {
          switch (t2.label) {
            case 0:
              return [4, (0, l.fetchApi)(this.site + a3).then(function(e3) {
                return e3.text();
              })];
            case 1:
              return e2 = t2.sent(), u2 = { path: a3, name: "", author: "", summary: "", status: n.NovelStatus.Unknown }, o2 = [], s = [], c = this.site, v = false, b = false, h = false, p = null, f = false, d = false, m = false, g = false, y = false, k = {}, w = new r.Parser({ onopentag: /* @__PURE__ */ __name(function(e3, t3) {
                var a4 = t3.class || "";
                if ("h1" === e3 && (v = true), "div" === e3 && ((a4.includes("block-book-slide-img") || a4.includes("img-ranobe")) && (h = true), ("descr-ranobe" === a4 || "active" === a4 && "\u041E\u043F\u0438\u0441\u0430\u043D\u0438\u0435" === t3["data-name"]) && (b = true)), b && "span" === e3 && a4.includes("open-desc")) {
                  var l2 = t3.onclick;
                  if (l2) {
                    var n2 = l2.match(/innerHTML\s*=\s*'([\s\S]+?)'/);
                    if (n2 && n2[1]) {
                      var r2 = n2[1];
                      r2 = r2.replace(/&lt;br&gt;/gi, "\n").replace(/<br\s*\/?>/gi, "\n").replace(/&quot;/g, '"').replace(/&#039;/g, "'").replace(/&amp;/g, "&"), u2.summary = r2, b = false;
                    }
                  }
                }
                "img" === e3 && h && !u2.cover && (u2.cover = t3.src), "div" === e3 && (a4.includes("data-ranobe") && (f = true, p = null), a4.includes("data-value") && (d = true), a4.includes("book-info-list") && (f = true, p = null), a4.includes("genreslist") && (p = "genre")), f && ("span" === e3 && (a4.includes("dashicons-book") && !a4.includes("book-alt") ? p = "genre" : a4.includes("admin-users") ? p = "author" : a4.includes("megaphone") && (p = "status")), "svg" === e3 && (a4.includes("icon-tabler-tag") ? p = "genre" : a4.includes("mood-edit") || a4.includes("icon-tabler-user") ? p = "author" : (a4.includes("chart-infographic") || a4.includes("megaphone")) && (p = "status"))), "div" !== e3 || "li-ranobe" !== a4 && "chapterinfo" !== a4 || (m = true), "a" === e3 && m && (k.path = t3.href.replace(c, ""), g = true), "div" !== e3 && "span" !== e3 || "li-col2-ranobe" !== a4 && "timechapter" !== a4 || (y = true);
              }, "onopentag"), ontext: /* @__PURE__ */ __name(function(e3) {
                var t3 = e3.trim();
                if (t3) {
                  if (v && (u2.name = t3.replace(/®/g, "").trim()), b && "\u041F\u0440\u043E\u0447\u0435\u0441\u0442\u044C \u043F\u043E\u043B\u043D\u043E\u0441\u0442\u044C\u044E" !== t3 && (u2.summary += t3 + "\n"), p) (d || f && !d) && ("author" === p ? "\u0410\u0432\u0442\u043E\u0440" === t3 || "\u041F\u0435\u0440\u0435\u0432\u043E\u0434\u0447\u0438\u043A" === t3 || "\u041D\u0435 \u0443\u043A\u0430\u0437\u0430\u043D" === t3 || t3.includes("\u041F\u0440\u043E\u0441\u043C\u043E\u0442\u0440\u043E\u0432") || (u2.author = t3) : "status" === p ? t3.includes("\u0421\u0442\u0430\u0442\u0443\u0441") || (u2.status = function(e4) {
                    var t4 = e4.toLowerCase().trim();
                    if (t4.includes("\u0430\u043A\u0442\u0438\u0432\u0435\u043D") || t4.includes("\u043F\u0440\u043E\u0434\u043E\u043B\u0436\u0430\u0435\u0442\u0441\u044F") || t4.includes("\u043E\u043D\u0433\u043E\u0438\u043D\u0433")) return n.NovelStatus.Ongoing;
                    if (t4.includes("\u0437\u0430\u0432\u0435\u0440\u0448\u0435\u043D") || t4.includes("\u043A\u043E\u043D\u0435\u0446") || t4.includes("\u0437\u0430\u043A\u043E\u043D\u0447\u0435\u043D")) return n.NovelStatus.Completed;
                    if (t4.includes("\u043F\u0440\u0438\u043E\u0441\u0442\u0430\u043D\u043E\u0432\u043B\u0435\u043D") || t4.includes("\u0437\u0430\u043C\u043E\u0440\u043E\u0436\u0435\u043D")) return n.NovelStatus.OnHiatus;
                    return n.NovelStatus.Unknown;
                  }(t3)) : "genre" === p && "," !== t3 && "\u0416\u0430\u043D\u0440\u044B" !== t3 && s.push(t3));
                  g && (k.name = t3), y && (k.releaseTime = function(e4) {
                    void 0 === e4 && (e4 = "");
                    var t4 = { "\u044F\u043D\u0432\u0430\u0440\u044F": 1, "\u0444\u0435\u0432\u0440\u0430\u043B\u044F": 2, "\u043C\u0430\u0440\u0442\u0430": 3, "\u0430\u043F\u0440\u0435\u043B\u044F": 4, "\u043C\u0430\u044F": 5, "\u0438\u044E\u043D\u044F": 6, "\u0438\u044E\u043B\u044F": 7, "\u0430\u0432\u0433\u0443\u0441\u0442\u0430": 8, "\u0441\u0435\u043D\u0442\u044F\u0431\u0440\u044F": 9, "\u043E\u043A\u0442\u044F\u0431\u0440\u044F": 10, "\u043D\u043E\u044F\u0431\u0440\u044F": 11, "\u0434\u0435\u043A\u0430\u0431\u0440\u044F": 12 }, a4 = /(d+)s*ч.?s*назад/, l2 = e4.match(a4);
                    if (l2) {
                      var n2 = parseInt(l2[1], 10);
                      return (0, i.default)().subtract(n2, "hour").format("LL");
                    }
                    if (e4.includes(".")) {
                      var r2 = e4.split("."), u3 = r2[0], o3 = r2[1], s2 = 2 === (null == (v2 = r2[2]) ? void 0 : v2.length) ? "20" + v2 : v2;
                      return (0, i.default)(s2 + "-" + o3 + "-" + u3).format("LL");
                    }
                    if (e4.includes(" ")) {
                      var c2 = e4.split(" ");
                      u3 = c2[0], o3 = c2[1];
                      if (u3 && t4[o3]) {
                        var v2 = (/* @__PURE__ */ new Date()).getFullYear();
                        return (0, i.default)(v2 + "-" + t4[o3] + "-" + u3).format("LL");
                      }
                    }
                    return e4 || null;
                  }(t3));
                ...
                "h1" === e3 && (v = false), "div" === e3 && (b && (b = false), h && (h = false), d && (d = false)), "a" === e3 && (g = false), "div" !== e3 && "span" !== e3 || !y || (y = false, k.path && o2.push(k), k = {}, m = false);
              }, "onclosetag") }), w.write(e2), w.end(), u2.genres = s.join(","), u2.chapters = o2.reverse(), [2, u2];
          }
        });
      });
    }, a2.prototype.parseChapter = function(a3) {
      return e(this, void 0, void 0, function() {
        var e2, n2, r2, i2, u2, o2;
        return t(this, function(t2) {
          switch (t2.label) {
            case 0:
              return [4, (0, l.fetchApi)(this.site + a3).then(function(e3) {
            ...
            case 1:
              return e2 = t2.sent(), n2 = "bookhamster" === this.id ? '<div class="entry-content">' : '<div class="chapter-content">', r2 = "bookhamster" === this.id ? "<!-- .entry-content -->" : '<div class="chapter-setting">', -1 === (i2 = e2.indexOf(n2)) ? [2, ""] : (u2 = e2.indexOf(r2, i2), (o2 = (o2 = e2.slice(i2, -1 !== u2 ? u2 : void 0)).replace(/<script[^>]*>[\s\S]*?<\/script>/gim, "")).includes("<img") && (o2 = o2.replace(/srcset="([^"]+)"/g, function(e3, t3) {
                if (!t3) return e3;
                var a4 = t3.split(" ").filter(function(e4) {
                  return e4.startsWith("http");
                }).pop();
                return a4 ? 'src="'.concat(a4, '"') : e3;
              })), [2, o2]);
          }
        });
      });
