...
(() => {
  ...
  var t = (init_filterInputs(), __toCommonJS(filterInputs_exports)), r = (init_defaultCover(), __toCommonJS(defaultCover_exports)), i = (init_fetch2(), __toCommonJS(fetch_exports)), n = (init_novelStatus(), __toCommonJS(novelStatus_exports)), o = require_lib6(), u = a(require_dayjs_min()), s = (function() {
    function a2() {
      var e2 = this;
      this.id = "AT", this.name = "\u0410\u0432\u0442\u043E\u0440 \u0422\u0443\u0434\u0435\u0439", this.icon = "src/ru/authortoday/icon.png", this.site = "https://author.today", this.version = "1.2.1", this.userAgent = "Mozilla/5.0 (Android 15; Mobile; rv:138.0) Gecko/138.0 Firefox/138.0", this.resolveUrl = function(l2, a3) {
    ...
    return a2.prototype.parseNovels = function(e2) {
      ...
      return e(this, void 0, void 0, (function() {
        var e2, t2, r2, n2, o2, u2, s2, v, c, h, p, b, f, d;
        return l(this, (function(l2) {
          switch (l2.label) {
            case 0:
            ...
            case 1:
              if (e2 = l2.sent(), t2 = a3.split("/"), r2 = t2[0], n2 = t2[1], o2 = null === (b = null === (p = e2.match(/userId:(.*?),/)) || void 0 === p ? void 0 : p[1]) || void 0 === b ? void 0 : b.trim(), u2 = "null" === o2 ? "" : o2, n2 || (n2 = (null === (d = null === (f = e2.match(/chapterId:(.*?),/)) || void 0 === f ? void 0 : f[1]) || void 0 === d ? void 0 : d.trim()) || ""), !n2) throw new Error("Chapter ID not found");
              return [4, (0, i.fetchApi)(this.site + "/reader/" + r2 + "/chapter?id=" + n2, { headers: { "User-Agent": this.userAgent } })];
            case 2:
              return [4, (s2 = l2.sent()).json()];
            case 3:
              if (v = l2.sent(), !(c = s2.headers.get("reader-secret"))) throw new Error("Failed to find the token\n" + v.messages);
              return h = (function(e3, l3, a4) {
                void 0 === a4 && (a4 = "");
