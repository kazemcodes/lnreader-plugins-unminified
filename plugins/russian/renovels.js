  ...
  var require_dayjs_min = __commonJS({
    "node_modules/dayjs/dayjs.min.js"(exports4, module) {
      ...
      !function(t2, e2) {
        ...
        "use strict";
        var t2 = 1e3, e2 = 6e4, n2 = 36e5, r = "millisecond", i = "second", s = "minute", u2 = "hour", a2 = "day", o = "week", c = "month", f = "quarter", h = "year", d = "date", l2 = "Invalid Date", $ = /^(\d{4})[-/]?(\d{1,2})?[-/]?(\d{0,2})[Tt\s]*(\d{1,2})?:?(\d{1,2})?:?(\d{1,2})?[.:]?(\d+)?$/, y = /\[([^\]]+)]|Y{1,4}|M{1,4}|D{1,2}|d{1,4}|H{1,2}|h{1,2}|a|A|m{1,2}|s{1,2}|Z{1,2}|SSS/g, M = { name: "en", weekdays: "Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"), months: "January_February_March_April_May_June_July_August_September_October_November_December".split("_"), ordinal: /* @__PURE__ */ __name(function(t3) {
          ...
          var r2 = 12 * (n3.year() - e3.year()) + (n3.month() - e3.month()), i2 = e3.clone().add(r2, c), s2 = n3 - i2 < 0, u3 = e3.clone().add(r2 + (s2 ? -1 : 1), c);
          return +(-(r2 + (n3 - i2) / (s2 ? i2 - u3 : u3 - i2)) || 0);
        }, "t"), a: /* @__PURE__ */ __name(function(t3) {
          return t3 < 0 ? Math.ceil(t3) || 0 : Math.floor(t3);
        }, "a"), p: /* @__PURE__ */ __name(function(t3) {
          return { M: c, y: h, w: o, d: a2, D: d, h: u2, m: s, s: i, ms: r, Q: f }[t3] || String(t3 || "").toLowerCase().replace(/s$/, "");
        ...
        var _ = function() {
          ...
          return m2.parse = function(t3) {
            ...
            var n3, o2 = b2.p(t3), f2 = "set" + (this.$u ? "UTC" : ""), l3 = (n3 = {}, n3[a2] = f2 + "Date", n3[d] = f2 + "Date", n3[c] = f2 + "Month", n3[h] = f2 + "FullYear", n3[u2] = f2 + "Hours", n3[s] = f2 + "Minutes", n3[i] = f2 + "Seconds", n3[r] = f2 + "Milliseconds", n3)[o2], $2 = o2 === a2 ? this.$D + (e3 - this.$W) : e3;
            if (o2 === c || o2 === h) {
            ...
            if ($2 === a2) return y2(1);
            if ($2 === o) return y2(7);
            var M3 = (d2 = {}, d2[s] = e2, d2[u2] = n2, d2[i] = t2, d2)[$2] || 1, m3 = this.$d.getTime() + r2 * M3;
            return b2.w(m3, this);
            ...
            var r2 = t3 || "YYYY-MM-DDTHH:mm:ssZ", i2 = b2.z(this), s2 = this.$H, u3 = this.$m, a3 = this.$M, o2 = n3.weekdays, c2 = n3.months, f2 = n3.meridiem, h2 = /* @__PURE__ */ __name(function(t4, n4, i3, s3) {
        ...
        return O.prototype = k, [["$ms", r], ["$s", i], ["$m", s], ["$H", u2], ["$W", a2], ["$M", c], ["$y", h], ["$D", d]].forEach(function(t3) {
          k[t3[1]] = function(e3) {
  ...
  var u = (init_filterInputs(), __toCommonJS(filterInputs_exports)), v = (init_fetch2(), __toCommonJS(fetch_exports)), b = (init_novelStatus(), __toCommonJS(novelStatus_exports)), t = a(require_dayjs_min()), n = function() {
    ...
    return a2.prototype.popularNovels = function(a3, u2) {
      ...
      return l(this, void 0, void 0, function() {
        var l2, u2, n2, r, i, o, s, c, p, h, f, d, y;
        return e(this, function(m) {
          switch (m.label) {
            case 0:
              return [4, (0, v.fetchApi)(this.site + "/api/titles/" + a3).then(function(l3) {
                return l3.json();
              })];
            case 1:
              l2 = m.sent().content, u2 = { path: a3, name: l2.main_name || l2.secondary_name || l2.another_name, summary: l2.description, cover: this.site + "/media/" + (l2.cover.high || l2.cover.mid || l2.cover.low), status: "\u041F\u0440\u043E\u0434\u043E\u043B\u0436\u0430\u0435\u0442\u0441\u044F" === l2.status.name ? b.NovelStatus.Ongoing : b.NovelStatus.Completed }, (n2 = [null == l2 ? void 0 : l2.genres, null == l2 ? void 0 : l2.categories].flat().map(function(l3) {
                return null == l3 ? void 0 : l3.name;
              }).filter(function(l3) {
                return l3;
              })).length && (u2.genres = n2.join(",")), r = ((null === (f = null === (h = l2.branches) || void 0 === h ? void 0 : h[0]) || void 0 === f ? void 0 : f.count_chapters) || l2.count_chapters) / 100, i = (null === (y = null === (d = l2.branches) || void 0 === d ? void 0 : d[0]) || void 0 === y ? void 0 : y.id) || l2.id, o = [], s = /* @__PURE__ */ __name(function(l3) {
                var u3, b2;
                return e(this, function(e2) {
                  switch (e2.label) {
                    case 0:
                      return [4, (n3 = 1e3, new Promise(function(l4) {
                        return setTimeout(l4, n3);
                      }))];
                    case 1:
                      return e2.sent(), [4, (0, v.fetchApi)(c.site + "/api/titles/chapters/?branch_id=" + i + "&ordering=index&user_data=1&count=100&page=" + (l3 + 1)).then(function(l4) {
                        return l4.json();
                      })];
                    case 2:
                      return u3 = e2.sent(), b2 = false, u3.content.forEach(function(l4) {
                        !l4.is_paid || l4.is_bought ? o.push({ name: "\u0422\u043E\u043C " + l4.tome + " \u0413\u043B\u0430\u0432\u0430 " + l4.chapter + (l4.name ? " " + l4.name.trim() : ""), path: a3 + "/" + l4.id, releaseTime: (0, t.default)(l4.upload_date).format("LLL"), chapterNumber: l4.index }) : b2 = true;
                      }), b2 ? [2, "break"] : [2];
                  }
                  var n3;
                });
              }, "s"), c = this, p = 0, m.label = 2;
            case 2:
              return p < r ? [5, s(p)] : [3, 5];
            case 3:
      ...
      return l(this, void 0, void 0, function() {
        ...
        return e(this, function(e2) {
          switch (e2.label) {
            case 0:
              return l2 = this.site + "/api/v2/titles/chapters/" + a3.split("/")[1], [4, (0, v.fetchApi)(l2).then(function(l3) {
                return l3.json();
              })];
            case 1:
              return [2, e2.sent().content || ""];
          }
        });
      });
    }, a2.prototype.searchNovels = function(a3) {
      return l(this, arguments, void 0, function(l2, a4) {
        var u2, b2, t2, n2 = this;
        return void 0 === a4 && (a4 = 1), e(this, function(e2) {
          switch (e2.label) {
            case 0:
              return u2 = "".concat(this.site, "/api/v2/search/?query=").concat(l2, "&count=100&field=titles&page=").concat(a4), [4, (0, v.fetchApi)(u2).then(function(l3) {
                return l3.json();
              })];
            case 1:
              return b2 = e2.sent().results, t2 = [], b2.forEach(function(l3) {
                return t2.push({ name: l3.main_name || l3.secondary_name, cover: n2.site + (l3.cover.high || l3.cover.mid || l3.cover.low), path: l3.dir });
              }), [2, t2];
          }
        });
      });
