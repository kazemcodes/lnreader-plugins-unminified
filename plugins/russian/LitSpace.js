...
var LNReaderPlugin = (() => {
  ...
  // .js/plugins/russian/LitSpace.js
  init_dirname();
  init_buffer2();
  init_process2();
    ...
    function a(a2) {
      return function(l) {
        return function(a3) {
          ...
          for (; s2 && (s2 = 0, a3[0] && (i2 = 0)), i2; ) try {
            if (r2 = 1, n2 && (o2 = 2 & a3[0] ? n2.return : a3[0] ? n2.throw || ((o2 = n2.return) && o2.call(n2), 0) : n2.next) && !(o2 = o2.call(n2, a3[1])).done) return o2;
            switch (n2 = 0, o2 && (a3 = [2 & a3[0], o2.value]), a3[0]) {
              case 0:
              case 1:
                o2 = a3;
                break;
              ...
              case 5:
                i2.label++, n2 = a3[1], a3 = [0];
                continue;
              case 7:
                a3 = i2.ops.pop(), i2.trys.pop();
                continue;
              default:
                if (!(o2 = i2.trys, (o2 = o2.length > 0 && o2[o2.length - 1]) || 6 !== a3[0] && 2 !== a3[0])) {
                  i2 = 0;
                  continue;
                }
                ...
                if (6 === a3[0] && i2.label < o2[1]) {
                  i2.label = o2[1], o2 = a3;
                  break;
                }
                if (o2 && i2.label < o2[2]) {
                  i2.label = o2[2], i2.ops.push(a3);
                  break;
                }
  ...
  var r = (init_filterInputs(), __toCommonJS(filterInputs_exports)), n = (init_defaultCover(), __toCommonJS(defaultCover_exports)), o = (init_fetch2(), __toCommonJS(fetch_exports)), i = { "Content-Type": "application/json", "X-Inertia": true, "X-Inertia-Version": "6666cd76f96956469e7be39d750cc7d9" }, s = function() {
    function s2() {
      var e2 = this;
      this.id = "freedlit.space", this.name = "LitSpace", this.site = "https://freedlit.space", this.version = "1.1.0", this.icon = "src/ru/freedlit/icon.png", this.resolveUrl = function(t2, r2) {
        return e2.site + (r2 ? "/book/" : "/reader/") + t2;
      }, this.getToken = function(e3) {
        for (var t2 = 0, r2 = (e3.map["set-cookie"] || "").split("; "); t2 < r2.length; t2++) {
          var n2 = r2[t2].split("="), o2 = n2[0], s3 = n2[1];
          if ("XSRF-TOKEN" === o2) return void (i["X-XSRF-TOKEN"] = decodeURIComponent(s3));
        }
        if (!i["X-XSRF-TOKEN"]) throw new Error("Failed to find the token");
      }, this.filters = { sort: { label: "\u0421\u043E\u0440\u0442\u0438\u0440\u043E\u0432\u043A\u0430:", value: "popular", options: [{ label: "\u041F\u043E \u043F\u043E\u043F\u0443\u043B\u044F\u0440\u043D\u043E\u0441\u0442\u0438", value: "popular" }, { label: "\u043F\u043E\u0441\u043B\u0435\u0434\u043D\u0438\u0435 \u043E\u0431\u043D\u043E\u0432\u043B\u0435\u043D\u0438\u044F", value: "updated" }, { label: "\u041F\u043E \u043D\u043E\u0432\u0438\u0437\u043D\u0435", value: "recent" }, { label: "\u041F\u043E \u043F\u0440\u043E\u0441\u043C\u043E\u0442\u0440\u0430\u043C", value: "views" }, { label: "\u041F\u043E \u043A\u043E\u043B\u0438\u0447\u0435\u0441\u0442\u0432\u0443 \u043B\u0430\u0439\u043A\u043E\u0432", value: "likes" }], type: r.FilterTypes.Picker }, access: { label: "\u0414\u043E\u0441\u0442\u0443\u043F:", value: "all", options: [{ label: "\u041B\u044E\u0431\u043E\u0439 \u0434\u043E\u0441\u0442\u0443\u043F", value: "all" }, { label: "\u0411\u0435\u0441\u043F\u043B\u0430\u0442\u043D\u044B\u0435", value: "free" }, { label: "\u041F\u043B\u0430\u0442\u043D\u044B\u0435", value: "paid" }], type: r.FilterTypes.Picker }, hideAdult: { label: "\u0421\u043A\u0440\u044B\u0442\u044C 18+", value: true, type: r.FilterTypes.Switch } };
    }
    __name(s2, "s");
    return s2.prototype.popularNovels = function(r2, i2) {
      return e(this, arguments, void 0, function(e2, r3) {
        var i3, s3, a, l, u, c = this, h = r3.showLatestNovels, p = r3.filters;
        return t(this, function(t2) {
          switch (t2.label) {
            case 0:
              return i3 = this.site + "/get-books/?sort=", i3 += h ? "recent" : (null === (a = null == p ? void 0 : p.sort) || void 0 === a ? void 0 : a.value) || "popular", i3 += "&access=" + ((null === (l = null == p ? void 0 : p.access) || void 0 === l ? void 0 : l.value) || "all"), i3 += "&hideAdult=" + ((null === (u = null == p ? void 0 : p.hideAdult) || void 0 === u ? void 0 : u.value) || false), i3 += "&page=" + e2, s3 = [], [4, (0, o.fetchApi)(i3).then(function(e3) {
                return c.getToken(e3.headers), e3.json();
              })];
            case 1:
              return t2.sent().books.data.forEach(function(e3) {
                return s3.push({ name: e3.title, cover: e3.cover ? c.site + "/storage/" + e3.cover : n.defaultCover, path: e3.item_id.toString() });
              }), [2, s3];
          }
        });
      });
      ...
      return e(this, void 0, void 0, function() {
        var e2, s3, a, l, u, c, h, p, d, f, v, b = this;
        return t(this, function(t2) {
          switch (t2.label) {
            case 0:
              return [4, (0, o.fetchApi)(this.resolveUrl(r2, true), { headers: i, Referer: this.resolveUrl(r2, true) }).then(function(e3) {
                return b.getToken(e3.headers), e3.json();
              })];
            case 1:
              return e2 = t2.sent().props.book, s3 = { path: r2, name: e2.title, cover: e2.cover ? this.site + "/storage/" + e2.cover : n.defaultCover, summary: e2.annotation, author: (null === (c = null === (u = e2.authors_names) || void 0 === u ? void 0 : u[0]) || void 0 === c ? void 0 : c.name) || "", genres: (null === (f = null === (d = null === (p = null === (h = e2.tags) || void 0 === h ? void 0 : h.map) || void 0 === p ? void 0 : p.call(h, function(e3) {
                return e3.name;
              })) || void 0 === d ? void 0 : d.join) || void 0 === f ? void 0 : f.call(d, ", ")) || "" }, [4, (0, o.fetchApi)(this.site + "/api/bookpage/get-chapters", { method: "post", headers: i, Referer: this.resolveUrl(r2), body: JSON.stringify({ book_id: r2 }) }).then(function(e3) {
                return b.getToken(e3.headers), e3.json();
              })];
            case 2:
              return a = t2.sent().success, l = [], (null === (v = null == a ? void 0 : a.items) || void 0 === v ? void 0 : v.length) && a.items.forEach(function(e3, t3) {
                return l.push({ name: e3.header, path: r2 + "/" + e3.id, releaseTime: e3.first_published_formated, chapterNumber: t3 + 1 });
              }), s3.chapters = l, [2, s3];
          }
        });
      });
      ...
      return e(this, void 0, void 0, function() {
        var e2, n2, s3, a, l = this;
        return t(this, function(t2) {
          switch (t2.label) {
            case 0:
              return e2 = r2.split("/"), n2 = e2[0], s3 = e2[1], i["X-XSRF-TOKEN"] ? [3, 2] : [4, (0, o.fetchApi)(this.site).then(function(e3) {
                return l.getToken(e3.headers);
              })];
            case 1:
              t2.sent(), t2.label = 2;
            case 2:
              return [4, (0, o.fetchApi)(this.site + "/reader/get-content", { method: "post", headers: i, Referer: this.resolveUrl(r2), body: JSON.stringify({ book_id: n2, chapter_id: s3 }) }).then(function(e3) {
                return l.getToken(e3.headers), e3.json();
              })];
            case 3:
              return a = t2.sent().success, [2, a.content];
          }
        });
      });
      ...
      return e(this, void 0, void 0, function() {
        ...
        return t(this, function(t2) {
          switch (t2.label) {
            case 0:
              return [4, (0, o.fetchApi)(this.site + "/api/search?query=" + r2).then(function(e3) {
                return s3.getToken(e3.headers), e3.json();
              })];
            case 1:
              return e2 = t2.sent().success, i2 = [], (null == e2 ? void 0 : e2.length) && e2.forEach(function(e3) {
                "book" === e3.type && e3.title && i2.push({ name: e3.title, cover: e3.cover ? s3.site + "/storage/" + e3.cover : n.defaultCover, path: e3.id.toString() });
              }), [2, i2];
          }
        });
      });
