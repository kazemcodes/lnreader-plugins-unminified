...
var LNReaderPlugin = (() => {
  ...
  var e = function() {
    ...
    return new (r2 || (r2 = Promise))(function(s2, a2) {
      ...
      function c(e3) {
        var t3;
        e3.done ? s2(e3.value) : (t3 = e3.value, t3 instanceof r2 ? t3 : new r2(function(e4) {
          e4(t3);
        })).then(i2, o2);
      }
      __name(c, "c");
    ...
    function o2(o3) {
      return function(c) {
        return function(o4) {
          ...
          for (; i2 && (i2 = 0, o4[0] && (a2 = 0)), a2; ) try {
            if (r2 = 1, n2 && (s2 = 2 & o4[0] ? n2.return : o4[0] ? n2.throw || ((s2 = n2.return) && s2.call(n2), 0) : n2.next) && !(s2 = s2.call(n2, o4[1])).done) return s2;
            switch (n2 = 0, s2 && (o4 = [2 & o4[0], s2.value]), o4[0]) {
              case 0:
              case 1:
                s2 = o4;
                break;
              ...
              case 7:
                ...
                continue;
              default:
                if (!(s2 = a2.trys, (s2 = s2.length > 0 && s2[s2.length - 1]) || 6 !== o4[0] && 2 !== o4[0])) {
                  a2 = 0;
                  continue;
                }
                ...
                if (6 === o4[0] && a2.label < s2[1]) {
                  a2.label = s2[1], s2 = o4;
                  break;
                }
                if (s2 && a2.label < s2[2]) {
                  a2.label = s2[2], a2.ops.push(o4);
                  break;
                }
  ...
  Object.defineProperty(exports, "__esModule", { value: true }), exports.RanobesPlugin = void 0;
  var n = require_lib6(), s = (init_fetch2(), __toCommonJS(fetch_exports)), a = (init_novelStatus(), __toCommonJS(novelStatus_exports)), i = function() {
    function i2(e2) {
      var t2 = this;
      this.parseDate = function(e3) {
        var r2 = /* @__PURE__ */ new Date();
        if (!e3) return r2.toISOString();
        if ("ranobes-ru" === t2.id) {
          if (e3.includes(" \u0432 ")) return e3.replace(" \u0432 ", " \u0433., ");
          var n2 = e3.split(", "), s2 = n2[0], a2 = n2[1];
          if (!a2) return r2.toISOString();
          var i3 = a2.split(":"), o2 = i3[0], c = i3[1];
          switch (s2) {
            case "\u0421\u0435\u0433\u043E\u0434\u043D\u044F":
              r2.setHours(parseInt(o2, 10)), r2.setMinutes(parseInt(c, 10));
              break;
            case "\u0412\u0447\u0435\u0440\u0430":
              r2.setDate(r2.getDate() - 1), r2.setHours(parseInt(o2, 10)), r2.setMinutes(parseInt(c, 10));
              break;
            default:
              return r2.toISOString();
          }
        } else {
          var u = e3.split(" "), l = u[0], p = u[1];
          if ("ago" !== u[2]) return r2.toISOString();
          switch (p) {
            case "minutes":
              r2.setMinutes(parseInt(l, 10));
              break;
            case "hour":
            case "hours":
              r2.setHours(parseInt(l, 10));
              break;
            case "day":
            case "days":
              r2.setDate(r2.getDate() - parseInt(l, 10));
              break;
            case "month":
            case "months":
              r2.setMonth(r2.getMonth() - parseInt(l, 10));
              break;
            case "year":
            case "years":
              r2.setFullYear(r2.getFullYear() - parseInt(l, 10));
              break;
            default:
              return r2.toISOString();
          }
        ...
        return r2.toISOString();
      }, this.id = e2.id, this.name = e2.sourceName, this.icon = "multisrc/ranobes/ranobes/icon.png", this.site = e2.sourceSite, this.version = "2.0.2", this.options = e2.options;
    }
    __name(i2, "i");
    return i2.prototype.safeFecth = function(e2, n2) {
      return t(this, void 0, void 0, function() {
        var t2, a2, i3, o2, c;
        return r(this, function(r2) {
          switch (r2.label) {
            case 0:
              return [4, (0, s.fetchApi)(e2, n2)];
            case 1:
              if (!(t2 = r2.sent()).ok) throw new Error("Could not reach site (" + t2.status + ") try to open in webview.");
              return [4, t2.text()];
            case 2:
              if (a2 = r2.sent(), (i3 = null === (c = null === (o2 = a2.match(/<title>(.*?)<\/title>/)) || void 0 === o2 ? void 0 : o2[1]) || void 0 === c ? void 0 : c.trim()) && ("Bot Verification" == i3 || "You are being redirected..." == i3 || "Un instant..." == i3 || "Just a moment..." == i3 || "Redirecting..." == i3)) throw new Error("Captcha error, please open in webview");
              return [2, a2];
          }
        });
      });
    }, i2.prototype.parseNovels = function(e2) {
      var t2 = [], r2 = { name: "" }, s2 = this.site, a2 = false, i3 = false, o2 = false, c = new n.Parser({ onopentag: /* @__PURE__ */ __name(function(e3, n2) {
        var c2, u;
        (null === (c2 = n2.class) || void 0 === c2 ? void 0 : c2.includes("short-cont")) && (a2 = true), a2 && ("h2" === e3 && (null === (u = n2.class) || void 0 === u ? void 0 : u.includes("title")) && (i3 = true), i3 && "a" === e3 && (r2.path = n2.href.slice(s2.length), o2 = true), "figure" === e3 && (r2.cover = n2.style.replace(/.*url\((.*?)\)./g, "$1")), r2.path && r2.cover && (t2.push(r2), (r2 = {}).name = ""));
      }, "onopentag"), ontext: /* @__PURE__ */ __name(function(e3) {
        o2 && (r2.name += e3);
      }, "ontext"), onclosetag: /* @__PURE__ */ __name(function(e3) {
        "h2" === e3 && (o2 = false, i3 = false), "figure" === e3 && (a2 = false);
      }, "onclosetag") });
      return c.write(e2), c.end(), t2;
    }, i2.prototype.parseChapters = function(e2) {
      var t2 = this, r2 = [];
      return e2.chapters.map(function(e3) {
        r2.push({ name: e3.title, releaseTime: new Date(e3.date).toISOString(), path: e3.link.slice(t2.site.length) });
      }), r2.reverse();
    }, i2.prototype.popularNovels = function(e2) {
      return t(this, void 0, void 0, function() {
        var t2, n2;
        return r(this, function(r2) {
          switch (r2.label) {
            case 0:
              return t2 = "".concat(this.site, "/").concat(this.options.path, "/page/").concat(e2, "/"), [4, this.safeFecth(t2)];
            case 1:
      ...
      return t(this, void 0, void 0, function() {
        var t2, i3, o2, c, u, l, p, h, f, d, v, g, b, m, w, y, S, x, O, _;
        return r(this, function(r2) {
          switch (r2.label) {
            case 0:
              return t2 = this.site, [4, this.safeFecth(t2 + s2)];
            case 1:
              return i3 = r2.sent(), o2 = { path: s2, name: "", summary: "", chapters: [], totalPages: 1 }, c = false, u = false, l = false, p = false, h = false, f = false, d = false, v = false, g = false, b = false, m = false, w = [], y = [], S = {}, x = 0, O = this.parseDate, (_ = new n.Parser({ onopentag: /* @__PURE__ */ __name(function(e2, r3) {
                "poster" === r3.class && (c = true), c && "img" === e2 && (o2.name = r3.alt, o2.cover = t2 + r3.src), ("div" === e2 && "moreless cont-text showcont-h" === r3.class || "cont-text showcont-h" === r3.class && "description" === r3.itemprop) && (l = true), "li" === e2 && r3.title && (r3.title.includes("Original status") || r3.title.includes("\u0421\u0442\u0430\u0442\u0443\u0441 \u043E\u0440\u0438\u0433\u0438\u043D\u0430\u043B\u0430")) && (p = true), "a" === e2 && "chapter" === r3.rel && (g = true, S.path = r3.href.replace(t2, "")), g && "span" === e2 && "title ellipses" === r3.class && (b = true), g && "span" === e2 && "grey" === r3.class && (m = true), "li" !== e2 || "Glossary + illustrations + division of chapters, etc." != r3.title && "\u0413\u043B\u043E\u0441\u0441\u0430\u0440\u0438\u0439 + \u0438\u043B\u043B\u044E\u0441\u0442\u0440\u0430\u0446\u0438\u0439 + \u0440\u0430\u0437\u0434\u0435\u043B\u0435\u043D\u0438\u0435 \u0433\u043B\u0430\u0432 \u0438 \u0442.\u0434." !== r3.title || (v = true);
              }, "onopentag"), onopentagname: /* @__PURE__ */ __name(function(e2) {
                l && "br" === e2 && (o2.summary += "\n"), p && "a" === e2 && (h = true), f && "a" === e2 && (d = true);
              }, "onopentagname"), onattribute: /* @__PURE__ */ __name(function(e2, t3) {
                "itemprop" === e2 && "creator" === t3 && (u = true), "id" === e2 && "mc-fs-genre" === t3 && (f = true);
              }, "onattribute"), ontext: /* @__PURE__ */ __name(function(e2) {
                if (u && (o2.author = e2), l && (o2.summary += e2.trim()), h && (o2.status = "Ongoing" === e2 || "\u0412 \u043F\u0440\u043E\u0446\u0435\u0441\u0441\u0435" == e2 ? a.NovelStatus.Ongoing : a.NovelStatus.Completed), d && w.push(e2), v) {
                  var t3 = e2.replace(/\D/g, "");
                  t3 && (x = parseInt(t3, 10));
                }
                g && (b && (S.name = e2.trim()), m && (S.releaseTime = O(e2.trim())));
              }, "ontext"), onclosetag: /* @__PURE__ */ __name(function(t3) {
                "a" === t3 && (c = false, u = false, h = false, d = false, p = false), "div" === t3 && (l = false, f = false), "li" === t3 && (v = false), "a" === t3 && (g = false, S.name && (y.push(e(e({}, S), { page: "1" })), S = {})), "span" === t3 && (b && (b = false), m && (m = false));
              }, "onclosetag") })).write(i3), _.end(), o2.genres = w.join(", "), o2.totalPages = Math.ceil((x || 1) / 25), o2.chapters = y, o2.chapters[0].path && (o2.latestChapter = o2.chapters[0]), [2, o2];
          }
        });
      });
    }, i2.prototype.parsePage = function(e2, s2) {
      return t(this, void 0, void 0, function() {
        var t2, a2, i3, o2, c, u, l, p, h, f, d, v, g, b;
        return r(this, function(r2) {
          switch (r2.label) {
            case 0:
              return t2 = "ranobes" == this.id ? e2.split("-")[0] : "/" + e2.split("-").slice(1).join("-").split(".")[0], a2 = this.site + "/chapters" + t2.replace(this.options.path + "/", ""), [4, this.safeFecth(a2 + "/page/" + s2)];
            case 1:
              return i3 = r2.sent(), o2 = this.site, c = false, u = false, l = false, p = false, h = [], f = {}, d = this.parseDate, v = { pages_count: "", chapters: [] }, (g = new n.Parser({ onopentag: /* @__PURE__ */ __name(function(e3, t3) {
                "div" === e3 && "cat_block cat_line" === t3.class && (u = true), u && "a" === e3 && t3.title && t3.href && (f.name = t3.title, f.path = t3.href.replace(o2, "")), "span" === e3 && "grey small" === t3.class && (l = true), "small" === e3 && l && (p = true);
              }, "onopentag"), ontext: /* @__PURE__ */ __name(function(e3) {
                p && (f.releaseTime = d(e3.trim())), c && e3.includes("window.__DATA__ =") && (v = JSON.parse(e3.replace("window.__DATA__ =", "")));
              }, "ontext"), onclosetag: /* @__PURE__ */ __name(function(e3) {
                "a" === e3 && f.name && (h.push(f), f = {}), "div" === e3 && (u = false), "span" === e3 && (l = false), "small" === e3 && (p = false), "main" === e3 && (c = true), "script" === e3 && (c = false);
              }, "onclosetag") })).write(i3), g.end(), (null === (b = v.chapters) || void 0 === b ? void 0 : b.length) && (h = this.parseChapters(v)), [2, { chapters: h }];
          }
        });
      });
      ...
      return t(this, void 0, void 0, function() {
        ...
        return r(this, function(r2) {
          switch (r2.label) {
            case 0:
              return [4, this.safeFecth(this.site + e2)];
            case 1:
              return t2 = r2.sent(), n2 = t2.indexOf('<div class="text" id="arrticle">'), s2 = t2.indexOf('<div class="category grey ellipses">', n2), [2, t2.substring(n2, s2)];
          }
        });
      });
    }, i2.prototype.searchNovels = function(e2, n2) {
      return t(this, void 0, void 0, function() {
        var t2, s2;
        return r(this, function(r2) {
          switch (r2.label) {
            case 0:
              return "ranobes-ru" !== this.id ? [3, 2] : [4, this.safeFecth(this.site + "/index.php?do=search", { headers: { "Content-Type": "application/x-www-form-urlencoded", Referer: this.site + "/" }, method: "POST", body: new URLSearchParams({ do: "search", subaction: "search", search_start: n2.toString(), story: e2 }).toString() })];
            case 1:
              return t2 = r2.sent(), [3, 4];
            case 2:
              return s2 = "".concat(this.site, "/search/").concat(e2, "/page/").concat(n2), [4, this.safeFecth(s2)];
            case 3:
              t2 = r2.sent(), r2.label = 4;
            case 4:
              return [2, this.parseNovels(t2)];
          }
        });
      });
    }, i2;
  }();
  exports.RanobesPlugin = i;
  var o = new i({ id: "ranobes-ru", sourceSite: "https://ranobes.com", sourceName: "Ranobes (RU)", options: { lang: "Russian", path: "ranobe" } });
  exports.default = o;
})();
