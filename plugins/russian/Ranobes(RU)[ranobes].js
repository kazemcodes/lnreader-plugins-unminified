...
var LNReaderPlugin = (() => {
  ...
  var n = require_lib6(), s = (init_fetch2(), __toCommonJS(fetch_exports)), a = (init_novelStatus(), __toCommonJS(novelStatus_exports)), i = new (function() {
    ...
    __name(i2, "i");
    return i2.prototype.safeFecth = function(e2) {
      return t(this, arguments, void 0, function(e3, t2) {
        var n2, a2, i3, o, c;
        return void 0 === t2 && (t2 = {}), r(this, function(r2) {
          switch (r2.label) {
            case 0:
              return [4, (0, s.fetchApi)(e3, t2)];
            case 1:
      ...
      var t2 = [], r2 = { name: "" }, s2 = this.site, a2 = false, i3 = false, o = false, c = new n.Parser({ onopentag: /* @__PURE__ */ __name(function(e3, n2) {
        var c2, u;
        (null === (c2 = n2.class) || void 0 === c2 ? void 0 : c2.includes("short-cont")) && (a2 = true), a2 && ("h2" === e3 && (null === (u = n2.class) || void 0 === u ? void 0 : u.includes("title")) && (i3 = true), i3 && "a" === e3 && (r2.path = n2.href.slice(s2.length), o = true), "figure" === e3 && (r2.cover = n2.style.replace(/.*url\((.*?)\)./g, "$1")), r2.path && r2.cover && (t2.push(r2), (r2 = {}).name = ""));
      }, "onopentag"), ontext: /* @__PURE__ */ __name(function(e3) {
        o && (r2.name += e3);
      }, "ontext"), onclosetag: /* @__PURE__ */ __name(function(e3) {
        "h2" === e3 && (o = false, i3 = false), "figure" === e3 && (a2 = false);
      }, "onclosetag") });
      ...
      return t(this, void 0, void 0, function() {
        var t2, i3, o, c, u, l, h, p, f, d, v, g, m, b, w, y, S, O, _, I;
        return r(this, function(r2) {
          switch (r2.label) {
            case 0:
              return t2 = this.site, [4, this.safeFecth(t2 + s2)];
            case 1:
              return i3 = r2.sent(), o = { path: s2, name: "", summary: "", chapters: [], totalPages: 1 }, c = false, u = false, l = false, h = false, p = false, f = false, d = false, v = false, g = false, m = false, b = false, w = [], y = [], S = {}, O = 0, _ = this.parseDate, (I = new n.Parser({ onopentag: /* @__PURE__ */ __name(function(e2, r3) {
                "poster" === r3.class && (c = true), c && "img" === e2 && (o.name = r3.alt, o.cover = t2 + r3.src), ("div" === e2 && "moreless cont-text showcont-h" === r3.class || "cont-text showcont-h" === r3.class && "description" === r3.itemprop) && (l = true), "li" === e2 && r3.title && (r3.title.includes("Original status") || r3.title.includes("\u0421\u0442\u0430\u0442\u0443\u0441 \u043E\u0440\u0438\u0433\u0438\u043D\u0430\u043B\u0430")) && (h = true), "a" === e2 && "chapter" === r3.rel && (g = true, S.path = r3.href.replace(t2, "")), g && "span" === e2 && "title ellipses" === r3.class && (m = true), g && "span" === e2 && "grey" === r3.class && (b = true), "li" !== e2 || "Glossary + illustrations + division of chapters, etc." != r3.title && "\u0413\u043B\u043E\u0441\u0441\u0430\u0440\u0438\u0439 + \u0438\u043B\u043B\u044E\u0441\u0442\u0440\u0430\u0446\u0438\u0439 + \u0440\u0430\u0437\u0434\u0435\u043B\u0435\u043D\u0438\u0435 \u0433\u043B\u0430\u0432 \u0438 \u0442.\u0434." !== r3.title || (v = true);
              }, "onopentag"), onopentagname: /* @__PURE__ */ __name(function(e2) {
                l && "br" === e2 && (o.summary += "\n"), h && "a" === e2 && (p = true), f && "a" === e2 && (d = true);
                ...
                if (u && (o.author = e2), l && (o.summary += e2.trim()), p && (o.status = "Ongoing" === e2 || "\u0412 \u043F\u0440\u043E\u0446\u0435\u0441\u0441\u0435" == e2 ? a.NovelStatus.Ongoing : a.NovelStatus.Completed), d && w.push(e2), v) {
                  var t3 = e2.replace(/\D/g, "");
                  t3 && (O = parseInt(t3, 10));
                }
                g && (m && (S.name = e2.trim()), b && (S.releaseTime = _(e2.trim())));
              }, "ontext"), onclosetag: /* @__PURE__ */ __name(function(t3) {
                "a" === t3 && (c = false, u = false, p = false, d = false, h = false), "div" === t3 && (l = false, f = false), "li" === t3 && (v = false), "a" === t3 && (g = false, S.name && (y.push(e(e({}, S), { page: "1" })), S = {})), "span" === t3 && (m && (m = false), b && (b = false));
      ...
      return t(this, void 0, void 0, function() {
        var t2, a2, i3, o, c, u, l, h, p, f, d, v, g, m;
        return r(this, function(r2) {
          switch (r2.label) {
            case 0:
            ...
            case 1:
              return i3 = r2.sent(), o = this.site, c = false, u = false, l = false, h = false, p = [], f = {}, d = this.parseDate, v = { pages_count: "", chapters: [] }, (g = new n.Parser({ onopentag: /* @__PURE__ */ __name(function(e3, t3) {
                "div" === e3 && "cat_block cat_line" === t3.class && (u = true), u && "a" === e3 && t3.title && t3.href && (f.name = t3.title, f.path = t3.href.replace(o, "")), "span" === e3 && "grey small" === t3.class && (l = true), "small" === e3 && l && (h = true);
              }, "onopentag"), ontext: /* @__PURE__ */ __name(function(e3) {
                h && (f.releaseTime = d(e3.trim())), c && e3.includes("window.__DATA__ =") && (v = JSON.parse(e3.replace("window.__DATA__ =", "")));
              }, "ontext"), onclosetag: /* @__PURE__ */ __name(function(e3) {
                "a" === e3 && f.name && (p.push(f), f = {}), "div" === e3 && (u = false), "span" === e3 && (l = false), "small" === e3 && (h = false), "main" === e3 && (c = true), "script" === e3 && (c = false);
