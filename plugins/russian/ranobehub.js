...
var LNReaderPlugin = (() => {
  ...
  var u = (init_filterInputs(), __toCommonJS(filterInputs_exports)), v = (init_fetch2(), __toCommonJS(fetch_exports)), b = (init_novelStatus(), __toCommonJS(novelStatus_exports)), t = a(require_dayjs_min()), n = { 1: b.NovelStatus.Ongoing, 2: b.NovelStatus.Completed, 3: b.NovelStatus.OnHiatus }, i = function() {
    function a2() {
      var l2 = this;
      this.id = "RNBH.org", this.name = "RanobeHub", this.version = "1.0.3", this.site = "https://ranobehub.org", this.icon = "src/ru/ranobehub/icon.png", this.resolveUrl = function(e2) {
      ...
      return l(this, void 0, void 0, function() {
        ...
        return e(this, function(e2) {
          switch (e2.label) {
            ...
            case 1:
              return l2 = e2.sent().data, u2 = { path: a3, name: l2.names.rus || l2.names.eng || "", cover: l2.posters.medium, summary: l2.description.replace(/<br\s*\/?>/gi, "\n").replace(/<\/p>/gi, "\n\n").replace(/<[^>]+>/g, "").trim(), author: (null === (s = null === (o = null == l2 ? void 0 : l2.authors) || void 0 === o ? void 0 : o[0]) || void 0 === s ? void 0 : s.name_eng) || "", status: n[l2.status.id] || b.NovelStatus.Unknown }, i2 = [l2.tags.events, l2.tags.genres].flat().map(function(l3) {
                var e3, a4;
