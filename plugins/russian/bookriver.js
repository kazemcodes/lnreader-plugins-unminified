...
var LNReaderPlugin = (() => {
  ...
  // .js/plugins/russian/bookriver.js
  init_dirname();
  init_buffer2();
  init_process2();
  var e = function(e2, t2, a2, l2) {
    ...
    var a2, l2, i2, n2 = { label: 0, sent: /* @__PURE__ */ __name(function() {
      ...
      return function(u2) {
        return function(r4) {
          ...
          for (; o2 && (o2 = 0, r4[0] && (n2 = 0)), n2; ) try {
            if (a2 = 1, l2 && (i2 = 2 & r4[0] ? l2.return : r4[0] ? l2.throw || ((i2 = l2.return) && i2.call(l2), 0) : l2.next) && !(i2 = i2.call(l2, r4[1])).done) return i2;
  ...
  var l = (init_filterInputs(), __toCommonJS(filterInputs_exports)), i = (init_fetch2(), __toCommonJS(fetch_exports)), n = (init_novelStatus(), __toCommonJS(novelStatus_exports)), o = a(require_dayjs_min()), r = /<script id="__NEXT_DATA__" type="application\/json">(\{.*?\})<\/script>/, u = function() {
    ...
    return a2.prototype.popularNovels = function(a3, l2) {
      ...
      return e(this, void 0, void 0, function() {
        var e2, l2, u2, s, v, c, p, h, b, f;
        return t(this, function(t2) {
          switch (t2.label) {
            case 0:
              return [4, (0, i.fetchApi)(this.resolveUrl(a3, true)).then(function(e3) {
                return e3.text();
              })];
            case 1:
              return e2 = t2.sent(), l2 = { path: a3, name: "" }, (u2 = e2.match(r)) instanceof Array && u2[1] && (s = JSON.parse(u2[1]).props.pageProps.state.book.bookPage, l2.name = s.name || "", l2.cover = s.coverImages[0].url, l2.summary = s.annotation, l2.author = null === (c = s.author) || void 0 === c ? void 0 : c.name, l2.status = "writing" === (null == s ? void 0 : s.statusComplete) ? n.NovelStatus.Ongoing : n.NovelStatus.Completed, (null === (p = s.tags) || void 0 === p ? void 0 : p.length) && (l2.genres = null === (h = s.tags) || void 0 === h ? void 0 : h.map(function(e3) {
                return e3.name;
              }).join(",")), (null === (f = null === (b = null == s ? void 0 : s.ebook) || void 0 === b ? void 0 : b.chapters) || void 0 === f ? void 0 : f.length) && (v = [], s.ebook.chapters.forEach(function(e3, t3) {
                e3.available && v.push({ name: e3.name, path: a3 + "/" + e3.chapterId, releaseTime: (0, o.default)(e3.firstPublishedAt || e3.createdAt || void 0).format("LLL"), chapterNumber: t3 + 1 });
              }), l2.chapters = v)), [2, l2];
          }
        });
      });
      ...
      return e(this, void 0, void 0, function() {
        ...
        return t(this, function(t2) {
          switch (t2.label) {
            case 0:
              return e2 = this.apiSite + "books/chapter/text/", [4, (0, i.fetchApi)(e2 + a3.split("/").pop()).then(function(e3) {
                return e3.json();
              })];
            case 1:
              return l2 = t2.sent().data, n2 = l2.content || "\u041A\u043E\u043D\u0435\u0446 \u043F\u0440\u043E\u0438\u0437\u0432\u0435\u0434\u0435\u043D\u0438\u044F", (null === (o2 = null == l2 ? void 0 : l2.audio) || void 0 === o2 ? void 0 : o2.available) && (n2 += "\n" + l2.audio.url), [2, n2];
          }
        });
      });
      ...
      return e(this, arguments, void 0, function(e2, a4) {
        ...
        return void 0 === a4 && (a4 = 1), t(this, function(t2) {
          switch (t2.label) {
            case 0:
              return l2 = this.apiSite + "search/autocomplete?keyword=" + e2 + "&page=" + a4 + "&perPage=10", [4, (0, i.fetchApi)(l2).then(function(e3) {
                return e3.json();
              })];
            case 1:
              return n2 = t2.sent().data, o2 = [], null === (r2 = null == n2 ? void 0 : n2.books) || void 0 === r2 || r2.forEach(function(e3) {
                return o2.push({ name: e3.name, cover: e3.coverImages[0].url, path: e3.slug });
              }), [2, o2];
          }
        });
