...
(() => {
  ...
  var n = (init_filterInputs(), __toCommonJS(filterInputs_exports)), i = (init_defaultCover(), __toCommonJS(defaultCover_exports)), o = (init_fetch2(), __toCommonJS(fetch_exports)), a = (init_novelStatus(), __toCommonJS(novelStatus_exports)), s = (init_browser(), __toCommonJS(browser_exports)), u = r(require_dayjs_min()), c = (function() {
    function r2() {
      this.id = "RV", this.name = "Ruvers", this.site = "https://ruvers.ru/", this.version = "1.0.0", this.icon = "src/ru/ruvers/icon.png", this.popularNovels = this.fetchNovels, this.filters = { sort: { label: "\u0421\u043E\u0440\u0442\u0438\u0440\u043E\u0432\u043A\u0430", value: "-rating", options: [{ label: "\u041F\u043E \u043D\u0430\u0437\u0432\u0430\u043D\u0438\u044E", value: "name" }, { label: "\u041F\u043E \u0434\u0430\u0442\u0435 \u0434\u043E\u0431\u0430\u0432\u043B\u0435\u043D\u0438\u044F", value: "-created_at" }, { label: "\u041F\u043E \u0440\u0435\u0439\u0442\u0438\u043D\u0433\u0443", value: "-rating" }], type: n.FilterTypes.Picker } };
    }
    __name(r2, "r");
    return r2.prototype.fetchNovels = function(r3, n2, a2) {
      return t(this, arguments, void 0, (function(t2, r4, n3) {
        var a3, s2, u2, c2, l = this, h = r4.filters;
        return e(this, (function(e2) {
          switch (e2.label) {
            case 0:
              return a3 = this.site + "api/books?page=" + t2, a3 += "&sort=" + ((null === (c2 = null == h ? void 0 : h.sort) || void 0 === c2 ? void 0 : c2.value) || "-rating"), n3 && (a3 += "&search=" + n3), [4, (0, o.fetchApi)(a3).then((function(t3) {
                return t3.json();
              }))];
            case 1:
              return s2 = e2.sent().data, u2 = [], s2.forEach((function(t3) {
                return u2.push({ name: t3.name, cover: t3.images[0] ? l.site + t3.images[0] : i.defaultCover, path: t3.slug });
              })), [2, u2];
          }
        }));
      }));
      ...
      return t(this, void 0, void 0, (function() {
        var t2;
        return e(this, (function(e2) {
          return t2 = { filters: {} }, [2, this.fetchNovels(n2, t2, r3)];
        }));
      }));
      ...
      return t(this, void 0, void 0, (function() {
        ...
        return e(this, (function(e2) {
          switch (e2.label) {
            ...
            case 1:
              return t2 = e2.sent(), n2 = (0, s.load)(t2), i2 = { path: r3, name: n2("div.name > h1").text().trim(), cover: n2(".slider_prods_single > img").attr("src"), summary: n2(".book_description").text().trim(), genres: n2(".genres > a").map((function(t3, e3) {
                var r4;
                return null === (r4 = n2(e3).text()) || void 0 === r4 ? void 0 : r4.trim();
              })).get().join(","), status: n2(".status_row > div:nth-child(1) > a").text().includes("\u0412 \u0440\u0430\u0431\u043E\u0442\u0435") ? a.NovelStatus.Ongoing : a.NovelStatus.Completed }, c2 = n2("comments-list").attr("commentable-id"), [4, (0, o.fetchApi)(this.site + "api/books/" + c2 + "/chapters/all").then((function(t3) {
                return t3.json();
              }))];
            case 2:
              return (l = e2.sent()).data.length && (h = [], l.data.forEach((function(t3, e3) {
                t3.is_published && (t3.is_free || t3.purchased_by_user) && h.push({ name: "\u0413\u043B\u0430\u0432\u0430 " + t3.number + " " + (t3.name || ""), path: r3 + "/" + t3.id, releaseTime: (0, u.default)(t3.created_at).format("LLL"), chapterNumber: e3 + 1 });
              })), i2.chapters = h), [2, i2];
          }
        }));
      }));
      ...
      return t(this, void 0, void 0, (function() {
        ...
        return e(this, (function(e2) {
          switch (e2.label) {
            ...
            case 1:
              if (t2 = e2.sent(), !(n2 = null === (i2 = t2.match(/(mobile-books|books)-chapters-text-component.*:text='"(.*?)"'/s)) || void 0 === i2 ? void 0 : i2[2])) throw new Error("No chapter found");
              return [2, (a2 = n2, a2.replace(/\\u([\d\w]{4})/gi, (function(t3, e3) {
