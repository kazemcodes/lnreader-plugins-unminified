...
var LNReaderPlugin = (() => {
      ...
      !function(t2, e2) {
        ...
        var _ = function() {
          ...
          return m2.parse = function(t3) {
            ...
            var n3, o3 = b.p(t3), f2 = "set" + (this.$u ? "UTC" : ""), l3 = (n3 = {}, n3[a2] = f2 + "Date", n3[d] = f2 + "Date", n3[c] = f2 + "Month", n3[h] = f2 + "FullYear", n3[u2] = f2 + "Hours", n3[s2] = f2 + "Minutes", n3[i2] = f2 + "Seconds", n3[r2] = f2 + "Milliseconds", n3)[o3], $2 = o3 === a2 ? this.$D + (e3 - this.$W) : e3;
            if (o3 === c || o3 === h) {
  ...
  // .js/plugins/russian/ranoberf.js
  init_dirname();
  init_buffer2();
  init_process2();
  var t = function(t2, e2, r2, n2) {
    ...
    return a2.next = l2(0), a2.throw = l2(1), a2.return = l2(2), "function" == typeof Symbol && (a2[Symbol.iterator] = function() {
      return this;
    }), a2;
    function l2(l3) {
      return function(u2) {
        return function(l4) {
          ...
          for (; a2 && (a2 = 0, l4[0] && (o2 = 0)), o2; ) try {
            if (r2 = 1, n2 && (i2 = 2 & l4[0] ? n2.return : l4[0] ? n2.throw || ((i2 = n2.return) && i2.call(n2), 0) : n2.next) && !(i2 = i2.call(n2, l4[1])).done) return i2;
            switch (n2 = 0, i2 && (l4 = [2 & l4[0], i2.value]), l4[0]) {
              case 0:
              case 1:
                i2 = l4;
                break;
              ...
              case 7:
                ...
                continue;
              default:
                if (!(i2 = o2.trys, (i2 = i2.length > 0 && i2[i2.length - 1]) || 6 !== l4[0] && 2 !== l4[0])) {
                  o2 = 0;
                  continue;
                }
                ...
                if (6 === l4[0] && o2.label < i2[1]) {
                  o2.label = i2[1], i2 = l4;
                  break;
                }
                if (i2 && o2.label < i2[2]) {
                  o2.label = i2[2], o2.ops.push(l4);
                  break;
                }
  ...
  var n = (init_filterInputs(), __toCommonJS(filterInputs_exports)), i = (init_defaultCover(), __toCommonJS(defaultCover_exports)), o = (init_fetch2(), __toCommonJS(fetch_exports)), a = (init_novelStatus(), __toCommonJS(novelStatus_exports)), l = r(require_dayjs_min()), u = /<script id="__NEXT_DATA__" type="application\/json">(\{.*?\})<\/script>/, s = function() {
    function r2() {
      this.id = "RNRF", this.name = "\u0420\u0430\u043D\u043E\u0431\u044D\u0420\u0424", this.site = "https://\u0440\u0430\u043D\u043E\u0431\u044D.\u0440\u0444", this.version = "1.0.1", this.icon = "src/ru/ranoberf/icon.png", this.filters = { sort: { label: "\u0421\u043E\u0440\u0442\u0438\u0440\u043E\u0432\u043A\u0430", value: "popular", options: [{ label: "\u0420\u0435\u0439\u0442\u0438\u043D\u0433", value: "popular" }, { label: "\u0414\u0430\u0442\u0435 \u0434\u043E\u0431\u0430\u0432\u043B\u0435\u043D\u0438\u044F", value: "new" }, { label: "\u0414\u0430\u0442\u0435 \u043E\u0431\u043D\u043E\u0432\u043B\u0435\u043D\u0438\u044F", value: "lastPublishedChapter" }, { label: "\u0417\u0430\u043A\u043E\u043D\u0447\u0435\u043D\u043D\u044B\u0435", value: "completed" }], type: n.FilterTypes.Picker } };
    }
    __name(r2, "r");
    return r2.prototype.popularNovels = function(r3, n2) {
      return t(this, arguments, void 0, function(t2, r4) {
        var n3, a2, l2, s2, c, p, h, v, f, d = this, b = r4.showLatestNovels, m = r4.filters;
        return e(this, function(e2) {
          switch (e2.label) {
            case 0:
              return n3 = this.site + "/books?order=", n3 += b ? "lastPublishedChapter" : (null === (p = null == m ? void 0 : m.sort) || void 0 === p ? void 0 : p.value) || "popular", n3 += "&page=" + t2, [4, (0, o.fetchApi)(n3).then(function(t3) {
                return t3.text();
              })];
            case 1:
              return a2 = e2.sent(), l2 = [], (s2 = a2.match(u)) instanceof Array && s2[1] && (c = JSON.parse(s2[1]), null === (f = null === (v = null === (h = c.props.pageProps) || void 0 === h ? void 0 : h.totalData) || void 0 === v ? void 0 : v.items) || void 0 === f || f.forEach(function(t3) {
                var e3;
                return l2.push({ name: t3.title, cover: (null === (e3 = null == t3 ? void 0 : t3.verticalImage) || void 0 === e3 ? void 0 : e3.url) ? d.site + t3.verticalImage.url : i.defaultCover, path: "/" + t3.slug });
              })), [2, l2];
          }
        });
      });
      ...
      return t(this, void 0, void 0, function() {
        var t2, n2, s2, c, p, h, v, f;
        return e(this, function(e2) {
          switch (e2.label) {
            case 0:
              return [4, (0, o.fetchApi)(this.site + r3).then(function(t3) {
                return t3.text();
              })];
            case 1:
              return t2 = e2.sent(), n2 = { path: r3, name: "" }, (s2 = t2.match(u)) instanceof Array && s2[1] && (c = JSON.parse(s2[1]).props.pageProps.book, n2.name = c.title, n2.summary = c.description, n2.cover = (null === (h = c.verticalImage) || void 0 === h ? void 0 : h.url) ? this.site + c.verticalImage.url : i.defaultCover, n2.status = (null == c ? void 0 : c.additionalInfo.includes("\u0410\u043A\u0442\u0438\u0432\u0435\u043D")) ? a.NovelStatus.Ongoing : a.NovelStatus.Completed, c.author && (n2.author = c.author), (null === (v = c.genres) || void 0 === v ? void 0 : v.length) && (n2.genres = null == c ? void 0 : c.genres.map(function(t3) {
                return t3.title;
              }).join(",")), (null === (f = c.chapters) || void 0 === f ? void 0 : f.length) && (p = [], c.chapters.forEach(function(t3, e3) {
                t3.isDonate && !t3.isUserPaid || p.push({ name: t3.title, path: t3.url, releaseTime: (0, l.default)(t3.publishedAt).format("LLL"), chapterNumber: c.chapters.length - e3 });
              }), n2.chapters = p.reverse())), [2, n2];
          }
        });
      });
    }, r2.prototype.parseChapter = function(r3) {
      return t(this, void 0, void 0, function() {
        var t2, n2, i2, a2, l2, s2, c;
        return e(this, function(e2) {
          switch (e2.label) {
            case 0:
              return [4, (0, o.fetchApi)(this.site + r3).then(function(t3) {
            ...
            case 1:
              return t2 = e2.sent(), (n2 = t2.match(u)) instanceof Array && n2[1] ? [2, (null === (c = null === (s2 = null === (l2 = null === (a2 = null === (i2 = JSON.parse(n2[1])) || void 0 === i2 ? void 0 : i2.props) || void 0 === a2 ? void 0 : a2.pageProps) || void 0 === l2 ? void 0 : l2.chapter) || void 0 === s2 ? void 0 : s2.content) || void 0 === c ? void 0 : c.text) || ""] : [2, ""];
          }
        });
      });
    }, r2.prototype.searchNovels = function(r3) {
      return t(this, void 0, void 0, function() {
        var t2, n2, a2, l2 = this;
        return e(this, function(e2) {
          switch (e2.label) {
            case 0:
              return t2 = "".concat(this.site, "/v3/books?filter[or][0][title][like]=").concat(r3, "&filter[or][1][titleEn][like]=").concat(r3, "&filter[or][2][fullTitle][like]=").concat(r3, "&filter[status][]=active&filter[status][]=abandoned&filter[status][]=completed&expand=verticalImage"), [4, (0, o.fetchApi)(t2).then(function(t3) {
                return t3.json();
              })];
            case 1:
              return n2 = e2.sent().items, a2 = [], n2.forEach(function(t3) {
                var e3;
                return a2.push({ name: t3.title, cover: (null === (e3 = null == t3 ? void 0 : t3.verticalImage) || void 0 === e3 ? void 0 : e3.url) ? l2.site + t3.verticalImage.url : i.defaultCover, path: "/" + t3.slug });
              }), [2, a2];
          }
        });
      });
