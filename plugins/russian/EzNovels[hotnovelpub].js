      ...
      return function(s) {
        return (function(l3) {
          ...
          for (; i && (i = 0, l3[0] && (r2 = 0)), r2; ) try {
            if (n2 = 1, a2 && (o2 = 2 & l3[0] ? a2.return : l3[0] ? a2.throw || ((o2 = a2.return) && o2.call(a2), 0) : a2.next) && !(o2 = o2.call(a2, l3[1])).done) return o2;
            switch (a2 = 0, o2 && (l3 = [2 & l3[0], o2.value]), l3[0]) {
              case 0:
              case 1:
                o2 = l3;
                break;
  ...
  var n = (init_fetch2(), __toCommonJS(fetch_exports)), a = (init_filterInputs(), __toCommonJS(filterInputs_exports)), o = (init_novelStatus(), __toCommonJS(novelStatus_exports)), r = new ((function() {
    ...
    return a2.prototype.popularNovels = function(a3, o2) {
      return e(this, arguments, void 0, (function(e2, a4) {
        var o3, r2, i, l, s, u, c = this, h = a4.filters, p = a4.showLatestNovels;
        return t(this, (function(t2) {
          switch (t2.label) {
            case 0:
              return o3 = this.apiSite + "/books/", o3 += p ? "new" : (null === (l = null == h ? void 0 : h.sort) || void 0 === l ? void 0 : l.value) || "hot", (null === (s = null == h ? void 0 : h.category) || void 0 === s ? void 0 : s.value) && (o3 = this.apiSite + "/category/" + h.category.value), o3 += "/?page=" + (e2 - 1) + "&limit=20", [4, (0, n.fetchApi)(o3, { headers: { lang: this.lang } }).then((function(e3) {
                return e3.json();
              }))];
            case 1:
