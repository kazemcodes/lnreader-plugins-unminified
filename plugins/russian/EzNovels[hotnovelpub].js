...
var LNReaderPlugin = (() => {
  ...
  // .js/plugins/russian/EzNovels[hotnovelpub].js
  init_dirname();
  init_buffer2();
  init_process2();
  var e = function(e2, t2, n2, o2) {
    return new (n2 || (n2 = Promise))(function(a2, r2) {
      ...
      __name(s, "s");
      s((o2 = o2.apply(e2, t2 || [])).next());
    });
  }, t = function(e2, t2) {
    var n2, o2, a2, r2 = { label: 0, sent: /* @__PURE__ */ __name(function() {
    ...
    function l(l2) {
      return function(s) {
        return function(l3) {
          ...
          for (; i && (i = 0, l3[0] && (r2 = 0)), r2; ) try {
            if (n2 = 1, o2 && (a2 = 2 & l3[0] ? o2.return : l3[0] ? o2.throw || ((a2 = o2.return) && a2.call(o2), 0) : o2.next) && !(a2 = a2.call(o2, l3[1])).done) return a2;
            switch (o2 = 0, a2 && (l3 = [2 & l3[0], a2.value]), l3[0]) {
              case 0:
              case 1:
                a2 = l3;
                break;
              ...
              case 5:
                r2.label++, o2 = l3[1], l3 = [0];
                continue;
              case 7:
                l3 = r2.ops.pop(), r2.trys.pop();
                continue;
              default:
                if (!(a2 = r2.trys, (a2 = a2.length > 0 && a2[a2.length - 1]) || 6 !== l3[0] && 2 !== l3[0])) {
                  r2 = 0;
                  continue;
                }
                ...
                if (6 === l3[0] && r2.label < a2[1]) {
                  r2.label = a2[1], a2 = l3;
                  break;
                }
                if (a2 && r2.label < a2[2]) {
                  r2.label = a2[2], r2.ops.push(l3);
                  break;
                }
  ...
  var n = (init_fetch2(), __toCommonJS(fetch_exports)), o = (init_novelStatus(), __toCommonJS(novelStatus_exports)), a = function() {
    function a2(e2) {
      var t2, n2 = this;
    ...
    __name(a2, "a");
    return a2.prototype.popularNovels = function(o2, a3) {
      return e(this, arguments, void 0, function(e2, o3) {
        var a4, r2, i, l, s, u, c = this, h = o3.filters, v = o3.showLatestNovels;
        return t(this, function(t2) {
          switch (t2.label) {
            case 0:
              return a4 = this.apiSite + "/books/", a4 += v ? "new" : (null === (l = null == h ? void 0 : h.sort) || void 0 === l ? void 0 : l.value) || "hot", (null === (s = null == h ? void 0 : h.category) || void 0 === s ? void 0 : s.value) && (a4 = this.apiSite + "/category/" + h.category.value), a4 += "/?page=" + (e2 - 1) + "&limit=20", [4, (0, n.fetchApi)(a4, { headers: { lang: this.lang } }).then(function(e3) {
                return e3.json();
              })];
            case 1:
              return r2 = t2.sent(), i = [], r2.status && (null === (u = r2.data.books.data) || void 0 === u ? void 0 : u.length) && r2.data.books.data.forEach(function(e3) {
                return i.push({ name: e3.name, cover: c.site + e3.image, path: e3.slug });
              }), [2, i];
          }
        });
      });
      ...
      return e(this, void 0, void 0, function() {
        ...
        return t(this, function(t2) {
          switch (t2.label) {
            case 0:
              return [4, (0, n.fetchApi)(this.apiSite + "/book/" + a3, { headers: { lang: this.lang } }).then(function(e3) {
                return e3.json();
              })];
            case 1:
              return e2 = t2.sent(), r2 = { name: e2.data.book.name, path: a3, cover: this.site + e2.data.book.image, summary: e2.data.book.authorize.description, author: e2.data.book.authorize.name, status: "updating" === e2.data.book.status ? o.NovelStatus.Ongoing : o.NovelStatus.Completed }, (null === (l = e2.data.tags.tags_name) || void 0 === l ? void 0 : l.length) && (r2.genres = e2.data.tags.tags_name.join(",")), (null === (s = e2.data.chapters) || void 0 === s ? void 0 : s.length) && (i = [], e2.data.chapters.forEach(function(e3, t3) {
                return i.push({ name: e3.title, path: e3.slug, releaseTime: void 0, chapterNumber: (e3.index || t3) + 1 });
              }), r2.chapters = i), [2, r2];
          }
        });
      });
      ...
      return e(this, void 0, void 0, function() {
        ...
        return t(this, function(t2) {
          switch (t2.label) {
            case 0:
              return [4, (0, n.fetchApi)(this.resolveUrl(o2)).then(function(e3) {
                return e3.text();
              })];
            case 1:
              return e2 = t2.sent(), (a3 = (null === (i = e2.match(/<div id="content-item" ([\s\S]*?)<\/div>/)) || void 0 === i ? void 0 : i[0]) || "") ? [4, (0, n.fetchApi)(this.site + "/server/getContent?slug=" + o2)] : [3, 4];
            case 2:
              return [4, t2.sent().json()];
            case 3:
              (r2 = t2.sent()).data && (a3 += r2.data.map(function(e3) {
                return "<p>" + e3 + "</p>";
              }).join("").replace(/\n/g, "</p><p>").replace(/\s/g, " ")), t2.label = 4;
            case 4:
              return [2, a3.replace(/\.copy right hot novel pub/g, "")];
          }
        });
      });
    }, a2.prototype.searchNovels = function(o2) {
      return e(this, void 0, void 0, function() {
        var e2, a3, r2;
        return t(this, function(t2) {
          switch (t2.label) {
            case 0:
              return [4, (0, n.fetchApi)(this.apiSite + "/search", { headers: { "Content-Type": "application/json;charset=utf-8", Referer: this.site, Origin: this.site, lang: this.lang }, method: "POST", body: JSON.stringify({ key_search: o2 }) }).then(function(e3) {
                return e3.json();
              })];
            case 1:
              return e2 = t2.sent(), a3 = [], e2.status && (null === (r2 = e2.data.books) || void 0 === r2 ? void 0 : r2.length) && e2.data.books.forEach(function(e3) {
                return a3.push({ name: e3.name, path: e3.slug });
              }), [2, a3];
          }
        });
      });
