...
var LNReaderPlugin = function () {
  ...
  // .js/plugins/vietnamese/LNHako.js
  init_dirname();
  init_buffer2();
  init_process2();
  ...
  (function (ParseNovelAction2) {
    ParseNovelAction2["Unknown"] = "Unknown";
    ParseNovelAction2["GetName"] = "GetName";
    ParseNovelAction2["GetSummary"] = "GetSummary";
    ParseNovelAction2["GetInfos"] = "GetInfos";
    ParseNovelAction2["GetGenres"] = "GetGenres";
    ParseNovelAction2["GetCover"] = "GetCover";
    ParseNovelAction2["GetVolumes"] = "GetVolumes";
  })(ParseNovelAction || (ParseNovelAction = {}));
  var HakoPlugin = /** @class */
  function () {
    function HakoPlugin2() {
      this.id = "ln.hako";
      this.name = "Hako";
    ...
    __name(HakoPlugin2, "HakoPlugin");
    HakoPlugin2.prototype.parseNovels = function (url) {
      return (0, fetch_1.fetchApi)(url).then(function (res) {
        return res.text();
      }).then(function (html) {
        var novels = [];
        var tempNovel = {};
    ...
    HakoPlugin2.prototype.popularNovels = function (pageNo, _a) {
    ...
    HakoPlugin2.prototype.parseNovel = function (novelPath) {
      var novel = {
        path: novelPath,
        name: "",
        author: "",
      ...
      var getNameHandler = {
        isDone: false,
        isStarted: false,
        onopentag: /* @__PURE__ */__name(function (name) {
          if (name === "a") {
            this.isStarted = true;
          }
        }, "onopentag"),
        ...
        onclosetag: /* @__PURE__ */__name(function () {
          if (this.isStarted) {
            this.isDone = true;
          }
        }, "onclosetag")
      ...
      var InfoItem;
      (function (InfoItem2) {
        InfoItem2[InfoItem2["Author"] = 0] = "Author";
        InfoItem2[InfoItem2["Artist"] = 1] = "Artist";
        InfoItem2[InfoItem2["Status"] = 2] = "Status";
        InfoItem2[InfoItem2["Unknown"] = 3] = "Unknown";
      })(InfoItem || (InfoItem = {}));
      var getInfosHandler = {
        isStarted: false,
      ...
      var getChapterListHandler = {
        ...
        ontext: /* @__PURE__ */__name(function (data) {
          if (this.readingTime) {
            var chapterTime = data.split("/").map(function (x) {
              return Number(x);
            });
      ...
      return (0, fetch_1.fetchApi)(this.site + novelPath).then(function (res) {
        return res.text();
      }).then(function (html) {
        var _a, _b, _c;
        var parser = new htmlparser2_1.Parser({
          onopentag: /* @__PURE__ */__name(function (name, attributes) {
            var _a2, _b2, _c2;
            (_a2 = parseNovelRouter.onopentag) === null || _a2 === void 0 ? void 0 : _a2.call(parseNovelRouter, name, attributes);
            if (parseNovelRouter.action) {
              (_c2 = (_b2 = parseNovelRouter.handlers[parseNovelRouter.action]) === null || _b2 === void 0 ? void 0 : _b2.onopentag) === null || _c2 === void 0 ? void 0 : _c2.call(_b2, name, attributes);
            }
          }, "onopentag"),
          ontext: /* @__PURE__ */__name(function (data) {
            var _a2, _b2;
            if (parseNovelRouter.action) {
              (_b2 = (_a2 = parseNovelRouter.handlers[parseNovelRouter.action]) === null || _a2 === void 0 ? void 0 : _a2.ontext) === null || _b2 === void 0 ? void 0 : _b2.call(_a2, data);
            }
          }, "ontext"),
          onclosetag: /* @__PURE__ */__name(function (name, isImplied) {
            var _a2, _b2, _c2;
            if (parseNovelRouter.action) {
              (_b2 = (_a2 = parseNovelRouter.handlers[parseNovelRouter.action]) === null || _a2 === void 0 ? void 0 : _a2.onclosetag) === null || _b2 === void 0 ? void 0 : _b2.call(_a2, name, isImplied);
            }
            (_c2 = parseNovelRouter.onclosetag) === null || _c2 === void 0 ? void 0 : _c2.call(parseNovelRouter, name, isImplied);
          }, "onclosetag")
        });
        parser.write(html);
        parser.end();
    ...
    HakoPlugin2.prototype.parseChapter = function (chapterPath) {
      return (0, fetch_1.fetchApi)(this.site + chapterPath).then(function (res) {
        return res.text();
      }).then(function (html) {
        var _a;
        return ((_a = html.match(/(<div id="chapter-content".+?>[^]+)<div style="text-align: center;/)) === null || _a === void 0 ? void 0 : _a[1]) || "Kh\xF4ng t\xECm th\u1EA5y n\u1ED9i dung";
      });
    };
    HakoPlugin2.prototype.searchNovels = function (searchTerm, pageNo) {
