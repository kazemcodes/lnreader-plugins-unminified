...
(() => {
  ...
  // .js/plugins/french/noveldeglace.js
  ...
  var a = (init_browser(), __toCommonJS(browser_exports)), r = (init_fetch2(), __toCommonJS(fetch_exports)), n = (init_novelStatus(), __toCommonJS(novelStatus_exports)), i = (init_filterInputs(), __toCommonJS(filterInputs_exports)), l = (init_defaultCover(), __toCommonJS(defaultCover_exports)), o = (function() {
    function o2() {
      this.id = "noveldeglace", this.name = "NovelDeGlace", this.icon = "src/fr/noveldeglace/icon.png", this.site = "https://noveldeglace.com/", this.version = "1.0.4", this.filters = { categorie_genre: { type: i.FilterTypes.Picker, label: "Cat\xE9gorie/Genre", value: "all", options: [{ label: "Tous", value: "all" }, { label: "\u2550\u2550\u2550CAT\xC9GORIES\u2550\u2550\u2550", value: "categorie_roman" }, { label: "Autre", value: "c_autre" }, { label: "Fille", value: "c_fille" }, { label: "Original", value: "c_original" }, { label: "Roman pour Adulte", value: "c_roman-pour-adulte" }, { label: "Seinen", value: "c_seinen" }, { label: "Shonen", value: "c_shonen" }, { label: "Xuanhuan", value: "c_xuanhuan" }, { label: "Yaoi", value: "c_yaoi" }, { label: "Yuri", value: "c_yuri" }, { label: "\u2550\u2550\u2550GENRES\u2550\u2550\u2550", value: "genre" }, { label: "Action", value: "g_action" }, { label: "Adulte", value: "g_adulte" }, { label: "Anti-H\xE9ros", value: "g_anti-heros" }, { label: "Arts Martiaux", value: "g_arts-martiaux" }, { label: "Aventure", value: "g_aventure" }, { label: "Com\xE9die", value: "g_comedie" }, { label: "Drame", value: "g_drame" }, { label: "Ecchi", value: "g_ecchi" }, { label: "Fantastique", value: "g_fantastique" }, { label: "Harem", value: "g_harem" }, { label: "Horreur", value: "g_horreur" }, { label: "Insectes", value: "g_insectes" }, { label: "Lolicon", value: "g_lolicon" }, { label: "Mature", value: "g_mature" }, { label: "Mecha", value: "g_mecha" }, { label: "Myst\xE8re", value: "g_mystere" }, { label: "Pas de harem", value: "g_pas-de-harem" }, { label: "Psychologique", value: "g_psychologique" }, { label: "Romance", value: "g_romance" }, { label: "Sci-fi", value: "g_sci-fi" }, { label: "Science-Fiction", value: "g_science-fiction" }, { label: "Shotacon", value: "g_shotacon" }, { label: "Shoujo Ai", value: "g_shoujo-ai" }, { label: "Smut", value: "g_smut" }, { label: "Surnaturel", value: "g_surnaturel" }, { label: "Trag\xE9die", value: "g_tragedie" }, { label: "Tranche de vie", value: "g_tranche-de-vie" }, { label: "Vie scolaire", value: "g_vie-scolaire" }, { label: "Xuanhuan", value: "g_xuanhuan" }] } };
    }
    __name(o2, "o");
    return o2.prototype.getCheerio = function(n2) {
      return e(this, void 0, void 0, (function() {
        var e2, i2;
        return t(this, (function(t2) {
          switch (t2.label) {
            case 0:
              return [4, (0, r.fetchApi)(n2, { headers: { "Accept-Encoding": "deflate" } })];
            case 1:
              return (e2 = t2.sent()).ok ? [4, e2.text()] : [2, void 0];
            case 2:
              return i2 = t2.sent(), [2, (0, a.load)(i2)];
          }
        }));
      }));
    }, o2.prototype.parseNovels = function(e2, t2) {
      var a2 = this, r2 = [];
      return e2("article").each((function(n2, i2) {
        var l2, o3 = e2(i2), u = o3.find("h2").text().trim(), s = o3.find("img").attr("src");
        if (l2 = t2 ? o3.find("span.Roman > a").attr("href") : o3.find("h2 > a").attr("href")) {
          var c = { name: u, path: l2.replace(a2.site, ""), cover: s };
          r2.push(c);
        }
      })), r2;
    }, o2.prototype.popularNovels = function(a2, r2) {
      return e(this, arguments, void 0, (function(e2, a3) {
        var r3, n2, i2, l2 = a3.filters, o3 = a3.showLatestNovels;
        return t(this, (function(t2) {
          switch (t2.label) {
            case 0:
              if (r3 = this.site, o3) r3 += "chapitre";
              else if (n2 = "all", l2 && "string" == typeof l2.categorie_genre.value && (n2 = l2.categorie_genre.value), "all" != n2 && "categorie_roman" != n2 && "genre" != n2) "c" == n2[0] ? r3 += "categorie_roman/" + n2.substring(2) : "g" == n2[0] && (r3 += "genre/" + n2.substring(2));
              else {
                if (e2 > 1) return [2, []];
                r3 += "roman";
              }
              return r3 += "/page/" + e2, [4, this.getCheerio(r3)];
            case 1:
              return (i2 = t2.sent()) ? [2, this.parseNovels(i2, o3)] : [2, []];
          }
        }));
      }));
    }, o2.prototype.parseNovel = function(a2) {
      return e(this, void 0, void 0, (function() {
        var e2, r2, i2, o3, u, s, c, h, v, f, p, g;
        return t(this, (function(t2) {
          switch (t2.label) {
            case 0:
              return [4, this.getCheerio(this.site + a2)];
            case 1:
              if (!(e2 = t2.sent())) throw new Error("Failed to load page (open in web view)");
              switch ((r2 = { path: a2, name: "Untitled" }).name = (null === (g = null === (p = e2("div.entry-content > div > strong")[0].nextSibling) || void 0 === p ? void 0 : p.nodeValue) || void 0 === g ? void 0 : g.trim()) || "Untitled", r2.cover = e2(".su-row > div > div > img").attr("src") || l.defaultCover, (i2 = e2("div[data-title=Tomes] >").toArray()).pop(), i2.shift(), r2.summary = e2("div[data-title=Synopsis]").text().trim() + "\n\n" + i2.map((function(t3) {
                return e2(t3).text();
              })).join("\n").trim(), r2.author = e2("strong:contains('Auteur :')").parent().text().replace("Auteur : ", "").trim(), r2.artist = e2("strong:contains('Illustrateur :')").parent().text().replace("Illustrateur :", "").trim(), o3 = e2(".categorie").text().replace("Cat\xE9gorie :", "").trim(), u = e2(".genre").text().replace("Genre :", "").replace(/, /g, ",").trim(), o3 && "Autre" != o3 && (r2.genres = o3), u && (r2.genres = r2.genres ? r2.genres + "," + u : u), e2("strong:contains('Statut :')").parent().attr("class")) {
                case "type etat0":
                case "type etat1":
                ...
                case "type etat5":
                  ...
                  break;
                case "type etat6":
                  r2.status = n.NovelStatus.Cancelled;
                  break;
                default:
                  r2.status = n.NovelStatus.Unknown;
              }
              return s = [], c = e2("div[data-title=Tomes] > div").last().contents(), h = c.length > 1, v = "", f = this.site, c.each((function(t3, a3) {
                h && (v = "T." + (t3 + 1) + " "), e2(a3).find(".chpt").each((function(t4, a4) {
                  var r3, n2, i3, l2 = e2(a4), o4 = v + l2.find("a").first().text().trim() || "";
                  if (l2.find("i.fa").length) {
                    var u2 = (null === (i3 = l2.find("i").parent().next().html()) || void 0 === i3 ? void 0 : i3.split("</a>")) || [];
                    null == u2 || u2.shift();
                    var c2 = [];
                    null == u2 || u2.forEach((function(e3) {
                      c2.push(e3.substring(e3.indexOf("(") + 1, e3.indexOf(")")));
                    }));
                    var h2 = [];
                    l2.find("i").parent().next().find("a").each((function() {
                      h2.push(this.attribs.href);
                    })), c2.length == h2.length && c2.forEach((function(e3, a5) {
                      var r4 = { name: o4 + " (" + (a5 + 1) + ")", releaseTime: e3, path: h2[a5].replace(f, ""), chapterNumber: t4 + (a5 + 1) / 1e3 };
                      s.push(r4);
                    }));
                  } else {
                    var p2 = (null === (r3 = l2.html()) || void 0 === r3 ? void 0 : r3.substring((null === (n2 = l2.html()) || void 0 === n2 ? void 0 : n2.indexOf("</a>")) || 0)) || "", g2 = (null == p2 ? void 0 : p2.substring(p2.indexOf("(") + 1, p2.indexOf(")"))) || void 0, d = l2.find("a").attr("href");
                    if (d) {
                      var b = { name: o4, releaseTime: g2, path: d.replace(f, ""), chapterNumber: t4 };
                      s.push(b);
                    }
                  }
                }));
      ...
      return e(this, void 0, void 0, (function() {
        ...
        return t(this, (function(t2) {
          switch (t2.label) {
            ...
            case 1:
              if (!(e2 = t2.sent())) throw new Error("Failed to load page (open in web view)");
              return e2(".mistape_caption").remove(), [2, e2(".chapter-content").html() || e2(".entry-content").html() || ""];
          }
        }));
      }));
      ...
      return e(this, void 0, void 0, (function() {
        ...
        return t(this, (function(t2) {
          switch (t2.label) {
            case 0:
              return 1 !== r2 ? [2, []] : (e2 = this.site + "roman", [4, this.getCheerio(e2)]);
            case 1:
              if (!(n2 = t2.sent())) throw new Error("Failed to load page (open in web view)");
              return [2, this.parseNovels(n2, false).filter((function(e3) {
                return e3.name.toLowerCase().normalize("NFD").replace(/[\u0300-\u036f]/g, "").trim().includes(a2.toLowerCase().normalize("NFD").replace(/[\u0300-\u036f]/g, "").trim());
              }))];
          }
        }));
      }));
