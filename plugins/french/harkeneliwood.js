...
(() => {
  ...
  // .js/plugins/french/harkeneliwood.js
  ...
  var r = (init_browser(), __toCommonJS(browser_exports)), i = (init_fetch2(), __toCommonJS(fetch_exports)), o = (init_defaultCover(), __toCommonJS(defaultCover_exports)), s = (init_novelStatus(), __toCommonJS(novelStatus_exports)), a = n(require_dayjs_min()), u = (function() {
    function n2() {
      this.id = "harkeneliwood", this.name = "HarkenEliwood", this.icon = "src/fr/harkeneliwood/icon.png", this.site = "https://harkeneliwood.wordpress.com", this.version = "1.0.0";
    }
    __name(n2, "n");
    return n2.prototype.getCheerio = function(n3) {
      return t(this, void 0, void 0, (function() {
        ...
        return e(this, (function(e2) {
          switch (e2.label) {
            case 0:
              return [4, (0, i.fetchApi)(n3, { headers: { "Accept-Encoding": "deflate" } })];
            case 1:
    ...
    }, n2.prototype.popularNovels = function(n3) {
      return t(this, void 0, void 0, (function() {
        var t2, r2, i2, s2, a2 = this;
        return e(this, (function(e2) {
          switch (e2.label) {
            case 0:
              return n3 > 1 ? [2, []] : (t2 = [], i2 = this.site, [4, this.getCheerio(i2 + "/projets/")]);
            case 1:
              return (s2 = e2.sent())("#content .entry-content [href]").not('[rel="nofollow noopener noreferrer"]').each((function(e3, n4) {
                var i3 = s2(n4).text().trim(), u2 = s2(n4).attr("href");
                u2 && i3 && (r2 = { name: i3, cover: o.defaultCover, path: u2.replace(a2.site, "") }, t2.push(r2));
              })), [2, t2];
          }
        }));
      }));
      ...
      return t(this, void 0, void 0, (function() {
        var t2, r2, i2, u2 = this;
        return e(this, (function(e2) {
          switch (e2.label) {
            case 0:
              return t2 = { path: n3, name: "Sans titre" }, [4, this.getCheerio(this.site + n3)];
            case 1:
              return r2 = e2.sent(), t2.name = r2("#content h1.entry-title").text().trim(), t2.cover = r2("#content .entry-content p img").first().attr("src") || o.defaultCover, t2.summary = this.getSummary(r2("#content .entry-content").text()), t2.author = this.getAuthor(r2("#content .entry-content").text()), t2.status = s.NovelStatus.Ongoing, i2 = [], r2("#content .entry-content p a").each((function(t3, e3) {
                var n4 = r2(e3).text().trim(), o2 = r2(e3).attr("href");
                if (o2 && o2.includes(u2.site) && n4) {
                  var s2 = (0, a.default)(null == o2 ? void 0 : o2.substring(u2.site.length + 1, u2.site.length + 11)).format("DD MMMM YYYY");
                  i2.push({ name: n4, path: o2.replace(u2.site, ""), releaseTime: s2 });
                }
              })), t2.chapters = i2, [2, t2];
          }
        }));
      }));
    }, n2.prototype.getSummary = function(t2) {
      var e2 = "", n3 = /([\s\S]*)Raw :/i, r2 = /Synopsis :([\s\S]*)Traduction anglaise/i.exec(t2), i2 = /Synopsis :([\s\S]*)Raw :/i.exec(t2), o2 = /Synopsis 1 :([\s\S]*)Synopsis 2 :([\s\S]*)Raw :/i.exec(t2), s2 = /Synopsis :([\s\S]*)Prélude/i.exec(t2), a2 = /Synospis :([\s\S]*)Original /i.exec(t2);
      if (e2 = null !== r2 ? r2[1] : null !== i2 ? i2[1] : null !== o2 ? o2[1] + o2[2] : null !== s2 ? s2[1] : null !== a2 ? a2[1] : t2, n3.test(e2)) {
        var u2 = n3.exec(e2);
        null !== u2 && (e2 = u2[1]);
      }
      return e2.trim();
    }, n2.prototype.getAuthor = function(t2) {
      var e2 = /Auteur\s*:\s*(.*?)\s*(?:\r?\n|$)/i.exec(t2);
      return null !== e2 && "" !== e2[1].trim() ? e2[1].trim() : "";
      ...
      return t(this, void 0, void 0, (function() {
        ...
        return e(this, (function(e2) {
          switch (e2.label) {
            case 0:
              return [4, this.getCheerio(this.site + n3)];
            case 1:
              return t2 = e2.sent(), r2 = t2("h1.entry-title"), i2 = t2("div.entry-content"), [2, (r2.html() || "") + (i2.html() || "")];
          }
        }));
      }));
    }, n2.prototype.searchNovels = function(n3, r2) {
      return t(this, void 0, void 0, (function() {
          ...
          switch (t2.label) {
            ...
            case 1:
              return [2, t2.sent().filter((function(t3) {
                return t3.name.toLowerCase().normalize("NFD").replace(/[\u0300-\u036f]/g, "").trim().includes(n3.toLowerCase().normalize("NFD").replace(/[\u0300-\u036f]/g, "").trim());
              }))];
          }
        }));
      }));
