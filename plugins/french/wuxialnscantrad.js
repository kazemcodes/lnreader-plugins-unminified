...
(() => {
      ...
      !(function(t2, e2) {
        ...
        var _ = (function() {
          ...
          return m2.parse = function(t3) {
            ...
            var n3, o3 = b.p(t3), f2 = "set" + (this.$u ? "UTC" : ""), l2 = (n3 = {}, n3[a2] = f2 + "Date", n3[d] = f2 + "Date", n3[c] = f2 + "Month", n3[h] = f2 + "FullYear", n3[u2] = f2 + "Hours", n3[s2] = f2 + "Minutes", n3[i2] = f2 + "Seconds", n3[r2] = f2 + "Milliseconds", n3)[o3], $3 = o3 === a2 ? this.$D + (e3 - this.$W) : e3;
            if (o3 === c || o3 === h) {
  ...
  // .js/plugins/french/wuxialnscantrad.js
  var t = function(t2, e2, r2, n2) {
    ...
    var r2, n2, i2, s2 = { label: 0, sent: /* @__PURE__ */ __name(function() {
    ...
    function u2(u3) {
      return function(a2) {
        return (function(u4) {
          ...
          for (; o2 && (o2 = 0, u4[0] && (s2 = 0)), s2; ) try {
            if (r2 = 1, n2 && (i2 = 2 & u4[0] ? n2.return : u4[0] ? n2.throw || ((i2 = n2.return) && i2.call(n2), 0) : n2.next) && !(i2 = i2.call(n2, u4[1])).done) return i2;
            switch (n2 = 0, i2 && (u4 = [2 & u4[0], i2.value]), u4[0]) {
              ...
              case 7:
                ...
                continue;
              default:
                if (!(i2 = s2.trys, (i2 = i2.length > 0 && i2[i2.length - 1]) || 6 !== u4[0] && 2 !== u4[0])) {
                  s2 = 0;
                  continue;
                }
                if (3 === u4[0] && (!i2 || u4[1] > i2[0] && u4[1] < i2[3])) {
                  s2.label = u4[1];
                  break;
                }
                if (6 === u4[0] && s2.label < i2[1]) {
                  s2.label = i2[1], i2 = u4;
                  break;
                }
                if (i2 && s2.label < i2[2]) {
  ...
  var n = (init_browser(), __toCommonJS(browser_exports)), i = (init_fetch2(), __toCommonJS(fetch_exports)), s = (init_defaultCover(), __toCommonJS(defaultCover_exports)), o = (init_novelStatus(), __toCommonJS(novelStatus_exports)), u = r(require_dayjs_min()), a = (function() {
    function r2() {
      this.id = "wuxialnscantrad", this.name = "WuxiaLnScantrad", this.icon = "src/fr/wuxialnscantrad/icon.png", this.site = "https://wuxialnscantrad.wordpress.com", this.version = "1.0.0";
    }
    __name(r2, "r");
    return r2.prototype.getCheerio = function(r3) {
      return t(this, void 0, void 0, (function() {
        var t2;
        return e(this, (function(e2) {
          switch (e2.label) {
            case 0:
              return [4, (0, i.fetchApi)(r3, { headers: { "Accept-Encoding": "deflate" } })];
            case 1:
              return [4, e2.sent().text()];
            case 2:
              return t2 = e2.sent(), [2, (0, n.load)(t2)];
          }
        }));
      }));
    }, r2.prototype.popularNovels = function(r3) {
      return t(this, void 0, void 0, (function() {
        var t2, n2, i2, o2, u2 = this;
        return e(this, (function(e2) {
          switch (e2.label) {
            case 0:
              return r3 > 1 ? [2, []] : (t2 = [], i2 = this.site, [4, this.getCheerio(i2)]);
            case 1:
              return (o2 = e2.sent())("#menu-item-2210 ul li").each((function(e3, r4) {
                var i3 = o2(r4).first().text().trim(), a2 = o2(r4).find("a").attr("href");
                a2 && i3 && (n2 = { name: i3, cover: s.defaultCover, path: a2.replace(u2.site, "") }, t2.push(n2));
              })), [2, t2];
          }
        }));
      }));
      ...
      return t(this, void 0, void 0, (function() {
        var t2, n2, i2, s2, o2, a2 = this;
        return e(this, (function(e2) {
          switch (e2.label) {
            case 0:
              return t2 = { path: r3, name: "Sans titre" }, [4, this.getCheerio(this.site + r3)];
            case 1:
              return n2 = e2.sent(), t2.name = n2(".entry-title").text().trim(), t2.cover = n2(".entry-content p strong img").first().attr("src") || n2(".entry-content p img").first().attr("src"), i2 = n2(".entry-content").text(), t2.author = this.getAuthor(i2), t2.genres = this.getGenres(i2), t2.artist = this.getArtist(i2), t2.summary = this.getSummary(i2), t2.status = this.getStatus(i2), s2 = n2(".entry-content ul").first().children("li"), o2 = [], s2.each((function(t3, e3) {
                var r4 = n2(e3).text().trim(), i3 = n2(e3).find("a").attr("href");
                if (i3 && i3.includes(a2.site) && r4) {
                  var s3 = i3.replace(a2.site, "");
                  if (!o2.some((function(t4) {
                    return t4.path === s3;
                  }))) {
                    var c = (0, u.default)(null == i3 ? void 0 : i3.substring(a2.site.length + 1, a2.site.length + 11)).format("DD MMMM YYYY");
                    o2.push({ name: r4, path: s3, releaseTime: c });
                  }
                }
              })), t2.chapters = o2, [2, t2];
          }
    ...
    }, r2.prototype.getAuthor = function(t2) {
      var e2 = /Auteur\(s\):\s*(.*)/.exec(t2), r3 = "";
      return null !== e2 && (r3 = e2[1].trim()), r3;
    }, r2.prototype.getGenres = function(t2) {
      var e2 = /Genres:\s*(.*)/.exec(t2), r3 = "";
      return null !== e2 && (r3 = e2[1].trim()), r3;
    }, r2.prototype.getArtist = function(t2) {
      var e2 = /Artiste\(s\):\s*(.*)Genres/.exec(t2), r3 = "";
      return null !== e2 && (r3 = e2[1].trim()), r3;
    }, r2.prototype.getSummary = function(t2) {
      for (var e2 = 0, r3 = [/Synopsis :([\s\S]*)Chapitres disponibles/, /Sypnopsis([\s\S]*)Sypnopsis officiel/, /Synopsis([\s\S]*)Chapitres disponibles/]; e2 < r3.length; e2++) {
        var n2 = r3[e2].exec(t2);
        if (null !== n2) return n2[1].trim();
      }
      return "";
    }, r2.prototype.getStatus = function(t2) {
      var e2 = /Statut:\s*(.*)/.exec(t2), r3 = "";
      switch (null !== e2 && (r3 = e2[1].trim()), r3) {
        case "En cours":
        default:
          return o.NovelStatus.Ongoing;
        case "Arr\xEAt\xE9":
          return o.NovelStatus.Cancelled;
        case "Termin\xE9":
          return o.NovelStatus.Completed;
      }
      ...
      return t(this, void 0, void 0, (function() {
        ...
        return e(this, (function(e2) {
          switch (e2.label) {
            case 0:
              return [4, this.getCheerio(this.site + r3)];
            case 1:
              return t2 = e2.sent(), n2 = "", t2(".entry-content").contents().each((function() {
                var e3, r4, i2, s2;
                if (null === (e3 = t2(this).html()) || void 0 === e3 ? void 0 : e3.includes("<script")) return false;
                (null === (r4 = t2(this).html()) || void 0 === r4 ? void 0 : r4.includes('data-attachment-id="480')) || (null === (i2 = t2.html(this)) || void 0 === i2 ? void 0 : i2.includes("<hr>")) || (null === (s2 = t2.html(this)) || void 0 === s2 ? void 0 : s2.includes("<p>&nbsp;</p>")) || (n2 += t2.html(this));
              })), [2, n2];
          }
        }));
      }));
          ...
          switch (t2.label) {
            ...
            case 1:
              return [2, t2.sent().filter((function(t3) {
                return t3.name.toLowerCase().normalize("NFD").replace(/[\u0300-\u036f]/g, "").trim().includes(r3.toLowerCase().normalize("NFD").replace(/[\u0300-\u036f]/g, "").trim());
              }))];
          }
        }));
      }));
