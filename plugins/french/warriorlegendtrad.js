...
(() => {
  ...
  // .js/plugins/french/warriorlegendtrad.js
  ...
  var n = (init_browser(), __toCommonJS(browser_exports)), i = (init_fetch2(), __toCommonJS(fetch_exports)), a = (init_defaultCover(), __toCommonJS(defaultCover_exports)), s = (init_novelStatus(), __toCommonJS(novelStatus_exports)), o = r(require_dayjs_min()), u = (function() {
    function r2() {
      this.id = "warriorlegendtrad", this.name = "Warrior Legend Trad", this.icon = "src/fr/warriorlegendtrad/icon.png", this.site = "https://warriorlegendtrad.wordpress.com", this.version = "1.0.1", this.regexAuthors = [/Auteur\u00A0:([^\n]*)/], this.regexGenres = [/Genre :([^\n]*)/], this.regexSummary = [/Synopsis\u00A0:([\s\S]*)index chapitre :/i];
    }
    __name(r2, "r");
    return r2.prototype.getCheerio = function(r3) {
      return e(this, void 0, void 0, (function() {
        ...
        return t(this, (function(t2) {
          switch (t2.label) {
            case 0:
              return [4, (0, i.fetchApi)(r3)];
            case 1:
              return [4, t2.sent().text()];
            case 2:
              return e2 = t2.sent(), [2, (0, n.load)(e2)];
          }
        }));
      }));
    }, r2.prototype.popularNovels = function(r3) {
      return e(this, void 0, void 0, (function() {
        var e2, n2, i2, s2, o2 = this;
        return t(this, (function(t2) {
          switch (t2.label) {
            case 0:
              return r3 > 2 ? [2, []] : (e2 = [], i2 = 1 === r3 ? this.site + "/light-novel" : this.site + "/crea", [4, this.getCheerio(i2)]);
            case 1:
              return (s2 = t2.sent())("div div div article").each((function(t3, r4) {
                var i3 = s2(r4).find(".entry-wrapper h2").first().text().trim(), u2 = s2(r4).find(".entry-wrapper h2 a").attr("href"), c = s2(r4).find("figure a img").attr("src") || a.defaultCover;
                u2 && i3 && (n2 = { name: i3, cover: c, path: u2.replace(o2.site, "") }, e2.push(n2));
              })), [2, e2];
          }
        }));
      }));
      ...
      return e(this, void 0, void 0, (function() {
        var e2, n2, i2, s2, u2 = this;
        return t(this, (function(t2) {
          switch (t2.label) {
            case 0:
              return e2 = { path: r3, name: "Sans titre" }, [4, this.getCheerio(this.site + r3)];
            case 1:
              return n2 = t2.sent(), e2.name = n2(".site-main article header h1").text().trim(), e2.cover = n2(".site-main article figure img").first().attr("src") || a.defaultCover, i2 = n2(".entry-content").text(), e2.author = this.extractInfo(i2, this.regexAuthors), e2.genres = this.extractInfo(i2, this.regexGenres), e2.summary = this.extractInfo(i2, this.regexSummary), e2.status = this.getStatus(i2), s2 = [], n2("div div article div").find("h2 a, h3 a").each((function(e3, t3) {
                var r4 = n2(t3).text().trim(), i3 = n2(t3).attr("href"), a2 = (0, o.default)(null == i3 ? void 0 : i3.substring(u2.site.length + 1, u2.site.length + 11)).format("DD MMMM YYYY");
                i3 && i3.includes(u2.site) && r4 && s2.push({ name: r4, path: i3.replace(u2.site, ""), releaseTime: a2 });
              })), e2.chapters = s2.sort((function(e3, t3) {
                if (!e3.releaseTime) return 1;
                if (!t3.releaseTime) return -1;
                var r4 = new Date(e3.releaseTime).getTime() - new Date(t3.releaseTime).getTime();
                return 0 === r4 ? e3.name.localeCompare(t3.name) : r4;
              })), [2, e2];
          }
        }));
      }));
    }, r2.prototype.extractInfo = function(e2, t2) {
      for (var r3 = 0, n2 = t2; r3 < n2.length; r3++) {
        var i2 = n2[r3].exec(e2);
        if (null !== i2) return i2[1].trim();
      }
      return "";
    }, r2.prototype.getStatus = function(e2) {
      var t2 = this.extractInfo(e2, [/État sur le site :([^\n]*)/i, /état sur le site:([^\n]*)/i]);
      return t2.includes("en cours") ? s.NovelStatus.Ongoing : t2.includes("en pause") ? s.NovelStatus.OnHiatus : t2.includes("termin\xE9") ? s.NovelStatus.Completed : t2.includes("abandonn\xE9") ? s.NovelStatus.Cancelled : s.NovelStatus.Ongoing;
      ...
      return e(this, void 0, void 0, (function() {
        ...
        return t(this, (function(t2) {
          switch (t2.label) {
            ...
            case 1:
              return e2 = t2.sent(), n2 = "", e2(".entry-content").contents().each((function() {
                var t3, r4, i2;
                (null === (t3 = e2.html(this)) || void 0 === t3 ? void 0 : t3.startsWith("<div")) || (null === (r4 = e2.html(this)) || void 0 === r4 ? void 0 : r4.startsWith("<hr")) || (null === (i2 = e2.html(this)) || void 0 === i2 ? void 0 : i2.includes("<script")) || (n2 += e2.html(this));
              })), [2, n2];
          }
        }));
      }));
          ...
          switch (e2.label) {
            ...
            case 1:
              return [2, e2.sent().filter((function(e3) {
                return e3.name.toLowerCase().normalize("NFD").replace(/[\u0300-\u036f]/g, "").trim().includes(r3.toLowerCase().normalize("NFD").replace(/[\u0300-\u036f]/g, "").trim());
              }))];
          }
        }));
      }));
