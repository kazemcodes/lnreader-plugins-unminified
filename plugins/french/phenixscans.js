...
(() => {
  ...
  // .js/plugins/french/phenixscans.js
      ...
      return function(u2) {
        return (function(o4) {
          ...
          for (; i2 && (i2 = 0, o4[0] && (n2 = 0)), n2; ) try {
            if (t2 = 1, l2 && (r2 = 2 & o4[0] ? l2.return : o4[0] ? l2.throw || ((r2 = l2.return) && r2.call(l2), 0) : l2.next) && !(r2 = r2.call(l2, o4[1])).done) return r2;
  ...
  var l = (init_browser(), __toCommonJS(browser_exports)), r = (init_fetch2(), __toCommonJS(fetch_exports)), n = (init_filterInputs(), __toCommonJS(filterInputs_exports)), i = (init_defaultCover(), __toCommonJS(defaultCover_exports)), o = (init_novelStatus(), __toCommonJS(novelStatus_exports)), u = t(require_dayjs_min()), s = (function() {
    function t2() {
      this.id = "phenixscans", this.name = "PhenixScans", this.icon = "src/fr/phenixscans/icon.png", this.site = "https://phenixscans.fr", this.version = "1.0.1", this.filters = { genre: { type: n.FilterTypes.CheckboxGroup, label: "Genre", value: [], options: [{ label: "Action", value: "action" }, { label: "Action Adventure Fantaisie Psychologique", value: "action-adventure-fantaisie-psychologique" }, { label: "Action Arts martiaux Aventure Fantastique Surnaturel", value: "action-arts-martiaux-aventure-fantastique-surnaturel" }, { label: "Action Aventure Fantastique", value: "action-aventure-fantastique" }, { label: "Action Drame Sh\xF4nen", value: "action-drame-shonen" }, { label: "Adult", value: "adult" }, { label: "Adventure", value: "adventure" }, { label: "amiti\xE9", value: "amitie" }, { label: "amour", value: "amour" }, { label: "Art-martiaux", value: "art-martiaux" }, { label: "Arts-martiaux", value: "arts-martiaux" }, { label: "Aventure", value: "aventure" }, { label: "Combat", value: "combat" }, { label: "Comedie", value: "comedie" }, { label: "Comedy", value: "comedy" }, { label: "Demons", value: "demons" }, { label: "Dragon", value: "dragon" }, { label: "Drama", value: "drama" }, { label: "Drame", value: "drame" }, { label: "Ecchi", value: "ecchi" }, { label: "Fantaisie", value: "fantaisie" }, { label: "fantastique", value: "fantastique" }, { label: "Fantasy", value: "fantasy" }, { label: "Ghosts", value: "ghosts" }, { label: "Harem", value: "harem" }, { label: "Historical", value: "historical" }, { label: "Historique", value: "historique" }, { label: "Horreur", value: "horreur" }, { label: "Horror", value: "horror" }, { label: "Isekai", value: "isekai" }, { label: "Josei", value: "josei" }, { label: "longstrip art", value: "longstrip-art" }, { label: "Magic", value: "magic" }, { label: "Magie", value: "magie" }, { label: "Male Protagonist", value: "male-protagonist" }, { label: "manga", value: "manga" }, { label: "Manhwa", value: "manhwa" }, { label: "Manhwa Player", value: "manhwa-player" }, { label: "Manwha", value: "manwha" }, { label: "Martial Arts", value: "martial-arts" }, { label: "Mature", value: "mature" }, { label: "Monstre", value: "monstre" }, { label: "Murim", value: "murim" }, { label: "myst\xE8re", value: "mystere" }, { label: "Mystery", value: "mystery" }, { label: "Necromancien", value: "necromancien" }, { label: "necromencer", value: "necromencer" }, { label: "Novel", value: "novel" }, { label: "One Shot", value: "one-shot" }, { label: "Over Power MC", value: "over-power-mc" }, { label: "Partenaire", value: "partenaire" }, { label: "Player", value: "player" }, { label: "Player Manhwa", value: "player-manhwa" }, { label: "Portail", value: "portail" }, { label: "Psychological", value: "psychological" }, { label: "Psychologique", value: "psychologique" }, { label: "regresseur", value: "regresseur" }, { label: "r\xE9gression", value: "regression" }, { label: "R\xE9incarnation", value: "reincarnation" }, { label: "Returner", value: "returner" }, { label: "Romance", value: "romance" }, { label: "School Life", value: "school-life" }, { label: "Sci-fi", value: "sci-fi" }, { label: "Seinen", value: "seinen" }, { label: "Sh\xF4jo", value: "shojo" }, { label: "Sh\xF4nen", value: "shonen" }, { label: "Shotacon", value: "shotacon" }, { label: "Shoujo", value: "shoujo" }, { label: "Shounen", value: "shounen" }, { label: "Slice of Life", value: "slice-of-life" }, { label: "Slide of Life", value: "slide-of-life" }, { label: "Smut", value: "smut" }, { label: "Sports", value: "sports" }, { label: "Supernatural", value: "supernatural" }, { label: "Surnaturel", value: "surnaturel" }, { label: "Syst\xE8me", value: "systeme" }, { label: "Trag\xE9die", value: "tragedie" }, { label: "Tragedy", value: "tragedy" }, { label: "Webtoons", value: "webtoons" }] } };
    }
    __name(t2, "t");
    return t2.prototype.getCheerio = function(t3) {
      return e(this, void 0, void 0, (function() {
        var e2;
        return a(this, (function(a2) {
          switch (a2.label) {
            case 0:
              return [4, (0, r.fetchApi)(t3)];
            case 1:
              return [4, a2.sent().text()];
            case 2:
              return e2 = a2.sent(), [2, (0, l.load)(e2)];
          }
        }));
      }));
    }, t2.prototype.popularNovels = function(t3, l2) {
      return e(this, arguments, void 0, (function(e2, t4) {
        var l3, r2, n2, o2, u2, s2, c, v, h, b, p = this, f = t4.showLatestNovels, m = t4.filters;
        return a(this, (function(a2) {
          switch (a2.label) {
            case 0:
              for (o2 in l3 = [], n2 = "", m) if ("object" == typeof m[o2].value) for (u2 = 0, s2 = m[o2].value; u2 < s2.length; u2++) c = s2[u2], n2 += "&genre%5B%5D=".concat(c);
              return v = f ? "update" : "popular", h = "".concat(this.site, "/manga/?page=").concat(e2).concat(n2, "&status=&type=novel&order=").concat(v), [4, this.getCheerio(h)];
            case 1:
              return (b = a2.sent())("div div div div a").each((function(e3, a3) {
                var t5, n3 = null === (t5 = b(a3).attr("title")) || void 0 === t5 ? void 0 : t5.trim(), o3 = b(a3).attr("href"), u3 = b(a3).find("div img").attr("src") || i.defaultCover;
                o3 && n3 && (r2 = { name: n3, cover: u3, path: o3.replace(p.site, "") }, l3.push(r2));
              })), [2, l3];
          }
        }));
      }));
      ...
      return e(this, void 0, void 0, (function() {
        var e2, l2, r2, n2 = this;
        return a(this, (function(a2) {
          switch (a2.label) {
            case 0:
              return e2 = { path: t3, name: "Sans titre" }, [4, this.getCheerio(this.site + t3)];
            case 1:
              return l2 = a2.sent(), e2.name = l2("h1[itemprop=name]").text().replace("\u2013 Novel", "").trim(), e2.cover = l2("div[itemprop=image] img").first().attr("src") || i.defaultCover, e2.author = l2(".fmed b:contains(Auteur)+span").text().trim(), e2.genres = l2(".mgen a").map((function() {
                return l2(this).text();
              })).get().join(", "), e2.summary = l2(".entry-content[itemprop=description]").text().trim(), e2.status = this.getStatus(l2(".tsinfo .imptdt:contains(Statut)").text().replace("Statut", "").trim()), r2 = [], l2("ul li:has(div.chbox):has(div.eph-num)").each((function(e3, a3) {
                var t4 = l2(a3).find("a .chapternum").text().trim(), i2 = l2(a3).find("a").attr("href"), o2 = n2.parseDate(l2(a3).find("a .chapterdate").text());
                i2 && i2.includes(n2.site) && t4 && r2.push({ name: t4, path: i2.replace(n2.site, ""), releaseTime: o2 });
              })), e2.chapters = r2, [2, e2];
          }
        }));
      }));
    }, t2.prototype.parseDate = function(e2) {
      var a2 = e2.split(" "), t3 = a2[0], l2 = a2[1], r2 = a2[2];
      return (0, u.default)("".concat(t3, " ").concat({ janvier: 1, fevrier: 2, mars: 3, avril: 4, mai: 5, juin: 6, juillet: 7, aout: 8, septembre: 9, octobre: 10, novembre: 11, decembre: 12 }[l2.normalize("NFD").replace(/[\u0300-\u036f]/g, "")], " ").concat(r2), "D MMMM YYYY").format("DD MMMM YYYY");
    }, t2.prototype.getStatus = function(e2) {
      var a2 = e2.toLowerCase();
      return ["en cours", "en cours de publication"].includes(a2) ? o.NovelStatus.Ongoing : ["en pause", "en attente"].includes(a2) ? o.NovelStatus.OnHiatus : ["compl\xE9t\xE9", "fini", "achev\xE9", "termin\xE9"].includes(a2) ? o.NovelStatus.Completed : ["abandonn\xE9"].includes(a2) ? o.NovelStatus.Cancelled : o.NovelStatus.Unknown;
    }, t2.prototype.parseChapter = function(t3) {
      return e(this, void 0, void 0, (function() {
        return a(this, (function(e2) {
          switch (e2.label) {
            case 0:
              return [4, this.getCheerio(this.site + t3)];
            case 1:
              return [2, e2.sent()("#readerarea").html() || ""];
          }
        }));
      }));
      ...
      return e(this, void 0, void 0, (function() {
        return a(this, (function(e2) {
          switch (e2.label) {
            case 0:
              return 1 !== l2 ? [2, []] : [4, this.popularNovels(1, { showLatestNovels: true, filters: void 0 })];
            case 1:
              return [2, e2.sent().filter((function(e3) {
                return e3.name.toLowerCase().normalize("NFD").replace(/[\u0300-\u036f]/g, "").trim().includes(t3.toLowerCase().normalize("NFD").replace(/[\u0300-\u036f]/g, "").trim());
              }))];
          }
        }));
      }));
