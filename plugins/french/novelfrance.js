...
var LNReaderPlugin = (() => {
  ...
  var a = (init_fetch2(), __toCommonJS(fetch_exports)), r = (init_novelStatus(), __toCommonJS(novelStatus_exports)), n = (init_filterInputs(), __toCommonJS(filterInputs_exports)), l = (init_defaultCover(), __toCommonJS(defaultCover_exports)), i = 24, o = function() {
    function o2() {
      var e2 = this;
      this.id = "novelfrance", this.name = "NovelFrance", this.icon = "src/fr/novelfrance/icon.png", this.site = "https://novelfrance.fr/", this.version = "1.0.0", this.resolveUrl = function(t2) {
      ...
      return e(this, void 0, void 0, function() {
        ...
        return t(this, function(t2) {
          switch (t2.label) {
            ...
            case 1:
              for (e2 = t2.sent(), r2 = e2.title || "", n2 = [], r2 && n2.push("<h1>".concat(this.escapeHtml(r2), "</h1>")), l2 = 0, i2 = e2.paragraphs || []; l2 < i2.length; l2++) o3 = i2[l2], r2 && 0 === o3.index || (u = (o3.content || "").trim()) && n2.push("<p>".concat(this.escapeHtml(u), "</p>"));
              return [2, n2.join("")];
          }
        });
      });
