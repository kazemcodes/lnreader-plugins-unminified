...
var LNReaderPlugin = (() => {
  ...
  var e = function(e2, t2, a2, l2) {
    ...
    var a2, l2, s2, i2 = { label: 0, sent: /* @__PURE__ */ __name(function() {
      ...
      return e(this, void 0, void 0, function() {
        ...
        return t(this, function(t2) {
          switch (t2.label) {
            ...
            case 1:
              return s2 = t2.sent(), n2 = { path: a2, name: "", genres: "", summary: "", author: "", artist: "", status: "", chapters: [] }, u3 = false, c = false, v = 0, h = false, p = false, d = false, b = false, f = false, m = false, g = false, y = 0, w = false, k = false, x = [], C = {}, N = this.hideLocked, S = new l.Parser({ onopentag: /* @__PURE__ */ __name(function(t3, a3) {
                var l2;
              ...
              }, "onclosetag") }), S.write(s2), S.end(), x.length && ((null === (j = this.options) || void 0 === j ? void 0 : j.reverseChapters) && x.reverse(), n2.chapters = x), n2.summary = n2.summary.trim(), [2, n2];
          }
        });
      });
