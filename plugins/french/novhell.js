...
(() => {
  ...
  var r = (init_browser(), __toCommonJS(browser_exports)), n = (init_fetch2(), __toCommonJS(fetch_exports)), i = (init_defaultCover(), __toCommonJS(defaultCover_exports)), o = (init_novelStatus(), __toCommonJS(novelStatus_exports)), a = (function() {
    function a2() {
      this.id = "novhell", this.name = "Novhell", this.icon = "src/fr/novhell/icon.png", this.site = "https://novhell.org", this.version = "1.0.1";
    }
    __name(a2, "a");
    return a2.prototype.getCheerio = function(i2) {
      ...
      return e(this, void 0, void 0, (function() {
        var e2, n2, i2, o2, a3 = this;
        return t(this, (function(t2) {
          switch (t2.label) {
            case 0:
              return r2 > 1 ? [2, []] : (e2 = [], i2 = this.site, [4, this.getCheerio(i2)]);
            case 1:
              return (o2 = t2.sent())("article div div div figure").each((function(t3, r3) {
                var i3 = o2(r3).find("figcaption span strong").first().text().trim();
                i3 && "" !== i3.trim() || (i3 = o2(r3).find("figcaption a strong").first().text().trim());
                var c = o2(r3).find("a img").attr("src"), s = o2(r3).find("a").attr("href");
                s && i3 && (n2 = { name: i3, cover: c, path: s.replace(a3.site, "") }, e2.push(n2));
              })), [2, e2];
          }
        }));
      }));
      ...
      return e(this, void 0, void 0, (function() {
        var e2, n2, a3, c, s = this;
        return t(this, (function(t2) {
          switch (t2.label) {
            case 0:
              return e2 = { path: r2, name: "Sans titre" }, [4, this.getCheerio(this.site + r2)];
            case 1:
              return n2 = t2.sent(), e2.name = (null === (c = n2('meta[property="og:title"]').attr("content")) || void 0 === c ? void 0 : c.replace("- NovHell", "")) || "", e2.cover = n2("section div div div div div img").first().attr("src") || i.defaultCover, e2.status = o.NovelStatus.Ongoing, e2.author = n2("strong:contains('Ecrit par ')").parent().text().replace("Ecrit par ", "").trim(), e2.author || (e2.author = n2("div p:contains('Auteur')").text().replace("Auteur", "").replace(":", "").trim()), e2.author || (e2.author = n2("div p:contains('Ecrit par :')").text().replace("Ecrit par :", "").trim()), e2.genres = n2("strong:contains('Genre')").parent().text().replace("Genre", "").replace(":", "").trim(), e2.genres || (e2.genres = n2("div p:contains('Genre')").text().replace("Genre", "").replace(":", "").trim()), e2.summary = n2("strong:contains('Synopsis')").parent().parent().text().replace("Synopsis", "").replace("Synopsis", "").replace(":", "").trim(), a3 = [], n2("main div article div div section div div div div div p a").each((function(e3, t3) {
                var r3 = n2(t3).text().replace(/\u00A0/g, " ").trim(), i2 = n2(t3).attr("href");
                if (i2 && i2.includes(s.site)) {
                  for (var o2 = /Chapitre (\d+)/g, c2 = 0, u = void 0; null !== (u = o2.exec(r3)); ) {
                    c2 += parseInt(u[1]);
                  }
                  a3.push({ name: r3, path: i2.replace(s.site, ""), chapterNumber: c2 });
                }
              })), e2.chapters = a3.sort((function(e3, t3) {
      ...
      return e(this, void 0, void 0, (function() {
        var e2, n2, i2, o2, a3, c, s;
        return t(this, (function(t2) {
          switch (t2.label) {
            case 0:
              return [4, this.getCheerio(this.site + r2)];
            case 1:
              if (e2 = t2.sent(), n2 = e2("main article div div section")) {
                for (i2 = n2.length, o2 = void 0, a3 = 2, c = 3; c <= 5; c++) if (0 !== (o2 = n2.eq(i2 - c)).find("h4").length) {
                  a3 = c - 1;
                  break;
                }
                if (s = n2.eq(i2 - a3), o2 && s) return [2, (o2.html() || "") + (s.html() || "")];
              }
              return [2, ""];
          }
        }));
