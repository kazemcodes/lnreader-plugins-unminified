...
var LNReaderPlugin = (() => {
  ...
  // .js/plugins/french/rezerowebnovelfr.js
  init_dirname();
  init_buffer2();
  init_process2();
  ...
  var r = (init_browser(), __toCommonJS(browser_exports)), n = (init_fetch2(), __toCommonJS(fetch_exports)), i = (init_novelStatus(), __toCommonJS(novelStatus_exports)), o = { "/histoire-principale/": { name: "Re:Zero - Histoire Principale", summary: "Histoire principale de Re:Zero traduite en fran\xE7ais." }, "/histoires-annexes/": { name: "Re:Zero - Histoires Annexes", summary: "Histoires annexes (Side Stories) de Re:Zero traduites en fran\xE7ais." }, "/if-stories/": { name: "Re:Zero - IF Stories", summary: "Histoires alternatives (IF Stories) de Re:Zero traduites en fran\xE7ais." } }, a = "https://rezerowebnovelfr.wordpress.com/wp-content/uploads/2021/03/sans-titre-1.png";
  function s(e2) {
    var t2 = parseInt(e2, 10);
    return isNaN(t2) ? e2.toUpperCase() : function(e3) {
      for (var t3 = "", r2 = e3, n2 = 0, i2 = [[100, "C"], [90, "XC"], [50, "L"], [40, "XL"], [10, "X"], [9, "IX"], [5, "V"], [4, "IV"], [1, "I"]]; n2 < i2.length; n2++) for (var o2 = i2[n2], a2 = o2[0], s2 = o2[1]; r2 >= a2; ) t3 += s2, r2 -= a2;
      return t3;
    }(t2);
  }
  __name(s, "s");
  var c = function() {
    function c2() {
      this.id = "rezerowebnovelfr", this.name = "Re:Zero Web Novel FR", this.icon = "src/fr/rezerowebnovelfr/icon.png", this.site = "https://rezerowebnovelfr.wordpress.com", this.version = "1.0.0";
    }
    __name(c2, "c");
    return c2.prototype.getCheerio = function(i2) {
      return e(this, void 0, void 0, function() {
        var e2;
        return t(this, function(t2) {
          switch (t2.label) {
            case 0:
              return [4, (0, n.fetchApi)(i2, { headers: { "Accept-Encoding": "deflate" } })];
            case 1:
    ...
    }, c2.prototype.popularNovels = function(r2) {
      return e(this, void 0, void 0, function() {
        return t(this, function(e2) {
          return r2 > 1 ? [2, []] : [2, Object.entries(o).map(function(e3) {
            var t2 = e3[0];
            return { name: e3[1].name, cover: a, path: t2 };
          })];
        });
      });
    }, c2.prototype.parseNovel = function(r2) {
      return e(this, void 0, void 0, function() {
        var n2, c3, u, l, h, f, p, v, d, m, y, b, w, g, x, N, C, I, R, L = this;
        return t(this, function(S) {
          switch (S.label) {
            case 0:
              return n2 = { path: r2, name: "Sans titre" }, [4, this.getCheerio(this.site + r2)];
            case 1:
              return c3 = S.sent(), n2.name = c3("h1.entry-title").text().trim(), n2.author = "Tappei Nagatsuki", n2.status = i.NovelStatus.Ongoing, (u = o[r2]) && (n2.name = u.name, n2.cover = a, n2.summary = u.summary), l = [], h = /* @__PURE__ */ __name(function(e2, t2, n3) {
                if (void 0 === n3 && (n3 = ""), e2 && e2.includes(L.site)) {
                  var i2 = e2.split("?")[0], o2 = i2.match(/\/(\d{4})\/(\d{2})\/(\d{2})\//);
                  if (o2 && t2) {
                    var a2 = i2.replace(L.site, "");
                    if (!l.some(function(e3) {
                      return e3.path === a2;
                    })) {
                      var s2 = "".concat(o2[1], "-").concat(o2[2], "-").concat(o2[3]), c4 = t2;
                      "/if-stories/" === r2 && (c4 = t2.replace(/^(Lire|lire|LIRE|LIRE LE)\s+/i, "").trim()), l.push({ name: n3 + c4, path: a2, releaseTime: s2 });
                    }
                  }
                }
              }, "h"), "/histoire-principale/" !== r2 ? [3, 3] : (f = [], c3(".entry-content .wp-block-button a").each(function(e2, t2) {
                var r3 = c3(t2).attr("href");
                r3 && r3.includes(L.site) && f.push(r3);
              }), [4, Promise.all(f.map(function(r3) {
                return e(L, void 0, void 0, function() {
                  return t(this, function(e2) {
                    switch (e2.label) {
                      case 0:
                        return e2.trys.push([0, 2, , 3]), [4, this.getCheerio(r3)];
                      case 1:
                        return [2, { page$: e2.sent(), arcUrl: r3 }];
                      case 2:
                        return e2.sent(), [2, null];
                      case 3:
                        return [2];
                    }
                  });
            ...
            case 2:
              for (p = S.sent(), v = /* @__PURE__ */ __name(function(e2) {
                if (!e2) return "continue";
                var t2 = e2.page$, r3 = e2.arcUrl.replace(d.site, "").match(/^\/arc-([^-/]+)/i), n3 = r3 ? "Arc ".concat(s(r3[1]), " - ") : "";
                t2("div.entry-content ul li a, div.entry-content ol li a").each(function(e3, r4) {
                  var i2 = t2(r4).attr("href"), o2 = t2(r4).text().trim();
                  h(i2, o2, n3);
                });
              }, "v"), d = this, m = 0, y = p; m < y.length; m++) b = y[m], v(b);
              return [3, 4];
            case 3:
              if ("/histoires-annexes/" === r2) for (w = "", g = c3("div.entry-content").children().toArray(), x = 0, N = g; x < N.length; x++) "tag" === (C = N[x]).type && ("h2" === C.tagName.toLowerCase() ? (I = c3(C).text().trim(), R = I.match(/arc\s+([ivxlcdm]+|\d+)/i), w = R ? "Arc ".concat(s(R[1]), " - ") : "".concat(I, " - ")) : c3(C).find("a").each(function(e2, t2) {
                var r3 = c3(t2).attr("href"), n3 = c3(t2).text().trim();
                h(r3, n3, w);
              }));
              else c3(".entry-content a").each(function(e2, t2) {
                var r3 = c3(t2).attr("href"), n3 = c3(t2).text().trim();
                h(r3, n3);
              });
              S.label = 4;
            case 4:
              return n2.chapters = l, [2, n2];
          }
        });
      });
      ...
      return e(this, void 0, void 0, function() {
        ...
        return t(this, function(t2) {
          switch (t2.label) {
            ...
            case 1:
              return (e2 = t2.sent())('div.entry-content .sharedaddy, div.entry-content .wpcnt, div.entry-content #jp-post-flair, div.entry-content div[id^="atatags-"]').remove(), n2 = e2("h1.entry-title").html() || "", i2 = e2("div.entry-content").html() || "", [2, n2 + i2];
          }
        });
      });
    }, c2.prototype.searchNovels = function(r2, n2) {
      return e(this, void 0, void 0, function() {
        return t(this, function(e2) {
          switch (e2.label) {
            case 0:
