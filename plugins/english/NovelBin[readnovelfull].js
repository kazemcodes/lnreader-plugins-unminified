...
var LNReaderPlugin = (() => {
  ...
  var n, r = require_lib6(), o = (init_fetch2(), __toCommonJS(fetch_exports)), l = (init_novelStatus(), __toCommonJS(novelStatus_exports)), i = function() {
    ...
    return i2.prototype.sleep = function(e2) {
      ...
      var a2, o2 = this, l2 = [], i3 = {}, s2 = [n.Idle], c = /* @__PURE__ */ __name(function() {
        return s2[s2.length - 1];
      }, "c"), u = /* @__PURE__ */ __name(function(e2) {
        return s2.push(e2);
      }, "u"), h = /* @__PURE__ */ __name(function() {
        return s2.length > 1 ? s2.pop() : c();
      }, "h"), v = new r.Parser({ onopentag: /* @__PURE__ */ __name(function(e2, t3) {
        var r2, l3 = c();
      ...
      return t(this, void 0, void 0, function() {
        ...
        return a(this, function(a2) {
          switch (a2.label) {
            ...
            case 2:
              return s2 = a2.sent(), c = { path: i3, chapters: [] }, u = [], h = [], v = [], p = [], f = [], g = [], d = null, b = {}, m = 0, w = [n.Idle], S = /* @__PURE__ */ __name(function() {
                return w[w.length - 1];
                ...
                c.summary = u.join("\n\n").trim();
              }, "onend") }), k.write(s2), k.end(), this.options.noAjax && g.length > 0 ? (c.chapters = g, [3, 7]) : [3, 3];
            case 3:
            ...
            case 5:
              return [4, I.text()];
            case 6:
              A = a2.sent(), O = [], G = {}, (H = new r.Parser({ onopentag: /* @__PURE__ */ __name(function(e2, t3) {
                var a3, r2;
              ...
              }, "onclosetag") })).write(A), H.end(), c.chapters = O, a2.label = 7;
            case 7:
              return [2, c];
          }
        });
        ...
        return a(this, function(a2) {
          switch (a2.label) {
            ...
            case 1:
              return [4, a2.sent().text()];
            case 2:
              return t2 = a2.sent(), s2 = [], c = false, u = "", h = [n.Idle], v = /* @__PURE__ */ __name(function() {
                return h[h.length - 1];
              }, "v"), p = /* @__PURE__ */ __name(function(e3) {
                return h.push(e3);
              }, "p"), f = /* @__PURE__ */ __name(function() {
                return h.length > 1 ? h.pop() : v();
              }, "f"), g = /[&<>"' ]/g, d = { "&": "&amp;", "<": "&lt;", ">": "&gt;", '"': "&quot;", "'": "&#39;", "\xA0": "&nbsp;" }, b = /* @__PURE__ */ __name(function(e3) {
                return e3.replace(g, function(e4) {
                  return d[e4];
                });
              }, "b"), m = new r.Parser({ onopentag: /* @__PURE__ */ __name(function(e3, t3) {
              ...
              }, "onclosetag") }), m.write(t2), m.end(), [2, s2.join("")];
          }
        });
      });
