...
var LNReaderPlugin = (() => {
  ...
  var n, r = require_lib6(), o = (init_fetch2(), __toCommonJS(fetch_exports)), l = (init_novelStatus(), __toCommonJS(novelStatus_exports)), i = (init_browser(), __toCommonJS(browser_exports)), s = function() {
    function s2(e2) {
      var t2;
    ...
    return s2.prototype.sleep = function(e2) {
      ...
      var a2, o2 = this, l2 = [], i2 = {}, s3 = [n.Idle], c2 = /* @__PURE__ */ __name(function() {
        return s3[s3.length - 1];
      }, "c"), u = /* @__PURE__ */ __name(function(e2) {
        return s3.push(e2);
      }, "u"), h = /* @__PURE__ */ __name(function() {
        return s3.length > 1 ? s3.pop() : c2();
        ...
        if (((null === (r2 = t3.class) || void 0 === r2 ? void 0 : r2.includes("archive")) || "col-content" === t3.class) && (u(n.NovelList), a2 = 0), l3 === n.NovelList || l3 === n.NovelName) switch (e2) {
          case "img":
            var s4 = t3["data-src"] || t3.src;
            s4 && (i2.cover = new URL(s4, o2.site).href);
            break;
          case "h3":
        ...
        var r2 = c2();
        "a" === t3 && r2 === n.NovelName && (i2.name && i2.path && l2.push(e({}, i2)), i2 = {}, h()), "div" === t3 && r2 === n.NovelList && --a2 < 0 && h();
      }, "onclosetag") });
      return v.write(t2), v.end(), l2;
    }, s2.prototype.popularNovels = function(e2, n2) {
      return t(this, arguments, void 0, function(e3, t2) {
        var n3, r2, l2, i2, s3, c2, u, h, v, p, d, f, g, b, m, y, w, S, N, C, k, x, L = t2.filters, P = t2.showLatestNovels;
        return a(this, function(t3) {
          switch (t3.label) {
            case 0:
              return n3 = this.options, r2 = n3.pageParam, l2 = void 0 === r2 ? "page" : r2, i2 = n3.novelListing, s3 = n3.typeParam, c2 = void 0 === s3 ? "type" : s3, u = n3.latestPage, h = n3.genreParam, v = void 0 === h ? "category_novel" : h, p = n3.genreKey, d = void 0 === p ? "id" : p, f = n3.langParam, g = n3.urlLangCode, b = n3.noPages, m = void 0 === b ? [] : b, y = n3.pageAsPath, w = void 0 !== y && y, 1 !== e3 && !P && !L.genres.value.length && m.length > 0 && m.includes(L.type.value) ? [2, []] : (S = "", i2 ? (N = new URLSearchParams(), P ? N.append(c2, u) : L.genres.value.length ? (N.append(c2, v), N.append(d, L.genres.value)) : N.append(c2, L.type.value), f && g && N.append(f, g), N.append(l2, e3.toString()), S = "".concat(this.site).concat(i2, "?").concat(N.toString())) : (C = P ? u : L.genres.value.length ? L.genres.value : L.type.value, S = w ? e3 > 1 ? "".concat(this.site).concat(C, "/").concat(e3.toString()) : "".concat(this.site).concat(C) : "".concat(this.site).concat(C, "?").concat(l2, "=").concat(e3.toString())), [4, (0, o.fetchApi)(S)]);
            case 1:
      ...
      return t(this, void 0, void 0, function() {
        var t2, s3, c2, u, h, v, p, d, f, g, b, m, y, w, S, N, C, k, x, L, P, j, I, A, O, G, H, U, M = this;
        return a(this, function(a2) {
          switch (a2.label) {
              ...
              return s3 = a2.sent(), c2 = { path: i2, chapters: [] }, u = [], h = [], v = [], p = [], d = [], f = [], g = null, b = {}, m = 0, w = [n.Idle], S = /* @__PURE__ */ __name(function() {
                ...
                switch (e2) {
                  case "div":
                    ...
                    M.options.noAjax || "rating" !== t3.id || (g = t3["data-novel-id"]), l2 === n.Info && y++;
                    break;
                  case "img":
                    if (l2 === n.Cover) {
                      var s4 = null !== (r2 = null !== (a3 = t3.src) && void 0 !== a3 ? a3 : t3["data-cfsrc"]) && void 0 !== r2 ? r2 : t3["data-src"], h2 = t3.title;
                      s4 && (c2.cover = new URL(s4, M.site).href), h2 ? c2.name = h2 : C();
                    }
                    break;
                  case "h3":
                  ...
                  if (d.join("").split("\n").map(function(e3) {
                    ...
                    switch (n2) {
                      ...
                      case "status":
                        ...
                        c2.status = null !== (t3 = o2[r2.toLowerCase()]) && void 0 !== t3 ? t3 : l.NovelStatus.Unknown;
                        break;
                      default:
                        return;
                    }
                ...
                } else c2.genres = p.join("").trim(), c2.author = v.join("").trim(), c2.status = h.join("").toLowerCase().replace(/\b\w/g, function(e3) {
                  return e3.toUpperCase();
                });
                c2.summary = u.join("\n\n").trim();
              }, "onend") }), k.write(s3), k.end(), this.options.noAjax && f.length > 0 ? (c2.chapters = f, [3, 7]) : [3, 3];
            case 3:
              return null === g ? [3, 7] : (x = this.options.chapterListing || "ajax/chapter-archive", L = this.options.chapterParam || "novelId", P = new URLSearchParams(((U = {})[L] = g, U)), j = "".concat(this.site).concat(x, "?").concat(P.toString()), [4, (0, o.fetchApi)(j)]);
            case 4:
            ...
            case 6:
              ...
              }, "onclosetag") })).write(A), H.end(), c2.chapters = O, a2.label = 7;
            case 7:
              return [2, c2];
          }
        });
        ...
        return a(this, function(a2) {
          switch (a2.label) {
            ...
            case 2:
              ...
              return u = [], h = false, v = "", p = [n.Idle], d = /* @__PURE__ */ __name(function() {
                return p[p.length - 1];
                ...
                switch (r2) {
                  case n.Idle:
                    "txt" !== o2 && "chr-content" !== t3.id && "chapter-content" !== t3.id || (f(n.Chapter), s3 = 0);
                    break;
                  case n.Chapter:
                    "sub" === e3 ? f(n.Hidden) : "div" === e3 && (s3++, ((null == o2 ? void 0 : o2.includes("unlock-buttons")) || (null == o2 ? void 0 : o2.includes("ads"))) && (f(n.Hidden), c2 = 0));
                    break;
                  case n.Hidden:
                ...
                var t3 = d();
                t3 === n.Hidden && ("sub" === e3 ? g() : "div" === e3 && --c2 < 0 && (g(), s3--)), t3 === n.Chapter && (y.isVoidElement(e3) || (h && e3 === v ? (h = false, v = "") : u.push("</".concat(e3, ">"))), "div" === e3 && --s3 < 0 && f(n.Stopped));
