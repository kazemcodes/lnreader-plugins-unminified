...
(() => {
  ...
  // .js/plugins/english/wuxiaworld.js
  var e = function(e2, n2, t2, o2) {
    return new (t2 || (t2 = Promise))((function(a2, i2) {
      function r2(e3) {
        try {
          l(o2.next(e3));
        } catch (e4) {
      ...
      function l(e3) {
        var n3;
        e3.done ? a2(e3.value) : (n3 = e3.value, n3 instanceof t2 ? n3 : new t2((function(e4) {
          e4(n3);
        }))).then(r2, s);
      }
      __name(l, "l");
      l((o2 = o2.apply(e2, n2 || [])).next());
    }));
  }, n = function(e2, n2) {
    var t2, o2, a2, i2 = { label: 0, sent: /* @__PURE__ */ __name(function() {
    ...
    function s(s2) {
      return function(l) {
        return (function(s3) {
          ...
          for (; r2 && (r2 = 0, s3[0] && (i2 = 0)), i2; ) try {
            if (t2 = 1, o2 && (a2 = 2 & s3[0] ? o2.return : s3[0] ? o2.throw || ((a2 = o2.return) && a2.call(o2), 0) : o2.next) && !(a2 = a2.call(o2, s3[1])).done) return a2;
            switch (o2 = 0, a2 && (s3 = [2 & s3[0], a2.value]), s3[0]) {
              case 0:
              case 1:
                a2 = s3;
                break;
        ...
        return n(this, (function(n2) {
          switch (n2.label) {
            ...
            case 1:
              ...
              return [4, (0, a.fetchProto)({ proto: this.proto, requestType: "GetChapterListRequest", responseType: "GetChapterListResponse", requestData: { novelId: null === (I = e2.item) || void 0 === I ? void 0 : I.id } }, this.apiSite + "Chapters/GetChapterList", { headers: { "Content-Type": "application/grpc-web+proto" } })];
            case 2:
              return l = n2.sent(), p = Number(null === (S = null === (G = null === (N = e2.item) || void 0 === N ? void 0 : N.karmaInfo) || void 0 === G ? void 0 : G.maxFreeChapter) || void 0 === S ? void 0 : S.units) + ((null === (T = null === (R = null === (V = e2.item) || void 0 === V ? void 0 : V.karmaInfo) || void 0 === R ? void 0 : R.maxFreeChapter) || void 0 === T ? void 0 : T.nanos) || 0) / 1e9 || 50, u = l.items.flatMap((function(e3) {
                return e3.chapterList.map((function(n3) {
                  var t2, o2, a2, i2, s2, l2;
                  return { page: e3.title, name: n3.name + (false === (null === (o2 = null === (t2 = n3.relatedUserInfo) || void 0 === t2 ? void 0 : t2.isChapterUnlocked) || void 0 === o2 ? void 0 : o2.value) || !n3.relatedUserInfo && Number(null === (a2 = n3.number) || void 0 === a2 ? void 0 : a2.units) + ((null === (i2 = n3.number) || void 0 === i2 ? void 0 : i2.nanos) || 0) / 1e9 > p ? " \u{1F512}" : ""), path: r3 + n3.slug, chapterNumber: n3.offset, releaseTime: new Date(1e3 * ((null === (s2 = n3.publishedAt) || void 0 === s2 ? void 0 : s2.seconds) || 0) + ((null === (l2 = n3.publishedAt) || void 0 === l2 ? void 0 : l2.nanos) || 0) / 1e6).toISOString() };
                }));
              })), s.chapters = u, [2, s];
          }
        }));
      }));
    }, r2.prototype.parseChapter = function(t2) {
      return e(this, void 0, void 0, (function() {
        var e2, o2, i2, r3;
        return n(this, (function(n2) {
          switch (n2.label) {
            case 0:
              return e2 = t2.split("/"), [4, (0, a.fetchProto)({ proto: this.proto, requestType: "GetChapterRequest", responseType: "GetChapterResponse", requestData: { chapterProperty: { slugs: { novelSlug: e2[1], chapterSlug: e2[2] } } } }, this.apiSite + "Chapters/GetChapter", { headers: { "Content-Type": "application/grpc-web+proto" } })];
            case 1:
              return o2 = n2.sent(), [2, (null === (r3 = null === (i2 = o2.item) || void 0 === i2 ? void 0 : i2.content) || void 0 === r3 ? void 0 : r3.value) || ""];
          }
        }));
      }));
    }, r2.prototype.searchNovels = function(t2) {
      return e(this, void 0, void 0, (function() {
        var e2, o2;
        return n(this, (function(n2) {
          switch (n2.label) {
            case 0:
              return e2 = this.site + "api/novels/search?query=" + encodeURIComponent(t2), [4, (0, a.fetchApi)(e2)];
            case 1:
              return [4, n2.sent().json()];
            case 2:
              return o2 = n2.sent(), [2, this.parseNovels(o2)];
          }
        }));
      }));
    }, r2;
