...
(() => {
  ...
  // .js/plugins/english/rainofsnow.js
        ...
        return (function(l3) {
          ...
          for (; i2 && (i2 = 0, l3[0] && (o2 = 0)), o2; ) try {
            ...
            switch (n2 = 0, a2 && (l3 = [2 & l3[0], a2.value]), l3[0]) {
              ...
              case 5:
                o2.label++, n2 = l3[1], l3 = [0];
                continue;
              case 7:
                l3 = o2.ops.pop(), o2.trys.pop();
                continue;
              default:
                if (!(a2 = o2.trys, (a2 = a2.length > 0 && a2[a2.length - 1]) || 6 !== l3[0] && 2 !== l3[0])) {
                  o2 = 0;
                  continue;
                }
                ...
                if (6 === l3[0] && o2.label < a2[1]) {
                  o2.label = a2[1], a2 = l3;
                  break;
                }
                if (a2 && o2.label < a2[2]) {
                  o2.label = a2[2], o2.ops.push(l3);
                  break;
                }
  ...
  var r = (init_fetch2(), __toCommonJS(fetch_exports)), n = (init_filterInputs(), __toCommonJS(filterInputs_exports)), a = (init_browser(), __toCommonJS(browser_exports)), o = (init_novelStatus(), __toCommonJS(novelStatus_exports)), i = (function() {
    function i2() {
      this.id = "rainofsnow", this.name = "Rainofsnow", this.icon = "src/en/rainofsnow/icon.png", this.site = "https://rainofsnow.com/", this.version = "1.1.2", this.filters = { genre: { value: "", label: "Filter By", options: [{ label: "All", value: "" }, { label: "Action", value: "?n_orderby=16" }, { label: "Adventure", value: "?n_orderby=11" }, { label: "Angst", value: "?n_orderby=776" }, { label: "Chinese", value: "?n_orderby=342" }, { label: "Comedy", value: "?n_orderby=13" }, { label: "Drama", value: "?n_orderby=3" }, { label: "Fantasy", value: "?n_orderby=7" }, { label: "Japanese", value: "?n_orderby=343" }, { label: "Korean", value: "?n_orderby=341" }, { label: "Mature", value: "?n_orderby=778" }, { label: "Mystery", value: "?n_orderby=12" }, { label: "Original Novel", value: "?n_orderby=339" }, { label: "Psychological", value: "?n_orderby=769" }, { label: "Romance", value: "?n_orderby=5" }, { label: "Sci-fi", value: "?n_orderby=14" }, { label: "Slice of Life", value: "?n_orderby=779" }, { label: "Supernatural", value: "?n_orderby=780" }, { label: "Tragedy", value: "?n_orderby=777" }], type: n.FilterTypes.Picker } };
    }
    __name(i2, "i");
    return i2.prototype.parseNovels = function(e2) {
      var t2 = this, r2 = [];
      return e2(".minbox").each((function(n2, a2) {
        var o2, i3 = e2(a2).find("h3").text(), l = e2(a2).find("img").attr("data-src"), s = null === (o2 = e2(a2).find("h3 > a").attr("href")) || void 0 === o2 ? void 0 : o2.replace(t2.site, "").replace(/\/+$/, "");
        s && r2.push({ name: i3, cover: l, path: s });
      })), r2;
    }, i2.prototype.popularNovels = function(n2, o2) {
      return e(this, arguments, void 0, (function(e2, n3) {
        var o3, i3, l, s = n3.filters;
        return t(this, (function(t2) {
          switch (t2.label) {
            case 0:
              return o3 = this.site + "novels/page/" + e2 + s.genre.value, [4, (0, r.fetchApi)(o3).then((function(e3) {
                return e3.text();
              }))];
            case 1:
              return i3 = t2.sent(), l = (0, a.load)(i3), [2, this.parseNovels(l)];
          }
        }));
      }));
      ...
      return e(this, void 0, void 0, (function() {
        ...
        return t(this, (function(t2) {
          switch (t2.label) {
            case 0:
              return e2 = { path: n2, name: "", totalPages: 0 }, [4, (0, r.fetchApi)(this.site + n2).then((function(e3) {
                return e3.text();
              }))];
            case 1:
              return i3 = t2.sent(), l = (0, a.load)(i3), e2.name = l(".text h2").text().trim(), e2.cover = l(".imagboca1 img").attr("data-src"), e2.summary = l("#synop").text().trim(), e2.genres = l('span:contains("Genre(s)")').next().text().trim(), e2.author = l('span:contains("Author")').next().text(), s = 1, l(".page-numbers li").each((function(e3, t3) {
                var r2 = l(t3).find("a").text().trim().match(/(\d+)/), n3 = Number((null == r2 ? void 0 : r2[1]) || "0");
                n3 > s && (s = n3);
              })), e2.totalPages = s, e2.chapters = this.parseChapters(l), e2.status = o.NovelStatus.Unknown, [2, e2];
          }
        }));
      }));
    }, i2.prototype.parsePage = function(n2, o2) {
      return e(this, void 0, void 0, (function() {
        var e2, i3, l;
        return t(this, (function(t2) {
          switch (t2.label) {
            case 0:
              return e2 = this.site + n2 + "/page/" + o2 + "/#chapter", [4, (0, r.fetchApi)(e2).then((function(e3) {
                return e3.text();
              }))];
            case 1:
              return i3 = t2.sent(), l = (0, a.load)(i3), [2, { chapters: this.parseChapters(l) }];
          }
        }));
      }));
    }, i2.prototype.parseChapters = function(e2) {
      var t2 = this, r2 = [];
      return e2("#chapter .march1 li").each((function(n2, a2) {
        var o2, i3 = null === (o2 = e2(a2).find("a").attr("href")) || void 0 === o2 ? void 0 : o2.slice(t2.site.length);
        if (i3) {
          var l = e2(a2).find(".chapter").first().text().trim(), s = e2(a2).find("small").text().trim().toLowerCase(), u = /([a-z]+) (..?), (.+)/.exec(s) || [], c = u[1], h = u[2], p = u[3], f = ["jan", "feb", "mar", "apr", "may", "jun", "jul", "aug", "sep", "oct", "nov", "dec"].indexOf(c.slice(0, 3)), v = c && -1 !== f ? new Date(+p, f, +h).toISOString() : null;
          r2.push({ name: l, path: i3, releaseTime: v });
        }
      })), r2;
      ...
      return e(this, void 0, void 0, (function() {
        ...
        return t(this, (function(t2) {
          switch (t2.label) {
            case 0:
              return [4, fetch(this.site + r2)];
            case 1:
              return [4, t2.sent().text()];
            case 2:
              return e2 = t2.sent(), n2 = (0, a.load)(e2), o2 = n2(".content > h2").text(), (i3 = n2(".content").html()) ? [2, o2 + "\n" + i3] : [2, ""];
          }
        }));
      }));
    }, i2.prototype.searchNovels = function(r2) {
      return e(this, void 0, void 0, (function() {
        var e2, n2, o2, i3;
        return t(this, (function(t2) {
          switch (t2.label) {
            case 0:
              return e2 = r2.replace(/\s+/g, "+"), n2 = this.site + "?s=" + encodeURIComponent(e2), [4, fetch(n2)];
            case 1:
              return [4, t2.sent().text()];
            case 2:
              return o2 = t2.sent(), i3 = (0, a.load)(o2), [2, this.parseNovels(i3)];
          }
        }));
      }));
    }, i2;
