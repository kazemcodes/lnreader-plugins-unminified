...
(() => {
  ...
  var e = function(e2, a2, l2, t2) {
    ...
    return o2.next = u(0), o2.throw = u(1), o2.return = u(2), "function" == typeof Symbol && (o2[Symbol.iterator] = function() {
      return this;
    }), o2;
    function u(u2) {
      return function(i) {
        return (function(u3) {
          ...
          for (; o2 && (o2 = 0, u3[0] && (n2 = 0)), n2; ) try {
            if (l2 = 1, t2 && (r2 = 2 & u3[0] ? t2.return : u3[0] ? t2.throw || ((r2 = t2.return) && r2.call(t2), 0) : t2.next) && !(r2 = r2.call(t2, u3[1])).done) return r2;
            switch (t2 = 0, r2 && (u3 = [2 & u3[0], r2.value]), u3[0]) {
              case 0:
              case 1:
                r2 = u3;
                break;
              case 4:
                return n2.label++, { value: u3[1], done: false };
              case 5:
                n2.label++, t2 = u3[1], u3 = [0];
                continue;
              case 7:
                u3 = n2.ops.pop(), n2.trys.pop();
                continue;
              default:
                if (!(r2 = n2.trys, (r2 = r2.length > 0 && r2[r2.length - 1]) || 6 !== u3[0] && 2 !== u3[0])) {
                  n2 = 0;
                  continue;
                }
                if (3 === u3[0] && (!r2 || u3[1] > r2[0] && u3[1] < r2[3])) {
                  n2.label = u3[1];
                  break;
                }
                if (6 === u3[0] && n2.label < r2[1]) {
                  n2.label = r2[1], r2 = u3;
                  break;
                }
                if (r2 && n2.label < r2[2]) {
                  n2.label = r2[2], n2.ops.push(u3);
                  break;
                }
    ...
    return o2.prototype.parseNovels = function(e2) {
          ...
          switch (a2.label) {
            ...
            case 2:
              return e2 = a2.sent(), (n2 = (0, l.load)(e2))("h3.title").each((function(e3, a3) {
                ...
                t2.removeAttr("href");
                var r3 = t2.text().trim(), o3 = l2.contents().filter((function(e4, a4) {
                  return 3 === a4.nodeType;
                })).text().trim();
                l2.html("".concat(r3, "<br>").concat(o3));
      ...
      return e(this, void 0, void 0, (function() {
        ...
        return a(this, (function(a2) {
          switch (a2.label) {
            case 0:
              return e2 = "".concat(this.site, "works/search?page=").concat(n2, "&work_search%5Blanguage_id%5D=en&work_search%5Bquery%5D=").concat(encodeURIComponent(r2)), [4, (0, t.fetchApi)(e2)];
            case 1:
              return [4, a2.sent().text()];
            case 2:
              return o3 = a2.sent(), u = (0, l.load)(o3), [2, this.parseNovels(u)];
