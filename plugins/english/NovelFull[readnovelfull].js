...
var LNReaderPlugin = (() => {
  ...
  var n, r = require_lib6(), o = (init_fetch2(), __toCommonJS(fetch_exports)), i = (init_novelStatus(), __toCommonJS(novelStatus_exports)), s = (init_browser(), __toCommonJS(browser_exports)), l = function() {
    ...
    return l2.prototype.sleep = function(e2) {
      ...
      return t(this, void 0, void 0, function() {
        var t2, l3, c2, u, h, p, v, d, f, g, b, m, w, y, S, C, N, k, L, x, P, A, j, I, H, M, G, O, U = this;
        return a(this, function(a2) {
          switch (a2.label) {
                ...
                switch (e2) {
                  ...
                  case "img":
                    if (i2 === n.Cover) {
                      ...
                      l4 && (c2.cover = new URL(l4, U.site).href), h2 ? c2.name = h2 : N();
                    }
                    break;
                  case "h3":
            ...
            case 3:
              return null === g ? [3, 7] : (L = this.options.chapterListing || "ajax/chapter-archive", x = this.options.chapterParam || "novelId", P = new URLSearchParams(((O = {})[x] = g, O)), A = "".concat(this.site).concat(L, "?").concat(P.toString()), [4, (0, o.fetchApi)(A)]);
            case 4:
            ...
            case 6:
              ...
              }, "onclosetag") })).write(I), G.end(), c2.chapters = H, a2.label = 7;
            case 7:
              return [2, c2];
          }
        });
