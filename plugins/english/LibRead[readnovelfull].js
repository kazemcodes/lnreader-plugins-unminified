  ...
  var n, r = require_lib6(), o = (init_fetch2(), __toCommonJS(fetch_exports)), s = (init_novelStatus(), __toCommonJS(novelStatus_exports)), i = function() {
    ...
    return i2.prototype.sleep = function(e2) {
      ...
      return t(this, arguments, void 0, function(e3, t2) {
        var n3, r2, s2, i3, l2, c, u, h, p, v, d, f, g, b, m, w, y, S, N, k, C, L, P = t2.filters, x = t2.showLatestNovels;
        return a(this, function(t3) {
          switch (t3.label) {
            case 0:
              return n3 = this.options, r2 = n3.pageParam, s2 = void 0 === r2 ? "page" : r2, i3 = n3.novelListing, l2 = n3.typeParam, c = void 0 === l2 ? "type" : l2, u = n3.latestPage, h = n3.genreParam, p = void 0 === h ? "category_novel" : h, v = n3.genreKey, d = void 0 === v ? "id" : v, f = n3.langParam, g = n3.urlLangCode, b = n3.noPages, m = void 0 === b ? [] : b, w = n3.pageAsPath, y = void 0 !== w && w, 1 !== e3 && !x && !P.genres.value.length && m.length > 0 && m.includes(P.type.value) ? [2, []] : (S = "", i3 ? (N = new URLSearchParams(), x ? N.append(c, u) : P.genres.value.length ? (N.append(c, p), N.append(d, P.genres.value)) : N.append(c, P.type.value), f && g && N.append(f, g), N.append(s2, e3.toString()), S = "".concat(this.site).concat(i3, "?").concat(N.toString())) : (k = x ? u : P.genres.value.length ? P.genres.value : P.type.value, S = y ? e3 > 1 ? "".concat(this.site).concat(k, "/").concat(e3.toString()) : "".concat(this.site).concat(k) : "".concat(this.site).concat(k, "?").concat(s2, "=").concat(e3.toString())), [4, (0, o.fetchApi)(S)]);
            case 1:
      ...
      return t(this, void 0, void 0, function() {
        var t2, l2, c, u, h, p, v, d, f, g, b, m, w, y, S, N, k, C, L, P, x, A, j, I, H, G, R, E, M = this;
        return a(this, function(a2) {
          switch (a2.label) {
            ...
            case 3:
              return null === g ? [3, 7] : (L = this.options.chapterListing || "ajax/chapter-archive", P = this.options.chapterParam || "novelId", x = new URLSearchParams(((E = {})[P] = g, E)), A = "".concat(this.site).concat(L, "?").concat(x.toString()), [4, (0, o.fetchApi)(A)]);
            case 4:
              return (j = a2.sent()).ok ? [3, 5] : (console.error("Failed to fetch chapters: ".concat(j.status)), c.chapters = [], [3, 7]);
            case 5:
              return [4, j.text()];
            case 6:
              I = a2.sent(), H = [], G = {}, (R = new r.Parser({ onopentag: /* @__PURE__ */ __name(function(e2, t3) {
                var a3, r2;
              ...
              }, "onclosetag") })).write(I), R.end(), c.chapters = H, a2.label = 7;
            case 7:
              return [2, c];
          }
        });
