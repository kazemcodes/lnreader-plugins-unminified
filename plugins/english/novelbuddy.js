...
(() => {
  ...
  var e = function(e2, a2, t2, l2) {
    return new (t2 || (t2 = Promise))((function(n2, r2) {
      function i(e3) {
        try {
          u(l2.next(e3));
        } catch (e4) {
    ...
    var t2, l2, n2, r2 = { label: 0, sent: /* @__PURE__ */ __name(function() {
    ...
    function o(o2) {
      return function(u) {
        return (function(o3) {
          ...
          for (; i && (i = 0, o3[0] && (r2 = 0)), r2; ) try {
            if (t2 = 1, l2 && (n2 = 2 & o3[0] ? l2.return : o3[0] ? l2.throw || ((n2 = l2.return) && n2.call(l2), 0) : l2.next) && !(n2 = n2.call(l2, o3[1])).done) return n2;
            switch (l2 = 0, n2 && (o3 = [2 & o3[0], n2.value]), o3[0]) {
              case 0:
              case 1:
                n2 = o3;
                break;
    ...
    return r2.prototype.parseNovels = function(e2) {
      ...
      return e(this, void 0, void 0, (function() {
        ...
        return a(this, (function(h) {
          switch (h.label) {
              ...
              return r3 = h.sent(), i = (0, t.load)(r3), o = { path: n2, name: i(".name h1").text().trim() || "Untitled", cover: "https:" + i(".img-cover img").attr("data-src"), summary: i(".section-body.summary .content").text().trim(), chapters: [] }, i(".meta.box p").each((function(e2, a2) {
                ...
                switch (t2) {
                  ...
                  case "Status :":
                    ...
                    break;
                  case "Genres :":
                    o.genres = l2.text().trim();
                }
              })), u = i("script").text().match(/bookId = (\d+);/)[1], s = [], c = /* @__PURE__ */ __name(function(n3) {
                return e(b, void 0, void 0, (function() {
                  var e2, r4;
                  return a(this, (function(a2) {
                    switch (a2.label) {
                      case 0:
                        return e2 = "".concat(this.site, "api/manga/").concat(n3, "/chapters?source=detail"), [4, (0, l.fetchApi)(e2)];
                      case 1:
                        return [4, a2.sent().text()];
                      case 2:
                        return r4 = a2.sent(), (i = (0, t.load)(r4))("li").each((function(e3, a3) {
                          var t2, l2 = i(a3).find(".chapter-title").text().trim(), n4 = i(a3).find(".chapter-update").text().trim(), r5 = ["jan", "feb", "mar", "apr", "may", "jun", "jul", "aug", "sep", "oct", "nov", "dec"], o2 = r5.join("|"), u2 = new RegExp("(".concat(o2, ") (\\d{1,2}), (\\d{4})"), "i").exec(n4);
                          if (u2) {
                            var c2 = +u2[3], v2 = r5.indexOf(u2[1].toLowerCase()), b2 = +u2[2], h2 = null === (t2 = i(a3).find("a").attr("href")) || void 0 === t2 ? void 0 : t2.slice(1);
                            h2 && s.push({ name: l2, releaseTime: new Date(c2, v2, b2).toISOString(), path: h2 });
                          }
                        })), [2, s];
                    }
                  }));
            ...
            case 3:
              return v.chapters = h.sent().reverse(), [2, o];
          }
        }));
      }));
        ...
        return a(this, (function(a2) {
          switch (a2.label) {
            ...
            case 1:
              return [4, a2.sent().text()];
            case 2:
              return e2 = a2.sent(), (r3 = (0, t.load)(e2))("#listen-chapter").remove(), r3("#google_translate_element").remove(), [2, r3(".chapter__content").html() || ""];
          }
        }));
      }));
      ...
      return e(this, void 0, void 0, (function() {
        ...
        return a(this, (function(a2) {
          switch (a2.label) {
            case 0:
              return e2 = "".concat(this.site, "search?q=").concat(encodeURIComponent(n2), "&page=").concat(r3), [4, (0, l.fetchApi)(e2)];
            case 1:
              return [4, a2.sent().text()];
            case 2:
              return i = a2.sent(), o = (0, t.load)(i), [2, this.parseNovels(o)];
          }
        }));
      }));
    }, r2;
