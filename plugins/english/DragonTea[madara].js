...
(() => {
  ...
  // .js/plugins/english/DragonTea[madara].js
  var e = function(e2, t2, a2, r2) {
    return new (a2 || (a2 = Promise))((function(l2, n2) {
      function i2(e3) {
        try {
          s2(r2.next(e3));
        } catch (e4) {
    ...
    var a2, r2, l2, n2 = { label: 0, sent: /* @__PURE__ */ __name(function() {
      ...
      return function(s2) {
        return (function(o4) {
          ...
          for (; i2 && (i2 = 0, o4[0] && (n2 = 0)), n2; ) try {
            if (a2 = 1, r2 && (l2 = 2 & o4[0] ? r2.return : o4[0] ? r2.throw || ((l2 = r2.return) && l2.call(r2), 0) : r2.next) && !(l2 = l2.call(r2, o4[1])).done) return l2;
            switch (r2 = 0, l2 && (o4 = [2 & o4[0], l2.value]), o4[0]) {
              case 0:
              case 1:
                l2 = o4;
                break;
              ...
              case 5:
                n2.label++, r2 = o4[1], o4 = [0];
                continue;
              case 7:
                o4 = n2.ops.pop(), n2.trys.pop();
                continue;
              default:
                if (!(l2 = n2.trys, (l2 = l2.length > 0 && l2[l2.length - 1]) || 6 !== o4[0] && 2 !== o4[0])) {
                  n2 = 0;
                  continue;
                }
                ...
                if (6 === o4[0] && n2.label < l2[1]) {
                  n2.label = l2[1], l2 = o4;
                  break;
                }
                if (l2 && n2.label < l2[2]) {
                  n2.label = l2[2], n2.ops.push(o4);
                  break;
                }
  ...
  var r = (init_fetch2(), __toCommonJS(fetch_exports)), l = (init_browser(), __toCommonJS(browser_exports)), n = (init_defaultCover(), __toCommonJS(defaultCover_exports)), i = (init_novelStatus(), __toCommonJS(novelStatus_exports)), o = a(require_dayjs_min()), s = (init_storage2(), __toCommonJS(storage_exports)), u = /* @__PURE__ */ __name(function(e2, t2) {
    return new RegExp(t2.join("|")).test(e2);
  }, "u"), c = new ((function() {
    function a2(e2) {
      var t2, a3;
      this.hideLocked = s.storage.get("hideLocked"), this.parseData = function(e3) {
        var t3, a4 = (0, o.default)(), r3 = (null === (t3 = e3.match(/\d+/)) || void 0 === t3 ? void 0 : t3[0]) || "", l2 = parseInt(r3, 10);
        if (!r3) return e3;
        if (u(e3, ["detik", "segundo", "second", "\u0E27\u0E34\u0E19\u0E32\u0E17\u0E35"])) a4 = a4.subtract(l2, "second");
        else if (u(e3, ["menit", "dakika", "min", "minute", "minuto", "\u0E19\u0E32\u0E17\u0E35", "\u062F\u0642\u0627\u0626\u0642"])) a4 = a4.subtract(l2, "minute");
        else if (u(e3, ["jam", "saat", "heure", "hora", "hour", "\u0E0A\u0E31\u0E48\u0E27\u0E42\u0E21\u0E07", "gi\u1EDD", "ore", "\u0633\u0627\u0639\u0629", "\u5C0F\u65F6"])) a4 = a4.subtract(l2, "hours");
        else if (u(e3, ["hari", "g\xFCn", "jour", "d\xEDa", "dia", "day", "\u0E27\u0E31\u0E19", "ng\xE0y", "giorni", "\u0623\u064A\u0627\u0645", "\u5929"])) a4 = a4.subtract(l2, "days");
        else if (u(e3, ["week", "semana"])) a4 = a4.subtract(l2, "week");
        else if (u(e3, ["month", "mes"])) a4 = a4.subtract(l2, "month");
        else {
          if (!u(e3, ["year", "a\xF1o"])) return "Invalid Date" !== (0, o.default)(e3).format("LL") ? (0, o.default)(e3).format("LL") : e3;
          a4 = a4.subtract(l2, "year");
        }
        return a4.format("LL");
      ...
      this.version = "1.0.".concat(8 + r2), this.options = e2.options, this.filters = e2.filters, (null === (a3 = this.options) || void 0 === a3 ? void 0 : a3.hasLocked) && (this.pluginSettings = { hideLocked: { value: "", label: "Hide locked chapters", type: "Switch" } });
    }
    __name(a2, "a");
    return a2.prototype.translateDragontea = function(e2) {
      var t2;
      if ("dragontea" !== this.id) return e2;
      var a3 = (0, l.load)((null === (t2 = e2.html()) || void 0 === t2 ? void 0 : t2.replace("\n", "").replace(/<br\s*\/?>/g, "\n")) || "");
      return e2.html(a3.html()), e2.find("*").addBack().contents().filter((function(e3, t3) {
        return 3 === t3.nodeType;
      })).each((function(e3, t3) {
        var r2 = a3(t3), l2 = r2.text().normalize("NFD").split("").map((function(e4) {
      ...
      return e2(".manga-title-badges").remove(), e2(".page-item-detail, .c-tabs-item__content").each((function(a3, r2) {
        var l2 = e2(r2).find(".post-title").text().trim(), i2 = e2(r2).find(".post-title").find("a").attr("href") || "";
        if (l2 && i2) {
          var o2 = e2(r2).find("img"), s2 = { name: l2, cover: o2.attr("data-src") || o2.attr("src") || o2.attr("data-lazy-srcset") || n.defaultCover, path: i2.replace(/https?:\/\/.*?\//, "/") };
          t2.push(s2);
        }
      })), t2;
    }, a2.prototype.popularNovels = function(a3, r2) {
      return e(this, arguments, void 0, (function(e2, a4) {
        var r3, l2, n2, i2, o2, s2, u2 = a4.filters, c2 = a4.showLatestNovels;
        return t(this, (function(t2) {
          switch (t2.label) {
            case 0:
              for (l2 in r3 = this.site + "/page/" + e2 + "/?s=&post_type=wp-manga", u2 || (u2 = this.filters || {}), c2 && (r3 += "&m_orderby=latest"), u2) if ("object" == typeof u2[l2].value) for (n2 = 0, i2 = u2[l2].value; n2 < i2.length; n2++) o2 = i2[n2], r3 += "&".concat(l2, "=").concat(o2);
              else u2[l2].value && (r3 += "&".concat(l2, "=").concat(u2[l2].value));
      ...
      return e(this, void 0, void 0, (function() {
        var e2, s2, u2, c2, h, v, p, m, d = this;
        return t(this, (function(t2) {
          switch (t2.label) {
            case 0:
            ...
            case 1:
              return (e2 = t2.sent())(".manga-title-badges, #manga-title span").remove(), (s2 = { path: a3, name: e2(".post-title h1").text().trim() || e2("#manga-title h1").text().trim() || e2(".manga-title").text().trim() || "" }).cover = e2(".summary_image > a > img").attr("data-lazy-src") || e2(".summary_image > a > img").attr("data-src") || e2(".summary_image > a > img").attr("src") || n.defaultCover, e2(".post-content_item, .post-content").each((function() {
                ...
                return e2(a4).text();
              })).get().join("\n\n").trim(), u2 = [], c2 = "", (null === (m = this.options) || void 0 === m ? void 0 : m.useNewChapterEndpoint) ? [4, (0, r.fetchApi)(this.site + a3 + "ajax/chapters/", { method: "POST", referrer: this.site + a3 }).then((function(e3) {
                return e3.text();
              }))] : [3, 3];
            case 2:
              return c2 = t2.sent(), [3, 5];
            case 3:
              return h = e2(".rating-post-id").attr("value") || e2("#manga-chapters-holder").attr("data-id") || "", (v = new FormData()).append("action", "manga_get_chapters"), v.append("manga", h), [4, (0, r.fetchApi)(this.site + "wp-admin/admin-ajax.php", { method: "POST", body: v }).then((function(e3) {
                return e3.text();
              }))];
            case 4:
              c2 = t2.sent(), t2.label = 5;
            case 5:
              return "0" !== c2 && (e2 = (0, l.load)(c2)), p = e2(".wp-manga-chapter").length, e2(".wp-manga-chapter").each((function(t3, a4) {
                var r2 = e2(a4).find("a").text().trim(), l2 = a4.attribs.class.includes("premium-block");
                l2 && (r2 = "\u{1F512} " + r2);
                var n2 = e2(a4).find("span.chapter-release-date").text().trim();
                n2 = n2 ? d.parseData(n2) : (0, o.default)().format("LL");
                var i2 = e2(a4).find("a").attr("href") || "";
                !i2 || "#" == i2 || l2 && d.hideLocked || u2.push({ name: r2, path: i2.replace(/https?:\/\/.*?\//, "/"), releaseTime: n2 || null, chapterNumber: p - t3 });
        ...
        return t(this, (function(t2) {
          switch (t2.label) {
            case 0:
              return [4, this.getCheerio(this.site + a3, false)];
            case 1:
              return e2 = t2.sent(), r2 = e2(".text-left") || e2(".text-right") || e2(".entry-content") || e2(".c-blog-post > div > div:nth-child(2)"), null === (l2 = this.options) || void 0 === l2 || l2.customJs, [2, this.translateDragontea(r2).html() || ""];
          }
        }));
      }));
