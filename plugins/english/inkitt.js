...
(() => {
  ...
  var r = (init_fetch2(), __toCommonJS(fetch_exports)), n = (init_filterInputs(), __toCommonJS(filterInputs_exports)), a = (init_browser(), __toCommonJS(browser_exports)), i = (init_novelStatus(), __toCommonJS(novelStatus_exports)), o = (function() {
    function o2() {
      var e2 = this;
      this.id = "inkitt", this.name = "Inkitt", this.icon = "src/en/inkitt/icon.png", this.site = "https://www.inkitt.com", this.version = "1.0.1", this.imageRequestInit = void 0, this.resolveUrl = function(t2, r2) {
        return e2.site + "/stories/" + t2;
      }, this.filters = { genres: { type: n.FilterTypes.Picker, label: "Genre", value: "", options: [{ label: "Sci-Fi", value: "scifi" }, { label: "Fantasy", value: "fantasy" }, { label: "Adventure", value: "adventure" }, { label: "Mystery", value: "mystery" }, { label: "Action", value: "action" }, { label: "Horror", value: "horror" }, { label: "Humor", value: "humor" }, { label: "Erotica", value: "erotica" }, { label: "Poetry", value: "poetry" }, { label: "Other", value: "other" }, { label: "Thriller", value: "thriller" }, { label: "Romance", value: "romance" }, { label: "Children", value: "children" }, { label: "Drama", value: "drama" }] } };
    }
    __name(o2, "o");
    return o2.prototype.popularNovels = function(n2, a2) {
      return e(this, arguments, void 0, (function(e2, n3) {
        var a3, i2, o3, s = this, l = (n3.showLatestNovels, n3.filters);
        return t(this, (function(t2) {
          switch (t2.label) {
            case 0:
              return (null === (o3 = null == l ? void 0 : l.genres) || void 0 === o3 ? void 0 : o3.value) ? [4, (0, r.fetchApi)(this.site + "/genre/".concat(l.genres.value, "/").concat(e2, "?period=alltime&sort=popular"))] : [3, 2];
            case 1:
              return a3 = t2.sent(), [3, 4];
            case 2:
              return [4, (0, r.fetchApi)(this.site + "/trending_stories?page=".concat(e2, "&period=alltime"))];
            case 3:
              a3 = t2.sent(), t2.label = 4;
            case 4:
              return t2.trys.push([4, 6, , 7]), [4, a3.json()];
            case 5:
              return i2 = t2.sent(), [3, 7];
            case 6:
              throw t2.sent(), new Error("Failed to load novels, try opening in webview.");
            case 7:
              return [2, i2.stories.map((function(e3) {
                return { name: e3.title, path: s.getPath(e3), cover: e3.vertical_cover.url || e3.vertical_cover.iphone || e3.cover.url };
              }))];
          }
        }));
      }));
    }, o2.prototype.getPath = function(e2) {
      return (e2.category_one || e2.genres[0]) + "/" + e2.id;
      ...
      return e(this, void 0, void 0, (function() {
        ...
        return t(this, (function(t2) {
          switch (t2.label) {
            case 0:
              return [4, (0, r.fetchApi)(this.site + "/stories/".concat(n2))];
            case 1:
              return [4, t2.sent().text()];
            case 2:
              return e2 = t2.sent(), o3 = (0, a.load)(e2), (s = { path: n2, name: o3("h1.story-title").text() }).author = o3("dl > dd > a.author-link").text(), s.genres = o3("dd.genres > a").map((function(e3, t3) {
                return o3(t3).text();
              })).toArray().join(", "), "Complete" === (l = o3('div.dlc > dl:has(dt:contains("Status")) > dd').text().trim()) && (s.status = i.NovelStatus.Completed), "Ongoing" === l && (s.status = i.NovelStatus.Ongoing), [4, (0, r.fetchApi)(this.site + "/api/stories/".concat(n2.split("/")[1]))];
            case 3:
              return [4, t2.sent().json()];
            case 4:
              return c = t2.sent(), s.cover = c.vertical_cover.url, s.summary = o3("p.story-summary").text(), s.chapters = c.chapters.map((function(e3) {
                return { name: e3.name, path: n2 + "/chapters/" + e3.chapter_number, chapterNumber: e3.chapter_number };
              })), [2, s];
          }
        }));
      }));
      ...
      return e(this, void 0, void 0, (function() {
        ...
        return t(this, (function(t2) {
          switch (t2.label) {
            case 0:
              return [4, (0, r.fetchApi)(this.site + "/stories/" + n2)];
            case 1:
              return [4, t2.sent().text()];
            case 2:
              return e2 = t2.sent(), [2, (0, a.load)(e2)("div#chapterText").html() || ""];
          }
        }));
      }));
      ...
      return e(this, void 0, void 0, (function() {
        ...
        return t(this, (function(t2) {
          switch (t2.label) {
            case 0:
              return [4, (0, r.fetchApi)(this.site + "/api/2/search/title?q=".concat(encodeURIComponent(n2), "&page=").concat(a2))];
            case 1:
              e2 = t2.sent(), t2.label = 2;
            case 2:
              return t2.trys.push([2, 4, , 5]), [4, e2.json()];
            case 3:
              return i2 = t2.sent(), [3, 5];
            case 4:
              throw t2.sent(), new Error("Failed to search novels, try opening in webview.");
            case 5:
              return [2, i2.stories.map((function(e3) {
                return { name: e3.title, path: o3.getPath(e3), cover: e3.vertical_cover.url || e3.vertical_cover.iphone || e3.cover.url };
              }))];
          }
        }));
      }));
