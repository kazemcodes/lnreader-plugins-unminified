...
var LNReaderPlugin = (() => {
  ...
  var init_load_parse = __esm({
    "node_modules/cheerio/dist/browser/load-parse.js"() {
      ...
      import_htmlparser2 = __toESM(require_lib6(), 1);
  ...
  var a, o = require_lib6(), r = (init_fetch2(), __toCommonJS(fetch_exports)), l = (init_novelStatus(), __toCommonJS(novelStatus_exports)), s = (init_browser(), __toCommonJS(browser_exports)), i = function() {
    function i2(e2) {
      var t2;
      ...
      this.version = "2.2.".concat(0 + n2), this.options = e2.options, this.filters = e2.filters;
    }
    __name(i2, "i");
    return i2.prototype.sleep = function(e2) {
      ...
      var n2, r2 = this, l2 = [], s2 = {}, i3 = [a.Idle], c2 = /* @__PURE__ */ __name(function() {
        ...
        if (((null === (o2 = t3.class) || void 0 === o2 ? void 0 : o2.includes("archive")) || "col-content" === t3.class) && (u(a.NovelList), n2 = 0), l3 === a.NovelList || l3 === a.NovelName) switch (e2) {
          case "img":
            ...
            i4 && (s2.cover = new URL(i4, r2.site).href);
            break;
          case "h3":
          ...
          case "a":
            if (l3 === a.NovelName) {
              var v2 = t3.href;
              v2 && (s2.path = new URL(v2, r2.site).pathname.substring(1), s2.name = t3.title);
            }
            break;
          case "div":
            n2++;
        ...
        var o2 = c2();
        "a" === t3 && o2 === a.NovelName && (s2.name && s2.path && l2.push(e({}, s2)), s2 = {}, v()), "div" === t3 && o2 === a.NovelList && --n2 < 0 && v();
      }, "onclosetag") });
      return h.write(t2), h.end(), l2;
    }, i2.prototype.popularNovels = function(e2, a2) {
      return t(this, arguments, void 0, function(e3, t2) {
        var a3, o2, l2, s2, i3, c2, u, v, h, p, d, f, g, b, m, y, w, S, k, N, C, x, L = t2.filters, P = t2.showLatestNovels;
        return n(this, function(t3) {
          switch (t3.label) {
            case 0:
              return a3 = this.options, o2 = a3.pageParam, l2 = void 0 === o2 ? "page" : o2, s2 = a3.novelListing, i3 = a3.typeParam, c2 = void 0 === i3 ? "type" : i3, u = a3.latestPage, v = a3.genreParam, h = void 0 === v ? "category_novel" : v, p = a3.genreKey, d = void 0 === p ? "id" : p, f = a3.langParam, g = a3.urlLangCode, b = a3.noPages, m = void 0 === b ? [] : b, y = a3.pageAsPath, w = void 0 !== y && y, 1 !== e3 && !P && !L.genres.value.length && m.length > 0 && m.includes(L.type.value) ? [2, []] : (S = "", s2 ? (k = new URLSearchParams(), P ? k.append(c2, u) : L.genres.value.length ? (k.append(c2, h), k.append(d, L.genres.value)) : k.append(c2, L.type.value), f && g && k.append(f, g), k.append(l2, e3.toString()), S = "".concat(this.site).concat(s2, "?").concat(k.toString())) : (N = P ? u : L.genres.value.length ? L.genres.value : L.type.value, S = w ? e3 > 1 ? "".concat(this.site).concat(N, "/").concat(e3.toString()) : "".concat(this.site).concat(N) : "".concat(this.site).concat(N, "?").concat(l2, "=").concat(e3.toString())), [4, (0, r.fetchApi)(S)]);
            case 1:
    ...
    }, i2.prototype.parseNovel = function(s2) {
      return t(this, void 0, void 0, function() {
        var t2, i3, c2, u, v, h, p, d, f, g, b, m, y, w, S, k, N, C, x, L, P, j, I, A, G, H, U, O, R = this;
        return n(this, function(n2) {
          switch (n2.label) {
            case 0:
              return t2 = this.site + s2, [4, (0, r.fetchApi)(t2)];
            case 1:
              return [4, n2.sent().text()];
            case 2:
              return i3 = n2.sent(), c2 = { path: s2, chapters: [] }, u = [], v = [], h = [], p = [], d = [], f = [], g = null, b = {}, m = 0, w = [a.Idle], S = /* @__PURE__ */ __name(function() {
                return w[w.length - 1];
                ...
                switch (e2) {
                  ...
                  case "img":
                    if (l2 === a.Cover) {
                      var i4 = null !== (o2 = null !== (n3 = t3.src) && void 0 !== n3 ? n3 : t3["data-cfsrc"]) && void 0 !== o2 ? o2 : t3["data-src"], v2 = t3.title;
                      i4 && (c2.cover = new URL(i4, R.site).href), v2 ? c2.name = v2 : N();
                    }
                    break;
                  case "h3":
                  ...
                  case "a":
                    if (l2 === a.ChapterList) {
                      m++;
                      var p2 = t3.href;
                      k(a.Chapter), b.name = t3.title || "Chapter ".concat(m), b.releaseTime = null, b.chapterNumber = m, b.path = (null == p2 ? void 0 : p2.substring(1)) || s2.replace(".html", "/chapter-".concat(m, ".html"));
                    }
                }
                ...
                switch (t3) {
                  ...
                  case "h3":
                    ...
                    break;
                  case "a":
                    n3 === a.Chapter && (b.name && b.path && f.push(e({}, b)), b = {}, N());
                    break;
                  case "li":
                    n3 === a.Info && d.push("\n");
                    break;
                  ...
                  if (d.join("").split("\n").map(function(e3) {
                    ...
                    switch (a2) {
                      ...
                      case "status":
                        ...
                        c2.status = null !== (t3 = r2[o2.toLowerCase()]) && void 0 !== t3 ? t3 : l.NovelStatus.Unknown;
                        break;
                      default:
                        return;
                    }
                ...
                } else c2.genres = p.join("").trim(), c2.author = h.join("").trim(), c2.status = v.join("").toLowerCase().replace(/\b\w/g, function(e3) {
            ...
            case 4:
              return (I = n2.sent()).ok ? [3, 5] : (console.error("Failed to fetch chapters: ".concat(I.status)), c2.chapters = [], [3, 7]);
            case 5:
              return [4, I.text()];
            case 6:
              ...
              }, "onclosetag") })).write(A), U.end(), c2.chapters = G, n2.label = 7;
            case 7:
              return [2, c2];
          }
        });
      ...
      return t(this, void 0, void 0, function() {
        var t2, l2, i3, c2, u, v, h, p, d, f, g, b, m, y, w;
        return n(this, function(n2) {
          switch (n2.label) {
            case 0:
            ...
            case 1:
              return [4, n2.sent().text()];
            case 2:
              if (t2 = n2.sent(), null === (w = this.options) || void 0 === w ? void 0 : w.customJs) try {
                l2 = (0, s.load)(t2), t2 = l2.html();
              } catch (e3) {
                throw console.error("Error executing customJs:", e3), e3;
              }
              return u = [], v = false, h = "", p = [a.Idle], d = /* @__PURE__ */ __name(function() {
                return p[p.length - 1];
              }, "d"), f = /* @__PURE__ */ __name(function(e3) {
                return p.push(e3);
                ...
                var n3, o2 = d(), r2 = null === (n3 = t3.class) || void 0 === n3 ? void 0 : n3.trim();
                switch (o2) {
                  case a.Idle:
                    "txt" !== r2 && "chr-content" !== t3.id && "chapter-content" !== t3.id || (f(a.Chapter), i3 = 0);
                    break;
                  case a.Chapter:
                    "sub" === e3 ? f(a.Hidden) : "div" === e3 && (i3++, ((null == r2 ? void 0 : r2.includes("unlock-buttons")) || (null == r2 ? void 0 : r2.includes("ads"))) && (f(a.Hidden), c2 = 0));
                    break;
                  case a.Hidden:
                    "sub" === e3 ? f(a.Hidden) : "div" === e3 && c2++;
                    break;
                  default:
                    return;
                }
                if (d() === a.Chapter) {
                  var l3 = Object.keys(t3);
                  if (0 === l3.length) u.push("<".concat(e3, ">"));
                  else if (l3.every(function(e4) {
                    return "" === t3[e4].trim();
                  })) {
                    v = true, h = e3;
                    ...
                    u.push(m("<".concat(s2, " ").concat(l3.join(" "), ">")));
                  } else {
                    var p2 = l3.map(function(e4) {
                      return " ".concat(e4, '="').concat(t3[e4].replace(/"/g, "&quot;"), '"');
                    }).join("");
                    u.push("<".concat(e3).concat(p2, ">"));
                  }
                }
              }, "onopentag"), ontext: /* @__PURE__ */ __name(function(e3) {
                d() === a.Chapter && u.push(m(e3));
              }, "ontext"), onclosetag: /* @__PURE__ */ __name(function(e3) {
                var t3 = d();
                t3 === a.Hidden && ("sub" === e3 ? g() : "div" === e3 && --c2 < 0 && (g(), i3--)), t3 === a.Chapter && (y.isVoidElement(e3) || (v && e3 === h ? (v = false, h = "") : u.push("</".concat(e3, ">"))), "div" === e3 && --i3 < 0 && f(a.Stopped));
              }, "onclosetag") }), y.write(t2), y.end(), [2, u.join("")];
          }
        });
      });
    }, i2.prototype.searchNovels = function(a2, o2) {
      return t(this, void 0, void 0, function() {
        var t2, l2, s2, i3, c2, u, v, h, p, d, f, g, b, m, y, w, S, k, N, C;
        return n(this, function(n2) {
          switch (n2.label) {
            case 0:
            ...
            case 1:
              n2.sent(), n2.label = 2;
            case 2:
              return l2 = this.options, s2 = l2.pageParam, i3 = void 0 === s2 ? "page" : s2, c2 = l2.searchKey, u = void 0 === c2 ? "keyword" : c2, v = l2.postSearch, h = l2.langParam, p = l2.urlLangCode, d = l2.searchPage, f = new URLSearchParams(e(e(((S = {})[u] = a2, S), h && p && ((k = {})[h] = p, k)), !v && ((N = {})[i3] = o2.toString(), N))), g = "".concat(this.site).concat(d).concat(v ? "" : "?".concat(f.toString())), b = v ? { method: "POST", body: f.toString(), headers: { "Content-Type": "application/x-www-form-urlencoded" } } : void 0, [4, (0, r.fetchApi)(g, b)];
            case 3:
