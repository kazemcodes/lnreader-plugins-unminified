...
var LNReaderPlugin = (() => {
  ...
  var e = function() {
    return e = Object.assign || function(e2) {
      for (var t2, n2 = 1, a2 = arguments.length; n2 < a2; n2++) for (var o2 in t2 = arguments[n2]) Object.prototype.hasOwnProperty.call(t2, o2) && (e2[o2] = t2[o2]);
      return e2;
    }, e.apply(this, arguments);
  }, t = function(e2, t2, n2, a2) {
    return new (n2 || (n2 = Promise))(function(o2, r2) {
      ...
      __name(i2, "i");
      i2((a2 = a2.apply(e2, t2 || [])).next());
    });
  }, n = function(e2, t2) {
    var n2, a2, o2, r2 = { label: 0, sent: /* @__PURE__ */ __name(function() {
    ...
    function s2(s3) {
      return function(i2) {
        return function(s4) {
          ...
          for (; l2 && (l2 = 0, s4[0] && (r2 = 0)), r2; ) try {
            if (n2 = 1, a2 && (o2 = 2 & s4[0] ? a2.return : s4[0] ? a2.throw || ((o2 = a2.return) && o2.call(a2), 0) : a2.next) && !(o2 = o2.call(a2, s4[1])).done) return o2;
            switch (a2 = 0, o2 && (s4 = [2 & s4[0], o2.value]), s4[0]) {
              case 0:
              case 1:
                o2 = s4;
                break;
              ...
              case 7:
                ...
                continue;
              default:
                if (!(o2 = r2.trys, (o2 = o2.length > 0 && o2[o2.length - 1]) || 6 !== s4[0] && 2 !== s4[0])) {
                  r2 = 0;
                  continue;
                }
  ...
  var a, o = require_lib6(), r = (init_fetch2(), __toCommonJS(fetch_exports)), l = (init_novelStatus(), __toCommonJS(novelStatus_exports)), s = function() {
    function s2(e2) {
      var t2;
      ...
      this.version = "2.1.".concat(2 + n2), this.options = e2.options, this.filters = e2.filters;
    }
    __name(s2, "s");
    return s2.prototype.sleep = function(e2) {
      ...
      var n2, r2 = this, l2 = [], s3 = {}, i2 = [a.Idle], c = /* @__PURE__ */ __name(function() {
        return i2[i2.length - 1];
      }, "c"), u = /* @__PURE__ */ __name(function(e2) {
        return i2.push(e2);
      }, "u"), v = /* @__PURE__ */ __name(function() {
        return i2.length > 1 ? i2.pop() : c();
      }, "v"), h = new o.Parser({ onopentag: /* @__PURE__ */ __name(function(e2, t3) {
        var o2, l3 = c();
        if (((null === (o2 = t3.class) || void 0 === o2 ? void 0 : o2.includes("archive")) || "col-content" === t3.class) && (u(a.NovelList), n2 = 0), l3 === a.NovelList || l3 === a.NovelName) switch (e2) {
          case "img":
            var i3 = t3["data-src"] || t3.src;
            i3 && (s3.cover = new URL(i3, r2.site).href);
            break;
          case "h3":
            l3 === a.NovelList && u(a.NovelName);
            break;
          case "a":
            if (l3 === a.NovelName) {
              var v2 = t3.href;
              v2 && (s3.path = new URL(v2, r2.site).pathname.substring(1), s3.name = t3.title);
            }
            break;
          case "div":
            n2++;
        ...
        var o2 = c();
        "a" === t3 && o2 === a.NovelName && (s3.name && s3.path && l2.push(e({}, s3)), s3 = {}, v()), "div" === t3 && o2 === a.NovelList && --n2 < 0 && v();
      }, "onclosetag") });
      return h.write(t2), h.end(), l2;
    }, s2.prototype.popularNovels = function(e2, a2) {
      return t(this, arguments, void 0, function(e3, t2) {
        var a3, o2, l2, s3, i2, c, u, v, h, p, f, d, g, b, m, y, w, S, k, N, C, x, L = t2.filters, P = t2.showLatestNovels;
        return n(this, function(t3) {
          switch (t3.label) {
            case 0:
              return a3 = this.options, o2 = a3.pageParam, l2 = void 0 === o2 ? "page" : o2, s3 = a3.novelListing, i2 = a3.typeParam, c = void 0 === i2 ? "type" : i2, u = a3.latestPage, v = a3.genreParam, h = void 0 === v ? "category_novel" : v, p = a3.genreKey, f = void 0 === p ? "id" : p, d = a3.langParam, g = a3.urlLangCode, b = a3.noPages, m = void 0 === b ? [] : b, y = a3.pageAsPath, w = void 0 !== y && y, 1 !== e3 && !P && !L.genres.value.length && m.length > 0 && m.includes(L.type.value) ? [2, []] : (S = "", s3 ? (k = new URLSearchParams(), P ? k.append(c, u) : L.genres.value.length ? (k.append(c, h), k.append(f, L.genres.value)) : k.append(c, L.type.value), d && g && k.append(d, g), k.append(l2, e3.toString()), S = "".concat(this.site).concat(s3, "?").concat(k.toString())) : (N = P ? u : L.genres.value.length ? L.genres.value : L.type.value, S = w ? e3 > 1 ? "".concat(this.site).concat(N, "/").concat(e3.toString()) : "".concat(this.site).concat(N) : "".concat(this.site).concat(N, "?").concat(l2, "=").concat(e3.toString())), [4, (0, r.fetchApi)(S)]);
            case 1:
      ...
      return t(this, void 0, void 0, function() {
        var t2, i2, c, u, v, h, p, f, d, g, b, m, y, w, S, k, N, C, x, L, P, j, I, A, G, H, U, O, R = this;
        return n(this, function(n2) {
          switch (n2.label) {
            case 0:
              return t2 = this.site + s3, [4, (0, r.fetchApi)(t2)];
            case 1:
              return [4, n2.sent().text()];
            case 2:
              return i2 = n2.sent(), c = { path: s3, chapters: [] }, u = [], v = [], h = [], p = [], f = [], d = [], g = null, b = {}, m = 0, w = [a.Idle], S = /* @__PURE__ */ __name(function() {
                return w[w.length - 1];
              }, "S"), k = /* @__PURE__ */ __name(function(e2) {
                return w.push(e2);
              }, "k"), N = /* @__PURE__ */ __name(function() {
                return w.length > 1 ? w.pop() : S();
              }, "N"), C = new o.Parser({ onopentag: /* @__PURE__ */ __name(function(e2, t3) {
                var n3, o2, r2, l2 = S();
                switch (e2) {
                  case "div":
                    switch (t3.class) {
                      case "books":
                      case "m-imgtxt":
                        return void k(a.Cover);
                      case "inner":
                      case "desc-text":
                        l2 === a.Cover && N(), k(a.Summary);
                        break;
                      case "info":
                        k(a.Info), y = 0;
                    }
                    R.options.noAjax || "rating" !== t3.id || (g = t3["data-novel-id"]), l2 === a.Info && y++;
                    break;
                  case "img":
                    if (l2 === a.Cover) {
                      var i3 = null !== (o2 = null !== (n3 = t3.src) && void 0 !== n3 ? n3 : t3["data-cfsrc"]) && void 0 !== o2 ? o2 : t3["data-src"], v2 = t3.title;
                      i3 && (c.cover = new URL(i3, R.site).href), v2 ? c.name = v2 : N();
                    }
                    break;
                  case "h3":
                    l2 === a.Cover && k(a.NovelName);
                    break;
                  case "span":
                    if (l2 === a.Cover && t3.title) {
                      var h2 = { Genre: a.Genres, Author: a.Author, Status: a.Status }[t3.title];
                      h2 && k(h2);
                    }
                    break;
                  case "br":
                    ...
                    break;
                  case "ul":
                    (null === (r2 = t3.class) || void 0 === r2 ? void 0 : r2.includes("info-meta")) && k(a.Info), R.options.noAjax && "idData" === t3.id && k(a.ChapterList);
                    break;
                  case "a":
                    if (l2 === a.ChapterList) {
                      m++;
                      var p2 = t3.href;
                      k(a.Chapter), b.name = t3.title || "Chapter ".concat(m), b.releaseTime = null, b.chapterNumber = m, b.path = (null == p2 ? void 0 : p2.substring(1)) || s3.replace(".html", "/chapter-".concat(m, ".html"));
                    }
                }
                ...
                switch (t3) {
                  ...
                  case "h3":
                    ...
                    break;
                  case "a":
                    n3 === a.Chapter && (b.name && b.path && d.push(e({}, b)), b = {}, N());
                    break;
                  case "li":
                    n3 === a.Info && f.push("\n");
                    break;
                ...
                if (f.length) {
                  if (f.join("").split("\n").map(function(e3) {
                    ...
                    var t3, n3 = e3.split(":"), a2 = n3[0].trim().toLowerCase(), o2 = n3[1].split(",").map(function(e4) {
                      return e4.trim();
                    }).join(", ");
                    switch (a2) {
                      case "author":
                      ...
                      case "genre":
                        ...
                        break;
                      case "status":
                        var r2 = { ongoing: l.NovelStatus.Ongoing, hiatus: l.NovelStatus.OnHiatus, dropped: l.NovelStatus.Cancelled, cancelled: l.NovelStatus.Cancelled, completed: l.NovelStatus.Completed };
                        c.status = null !== (t3 = r2[o2.toLowerCase()]) && void 0 !== t3 ? t3 : l.NovelStatus.Unknown;
                        break;
                      default:
                        return;
                    }
                ...
                } else c.genres = p.join("").trim(), c.author = h.join("").trim(), c.status = v.join("").toLowerCase().replace(/\b\w/g, function(e3) {
                  return e3.toUpperCase();
                });
                c.summary = u.join("\n\n").trim();
              }, "onend") }), C.write(i2), C.end(), this.options.noAjax && d.length > 0 ? (c.chapters = d, [3, 7]) : [3, 3];
            case 3:
              return null === g ? [3, 7] : (x = this.options.chapterListing || "ajax/chapter-archive", L = this.options.chapterParam || "novelId", P = new URLSearchParams(((O = {})[L] = g, O)), j = "".concat(this.site).concat(x, "?").concat(P.toString()), [4, (0, r.fetchApi)(j)]);
            case 4:
              return (I = n2.sent()).ok ? [3, 5] : (console.error("Failed to fetch chapters: ".concat(I.status)), c.chapters = [], [3, 7]);
            case 5:
              return [4, I.text()];
            case 6:
              A = n2.sent(), G = [], H = {}, (U = new o.Parser({ onopentag: /* @__PURE__ */ __name(function(e2, t3) {
                var n3, o2;
                if ("a" === e2 && t3.href ? (n3 = t3.href, o2 = t3.title || "", k(a.Chapter)) : "option" === e2 && t3.value && (n3 = t3.value, o2 = "", k(a.Chapter)), void 0 !== n3) {
                  var r2 = new URL(n3, R.site);
                  H.path = r2.pathname.substring(1), H.name = o2;
                }
              }, "onopentag"), ontext: /* @__PURE__ */ __name(function(e2) {
                var t3 = e2.trim();
                S() === a.Chapter && !H.name && t3 && (H.name += t3);
              }, "ontext"), onclosetag: /* @__PURE__ */ __name(function(t3) {
                "a" !== t3 && "option" !== t3 || S() !== a.Chapter || (H.name && H.path && (H.name = H.name.trim(), H.releaseTime = null, G.push(e({}, H))), H = {}, N());
              }, "onclosetag") })).write(A), U.end(), c.chapters = G, n2.label = 7;
            case 7:
              return [2, c];
          }
        });
      ...
      return t(this, void 0, void 0, function() {
        var t2, l2, s3, i2, c, u, v, h, p, f, d, g, b, m;
        return n(this, function(n2) {
          switch (n2.label) {
            case 0:
              return [4, (0, r.fetchApi)(this.site + e2)];
            case 1:
              return [4, n2.sent().text()];
            case 2:
              return t2 = n2.sent(), i2 = [], c = false, u = "", v = [a.Idle], h = /* @__PURE__ */ __name(function() {
                return v[v.length - 1];
              }, "h"), p = /* @__PURE__ */ __name(function(e3) {
                return v.push(e3);
              }, "p"), f = /* @__PURE__ */ __name(function() {
                return v.length > 1 ? v.pop() : h();
              }, "f"), d = /[&<>"' ]/g, g = { "&": "&amp;", "<": "&lt;", ">": "&gt;", '"': "&quot;", "'": "&#39;", "\xA0": "&nbsp;" }, b = /* @__PURE__ */ __name(function(e3) {
                return e3.replace(d, function(e4) {
                  return g[e4];
                });
              }, "b"), m = new o.Parser({ onopentag: /* @__PURE__ */ __name(function(e3, t3) {
                var n3, o2 = h(), r2 = null === (n3 = t3.class) || void 0 === n3 ? void 0 : n3.trim();
                switch (o2) {
                  case a.Idle:
                    "txt" !== r2 && "chr-content" !== t3.id && "chapter-content" !== t3.id || (p(a.Chapter), l2 = 0);
                    break;
                  case a.Chapter:
                    "sub" === e3 ? p(a.Hidden) : "div" === e3 && (l2++, ((null == r2 ? void 0 : r2.includes("unlock-buttons")) || (null == r2 ? void 0 : r2.includes("ads"))) && (p(a.Hidden), s3 = 0));
                    break;
                  case a.Hidden:
                    "sub" === e3 ? p(a.Hidden) : "div" === e3 && s3++;
                    break;
                  default:
                    return;
                }
                if (h() === a.Chapter) {
                  var v2 = Object.keys(t3);
                  if (0 === v2.length) i2.push("<".concat(e3, ">"));
                  else if (v2.every(function(e4) {
                    return "" === t3[e4].trim();
                  })) {
                    c = true, u = e3;
                    ...
                    i2.push(b("<".concat(f2, " ").concat(v2.join(" "), ">")));
                  } else {
                    var d2 = v2.map(function(e4) {
                      return " ".concat(e4, '="').concat(t3[e4].replace(/"/g, "&quot;"), '"');
                    }).join("");
                    i2.push("<".concat(e3).concat(d2, ">"));
                  }
                }
              }, "onopentag"), ontext: /* @__PURE__ */ __name(function(e3) {
                h() === a.Chapter && i2.push(b(e3));
              }, "ontext"), onclosetag: /* @__PURE__ */ __name(function(e3) {
                var t3 = h();
                t3 === a.Hidden && ("sub" === e3 ? f() : "div" === e3 && --s3 < 0 && (f(), l2--)), t3 === a.Chapter && (m.isVoidElement(e3) || (c && e3 === u ? (c = false, u = "") : i2.push("</".concat(e3, ">"))), "div" === e3 && --l2 < 0 && p(a.Stopped));
              }, "onclosetag") }), m.write(t2), m.end(), [2, i2.join("")];
          }
        });
      });
    }, s2.prototype.searchNovels = function(a2, o2) {
      return t(this, void 0, void 0, function() {
        var t2, l2, s3, i2, c, u, v, h, p, f, d, g, b, m, y, w, S, k, N, C;
        return n(this, function(n2) {
          switch (n2.label) {
            case 0:
            ...
            case 1:
              n2.sent(), n2.label = 2;
            case 2:
              return l2 = this.options, s3 = l2.pageParam, i2 = void 0 === s3 ? "page" : s3, c = l2.searchKey, u = void 0 === c ? "keyword" : c, v = l2.postSearch, h = l2.langParam, p = l2.urlLangCode, f = l2.searchPage, d = new URLSearchParams(e(e(((S = {})[u] = a2, S), h && p && ((k = {})[h] = p, k)), !v && ((N = {})[i2] = o2.toString(), N))), g = "".concat(this.site).concat(f).concat(v ? "" : "?".concat(d.toString())), b = v ? { method: "POST", body: d.toString(), headers: { "Content-Type": "application/x-www-form-urlencoded" } } : void 0, [4, (0, r.fetchApi)(g, b)];
            case 3:
              if (m = n2.sent(), this.lastSearch = Date.now(), !m.ok) throw new Error("Could not reach site ('".concat(m.status, "') try to open in webview."));
              return [4, m.text()];
            case 4:
              if (y = n2.sent(), w = (null === (C = y.match(/alert\((.*?)\)/)) || void 0 === C ? void 0 : C[1]) || "") throw new Error(w);
