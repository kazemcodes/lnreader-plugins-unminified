...
var LNReaderPlugin = (() => {
  ...
  var a, o = require_lib6(), r = (init_fetch2(), __toCommonJS(fetch_exports)), l = (init_novelStatus(), __toCommonJS(novelStatus_exports)), s = (function() {
    ...
    return s2.prototype.sleep = function(e2) {
      ...
      var n2, r2 = this, l2 = [], s3 = {}, i2 = [a.Idle], c = function() {
        return i2[i2.length - 1];
      }, u = function(e2) {
        return i2.push(e2);
      }, v = function() {
        return i2.length > 1 ? i2.pop() : c();
      }, h = new o.Parser({ onopentag: function(e2, t3) {
        var o2, l3 = c();
      ...
      return t(this, void 0, void 0, (function() {
        ...
        return n(this, (function(n2) {
          switch (n2.label) {
            ...
            case 2:
              return i2 = n2.sent(), c = { path: s3, chapters: [] }, u = [], v = [], h = [], p = [], f = [], d = [], g = null, b = {}, m = 0, w = [a.Idle], S = function() {
                return w[w.length - 1];
              }, k = function(e2) {
                return w.push(e2);
              }, N = function() {
                return w.length > 1 ? w.pop() : S();
              }, C = new o.Parser({ onopentag: function(e2, t3) {
                var n3, o2, r2, l2 = S();
                switch (e2) {
                  case "div":
                    switch (t3.class) {
                ...
                c.summary = u.join("\n\n").trim();
              } }), C.write(i2), C.end(), this.options.noAjax && d.length > 0 ? (c.chapters = d, [3, 7]) : [3, 3];
            case 3:
            ...
            case 5:
              return [4, I.text()];
            case 6:
              A = n2.sent(), G = [], H = {}, (U = new o.Parser({ onopentag: function(e2, t3) {
                var n3, o2;
              ...
              } })).write(A), U.end(), c.chapters = G, n2.label = 7;
            case 7:
              return [2, c];
          }
        }));
        ...
        return n(this, (function(n2) {
          switch (n2.label) {
            ...
            case 1:
              return [4, n2.sent().text()];
            case 2:
              return t2 = n2.sent(), i2 = [], c = false, u = "", v = [a.Idle], h = function() {
                return v[v.length - 1];
              }, p = function(e3) {
                return v.push(e3);
              }, f = function() {
                return v.length > 1 ? v.pop() : h();
              }, d = /[&<>"' ]/g, g = { "&": "&amp;", "<": "&lt;", ">": "&gt;", '"': "&quot;", "'": "&#39;", "\xA0": "&nbsp;" }, b = function(e3) {
                return e3.replace(d, (function(e4) {
                  return g[e4];
                }));
              }, m = new o.Parser({ onopentag: function(e3, t3) {
