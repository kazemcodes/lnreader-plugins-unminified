...
(() => {
  ...
  // .js/plugins/english/webnovel.js
  var e = function(e2, t2, a2, n2) {
    return new (a2 || (a2 = Promise))((function(l2, r2) {
      function i2(e3) {
        try {
          s(n2.next(e3));
        } catch (e4) {
      ...
      function s(e3) {
        var t3;
        e3.done ? l2(e3.value) : (t3 = e3.value, t3 instanceof a2 ? t3 : new a2((function(e4) {
          e4(t3);
        }))).then(i2, o);
      }
      __name(s, "s");
    ...
    var a2, n2, l2, r2 = { label: 0, sent: /* @__PURE__ */ __name(function() {
      ...
      return function(s) {
        return (function(o3) {
          ...
          for (; i2 && (i2 = 0, o3[0] && (r2 = 0)), r2; ) try {
            if (a2 = 1, n2 && (l2 = 2 & o3[0] ? n2.return : o3[0] ? n2.throw || ((l2 = n2.return) && l2.call(n2), 0) : n2.next) && !(l2 = l2.call(n2, o3[1])).done) return l2;
            switch (n2 = 0, l2 && (o3 = [2 & o3[0], l2.value]), o3[0]) {
              case 0:
              case 1:
                l2 = o3;
                break;
              ...
              case 5:
                r2.label++, n2 = o3[1], o3 = [0];
                continue;
              case 7:
                o3 = r2.ops.pop(), r2.trys.pop();
                continue;
              default:
                if (!(l2 = r2.trys, (l2 = l2.length > 0 && l2[l2.length - 1]) || 6 !== o3[0] && 2 !== o3[0])) {
                  r2 = 0;
                  continue;
                }
                if (3 === o3[0] && (!l2 || o3[1] > l2[0] && o3[1] < l2[3])) {
                  r2.label = o3[1];
                  break;
                }
                if (6 === o3[0] && r2.label < l2[1]) {
                  r2.label = l2[1], l2 = o3;
                  break;
                }
                if (l2 && r2.label < l2[2]) {
                  r2.label = l2[2], r2.ops.push(o3);
                  break;
                }
  ...
  var a = (init_browser(), __toCommonJS(browser_exports)), n = (init_fetch2(), __toCommonJS(fetch_exports)), l = (init_filterInputs(), __toCommonJS(filterInputs_exports)), r = (init_storage2(), __toCommonJS(storage_exports)), i = (function() {
    function i2() {
      this.id = "webnovel", this.name = "Webnovel", this.version = "1.0.3", this.icon = "src/en/webnovel/icon.png", this.site = "https://www.webnovel.com", this.headers = { "User-Agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.0.0 Safari/537.36" }, this.imageRequestInit = { headers: { referrer: this.site } }, this.hideLocked = r.storage.get("hideLocked"), this.pluginSettings = { hideLocked: { value: "", label: "Hide locked chapters", type: "Switch" } }, this.filters = { sort: { label: "Sort Results By", value: "1", options: [{ label: "Popular", value: "1" }, { label: "Recommended", value: "2" }, { label: "Most Collections", value: "3" }, { label: "Rating", value: "4" }, { label: "Time Updated", value: "5" }], type: l.FilterTypes.Picker }, status: { label: "Content Status", value: "0", options: [{ label: "All", value: "0" }, { label: "Completed", value: "2" }, { label: "Ongoing", value: "1" }], type: l.FilterTypes.Picker }, genres_gender: { label: "Genres (Male/Female)", value: "1", options: [{ label: "Male", value: "1" }, { label: "Female", value: "2" }], type: l.FilterTypes.Picker }, genres_male: { label: "Male Genres", value: "1", options: [{ label: "All", value: "1" }, { label: "Action", value: "novel-action-male" }, { label: "Animation, Comics, Games", value: "novel-acg-male" }, { label: "Eastern", value: "novel-eastern-male" }, { label: "Fantasy", value: "novel-fantasy-male" }, { label: "Games", value: "novel-games-male" }, { label: "History", value: "novel-history-male" }, { label: "Horror", value: "novel-horror-male" }, { label: "Realistic", value: "novel-realistic-male" }, { label: "Sci-fi", value: "novel-scifi-male" }, { label: "Sports", value: "novel-sports-male" }, { label: "Urban", value: "novel-urban-male" }, { label: "War", value: "novel-war-male" }], type: l.FilterTypes.Picker }, genres_female: { label: "Female Genres", value: "2", options: [{ label: "All", value: "2" }, { label: "Fantasy", value: "novel-fantasy-female" }, { label: "General", value: "novel-general-female" }, { label: "History", value: "novel-history-female" }, { label: "LGBT+", value: "novel-lgbt-female" }, { label: "Sci-fi", value: "novel-scifi-female" }, { label: "Teen", value: "novel-teen-female" }, { label: "Urban", value: "novel-urban-female" }], type: l.FilterTypes.Picker }, type: { label: "Content Type", value: "0", options: [{ label: "All", value: "0" }, { label: "Translate", value: "1" }, { label: "Original", value: "2" }, { label: "MTL (Machine Translation)", value: "3" }], type: l.FilterTypes.Picker }, fanfic_search: { label: "Search fanfics (Overrides other filters)", value: "", type: l.FilterTypes.TextInput } };
    }
    __name(i2, "i");
    return i2.prototype.parseNovels = function(a2, n2, l2) {
      return e(this, void 0, void 0, (function() {
        var e2;
        return t(this, (function(t2) {
          return e2 = n2 ? "data-original" : l2 ? "src" : "", [2, a2("".concat(n2 ? ".j_category_wrapper" : l2 ? ".j_list_container" : "", " li")).map((function(t3, n3) {
            var l3 = a2(n3).find(".g_thumb").attr("title") || "No Title Found", r2 = a2(n3).find(".g_thumb > img").attr(e2), i3 = a2(n3).find(".g_thumb").attr("href");
            return i3 ? { name: l3, cover: "https:" + r2, path: i3 } : null;
          })).get().filter((function(e3) {
            return null !== e3;
          }))];
        }));
      }));
    }, i2.prototype.popularNovels = function(l2, r2) {
      return e(this, arguments, void 0, (function(e2, l3) {
        var r3, i3, o, s, u = l3.showLatestNovels, c = l3.filters;
        return t(this, (function(t2) {
          switch (t2.label) {
            case 0:
              return (null == c ? void 0 : c.fanfic_search.value) ? [2, this.searchNovelsInternal(c.fanfic_search.value, e2, "fanfic")] : (r3 = this.site + "/stories/", i3 = new URLSearchParams(), u ? r3 += "novel?orderBy=5&pageIndex=".concat(e2) : c ? ("1" === c.genres_gender.value ? "1" !== c.genres_male.value ? r3 += c.genres_male.value : (r3 += "novel", i3.append("gender", "1")) : "2" === c.genres_gender.value && ("2" !== c.genres_female.value ? r3 += c.genres_female.value : (r3 += "novel", i3.append("gender", "2"))), "3" !== c.type.value ? i3.append("sourceType", c.type.value) : (i3.append("translateMode", "3"), i3.append("sourceType", "1")), i3.append("bookStatus", c.status.value), i3.append("orderBy", c.sort.value), i3.append("pageIndex", e2.toString()), r3 += "?" + i3.toString()) : r3 += "novel?orderBy=1&pageIndex=".concat(e2), [4, (0, n.fetchApi)(r3, { headers: this.headers })]);
            case 1:
              return [4, t2.sent().text()];
            case 2:
              return o = t2.sent(), s = (0, a.load)(o), [2, this.parseNovels(s, true, false)];
          }
        }));
      }));
    }, i2.prototype.parseChapters = function(l2) {
      return e(this, void 0, void 0, (function() {
        var e2, r2, i3, o, s = this;
        return t(this, (function(t2) {
          switch (t2.label) {
            case 0:
              return e2 = this.site + l2 + "/catalog", [4, (0, n.fetchApi)(e2, { headers: this.headers })];
            case 1:
              return [4, t2.sent().text()];
            case 2:
              return r2 = t2.sent(), i3 = (0, a.load)(r2), o = [], i3(".volume-item").each((function(e3, t3) {
                var a2 = i3(t3).first().text().trim().match(/Volume\s(\d+)/), n2 = a2 ? "Volume ".concat(a2[1]) : "Unknown Volume";
                i3(t3).find("li").each((function(e4, t4) {
                  var a3, l3 = "".concat(n2, ": ") + ((null === (a3 = i3(t4).find("a").attr("title")) || void 0 === a3 ? void 0 : a3.trim()) || "No Title Found"), r3 = i3(t4).find("a").attr("href"), u = i3(t4).find("svg").length;
                  !r3 || u && s.hideLocked || o.push({ name: u ? "".concat(l3, " \u{1F512}") : l3, path: r3 });
                }));
              })), [2, o];
          }
        }));
      ...
      return e(this, void 0, void 0, (function() {
        ...
        return t(this, (function(t2) {
          switch (t2.label) {
            case 0:
              return e2 = this.site + l2, [4, (0, n.fetchApi)(e2, { headers: this.headers })];
            case 1:
              return [4, t2.sent().text()];
            case 2:
              return r2 = t2.sent(), i3 = (0, a.load)(r2), o = { path: l2, name: i3(".g_thumb > img").attr("alt") || "No Title Found", cover: "https:" + i3(".g_thumb > img").attr("src"), genres: i3(".det-hd-detail > .det-hd-tag").attr("title") || "", summary: i3(".j_synopsis > p").find("br").replaceWith("\n").end().text().trim() || "No Summary Found", author: i3(".det-info .c_s").filter((function(e3, t3) {
                return "Author:" === i3(t3).text().trim();
              })).next().text().trim() || "No Author Found", status: i3(".det-hd-detail svg").filter((function(e3, t3) {
                return "Status" === i3(t3).attr("title");
              })).next().text().trim() || "Unknown Status" }, [4, this.parseChapters(l2)];
            case 3:
              return o.chapters = t2.sent(), [2, o];
          }
        }));
      }));
        ...
        return t(this, (function(t2) {
          switch (t2.label) {
            ...
            case 1:
              return [4, t2.sent().text()];
            case 2:
              return r2 = t2.sent(), i3 = (0, a.load)(r2), [".para-comment"].forEach((function(e3) {
                return i3(e3).remove();
              })), [2, i3(".cha-tit").html() + i3(".cha-words").html()];
          }
        }));
      }));
    }, i2.prototype.searchNovels = function(a2, n2) {
      return e(this, void 0, void 0, (function() {
        return t(this, (function(e2) {
          return [2, this.searchNovelsInternal(a2, n2)];
        }));
      }));
    }, i2.prototype.searchNovelsInternal = function(l2, r2, i3) {
      return e(this, void 0, void 0, (function() {
        var e2, o, s;
        return t(this, (function(t2) {
          switch (t2.label) {
            case 0:
              return l2 = l2.replace(/\s+/g, "+"), e2 = "".concat(this.site, "/search?keywords=").concat(encodeURIComponent(l2), "&pageIndex=").concat(r2).concat(i3 ? "&type=".concat(i3) : ""), [4, (0, n.fetchApi)(e2, { headers: this.headers })];
            case 1:
              return [4, t2.sent().text()];
            case 2:
              return o = t2.sent(), s = (0, a.load)(o), [2, this.parseNovels(s, false, true)];
          }
        }));
      }));
    }, i2;
