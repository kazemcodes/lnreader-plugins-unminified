...
var LNReaderPlugin = (() => {
  ...
  // .js/plugins/english/KDTNovels[lightnovelwp].js
  init_dirname();
  init_buffer2();
  init_process2();
  ...
  var c = new (function() {
    ...
    return c2.prototype.getHostname = function(e2) {
      ...
      return e(this, void 0, void 0, function() {
        var e2, r2, o2, c3, u, v, h, p, d, f, m, b, g, y, w, k, N, C, S, x, L;
        return t(this, function(t2) {
          switch (t2.label) {
            case 0:
              return e2 = this.site, [4, this.safeFecth(e2 + a2, false)];
            case 1:
              return r2 = t2.sent(), o2 = { path: a2, name: "", genres: "", summary: "", author: "", artist: "", status: "", chapters: [] }, c3 = false, u = false, v = 0, h = false, p = false, d = false, f = false, m = false, b = false, g = false, y = 0, w = false, k = false, N = [], C = {}, S = this.hideLocked, x = new s.Parser({ onopentag: /* @__PURE__ */ __name(function(t3, a3) {
                var s2;
