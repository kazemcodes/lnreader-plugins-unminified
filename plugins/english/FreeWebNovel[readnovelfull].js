  ...
  var n, r = require_lib6(), o = (init_fetch2(), __toCommonJS(fetch_exports)), s = (init_novelStatus(), __toCommonJS(novelStatus_exports)), i = function() {
    ...
    return i2.prototype.sleep = function(e2) {
      ...
      return t(this, arguments, void 0, function(e3, t2) {
        var n3, r2, s2, i3, l2, c, u, h, p, v, d, f, g, b, m, w, y, S, N, k, C, P, L = t2.filters, x = t2.showLatestNovels;
        return a(this, function(t3) {
          switch (t3.label) {
            case 0:
              return n3 = this.options, r2 = n3.pageParam, s2 = void 0 === r2 ? "page" : r2, i3 = n3.novelListing, l2 = n3.typeParam, c = void 0 === l2 ? "type" : l2, u = n3.latestPage, h = n3.genreParam, p = void 0 === h ? "category_novel" : h, v = n3.genreKey, d = void 0 === v ? "id" : v, f = n3.langParam, g = n3.urlLangCode, b = n3.noPages, m = void 0 === b ? [] : b, w = n3.pageAsPath, y = void 0 !== w && w, 1 !== e3 && !x && !L.genres.value.length && m.length > 0 && m.includes(L.type.value) ? [2, []] : (S = "", i3 ? (N = new URLSearchParams(), x ? N.append(c, u) : L.genres.value.length ? (N.append(c, p), N.append(d, L.genres.value)) : N.append(c, L.type.value), f && g && N.append(f, g), N.append(s2, e3.toString()), S = "".concat(this.site).concat(i3, "?").concat(N.toString())) : (k = x ? u : L.genres.value.length ? L.genres.value : L.type.value, S = y ? e3 > 1 ? "".concat(this.site).concat(k, "/").concat(e3.toString()) : "".concat(this.site).concat(k) : "".concat(this.site).concat(k, "?").concat(s2, "=").concat(e3.toString())), [4, (0, o.fetchApi)(S)]);
            case 1:
      ...
      return t(this, void 0, void 0, function() {
        var t2, l2, c, u, h, p, v, d, f, g, b, m, w, y, S, N, k, C, P, L, x, A, j, I, H, G, E, R, M = this;
        return a(this, function(a2) {
          switch (a2.label) {
            ...
            case 2:
              return l2 = a2.sent(), c = { path: i3, chapters: [] }, u = [], h = [], p = [], v = [], d = [], f = [], g = null, b = {}, m = 0, y = [n.Idle], S = /* @__PURE__ */ __name(function() {
                return y[y.length - 1];
              }, "S"), N = /* @__PURE__ */ __name(function(e2) {
                return y.push(e2);
              }, "N"), k = /* @__PURE__ */ __name(function() {
                return y.length > 1 ? y.pop() : S();
              }, "k"), C = new r.Parser({ onopentag: /* @__PURE__ */ __name(function(e2, t3) {
                var a3, r2, o2, s2 = S();
                switch (e2) {
                  case "div":
                    switch (t3.class) {
                    ...
                    M.options.noAjax || "rating" !== t3.id || (g = t3["data-novel-id"]), s2 === n.Info && w++;
                    break;
                  case "img":
                    if (s2 === n.Cover) {
                      var l3 = null !== (r2 = null !== (a3 = t3.src) && void 0 !== a3 ? a3 : t3["data-cfsrc"]) && void 0 !== r2 ? r2 : t3["data-src"], h2 = t3.title;
                      l3 && (c.cover = new URL(l3, M.site).href), h2 ? c.name = h2 : k();
                    }
                    break;
                  case "h3":
                  ...
                  case "a":
                    if (s2 === n.ChapterList) {
                      m++;
                      var v2 = t3.href;
                      N(n.Chapter), b.name = t3.title || "Chapter ".concat(m), b.releaseTime = null, b.chapterNumber = m, b.path = (null == v2 ? void 0 : v2.substring(1)) || i3.replace(".html", "/chapter-".concat(m, ".html"));
                    }
                }
                ...
                switch (t3) {
                  ...
                  case "h3":
                    ...
                    break;
                  case "a":
                    a3 === n.Chapter && (b.name && b.path && f.push(e({}, b)), b = {}, k());
                    break;
                  case "li":
                    a3 === n.Info && d.push("\n");
                    break;
                ...
                c.summary = u.join("\n\n").trim();
              }, "onend") }), C.write(l2), C.end(), this.options.noAjax && f.length > 0 ? (c.chapters = f, [3, 7]) : [3, 3];
            case 3:
              return null === g ? [3, 7] : (P = this.options.chapterListing || "ajax/chapter-archive", L = this.options.chapterParam || "novelId", x = new URLSearchParams(((R = {})[L] = g, R)), A = "".concat(this.site).concat(P, "?").concat(x.toString()), [4, (0, o.fetchApi)(A)]);
            case 4:
              return (j = a2.sent()).ok ? [3, 5] : (console.error("Failed to fetch chapters: ".concat(j.status)), c.chapters = [], [3, 7]);
            case 5:
              return [4, j.text()];
            case 6:
              I = a2.sent(), H = [], G = {}, (E = new r.Parser({ onopentag: /* @__PURE__ */ __name(function(e2, t3) {
                var a3, r2;
                ...
                "a" !== t3 && "option" !== t3 || S() !== n.Chapter || (G.name && G.path && (G.name = G.name.trim(), G.releaseTime = null, H.push(e({}, G))), G = {}, k());
              }, "onclosetag") })).write(I), E.end(), c.chapters = H, a2.label = 7;
            case 7:
              return [2, c];
          }
        });
      ...
      return t(this, void 0, void 0, function() {
        var t2, s2, i3, l2, c, u, h, p, v, d, f, g, b, m;
        return a(this, function(a2) {
          switch (a2.label) {
            case 0:
            ...
            case 2:
              return t2 = a2.sent(), l2 = [], c = false, u = "", h = [n.Idle], p = /* @__PURE__ */ __name(function() {
                ...
                var t3 = p();
                t3 === n.Hidden && ("sub" === e3 ? d() : "div" === e3 && --i3 < 0 && (d(), s2--)), t3 === n.Chapter && (m.isVoidElement(e3) || (c && e3 === u ? (c = false, u = "") : l2.push("</".concat(e3, ">"))), "div" === e3 && --s2 < 0 && v(n.Stopped));
      ...
      return t(this, void 0, void 0, function() {
        var t2, s2, i3, l2, c, u, h, p, v, d, f, g, b, m, w, y, S, N, k, C;
        return a(this, function(a2) {
          switch (a2.label) {
            case 0:
