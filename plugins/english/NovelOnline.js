...
var LNReaderPlugin = (() => {
  ...
  // .js/plugins/english/NovelOnline.js
  init_dirname();
  init_buffer2();
  init_process2();
    ...
    function i(i2) {
      return function(u) {
        return function(i3) {
          ...
          for (; o && (o = 0, i3[0] && (r2 = 0)), r2; ) try {
            if (a2 = 1, l2 && (n2 = 2 & i3[0] ? l2.return : i3[0] ? l2.throw || ((n2 = l2.return) && n2.call(l2), 0) : l2.next) && !(n2 = n2.call(l2, i3[1])).done) return n2;
            switch (l2 = 0, n2 && (i3 = [2 & i3[0], n2.value]), i3[0]) {
              case 0:
              case 1:
                n2 = i3;
                break;
              case 4:
                return r2.label++, { value: i3[1], done: false };
              case 5:
                r2.label++, l2 = i3[1], i3 = [0];
                continue;
              case 7:
                i3 = r2.ops.pop(), r2.trys.pop();
                continue;
              default:
                if (!(n2 = r2.trys, (n2 = n2.length > 0 && n2[n2.length - 1]) || 6 !== i3[0] && 2 !== i3[0])) {
                  r2 = 0;
                  continue;
                }
                if (3 === i3[0] && (!n2 || i3[1] > n2[0] && i3[1] < n2[3])) {
                  r2.label = i3[1];
                  break;
                }
                if (6 === i3[0] && r2.label < n2[1]) {
                  r2.label = n2[1], n2 = i3;
                  break;
                }
                if (n2 && r2.label < n2[2]) {
                  r2.label = n2[2], r2.ops.push(i3);
                  break;
                }
  ...
  var a = (init_browser(), __toCommonJS(browser_exports)), l = (init_fetch2(), __toCommonJS(fetch_exports)), n = (init_filterInputs(), __toCommonJS(filterInputs_exports)), r = function() {
    function r2() {
      this.id = "NO.net", this.name = "novelsOnline", this.site = "https://novelsonline.org", this.icon = "src/en/novelsonline/icon.png", this.version = "1.0.2", this.filters = { keyword: { value: "", label: "Keyword", type: n.FilterTypes.TextInput }, novel_type: { value: [], label: "Novel Type", options: [{ label: "Web Novel", value: "Web Novel" }, { label: "Light Novel", value: "Light Novel" }, { label: "Chinese Novel", value: "Chinese Novel" }, { label: "Korean Novel", value: "Korean Novel" }], type: n.FilterTypes.CheckboxGroup }, language: { value: [], label: "Language", options: [{ label: "Chinese", value: "Chinese" }, { label: "Japanese", value: "Japanese" }, { label: "Korean", value: "Korean" }], type: n.FilterTypes.CheckboxGroup }, genre: { value: [], label: "Genre", options: [{ label: "Action", value: "4" }, { label: "Adventure", value: "1" }, { label: "Celebrity", value: "39" }, { label: "Comedy", value: "12" }, { label: "Drama", value: "6" }, { label: "Ecchi", value: "47" }, { label: "Fantasy", value: "2" }, { label: "Gender Bender", value: "14" }, { label: "Harem", value: "45" }, { label: "Historical", value: "22" }, { label: "Horror", value: "31" }, { label: "Josei", value: "21" }, { label: "Martial Arts", value: "18" }, { label: "Mature", value: "46" }, { label: "Mecha", value: "30" }, { label: "Mystery", value: "7" }, { label: "Psychological", value: "8" }, { label: "Romance", value: "9" }, { label: "School Life", value: "10" }, { label: "Sci-fi", value: "3" }, { label: "Seinen", value: "23" }, { label: "Shotacon", value: "35" }, { label: "Shoujo", value: "11" }, { label: "Shoujo Ai", value: "34" }, { label: "Shounen", value: "5" }, { label: "Shounen Ai", value: "32" }, { label: "Slice of Life", value: "13" }, { label: "Sports", value: "33" }, { label: "Supernatural", value: "25" }, { label: "Tragedy", value: "24" }, { label: "Wuxia", value: "17" }, { label: "Xianxia", value: "20" }, { label: "Xuanhuan", value: "38" }, { label: "Yaoi", value: "16" }, { label: "Yuri", value: "27" }], type: n.FilterTypes.CheckboxGroup }, completed: { value: "", label: "Completed", options: [{ label: "Any", value: "" }, { label: "Yes", value: "yes" }, { label: "No", value: "no" }], type: n.FilterTypes.Picker } };
    }
    __name(r2, "r");
    return r2.prototype.safeFetch = function(n2) {
      return e(this, arguments, void 0, function(e2, n3) {
        var r3, o, i;
        return void 0 === n3 && (n3 = void 0), t(this, function(t2) {
          switch (t2.label) {
            case 0:
              return [4, (0, l.fetchApi)(e2, n3)];
            case 1:
              if (!(r3 = t2.sent()).ok) throw new Error("Could not reach site (" + r3.status + ") try to open in webview.");
              return [4, r3.text()];
            case 2:
              if (o = t2.sent(), i = (0, a.load)(o), !(void 0 !== i("title"))) throw new Error("Captcha protection detected (Input is random characters). Please try opening the page in WebView.");
              return [2, i];
          }
        });
      });
    }, r2.prototype.parseNovels = function(a2) {
      return e(this, void 0, void 0, function() {
        var e2, l2 = this;
        return t(this, function(t2) {
          return e2 = [], a2(".top-novel-block").each(function(t3, n2) {
            var r3 = a2(n2).find("h2").text(), o = a2(n2).find(".top-novel-cover img").attr("src"), i = a2(n2).find("h2 a").attr("href");
            i && e2.push({ name: r3, cover: o, path: i.replace(l2.site, "") });
          }), [2, e2];
        });
      });
    }, r2.prototype.popularNovels = function(a2, l2) {
      return e(this, arguments, void 0, function(e2, a3) {
        var l3, n2, r3, o, i, u, s = a3.filters;
        return t(this, function(t2) {
          switch (t2.label) {
            case 0:
              for (n2 in l3 = new URLSearchParams(), s) if ("keyword" === n2) l3.append("keyword", s[n2].value);
              else if ("object" == typeof s[n2].value) for (r3 = 0, o = s[n2].value; r3 < o.length; r3++) i = o[r3], l3.append("include[".concat(n2, "][]"), i);
              else s[n2].value && l3.append("include[".concat(n2, "][]"), s[n2].value);
              return l3.toString() ? (l3.append("search", "1"), [2, 1 == e2 ? this.detailedSearch(l3) : []]) : [4, this.safeFetch(this.site + "/top-novel/" + e2)];
            case 1:
              return u = t2.sent(), [2, this.parseNovels(u)];
          }
        });
      });
    }, r2.prototype.searchNovels = function(a2) {
      return e(this, void 0, void 0, function() {
        var e2;
        return t(this, function(t2) {
          return (e2 = new URLSearchParams()).append("keyword", a2), e2.append("search", "1"), [2, this.detailedSearch(e2)];
        });
      });
    }, r2.prototype.detailedSearch = function(a2) {
      return e(this, void 0, void 0, function() {
        var e2;
        return t(this, function(t2) {
          switch (t2.label) {
            case 0:
              return [4, this.safeFetch(this.site + "/detailed-search", { method: "POST", headers: { "Content-Type": "application/x-www-form-urlencoded" }, body: a2.toString() })];
            case 1:
              return e2 = t2.sent(), [2, this.parseNovels(e2)];
          }
        });
      });
    }, r2.prototype.parseNovel = function(a2) {
      return e(this, void 0, void 0, function() {
        var e2, l2, n2 = this;
        return t(this, function(t2) {
          switch (t2.label) {
            case 0:
              return [4, this.safeFetch(this.site + a2)];
            case 1:
              return e2 = t2.sent(), l2 = { path: a2, name: e2("h1").text() || "Untitled", cover: e2(".novel-cover").find("a > img").attr("src"), chapters: [] }, e2(".novel-detail-item").each(function(t3, a3) {
                var n3 = e2(a3).find("h6").text(), r3 = e2(a3).find(".novel-detail-body");
                switch (n3) {
                  case "Description":
                    l2.summary = r3.text();
                    break;
                  case "Genre":
                    l2.genres = r3.find("li").map(function(t4, a4) {
                      return e2(a4).text();
                    }).get().join(", ");
                    break;
                  case "Author(s)":
                    l2.author = r3.find("li").map(function(t4, a4) {
                      return e2(a4).text();
                    }).get().join(", ");
                    break;
                  case "Artist(s)":
                    var o = r3.find("li").map(function(t4, a4) {
                      return e2(a4).text();
                    }).get().join(", ");
                    o && "N/A" != o && (l2.artist = o);
                    break;
                  case "Status":
                    l2.status = r3.text().trim();
                }
              }), l2.chapters = e2("ul.chapter-chs > li > a").map(function(t3, a3) {
                var l3 = e2(a3).attr("href");
                return { name: e2(a3).text(), path: null == l3 ? void 0 : l3.replace(n2.site, "") };
              }).get(), [2, l2];
          }
        });
      });
        ...
        return t(this, function(t2) {
          switch (t2.label) {
            case 0:
              return [4, this.safeFetch(this.site + a2)];
            case 1:
              return e2 = t2.sent(), [2, e2("#contentall").html() || ""];
          }
        });
      });
    }, r2;
