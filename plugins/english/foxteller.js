...
var LNReaderPlugin = (() => {
  ...
  var r = require_lib6(), n = (init_filterInputs(), __toCommonJS(filterInputs_exports)), i = (init_defaultCover(), __toCommonJS(defaultCover_exports)), o = (init_fetch2(), __toCommonJS(fetch_exports)), a = (init_novelStatus(), __toCommonJS(novelStatus_exports)), s = function() {
    function s2() {
      var e2 = this;
      this.id = "foxteller", this.name = "Foxteller", this.site = "https://www.foxteller.com", this.version = "1.0.2", this.icon = "src/en/foxteller/icon.png", this.resolveUrl = function(t2) {
    ...
    __name(s2, "s");
    return s2.prototype.safeFecth = function(r2) {
      return e(this, arguments, void 0, function(e2, r3) {
        var n2, i2, a2, s3, l2;
        return void 0 === r3 && (r3 = {}), t(this, function(t2) {
          switch (t2.label) {
            case 0:
              return [4, (0, o.fetchApi)(e2, r3)];
            case 1:
              if (!(n2 = t2.sent()).ok) throw new Error("Could not reach site (" + n2.status + ") try to open in webview.");
              return [4, n2.text()];
            case 2:
