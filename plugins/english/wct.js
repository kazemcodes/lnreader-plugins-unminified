...
var LNReaderPlugin = (() => {
  ...
  var r = (init_browser(), __toCommonJS(browser_exports)), i = (init_fetch2(), __toCommonJS(fetch_exports)), o = (init_novelStatus(), __toCommonJS(novelStatus_exports)), a = function() {
    function a2() {
      this.id = "witchculttranslations", this.name = "Witch Cult Translations", this.site = "https://witchculttranslation.com", this.icon = "src/en/wct/icon.png", this.version = "1.0.0", this.cachedNovel = null;
    }
    __name(a2, "a");
    return a2.prototype.novel = function() {
      return e(this, void 0, void 0, function() {
        var t2, e2, o2;
        return n(this, function(n2) {
          switch (n2.label) {
            case 0:
              return null !== this.cachedNovel ? [2, this.cachedNovel] : [4, (0, i.fetchApi)(this.site)];
            case 1:
              return [4, n2.sent().text()];
            case 2:
              return t2 = n2.sent(), e2 = (0, r.load)(t2), o2 = e2(".entry-content h1 img").last().attr("src"), this.cachedNovel = { name: "Re:Zero kara Hajimeru Isekai Seikatsu", path: "/table-of-content", cover: o2 }, [2, this.cachedNovel];
          }
        });
      });
    }, a2.prototype.popularNovels = function(t2) {
      return e(this, void 0, void 0, function() {
        var e2, r2, i2;
        return n(this, function(n2) {
          switch (n2.label) {
            case 0:
              return e2 = [], 1 !== t2 ? [3, 2] : (i2 = (r2 = e2).push, [4, this.novel()]);
            case 1:
              i2.apply(r2, [n2.sent()]), n2.label = 2;
            case 2:
              return [2, e2];
          }
        });
      });
    }, a2.prototype.searchNovels = function(t2) {
      return e(this, void 0, void 0, function() {
        var e2, r2, i2 = this;
        return n(this, function(n2) {
          switch (n2.label) {
            case 0:
              return [4, this.novel()];
            case 1:
              return e2 = [n2.sent()], r2 = this.normalize(t2), [2, e2.filter(function(t3) {
                var e3 = t3.name;
                return i2.normalize(e3).includes(r2);
              })];
          }
        });
      });
    }, a2.prototype.normalize = function(t2) {
      return t2.toLowerCase().replace(/[^a-z0-9]/g, "");
    }, a2.prototype.parseChapter = function(t2) {
      return e(this, void 0, void 0, function() {
        var e2, o2, a3, s;
        return n(this, function(n2) {
          switch (n2.label) {
            case 0:
              return [4, (0, i.fetchApi)(this.site + t2)];
            case 1:
              return [4, n2.sent().text()];
            case 2:
              return e2 = n2.sent(), o2 = (0, r.load)(e2), a3 = o2("h1.entry-title").text().trim(), (s = o2(".entry-content").first()).find("#patreon-snippet, .sharedaddy, .jp-relatedposts, #jp-post-flair").remove(), [2, "<h1>".concat(a3, "</h1>").concat(s.html() || "")];
          }
        });
      });
      ...
      return e(this, void 0, void 0, function() {
        ...
        return n(this, function(n2) {
          switch (n2.label) {
            case 0:
              return [4, Promise.all([(0, i.fetchApi)(this.site + a3).then(function(t2) {
                return t2.text();
              }), this.novel()])];
            case 1:
              return e2 = n2.sent(), s = e2[0], c = e2[1], l = (0, r.load)(s), [2, t(t({}, c), { author: "Tappei Nagatsuki", chapters: this.parseChaptersFromTOC(l), status: o.NovelStatus.Ongoing, summary: `Fan translation of the Re:Zero web novel (Arc 5 onwards).
...
Suddenly, Natsuki Subaru, a shut-in student, is summoned to another world on his way home from the convenience store. A completely ordinary person with no knowledge, skills, combat abilities, or communication skills, he's thrown into this other world without any cheat bonuses and must desperately try to survive. The only blessing he receives is the painful ability to "return by death," which allows him to rewind time after dying! In this other world where he has no one to rely on, how many times will he die, and what will he ultimately gain?` })];
    ...
    }, a2.prototype.parseChaptersFromTOC = function(t2) {
      for (var e2 = [], n2 = 0, r2 = 0, i2 = 0, o2 = t2(".entry-content").first().children().toArray(); i2 < o2.length; i2++) {
        var a3 = o2[i2];
        if ("tag" === a3.type) {
          var s = a3.tagName.toLowerCase();
          if ("h1" !== s && "h2" !== s) "ul" !== s || n2 < 5 || t2(a3).find("li > a").each(function(i3, o3) {
            var a4 = t2(o3).attr("href");
            if (a4 && /^https?:\/\/(?:www\.)?witchculttranslation\.com\//i.test(a4)) {
              var s2 = t2(o3).text().trim();
              if (s2) {
                var c2 = "/".concat(a4.replace(/^https?:\/\/(?:www\.)?witchculttranslation\.com\//i, "").replace(/^\/+/, "")), l2 = c2.match(/^\/(\d{4})\/(\d{2})\/(\d{2})\//), u = l2 ? "".concat(l2[1], "-").concat(l2[2], "-").concat(l2[3]) : null;
                r2 += 1, e2.push({ name: "Arc ".concat(n2, ", ").concat(s2), path: c2, releaseTime: u, chapterNumber: r2 });
              }
            }
          });
          else {
            var c = t2(a3).text().trim(), l = c.match(/^Arc\s+(\d+)/i);
            if (l) {
              n2 = parseInt(l[1], 10);
              continue;
            }
            if (/^Side Content/i.test(c)) break;
          }
        }
      }
      return e2;
