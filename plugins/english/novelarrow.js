...
var LNReaderPlugin = (() => {
  ...
  // .js/plugins/english/novelarrow.js
  init_dirname();
  init_buffer2();
  init_process2();
  var t = function(t2, e2, n2, r2) {
    return new (n2 || (n2 = Promise))(function(a2, o2) {
      ...
      __name(s, "s");
      s((r2 = r2.apply(t2, e2 || [])).next());
    });
  }, e = function(t2, e2) {
    var n2, r2, a2, o2 = { label: 0, sent: /* @__PURE__ */ __name(function() {
      if (1 & a2[0]) throw a2[1];
      return a2[1];
    }, "sent"), trys: [], ops: [] }, c = Object.create(("function" == typeof Iterator ? Iterator : Object).prototype);
    ...
    function i(i2) {
      return function(s) {
        return function(i3) {
          ...
          for (; c && (c = 0, i3[0] && (o2 = 0)), o2; ) try {
            if (n2 = 1, r2 && (a2 = 2 & i3[0] ? r2.return : i3[0] ? r2.throw || ((a2 = r2.return) && a2.call(r2), 0) : r2.next) && !(a2 = a2.call(r2, i3[1])).done) return a2;
            switch (r2 = 0, a2 && (i3 = [2 & i3[0], a2.value]), i3[0]) {
              case 0:
              case 1:
                a2 = i3;
                break;
              ...
              case 5:
                o2.label++, r2 = i3[1], i3 = [0];
                continue;
              case 7:
                i3 = o2.ops.pop(), o2.trys.pop();
                continue;
              default:
                if (!(a2 = o2.trys, (a2 = a2.length > 0 && a2[a2.length - 1]) || 6 !== i3[0] && 2 !== i3[0])) {
                  o2 = 0;
                  continue;
                }
                ...
                if (6 === i3[0] && o2.label < a2[1]) {
                  o2.label = a2[1], a2 = i3;
                  break;
                }
                if (a2 && o2.label < a2[2]) {
                  o2.label = a2[2], o2.ops.push(i3);
                  break;
                }
  ...
  var n = (init_browser(), __toCommonJS(browser_exports)), r = (init_fetch2(), __toCommonJS(fetch_exports)), a = (init_novelStatus(), __toCommonJS(novelStatus_exports)), o = function() {
    function o2() {
      this.id = "novelarrow", this.name = "Novel Arrow", this.icon = "src/en/novelarrow/icon.png", this.site = "https://novelarrow.com/", this.version = "1.0.0";
    }
    __name(o2, "o");
    return o2.prototype.popularNovels = function(a2) {
      return t(this, void 0, void 0, function() {
        var t2, o3, c, i;
        return e(this, function(e2) {
          switch (e2.label) {
            case 0:
              return t2 = "".concat(this.site, "novels/latest?page=").concat(a2), [4, (0, r.fetchApi)(t2).then(function(t3) {
                return t3.text();
              })];
            case 1:
              return o3 = e2.sent(), c = (0, n.load)(o3), i = [], c("article").each(function(t3, e3) {
                var n2 = c(e3).find("h2").text().trim(), r2 = c(e3).find("img").attr("src"), a3 = c(e3).find("a").attr("href");
                n2 && a3 && i.push({ name: n2, cover: r2, path: a3.substring(1) });
              }), [2, i];
          }
        });
      });
      ...
      return t(this, void 0, void 0, function() {
        var t2, c, i, s, u, p, l, h, f, m, v, g, d, y, b, w, x, _;
        return e(this, function(e2) {
          switch (e2.label) {
            case 0:
              return t2 = this.site + o3.replace(/^\//, ""), [4, (0, r.fetchApi)(t2).then(function(t3) {
                return t3.text();
              })];
            case 1:
              c = e2.sent(), i = (0, n.load)(c), s = o3.replace("novel/", "").replace(/^\//, ""), (u = i('meta[name="og:novel:genre"]').attr("content") || i('meta[property="og:novel:genre"]').attr("content")) || (p = [], i('meta[property="article:tag"]').each(function(t3, e3) {
                var n2 = i(e3).attr("content");
                n2 && p.push(n2);
              }), u = p.join(", ")), l = i('meta[name="description"]').attr("content") || i('meta[property="og:description"]').attr("content"), (h = c.match(/\\?"description\\?":\\?"(.*?)\\?"/)) && h[1].length > ((null == l ? void 0 : l.length) || 0) && (l = h[1].replace(/\\n/g, "\n").replace(/\\"/g, '"')), f = { path: o3, name: i('meta[name="og:novel:novel_name"]').attr("content") || i('meta[property="og:novel:novel_name"]').attr("content") || (null === (_ = i('meta[property="og:title"]').attr("content")) || void 0 === _ ? void 0 : _.split(" Novel")[0]) || i("h1").first().text().trim(), cover: i('meta[property="og:image"]').attr("content") || i('meta[name="og:image"]').attr("content"), author: i('meta[name="og:novel:author"]').attr("content") || i('meta[property="og:novel:author"]').attr("content") || i('meta[name="author"]').attr("content") || i('meta[property="article:author"]').attr("content"), status: "Ongoing" === (i('meta[name="og:novel:status"]').attr("content") || i('meta[property="og:novel:status"]').attr("content")) ? a.NovelStatus.Ongoing : a.NovelStatus.Completed, summary: l, genres: u, chapters: [] }, m = "".concat(this.site, "api-web/novels/").concat(s, "/chapters?sort=asc"), e2.label = 2;
            case 2:
              return e2.trys.push([2, 4, , 5]), [4, (0, r.fetchApi)(m, { headers: { Accept: "application/json" } }).then(function(t3) {
                return t3.json();
              })];
            case 3:
              return (v = e2.sent()) && v.items && (f.chapters = v.items.map(function(t3) {
                return { name: t3.chapter_name, path: "chapter/".concat(s, "/").concat(t3.chapter_id), releaseTime: null };
              })), [3, 5];
            case 4:
              for (e2.sent(), g = /* @__PURE__ */ new Map(), d = /\\?"chapter_id\\?":\\?"([^"]+)\\?",\\?"chapter_name\\?":\\?"([^"]+)\\?"/g, y = void 0; null !== (y = d.exec(c)); ) b = y[1], w = y[2].replace(/\\"/g, '"'), x = "chapter/".concat(s, "/").concat(b), g.has(x) || g.set(x, { name: w, path: x, releaseTime: null });
              return f.chapters = Array.from(g.values()), [3, 5];
            case 5:
              return [2, f];
          }
        });
      ...
      return t(this, void 0, void 0, function() {
        var t2, o3, c, i, s, u, p, l, h, f;
        return e(this, function(e2) {
          switch (e2.label) {
            case 0:
              t2 = a2.replace("chapter/", "").split("/"), o3 = t2[0], c = t2[1], i = "".concat(this.site, "api-web/novels/").concat(o3, "/chapters/").concat(c), e2.label = 1;
            case 1:
              return e2.trys.push([1, 3, , 5]), [4, (0, r.fetchApi)(i, { headers: { Accept: "application/json", "x-track-reading-progress": "false" } }).then(function(t3) {
                return t3.json();
              })];
            case 2:
              return (s = e2.sent()) && s.item && s.item.chapterInfo && s.item.chapterInfo.chapter_content ? [2, s.item.chapterInfo.chapter_content] : [3, 5];
            case 3:
              return e2.sent(), [4, (0, r.fetchApi)("".concat(this.site).concat(a2)).then(function(t3) {
                return t3.text();
              })];
            case 4:
              return u = e2.sent(), p = /\\u003ch4\\u003e(.*)\\u003c\/p\\u003e/, (l = u.match(p)) ? (h = (h = l[0]).replace(/\\u003c/g, "<").replace(/\\u003e/g, ">").replace(/\\"/g, '"').replace(/\\n/g, "").replace(/\\t/g, "").replace(/\\r/g, "").replace(/\\\\/g, "\\"), -1 !== (f = h.lastIndexOf("</p>")) && (h = h.substring(0, f + 4)), [2, h]) : [2, (0, n.load)(u)(".site-reading-copy").html() || "Content not found or premium."];
            case 5:
              return [2, "Content not found or premium."];
          }
        });
      });
      ...
      return t(this, void 0, void 0, function() {
        ...
        return e(this, function(e2) {
          switch (e2.label) {
            case 0:
              return t2 = "".concat(this.site, "novels/search?keyword=").concat(encodeURIComponent(a2), "&page=").concat(o3), [4, (0, r.fetchApi)(t2).then(function(t3) {
                return t3.text();
              })];
            case 1:
              return c = e2.sent(), i = (0, n.load)(c), s = [], i("article").each(function(t3, e3) {
                var n2 = i(e3).find("h2").text().trim(), r2 = i(e3).find("img").attr("src"), a3 = i(e3).find("a").attr("href");
                n2 && a3 && s.push({ name: n2, cover: r2, path: a3.substring(1) });
              }), [2, s];
          }
        });
      });
