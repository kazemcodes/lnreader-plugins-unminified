...
var LNReaderPlugin = (() => {
  ...
  var n, r = require_lib6(), o = (init_fetch2(), __toCommonJS(fetch_exports)), i = (init_novelStatus(), __toCommonJS(novelStatus_exports)), s = function() {
    ...
    return s2.prototype.sleep = function(e2) {
      ...
      return t(this, void 0, void 0, function() {
        var t2, l2, c, u, h, p, v, d, f, g, b, m, w, y, S, C, N, k, L, P, x, A, j, I, H, R, G, M, O = this;
        return a(this, function(a2) {
          switch (a2.label) {
            ...
            case 3:
              return null === g ? [3, 7] : (L = this.options.chapterListing || "ajax/chapter-archive", P = this.options.chapterParam || "novelId", x = new URLSearchParams(((M = {})[P] = g, M)), A = "".concat(this.site).concat(L, "?").concat(x.toString()), [4, (0, o.fetchApi)(A)]);
            case 4:
              return (j = a2.sent()).ok ? [3, 5] : (console.error("Failed to fetch chapters: ".concat(j.status)), c.chapters = [], [3, 7]);
            case 5:
              return [4, j.text()];
            case 6:
              I = a2.sent(), H = [], R = {}, (G = new r.Parser({ onopentag: /* @__PURE__ */ __name(function(e2, t3) {
                var a3, r2;
                ...
                "a" !== t3 && "option" !== t3 || S() !== n.Chapter || (R.name && R.path && (R.name = R.name.trim(), R.releaseTime = null, H.push(e({}, R))), R = {}, N());
