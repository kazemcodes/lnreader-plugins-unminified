  ...
  var c = new (function() {
    ...
    return c2.prototype.getHostname = function(e2) {
      ...
      return e(this, arguments, void 0, function(e2, a3) {
        var l3, s2, r2, i2, n2, o2, c3, u, v, h = a3.filters, p = a3.showLatestNovels;
        return t(this, function(t2) {
          switch (t2.label) {
            case 0:
              for (r2 in l3 = null !== (v = null === (u = this.options) || void 0 === u ? void 0 : u.seriesPath) && void 0 !== v ? v : "/series/", s2 = this.site + l3 + "?page=" + e2, h || (h = this.filters || {}), p && (s2 += "&order=latest"), h) if ("object" == typeof h[r2].value) for (i2 = 0, n2 = h[r2].value; i2 < n2.length; i2++) o2 = n2[i2], s2 += "&".concat(r2, "=").concat(o2);
      ...
      return e(this, void 0, void 0, function() {
        var e2, s2, n2, c3, u, v, h, p, d, f, b, m, g, y, w, k, N, S, C, L, x;
        return t(this, function(t2) {
          switch (t2.label) {
            case 0:
              return e2 = this.site, [4, this.safeFecth(e2 + a2, false)];
            case 1:
              return s2 = t2.sent(), n2 = { path: a2, name: "", genres: "", summary: "", author: "", artist: "", status: "", chapters: [] }, c3 = false, u = false, v = 0, h = false, p = false, d = false, f = false, b = false, m = false, g = false, y = 0, w = false, k = false, N = [], S = {}, C = this.hideLocked, L = new l.Parser({ onopentag: /* @__PURE__ */ __name(function(t3, a3) {
                var l2;
                !n2.cover && (null === (l2 = a3.class) || void 0 === l2 ? void 0 : l2.includes("ts-post-image")) ? (n2.name = a3.title, n2.cover = a3["data-src"] || a3.src || i.defaultCover) : "genxed" === a3.class || "sertogenre" === a3.class ? c3 = true : c3 && "a" === t3 ? u = true : "div" !== t3 || "entry-content" !== a3.class && "description" !== a3.itemprop ? "spe" === a3.class || "serl" === a3.class ? h = true : h && "span" === t3 ? p = true : "div" === t3 && "sertostat" === a3.class ? (h = true, p = true, b = true) : a3.class && a3.class.includes("eplister") ? m = true : m && "li" === t3 ? g = true : g ? "a" === t3 && void 0 === S.path ? S.path = a3.href.replace(e2, "").trim() : "epl-num" === a3.class ? y = 1 : "epl-title" === a3.class ? y = 2 : "epl-date" === a3.class ? y = 3 : "epl-price" === a3.class && (y = 4) : !v || "div" !== t3 && "script" !== t3 || v++ : v++;
                ...
                if (c3) u && (n2.genres += e3 + ", ");
                  ...
                  if (1 === y) e3.includes("\u{1F512}") ? (w = true, k = true) : k && (w = false), o(e3, S);
                  else if (2 === y) S.name = (null === (a3 = null === (t3 = e3.match(RegExp("^".concat(n2.name.replace(/[.*+?^${}()|[\]\\]/g, "\\$&"), "\\s*(.+)")))) || void 0 === t3 ? void 0 : t3[1]) || void 0 === a3 ? void 0 : a3.trim()) || e3.trim(), S.chapterNumber || o(e3, S);
