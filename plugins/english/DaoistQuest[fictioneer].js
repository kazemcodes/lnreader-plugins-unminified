...
(() => {
      ...
      return t(this, arguments, void 0, (function(t2, i3) {
        ...
        return e(this, (function(e2) {
          switch (e2.label) {
            ...
            case 2:
              return o4 = e2.sent(), [2, (s = (0, r.load)(o4))("#featured-list > li > div > div, #list-of-stories > li > div > div").map((function(t3, e3) {
                return { name: s(e3).find("h3 > a").text(), cover: s(e3).find("a.cell-img:has(img)").attr("href"), path: s(e3).find("h3 > a").attr("href").replace(a.site + "/", "").replace(/\/$/, "") };
              })).toArray()];
          }
        }));
      }));
        ...
        return e(this, (function(e2) {
          switch (e2.label) {
            ...
            case 1:
              return [4, e2.sent().text()];
            case 2:
              return t2 = e2.sent(), s = (0, r.load)(t2), (a = { path: o3, name: s("h1.story__identity-title").text() }).author = s("div.story__identity-meta").text().split("|")[0].replace("Author: ", "").replace("by ", "").trim(), a.cover = s("figure.story__thumbnail > a").attr("href"), a.genres = s("div.tag-group > a, section.tag-group > a").map((function(t3, e3) {
                return s(e3).text();
              })).toArray().join(","), a.summary = s("section.story__summary").text(), a.chapters = s("li.chapter-group__list-item._publish").filter((function(t3, e3) {
                return !e3.attribs.class.includes("_password");
              })).filter((function(t3, e3) {
                return !s(e3).find("i").first().attr("class").includes("fa-lock");
              })).map((function(t3, e3) {
                var r2;
                return { name: s(e3).find("a").text(), path: null === (r2 = s(e3).find("a").attr("href")) || void 0 === r2 ? void 0 : r2.replace(u.site + "/", "").replace(/\/$/, "") };
              })).toArray(), "Ongoing" === (c = s("span.story__status").text().trim()) && (a.status = i.NovelStatus.Ongoing), "Completed" === c && (a.status = i.NovelStatus.Completed), "Cancelled" === c && (a.status = i.NovelStatus.Cancelled), "Hiatus" === c && (a.status = i.NovelStatus.OnHiatus), [2, a];
          }
        }));
      }));
        ...
        return e(this, (function(e2) {
          switch (e2.label) {
            ...
            case 1:
              return [4, e2.sent().text()];
            case 2:
              return t2 = e2.sent(), [2, (s = (0, r.load)(t2))("#search-result-list > li > div > div").map((function(t3, e3) {
                return { name: s(e3).find("h3 > a").text(), cover: s(e3).find("a.cell-img:has(img)").attr("href"), path: s(e3).find("h3 > a").attr("href").replace(a.site + "/", "").replace(/\/$/, "") };
              })).toArray()];
          }
        }));
  ...
  })())({ id: "daoistquest", sourceSite: "https://daoist.quest", sourceName: "Daoist Quest", options: { browsePage: "collection/novels", versionIncrements: 1 } });
  exports.default = o;
})();
