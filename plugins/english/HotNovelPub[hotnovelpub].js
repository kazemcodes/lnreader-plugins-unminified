...
var LNReaderPlugin = (() => {
  ...
  // .js/plugins/english/HotNovelPub[hotnovelpub].js
  init_dirname();
  init_buffer2();
  init_process2();
  var e = function(e2, t2, a2, n2) {
    return new (a2 || (a2 = Promise))(function(o2, r2) {
      function i(e3) {
        try {
          s(n2.next(e3));
        } catch (e4) {
    ...
    var a2, n2, o2, r2 = { label: 0, sent: /* @__PURE__ */ __name(function() {
        ...
        return function(l3) {
          ...
          for (; i && (i = 0, l3[0] && (r2 = 0)), r2; ) try {
            ...
            switch (n2 = 0, o2 && (l3 = [2 & l3[0], o2.value]), l3[0]) {
              ...
              case 5:
                r2.label++, n2 = l3[1], l3 = [0];
                continue;
              case 7:
                l3 = r2.ops.pop(), r2.trys.pop();
                continue;
              default:
                if (!(o2 = r2.trys, (o2 = o2.length > 0 && o2[o2.length - 1]) || 6 !== l3[0] && 2 !== l3[0])) {
                  r2 = 0;
                  continue;
                }
  ...
  var a = (init_fetch2(), __toCommonJS(fetch_exports)), n = (init_novelStatus(), __toCommonJS(novelStatus_exports)), o = function() {
    ...
    return o2.prototype.popularNovels = function(n2, o3) {
      return e(this, arguments, void 0, function(e2, n3) {
        var o4, r2, i, l, s, u, c = this, h = n3.filters, p = n3.showLatestNovels;
      ...
      return e(this, void 0, void 0, function() {
        ...
        return t(this, function(t2) {
          switch (t2.label) {
            ...
            case 1:
              return e2 = t2.sent(), r2 = { name: e2.data.book.name, path: o3, cover: this.site + e2.data.book.image, summary: e2.data.book.authorize.description, author: e2.data.book.authorize.name, status: "updating" === e2.data.book.status ? n.NovelStatus.Ongoing : n.NovelStatus.Completed }, (null === (l = e2.data.tags.tags_name) || void 0 === l ? void 0 : l.length) && (r2.genres = e2.data.tags.tags_name.join(",")), (null === (s = e2.data.chapters) || void 0 === s ? void 0 : s.length) && (i = [], e2.data.chapters.forEach(function(e3, t3) {
      ...
      return e(this, void 0, void 0, function() {
        ...
        return t(this, function(t2) {
          switch (t2.label) {
            ...
            case 1:
              return e2 = t2.sent(), (o3 = (null === (i = e2.match(/<div id="content-item" ([\s\S]*?)<\/div>/)) || void 0 === i ? void 0 : i[0]) || "") ? [4, (0, a.fetchApi)(this.site + "/server/getContent?slug=" + n2)] : [3, 4];
            case 2:
