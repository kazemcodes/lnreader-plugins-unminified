      ...
      return e(this, void 0, void 0, function() {
        ...
        return a(this, function(a2) {
          switch (a2.label) {
            ...
            case 1:
              return r2 = a2.sent(), o2 = { path: t2, name: "", genres: "", summary: "", author: "", artist: "", status: "", chapters: [] }, u3 = false, c = false, v = 0, h = false, p = false, d = false, b = false, f = false, m = false, g = false, y = 0, w = false, k = false, x = [], N = {}, C = this.hideLocked, S = new l.Parser({ onopentag: /* @__PURE__ */ __name(function(a3, t3) {
                var l2;
              ...
              }, "onclosetag") }), S.write(r2), S.end(), x.length && ((null === (L = this.options) || void 0 === L ? void 0 : L.reverseChapters) && x.reverse(), o2.chapters = x), o2.summary = o2.summary.trim(), [2, o2];
          }
        });
      });
