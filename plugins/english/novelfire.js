...
(() => {
  ...
  var n = (init_browser(), __toCommonJS(browser_exports)), r = (init_fetch2(), __toCommonJS(fetch_exports)), o = (init_novelStatus(), __toCommonJS(novelStatus_exports)), i = (init_filterInputs(), __toCommonJS(filterInputs_exports)), u = (function() {
    ...
    return e2.prototype.getCheerio = function(e3, t2) {
        ...
        return l(this, (function(l2) {
          switch (l2.label) {
            ...
            case 1:
              ...
              return o2 = n.load, [4, a2.text()];
            case 2:
              return [2, o2.apply(void 0, [l2.sent()])];
          }
        }));
      }));
    }, e2.prototype.popularNovels = function(e3, t2) {
      return a(this, arguments, void 0, (function(e4, t3) {
        var a2, n2, r2, o2, i2, u2, s2, c, v, p = this, h = t3.showLatestNovels, b = t3.filters;
        return l(this, (function(t4) {
          switch (t4.label) {
            case 0:
              if (a2 = this.site + "search-adv", h) a2 += "?ctgcon=and&totalchapter=0&ratcon=min&rating=0&status=-1&sort=date&tagcon=and&page=".concat(e4);
              else if (b) {
                for (n2 = new URLSearchParams(), r2 = 0, o2 = b.language.value; r2 < o2.length; r2++) i2 = o2[r2], n2.append("country_id[]", i2);
                for (n2.append("ctgcon", b.genre_operator.value), u2 = 0, s2 = b.genres.value; u2 < s2.length; u2++) c = s2[u2], n2.append("categories[]", c);
                n2.append("totalchapter", b.chapters.value), n2.append("ratcon", b.rating_operator.value), n2.append("rating", b.rating.value), n2.append("status", b.status.value), n2.append("sort", b.sort.value), n2.append("page", e4.toString()), a2 += "?".concat(n2.toString());
            ...
            case 1:
              return [2, (v = t4.sent())(".novel-item").map((function(e5, t5) {
                var a3 = v(t5).find(".novel-title > a").attr("title") || "No Title Found", l2 = v(t5).find(".novel-cover > img").attr("data-src"), n3 = v(t5).find(".novel-title > a").attr("href");
                return n3 ? { name: a3, cover: l2, path: n3.replace(p.site, "") } : null;
    ...
    }, e2.prototype.parseChapters = function(e3, t2) {
      return a(this, void 0, void 0, (function() {
        var o2, i2, u2, c, v, p, h, b, f, d, g, y, m, w, x, S, k, C = this;
        return l(this, (function(A) {
          switch (A.label) {
            case 0:
              o2 = Array.from({ length: t2 }, (function(e4, t3) {
                return t3 + 1;
              })), i2 = [], u2 = /* @__PURE__ */ __name(function(t3) {
                return a(C, void 0, void 0, (function() {
                  var a2, o3, i3, u3 = this;
                  return l(this, (function(l2) {
                    switch (l2.label) {
                      case 0:
                        return a2 = "".concat(this.site).concat(e3, "/chapters?page=").concat(t3), [4, (0, r.fetchApi)(a2)];
                      case 1:
                        return [4, l2.sent().text()];
                      case 2:
                        if (o3 = l2.sent(), (i3 = (0, n.load)(o3)).text().includes("You are being rate limited")) throw new s();
                        return [2, i3(".chapter-list li").map((function(e4, t4) {
                          var a3 = i3(t4).find("a").attr("title") || "No Title Found", l3 = i3(t4).find("a").attr("href");
                          return l3 ? { name: a3, path: l3.replace(u3.site, "") } : null;
              ...
              }, "u"), c = 5, v = 10, p = 3.5, h = [], b = 0, A.label = 1;
            case 1:
              if (!(b < o2.length)) return [3, 11];
              f = o2.slice(b, b + c), d = f[0], g = f[f.length - 1], y = 0, A.label = 2;
            case 2:
              if (!(y < v)) return [3, 10];
              A.label = 3;
            case 3:
              return A.trys.push([3, 5, , 9]), [4, Promise.all(f.map(u2))];
            case 4:
              return m = A.sent(), h.push.apply(h, m), [3, 10];
            case 5:
              if (!((w = A.sent()) instanceof s)) return [3, 7];
              if (y += 1, console.warn("[pages=".concat(d, "-").concat(g, "] Novel Fire is rate limiting requests. Retry attempt ").concat(y + 1, " in ").concat(p, " seconds...")), y === v) throw w;
              return [4, new Promise((function(e4) {
                return setTimeout(e4, 1e3 * p);
              }))];
            case 6:
              return A.sent(), [3, 8];
            case 7:
            ...
            case 10:
              return b += c, [3, 1];
            case 11:
              for (x = 0, S = h; x < S.length; x++) k = S[x], i2.push.apply(i2, k);
              return [2, 0 === i2.length ? [] : i2];
          }
        }));
      }));
    }, e2.prototype.parseNovel = function(e3) {
      return a(this, void 0, void 0, (function() {
        var t2, a2, n2, r2, i2, u2, s2, c, v, p, h, b, f, d;
        return l(this, (function(l2) {
          switch (l2.label) {
            case 0:
              return [4, this.getCheerio(this.site + e3, false)];
            case 1:
              return t2 = l2.sent(), a2 = this.site, (n2 = { path: e3 }).name = null !== (b = null !== (h = t2(".novel-title").text().trim()) && void 0 !== h ? h : t2(".cover > img").attr("alt")) && void 0 !== b ? b : "No Titled Found", (r2 = null !== (f = t2(".cover > img").attr("data-src")) && void 0 !== f ? f : t2(".cover > img").attr("src")) && (n2.cover = new URL(r2, a2).href), n2.genres = t2(".categories .property-item").map((function(e4, a3) {
                return t2(a3).text();
              })).toArray().join(","), (i2 = t2(".summary .content").text().trim()) ? (i2 = i2.replace("Show More", ""), n2.summary = i2) : n2.summary = "No Summary Found", n2.author = t2(".author .property-item > span").text() || "No Author Found", u2 = t2(".header-stats .ongoing").text() || t2(".header-stats .completed").text() || "Unknown", s2 = { ongoing: o.NovelStatus.Ongoing, hiatus: o.NovelStatus.OnHiatus, dropped: o.NovelStatus.Cancelled, cancelled: o.NovelStatus.Cancelled, completed: o.NovelStatus.Completed, unknown: o.NovelStatus.Unknown }, n2.status = null !== (d = s2[u2.toLowerCase()]) && void 0 !== d ? d : o.NovelStatus.Unknown, c = t2(".header-stats .icon-book-open").parent().text().trim(), v = Math.ceil(parseInt(c) / 100), p = n2, [4, this.parseChapters(e3, v)];
            case 2:
              return p.chapters = l2.sent(), [2, n2];
          }
        }));
      }));
      ...
      return a(this, void 0, void 0, (function() {
        ...
        return l(this, (function(l2) {
          switch (l2.label) {
            case 0:
              return t2 = this.site + e3, [4, (0, r.fetchApi)(t2)];
            case 1:
              return [4, l2.sent().text()];
            case 2:
              return a2 = l2.sent(), o2 = (0, n.load)(a2), [".box-ads", ".box-notification", /^nf/].forEach((function(e4) {
                e4 instanceof RegExp ? o2("*").filter((function(t3, a3) {
                  return e4.test(o2(a3).prop("tagName").toLowerCase());
                })).remove() : o2(e4).remove();
              })), [2, o2("#content").html()];
          }
        }));
      ...
      return a(this, void 0, void 0, (function() {
        ...
        return l(this, (function(l2) {
          switch (l2.label) {
            case 0:
              return a2 = "".concat(this.site, "search?keyword=").concat(encodeURIComponent(e3), "&page=").concat(t2), [4, (0, r.fetchApi)(a2)];
            case 1:
              return [4, l2.sent().text()];
            case 2:
              return o2 = l2.sent(), [2, (i2 = (0, n.load)(o2))(".novel-list.chapters .novel-item").map((function(e4, t3) {
                var a3 = i2(t3).find("a").attr("title") || "No Title Found", l3 = i2(t3).find(".novel-cover > img").attr("src"), n2 = i2(t3).find("a").attr("href");
                return n2 ? { name: a3, cover: l3, path: n2.replace(u2.site, "") } : null;
              })).get().filter((function(e4) {
                return null !== e4;
              }))];
          }
