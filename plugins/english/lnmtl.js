...
var LNReaderPlugin = (() => {
      ...
      return function(c) {
        return function(o3) {
          ...
          for (; s2 && (s2 = 0, o3[0] && (i2 = 0)), i2; ) try {
            if (n2 = 1, r2 && (a2 = 2 & o3[0] ? r2.return : o3[0] ? r2.throw || ((a2 = r2.return) && a2.call(r2), 0) : r2.next) && !(a2 = a2.call(r2, o3[1])).done) return a2;
  ...
  var n, r = require_lib6(), a = (init_fetch2(), __toCommonJS(fetch_exports)), i = (init_filterInputs(), __toCommonJS(filterInputs_exports)), s = function() {
    function s2() {
      this.id = "lnmtl", this.name = "LnMTL", this.icon = "src/en/lnmtl/icon.png", this.site = "https://lnmtl.com/", this.version = "2.1.1", this.filters = { order: { value: "favourites", label: "Order by", options: [{ label: "Favourites", value: "favourites" }, { label: "Name", value: "name" }, { label: "Addition Date", value: "date" }], type: i.FilterTypes.Picker }, sort: { value: "desc", label: "Sort by", options: [{ label: "Descending", value: "desc" }, { label: "Ascending", value: "asc" }], type: i.FilterTypes.Picker }, storyStatus: { value: "all", label: "Status", options: [{ label: "All", value: "all" }, { label: "Ongoing", value: "ongoing" }, { label: "Finished", value: "finished" }], type: i.FilterTypes.Picker } };
    }
    __name(s2, "s");
    return s2.prototype.sleep = function(n2) {
    ...
    }, s2.prototype.popularNovels = function(i2, s3) {
      return e(this, arguments, void 0, function(e2, i3) {
        var s4, o, c, l, u, p, h, f, d = i3.filters;
        return t(this, function(t2) {
          switch (t2.label) {
            case 0:
              return s4 = new URLSearchParams({ orderBy: d.order.value, order: d.sort.value, filter: d.storyStatus.value, page: e2.toString() }), o = "".concat(this.site, "novel?").concat(s4.toString()), [4, (0, a.fetchApi)(o)];
            case 1:
              return [4, t2.sent().text()];
            case 2:
              return c = t2.sent(), l = this.site, u = n.Idle, p = {}, h = [], f = new r.Parser({ onopentag: /* @__PURE__ */ __name(function(e3, t3) {
                var r2;
                if ((null === (r2 = t3.class) || void 0 === r2 ? void 0 : r2.includes("media-left")) && (u = n.Novel), u === n.Novel) switch (e3) {
                  case "a":
                    p.path = t3.href.replace(l, "");
                    break;
                  case "img":
                    p.name = t3.alt, p.cover = t3.src;
                }
              }, "onopentag"), onclosetag: /* @__PURE__ */ __name(function(e3) {
                "div" === e3 && (p.path && p.name && (h.push(p), p = {}), u = n.Idle);
              }, "onclosetag") }), f.write(c), f.end(), [2, h];
          }
        });
      });
    }, s2.prototype.parseNovel = function(i2) {
      return e(this, void 0, void 0, function() {
        var e2, s3, o, c, l, u, p, h, f, d;
        return t(this, function(t2) {
          switch (t2.label) {
            case 0:
              return [4, (0, a.fetchApi)(this.site + i2)];
            case 1:
              return [4, t2.sent().text().then(function(e3) {
                return e3.replace(/>\s+</g, "><");
              })];
            case 2:
              return e2 = t2.sent(), s3 = { path: i2, totalPages: 1, chapters: [] }, o = n.Idle, c = 0, l = 0, u = false, p = false, h = [], f = [], d = new r.Parser({ onopentag: /* @__PURE__ */ __name(function(e3, t3) {
                var r2, a2, i3;
                switch (e3) {
                  case "img":
                    (null === (r2 = t3.class) || void 0 === r2 ? void 0 : r2.includes("img-rounded")) && (s3.name = t3.title, s3.cover = t3.src);
                    break;
                  case "dt":
                    o = n.InPanelKey;
                    break;
                  case "dd":
                    ...
                    break;
                  case "ul":
                    (null === (a2 = t3.class) || void 0 === a2 ? void 0 : a2.includes("list-inline")) && l++;
                    break;
                  case "li":
                    1 === l && (o = n.InGenres);
                    break;
                  default:
                    if (t3.class) {
                      var u2 = { description: n.InDescription, source: n.InSource, progress: n.Idle };
                      o = null !== (i3 = u2[t3.class]) && void 0 !== i3 ? i3 : o;
                    }
                }
              }, "onopentag"), ontext: /* @__PURE__ */ __name(function(e3) {
                switch (o) {
                  case n.InScript:
                    var t3 = JSON.parse(e3.match(/lnmtl.volumes = (.+])(?=;)/)[1] || "");
                    s3.totalPages = t3.length;
                    break;
                  case n.InDescription:
                    h.push(e3.trim()), h.push("\n\n");
                    break;
                  case n.InSource:
                    h.push(e3);
                    break;
                  case n.InPanelKey:
                    ...
                    break;
                  case n.InPanelValue:
                    u && 1 === c ? (s3.author = (s3.author || "") + e3.trim(), u = false) : p && 2 === c && (s3.status = (s3.status || "") + e3.trim(), p = false);
                    break;
                  case n.InGenres:
                    f.push(e3.trim());
                }
                ...
                switch (e3) {
                  case "ul":
                    o === n.InGenres && (o = n.Idle);
                    break;
                  case "main":
                    o = n.InScript;
                    break;
                  case "script":
                    o === n.InScript && (o = n.Idle);
                }
              }, "onclosetag"), onend: /* @__PURE__ */ __name(function() {
                s3.summary = h.join(""), s3.genres = f.join(", ");
              }, "onend") }), d.write(e2), d.end(), [2, s3];
          }
        });
      });
    }, s2.prototype.parsePage = function(i2, s3) {
      return e(this, void 0, void 0, function() {
        var e2, o, c, l, u, p, h, f, d, v;
        return t(this, function(t2) {
          switch (t2.label) {
            case 0:
              return [4, (0, a.fetchApi)(this.site + i2)];
            ...
            case 2:
              return e2 = t2.sent(), o = n.Idle, c = { id: "", title: "" }, (l = new r.Parser({ ontext: /* @__PURE__ */ __name(function(e3) {
                if (o === n.InScript) {
                  var t3 = JSON.parse(e3.match(/lnmtl.volumes = (.+])(?=;)/)[1] || "");
                  c = t3[+s3 - 1];
                }
              }, "ontext"), onclosetag: /* @__PURE__ */ __name(function(e3) {
                "main" === e3 && (o = n.InScript), "script" === e3 && (o = n.Idle);
              }, "onclosetag") })).write(e2), l.end(), u = [], [4, this.sleep(1e3)];
            case 3:
              return t2.sent(), [4, (0, a.fetchApi)("".concat(this.site, "chapter?volumeId=").concat(c.id))];
            case 4:
              return [4, t2.sent().json()];
            case 5:
              p = t2.sent(), h = p.data.map(function(e3) {
                return { name: "#".concat(e3.number, " - ").concat(e3.title), path: "chapter/".concat(e3.slug), releaseTime: new Date(e3.created_at).toISOString() };
              }), u.push.apply(u, h), f = 2, t2.label = 6;
            case 6:
              return f <= p.last_page ? [4, this.sleep(1e3)] : [3, 11];
            case 7:
              return t2.sent(), [4, (0, a.fetchApi)("".concat(this.site, "chapter?page=").concat(f, "&volumeId=").concat(c.id))];
            case 8:
              return [4, t2.sent().json()];
            case 9:
              d = t2.sent(), v = d.data.map(function(e3) {
                return { name: "#".concat(e3.number, " ").concat(e3.title), path: "chapter/".concat(e3.slug), releaseTime: new Date(e3.created_at).toISOString() };
              }), u.push.apply(u, v), t2.label = 10;
            case 10:
              return f++, [3, 6];
            case 11:
              return [2, { chapters: u }];
        ...
        return t(this, function(t2) {
          switch (t2.label) {
            ...
            case 1:
              return [4, t2.sent().text()];
            case 2:
              return e2 = t2.sent(), s3 = n.Idle, o = [], c = /[&<>"']/g, l = { "&": "&amp;", "<": "&lt;", ">": "&gt;", '"': "&quot;", "'": "&#39;" }, u = /* @__PURE__ */ __name(function(e3) {
                return c.test(e3) ? (c.lastIndex = 0, e3.replace(c, function(e4) {
                  return l[e4];
                })) : e3;
              }, "u"), p = new r.Parser({ onopentag: /* @__PURE__ */ __name(function(e3, t3) {
                var r2;
                "sentence" === e3 && (null === (r2 = t3.class) || void 0 === r2 ? void 0 : r2.includes("translated")) && (s3 = n.Chapter, o.push("<p>"));
              }, "onopentag"), onopentagname: /* @__PURE__ */ __name(function(e3) {
                "nav" === e3 && (s3 = n.Idle);
              }, "onopentagname"), ontext: /* @__PURE__ */ __name(function(e3) {
                s3 === n.Chapter && o.push(u(e3));
              }, "ontext"), onclosetag: /* @__PURE__ */ __name(function(e3) {
                "sentence" === e3 && s3 === n.Chapter && (o.push("</p>"), s3 = n.Idle);
              }, "onclosetag") }), p.write(e2), p.end(), [2, o.join("").replace(/„/g, "\u201C")];
          }
        });
      });
      ...
      return e(this, void 0, void 0, function() {
        ...
        return t(this, function(t2) {
          switch (t2.label) {
            case 0:
              return [4, (0, a.fetchApi)(this.site).then(function(e3) {
                return e3.text();
              }).then(function(e3) {
                return e3.replace(/>\s+</g, "><");
              })];
            case 1:
              return e2 = t2.sent(), s3 = n.Idle, o = /* @__PURE__ */ new Set(), c = new r.Parser({ onopentag: /* @__PURE__ */ __name(function(e3, t3) {
                var r2;
                s3 === n.InFooter && "script" === e3 && (null === (r2 = t3.type) || void 0 === r2 ? void 0 : r2.includes("application/javascript")) && (s3 = n.InScript);
              }, "onopentag"), ontext: /* @__PURE__ */ __name(function(e3) {
                if (s3 === n.InScript) {
                  var t3 = e3.match(/prefetch: '\/(.*?\.json)/);
                  t3 && o.add(t3[1]);
                }
              }, "ontext"), onclosetag: /* @__PURE__ */ __name(function(e3) {
                switch (e3) {
                  case "footer":
                    ...
                    break;
                  case "script":
                    s3 === n.InScript && (s3 = n.Idle);
                }
              }, "onclosetag") }), c.write(e2), c.end(), [4, (0, a.fetchApi)("".concat(this.site).concat(Array.from(o).join("")))];
            case 2:
              return [4, t2.sent().json()];
            case 3:
              return l = t2.sent(), u = l.filter(function(e3) {
                return e3.name.toLowerCase().includes(i2.toLowerCase());
              }), p = [], u.map(function(e3) {
                var t3 = e3.name, n2 = { path: "novel/".concat(e3.slug), name: t3, cover: e3.image };
                p.push(n2);
              }), [2, p];
          }
        });
  ...
  exports.default = new s(), function(e2) {
