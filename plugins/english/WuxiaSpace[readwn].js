...
(() => {
      ...
      !(function(t2, e2) {
        ...
        var _ = (function() {
          ...
          return m2.parse = function(t3) {
            ...
            var n3, o3 = b.p(t3), f2 = "set" + (this.$u ? "UTC" : ""), l2 = (n3 = {}, n3[a2] = f2 + "Date", n3[d] = f2 + "Date", n3[c] = f2 + "Month", n3[h] = f2 + "FullYear", n3[u] = f2 + "Hours", n3[s2] = f2 + "Minutes", n3[i2] = f2 + "Seconds", n3[r2] = f2 + "Milliseconds", n3)[o3], $3 = o3 === a2 ? this.$D + (e3 - this.$W) : e3;
            if (o3 === c || o3 === h) {
  ...
  // .js/plugins/english/WuxiaSpace[readwn].js
  ...
  var r = (init_fetch2(), __toCommonJS(fetch_exports)), i = (init_novelStatus(), __toCommonJS(novelStatus_exports)), a = (init_browser(), __toCommonJS(browser_exports)), o = n(require_dayjs_min()), s = new ((function() {
    function n2(t2) {
      var e2;
      this.id = t2.id, this.name = t2.sourceName, this.icon = "multisrc/readwn/".concat(t2.id.toLowerCase(), "/icon.png"), this.site = t2.sourceSite;
      var n3 = (null === (e2 = t2.options) || void 0 === e2 ? void 0 : e2.versionIncrements) || 0;
      this.version = "1.0.".concat(2 + n3), this.filters = t2.filters;
    }
    __name(n2, "n");
    return n2.prototype.popularNovels = function(n3, i2) {
      return t(this, arguments, void 0, (function(t2, n4) {
        var i3, o2, s2, u, l, c, h, d = this, f = n4.filters, p = n4.showLatestNovels;
        return e(this, (function(e2) {
          switch (e2.label) {
            case 0:
              return i3 = this.site + "/list/", i3 += ((null === (u = null == f ? void 0 : f.genres) || void 0 === u ? void 0 : u.value) || "all") + "/", i3 += ((null === (l = null == f ? void 0 : f.status) || void 0 === l ? void 0 : l.value) || "all") + "-", i3 += p ? "lastdotime" : (null === (c = null == f ? void 0 : f.sort) || void 0 === c ? void 0 : c.value) || "newstime", i3 += "-" + (t2 - 1) + ".html", (null === (h = null == f ? void 0 : f.tags) || void 0 === h ? void 0 : h.value) && (i3 = this.site + "/tags/" + f.tags.value + "-0.html"), [4, (0, r.fetchApi)(i3).then((function(t3) {
                return t3.text();
              }))];
            case 1:
              return o2 = e2.sent(), s2 = (0, a.load)(o2), [2, s2("li.novel-item").map((function(t3, e3) {
                return { name: s2(e3).find("h4").text() || "", cover: d.site + s2(e3).find(".novel-cover > img").attr("data-src"), path: s2(e3).find("a").attr("href") || "" };
              })).get().filter((function(t3) {
                return t3.name && t3.path;
              }))];
          }
        }));
      }));
      ...
      return t(this, void 0, void 0, (function() {
        ...
        return e(this, (function(e2) {
          switch (e2.label) {
            ...
            case 1:
              if (t2 = e2.sent(), s2 = (0, a.load)(t2), (u = { path: n3, name: s2("h1.novel-title").text() || "" }).author = s2("span[itemprop=author]").text(), u.cover = this.site + s2("figure.cover > img").attr("data-src"), u.summary = s2(".summary").text().replace("Summary", "").trim(), u.genres = s2("div.categories > ul > li").map((function(t3, e3) {
                var n4;
                return null === (n4 = s2(e3).text()) || void 0 === n4 ? void 0 : n4.trim();
              })).get().join(","), s2("div.header-stats > span").each((function() {
                "Status" === s2(this).find("small").text() && (u.status = "Ongoing" === s2(this).find("strong").text() ? i.NovelStatus.Ongoing : i.NovelStatus.Completed);
              })), l = parseInt(s2(".header-stats").find("span > strong").first().text().trim()), c = s2(".chapter-list li").map((function(t3, e3) {
                var n4, r2, i2, a2 = s2(e3).find("a .chapter-title").text().trim(), u2 = null === (n4 = s2(e3).find("a").attr("href")) || void 0 === n4 ? void 0 : n4.trim();
                if (!a2 || !u2) return null;
                var l2 = s2(e3).find("a .chapter-update").text().trim();
                if (null === (r2 = null == l2 ? void 0 : l2.includes) || void 0 === r2 ? void 0 : r2.call(l2, "ago")) {
                  var c2 = (null === (i2 = l2.match(/\d+/)) || void 0 === i2 ? void 0 : i2[0]) || "0", h2 = parseInt(c2, 10);
                  if (h2) {
                    var d2 = (0, o.default)();
                    (l2.includes("hours ago") || l2.includes("hour ago")) && d2.subtract(h2, "hours"), (l2.includes("days ago") || l2.includes("day ago")) && d2.subtract(h2, "days"), (l2.includes("months ago") || l2.includes("month ago")) && d2.subtract(h2, "months"), l2 = d2.format("LL");
                  }
                }
                return { name: a2, path: u2, releaseTime: l2, chapterNumber: t3 + 1 };
              })).get().filter((function(t3) {
                return t3;
              })), l > c.length) for (h = parseInt((null === (f = c[c.length - 1].path.match(/_(\d+)\.html/)) || void 0 === f ? void 0 : f[1]) || "", 10), d = (h || c.length) + 1; d <= l; d++) c.push({ name: "Chapter " + d, path: n3.replace(".html", "_" + d + ".html"), releaseTime: null, chapterNumber: d });
      ...
      return t(this, void 0, void 0, (function() {
        ...
        return e(this, (function(e2) {
          switch (e2.label) {
            ...
            case 1:
              return t2 = e2.sent(), i2 = (0, a.load)(t2), [2, i2(".chapter-content").html() || ""];
          }
        }));
      }));
      ...
      return t(this, void 0, void 0, (function() {
        ...
        return e(this, (function(e2) {
          switch (e2.label) {
            case 0:
              return [4, (0, r.fetchApi)(this.site + "/e/search/index.php", { headers: { "Content-Type": "application/x-www-form-urlencoded", Referer: this.site + "/search.html", Origin: this.site }, method: "POST", body: new URLSearchParams({ show: "title", tempid: 1, tbname: "news", keyboard: n3 }).toString() }).then((function(t3) {
                return t3.text();
              }))];
            case 1:
              return t2 = e2.sent(), i2 = (0, a.load)(t2), [2, i2("li.novel-item").map((function(t3, e3) {
                return { name: i2(e3).find("h4").text() || "", cover: o2.site + i2(e3).find("img").attr("data-src"), path: i2(e3).find("a").attr("href") || "" };
              })).get().filter((function(t3) {
                return t3.name && t3.path;
              }))];
          }
  ...
  })())({ id: "wuxiaspace", sourceSite: "https://www.wuxiaspot.com", sourceName: "Wuxia Space", options: { versionIncrements: 1 } });
  exports.default = s;
})();
