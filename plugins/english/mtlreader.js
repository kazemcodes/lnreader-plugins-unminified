...
(() => {
  ...
  // .js/plugins/english/mtlreader.js
          ...
          for (; a && (a = 0, c3[0] && (o = 0)), o; ) try {
            ...
            switch (r2 = 0, i2 && (c3 = [2 & c3[0], i2.value]), c3[0]) {
              ...
              case 7:
                ...
                continue;
              default:
                if (!(i2 = o.trys, (i2 = i2.length > 0 && i2[i2.length - 1]) || 6 !== c3[0] && 2 !== c3[0])) {
                  o = 0;
                  continue;
                }
                ...
                if (6 === c3[0] && o.label < i2[1]) {
                  o.label = i2[1], i2 = c3;
                  break;
                }
                if (i2 && o.label < i2[2]) {
                  o.label = i2[2], o.ops.push(c3);
                  break;
                }
  ...
  var n = (init_browser(), __toCommonJS(browser_exports)), r = (init_fetch2(), __toCommonJS(fetch_exports)), i = (function() {
    function i2() {
      this.id = "mtlreader", this.name = "MTL Reader", this.version = "1.0.1", this.icon = "src/en/mtlreader/icon.png", this.site = "https://mtlreader.com/";
    }
    __name(i2, "i");
    return i2.prototype.parseNovels = function(t2) {
      var e2 = this, n2 = [];
      return t2(".col-md-4").each((function(r2, i3) {
        var o = t2(i3).find("h5").text(), a = t2(i3).find("img").attr("src"), c = t2(i3).find("h5 > a").attr("href");
        if (c) {
          var s = { name: o, cover: a, path: c.replace(e2.site, "") };
          n2.push(s);
        }
      })), n2;
    }, i2.prototype.popularNovels = function(i3) {
      return t(this, void 0, void 0, (function() {
        var t2, o, a;
        return e(this, (function(e2) {
          switch (e2.label) {
            case 0:
              return t2 = "".concat(this.site, "novels?page=").concat(i3), [4, (0, r.fetchApi)(t2).then((function(t3) {
                return t3.text();
              }))];
            case 1:
              return o = e2.sent(), a = (0, n.load)(o), [2, this.parseNovels(a)];
          }
        }));
      }));
      ...
      return t(this, void 0, void 0, (function() {
        ...
        return e(this, (function(e2) {
          switch (e2.label) {
            case 0:
              return [4, (0, r.fetchApi)(this.site + i3).then((function(t3) {
                return t3.text();
              }))];
            case 1:
              return t2 = e2.sent(), o = (0, n.load)(t2), (a = { path: i3, name: o(".agent-title").text().trim() || "Untitled", cover: o(".agent-p-img > img").attr("src"), summary: o("#editdescription").text().trim(), chapters: [] }).author = o("i.fa-user").parent().text().replace("Author: ", "").trim(), c = [], o("tr.spaceUnder").each((function(t3, e3) {
                var n2 = o(e3).find("a").text().trim(), r2 = o(e3).find("a").attr("href");
                r2 && c.push({ name: n2, path: r2.replace(s.site, "") });
              })), a.chapters = c, [2, a];
          }
        }));
      }));
      ...
      return t(this, void 0, void 0, (function() {
        ...
        return e(this, (function(e2) {
          switch (e2.label) {
            ...
            case 1:
              return t2 = e2.sent(), (o = (0, n.load)(t2))(".container ins,script,p.mtlreader").remove(), [2, o(".container").html() || ""];
          }
        }));
      }));
      ...
      return t(this, void 0, void 0, (function() {
        ...
        return e(this, (function(e2) {
          switch (e2.label) {
            ...
            case 1:
              return t2 = e2.sent(), o = (0, n.load)(t2), a = o('input[name="_token"]').attr("value"), c = "".concat(this.site, "search?_token=").concat(a, "&input=").concat(encodeURIComponent(i3)), [4, (0, r.fetchApi)(c).then((function(t3) {
                return t3.text();
              }))];
            case 2:
              return s = e2.sent(), u = (0, n.load)(s), [2, this.parseNovels(u)];
          }
        }));
      }));
    }, i2;
