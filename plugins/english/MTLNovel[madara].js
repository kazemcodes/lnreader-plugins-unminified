...
var LNReaderPlugin = (() => {
  ...
  // .js/plugins/english/MTLNovel[madara].js
  var t = function(t2, e2, r2, a2) {
    return new (r2 || (r2 = Promise))((function(n2, i2) {
      ...
      u2((a2 = a2.apply(t2, e2 || [])).next());
    }));
  }, e = function(t2, e2) {
    var r2, a2, n2, i2 = { label: 0, sent: function() {
      ...
      return function(u2) {
        return (function(s4) {
          ...
          for (; o2 && (o2 = 0, s4[0] && (i2 = 0)), i2; ) try {
            if (r2 = 1, a2 && (n2 = 2 & s4[0] ? a2.return : s4[0] ? a2.throw || ((n2 = a2.return) && n2.call(a2), 0) : a2.next) && !(n2 = n2.call(a2, s4[1])).done) return n2;
            switch (a2 = 0, n2 && (s4 = [2 & s4[0], n2.value]), s4[0]) {
              case 0:
              case 1:
                n2 = s4;
                break;
  ...
  var a = (init_fetch2(), __toCommonJS(fetch_exports)), n = (init_browser(), __toCommonJS(browser_exports)), i = (init_defaultCover(), __toCommonJS(defaultCover_exports)), o = (init_novelStatus(), __toCommonJS(novelStatus_exports)), s = r(require_dayjs_min()), u = (init_storage2(), __toCommonJS(storage_exports)), c = function(t2, e2) {
    return new RegExp(e2.join("|")).test(t2);
  }, l = new ((function() {
    function r2(t2) {
      var e2, r3;
      this.hideLocked = u.storage.get("hideLocked"), this.parseData = function(t3) {
        var e3, r4 = (0, s.default)(), a3 = (null === (e3 = t3.match(/\d+/)) || void 0 === e3 ? void 0 : e3[0]) || "", n2 = parseInt(a3, 10);
        if (!a3) return t3;
        if (c(t3, ["detik", "segundo", "second", "\u0E27\u0E34\u0E19\u0E32\u0E17\u0E35"])) r4 = r4.subtract(n2, "second");
        else if (c(t3, ["menit", "dakika", "min", "minute", "minuto", "\u0E19\u0E32\u0E17\u0E35", "\u062F\u0642\u0627\u0626\u0642"])) r4 = r4.subtract(n2, "minute");
        else if (c(t3, ["jam", "saat", "heure", "hora", "hour", "\u0E0A\u0E31\u0E48\u0E27\u0E42\u0E21\u0E07", "gi\u1EDD", "ore", "\u0633\u0627\u0639\u0629", "\u5C0F\u65F6"])) r4 = r4.subtract(n2, "hours");
        else if (c(t3, ["hari", "g\xFCn", "jour", "d\xEDa", "dia", "day", "\u0E27\u0E31\u0E19", "ng\xE0y", "giorni", "\u0623\u064A\u0627\u0645", "\u5929"])) r4 = r4.subtract(n2, "days");
        else if (c(t3, ["week", "semana"])) r4 = r4.subtract(n2, "week");
        else if (c(t3, ["month", "mes"])) r4 = r4.subtract(n2, "month");
        else {
          if (!c(t3, ["year", "a\xF1o"])) return "Invalid Date" !== (0, s.default)(t3).format("LL") ? (0, s.default)(t3).format("LL") : t3;
          r4 = r4.subtract(n2, "year");
        }
        return r4.format("LL");
      ...
      var a2 = (null === (e2 = t2.options) || void 0 === e2 ? void 0 : e2.versionIncrements) || 0;
      this.version = "1.0.".concat(8 + a2), this.options = t2.options, this.filters = t2.filters, (null === (r3 = this.options) || void 0 === r3 ? void 0 : r3.hasLocked) && (this.pluginSettings = { hideLocked: { value: "", label: "Hide locked chapters", type: "Switch" } });
    }
    return r2.prototype.translateDragontea = function(t2) {
      ...
      return t2.html(r3.html()), t2.find("*").addBack().contents().filter((function(t3, e3) {
        return 3 === e3.nodeType;
      })).each((function(t3, e3) {
        var a2 = r3(e3), n2 = a2.text().normalize("NFD").split("").map((function(t4) {
          var e4 = t4.normalize("NFC"), r4 = "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ".indexOf(e4);
          return r4 >= 0 ? "zyxwvutsrqponmlkjihgfedcbaZYXWVUTSRQPONMLKJIHGFEDCBA"[r4] + t4.slice(e4.length) : t4;
        })).join("");
        a2.replaceWith(n2.replace("\n", "<br>"));
      })), t2;
    }, r2.prototype.getHostname = function(t2) {
      var e2 = (t2 = t2.split("/")[2]).split(".");
      return e2.pop(), e2.join(".");
    }, r2.prototype.getCheerio = function(r3, i2) {
      return t(this, void 0, void 0, (function() {
        ...
        return e(this, (function(e2) {
          switch (e2.label) {
            ...
            case 2:
              if (o2 = s2.apply(void 0, [e2.sent()]), u2 = o2("title").text().trim(), this.getHostname(r3) != this.getHostname(t2.url) || "Bot Verification" == u2 || "You are being redirected..." == u2 || "Un instant..." == u2 || "Just a moment..." == u2 || "Redirecting..." == u2) throw new Error("Captcha error, please open in webview");
              return [2, o2];
          }
        }));
      }));
    }, r2.prototype.parseNovels = function(t2) {
      var e2 = [];
      return t2(".manga-title-badges").remove(), t2(".page-item-detail, .c-tabs-item__content").each((function(r3, a2) {
        var n2 = t2(a2).find(".post-title").text().trim(), o2 = t2(a2).find(".post-title").find("a").attr("href") || "";
        if (n2 && o2) {
          var s2 = t2(a2).find("img"), u2 = { name: n2, cover: s2.attr("data-src") || s2.attr("src") || s2.attr("data-lazy-srcset") || i.defaultCover, path: o2.replace(/https?:\/\/.*?\//, "/") };
          e2.push(u2);
        }
      })), e2;
    }, r2.prototype.popularNovels = function(r3, a2) {
      return t(this, arguments, void 0, (function(t2, r4) {
        var a3, n2, i2, o2, s2, u2, c2 = r4.filters, l2 = r4.showLatestNovels;
        return e(this, (function(e2) {
          switch (e2.label) {
            case 0:
              for (n2 in a3 = this.site + "/page/" + t2 + "/?s=&post_type=wp-manga", c2 || (c2 = this.filters || {}), l2 && (a3 += "&m_orderby=latest"), c2) if ("object" == typeof c2[n2].value) for (i2 = 0, o2 = c2[n2].value; i2 < o2.length; i2++) s2 = o2[i2], a3 += "&".concat(n2, "=").concat(s2);
              else c2[n2].value && (a3 += "&".concat(n2, "=").concat(c2[n2].value));
              return [4, this.getCheerio(a3, 1 != t2)];
            case 1:
              return u2 = e2.sent(), [2, this.parseNovels(u2)];
          }
        }));
      }));
    }, r2.prototype.parseNovel = function(r3) {
      return t(this, void 0, void 0, (function() {
        var t2, u2, c2, l2, p, h, m, d, f = this;
        return e(this, (function(e2) {
          switch (e2.label) {
            case 0:
              return [4, this.getCheerio(this.site + r3, false)];
            case 1:
              return (t2 = e2.sent())(".manga-title-badges, #manga-title span").remove(), (u2 = { path: r3, name: t2(".post-title h1").text().trim() || t2("#manga-title h1").text().trim() || t2(".manga-title").text().trim() || "" }).cover = t2(".summary_image > a > img").attr("data-lazy-src") || t2(".summary_image > a > img").attr("data-src") || t2(".summary_image > a > img").attr("src") || i.defaultCover, t2(".post-content_item, .post-content").each((function() {
                var e3 = t2(this).find("h5").text().trim(), r4 = t2(this).find(".summary-content") || t2(this).find(".summary_content");
                switch (e3) {
                  case "Genre(s)":
                  case "Genre":
                  case "Tags(s)":
                  ...
                  case "Kategori":
                  case "\u0627\u0644\u062A\u0635\u0646\u064A\u0641\u0627\u062A":
                    u2.genres ? u2.genres += ", " + r4.find("a").map((function(e4, r5) {
                      return t2(r5).text();
                    })).get().join(", ") : u2.genres = r4.find("a").map((function(e4, r5) {
                      return t2(r5).text();
                    })).get().join(", ");
                    break;
                  case "Author(s)":
                  ...
                  case "\u0627\u0644\u0645\u0624\u0644\u0641":
                  case "\u0627\u0644\u0645\u0624\u0644\u0641 (\u064A\u0646)":
                    u2.author = r4.text().trim();
                    break;
                  case "Status":
                  case "Novel":
                  case "Estado":
                  case "Durum":
                    u2.status = r4.text().trim().includes("OnGoing") || r4.text().trim().includes("\u0645\u0633\u062A\u0645\u0631\u0629") ? o.NovelStatus.Ongoing : o.NovelStatus.Completed;
                    break;
                  case "Artist(s)":
                    u2.artist = r4.text().trim();
                }
              })), u2.genres || (u2.genres = t2(".genres-content").text().trim()), u2.status || (u2.status = t2(".manga-status").text().trim().includes("OnGoing") ? o.NovelStatus.Ongoing : o.NovelStatus.Completed), u2.author || (u2.author = t2(".manga-author a").text().trim()), u2.rating || (u2.rating = parseFloat(t2(".post-rating span").text().trim())), u2.author || (u2.author = t2(".manga-authors").text().trim()), t2("div.summary__content .code-block,script,noscript").remove(), u2.summary = this.translateDragontea(t2("div.summary__content")).text().trim() || t2("#tab-manga-about").text().trim() || t2('.post-content_item h5:contains("Summary")').next().find("span").map((function(e3, r4) {
                return t2(r4).text();
              })).get().join("\n\n").trim() || t2(".manga-summary p").map((function(e3, r4) {
                return t2(r4).text();
              })).get().join("\n\n").trim() || t2(".manga-excerpt p").map((function(e3, r4) {
                return t2(r4).text();
              })).get().join("\n\n").trim(), c2 = [], l2 = "", (null === (d = this.options) || void 0 === d ? void 0 : d.useNewChapterEndpoint) ? [4, (0, a.fetchApi)(this.site + r3 + "ajax/chapters/", { method: "POST", referrer: this.site + r3 }).then((function(t3) {
                return t3.text();
              }))] : [3, 3];
            case 2:
              return l2 = e2.sent(), [3, 5];
            case 3:
              return p = t2(".rating-post-id").attr("value") || t2("#manga-chapters-holder").attr("data-id") || "", (h = new FormData()).append("action", "manga_get_chapters"), h.append("manga", p), [4, (0, a.fetchApi)(this.site + "wp-admin/admin-ajax.php", { method: "POST", body: h }).then((function(t3) {
                return t3.text();
              }))];
            case 4:
              l2 = e2.sent(), e2.label = 5;
            case 5:
              return "0" !== l2 && (t2 = (0, n.load)(l2)), m = t2(".wp-manga-chapter").length, t2(".wp-manga-chapter").each((function(e3, r4) {
                var a2 = t2(r4).find("a").text().trim(), n2 = r4.attribs.class.includes("premium-block");
                n2 && (a2 = "\u{1F512} " + a2);
                ...
                !o2 || "#" == o2 || n2 && f.hideLocked || c2.push({ name: a2, path: o2.replace(/https?:\/\/.*?\//, "/"), releaseTime: i2 || null, chapterNumber: m - e3 });
              })), u2.chapters = c2.reverse(), [2, u2];
          }
        }));
      }));
    }, r2.prototype.parseChapter = function(r3) {
      return t(this, void 0, void 0, (function() {
        var t2, a2, n2;
        return e(this, (function(e2) {
          switch (e2.label) {
            case 0:
              return [4, this.getCheerio(this.site + r3, false)];
            case 1:
              return t2 = e2.sent(), a2 = t2(".text-left") || t2(".text-right") || t2(".entry-content") || t2(".c-blog-post > div > div:nth-child(2)"), null === (n2 = this.options) || void 0 === n2 || n2.customJs, [2, this.translateDragontea(a2).html() || ""];
          }
        }));
      }));
    }, r2.prototype.searchNovels = function(r3, a2) {
      return t(this, void 0, void 0, (function() {
        var t2, n2;
        return e(this, (function(e2) {
          switch (e2.label) {
            case 0:
              return t2 = this.site + "/page/" + a2 + "/?s=" + encodeURIComponent(r3) + "&post_type=wp-manga", [4, this.getCheerio(t2, true)];
            case 1:
