  ...
  var n, r = require_lib6(), o = (init_fetch2(), __toCommonJS(fetch_exports)), s = (init_novelStatus(), __toCommonJS(novelStatus_exports)), i = (init_browser(), __toCommonJS(browser_exports)), l = function() {
    ...
    return l2.prototype.sleep = function(e2) {
      ...
      return t(this, arguments, void 0, function(e3, t2) {
        var n3, r2, s2, i2, l3, c2, u, h, p, v, d, f, m, b, g, w, y, k, S, C, N, L, P = t2.filters, x = t2.showLatestNovels;
        return a(this, function(t3) {
          switch (t3.label) {
            case 0:
              return n3 = this.options, r2 = n3.pageParam, s2 = void 0 === r2 ? "page" : r2, i2 = n3.novelListing, l3 = n3.typeParam, c2 = void 0 === l3 ? "type" : l3, u = n3.latestPage, h = n3.genreParam, p = void 0 === h ? "category_novel" : h, v = n3.genreKey, d = void 0 === v ? "id" : v, f = n3.langParam, m = n3.urlLangCode, b = n3.noPages, g = void 0 === b ? [] : b, w = n3.pageAsPath, y = void 0 !== w && w, 1 !== e3 && !x && !P.genres.value.length && g.length > 0 && g.includes(P.type.value) ? [2, []] : (k = "", i2 ? (S = new URLSearchParams(), x ? S.append(c2, u) : P.genres.value.length ? (S.append(c2, p), S.append(d, P.genres.value)) : S.append(c2, P.type.value), f && m && S.append(f, m), S.append(s2, e3.toString()), k = "".concat(this.site).concat(i2, "?").concat(S.toString())) : (C = x ? u : P.genres.value.length ? P.genres.value : P.type.value, k = y ? e3 > 1 ? "".concat(this.site).concat(C, "/").concat(e3.toString()) : "".concat(this.site).concat(C) : "".concat(this.site).concat(C, "?").concat(s2, "=").concat(e3.toString())), [4, (0, o.fetchApi)(k)]);
            case 1:
      ...
      return t(this, void 0, void 0, function() {
        var t2, l3, c2, u, h, p, v, d, f, m, b, g, w, y, k, S, C, N, L, P, x, I, j, A, _, R, H, G, U = this;
          ...
          switch (a2.label) {
            ...
            case 2:
              return l3 = a2.sent(), c2 = { path: i2, chapters: [] }, u = [], h = [], p = [], v = [], d = [], f = [], m = null, b = {}, g = 0, y = [n.Idle], k = /* @__PURE__ */ __name(function() {
                ...
                switch (e2) {
                  ...
                  case "img":
                    if (s2 === n.Cover) {
                      ...
                      l4 && (c2.cover = new URL(l4, U.site).href), h2 ? c2.name = h2 : C();
                    }
                    break;
                  case "h3":
                  ...
                  case "a":
                    if (s2 === n.ChapterList) {
                      g++;
                      var v2 = t3.href;
                      S(n.Chapter), b.name = t3.title || "Chapter ".concat(g), b.releaseTime = null, b.chapterNumber = g, b.path = (null == v2 ? void 0 : v2.substring(1)) || i2.replace(".html", "/chapter-".concat(g, ".html"));
                    }
                }
                ...
                c2.summary = u.join("\n\n").trim();
              }, "onend") }), N.write(l3), N.end(), this.options.noAjax && f.length > 0 ? (c2.chapters = f, [3, 7]) : [3, 3];
            case 3:
            ...
            case 6:
              ...
              }, "onclosetag") })).write(A), H.end(), c2.chapters = _, a2.label = 7;
            case 7:
              return [2, c2];
          }
        });
          ...
          switch (a2.label) {
            ...
            case 2:
              ...
              return u = [], h = false, p = "", v = [n.Idle], d = /* @__PURE__ */ __name(function() {
                ...
                return v.push(e3);
              }, "f"), m = /* @__PURE__ */ __name(function() {
                return v.length > 1 ? v.pop() : d();
              }, "m"), b = { "&": "&amp;", "<": "&lt;", ">": "&gt;", '"': "&quot;", "'": "&#39;", "\xA0": "&nbsp;" }, g = /* @__PURE__ */ __name(function(e3) {
                return e3.replace(/[&<>"' ]/g, function(e4) {
                  return b[e4];
                });
              }, "g"), w = new r.Parser({ onopentag: /* @__PURE__ */ __name(function(e3, t3) {
                ...
                d() === n.Chapter && u.push(g(e3));
              }, "ontext"), onclosetag: /* @__PURE__ */ __name(function(e3) {
                var t3 = d();
                t3 === n.Hidden && ("sub" === e3 ? m() : "div" === e3 && --c2 < 0 && (m(), l3--)), t3 === n.Chapter && (w.isVoidElement(e3) || (h && e3 === p ? (h = false, p = "") : u.push("</".concat(e3, ">"))), "div" === e3 && --l3 < 0 && f(n.Stopped));
      ...
      return t(this, void 0, void 0, function() {
        var t2, s2, i2, l3, c2, u, h, p, v, d, f, m, b, g, w, y, k, S, C, N;
        return a(this, function(a2) {
          switch (a2.label) {
            case 0:
