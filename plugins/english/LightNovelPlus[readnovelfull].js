...
var LNReaderPlugin = (() => {
  ...
  var n, r = require_lib6(), o = (init_fetch2(), __toCommonJS(fetch_exports)), s = (init_novelStatus(), __toCommonJS(novelStatus_exports)), i = function() {
    function i2(e2) {
      var t2;
    ...
    return i2.prototype.sleep = function(e2) {
      ...
      var a2, o2 = this, s2 = [], i3 = {}, l2 = [n.Idle], c = /* @__PURE__ */ __name(function() {
        ...
        if (((null === (r2 = t3.class) || void 0 === r2 ? void 0 : r2.includes("archive")) || "col-content" === t3.class) && (u(n.NovelList), a2 = 0), s3 === n.NovelList || s3 === n.NovelName) switch (e2) {
          case "img":
            ...
            l3 && (i3.cover = new URL(l3, o2.site).href);
            break;
          case "h3":
        ...
        var r2 = c();
        "a" === t3 && r2 === n.NovelName && (i3.name && i3.path && s2.push(e({}, i3)), i3 = {}, h()), "div" === t3 && r2 === n.NovelList && --a2 < 0 && h();
      }, "onclosetag") });
      return p.write(t2), p.end(), s2;
    }, i2.prototype.popularNovels = function(e2, n2) {
      return t(this, arguments, void 0, function(e3, t2) {
        var n3, r2, s2, i3, l2, c, u, h, p, v, d, f, m, b, g, w, y, k, S, C, N, L, P = t2.filters, x = t2.showLatestNovels;
        return a(this, function(t3) {
          switch (t3.label) {
            case 0:
              return n3 = this.options, r2 = n3.pageParam, s2 = void 0 === r2 ? "page" : r2, i3 = n3.novelListing, l2 = n3.typeParam, c = void 0 === l2 ? "type" : l2, u = n3.latestPage, h = n3.genreParam, p = void 0 === h ? "category_novel" : h, v = n3.genreKey, d = void 0 === v ? "id" : v, f = n3.langParam, m = n3.urlLangCode, b = n3.noPages, g = void 0 === b ? [] : b, w = n3.pageAsPath, y = void 0 !== w && w, 1 !== e3 && !x && !P.genres.value.length && g.length > 0 && g.includes(P.type.value) ? [2, []] : (k = "", i3 ? (S = new URLSearchParams(), x ? S.append(c, u) : P.genres.value.length ? (S.append(c, p), S.append(d, P.genres.value)) : S.append(c, P.type.value), f && m && S.append(f, m), S.append(s2, e3.toString()), k = "".concat(this.site).concat(i3, "?").concat(S.toString())) : (C = x ? u : P.genres.value.length ? P.genres.value : P.type.value, k = y ? e3 > 1 ? "".concat(this.site).concat(C, "/").concat(e3.toString()) : "".concat(this.site).concat(C) : "".concat(this.site).concat(C, "?").concat(s2, "=").concat(e3.toString())), [4, (0, o.fetchApi)(k)]);
            case 1:
      ...
      return t(this, void 0, void 0, function() {
        var t2, l2, c, u, h, p, v, d, f, m, b, g, w, y, k, S, C, N, L, P, x, I, j, A, _, R, H, G, U = this;
        return a(this, function(a2) {
          switch (a2.label) {
            ...
            case 2:
              return l2 = a2.sent(), c = { path: i3, chapters: [] }, u = [], h = [], p = [], v = [], d = [], f = [], m = null, b = {}, g = 0, y = [n.Idle], k = /* @__PURE__ */ __name(function() {
                return y[y.length - 1];
              }, "k"), S = /* @__PURE__ */ __name(function(e2) {
                return y.push(e2);
              }, "S"), C = /* @__PURE__ */ __name(function() {
                return y.length > 1 ? y.pop() : k();
              }, "C"), N = new r.Parser({ onopentag: /* @__PURE__ */ __name(function(e2, t3) {
                var a3, r2, o2, s2 = k();
                switch (e2) {
                  case "div":
                    switch (t3.class) {
                      case "books":
                      case "m-imgtxt":
                        return void S(n.Cover);
                      case "inner":
                      case "desc-text":
                        s2 === n.Cover && C(), S(n.Summary);
                        break;
                      case "info":
                        S(n.Info), w = 0;
                    }
                  ...
                  case "img":
                    if (s2 === n.Cover) {
                      ...
                      l3 && (c.cover = new URL(l3, U.site).href), h2 ? c.name = h2 : C();
                    }
                    break;
                  case "h3":
                    s2 === n.Cover && S(n.NovelName);
                    break;
                  case "span":
                  ...
                  case "br":
                    ...
                    break;
                  case "ul":
                    (null === (o2 = t3.class) || void 0 === o2 ? void 0 : o2.includes("info-meta")) && S(n.Info), U.options.noAjax && "idData" === t3.id && S(n.ChapterList);
                    break;
                  case "a":
                    if (s2 === n.ChapterList) {
                      g++;
                      var v2 = t3.href;
                      S(n.Chapter), b.name = t3.title || "Chapter ".concat(g), b.releaseTime = null, b.chapterNumber = g, b.path = (null == v2 ? void 0 : v2.substring(1)) || i3.replace(".html", "/chapter-".concat(g, ".html"));
                    }
                }
                ...
                c.summary = u.join("\n\n").trim();
              }, "onend") }), N.write(l2), N.end(), this.options.noAjax && f.length > 0 ? (c.chapters = f, [3, 7]) : [3, 3];
            case 3:
            ...
            case 5:
              return [4, j.text()];
            case 6:
              A = a2.sent(), _ = [], R = {}, (H = new r.Parser({ onopentag: /* @__PURE__ */ __name(function(e2, t3) {
                var a3, r2;
                if ("a" === e2 && t3.href ? (a3 = t3.href, r2 = t3.title || "", S(n.Chapter)) : "option" === e2 && t3.value && (a3 = t3.value, r2 = "", S(n.Chapter)), void 0 !== a3) {
                  var o2 = new URL(a3, U.site);
                  R.path = o2.pathname.substring(1), R.name = r2;
                }
              }, "onopentag"), ontext: /* @__PURE__ */ __name(function(e2) {
                var t3 = e2.trim();
                k() === n.Chapter && !R.name && t3 && (R.name += t3);
              }, "ontext"), onclosetag: /* @__PURE__ */ __name(function(t3) {
                "a" !== t3 && "option" !== t3 || k() !== n.Chapter || (R.name && R.path && (R.name = R.name.trim(), R.releaseTime = null, _.push(e({}, R))), R = {}, C());
              }, "onclosetag") })).write(A), H.end(), c.chapters = _, a2.label = 7;
            case 7:
              return [2, c];
          }
        });
      ...
      return t(this, void 0, void 0, function() {
        var t2, s2, i3, l2, c, u, h, p, v, d, f, m, b, g;
        return a(this, function(a2) {
          switch (a2.label) {
            case 0:
            ...
            case 2:
              return t2 = a2.sent(), l2 = [], c = false, u = "", h = [n.Idle], p = /* @__PURE__ */ __name(function() {
              ...
              }, "d"), f = /[&<>"' ]/g, m = { "&": "&amp;", "<": "&lt;", ">": "&gt;", '"': "&quot;", "'": "&#39;", "\xA0": "&nbsp;" }, b = /* @__PURE__ */ __name(function(e3) {
                return e3.replace(f, function(e4) {
                  return m[e4];
                });
              }, "b"), g = new r.Parser({ onopentag: /* @__PURE__ */ __name(function(e3, t3) {
                ...
                switch (r2) {
                  case n.Idle:
                    ...
                    break;
                  case n.Chapter:
                    "sub" === e3 ? v(n.Hidden) : "div" === e3 && (s2++, ((null == o2 ? void 0 : o2.includes("unlock-buttons")) || (null == o2 ? void 0 : o2.includes("ads"))) && (v(n.Hidden), i3 = 0));
                    break;
                  case n.Hidden:
                    "sub" === e3 ? v(n.Hidden) : "div" === e3 && i3++;
                    break;
                  default:
                    return;
                }
                ...
                var t3 = p();
                t3 === n.Hidden && ("sub" === e3 ? d() : "div" === e3 && --i3 < 0 && (d(), s2--)), t3 === n.Chapter && (g.isVoidElement(e3) || (c && e3 === u ? (c = false, u = "") : l2.push("</".concat(e3, ">"))), "div" === e3 && --s2 < 0 && v(n.Stopped));
              }, "onclosetag") }), g.write(t2), g.end(), [2, l2.join("")];
          }
        });
      });
    }, i2.prototype.searchNovels = function(n2, r2) {
      return t(this, void 0, void 0, function() {
        var t2, s2, i3, l2, c, u, h, p, v, d, f, m, b, g, w, y, k, S, C, N;
        return a(this, function(a2) {
          switch (a2.label) {
            case 0:
