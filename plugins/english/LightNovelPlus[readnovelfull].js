      ...
      return t(this, void 0, void 0, (function() {
        ...
        return a(this, (function(a2) {
          switch (a2.label) {
            ...
            case 2:
              return l2 = a2.sent(), c = { path: i3, chapters: [] }, u = [], h = [], p = [], v = [], d = [], f = [], m = null, b = {}, g = 0, y = [n.Idle], k = function() {
                return y[y.length - 1];
              }, S = function(e2) {
                return y.push(e2);
              }, C = function() {
                return y.length > 1 ? y.pop() : k();
              }, N = new r.Parser({ onopentag: function(e2, t3) {
                var a3, r2, o2, s2 = k();
                switch (e2) {
                  case "div":
                    switch (t3.class) {
                ...
                c.summary = u.join("\n\n").trim();
              } }), N.write(l2), N.end(), this.options.noAjax && f.length > 0 ? (c.chapters = f, [3, 7]) : [3, 3];
            case 3:
            ...
            case 5:
              return [4, j.text()];
            case 6:
              A = a2.sent(), _ = [], R = {}, (H = new r.Parser({ onopentag: function(e2, t3) {
                var a3, r2;
              ...
              } })).write(A), H.end(), c.chapters = _, a2.label = 7;
            case 7:
              return [2, c];
          }
        }));
        ...
        return a(this, (function(a2) {
          switch (a2.label) {
            ...
            case 2:
              ...
              }, f = /[&<>"' ]/g, m = { "&": "&amp;", "<": "&lt;", ">": "&gt;", '"': "&quot;", "'": "&#39;", "\xA0": "&nbsp;" }, b = function(e3) {
                return e3.replace(f, (function(e4) {
                  return m[e4];
                }));
              }, g = new r.Parser({ onopentag: function(e3, t3) {
