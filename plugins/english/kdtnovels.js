...
(() => {
  ...
  var require_types = __commonJS({
    "node_modules/protobufjs/src/types.js"(exports2) {
      ...
      function bake(values, offset) {
        var i = 0, o2 = {};
        offset |= 0;
        while (i < values.length) o2[s2[i + offset]] = values[i++];
        return o2;
      }
      __name(bake, "bake");
      types.basic = bake([
  ...
  // .js/plugins/english/kdtnovels.js
  var e = function(e2, t2, r2, n2) {
    return new (r2 || (r2 = Promise))((function(a2, s2) {
      function o2(e3) {
        try {
          c(n2.next(e3));
        } catch (e4) {
    ...
    var r2, n2, a2, s2 = { label: 0, sent: /* @__PURE__ */ __name(function() {
      if (1 & a2[0]) throw a2[1];
      return a2[1];
    }, "sent"), trys: [], ops: [] }, o2 = Object.create(("function" == typeof Iterator ? Iterator : Object).prototype);
    return o2.next = i(0), o2.throw = i(1), o2.return = i(2), "function" == typeof Symbol && (o2[Symbol.iterator] = function() {
      return this;
    }), o2;
    function i(i2) {
      return function(c) {
        return (function(i3) {
          ...
          for (; o2 && (o2 = 0, i3[0] && (s2 = 0)), s2; ) try {
            if (r2 = 1, n2 && (a2 = 2 & i3[0] ? n2.return : i3[0] ? n2.throw || ((a2 = n2.return) && a2.call(n2), 0) : n2.next) && !(a2 = a2.call(n2, i3[1])).done) return a2;
            switch (n2 = 0, a2 && (i3 = [2 & i3[0], a2.value]), i3[0]) {
              case 0:
              case 1:
                a2 = i3;
                break;
              case 4:
                return s2.label++, { value: i3[1], done: false };
              case 5:
                s2.label++, n2 = i3[1], i3 = [0];
                continue;
              case 7:
                i3 = s2.ops.pop(), s2.trys.pop();
                continue;
              default:
                if (!(a2 = s2.trys, (a2 = a2.length > 0 && a2[a2.length - 1]) || 6 !== i3[0] && 2 !== i3[0])) {
                  s2 = 0;
                  continue;
                }
                if (3 === i3[0] && (!a2 || i3[1] > a2[0] && i3[1] < a2[3])) {
                  s2.label = i3[1];
                  break;
                }
                if (6 === i3[0] && s2.label < a2[1]) {
                  s2.label = a2[1], a2 = i3;
                  break;
                }
                if (a2 && s2.label < a2[2]) {
                  s2.label = a2[2], s2.ops.push(i3);
                  break;
                }
  ...
  var r = (init_browser(), __toCommonJS(browser_exports)), n = (init_fetch2(), __toCommonJS(fetch_exports)), a = (init_defaultCover(), __toCommonJS(defaultCover_exports)), s = (init_novelStatus(), __toCommonJS(novelStatus_exports)), o = (function() {
    function o2() {
      this.id = "kdtnovels", this.name = "KDT Novels", this.version = "1.0.0", this.icon = "src/en/kdtnovels/icon.png", this.site = "https://kdtnovels.com/";
    }
    __name(o2, "o");
    return o2.prototype.parseNovelItems = function(e2) {
      var t2 = this, n2 = (0, r.load)(e2), s2 = [];
      return n2("div.c-tabs-item__content").each((function(e3, r2) {
        var o3 = n2(r2), i = o3.find("div.tab-thumb img").first(), c = i.attr("data-src") || i.attr("src") || a.defaultCover, u = o3.find("div.post-title > h3 > a").first(), l = u.text().trim(), h = u.attr("href");
        if (l && h) {
          var p = h.replace(t2.site, "").replace(/^\/+|\/+$/g, "");
          s2.push({ name: l, path: p, cover: c || a.defaultCover });
        }
      })), s2;
    }, o2.prototype.parseNovelStatus = function(e2) {
      if (!e2) return s.NovelStatus.Unknown;
      var t2 = e2.toLowerCase().trim();
      return t2.includes("ongoing") || t2.includes("on going") ? s.NovelStatus.Ongoing : t2.includes("completed") || t2.includes("complete") ? s.NovelStatus.Completed : t2.includes("licensed") ? s.NovelStatus.Licensed : t2.includes("finished") || t2.includes("publishing finished") ? s.NovelStatus.PublishingFinished : t2.includes("cancelled") || t2.includes("canceled") ? s.NovelStatus.Cancelled : t2.includes("hiatus") || t2.includes("on hiatus") ? s.NovelStatus.OnHiatus : e2 || s.NovelStatus.Unknown;
    }, o2.prototype.popularNovels = function(r2, a2) {
      return e(this, void 0, void 0, (function() {
        var e2, s2, o3, i;
        return t(this, (function(t2) {
          switch (t2.label) {
            case 0:
              e2 = a2.showLatestNovels ? "latest" : "views", s2 = "".concat(this.site, "/page/").concat(r2, "/?s&post_type=wp-manga&m_orderby=").concat(e2), t2.label = 1;
            case 1:
              return t2.trys.push([1, 4, , 5]), [4, (0, n.fetchApi)(s2)];
            case 2:
              return [4, t2.sent().text()];
            case 3:
              return o3 = t2.sent(), [2, this.parseNovelItems(o3)];
            case 4:
              return i = t2.sent(), console.error("Error fetching popular novels:", i), [2, []];
            case 5:
              return [2];
          }
        }));
      }));
    }, o2.prototype.searchNovels = function(r2, a2) {
      return e(this, void 0, void 0, (function() {
        var e2, s2, o3, i;
        return t(this, (function(t2) {
          switch (t2.label) {
            case 0:
              e2 = "".concat(this.site, "/page/").concat(a2, "/?s=").concat(encodeURIComponent(r2), "&post_type=wp-manga&op&author&artist&release&adult"), t2.label = 1;
            case 1:
              return t2.trys.push([1, 4, , 5]), [4, (0, n.fetchApi)(e2)];
            case 2:
              return [4, t2.sent().text()];
            case 3:
              return s2 = t2.sent(), 0 === (o3 = this.parseNovelItems(s2)).length && console.log('No search results found for term: "'.concat(r2, '" on page ').concat(a2)), [2, o3];
            case 4:
              return i = t2.sent(), console.error("Error searching novels:", i), [2, []];
            case 5:
              return [2];
          }
        }));
      }));
    }, o2.prototype.parseNovel = function(s2) {
      return e(this, void 0, void 0, (function() {
        var e2, o3, i, c, u, l, h, p, d, f, v, m, g, b, y, w, x, N, C, S;
        return t(this, (function(t2) {
          switch (t2.label) {
            case 0:
              e2 = this.site + s2, t2.label = 1;
            case 1:
              return t2.trys.push([1, 9, , 10]), [4, (0, n.fetchApi)(e2)];
            case 2:
              return [4, t2.sent().text()];
            case 3:
              o3 = t2.sent(), i = (0, r.load)(o3), c = { name: "", path: s2, cover: a.defaultCover, author: "", artist: "", genres: "", summary: "", status: "", chapters: [] }, u = i(".manga-title").first(), c.name = u.text().trim() || "Unknown Title", l = i("div.summary_image img").first(), h = l.attr("data-src") || l.attr("src"), c.cover = h || a.defaultCover, p = i("div.genres-content a"), d = [], p.each((function(e3, t3) {
                var r2 = i(t3).text().trim();
                r2 && d.push(r2);
              })), c.genres = d.join(","), f = i("div.manga-excerpt p"), v = [], f.each((function(e3, t3) {
                var r2 = i(t3).text().trim();
                r2 && v.push(r2);
              })), c.summary = v.join("\n\n"), m = i("div.manga-status span:nth-child(2)").first(), g = m.text().trim(), c.status = this.parseNovelStatus(g), b = [], t2.label = 4;
            case 4:
              return t2.trys.push([4, 7, , 8]), y = "".concat(e2, "/ajax/chapters/?t=1"), [4, (0, n.fetchApi)(y, { method: "POST" })];
            case 5:
              return [4, t2.sent().text()];
            case 6:
              return w = t2.sent(), x = (0, r.load)(w), (N = x("li.free-chap")).each((function(e3, t3) {
                var r2 = x(t3), n2 = r2.find("a").first(), a2 = n2.text().trim(), s3 = n2.attr("href"), o4 = r2.find("span.chapter-release-date").first().text().trim() || null, i2 = N.length - e3, c2 = a2.match(/Ch\s*(\d+(?:\.\d+)?)/i);
                if (c2 || (c2 = a2.match(/c(\d+(?:\.\d+)?)/i)), c2 && (i2 = parseFloat(c2[1])), a2 && s3) {
                  var u2 = void 0;
                  if (s3.startsWith("http")) u2 = new URL(s3).pathname.replace(/^\/+|\/+$/g, "");
                  else u2 = s3.replace(/^\/+|\/+$/g, "");
                  b.push({ name: a2, path: u2, releaseTime: o4, chapterNumber: i2 });
                }
              })), b.reverse(), [3, 8];
            case 7:
              return C = t2.sent(), console.error("Error fetching chapter list:", C), b = [], [3, 8];
            case 8:
              return c.chapters = b, [2, c];
            case 9:
              return S = t2.sent(), console.error("Error parsing novel:", S), [2, { name: "Error loading novel", path: s2, cover: a.defaultCover, chapters: [] }];
            case 10:
              return [2];
          }
        }));
      ...
      return e(this, void 0, void 0, (function() {
        ...
        return t(this, (function(t2) {
          switch (t2.label) {
            case 0:
              e2 = this.site + a2, t2.label = 1;
            case 1:
              return t2.trys.push([1, 4, , 5]), [4, (0, n.fetchApi)(e2)];
            case 2:
              return [4, t2.sent().text()];
            case 3:
              return s2 = t2.sent(), o3 = (0, r.load)(s2), 0 === (i = o3("div.reading-content").first()).length ? (console.warn("Chapter content container not found"), [2, ""]) : (i.find('input[type="hidden"]').remove(), i.find("img").each((function(e3, t3) {
                var r2 = o3(t3), n2 = r2.attr("data-src");
                n2 && !r2.attr("src") && r2.attr("src", n2), r2.attr("alt") || r2.attr("alt", "Chapter image");
              })), i.find("p, div, br").each((function(e3, t3) {
                var r2, n2, a3 = o3(t3);
                "p" === (null === (r2 = t3.tagName) || void 0 === r2 ? void 0 : r2.toLowerCase()) && a3.text().trim(), "div" === (null === (n2 = t3.tagName) || void 0 === n2 ? void 0 : n2.toLowerCase()) && a3.text().trim();
              })), (c = i.html()) && (c = c.replace(/<!--[\s\S]*?-->/g, "")), [2, (null == c ? void 0 : c.trim()) || ""]);
            case 4:
              return u = t2.sent(), console.error("Error parsing chapter:", u), [2, ""];
            case 5:
              return [2];
          }
        }));
