...
var LNReaderPlugin = (() => {
  ...
  // .js/plugins/english/crimsonscrolls.js
  init_dirname();
  init_buffer2();
  init_process2();
  ...
  var n, r = (init_browser(), __toCommonJS(browser_exports)), i = (init_fetch2(), __toCommonJS(fetch_exports)), o = (init_storage2(), __toCommonJS(storage_exports));
  !function(t2) {
    t2.novels = "load_novels", t2.search = "live_novel_search";
  }(n || (n = {}));
  var a = function() {
    function a2() {
      var t2 = this;
      this.id = "crimsonscrolls", this.name = "Crimson Scrolls", this.icon = "src/en/crimsonscrolls/icon.png", this.site = "https://crimsonscrolls.net", this.version = "1.0.0", this.hideLocked = o.storage.get("hideLocked"), this.pluginSettings = { hideLocked: { value: "", label: "Hide locked chapters", type: "Switch" } }, this.resolveUrl = function(e2, n2) {
        return t2.site + "/novel/" + e2;
      };
    }
    __name(a2, "a");
    return a2.prototype.queryAPI = function(n2) {
      return t(this, void 0, void 0, function() {
        var t2, o2, a3, s, c, l, u;
        return e(this, function(e2) {
          switch (e2.label) {
            case 0:
              for ((t2 = new FormData()).append("action", n2.action), o2 = 0, a3 = Object.entries(n2.params); o2 < a3.length; o2++) s = a3[o2], c = s[0], l = s[1], t2.append(c, l);
              return [4, (0, i.fetchApi)("".concat(this.site, "/wp-admin/admin-ajax.php"), { method: "POST", body: t2 }).then(function(t3) {
                return t3.json();
              })];
            case 1:
              return u = e2.sent(), [2, (0, r.load)(u.html)];
          }
        });
      });
    }, a2.prototype.fetchChapters = function(n2, r2) {
      return t(this, void 0, void 0, function() {
        var t2, o2, a3, s, c;
        return e(this, function(e2) {
          switch (e2.label) {
            case 0:
              return t2 = "".concat(this.site, "/wp-json/cs/v1/novels/").concat(n2, "/chapters?per_page=75&order=asc"), [4, (0, i.fetchApi)("".concat(t2, "&page=").concat(r2 || 1)).then(function(t3) {
                return t3.json();
              })];
            case 1:
              return o2 = e2.sent(), a3 = o2.items.some(function(t3) {
                return t3.locked;
              }), !(o2.page < o2.total_pages) || a3 && this.hideLocked ? [3, 3] : (c = (s = o2.items).concat, [4, this.fetchChapters(n2, parseInt(o2.page) + 1)]);
            case 2:
              return [2, c.apply(s, [e2.sent()])];
            case 3:
              return [2, o2.items];
          }
        });
      ...
      var e2 = this, n2 = [];
      return t2(":is(a.live-search-item, div.novel-list-card)").each(function(r2, i2) {
        var o2 = t2(i2).find(":is(div.live-search-title, h3.novel-title)").text().trim(), a3 = t2(i2).find(":is(img.live-search-cover, div.novel-cover img)").attr("src"), s = t2(i2).find("a").attr("href") || t2(i2).attr("href");
        if (s) {
          var c = { name: o2.trim().split(" ").filter(function(t3) {
            return t3.length > 0;
          }).join(" "), cover: a3, path: s.replace(e2.site, "").split("/").at(2) };
          n2.push(c);
        }
      }), n2;
      ...
      return t(this, void 0, void 0, function() {
        ...
        return e(this, function(e2) {
          switch (e2.label) {
            case 0:
              return [4, this.queryAPI({ action: n.novels, params: { page: r2 } })];
            case 1:
              return t2 = e2.sent(), [2, this.parseNovels(t2)];
          }
        });
      });
      ...
      return t(this, void 0, void 0, function() {
        ...
        return e(this, function(e2) {
          switch (e2.label) {
            case 0:
              return [4, (0, i.fetchApi)("".concat(this.site, "/novel/").concat(n2)).then(function(t3) {
                return t3.text();
              })];
            case 1:
              return t2 = e2.sent(), o2 = (0, r.load)(t2), a3 = o2("#single-novel-content-wrapper"), (s = { path: n2, name: a3.find("h1.chapter-title").text().trim() || "Untitled", cover: a3.find(".single-novel-cover > img").data("src"), summary: a3.find("#synopsis-full").text().trim(), author: a3.find(".single-novel-meta strong").filter(function(t3, e3) {
                return o2(e3).text().toLowerCase().search("author") >= 0;
              })[0].next.data.trim(), chapters: [] }).genres = a3.find(".single-novel-meta strong").filter(function(t3, e3) {
                return o2(e3).text().toLowerCase().search("genre") >= 0;
              })[0].next.data.split(",").map(function(t3) {
                return t3.trim();
              }).join(","), s.status = "Unknown", c = o2("#chapter-list").data("novel"), [4, this.fetchChapters(c)];
            case 2:
              for (u in l = e2.sent(), s.chapters = [], l) l[u].locked && this.hideLocked || s.chapters.push({ name: l[u].locked ? "\u{1F512} ".concat(l[u].title) : l[u].title, path: l[u].url.replace(this.site, "").split("/").at(2), chapterNumber: parseInt(u) + 1 });
              return [2, s];
          }
        });
      });
      ...
      return t(this, void 0, void 0, function() {
        ...
        return e(this, function(e2) {
          switch (e2.label) {
            case 0:
              return [4, (0, i.fetchApi)("".concat(this.site, "/chapter/").concat(n2)).then(function(t3) {
                return t3.text();
              })];
            case 1:
              for (t2 = e2.sent(), o2 = (0, r.load)(t2), a3 = 0, s = ["hr.cs-attrib-divider", "div.cs-attrib", "p.cs-chapter-attrib"]; a3 < s.length; a3++) o2("#chapter-display ".concat(s[a3], ":last")).remove();
              return [2, o2("#chapter-display").html() || ""];
          }
        });
      });
    }, a2.prototype.searchNovels = function(r2) {
      return t(this, void 0, void 0, function() {
        var t2;
        return e(this, function(e2) {
          switch (e2.label) {
            case 0:
              return [4, this.queryAPI({ action: n.search, params: { query: r2 } })];
            case 1:
              return t2 = e2.sent(), [2, this.parseNovels(t2)];
          }
        });
