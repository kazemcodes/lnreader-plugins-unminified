      ...
      return e(this, void 0, void 0, function() {
        ...
        return a(this, function(a2) {
          switch (a2.label) {
            ...
            case 1:
              return e2 = a2.sent(), i3 = 0, o = t.Idle, u = [], s = /[&<>"' ]/g, c = { "&": "&amp;", "<": "&lt;", ">": "&gt;", '"': "&quot;", "'": "&#39;", "\xA0": "&nbsp;" }, p = /* @__PURE__ */ __name(function(e3) {
                return e3.replace(s, function(e4) {
                  return c[e4];
                });
              }, "p"), (h = new r.Parser({ onopentag: /* @__PURE__ */ __name(function(e3, a3) {
                switch (o) {
                  case t.Idle:
                ...
                switch (o) {
                  case t.Chapter:
                    h.isVoidElement(e3) || u.push("</".concat(e3, ">")), "div" === e3 && i3--, 0 === i3 && (o = t.Stopped);
                    break;
                  case t.Hidden:
                    o = t.Chapter;
                }
              }, "onclosetag") })).write(e2), h.end(), [2, u.join("")];
          }
        });
      });
