...
var LNReaderPlugin = (() => {
  ...
  var e = function(e2, a2, t2, r2) {
    return new (t2 || (t2 = Promise))(function(l2, n2) {
      function i2(e3) {
        try {
          u(r2.next(e3));
        } catch (e4) {
      ...
      __name(u, "u");
      u((r2 = r2.apply(e2, a2 || [])).next());
    });
  }, a = function(e2, a2) {
    var t2, r2, l2, n2 = { label: 0, sent: /* @__PURE__ */ __name(function() {
    ...
    function o(o2) {
      return function(u) {
        return function(o3) {
          ...
          for (; i2 && (i2 = 0, o3[0] && (n2 = 0)), n2; ) try {
            if (t2 = 1, r2 && (l2 = 2 & o3[0] ? r2.return : o3[0] ? r2.throw || ((l2 = r2.return) && l2.call(r2), 0) : r2.next) && !(l2 = l2.call(r2, o3[1])).done) return l2;
            switch (r2 = 0, l2 && (o3 = [2 & o3[0], l2.value]), o3[0]) {
              case 0:
              case 1:
                l2 = o3;
                break;
              ...
              case 5:
                n2.label++, r2 = o3[1], o3 = [0];
                continue;
              case 7:
                o3 = n2.ops.pop(), n2.trys.pop();
                continue;
              default:
                if (!(l2 = n2.trys, (l2 = l2.length > 0 && l2[l2.length - 1]) || 6 !== o3[0] && 2 !== o3[0])) {
                  n2 = 0;
                  continue;
                }
                ...
                if (6 === o3[0] && n2.label < l2[1]) {
                  n2.label = l2[1], l2 = o3;
                  break;
                }
                if (l2 && n2.label < l2[2]) {
                  n2.label = l2[2], n2.ops.push(o3);
                  break;
                }
                l2[2] && n2.ops.pop(), n2.trys.pop();
                continue;
            }
            o3 = a2.call(e2, n2);
          } catch (e3) {
  ...
  var t, r = require_lib6(), l = (init_fetch2(), __toCommonJS(fetch_exports)), n = (init_filterInputs(), __toCommonJS(filterInputs_exports)), i = function() {
    ...
    return i2.prototype.parseNovels = function(e2) {
      ...
      return e(this, void 0, void 0, function() {
        var e2, i3, o, u, s, c, p, h, v, b;
        return a(this, function(a2) {
          switch (a2.label) {
            case 0:
              return e2 = n2.endsWith("/") ? "" : "/", [4, (0, l.fetchApi)(this.site + n2 + e2)];
            case 1:
              return [4, a2.sent().text()];
            case 2:
              return i3 = a2.sent(), o = { path: n2 }, u = 0, s = t.Idle, c = {}, p = [], h = [], v = [], b = new r.Parser({ onopentag: /* @__PURE__ */ __name(function(a3, r2) {
                var l2, i4;
                switch (a3) {
                  case "div":
                    if ("Cover" === r2.id && (s = t.Cover), null === (l2 = r2.class) || void 0 === l2 ? void 0 : l2.includes("item-box")) {
                      s = t.Chapter;
                      var p2 = r2.onclick.match(/\d+/)[0];
                      return void (c.path = "".concat(n2).concat(e2).concat(p2, ".html"));
                    }
                    s === t.Chapter && u++;
                    break;
                  case "img":
                    s === t.Cover && (o.name = r2.title, o.cover = r2.src);
                    break;
                  case "p":
                    "txtItme" === r2.class ? o.status ? o.author || (s = t.Author) : s = t.Status : "full-des" === r2.id && (s = t.Summary);
                    break;
                  case "br":
                    h.push("\n");
                    break;
                  case "a":
                    (null === (i4 = r2.class) || void 0 === i4 ? void 0 : i4.includes("btn-default")) && (s = t.Genres);
                    break;
                  case "span":
                ...
                switch (s) {
                  case t.Status:
                    o.status = (o.status || "") + e3.trim();
                    break;
                  case t.Author:
                    o.author = (o.author || "") + e3.trim();
                    break;
                  case t.Genres:
                    v.push(e3.trim());
                    break;
                  case t.Summary:
                    ...
                    break;
                  case t.ChapterName:
                    c.name = (c.name || "") + e3.trim();
                    break;
                  case t.ChapterTime:
                    if (null == e3 ? void 0 : e3.includes("Advanced")) return;
                    var a3 = e3.split(".").map(function(e4) {
                      return Number(e4);
                    });
                    3 === a3.length && (c.releaseTime = new Date(a3[0], a3[1] - 1, a3[2]).toISOString());
                }
              }, "ontext"), onclosetag: /* @__PURE__ */ __name(function(e3) {
                switch (e3) {
                  case "div":
                    s === t.Cover && (s = t.Idle), s === t.Chapter && --u < 0 && (c.path && c.name && c.releaseTime && p.push(c), c = {}, u = 0, s = t.Idle);
                    break;
                  case "p":
                    s !== t.Status && s !== t.Author && s !== t.Summary || (s = t.Idle);
                    break;
                  case "a":
                    s === t.Genres && (s = t.Idle);
                    break;
                  case "span":
                    s !== t.ChapterName && s !== t.ChapterTime || (s = t.Chapter, u--);
                }
              }, "onclosetag"), onend: /* @__PURE__ */ __name(function() {
                o.genres = v.join(", "), o.summary = h.join(""), o.chapters = p;
              }, "onend") }), b.write(i3), b.end(), [2, o];
          }
        });
      });
      ...
      return e(this, void 0, void 0, function() {
        ...
        return a(this, function(a2) {
          switch (a2.label) {
            case 0:
              return [4, (0, l.fetchApi)(this.site + n2).then(function(e3) {
                return e3.text();
              })];
            case 1:
              return e2 = a2.sent(), i3 = 0, o = t.Idle, u = [], s = { "&": "&amp;", "<": "&lt;", ">": "&gt;", '"': "&quot;", "'": "&#39;", "\xA0": "&nbsp;" }, c = /* @__PURE__ */ __name(function(e3) {
                return e3.replace(/[&<>"'\xA0]/g, function(e4) {
                  return s[e4];
                });
              }, "c"), (p = new r.Parser({ onopentag: /* @__PURE__ */ __name(function(e3, a3) {
                switch (o) {
                  case t.Idle:
                    "div" === e3 && "main" === a3.class && (o = t.Chapter, i3++);
                    break;
                  case t.Chapter:
                    "div" === e3 && i3++;
                    break;
                ...
                if (o === t.Chapter) {
                  var r2 = Object.keys(a3).map(function(e4) {
                    var t2 = a3[e4].replace(/"/g, "&quot;");
                    return " ".concat(e4, '="').concat(t2, '"');
                  });
                  u.push("<".concat(e3).concat(r2.join(""), ">"));
                }
              }, "onopentag"), ontext: /* @__PURE__ */ __name(function(e3) {
                if (o === t.Chapter) {
                  var a3 = c(e3);
                  ["pawread", "tinyurl", "bit.ly"].some(function(e4) {
                    return null == a3 ? void 0 : a3.includes(e4);
                  }) ? (o = t.Hidden, u.pop()) : u.push(a3);
                }
              }, "ontext"), onclosetag: /* @__PURE__ */ __name(function(e3) {
                switch (o) {
                  case t.Chapter:
                    p.isVoidElement(e3) || u.push("</".concat(e3, ">")), "div" === e3 && i3--, 0 === i3 && (o = t.Stopped);
                    break;
                  case t.Hidden:
                    o = t.Chapter;
                }
              }, "onclosetag") })).write(e2), p.end(), [2, u.join("")];
          }
        });
      });
    }, i2.prototype.searchNovels = function(t2, r2) {
      return e(this, void 0, void 0, function() {
        var e2, n2;
        return a(this, function(a2) {
          switch (a2.label) {
            case 0:
              return e2 = new URLSearchParams({ keywords: t2, page: r2.toString() }), [4, (0, l.fetchApi)("".concat(this.site, "search/?").concat(e2.toString()))];
            case 1:
              return [4, a2.sent().text()];
            case 2:
  ...
  exports.default = new i(), function(e2) {
    e2[e2.Idle = 0] = "Idle", e2[e2.Cover = 1] = "Cover", e2[e2.Genres = 2] = "Genres", e2[e2.Author = 3] = "Author", e2[e2.Status = 4] = "Status", e2[e2.Hidden = 5] = "Hidden", e2[e2.Summary = 6] = "Summary", e2[e2.Stopped = 7] = "Stopped", e2[e2.Chapter = 8] = "Chapter", e2[e2.ChapterName = 9] = "ChapterName", e2[e2.ChapterTime = 10] = "ChapterTime", e2[e2.NovelName = 11] = "NovelName", e2[e2.Novel = 12] = "Novel";
  }(t || (t = {}));
})();
