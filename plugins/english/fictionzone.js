...
(() => {
      ...
      !(function(t2, e2) {
        ...
        var _ = (function() {
          ...
          return m2.parse = function(t3) {
            ...
            var n3, o3 = b.p(t3), f2 = "set" + (this.$u ? "UTC" : ""), l2 = (n3 = {}, n3[a2] = f2 + "Date", n3[d] = f2 + "Date", n3[c2] = f2 + "Month", n3[h] = f2 + "FullYear", n3[u] = f2 + "Hours", n3[s2] = f2 + "Minutes", n3[i2] = f2 + "Seconds", n3[r2] = f2 + "Milliseconds", n3)[o3], $3 = o3 === a2 ? this.$D + (e3 - this.$W) : e3;
            if (o3 === c2 || o3 === h) {
            ...
            if ($3 === a2) return y2(1);
            if ($3 === o2) return y2(7);
            var M3 = (d2 = {}, d2[s2] = e2, d2[u] = n2, d2[i2] = t2, d2)[$3] || 1, m3 = this.$d.getTime() + r3 * M3;
            return b.w(m3, this);
            ...
            var r3 = t3 || "YYYY-MM-DDTHH:mm:ssZ", i3 = b.z(this), s3 = this.$H, u2 = this.$m, a3 = this.$M, o3 = n3.weekdays, c3 = n3.months, f2 = n3.meridiem, h2 = /* @__PURE__ */ __name(function(t4, n4, i4, s4) {
  ...
  // .js/plugins/english/fictionzone.js
  var t = function(t2, e2, n2, r2) {
    ...
    if (n2 || 2 === arguments.length) for (var r2, i2 = 0, a2 = e2.length; i2 < a2; i2++) !r2 && i2 in e2 || (r2 || (r2 = Array.prototype.slice.call(e2, 0, i2)), r2[i2] = e2[i2]);
    return t2.concat(r2 || Array.prototype.slice.call(e2));
  }, r = function(t2) {
    return t2 && t2.__esModule ? t2 : { default: t2 };
  };
  Object.defineProperty(exports, "__esModule", { value: true });
  var i = (init_fetch2(), __toCommonJS(fetch_exports)), a = (init_browser(), __toCommonJS(browser_exports)), o = (init_novelStatus(), __toCommonJS(novelStatus_exports)), s = r(require_dayjs_min()), c = (function() {
    function r2() {
      var t2 = this;
      this.id = "fictionzone", this.name = "Fiction Zone", this.icon = "src/en/fictionzone/icon.png", this.site = "https://fictionzone.net", this.version = "1.0.1", this.filters = void 0, this.imageRequestInit = void 0, this.cachedNovelIds = /* @__PURE__ */ new Map(), this.resolveUrl = function(e2, n2) {
        return t2.site + "/" + e2;
      };
    }
    __name(r2, "r");
    return r2.prototype.popularNovels = function(n2, r3) {
      return t(this, arguments, void 0, (function(t2, n3) {
        n3.showLatestNovels, n3.filters;
        return e(this, (function(e2) {
          switch (e2.label) {
            case 0:
              return [4, this.getPage(this.site + "/library?page=" + t2)];
            case 1:
              return [2, e2.sent()];
          }
        }));
      }));
    }, r2.prototype.getPage = function(n2) {
      return t(this, void 0, void 0, (function() {
        var t2, r3;
        return e(this, (function(e2) {
          switch (e2.label) {
            case 0:
              return [4, (0, i.fetchApi)(n2)];
            case 1:
              return [4, e2.sent().text()];
            case 2:
              return t2 = e2.sent(), [2, (r3 = (0, a.load)(t2))("div.novel-card").map((function(t3, e3) {
                return { name: r3(e3).find("a > div.title > h1").text(), cover: r3(e3).find("img").attr("src"), path: r3(e3).find("a").attr("href").replace(/^\//, "").replace(/\/$/, "") };
              })).toArray()];
          }
        }));
      }));
      ...
      return t(this, void 0, void 0, (function() {
        var t2, s2, c2, u, l, h, p, d, f, v = this;
        return e(this, (function(e2) {
          switch (e2.label) {
            case 0:
              return [4, (0, i.fetchApi)(this.site + "/" + r3)];
            case 1:
              return [4, e2.sent().text()];
            case 2:
              for (t2 = e2.sent(), s2 = (0, a.load)(t2), (c2 = { path: r3, name: s2("div.novel-title > h1").text(), totalPages: 1 }).author = s2("div.novel-author > content").text(), c2.cover = s2("div.novel-img > img").attr("src"), c2.genres = n(n([], s2("div.genres > .items > span").map((function(t3, e3) {
                return s2(e3).text();
              })).toArray(), true), s2("div.tags > .items > a").map((function(t3, e3) {
                return s2(e3).text();
              })).toArray(), true).join(","), "Ongoing" === s2("div.novel-status > div.content").text().trim() && (c2.status = o.NovelStatus.Ongoing), c2.summary = s2("#synopsis > div.content").text(), u = s2("script#__NUXT_DATA__").html(), l = JSON.parse(u), h = null, p = 0, d = l; p < d.length && ("string" != typeof (f = d[p]) || !f.startsWith("novel_covers/")); p++) h = f;
              return this.cachedNovelIds.set(r3, h.toString()), c2.chapters = s2("div.chapters > div.list-wrapper > div.items > a.chapter").map((function(t3, e3) {
                var n2, r4 = s2(e3).find("span.chapter-title").text(), i2 = null === (n2 = s2(e3).attr("href")) || void 0 === n2 ? void 0 : n2.replace(/^\//, "").replace(/\/$/, "");
                return { name: r4, releaseTime: v.parseAgoDate(s2(e3).find("span.update-date").text()), path: null == i2 ? void 0 : i2.replace(/^\//, "").replace(/\/$/, "") };
              })).toArray().filter((function(t3) {
                return !!t3.path;
              })), c2.totalPages = parseInt(s2("div.chapters ul.el-pager > li:last-child").text()), [2, c2];
          }
        }));
      }));
    }, r2.prototype.parsePage = function(n2, r3) {
      return t(this, void 0, void 0, (function() {
        var t2;
        return e(this, (function(e2) {
          switch (e2.label) {
            case 0:
              return (t2 = this.cachedNovelIds.get(n2)) ? [3, 2] : [4, this.parseNovel(n2)];
            case 1:
              e2.sent(), t2 = this.cachedNovelIds.get(n2), e2.label = 2;
            case 2:
              return [4, (0, i.fetchApi)(this.site + "/api/__api_party/api-v1", { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ path: "/chapter/all/" + t2, query: { page: parseInt(r3) }, headers: { "content-type": "application/json" }, method: "get" }) }).then((function(t3) {
                return t3.json();
              }))];
            case 3:
              return [2, { chapters: e2.sent()._data.map((function(t3) {
                return { name: t3.title, releaseTime: new Date(t3.created_at).toISOString(), path: n2 + "/" + t3.slug };
              })) }];
          }
        }));
      }));
    }, r2.prototype.parseChapter = function(n2) {
      return t(this, void 0, void 0, (function() {
        var t2;
        return e(this, (function(e2) {
          switch (e2.label) {
            case 0:
              return [4, (0, i.fetchApi)(this.site + "/" + n2)];
            case 1:
              return [4, e2.sent().text()];
            case 2:
              return t2 = e2.sent(), [2, (0, a.load)(t2)("div.chapter-content").html() || ""];
          }
        }));
      }));
    }, r2.prototype.searchNovels = function(n2, r3) {
      return t(this, void 0, void 0, (function() {
        return e(this, (function(t2) {
          switch (t2.label) {
            case 0:
              return [4, this.getPage(this.site + "/library?query=" + encodeURIComponent(n2) + "&page=" + r3 + "&sort=views-all")];
            case 1:
              return [2, t2.sent()];
          }
        }));
      }));
    }, r2.prototype.parseAgoDate = function(t2) {
      var e2;
      if (null == t2 ? void 0 : t2.includes("ago")) {
        var n2 = (0, s.default)(/* @__PURE__ */ new Date()), r3 = (null === (e2 = t2.match(/\d+/)) || void 0 === e2 ? void 0 : e2[0]) || "", i2 = parseInt(r3, 10);
        return r3 ? ((t2.includes("hours ago") || t2.includes("hour ago")) && n2.subtract(i2, "hours"), (t2.includes("days ago") || t2.includes("day ago")) && n2.subtract(i2, "days"), (t2.includes("months ago") || t2.includes("month ago")) && n2.subtract(i2, "months"), (t2.includes("years ago") || t2.includes("year ago")) && n2.subtract(i2, "years"), n2.toISOString()) : null;
      }
      return null;
    }, r2;
  })();
