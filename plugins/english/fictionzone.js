...
var LNReaderPlugin = (() => {
  ...
  var r = (init_fetch2(), __toCommonJS(fetch_exports)), o = (init_novelStatus(), __toCommonJS(novelStatus_exports)), a = function() {
    function a2() {
      var t2 = this;
      this.id = "fictionzone", this.name = "Fiction Zone", this.icon = "src/en/fictionzone/icon.png", this.site = "https://fictionzone.net", this.version = "1.0.2", this.filters = void 0, this.resolveUrl = function(e2, n2) {
        return t2.site + "/" + e2.split("|")[0];
      };
    }
    __name(a2, "a");
          ...
          switch (e2.label) {
            ...
            case 1:
              return a3 = e2.sent(), i = { path: r2, name: a3.data.title, cover: "https://cdn.fictionzone.net/insecure/rs:fill:165:250/".concat(a3.data.image, ".webp"), genres: n(n([], a3.data.genres.map(function(t3) {
                ...
                return t3.name;
              }), true).join(","), status: 1 == a3.data.status ? o.NovelStatus.Ongoing : 0 == a3.data.status ? o.NovelStatus.Completed : o.NovelStatus.Unknown, author: (null === (s = a3.data.contributors.filter(function(t3) {
                return "author" == t3.role;
              })[0]) || void 0 === s ? void 0 : s.display_name) || "", summary: a3.data.synopsis }, [4, this.getChapterPage(a3.data.id, r2)];
            case 2:
      ...
      return t(this, void 0, void 0, function() {
        return e(this, function(t2) {
          switch (t2.label) {
            ...
            case 1:
              return [2, "<p>" + t2.sent().data.content.replaceAll("\n", "</p><p>") + "</p>"];
          }
        });
      });
