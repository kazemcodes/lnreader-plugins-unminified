...
var LNReaderPlugin = (() => {
  ...
  var t = function() {
    return t = Object.assign || function(t2) {
      for (var e2, r2 = 1, n2 = arguments.length; r2 < n2; r2++) for (var s2 in e2 = arguments[r2]) Object.prototype.hasOwnProperty.call(e2, s2) && (t2[s2] = e2[s2]);
      return t2;
    }, t.apply(this, arguments);
  }, e = function(t2, e2, r2, n2) {
    ...
    var r2, n2, s2, a2 = { label: 0, sent: /* @__PURE__ */ __name(function() {
      if (1 & s2[0]) throw s2[1];
      return s2[1];
    }, "sent"), trys: [], ops: [] }, i2 = Object.create(("function" == typeof Iterator ? Iterator : Object).prototype);
    return i2.next = o(0), i2.throw = o(1), i2.return = o(2), "function" == typeof Symbol && (i2[Symbol.iterator] = function() {
      return this;
    }), i2;
    function o(o2) {
      return function(c) {
        return function(o3) {
          ...
          for (; i2 && (i2 = 0, o3[0] && (a2 = 0)), a2; ) try {
            if (r2 = 1, n2 && (s2 = 2 & o3[0] ? n2.return : o3[0] ? n2.throw || ((s2 = n2.return) && s2.call(n2), 0) : n2.next) && !(s2 = s2.call(n2, o3[1])).done) return s2;
            switch (n2 = 0, s2 && (o3 = [2 & o3[0], s2.value]), o3[0]) {
              case 0:
              case 1:
                s2 = o3;
                break;
              case 4:
                return a2.label++, { value: o3[1], done: false };
              case 5:
                a2.label++, n2 = o3[1], o3 = [0];
                continue;
              case 7:
                o3 = a2.ops.pop(), a2.trys.pop();
                continue;
              default:
                if (!(s2 = a2.trys, (s2 = s2.length > 0 && s2[s2.length - 1]) || 6 !== o3[0] && 2 !== o3[0])) {
                  a2 = 0;
                  continue;
                }
                if (3 === o3[0] && (!s2 || o3[1] > s2[0] && o3[1] < s2[3])) {
                  a2.label = o3[1];
                  break;
                }
                if (6 === o3[0] && a2.label < s2[1]) {
                  a2.label = s2[1], s2 = o3;
                  break;
                }
                if (s2 && a2.label < s2[2]) {
                  a2.label = s2[2], a2.ops.push(o3);
                  break;
                }
  ...
  var n = require_lib6(), s = (init_fetch2(), __toCommonJS(fetch_exports)), a = (init_novelStatus(), __toCommonJS(novelStatus_exports)), i = new (function() {
    function i2(t2) {
      var e2 = this;
      this.parseDate = function(t3) {
        var r2 = /* @__PURE__ */ new Date();
        if (!t3) return r2.toISOString();
        if ("ranobes-ru" === e2.id) {
          if (t3.includes(" \u0432 ")) return t3.replace(" \u0432 ", " \u0433., ");
          var n2 = t3.split(", "), s2 = n2[0], a2 = n2[1];
          if (!a2) return r2.toISOString();
          var i3 = a2.split(":"), o = i3[0], c = i3[1];
          switch (s2) {
            case "\u0421\u0435\u0433\u043E\u0434\u043D\u044F":
              r2.setHours(parseInt(o, 10)), r2.setMinutes(parseInt(c, 10));
              break;
            case "\u0412\u0447\u0435\u0440\u0430":
              r2.setDate(r2.getDate() - 1), r2.setHours(parseInt(o, 10)), r2.setMinutes(parseInt(c, 10));
              break;
            default:
              return r2.toISOString();
          }
        } else {
          var l = t3.split(" "), u = l[0], h = l[1];
          if ("ago" !== l[2]) return r2.toISOString();
          switch (h) {
            case "minutes":
              r2.setMinutes(parseInt(u, 10));
              break;
            case "hour":
            case "hours":
              r2.setHours(parseInt(u, 10));
              break;
            case "day":
            case "days":
              r2.setDate(r2.getDate() - parseInt(u, 10));
              break;
            case "month":
            case "months":
              r2.setMonth(r2.getMonth() - parseInt(u, 10));
              break;
            case "year":
            case "years":
              r2.setFullYear(r2.getFullYear() - parseInt(u, 10));
              break;
            default:
              return r2.toISOString();
          }
        ...
        return r2.toISOString();
      }, this.id = t2.id, this.name = t2.sourceName, this.icon = "multisrc/ranobes/ranobes/icon.png", this.site = t2.sourceSite, this.version = "2.0.2", this.options = t2.options;
    }
    __name(i2, "i");
    return i2.prototype.safeFecth = function(t2) {
      return e(this, arguments, void 0, function(t3, e2) {
        var n2, a2, i3, o, c;
        return void 0 === e2 && (e2 = {}), r(this, function(r2) {
          switch (r2.label) {
            case 0:
              return [4, (0, s.fetchApi)(t3, e2)];
            case 1:
              if (!(n2 = r2.sent()).ok) throw new Error("Could not reach site (" + n2.status + ") try to open in webview.");
              return [4, n2.text()];
            case 2:
              if (a2 = r2.sent(), (i3 = null === (c = null === (o = a2.match(/<title>(.*?)<\/title>/)) || void 0 === o ? void 0 : o[1]) || void 0 === c ? void 0 : c.trim()) && ("Bot Verification" == i3 || "You are being redirected..." == i3 || "Un instant..." == i3 || "Just a moment..." == i3 || "Redirecting..." == i3)) throw new Error("Captcha error, please open in webview");
              return [2, a2];
          }
        });
      });
    }, i2.prototype.parseNovels = function(t2) {
      var e2 = [], r2 = { name: "" }, s2 = this.site, a2 = false, i3 = false, o = false, c = new n.Parser({ onopentag: /* @__PURE__ */ __name(function(t3, n2) {
        var c2, l;
        (null === (c2 = n2.class) || void 0 === c2 ? void 0 : c2.includes("short-cont")) && (a2 = true), a2 && ("h2" === t3 && (null === (l = n2.class) || void 0 === l ? void 0 : l.includes("title")) && (i3 = true), i3 && "a" === t3 && (r2.path = n2.href.slice(s2.length), o = true), "figure" === t3 && (r2.cover = n2.style.replace(/.*url\((.*?)\)./g, "$1")), r2.path && r2.cover && (e2.push(r2), (r2 = {}).name = ""));
      }, "onopentag"), ontext: /* @__PURE__ */ __name(function(t3) {
        o && (r2.name += t3);
      }, "ontext"), onclosetag: /* @__PURE__ */ __name(function(t3) {
        "h2" === t3 && (o = false, i3 = false), "figure" === t3 && (a2 = false);
      }, "onclosetag") });
      return c.write(t2), c.end(), e2;
    }, i2.prototype.parseChapters = function(t2) {
      var e2 = this, r2 = [];
      return t2.chapters.map(function(t3) {
        r2.push({ name: t3.title, releaseTime: new Date(t3.date).toISOString(), path: t3.link.slice(e2.site.length) });
      }), r2.reverse();
    }, i2.prototype.popularNovels = function(t2) {
      return e(this, void 0, void 0, function() {
        var e2, n2;
        return r(this, function(r2) {
          switch (r2.label) {
            case 0:
              return e2 = "".concat(this.site, "/").concat(this.options.path, "/page/").concat(t2, "/"), [4, this.safeFecth(e2)];
            case 1:
              return n2 = r2.sent(), [2, this.parseNovels(n2)];
          }
        });
      });
    }, i2.prototype.parseNovel = function(s2) {
      return e(this, void 0, void 0, function() {
        var e2, i3, o, c, l, u, h, p, f, d, v, g, m, b, w, y, S, O, _, I;
        return r(this, function(r2) {
          switch (r2.label) {
            case 0:
              return e2 = this.site, [4, this.safeFecth(e2 + s2)];
            case 1:
              return i3 = r2.sent(), o = { path: s2, name: "", summary: "", chapters: [], totalPages: 1 }, c = false, l = false, u = false, h = false, p = false, f = false, d = false, v = false, g = false, m = false, b = false, w = [], y = [], S = {}, O = 0, _ = this.parseDate, (I = new n.Parser({ onopentag: /* @__PURE__ */ __name(function(t2, r3) {
                "poster" === r3.class && (c = true), c && "img" === t2 && (o.name = r3.alt, o.cover = e2 + r3.src), ("div" === t2 && "moreless cont-text showcont-h" === r3.class || "cont-text showcont-h" === r3.class && "description" === r3.itemprop) && (u = true), "li" === t2 && r3.title && (r3.title.includes("Original status") || r3.title.includes("\u0421\u0442\u0430\u0442\u0443\u0441 \u043E\u0440\u0438\u0433\u0438\u043D\u0430\u043B\u0430")) && (h = true), "a" === t2 && "chapter" === r3.rel && (g = true, S.path = r3.href.replace(e2, "")), g && "span" === t2 && "title ellipses" === r3.class && (m = true), g && "span" === t2 && "grey" === r3.class && (b = true), "li" !== t2 || "Glossary + illustrations + division of chapters, etc." != r3.title && "\u0413\u043B\u043E\u0441\u0441\u0430\u0440\u0438\u0439 + \u0438\u043B\u043B\u044E\u0441\u0442\u0440\u0430\u0446\u0438\u0439 + \u0440\u0430\u0437\u0434\u0435\u043B\u0435\u043D\u0438\u0435 \u0433\u043B\u0430\u0432 \u0438 \u0442.\u0434." !== r3.title || (v = true);
              }, "onopentag"), onopentagname: /* @__PURE__ */ __name(function(t2) {
                u && "br" === t2 && (o.summary += "\n"), h && "a" === t2 && (p = true), f && "a" === t2 && (d = true);
              }, "onopentagname"), onattribute: /* @__PURE__ */ __name(function(t2, e3) {
                "itemprop" === t2 && "creator" === e3 && (l = true), "id" === t2 && "mc-fs-genre" === e3 && (f = true);
              }, "onattribute"), ontext: /* @__PURE__ */ __name(function(t2) {
                if (l && (o.author = t2), u && (o.summary += t2.trim()), p && (o.status = "Ongoing" === t2 || "\u0412 \u043F\u0440\u043E\u0446\u0435\u0441\u0441\u0435" == t2 ? a.NovelStatus.Ongoing : a.NovelStatus.Completed), d && w.push(t2), v) {
                  var e3 = t2.replace(/\D/g, "");
                  e3 && (O = parseInt(e3, 10));
                }
                g && (m && (S.name = t2.trim()), b && (S.releaseTime = _(t2.trim())));
              }, "ontext"), onclosetag: /* @__PURE__ */ __name(function(e3) {
                "a" === e3 && (c = false, l = false, p = false, d = false, h = false), "div" === e3 && (u = false, f = false), "li" === e3 && (v = false), "a" === e3 && (g = false, S.name && (y.push(t(t({}, S), { page: "1" })), S = {})), "span" === e3 && (m && (m = false), b && (b = false));
              }, "onclosetag") })).write(i3), I.end(), o.genres = w.join(", "), o.totalPages = Math.ceil((O || 1) / 25), o.chapters = y, o.chapters[0].path && (o.latestChapter = o.chapters[0]), [2, o];
          }
        });
      });
    }, i2.prototype.parsePage = function(t2, s2) {
      return e(this, void 0, void 0, function() {
        var e2, a2, i3, o, c, l, u, h, p, f, d, v, g, m;
        return r(this, function(r2) {
          switch (r2.label) {
            case 0:
              return e2 = "ranobes" == this.id ? t2.split("-")[0] : "/" + t2.split("-").slice(1).join("-").split(".")[0], a2 = this.site + "/chapters" + e2.replace(this.options.path + "/", ""), [4, this.safeFecth(a2 + "/page/" + s2)];
            case 1:
              return i3 = r2.sent(), o = this.site, c = false, l = false, u = false, h = false, p = [], f = {}, d = this.parseDate, v = { pages_count: "", chapters: [] }, (g = new n.Parser({ onopentag: /* @__PURE__ */ __name(function(t3, e3) {
                "div" === t3 && "cat_block cat_line" === e3.class && (l = true), l && "a" === t3 && e3.title && e3.href && (f.name = e3.title, f.path = e3.href.replace(o, "")), "span" === t3 && "grey small" === e3.class && (u = true), "small" === t3 && u && (h = true);
              }, "onopentag"), ontext: /* @__PURE__ */ __name(function(t3) {
                h && (f.releaseTime = d(t3.trim())), c && t3.includes("window.__DATA__ =") && (v = JSON.parse(t3.replace("window.__DATA__ =", "")));
              }, "ontext"), onclosetag: /* @__PURE__ */ __name(function(t3) {
                "a" === t3 && f.name && (p.push(f), f = {}), "div" === t3 && (l = false), "span" === t3 && (u = false), "small" === t3 && (h = false), "main" === t3 && (c = true), "script" === t3 && (c = false);
              }, "onclosetag") })).write(i3), g.end(), (null === (m = v.chapters) || void 0 === m ? void 0 : m.length) && (p = this.parseChapters(v)), [2, { chapters: p }];
          }
        });
      });
    }, i2.prototype.parseChapter = function(t2) {
      return e(this, void 0, void 0, function() {
        var e2, n2, s2;
        return r(this, function(r2) {
          switch (r2.label) {
            case 0:
              return [4, this.safeFecth(this.site + t2)];
            case 1:
              return e2 = r2.sent(), n2 = e2.indexOf('<div class="text" id="arrticle">'), s2 = e2.indexOf('<div class="category grey ellipses">', n2), [2, e2.substring(n2, s2)];
          }
        });
      });
    }, i2.prototype.searchNovels = function(t2, n2) {
      return e(this, void 0, void 0, function() {
        var e2, s2;
        return r(this, function(r2) {
          switch (r2.label) {
            case 0:
              return "ranobes-ru" !== this.id ? [3, 2] : [4, this.safeFecth(this.site + "/index.php?do=search", { headers: { "Content-Type": "application/x-www-form-urlencoded", Referer: this.site + "/" }, method: "POST", body: new URLSearchParams({ do: "search", subaction: "search", search_start: n2.toString(), story: t2 }).toString() })];
            case 1:
              return e2 = r2.sent(), [3, 4];
            case 2:
              return s2 = "".concat(this.site, "/search/").concat(t2, "/page/").concat(n2), [4, this.safeFecth(s2)];
            case 3:
              e2 = r2.sent(), r2.label = 4;
            case 4:
              return [2, this.parseNovels(e2)];
          }
        });
      });
    }, i2;
  }())({ id: "ranobes", sourceSite: "https://ranobes.top", sourceName: "Ranobes", options: { lang: "English", path: "novels" } });
  exports.default = i;
})();
