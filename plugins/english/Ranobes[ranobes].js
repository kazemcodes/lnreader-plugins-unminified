...
var LNReaderPlugin = (() => {
  ...
  var n = require_lib6(), s = (init_fetch2(), __toCommonJS(fetch_exports)), a = (init_novelStatus(), __toCommonJS(novelStatus_exports)), i = function() {
    ...
    return i2.prototype.safeFecth = function(e2, n2) {
      ...
      var t2 = [], r2 = { name: "" }, s2 = this.site, a2 = false, i3 = false, o2 = false, c = new n.Parser({ onopentag: /* @__PURE__ */ __name(function(e3, n2) {
        var c2, l;
        (null === (c2 = n2.class) || void 0 === c2 ? void 0 : c2.includes("short-cont")) && (a2 = true), a2 && ("h2" === e3 && (null === (l = n2.class) || void 0 === l ? void 0 : l.includes("title")) && (i3 = true), i3 && "a" === e3 && (r2.path = n2.href.slice(s2.length), o2 = true), "figure" === e3 && (r2.cover = n2.style.replace(/.*url\((.*?)\)./g, "$1")), r2.path && r2.cover && (t2.push(r2), (r2 = {}).name = ""));
      ...
      return t(this, void 0, void 0, function() {
        var t2, i3, o2, c, l, u, p, h, f, d, v, g, b, m, w, y, S, x, O, _;
        return r(this, function(r2) {
          switch (r2.label) {
            case 0:
              return t2 = this.site, [4, this.safeFecth(t2 + s2)];
            case 1:
              return i3 = r2.sent(), o2 = { path: s2, name: "", summary: "", chapters: [], totalPages: 1 }, c = false, l = false, u = false, p = false, h = false, f = false, d = false, v = false, g = false, b = false, m = false, w = [], y = [], S = {}, x = 0, O = this.parseDate, (_ = new n.Parser({ onopentag: /* @__PURE__ */ __name(function(e2, r3) {
                "poster" === r3.class && (c = true), c && "img" === e2 && (o2.name = r3.alt, o2.cover = t2 + r3.src), ("div" === e2 && "moreless cont-text showcont-h" === r3.class || "cont-text showcont-h" === r3.class && "description" === r3.itemprop) && (u = true), "li" === e2 && r3.title && (r3.title.includes("Original status") || r3.title.includes("\u0421\u0442\u0430\u0442\u0443\u0441 \u043E\u0440\u0438\u0433\u0438\u043D\u0430\u043B\u0430")) && (p = true), "a" === e2 && "chapter" === r3.rel && (g = true, S.path = r3.href.replace(t2, "")), g && "span" === e2 && "title ellipses" === r3.class && (b = true), g && "span" === e2 && "grey" === r3.class && (m = true), "li" !== e2 || "Glossary + illustrations + division of chapters, etc." != r3.title && "\u0413\u043B\u043E\u0441\u0441\u0430\u0440\u0438\u0439 + \u0438\u043B\u043B\u044E\u0441\u0442\u0440\u0430\u0446\u0438\u0439 + \u0440\u0430\u0437\u0434\u0435\u043B\u0435\u043D\u0438\u0435 \u0433\u043B\u0430\u0432 \u0438 \u0442.\u0434." !== r3.title || (v = true);
                ...
                "itemprop" === e2 && "creator" === t3 && (l = true), "id" === e2 && "mc-fs-genre" === t3 && (f = true);
              }, "onattribute"), ontext: /* @__PURE__ */ __name(function(e2) {
                if (l && (o2.author = e2), u && (o2.summary += e2.trim()), h && (o2.status = "Ongoing" === e2 || "\u0412 \u043F\u0440\u043E\u0446\u0435\u0441\u0441\u0435" == e2 ? a.NovelStatus.Ongoing : a.NovelStatus.Completed), d && w.push(e2), v) {
                  var t3 = e2.replace(/\D/g, "");
                  t3 && (x = parseInt(t3, 10));
                }
                g && (b && (S.name = e2.trim()), m && (S.releaseTime = O(e2.trim())));
              }, "ontext"), onclosetag: /* @__PURE__ */ __name(function(t3) {
                "a" === t3 && (c = false, l = false, h = false, d = false, p = false), "div" === t3 && (u = false, f = false), "li" === t3 && (v = false), "a" === t3 && (g = false, S.name && (y.push(e(e({}, S), { page: "1" })), S = {})), "span" === t3 && (b && (b = false), m && (m = false));
      ...
      return t(this, void 0, void 0, function() {
        var t2, a2, i3, o2, c, l, u, p, h, f, d, v, g, b;
        return r(this, function(r2) {
          switch (r2.label) {
            case 0:
            ...
            case 1:
              return i3 = r2.sent(), o2 = this.site, c = false, l = false, u = false, p = false, h = [], f = {}, d = this.parseDate, v = { pages_count: "", chapters: [] }, (g = new n.Parser({ onopentag: /* @__PURE__ */ __name(function(e3, t3) {
                "div" === e3 && "cat_block cat_line" === t3.class && (l = true), l && "a" === e3 && t3.title && t3.href && (f.name = t3.title, f.path = t3.href.replace(o2, "")), "span" === e3 && "grey small" === t3.class && (u = true), "small" === e3 && u && (p = true);
              }, "onopentag"), ontext: /* @__PURE__ */ __name(function(e3) {
                p && (f.releaseTime = d(e3.trim())), c && e3.includes("window.__DATA__ =") && (v = JSON.parse(e3.replace("window.__DATA__ =", "")));
              }, "ontext"), onclosetag: /* @__PURE__ */ __name(function(e3) {
                "a" === e3 && f.name && (h.push(f), f = {}), "div" === e3 && (l = false), "span" === e3 && (u = false), "small" === e3 && (p = false), "main" === e3 && (c = true), "script" === e3 && (c = false);
  ...
  var o = new i({ id: "ranobes", sourceSite: "https://ranobes.top", sourceName: "Ranobes", options: { lang: "English", path: "novels" } });
  exports.default = o;
})();
