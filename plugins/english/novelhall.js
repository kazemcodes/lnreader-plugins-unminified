...
(() => {
  ...
  // .js/plugins/english/novelhall.js
  ...
  var n = (init_browser(), __toCommonJS(browser_exports)), r = (init_fetch2(), __toCommonJS(fetch_exports)), o = (init_defaultCover(), __toCommonJS(defaultCover_exports)), i = (function() {
    function i2() {
      this.id = "novelhall", this.name = "Novel Hall", this.version = "1.0.3", this.icon = "src/en/novelhall/icon.png", this.site = "https://novelhall.com/";
    }
    __name(i2, "i");
    return i2.prototype.popularNovels = function(i3) {
      return t(this, void 0, void 0, (function() {
        ...
        return e(this, (function(e2) {
          switch (e2.label) {
            case 0:
              return t2 = "".concat(this.site, "all2022-").concat(i3, ".html"), [4, (0, r.fetchApi)(t2).then((function(t3) {
                return t3.text();
              }))];
            case 1:
              return a = e2.sent(), c = (0, n.load)(a), u = [], c("li.btm").each((function(t3, e3) {
                var n2 = c(e3).text().trim(), r2 = c(e3).find("a").attr("href");
                if (r2) {
                  var i4 = { name: n2, cover: o.defaultCover, path: r2 };
                  u.push(i4);
                }
              })), [2, u];
          }
      ...
      return t(this, void 0, void 0, (function() {
        ...
        return e(this, (function(e2) {
          switch (e2.label) {
            case 0:
              return [4, (0, r.fetchApi)(this.site + o2).then((function(t3) {
                return t3.text();
              }))];
            case 1:
              return t2 = e2.sent(), i3 = (0, n.load)(t2), a = { path: o2, name: i3(".book-info > h1").text() || "Untitled", cover: i3('meta[property="og:image"]').attr("content"), summary: i3(".intro").text().trim(), chapters: [] }, i3(".total").find("p").remove(), a.author = i3('.total span:contains("Author")').text().replace("Author\uFF1A", "").trim(), a.status = i3('.total span:contains("Status")').text().replace("Status\uFF1A", "").replace("Active", "Ongoing").trim(), a.genres = i3(".total a").map((function(t3, e3) {
                return i3(e3).text();
              })).toArray().join(","), c = [], i3("#morelist ul > li").each((function(t3, e3) {
                var n2 = i3(e3).find("a").text().trim(), r2 = i3(e3).find("a").attr("href");
                r2 && c.push({ name: n2, path: r2 });
              })), a.chapters = c, [2, a];
          }
        }));
      }));
      ...
      return t(this, void 0, void 0, (function() {
        ...
        return e(this, (function(e2) {
          switch (e2.label) {
            ...
            case 1:
              return t2 = e2.sent(), i3 = (0, n.load)(t2), [2, i3("#htmlContent").html() || ""];
          }
        }));
      }));
      ...
      return t(this, void 0, void 0, (function() {
        ...
        return e(this, (function(e2) {
          switch (e2.label) {
            case 0:
              return t2 = "".concat(this.site, "index.php?s=so&module=book&keyword=").concat(encodeURIComponent(i3)), [4, (0, r.fetchApi)(t2).then((function(t3) {
                return t3.text();
              }))];
            case 1:
              return a = e2.sent(), c = (0, n.load)(a), u = [], c("table tr").each((function(t3, e3) {
                var n2 = c(e3).find("td:nth-child(2)").text().replace(/\t+/g, "").replace(/\n/g, " "), r2 = c(e3).find("td:nth-child(2) a").attr("href");
                if (r2) {
                  var i4 = { name: n2, cover: o.defaultCover, path: r2 };
                  u.push(i4);
                }
