...
(() => {
  ...
  // .js/plugins/english/dreambigtl.js
  var t = function(t2, e2, n2, r2) {
    ...
    var n2, r2, i2, o = { label: 0, sent: /* @__PURE__ */ __name(function() {
          ...
          for (; a && (a = 0, s3[0] && (o = 0)), o; ) try {
            ...
            switch (r2 = 0, i2 && (s3 = [2 & s3[0], i2.value]), s3[0]) {
              ...
              case 7:
                ...
                continue;
              default:
                if (!(i2 = o.trys, (i2 = i2.length > 0 && i2[i2.length - 1]) || 6 !== s3[0] && 2 !== s3[0])) {
                  o = 0;
                  continue;
                }
                ...
                if (6 === s3[0] && o.label < i2[1]) {
                  o.label = i2[1], i2 = s3;
                  break;
                }
                if (i2 && o.label < i2[2]) {
                  o.label = i2[2], o.ops.push(s3);
                  break;
                }
  ...
  var n = (init_browser(), __toCommonJS(browser_exports)), r = (init_fetch2(), __toCommonJS(fetch_exports)), i = (function() {
    function i2() {
      this.id = "dreambigtl", this.name = "Dream Big Translations", this.version = "1.0.0", this.site = "https://www.dreambigtl.com/", this.icon = "src/en/dreambigtl/icon.png";
    }
    __name(i2, "i");
    return i2.prototype.popularNovels = function(i3, o) {
      return t(this, arguments, void 0, (function(t2, i4) {
        var o2, a, s, c, u, l = this, h = i4.showLatestNovels;
        return e(this, (function(t3) {
          switch (t3.label) {
            case 0:
              return o2 = "".concat(this.site, "p/disclaimer.html"), [4, (0, r.fetchApi)(o2)];
            case 1:
              return [4, t3.sent().text()];
            case 2:
              return a = t3.sent(), s = (0, n.load)(a), c = [], u = ["New Novels", "Ongoing Novels", "Completed Novels"], s("#webify-pro-main-nav-menu > li.has-sub").each((function(t4, e2) {
                var n2 = s(e2).children("a").first().text().trim();
                u.includes(n2) && s(e2).find("ul.sub-menu.m-sub").find("li > a").each((function(t5, e3) {
                  var n3 = s(e3).text().trim(), r2 = s(e3).attr("href");
                  r2 && c.push({ name: n3, path: r2.replace(l.site, ""), cover: "" });
                }));
              })), c.forEach((function(t4) {
                return console.log("Novel:", t4.name, t4.path);
              })), 0 === c.length && s("a").each((function(t4, e2) {
                var n2 = s(e2).attr("href");
                if (n2 && n2.includes("/p/") && !n2.includes("disclaimer")) {
                  var r2 = s(e2).text().trim();
                  c.push({ name: r2, path: n2.replace(l.site, ""), cover: "" });
                }
              })), h && c.sort((function(t4, e2) {
                return e2.path.localeCompare(t4.path);
              })), [2, c];
          }
        }));
      }));
      ...
      return t(this, void 0, void 0, (function() {
        ...
        return e(this, (function(e2) {
          switch (e2.label) {
            case 0:
              return t2 = this.site + i3, [4, (0, r.fetchApi)(t2)];
            case 1:
              return [4, e2.sent().text()];
            case 2:
              return o = e2.sent(), a = (0, n.load)(o), s = { path: i3, name: a("h1.entry-title").text().trim(), cover: a(".post-body img").first().attr("src") || "", summary: a(".post-body p").first().text().trim(), author: (null === (u = null === (c = a(".post-body").text().match(/Author:\s*(.+)/i)) || void 0 === c ? void 0 : c[1]) || void 0 === u ? void 0 : u.trim()) || "Unknown", status: this.getNovelStatus(i3) }, [4, this.parseChapters(a)];
            case 3:
              return s.chapters = e2.sent(), [2, s];
          }
        }));
      }));
    }, i2.prototype.parseChapters = function(n2) {
      return t(this, void 0, void 0, (function() {
        var t2, r2 = this;
        return e(this, (function(e2) {
          return t2 = [], n2(".chapter-panel").each((function(e3, i3) {
            "Free Tier" === n2(i3).find("summary").text().trim() && n2(i3).find("ul li a").each((function(e4, i4) {
              var o = n2(i4).text().trim(), a = n2(i4).attr("href");
              a && t2.push({ name: o, path: a.replace(r2.site, "") });
            }));
          })), 0 === t2.length && n2('h2:contains("List of Chapters"), span:contains("List of Chapters")').each((function(e3, i3) {
            n2(i3).next("ul").find("li a").each((function(e4, i4) {
              var o = n2(i4).text().trim(), a = n2(i4).attr("href");
              a && t2.push({ name: o, path: a.replace(r2.site, "") });
            }));
          })), [2, t2.reverse()];
    ...
    }, i2.prototype.getNovelStatus = function(t2) {
      return t2.includes("completed") ? "Completed" : "Ongoing";
        ...
        return e(this, (function(e2) {
          switch (e2.label) {
            ...
            case 1:
              return [4, e2.sent().text()];
            case 2:
              return o = e2.sent(), a = (0, n.load)(o), s = a("h1.entry-title").text().trim(), c = a(".post-body").html() || "", [2, "<h1>".concat(s, "</h1>").concat(c)];
          }
        }));
      }));
    }, i2.prototype.searchNovels = function(i3) {
      return t(this, void 0, void 0, (function() {
        var t2, o, a, s, c = this;
        return e(this, (function(e2) {
          switch (e2.label) {
            case 0:
              return t2 = "".concat(this.site, "search?q=").concat(encodeURIComponent(i3)), [4, (0, r.fetchApi)(t2)];
            case 1:
              return [4, e2.sent().text()];
            case 2:
              return o = e2.sent(), a = (0, n.load)(o), s = [], a(".blog-posts.index-post-wrap .blog-post.hentry.index-post").each((function(t3, e3) {
                var n2 = a(e3).find(".entry-title a").text().trim(), r2 = a(e3).find(".entry-title a").attr("href"), i4 = a(e3).find(".entry-image").attr("data-image") || "";
                r2 && s.push({ name: n2, path: r2.replace(c.site, ""), cover: i4 });
              })), [2, s];
          }
        }));
      }));
