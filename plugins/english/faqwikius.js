...
(() => {
  ...
  // .js/plugins/english/faqwikius.js
  ...
  var n = (init_fetch2(), __toCommonJS(fetch_exports)), r = (init_browser(), __toCommonJS(browser_exports)), i = (init_novelStatus(), __toCommonJS(novelStatus_exports)), o = (function() {
    function o2() {
      this.id = "FWK.US", this.name = "Faq Wiki", this.site = "https://faqwiki.us/", this.version = "2.0.1", this.icon = "src/en/faqwikius/icon.png";
    }
    __name(o2, "o");
    return o2.prototype.parseNovels = function(t2, e2) {
      var n2 = this, r2 = [];
      return t2(".plt-page-item").each((function(e3, i2) {
        var o3, a, c, s = t2(i2).text().replace("Novel \u2013 All Chapters", "").trim(), u = t2(i2).find("img").attr("data-ezsrc");
        u = u ? u.replace(/\?ezimgfmt=.*$/, "") : t2(i2).find("img").attr("src");
        var l = null === (c = null === (a = null === (o3 = t2(i2).find("a").attr("href")) || void 0 === o3 ? void 0 : o3.replace("tp:", "tps:")) || void 0 === a ? void 0 : a.replace(n2.site, "")) || void 0 === c ? void 0 : c.replace(/\/+$/, "");
        l && r2.push({ name: s, cover: u, path: l });
      })), e2 && (r2 = r2.filter((function(t3) {
        return t3.name.toLowerCase().includes(e2.toLowerCase());
      }))), r2;
      ...
      return t(this, void 0, void 0, (function() {
        ...
        return e(this, (function(e2) {
          switch (e2.label) {
            case 0:
              return [4, (0, n.fetchApi)(this.site).then((function(t3) {
                return t3.text();
              }))];
            case 1:
              return t2 = e2.sent(), i2 = (0, r.load)(t2), [2, this.parseNovels(i2)];
          }
        }));
      }));
    }, o2.prototype.parseNovel = function(o3) {
      return t(this, void 0, void 0, (function() {
        var t2, a, c, s, u, l, p, h = this;
        return e(this, (function(e2) {
          switch (e2.label) {
            case 0:
              return [4, (0, n.fetchApi)(this.site + o3).then((function(t3) {
                return t3.text();
              }))];
            case 1:
              return t2 = e2.sent(), a = (0, r.load)(t2), (c = { path: o3, name: "" }).name = a(".entry-title").text().replace("Novel \u2013 All Chapters", "").trim(), s = a(".wp-block-image img"), u = s.attr("data-ezsrc") || s.attr("src"), c.cover = null == u ? void 0 : u.replace(/\?ezimgfmt=.*$/, ""), l = a("#lcp_instance_0 +:icontains('complete')").text(), c.status = l ? i.NovelStatus.Completed : i.NovelStatus.Ongoing, a(".entry-content strong").each((function(t3, e3) {
                var n2 = a(e3).text().trim().toLowerCase(), r2 = a(e3).parent(), i2 = [r2.text().slice(n2.length).trim()].concat(r2.nextUntil("p:has(strong)").map((function(t4, e4) {
                  return a(e4).text().trim();
                })).get()), o4 = i2.join(" ").trim();
                ["Slice of Life", "School Life"].forEach((function(t4) {
                  o4 = o4.replace(new RegExp("\\b".concat(t4, "\\b"), "g"), t4.replace(/ /g, "_"));
                }));
                var s2 = o4.split(/\s+/).map((function(t4) {
              ...
              })), p = [], a(".lcp_catlist li a").each((function(t3, e3) {
                var n2, r2, i2 = a(e3).text().replace(c.name + "", "").replace("Novel", "").trim(), o4 = null === (r2 = null === (n2 = a(e3).attr("href")) || void 0 === n2 ? void 0 : n2.replace(h.site, "")) || void 0 === r2 ? void 0 : r2.replace(/\/+$/, ""), s2 = t3 + 1;
                o4 && p.push({ name: i2, path: o4, chapterNumber: s2 });
              })), c.chapters = p, [2, c];
          }
        }));
      }));
      ...
      return t(this, void 0, void 0, (function() {
        ...
        return e(this, (function(e2) {
          switch (e2.label) {
            case 0:
              return [4, (0, n.fetchApi)(this.site + i2).then((function(t3) {
                return t3.text();
              }))];
            case 1:
              return t2 = e2.sent(), o3 = (0, r.load)(t2), [".entry-content span", ".entry-content div", "script"].map((function(t3) {
                o3(t3).remove();
              })), [2, o3(".entry-content").html()];
          }
        }));
      }));
    }, o2.prototype.searchNovels = function(i2) {
      return t(this, void 0, void 0, (function() {
        var t2, o3;
        return e(this, (function(e2) {
          switch (e2.label) {
            ...
            case 1:
              return t2 = e2.sent(), o3 = (0, r.load)(t2), [2, this.parseNovels(o3, i2)];
          }
        }));
      }));
    }, o2;
