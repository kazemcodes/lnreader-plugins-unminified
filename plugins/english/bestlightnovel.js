...
(() => {
  ...
  // .js/plugins/english/bestlightnovel.js
      ...
      return function(u) {
        return (function(i4) {
          ...
          for (; o2 && (o2 = 0, i4[0] && (n2 = 0)), n2; ) try {
            if (a2 = 1, t2 && (r2 = 2 & i4[0] ? t2.return : i4[0] ? t2.throw || ((r2 = t2.return) && r2.call(t2), 0) : t2.next) && !(r2 = r2.call(t2, i4[1])).done) return r2;
  ...
  var a = (init_browser(), __toCommonJS(browser_exports)), t = (init_defaultCover(), __toCommonJS(defaultCover_exports)), r = (init_fetch2(), __toCommonJS(fetch_exports)), n = (init_novelStatus(), __toCommonJS(novelStatus_exports)), o = (init_filterInputs(), __toCommonJS(filterInputs_exports)), i = (function() {
    function i2() {
      this.id = "BLN", this.name = "BestLightNovel", this.icon = "src/en/bestlightnovel/icon.png", this.site = "https://bestlightnovel.com/", this.version = "1.0.1", this.filters = { status: { label: "Status", value: "all", options: [{ label: "ALL", value: "all" }, { label: "Completed", value: "completed" }, { label: "Ongoing", value: "ongoing" }], type: o.FilterTypes.Picker }, type: { value: "topview", label: "Type", options: [{ label: "Recently updated", value: "latest" }, { label: "Newest", value: "newest" }, { label: "Top view", value: "topview" }], type: o.FilterTypes.Picker }, category: { label: "Category", value: "all", options: [{ label: "ALL", value: "all" }, { label: "Action", value: "1" }, { label: "Adventure", value: "2" }, { label: "Animals", value: "65" }, { label: "Arts", value: "40" }, { label: "Biographies", value: "41" }, { label: "Business", value: "42" }, { label: "Chinese", value: "3" }, { label: "Comedy", value: "4" }, { label: "Computers", value: "43" }, { label: "Crafts, Hobbies", value: "45" }, { label: "Drama", value: "5" }, { label: "Education", value: "46" }, { label: "English", value: "6" }, { label: "Entertainment", value: "47" }, { label: "Fantasy", value: "7" }, { label: "Fiction", value: "48" }, { label: "Gender Bender", value: "8" }, { label: "Harem", value: "9" }, { label: "Historical", value: "10" }, { label: "History", value: "49" }, { label: "Home", value: "50" }, { label: "Horror", value: "11" }, { label: "Humor", value: "51" }, { label: "Investing", value: "52" }, { label: "Josei", value: "12" }, { label: "Korean", value: "13" }, { label: "Literature", value: "53" }, { label: "Lolicon", value: "14" }, { label: "Martial Arts", value: "15" }, { label: "Mature", value: "16" }, { label: "Mecha", value: "17" }, { label: "Memoirs", value: "54" }, { label: "Mystery", value: "18" }, { label: "Original", value: "19" }, { label: "Other Books", value: "66" }, { label: "Philosophy", value: "55" }, { label: "Photography", value: "56" }, { label: "Politics", value: "57" }, { label: "Professional", value: "58" }, { label: "Psychological", value: "20" }, { label: "Reference", value: "59" }, { label: "Reincarnation", value: "21" }, { label: "Religion", value: "60" }, { label: "Romance", value: "22" }, { label: "School Life", value: "23" }, { label: "School Stories", value: "67" }, { label: "Sci-Fi", value: "24" }, { label: "Seinen", value: "25" }, { label: "Short Stories", value: "68" }, { label: "Shotacon", value: "26" }, { label: "Shoujo", value: "27" }, { label: "Shoujo Ai", value: "28" }, { label: "Shounen", value: "29" }, { label: "Shounen Ai", value: "30" }, { label: "Slice Of Life", value: "31" }, { label: "Smut", value: "32" }, { label: "Social Science", value: "61" }, { label: "Spirituality", value: "62" }, { label: "Sports", value: "33" }, { label: "Supernatural", value: "34" }, { label: "Teaser", value: "69" }, { label: "Technical", value: "63" }, { label: "Technology", value: "64" }, { label: "Tragedy", value: "35" }, { label: "Virtual Reality", value: "36" }, { label: "Wuxia", value: "37" }, { label: "Xianxia", value: "38" }, { label: "Xuanhuan", value: "39" }], type: o.FilterTypes.Picker } };
    }
    __name(i2, "i");
    return i2.prototype.parseNovels = function(e2) {
      var l2 = this, a2 = [];
      return e2(".update_item.list_category").each((function(t2, r2) {
        var n2 = e2(r2).find("h3 > a").attr("href");
        if (n2) {
          var o2 = e2(r2).find("h3 > a").text(), i3 = e2(r2).find("img").attr("src"), u = { name: o2, path: n2.replace(l2.site, ""), cover: i3 };
          a2.push(u);
        } else console.error("No novel url!");
      })), a2;
    }, i2.prototype.popularNovels = function(t2, n2) {
      return e(this, arguments, void 0, (function(e2, t3) {
        var n3, o2, i3, u, s, c, v = t3.filters;
        return l(this, (function(l2) {
          switch (l2.label) {
            case 0:
              return n3 = this.site + "novel_list?", n3 += "type=" + v.type.value, n3 += "&category=" + v.category.value, n3 += "&state=" + v.status.value, n3 += "&page=" + e2, [4, (0, r.fetchApi)(n3)];
            case 1:
              return (o2 = l2.sent()).ok ? [3, 3] : (u = (i3 = console).error, [4, o2.text()]);
            case 2:
              return u.apply(i3, [l2.sent()]), [2, []];
            case 3:
              return [4, o2.text()];
            case 4:
              return s = l2.sent(), c = (0, a.load)(s), [2, this.parseNovels(c)];
          }
        }));
      }));
    }, i2.prototype.parseNovel = function(o2) {
      return e(this, void 0, void 0, (function() {
        var e2, i3, u, s, c, v = this;
        return l(this, (function(l2) {
          switch (l2.label) {
            case 0:
              return [4, (0, r.fetchApi)(this.site + o2)];
            case 1:
              return [4, l2.sent().text()];
            case 2:
              return e2 = l2.sent(), i3 = (0, a.load)(e2), u = { path: o2, name: i3(".truyen_info_right  h1").text().trim() || "", cover: i3(".info_image img").attr("src") || t.defaultCover, summary: (null === (c = i3("#noidungm").text()) || void 0 === c ? void 0 : c.trim()) || "", chapters: [] }, i3("ul.truyen_info_right > li").each((function() {
                var e3 = i3(this).find("span").text(), l3 = i3(this).find("a").map((function(e4, l4) {
                  return i3(l4).text();
                })).toArray().join(", ");
                switch (e3) {
                  case "Author(s): ":
                  ...
                  case "GENRES: ":
                    ...
                    break;
                  case "STATUS : ":
                    u.status = "Ongoing" === l3 ? n.NovelStatus.Ongoing : "Completed" === l3 ? n.NovelStatus.Completed : n.NovelStatus.Unknown;
                }
              })), s = [], i3(".chapter-list div.row").each((function(e3, l3) {
                var a2 = i3(l3).find("a").text().trim(), t2 = i3(l3).find("span:last").text().trim(), r2 = ["jan", "feb", "mar", "apr", "may", "jun", "jul", "aug", "sep", "oct", "nov", "dec"].join("|"), n2 = new RegExp("(".concat(r2, ")-(\\d{1,2})-(\\d{2})"), "i").exec(t2);
                if (n2) {
                  var o3 = +n2[3] + 2e3, u2 = r2.indexOf(n2[1].toLowerCase()), c2 = +n2[2], b = i3(l3).find("a").attr("href");
                  b ? s.push({ name: a2, releaseTime: new Date(o3, u2, c2).toISOString(), path: b.replace(v.site, "") }) : console.error("No chapter url!");
                }
              })), u.chapters = s.reverse(), [2, u];
          }
        }));
      }));
      ...
      return e(this, void 0, void 0, (function() {
        ...
        return l(this, (function(l2) {
          switch (l2.label) {
            case 0:
              return [4, (0, r.fetchApi)(this.site + t2)];
            case 1:
              return [4, l2.sent().text()];
            case 2:
              return e2 = l2.sent(), n2 = (0, a.load)(e2), [2, n2("#vung_doc").html() || ""];
          }
        }));
      }));
      ...
      return e(this, void 0, void 0, (function() {
        ...
        return l(this, (function(l2) {
          switch (l2.label) {
            case 0:
              return e2 = "".concat(this.site, "search_novels/").concat(encodeURIComponent(t2), "?page=").concat(n2), [4, (0, r.fetchApi)(e2)];
            case 1:
              return [4, l2.sent().text()];
            case 2:
              return o2 = l2.sent(), i3 = (0, a.load)(o2), [2, this.parseNovels(i3)];
          }
        }));
      }));
    }, i2;
