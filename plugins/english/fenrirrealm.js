...
(() => {
  ...
  var e = function(e2, t2, r2, a2) {
    return new (r2 || (r2 = Promise))((function(n2, l2) {
      function i2(e3) {
        try {
          u(a2.next(e3));
        } catch (e4) {
    ...
    var r2, a2, n2, l2 = { label: 0, sent: /* @__PURE__ */ __name(function() {
  ...
  var r = (init_fetch2(), __toCommonJS(fetch_exports)), a = (init_browser(), __toCommonJS(browser_exports)), n = (init_filterInputs(), __toCommonJS(filterInputs_exports)), l = (init_storage2(), __toCommonJS(storage_exports)), i = (init_defaultCover(), __toCommonJS(defaultCover_exports)), o = (function() {
    ...
    return o2.prototype.popularNovels = function(a2, n2) {
      ...
      return e(this, void 0, void 0, (function() {
        ...
        return t(this, (function(t2) {
          switch (t2.label) {
            case 0:
              return [4, (0, r.fetchApi)("".concat(this.site, "/series/").concat(n2), {}).then((function(e3) {
                return e3.text();
              }))];
            case 1:
              return e2 = t2.sent(), l2 = (0, a.load)(e2), (o3 = { path: n2, name: l2("h1.my-2").text(), summary: l2("div.overflow-hidden.transition-all.max-h-\\[108px\\] p").map((function(e3, t3) {
                return (0, a.load)(t3).text();
              })).get().join("\n\n") }).author = l2("div.flex-1 > div.mb-3 > a.inline-flex").text(), u = e2.match(/,cover:"storage\/(.+?)",cover_data_url/), o3.cover = u ? this.site + "/storage/" + u[1] : i.defaultCover, o3.genres = l2("div.flex-1 > div.flex:not(.mb-3, .mt-5) > a").map((function(e3, t3) {
                return (0, a.load)(t3).text();
              })).toArray().join(","), o3.status = l2("div.flex-1 > div.mb-3 > span.rounded-md").first().text(), [4, (0, r.fetchApi)(this.site + "/api/novels/chapter-list/" + n2).then((function(e3) {
                return e3.json();
              }))];
            case 2:
              return s = t2.sent(), this.hideLocked && (s = s.filter((function(e3) {
                var t3;
                return !(null === (t3 = e3.locked) || void 0 === t3 ? void 0 : t3.price);
              }))), o3.chapters = s.map((function(e3) {
                var t3, r2, a2, l3, i2, o4;
                return { name: ((null === (t3 = e3.locked) || void 0 === t3 ? void 0 : t3.price) ? "\u{1F512} " : "") + (null === (null === (r2 = e3.group) || void 0 === r2 ? void 0 : r2.index) ? "" : "Vol " + (null === (a2 = e3.group) || void 0 === a2 ? void 0 : a2.index) + " ") + "Chapter " + e3.number + (e3.title && e3.title.trim() != "Chapter " + e3.number ? " - " + e3.title.replace(/^chapter [0-9]+ . /i, "") : ""), path: n2 + (null === (null === (l3 = e3.group) || void 0 === l3 ? void 0 : l3.index) ? "" : "/" + (null === (i2 = e3.group) || void 0 === i2 ? void 0 : i2.slug)) + "/chapter-" + e3.number, releaseTime: e3.created_at, chapterNumber: e3.number + 1e12 * ((null === (o4 = e3.group) || void 0 === o4 ? void 0 : o4.index) || 0) };
              })).sort((function(e3, t3) {
      ...
      return e(this, void 0, void 0, (function() {
        ...
        return t(this, (function(t2) {
          switch (t2.label) {
            case 0:
              return [4, (0, r.fetchApi)(this.site + "/series/" + n2, {}).then((function(e3) {
                return e3.text();
              }))];
            case 1:
              return e2 = t2.sent(), (l2 = (0, a.load)(e2)('[id^="reader-area-"]')).contents().filter((function(e3, t3) {
                return "comment" === t3.type;
              })).remove(), [2, l2.html() || ""];
          }
        }));
      }));
      ...
      return e(this, void 0, void 0, (function() {
        ...
        return t(this, (function(t2) {
          switch (t2.label) {
            case 0:
              return [4, (0, r.fetchApi)("".concat(this.site, "/api/series/filter?page=").concat(n2, "&per_page=20&search=").concat(encodeURIComponent(a2))).then((function(e3) {
                return e3.json();
              })).then((function(t3) {
                return t3.data.map((function(t4) {
                  return e2.parseNovelFromApi(t4);
                }));
              }))];
            case 1:
              return [2, t2.sent()];
    ...
    }, o2.prototype.parseNovelFromApi = function(e2) {
