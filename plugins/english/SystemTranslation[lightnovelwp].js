...
var LNReaderPlugin = (() => {
  ...
  // .js/plugins/english/SystemTranslation[lightnovelwp].js
  ...
  var a = (init_browser(), __toCommonJS(browser_exports)), s = require_lib9(), r = (init_fetch2(), __toCommonJS(fetch_exports)), i = (init_novelStatus(), __toCommonJS(novelStatus_exports)), l = (init_defaultCover(), __toCommonJS(defaultCover_exports)), n = (init_storage2(), __toCommonJS(storage_exports));
  function o(e2, t2) {
    var a2 = e2.match(/(\d+)$/);
    ...
    return c2.prototype.getHostname = function(e2) {
        ...
        return t(this, (function(t2) {
          switch (t2.label) {
            ...
            case 1:
              ...
              return [4, n2.text()];
            case 2:
              if (o2 = t2.sent(), c3 = null === (v = null === (u = o2.match(/<title>(.*?)<\/title>/)) || void 0 === u ? void 0 : u[1]) || void 0 === v ? void 0 : v.trim(), this.getHostname(a2) != this.getHostname(n2.url) || c3 && ("Bot Verification" == c3 || "You are being redirected..." == c3 || "Un instant..." == c3 || "Just a moment..." == c3 || "Redirecting..." == c3)) throw new Error("Captcha error, please open in webview (or the website has changed url)");
              return [2, o2];
          }
        }));
      }));
      ...
      return (e2.match(/<article([^]*?)<\/article>/g) || []).forEach((function(e3) {
        ...
        if (i2 && r2) {
          ...
          if (r2.includes(t2.site)) o2 = r2.replace(t2.site, "");
          else {
            var c3 = r2.split("/");
            c3.shift(), c3.shift(), c3.shift(), o2 = c3.join("/");
          }
          s2.push({ name: i2, cover: n2[2] || n2[1] || l.defaultCover, path: o2 });
        }
      })), s2;
    }, c2.prototype.popularNovels = function(a2, s2) {
      return e(this, arguments, void 0, (function(e2, a3) {
        var s3, r2, i2, l2, n2, o2, c3, u, v, h = a3.filters, p = a3.showLatestNovels;
        return t(this, (function(t2) {
          switch (t2.label) {
            case 0:
              for (i2 in s3 = null !== (v = null === (u = this.options) || void 0 === u ? void 0 : u.seriesPath) && void 0 !== v ? v : "/series/", r2 = this.site + s3 + "?page=" + e2, h || (h = this.filters || {}), p && (r2 += "&order=latest"), h) if ("object" == typeof h[i2].value) for (l2 = 0, n2 = h[i2].value; l2 < n2.length; l2++) o2 = n2[l2], r2 += "&".concat(i2, "=").concat(o2);
      ...
      return e(this, void 0, void 0, (function() {
        var e2, r2, n2, c3, u, v, h, p, d, f, m, b, y, g, w, k, x, C, N, S, L;
        return t(this, (function(t2) {
          switch (t2.label) {
            case 0:
              return e2 = this.site, [4, this.safeFecth(e2 + a2, false)];
            case 1:
              return r2 = t2.sent(), n2 = { path: a2, name: "", genres: "", summary: "", author: "", artist: "", status: "", chapters: [] }, c3 = false, u = false, v = 0, h = false, p = false, d = false, f = false, m = false, b = false, y = false, g = 0, w = false, k = false, x = [], C = {}, N = this.hideLocked, S = new s.Parser({ onopentag: function(t3, a3) {
                var s2;
                !n2.cover && (null === (s2 = a3.class) || void 0 === s2 ? void 0 : s2.includes("ts-post-image")) ? (n2.name = a3.title, n2.cover = a3["data-src"] || a3.src || l.defaultCover) : "genxed" === a3.class || "sertogenre" === a3.class ? c3 = true : c3 && "a" === t3 ? u = true : "div" !== t3 || "entry-content" !== a3.class && "description" !== a3.itemprop ? "spe" === a3.class || "serl" === a3.class ? h = true : h && "span" === t3 ? p = true : "div" === t3 && "sertostat" === a3.class ? (h = true, p = true, m = true) : a3.class && a3.class.includes("eplister") ? b = true : b && "li" === t3 ? y = true : y ? "a" === t3 && void 0 === C.path ? C.path = a3.href.replace(e2, "").trim() : "epl-num" === a3.class ? g = 1 : "epl-title" === a3.class ? g = 2 : "epl-date" === a3.class ? g = 3 : "epl-price" === a3.class && (g = 4) : !v || "div" !== t3 && "script" !== t3 || v++ : v++;
              }, ontext: function(e3) {
                var t3, a3;
                if (c3) u && (n2.genres += e3 + ", ");
                  ...
                  if (1 === g) e3.includes("\u{1F512}") ? (w = true, k = true) : k && (w = false), o(e3, C);
                  else if (2 === g) C.name = (null === (a3 = null === (t3 = e3.match(RegExp("^".concat(n2.name.replace(/[.*+?^${}()|[\]\\]/g, "\\$&"), "\\s*(.+)")))) || void 0 === t3 ? void 0 : t3[1]) || void 0 === a3 ? void 0 : a3.trim()) || e3.trim(), C.chapterNumber || o(e3, C);
                  else if (3 === g) C.releaseTime = e3;
                  else if (4 === g) {
                ...
                var t3, a3, s2;
                c3 ? u ? u = false : (c3 = false, n2.genres = null === (t3 = n2.genres) || void 0 === t3 ? void 0 : t3.slice(0, -2)) : v ? "p" === e3 ? n2.summary += "\n\n" : "br" === e3 ? n2.summary += "\n" : "div" !== e3 && "script" !== e3 || v-- : h ? p ? "span" === e3 && (p = false, d && n2.author ? d = false : f && n2.artist ? f = false : m && "" !== n2.status && (m = false)) : "div" === e3 && (h = false, n2.author = null === (a3 = n2.author) || void 0 === a3 ? void 0 : a3.trim(), n2.artist = null === (s2 = n2.artist) || void 0 === s2 ? void 0 : s2.trim()) : b && (y ? 1 === g || 2 === g || 3 === g || 4 === g ? g = 0 : "li" === e3 && (y = false, C.chapterNumber || (C.chapterNumber = 0), w && (C.name = "\u{1F512} " + C.name), N && w || x.push(C), C = {}) : "ul" === e3 && (b = false));
              } }), S.write(r2), S.end(), x.length && ((null === (L = this.options) || void 0 === L ? void 0 : L.reverseChapters) && x.reverse(), n2.chapters = x), n2.summary = n2.summary.trim(), [2, n2];
          }
        }));
      }));
