...
var LNReaderPlugin = (() => {
  ...
  // .js/plugins/english/readfrom.js
  init_dirname();
  init_buffer2();
  init_process2();
  var t = function() {
    ...
    if (r2 || 2 === arguments.length) for (var n2, i2 = 0, a2 = e2.length; i2 < a2; i2++) !n2 && i2 in e2 || (n2 || (n2 = Array.prototype.slice.call(e2, 0, i2)), n2[i2] = e2[i2]);
    return t2.concat(n2 || Array.prototype.slice.call(e2));
  };
  Object.defineProperty(exports, "__esModule", { value: true });
  var i = (init_fetch2(), __toCommonJS(fetch_exports)), a = (init_browser(), __toCommonJS(browser_exports)), o = (init_defaultCover(), __toCommonJS(defaultCover_exports)), s = { "User-Agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/146.0.0.0 Safari/537.36" }, c = function() {
    function c2() {
      this.id = "readfrom", this.name = "Read From Net", this.icon = "src/en/readfrom/icon.png", this.site = "https://readfrom.net/", this.version = "1.1.0", this.filters = void 0, this.headers = new Headers(s), this.imageRequestInit = { headers: s }, this.loadedNovelCache = [];
    }
    __name(c2, "c");
    return c2.prototype.parseNovels = function(t2, e2) {
      var r2, n2 = this, i2 = t2((e2 ? "div.text" : "#dle-content") + " > article.box").map(function(r3, i3) {
        var a2 = t2(i3).find("h2.title a").attr("href");
        if (a2) {
          var s2 = t2(i3).find(e2 ? "div.text5" : "div.text3")[0];
          return t2(s2).find(".coll-ellipsis").remove(), t2(s2).find("a").remove(), { name: t2(i3).find("h2.title").text().trim(), path: new URL(a2, n2.site).pathname.substring(1), cover: t2(i3).find("img").attr("src") || o.defaultCover, summary: t2(s2).text().trim() + t2(s2).find("span.coll-hidden").text(), genres: t2(i3).find(e2 ? "h5.title > a" : "h2 > a").filter(function(t3, e3) {
            var r4, n3;
            return null === (n3 = null === (r4 = e3.attribs.title) || void 0 === r4 ? void 0 : r4.startsWith) || void 0 === n3 ? void 0 : n3.call(r4, "Genre - ");
          }).map(function(e3, r4) {
            return t2(r4).text();
          }).toArray().join(", "), author: e2 ? t2(i3).find("h5.title > a").filter(function(t3, e3) {
            var r4, n3;
            return null === (n3 = null === (r4 = e3.attribs.title) || void 0 === r4 ? void 0 : r4.startsWith) || void 0 === n3 ? void 0 : n3.call(r4, "Book author - ");
          }).text() : t2(i3).find("h4 > a").text() };
        }
      }).toArray();
      for ((r2 = this.loadedNovelCache).push.apply(r2, i2); this.loadedNovelCache.length > 100; ) this.loadedNovelCache.shift();
      return i2;
    }, c2.prototype.popularNovels = function(t2, n2) {
      return e(this, arguments, void 0, function(t3, e2) {
        var n3, o2, s2 = e2.showLatestNovels;
        return r(this, function(e3) {
          switch (e3.label) {
            case 0:
              return n3 = s2 ? "last_added_books" : "allbooks", [4, (0, i.fetchApi)(this.site + n3 + "/page/" + t3, { headers: this.headers })];
            case 1:
              return [4, e3.sent().text()];
            case 2:
              return o2 = e3.sent(), [2, this.parseNovels((0, a.load)(o2))];
          }
        });
      });
    }, c2.prototype.parseNovel = function(s2) {
      return e(this, void 0, void 0, function() {
        var e2, c3, u, l, h, f, d, p = this;
        return r(this, function(r2) {
          switch (r2.label) {
            case 0:
              return [4, (0, i.fetchApi)(this.site + s2, { headers: this.headers })];
            case 1:
              return [4, r2.sent().text()];
            case 2:
              return e2 = r2.sent(), c3 = (0, a.load)(e2), (u = { path: s2, name: "Untitled" }).name = c3("center > h2.title").text().split(", \n\n")[0].trim(), u.cover = c3("article.box > div > center > div > a > img").attr("src") || o.defaultCover, l = c3("div.pages").first().find("> a").toArray().flatMap(function(t2) {
                var e3 = c3(t2).attr("href");
                if (!e3) return [];
                var r3 = new URL(e3, p.site).pathname.substring(1);
                return r3 ? [{ name: c3(t2).text().trim(), path: r3 }] : [];
              }), u.chapters = n([{ name: "1", path: s2, chapterNumber: 1 }], l.map(function(e3, r3) {
                return t(t({}, e3), { chapterNumber: r3 + 2 });
              }), true), h = this.loadedNovelCache.find(function(t2) {
                return t2.path === s2;
              }), h ? [3, 4] : [4, this.searchNovels(u.name, 1)];
            case 3:
              h = r2.sent().find(function(t2) {
                return t2.path === s2;
              }), r2.label = 4;
            case 4:
              return h && (u.summary = h.summary, u.genres = h.genres, u.author = h.author), (f = c3("center > b:has(a)").filter(function(t2, e3) {
                return c3(e3).find("a").attr("href").startsWith("/series.html");
              })[0]) && (d = c3(f).text().trim(), u.summary = d + "\n\n" + u.summary), [2, u];
          }
        });
      });
    }, c2.prototype.parseChapter = function(t2) {
      return e(this, void 0, void 0, function() {
        var e2, n2, o2, s2, c3, u, l, h, f, d, p;
        return r(this, function(r2) {
          switch (r2.label) {
            case 0:
              return [4, (0, i.fetchApi)(this.site + t2, { headers: this.headers })];
            case 1:
              return e2 = r2.sent(), o2 = a.load, [4, e2.text()];
            case 2:
              for ((n2 = o2.apply(void 0, [r2.sent()]))("#textToRead > span:empty, #textToRead > center").remove(), s2 = [], c3 = [], u = /* @__PURE__ */ new Set(["b", "i", "u", "strong", "em", "a"]), l = /* @__PURE__ */ __name(function() {
                return c3.length && (s2.push("<p>".concat(c3.join(" ").trim(), "</p>")), c3 = []);
              }, "l"), h = 0, f = n2("#textToRead").contents().toArray(); h < f.length; h++) {
                switch ((d = f[h]).type) {
                  case "comment":
                    continue;
                  case "text":
                    d.data.trim() && (p = d.data.trim().replace(/_([^_]+)_/g, "<i>$1</i>"), c3.push(p));
                    continue;
                  case "tag":
                    if (u.has(d.name)) {
                      c3.push(n2.html(d));
    ...
    }, c2.prototype.searchNovels = function(t2, n2) {
      return e(this, void 0, void 0, function() {
        var e2;
        return r(this, function(r2) {
          switch (r2.label) {
            case 0:
              return 1 !== n2 ? [2, []] : [4, (0, i.fetchApi)("https://readfrom.net/build_in_search/?q=" + encodeURIComponent(t2), { headers: this.headers })];
            case 1:
              return [4, r2.sent().text()];
            case 2:
              return e2 = r2.sent(), [2, this.parseNovels((0, a.load)(e2), true)];
          }
        });
      });
    }, c2;
