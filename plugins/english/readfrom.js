...
(() => {
  ...
  var r = (init_fetch2(), __toCommonJS(fetch_exports)), n = (init_browser(), __toCommonJS(browser_exports)), a = (init_defaultCover(), __toCommonJS(defaultCover_exports)), i = (function() {
    function i2() {
      var t2 = this;
      this.id = "readfrom", this.name = "Read From Net", this.icon = "src/en/readfrom/icon.png", this.site = "https://readfrom.net", this.version = "1.0.2", this.filters = void 0, this.imageRequestInit = void 0, this.loadedNovelCache = [], this.resolveUrl = function(e2, r2) {
        return t2.site + "/" + e2;
      };
    }
    __name(i2, "i");
    return i2.prototype.parseNovels = function(t2, e2) {
      var r2, n2 = t2((e2 ? "div.text" : "#dle-content") + " > article.box").map((function(r3, n3) {
        var i3 = t2(n3).find(e2 ? "div.text5" : "div.text3")[0];
        return t2(i3).find(".coll-ellipsis").remove(), t2(i3).find("a").remove(), { name: t2(n3).find("h2.title").text().trim(), path: t2(n3).find("h2.title > a").attr("href").replace("https://readfrom.net/", "").replace(/^\//, ""), cover: t2(n3).find("img").attr("src") || a.defaultCover, summary: t2(i3).text().trim() + t2(i3).find("span.coll-hidden").text(), genres: t2(n3).find(e2 ? "h5.title > a" : "h2 > a").filter((function(t3, e3) {
          var r4, n4;
          return null === (n4 = null === (r4 = e3.attribs.title) || void 0 === r4 ? void 0 : r4.startsWith) || void 0 === n4 ? void 0 : n4.call(r4, "Genre - ");
        })).map((function(e3, r4) {
          return t2(r4).text();
        })).toArray().join(", "), author: e2 ? t2(n3).find("h5.title > a").filter((function(t3, e3) {
          var r4, n4;
          return null === (n4 = null === (r4 = e3.attribs.title) || void 0 === r4 ? void 0 : r4.startsWith) || void 0 === n4 ? void 0 : n4.call(r4, "Book author - ");
        })).text() : t2(n3).find("h4 > a").text() };
      })).toArray();
      for ((r2 = this.loadedNovelCache).push.apply(r2, n2); this.loadedNovelCache.length > 100; ) this.loadedNovelCache.shift();
      return n2;
    }, i2.prototype.popularNovels = function(a2, i3) {
      return t(this, arguments, void 0, (function(t2, a3) {
        var i4, o, s = a3.showLatestNovels;
        a3.filters;
        return e(this, (function(e2) {
          switch (e2.label) {
            case 0:
              return i4 = s ? "last_added_books" : "allbooks", [4, (0, r.fetchApi)("https://readfrom.net/" + i4 + "/page/" + t2 + "/")];
            case 1:
              return [4, e2.sent().text()];
            case 2:
              return o = e2.sent(), [2, this.parseNovels((0, n.load)(o))];
          }
        }));
      }));
      ...
      return t(this, void 0, void 0, (function() {
        ...
        return e(this, (function(e2) {
          switch (e2.label) {
            case 0:
              return [4, (0, r.fetchApi)("https://readfrom.net/" + i3)];
            case 1:
              return [4, e2.sent().text()];
            case 2:
              return t2 = e2.sent(), o = (0, n.load)(t2), (s = { path: i3, name: "Untitled" }).name = o("center > h2.title").text().split(", \n\n")[0].trim(), s.cover = o("article.box > div > center > div > a > img").attr("src") || a.defaultCover, s.chapters = o(o("div.pages").get()[0]).find("> a").map((function(t3, e3) {
                return { name: o(e3).text().trim(), path: o(e3).attr("href").replace("https://readfrom.net/", "").replace(/^\//, ""), chapterNumber: t3 + 2 };
              })).toArray(), s.chapters.unshift({ name: "1", path: i3, chapterNumber: 1 }), c = this.loadedNovelCache.find((function(t3) {
                return t3.path === i3;
              })), c ? [3, 4] : [4, this.searchNovels(s.name, 1)];
            case 3:
              c = e2.sent().find((function(t3) {
                return t3.path === i3;
              })), e2.label = 4;
            case 4:
              return c && (s.summary = c.summary, s.genres = c.genres, s.author = c.author), (l = o("center > b:has(a)").filter((function(t3, e3) {
                return o(e3).find("a").attr("href").startsWith("/series.html");
              }))[0]) && (u = o(l).text().trim(), s.summary = u + "\n\n" + s.summary), [2, s];
          }
        }));
      }));
      ...
      return t(this, void 0, void 0, (function() {
        ...
        return e(this, (function(e2) {
          switch (e2.label) {
            case 0:
              return [4, (0, r.fetchApi)("https://readfrom.net/" + a2)];
            case 1:
              return [4, e2.sent().text()];
            case 2:
              return t2 = e2.sent(), (i3 = (0, n.load)(t2))("#textToRead > span:empty").remove(), i3("#textToRead > center").remove(), o = i3("#textToRead"), s = [], c = [], o.contents().each((function(t3, e3) {
                switch (e3.type) {
                  case "text":
                    var r2 = e3.data.trim();
                    r2 && s.push(r2);
                    break;
                  case "tag":
                    s.length > 0 && (c.push("<p>".concat(s.join(" "), "</p>")), s = []), "br" !== e3.tagName && c.push(i3.html(e3));
                }
              })), s.length > 0 && c.push("<p>".concat(s.join(" "), "</p>")), [2, c.join("")];
          }
        }));
      }));
      ...
      return t(this, void 0, void 0, (function() {
        ...
        return e(this, (function(e2) {
          switch (e2.label) {
            case 0:
              return 1 !== i3 ? [2, []] : [4, (0, r.fetchApi)("https://readfrom.net/build_in_search/?q=" + encodeURIComponent(a2))];
            case 1:
              return [4, e2.sent().text()];
            case 2:
              return t2 = e2.sent(), [2, this.parseNovels((0, n.load)(t2), true)];
          }
        }));
      }));
    }, i2;
