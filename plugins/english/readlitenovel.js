...
(() => {
  ...
  function getLoad(parse6, render3) {
    return /* @__PURE__ */ __name(function load2(content, options, isDocument2 = true) {
      ...
      function initialize(selector, context, root2 = initialRoot, opts) {
        ...
        const r3 = typeof root2 === "string" ? [parse6(root2, options2, false, null)] : "length" in root2 ? root2 : [root2];
  ...
  var init_bundle_mjs = __esm({
    "node_modules/tailwind-merge/dist/bundle-mjs.mjs"() {
      ...
      isNumber2 = /* @__PURE__ */ __name((value) => !!value && !Number.isNaN(Number(value)), "isNumber");
      isInteger = /* @__PURE__ */ __name((value) => !!value && Number.isInteger(Number(value)), "isInteger");
      isPercent = /* @__PURE__ */ __name((value) => value.endsWith("%") && isNumber2(value.slice(0, -1)), "isPercent");
      ...
      isArbitraryNumber = /* @__PURE__ */ __name((value) => getIsArbitraryValue(value, isLabelNumber, isNumber2), "isArbitraryNumber");
      ...
      getDefaultConfig = /* @__PURE__ */ __name(() => {
        ...
        const scaleBorderWidth = /* @__PURE__ */ __name(() => ["", isNumber2, isArbitraryVariableLength, isArbitraryLength], "scaleBorderWidth");
        ...
        const scaleMaskImagePosition = /* @__PURE__ */ __name(() => [isNumber2, isPercent, isArbitraryVariablePosition, isArbitraryPosition], "scaleMaskImagePosition");
        ...
        const scaleRotate = /* @__PURE__ */ __name(() => ["none", isNumber2, isArbitraryVariable, isArbitraryValue], "scaleRotate");
        const scaleScale = /* @__PURE__ */ __name(() => ["none", isNumber2, isArbitraryVariable, isArbitraryValue], "scaleScale");
        const scaleSkew = /* @__PURE__ */ __name(() => [isNumber2, isArbitraryVariable, isArbitraryValue], "scaleSkew");
    ...
    "node_modules/dayjs/dayjs.min.js"(exports2, module2) {
      !(function(t2, e2) {
        ...
        var t2 = 1e3, e2 = 6e4, n2 = 36e5, r3 = "millisecond", i2 = "second", s2 = "minute", u2 = "hour", a2 = "day", o2 = "week", c = "month", f = "quarter", h = "year", d = "date", l = "Invalid Date", $2 = /^(\d{4})[-/]?(\d{1,2})?[-/]?(\d{0,2})[Tt\s]*(\d{1,2})?:?(\d{1,2})?:?(\d{1,2})?[.:]?(\d+)?$/, y = /\[([^\]]+)]|Y{1,4}|M{1,4}|D{1,2}|d{1,4}|H{1,2}|h{1,2}|a|A|m{1,2}|s{1,2}|Z{1,2}|SSS/g, M = { name: "en", weekdays: "Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"), months: "January_February_March_April_May_June_July_August_September_October_November_December".split("_"), ordinal: /* @__PURE__ */ __name(function(t3) {
          ...
          return { M: c, y: h, w: o2, d: a2, D: d, h: u2, m: s2, s: i2, ms: r3, Q: f }[t3] || String(t3 || "").toLowerCase().replace(/s$/, "");
        ...
        }, "S"), w = /* @__PURE__ */ __name(function t3(e3, n3, r4) {
          var i3;
          if (!e3) return g;
          if ("string" == typeof e3) {
        ...
        var _ = (function() {
          ...
          return m2.parse = function(t3) {
            ...
            var n3 = this, r4 = !!b.u(e3) || e3, f2 = b.p(t3), l2 = /* @__PURE__ */ __name(function(t4, e4) {
            ...
            var n3, o3 = b.p(t3), f2 = "set" + (this.$u ? "UTC" : ""), l2 = (n3 = {}, n3[a2] = f2 + "Date", n3[d] = f2 + "Date", n3[c] = f2 + "Month", n3[h] = f2 + "FullYear", n3[u2] = f2 + "Hours", n3[s2] = f2 + "Minutes", n3[i2] = f2 + "Seconds", n3[r3] = f2 + "Milliseconds", n3)[o3], $3 = o3 === a2 ? this.$D + (e3 - this.$W) : e3;
            if (o3 === c || o3 === h) {
            ...
            if ($3 === c) return this.set(c, this.$M + r4);
            if ($3 === h) return this.set(h, this.$y + r4);
            if ($3 === a2) return y2(1);
            if ($3 === o2) return y2(7);
            var M3 = (d2 = {}, d2[s2] = e2, d2[u2] = n2, d2[i2] = t2, d2)[$3] || 1, m3 = this.$d.getTime() + r4 * M3;
            return b.w(m3, this);
            ...
            var r4 = t3 || "YYYY-MM-DDTHH:mm:ssZ", i3 = b.z(this), s3 = this.$H, u3 = this.$m, a3 = this.$M, o3 = n3.weekdays, c2 = n3.months, f2 = n3.meridiem, h2 = /* @__PURE__ */ __name(function(t4, n4, i4, s4) {
            ...
            var $3, y2 = this, M3 = b.p(d2), m3 = O(r4), v2 = (m3.utcOffset() - this.utcOffset()) * e2, g2 = this - m3, D2 = /* @__PURE__ */ __name(function() {
              return b.m(y2, m3);
            }, "D");
            switch (M3) {
              case h:
        ...
        return O.prototype = k, [["$ms", r3], ["$s", i2], ["$m", s2], ["$H", u2], ["$W", a2], ["$M", c], ["$y", h], ["$D", d]].forEach((function(t3) {
          k[t3[1]] = function(e3) {
  ...
  // .js/plugins/english/readlitenovel.js
  var t = function(t2, e2, r3, n2) {
    return new (r3 || (r3 = Promise))((function(a2, i2) {
      ...
      function u2(t3) {
        var e3;
        t3.done ? a2(t3.value) : (e3 = t3.value, e3 instanceof r3 ? e3 : new r3((function(t4) {
          t4(e3);
        }))).then(o2, s2);
      }
      __name(u2, "u");
    ...
    var r3, n2, a2, i2 = { label: 0, sent: /* @__PURE__ */ __name(function() {
      ...
      return function(u2) {
        return (function(s4) {
          ...
          for (; o2 && (o2 = 0, s4[0] && (i2 = 0)), i2; ) try {
            if (r3 = 1, n2 && (a2 = 2 & s4[0] ? n2.return : s4[0] ? n2.throw || ((a2 = n2.return) && a2.call(n2), 0) : n2.next) && !(a2 = a2.call(n2, s4[1])).done) return a2;
            switch (n2 = 0, a2 && (s4 = [2 & s4[0], a2.value]), s4[0]) {
              case 0:
              case 1:
                a2 = s4;
                break;
  ...
  var n = (init_browser(), __toCommonJS(browser_exports)), a = (init_isAbsoluteUrl(), __toCommonJS(isAbsoluteUrl_exports)), i = (init_fetch2(), __toCommonJS(fetch_exports)), o = (init_filterInputs(), __toCommonJS(filterInputs_exports)), s = r2(require_dayjs_min()), u = (function() {
    function r3() {
      this.id = "rln.app", this.name = "ReadLiteNovel", this.version = "1.0.1", this.icon = "src/en/readlitenovel/icon.png", this.site = "https://rln.app", this.filters = { order: { value: "top-rated", label: "Order by", options: [{ label: "MOST VIEWED", value: "most-viewed" }, { label: "TOP RATED", value: "top-rated" }, { label: "BOOKMARKS", value: "subscribers" }, { label: "NEW", value: "new" }], type: o.FilterTypes.Picker } };
    }
    __name(r3, "r");
    return r3.prototype.parseAgoDate = function(t2) {
      var e2;
      if (null == t2 ? void 0 : t2.includes("ago")) {
        var r4 = (0, s.default)(/* @__PURE__ */ new Date()), n2 = (null === (e2 = t2.match(/\d+/)) || void 0 === e2 ? void 0 : e2[0]) || "", a2 = parseInt(n2, 10);
        return n2 ? ((t2.includes("hours ago") || t2.includes("hour ago")) && r4.subtract(a2, "hours"), (t2.includes("days ago") || t2.includes("day ago")) && r4.subtract(a2, "days"), (t2.includes("months ago") || t2.includes("month ago")) && r4.subtract(a2, "months"), (t2.includes("years ago") || t2.includes("year ago")) && r4.subtract(a2, "years"), r4.toISOString()) : null;
      }
      return null;
    }, r3.prototype.popularNovels = function(r4, o2) {
      return t(this, arguments, void 0, (function(t2, r5) {
        var o3, s2, u2, c, l = this, h = r5.filters;
        return e(this, (function(e2) {
          switch (e2.label) {
            case 0:
              return o3 = "".concat(this.site, "/ranking/").concat(h.order.value, "/").concat(t2), [4, (0, i.fetchApi)(o3)];
            case 1:
              return [4, e2.sent().text()];
            case 2:
              return s2 = e2.sent(), u2 = (0, n.load)(s2), c = [], u2(".category-items li").each((function(t3, e3) {
                var r6 = u2(e3).find(".category-name a").attr("href");
                if (r6) {
                  var n2 = u2(e3).find(".category-name a").text().trim(), i2 = u2(e3).find(".category-img img").attr("src");
                  i2 && !(0, a.isUrlAbsolute)(i2) && (i2 = l.site + i2);
                  var o4 = { path: null == r6 ? void 0 : r6.replace(l.site, ""), name: n2, cover: i2 };
                  c.push(o4);
                }
              })), [2, c];
          }
    ...
    }, r3.prototype.parseNovel = function(r4) {
      return t(this, void 0, void 0, (function() {
        var t2, a2, o2, s2, u2 = this;
        return e(this, (function(e2) {
          switch (e2.label) {
            case 0:
              return [4, (0, i.fetchApi)(this.site + r4)];
            case 1:
              return [4, e2.sent().text()];
            case 2:
              return t2 = e2.sent(), a2 = (0, n.load)(t2), o2 = { path: r4, name: a2(".novel-title").text() || "Untitled", cover: a2(".novels-detail img").attr("src"), summary: a2(".empty-box").text().trim(), chapters: [] }, a2(".novels-detail-right li").each((function(t3, e3) {
                var r5 = a2(e3).find("div:first").text(), n2 = a2(e3).find("div:last");
                switch (r5) {
                  case "Status:":
                    o2.status = n2.text();
                    break;
                  case "Genres:":
                    o2.genres = n2.find("a").map((function(t4, e4) {
                      return a2(e4).text();
                    })).toArray().join(", ") || n2.text();
                    break;
                  case "Author(s):":
                    o2.author = n2.find("a").map((function(t4, e4) {
                      return a2(e4).text();
                    })).toArray().join(", ") || n2.text();
                    break;
                  case "Translator:":
              ...
              })), s2 = [], a2(".cm-tabs-content li").each((function(t3, e3) {
                var r5 = a2(e3).find("a").attr("href");
                if (r5) {
                  var n2 = a2(e3).find("a").text().trim(), i2 = u2.parseAgoDate(a2(e3).find("svg").attr("data-bs-original-title"));
                  s2.push({ name: n2, path: null == r5 ? void 0 : r5.replace(u2.site, ""), releaseTime: i2 });
                }
              })), o2.chapters = s2, [2, o2];
          }
        }));
      }));
    }, r3.prototype.parseChapter = function(r4) {
      return t(this, void 0, void 0, (function() {
        var t2, a2;
        return e(this, (function(e2) {
          switch (e2.label) {
            ...
            case 1:
              return [4, e2.sent().text()];
            case 2:
              return t2 = e2.sent(), a2 = (0, n.load)(t2), [2, a2("#chapterText").html() || ""];
          }
        }));
      }));
    }, r3.prototype.searchNovels = function(r4) {
      return t(this, void 0, void 0, (function() {
        var t2, n2, a2;
        return e(this, (function(e2) {
          switch (e2.label) {
            case 0:
              return t2 = this.site + "/search/autocomplete?dataType=json&query=".concat(encodeURIComponent(r4)), [4, (0, i.fetchApi)(t2)];
            case 1:
              return [4, e2.sent().json()];
            case 2:
              return n2 = e2.sent(), a2 = [], n2.results.forEach((function(t3) {
                return a2.push({ path: t3.link, name: t3.original_title, cover: t3.image });
              })), [2, a2];
          }
        }));
      }));
