...
(() => {
      ...
      !(function(t2, e2) {
        ...
        var _ = (function() {
          ...
          return m2.parse = function(t3) {
            ...
            var n3, o3 = b.p(t3), f2 = "set" + (this.$u ? "UTC" : ""), l2 = (n3 = {}, n3[a2] = f2 + "Date", n3[d] = f2 + "Date", n3[c2] = f2 + "Month", n3[h] = f2 + "FullYear", n3[u2] = f2 + "Hours", n3[s2] = f2 + "Minutes", n3[i2] = f2 + "Seconds", n3[r2] = f2 + "Milliseconds", n3)[o3], $3 = o3 === a2 ? this.$D + (e3 - this.$W) : e3;
            if (o3 === c2 || o3 === h) {
  ...
  // .js/plugins/english/novelight.js
  var t = function(t2, e2, n2, i2) {
      ...
      return function(c2) {
        return (function(s4) {
          ...
          for (; a2 && (a2 = 0, s4[0] && (o2 = 0)), o2; ) try {
            if (n2 = 1, i2 && (r2 = 2 & s4[0] ? i2.return : s4[0] ? i2.throw || ((r2 = i2.return) && r2.call(i2), 0) : i2.next) && !(r2 = r2.call(i2, s4[1])).done) return r2;
  ...
  var i = (init_browser(), __toCommonJS(browser_exports)), r = (init_fetch2(), __toCommonJS(fetch_exports)), o = (init_defaultCover(), __toCommonJS(defaultCover_exports)), a = n(require_dayjs_min()), s = (init_storage2(), __toCommonJS(storage_exports)), c = (init_novelStatus(), __toCommonJS(novelStatus_exports)), u = (function() {
    function n2() {
      this.id = "novelight", this.name = "Novelight", this.version = "1.1.1", this.icon = "src/en/novelight/icon.png", this.site = "https://novelight.net/", this.hideLocked = s.storage.get("hideLocked"), this.pluginSettings = { hideLocked: { value: "", label: "Hide locked chapters", type: "Switch" } };
    }
    __name(n2, "n");
    return n2.prototype.popularNovels = function(n3) {
      return t(this, void 0, void 0, (function() {
        var t2, a2, s2, c2, u2 = this;
        return e(this, (function(e2) {
          switch (e2.label) {
            case 0:
              return t2 = "".concat(this.site, "catalog/?ordering=popularity&page=").concat(n3), [4, (0, r.fetchApi)(t2).then((function(t3) {
                return t3.text();
              }))];
            case 1:
              return a2 = e2.sent(), s2 = (0, i.load)(a2), c2 = [], s2("a.item").each((function(t3, e3) {
                var n4 = s2(e3).find("div.title").text().trim(), i2 = e3.attribs.href, r2 = s2(e3).find("img").attr("src"), a3 = r2 ? u2.site + r2 : o.defaultCover;
                if (i2) {
                  var l = { name: n4, cover: null != a3 ? a3 : o.defaultCover, path: i2.replace("/", "") };
                  c2.push(l);
                }
              })), [2, c2];
          }
    ...
    }, n2.prototype.parseNovel = function(n3) {
      return t(this, void 0, void 0, (function() {
        var t2, o2, a2, s2, u2, l, h, d, f, p;
        return e(this, (function(e2) {
          switch (e2.label) {
            case 0:
              return [4, (0, r.fetchApi)(this.site + n3).then((function(t3) {
                return t3.text();
              }))];
            case 1:
              for (t2 = e2.sent(), o2 = (0, i.load)(t2), a2 = { path: n3, name: o2("h1").text() || "Untitled", cover: this.site + o2(".poster > img").attr("src"), summary: o2("section.text-info.section > p").text(), totalPages: o2("#select-pagination-chapter > option").length, chapters: [] }, s2 = o2("div.mini-info > .item").toArray(), u2 = "", l = "", h = 0, d = s2; h < d.length; h++) f = d[h], "Status" === (p = o2(f).find(".sub-header").text().trim()) && (u2 = o2(f).find("div.info").text().trim()), "Translation" === p && (l = o2(f).find("div.info").text().trim()), "Author" === p && (a2.author = o2(f).find("div.info").text().trim()), "Genres" === p && (a2.genres = o2(f).find("div.info > a").map((function(t3, e3) {
                return o2(e3).text();
              })).toArray().join(", "));
              return "cancelled" === u2 ? a2.status = c.NovelStatus.Cancelled : "releasing" === u2 || "ongoing" === l ? a2.status = c.NovelStatus.Ongoing : "completed" === u2 && "completed" === l && (a2.status = c.NovelStatus.Completed), [2, a2];
          }
        }));
      }));
    }, n2.prototype.parsePage = function(n3, o2) {
      return t(this, void 0, void 0, (function() {
        var t2, s2, c2, u2, l, h, d, f, p, v, m, g, b = this;
        return e(this, (function(e2) {
          switch (e2.label) {
            case 0:
              return [4, (0, r.fetchApi)(this.site + n3).then((function(t3) {
            ...
            case 1:
              return t2 = e2.sent(), s2 = null === (d = null == t2 ? void 0 : t2.match(/window\.CSRF_TOKEN = "([^"]+)"/)) || void 0 === d ? void 0 : d[1], c2 = null === (f = null == t2 ? void 0 : t2.match(/const OBJECT_BY_COMMENT = ([0-9]+)/)) || void 0 === f ? void 0 : f[1], u2 = parseInt(null !== (g = null === (m = null === (v = null === (p = null == t2 ? void 0 : t2.match(/<option value="([0-9]+)"/g)) || void 0 === p ? void 0 : p.at(-1)) || void 0 === v ? void 0 : v.match(/([0-9]+)/)) || void 0 === m ? void 0 : m[1]) && void 0 !== g ? g : "1"), [4, (0, r.fetchApi)("".concat(this.site, "/book/ajax/chapter-pagination?csrfmiddlewaretoken=").concat(s2, "&book_id=").concat(c2, "&page=").concat(u2 - parseInt(o2) + 1), { headers: { Host: this.site.replace("https://", "").replace("/", ""), Referer: this.site + n3, "X-Requested-With": "XMLHttpRequest" } }).then((function(t3) {
                return t3.json();
              })).then((function(t3) {
                return t3.html;
              }))];
            case 2:
              return l = e2.sent(), h = [], (0, i.load)("<html>" + l + "</html>")("a").each((function(t3, e3) {
                var n4 = (0, i.load)(e3)(".title").text().trim(), r2 = !!(0, i.load)(e3)(".cost").text().trim();
                if (!b.hideLocked || !r2) {
                  var s3;
                  try {
                    s3 = (0, a.default)((0, i.load)(e3)(".date").text().trim(), "DD.MM.YYYY").toISOString();
                  } catch (t4) {
                  }
                  var c3 = r2 ? "\u{1F512} " + n4 : n4, u3 = e3.attribs.href;
                  h.push({ name: c3, path: u3, page: o2, releaseTime: s3 });
                }
              })), [2, { chapters: h.reverse() }];
          }
        }));
      }));
    }, n2.prototype.parseChapter = function(n3) {
      return t(this, void 0, void 0, (function() {
        var o2, a2, s2, c2, u2, l, h, d, f = this;
        return e(this, (function(p) {
          switch (p.label) {
            case 0:
              return [4, (0, r.fetchApi)(this.site + n3).then((function(t2) {
                return t2.text();
              }))];
            case 1:
              return o2 = p.sent(), a2 = null === (h = null == o2 ? void 0 : o2.match(/window\.CSRF_TOKEN = "([^"]+)"/)) || void 0 === h ? void 0 : h[1], s2 = null === (d = null == o2 ? void 0 : o2.match(/const CHAPTER_ID = "([0-9]+)/)) || void 0 === d ? void 0 : d[1], [4, (0, r.fetchApi)(this.site + "book/ajax/read-chapter/" + s2, { method: "GET", headers: { Cookie: "csrftoken=" + a2, Referer: this.site + n3, "X-Requested-With": "XMLHttpRequest" } }).then((function(n4) {
                  ...
                  return e(this, (function(e2) {
                    switch (e2.label) {
                      case 0:
                        return [4, n4.json()];
                      case 1:
                        return t2 = e2.sent(), c2 = t2.class, [2, t2.content];
                    }
                  }));
                }));
              }))];
            case 2:
              return u2 = p.sent(), l = (0, i.load)(u2), [2, (l("." + c2).html() || "").replace(/class="advertisment"/g, 'style="display:none;"')];
          }
        }));
      }));
    }, n2.prototype.searchNovels = function(n3) {
      return t(this, void 0, void 0, (function() {
        var t2, a2, s2, c2, u2 = this;
        return e(this, (function(e2) {
          switch (e2.label) {
            case 0:
              return t2 = "".concat(this.site, "catalog/?search=").concat(encodeURIComponent(n3)), [4, (0, r.fetchApi)(t2).then((function(t3) {
                return t3.text();
              }))];
            case 1:
              return a2 = e2.sent(), s2 = (0, i.load)(a2), c2 = [], s2("a.item").each((function(t3, e3) {
