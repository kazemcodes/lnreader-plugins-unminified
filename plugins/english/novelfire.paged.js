...
var LNReaderPlugin = (() => {
  ...
  // .js/plugins/english/novelfire.paged.js
  init_dirname();
  init_buffer2();
  init_process2();
  ...
  var n = (init_browser(), __toCommonJS(browser_exports)), r = (init_fetch2(), __toCommonJS(fetch_exports)), o = (init_novelStatus(), __toCommonJS(novelStatus_exports)), i = (init_filterInputs(), __toCommonJS(filterInputs_exports)), u = (init_constants(), __toCommonJS(constants_exports)), s = function() {
    ...
    return e2.prototype.getCheerio = function(e3, t2) {
      ...
      return a(this, arguments, void 0, function(e4, t3) {
        var a2, n2, r2, o2, i2, u2, s2, c, v, p = this, b = t3.showLatestNovels, h = t3.filters;
          ...
          switch (t4.label) {
            case 0:
              if (a2 = this.site + "search-adv", b) a2 += "?ctgcon=and&totalchapter=0&ratcon=min&rating=0&status=-1&sort=date&tagcon=and&page=".concat(e4);
                ...
                for (n2.append("ctgcon", h.genre_operator.value), u2 = 0, s2 = h.genres.value; u2 < s2.length; u2++) c = s2[u2], n2.append("categories[]", c);
            ...
            case 1:
              return [2, (v = t4.sent())(".novel-item").map(function(e5, t5) {
                var a3 = v(t5).find(".novel-title > a").text() || "No Title Found", l2 = v(t5).find(".novel-cover > img").attr("data-src"), n3 = v(t5).find(".novel-title > a").attr("href");
      ...
      return a(this, void 0, void 0, function() {
        var t2, a2, n2, r2, i2, s2, c, v, p, b, h, f;
        return l(this, function(l2) {
          switch (l2.label) {
            case 0:
              return [4, this.getCheerio(this.site + e3, false)];
            case 1:
              return t2 = l2.sent(), a2 = this.site, (n2 = { path: e3 }).name = null !== (b = null !== (p = t2(".novel-title").text().trim()) && void 0 !== p ? p : t2(".cover > img").attr("alt")) && void 0 !== b ? b : "No Titled Found", r2 = null !== (h = t2(".cover > img").attr("data-src")) && void 0 !== h ? h : t2(".cover > img").attr("src"), n2.cover = r2 ? new URL(r2, a2).href : u.defaultCover, n2.genres = t2(".categories .property-item").map(function(e4, a3) {
                return t2(a3).text();
              }).toArray().join(","), (i2 = t2(".summary .content").text().trim()) ? (i2 = i2.replace("Show More", ""), n2.summary = i2) : n2.summary = "No Summary Found", n2.author = t2(".author .property-item > span").text(), s2 = t2(".header-stats .ongoing").text() || t2(".header-stats .completed").text() || "Unknown", c = { ongoing: o.NovelStatus.Ongoing, hiatus: o.NovelStatus.OnHiatus, dropped: o.NovelStatus.Cancelled, cancelled: o.NovelStatus.Cancelled, completed: o.NovelStatus.Completed, unknown: o.NovelStatus.Unknown }, n2.status = null !== (f = c[s2.toLowerCase()]) && void 0 !== f ? f : o.NovelStatus.Unknown, n2.rating = parseFloat(t2(".nub").text().trim()), v = t2(".header-stats .icon-book-open").parent().text().trim(), n2.totalPages = Math.ceil(parseInt(v) / 100), [2, n2];
          }
        });
      });
      ...
      return a(this, void 0, void 0, function() {
        ...
        return l(this, function(l2) {
          switch (l2.label) {
            case 0:
              return a2 = "".concat(this.site).concat(e3, "/chapters?page=").concat(t2), [4, (0, r.fetchApi)(a2)];
            case 1:
              return [4, l2.sent().text()];
            case 2:
              return o2 = l2.sent(), i2 = (0, n.load)(o2), [2, { chapters: i2(".chapter-list li").map(function(e4, t3) {
                var a3 = i2(t3).find("a").attr("title") || "No Title Found", l3 = i2(t3).find("a").attr("href");
                return l3 ? { name: a3, path: l3.replace(u2.site, "") } : null;
