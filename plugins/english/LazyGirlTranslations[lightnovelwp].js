...
var LNReaderPlugin = (() => {
  ...
  var e = function(e2, t2, a2, s2) {
    ...
    var a2, s2, l2, r2 = { label: 0, sent: /* @__PURE__ */ __name(function() {
      ...
      return e(this, void 0, void 0, function() {
        ...
        return t(this, function(t2) {
          switch (t2.label) {
            ...
            case 1:
              return l2 = t2.sent(), o2 = { path: a2, name: "", genres: "", summary: "", author: "", artist: "", status: "", chapters: [] }, u3 = false, c = false, v = 0, h = false, p = false, d = false, f = false, b = false, m = false, g = false, y = 0, w = false, k = false, S = [], x = {}, N = this.hideLocked, C = new s.Parser({ onopentag: /* @__PURE__ */ __name(function(t3, a3) {
                var s2;
              ...
              }, "onclosetag") }), C.write(l2), C.end(), S.length && ((null === (L = this.options) || void 0 === L ? void 0 : L.reverseChapters) && S.reverse(), o2.chapters = S), o2.summary = o2.summary.trim(), [2, o2];
          }
        });
      });
