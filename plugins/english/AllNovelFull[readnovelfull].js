  ...
  var n, r = require_lib6(), o = (init_fetch2(), __toCommonJS(fetch_exports)), i = (init_novelStatus(), __toCommonJS(novelStatus_exports)), s = (init_browser(), __toCommonJS(browser_exports)), l = function() {
    ...
    return l2.prototype.sleep = function(e2) {
      ...
      return t(this, arguments, void 0, function(e3, t2) {
        var n3, r2, i2, s2, l3, c2, u, h, p, v, d, f, g, b, m, w, y, S, C, N, k, L, x = t2.filters, P = t2.showLatestNovels;
        return a(this, function(t3) {
          switch (t3.label) {
            case 0:
              return n3 = this.options, r2 = n3.pageParam, i2 = void 0 === r2 ? "page" : r2, s2 = n3.novelListing, l3 = n3.typeParam, c2 = void 0 === l3 ? "type" : l3, u = n3.latestPage, h = n3.genreParam, p = void 0 === h ? "category_novel" : h, v = n3.genreKey, d = void 0 === v ? "id" : v, f = n3.langParam, g = n3.urlLangCode, b = n3.noPages, m = void 0 === b ? [] : b, w = n3.pageAsPath, y = void 0 !== w && w, 1 !== e3 && !P && !x.genres.value.length && m.length > 0 && m.includes(x.type.value) ? [2, []] : (S = "", s2 ? (C = new URLSearchParams(), P ? C.append(c2, u) : x.genres.value.length ? (C.append(c2, p), C.append(d, x.genres.value)) : C.append(c2, x.type.value), f && g && C.append(f, g), C.append(i2, e3.toString()), S = "".concat(this.site).concat(s2, "?").concat(C.toString())) : (N = P ? u : x.genres.value.length ? x.genres.value : x.type.value, S = y ? e3 > 1 ? "".concat(this.site).concat(N, "/").concat(e3.toString()) : "".concat(this.site).concat(N) : "".concat(this.site).concat(N, "?").concat(i2, "=").concat(e3.toString())), [4, (0, o.fetchApi)(S)]);
            case 1:
      ...
      return t(this, void 0, void 0, function() {
        var t2, l3, c2, u, h, p, v, d, f, g, b, m, w, y, S, C, N, k, L, x, P, A, j, I, H, G, M, R, O = this;
        return a(this, function(a2) {
          switch (a2.label) {
            ...
            case 2:
              return l3 = a2.sent(), c2 = { path: s2, chapters: [] }, u = [], h = [], p = [], v = [], d = [], f = [], g = null, b = {}, m = 0, y = [n.Idle], S = /* @__PURE__ */ __name(function() {
                return y[y.length - 1];
                ...
                switch (e2) {
                  ...
                  case "img":
                    if (i2 === n.Cover) {
                      ...
                      l4 && (c2.cover = new URL(l4, O.site).href), h2 ? c2.name = h2 : N();
                    }
                    break;
                  case "h3":
                  ...
                  case "a":
                    if (i2 === n.ChapterList) {
                      m++;
                      var v2 = t3.href;
                      C(n.Chapter), b.name = t3.title || "Chapter ".concat(m), b.releaseTime = null, b.chapterNumber = m, b.path = (null == v2 ? void 0 : v2.substring(1)) || s2.replace(".html", "/chapter-".concat(m, ".html"));
                    }
                }
            ...
            case 3:
              return null === g ? [3, 7] : (L = this.options.chapterListing || "ajax/chapter-archive", x = this.options.chapterParam || "novelId", P = new URLSearchParams(((R = {})[x] = g, R)), A = "".concat(this.site).concat(L, "?").concat(P.toString()), [4, (0, o.fetchApi)(A)]);
            case 4:
            ...
            case 6:
              ...
              }, "onclosetag") })).write(I), M.end(), c2.chapters = H, a2.label = 7;
            case 7:
              return [2, c2];
          }
        });
      ...
      return t(this, void 0, void 0, function() {
        var t2, i2, l3, c2, u, h, p, v, d, f, g, b, m, w, y;
        return a(this, function(a2) {
          switch (a2.label) {
            case 0:
            ...
            case 2:
              ...
              return u = [], h = false, p = "", v = [n.Idle], d = /* @__PURE__ */ __name(function() {
                return v[v.length - 1];
                ...
                if (d() === n.Chapter) {
                  ...
                  if (0 === i3.length) u.push("<".concat(e3, ">"));
                    ...
                    u.push(m("<".concat(s2, " ").concat(i3.join(" "), ">")));
                  } else {
      ...
      return t(this, void 0, void 0, function() {
        var t2, i2, s2, l3, c2, u, h, p, v, d, f, g, b, m, w, y, S, C, N, k;
        return a(this, function(a2) {
          switch (a2.label) {
            case 0:
