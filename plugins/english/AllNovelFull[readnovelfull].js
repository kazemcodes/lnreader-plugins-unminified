...
var LNReaderPlugin = (() => {
  ...
  var n, r = require_lib6(), o = (init_fetch2(), __toCommonJS(fetch_exports)), i = (init_novelStatus(), __toCommonJS(novelStatus_exports)), s = function() {
    function s2(e2) {
      var t2;
    ...
    return s2.prototype.sleep = function(e2) {
      ...
      var a2, o2 = this, i2 = [], s3 = {}, l2 = [n.Idle], c = /* @__PURE__ */ __name(function() {
        return l2[l2.length - 1];
      }, "c"), u = /* @__PURE__ */ __name(function(e2) {
        return l2.push(e2);
      }, "u"), h = /* @__PURE__ */ __name(function() {
        return l2.length > 1 ? l2.pop() : c();
        ...
        if (((null === (r2 = t3.class) || void 0 === r2 ? void 0 : r2.includes("archive")) || "col-content" === t3.class) && (u(n.NovelList), a2 = 0), i3 === n.NovelList || i3 === n.NovelName) switch (e2) {
          case "img":
            ...
            l3 && (s3.cover = new URL(l3, o2.site).href);
            break;
          case "h3":
          ...
          case "a":
            if (i3 === n.NovelName) {
              var h2 = t3.href;
              h2 && (s3.path = new URL(h2, o2.site).pathname.substring(1), s3.name = t3.title);
            }
            break;
          case "div":
            a2++;
        ...
        var r2 = c();
        "a" === t3 && r2 === n.NovelName && (s3.name && s3.path && i2.push(e({}, s3)), s3 = {}, h()), "div" === t3 && r2 === n.NovelList && --a2 < 0 && h();
      }, "onclosetag") });
      return p.write(t2), p.end(), i2;
    }, s2.prototype.popularNovels = function(e2, n2) {
      return t(this, arguments, void 0, function(e3, t2) {
        var n3, r2, i2, s3, l2, c, u, h, p, v, d, f, g, b, m, w, y, S, C, N, k, L, P = t2.filters, x = t2.showLatestNovels;
        return a(this, function(t3) {
          switch (t3.label) {
            case 0:
              return n3 = this.options, r2 = n3.pageParam, i2 = void 0 === r2 ? "page" : r2, s3 = n3.novelListing, l2 = n3.typeParam, c = void 0 === l2 ? "type" : l2, u = n3.latestPage, h = n3.genreParam, p = void 0 === h ? "category_novel" : h, v = n3.genreKey, d = void 0 === v ? "id" : v, f = n3.langParam, g = n3.urlLangCode, b = n3.noPages, m = void 0 === b ? [] : b, w = n3.pageAsPath, y = void 0 !== w && w, 1 !== e3 && !x && !P.genres.value.length && m.length > 0 && m.includes(P.type.value) ? [2, []] : (S = "", s3 ? (C = new URLSearchParams(), x ? C.append(c, u) : P.genres.value.length ? (C.append(c, p), C.append(d, P.genres.value)) : C.append(c, P.type.value), f && g && C.append(f, g), C.append(i2, e3.toString()), S = "".concat(this.site).concat(s3, "?").concat(C.toString())) : (N = x ? u : P.genres.value.length ? P.genres.value : P.type.value, S = y ? e3 > 1 ? "".concat(this.site).concat(N, "/").concat(e3.toString()) : "".concat(this.site).concat(N) : "".concat(this.site).concat(N, "?").concat(i2, "=").concat(e3.toString())), [4, (0, o.fetchApi)(S)]);
            case 1:
      ...
      return t(this, void 0, void 0, function() {
        var t2, l2, c, u, h, p, v, d, f, g, b, m, w, y, S, C, N, k, L, P, x, A, j, I, H, G, M, R, O = this;
        return a(this, function(a2) {
          switch (a2.label) {
            case 0:
              return t2 = this.site + s3, [4, (0, o.fetchApi)(t2)];
            case 1:
              return [4, a2.sent().text()];
            case 2:
              return l2 = a2.sent(), c = { path: s3, chapters: [] }, u = [], h = [], p = [], v = [], d = [], f = [], g = null, b = {}, m = 0, y = [n.Idle], S = /* @__PURE__ */ __name(function() {
                return y[y.length - 1];
              }, "S"), C = /* @__PURE__ */ __name(function(e2) {
                return y.push(e2);
              }, "C"), N = /* @__PURE__ */ __name(function() {
                return y.length > 1 ? y.pop() : S();
              }, "N"), k = new r.Parser({ onopentag: /* @__PURE__ */ __name(function(e2, t3) {
                var a3, r2, o2, i2 = S();
                switch (e2) {
                  case "div":
                    switch (t3.class) {
                      ...
                      case "inner":
                      case "desc-text":
                        i2 === n.Cover && N(), C(n.Summary);
                        break;
                      case "info":
                        C(n.Info), w = 0;
                    }
                    O.options.noAjax || "rating" !== t3.id || (g = t3["data-novel-id"]), i2 === n.Info && w++;
                    break;
                  case "img":
                    if (i2 === n.Cover) {
                      var l3 = null !== (r2 = null !== (a3 = t3.src) && void 0 !== a3 ? a3 : t3["data-cfsrc"]) && void 0 !== r2 ? r2 : t3["data-src"], h2 = t3.title;
                      l3 && (c.cover = new URL(l3, O.site).href), h2 ? c.name = h2 : N();
                    }
                    break;
                  case "h3":
                    i2 === n.Cover && C(n.NovelName);
                    break;
                  case "span":
                    if (i2 === n.Cover && t3.title) {
                  ...
                  case "br":
                    ...
                    break;
                  case "ul":
                    (null === (o2 = t3.class) || void 0 === o2 ? void 0 : o2.includes("info-meta")) && C(n.Info), O.options.noAjax && "idData" === t3.id && C(n.ChapterList);
                    break;
                  case "a":
                    if (i2 === n.ChapterList) {
                      m++;
                      var v2 = t3.href;
                      C(n.Chapter), b.name = t3.title || "Chapter ".concat(m), b.releaseTime = null, b.chapterNumber = m, b.path = (null == v2 ? void 0 : v2.substring(1)) || s3.replace(".html", "/chapter-".concat(m, ".html"));
                    }
                }
                ...
                switch (t3) {
                  ...
                  case "h3":
                    ...
                    break;
                  case "a":
                    a3 === n.Chapter && (b.name && b.path && f.push(e({}, b)), b = {}, N());
                    break;
                  case "li":
                    a3 === n.Info && d.push("\n");
                    break;
                  ...
                  if (d.join("").split("\n").map(function(e3) {
                    ...
                    switch (n2) {
                      ...
                      case "status":
                        ...
                        c.status = null !== (t3 = o2[r2.toLowerCase()]) && void 0 !== t3 ? t3 : i.NovelStatus.Unknown;
                        break;
                      default:
                        return;
                    }
                ...
                c.summary = u.join("\n\n").trim();
              }, "onend") }), k.write(l2), k.end(), this.options.noAjax && f.length > 0 ? (c.chapters = f, [3, 7]) : [3, 3];
            case 3:
              return null === g ? [3, 7] : (L = this.options.chapterListing || "ajax/chapter-archive", P = this.options.chapterParam || "novelId", x = new URLSearchParams(((R = {})[P] = g, R)), A = "".concat(this.site).concat(L, "?").concat(x.toString()), [4, (0, o.fetchApi)(A)]);
            case 4:
              return (j = a2.sent()).ok ? [3, 5] : (console.error("Failed to fetch chapters: ".concat(j.status)), c.chapters = [], [3, 7]);
            case 5:
              return [4, j.text()];
            case 6:
              I = a2.sent(), H = [], G = {}, (M = new r.Parser({ onopentag: /* @__PURE__ */ __name(function(e2, t3) {
                var a3, r2;
                if ("a" === e2 && t3.href ? (a3 = t3.href, r2 = t3.title || "", C(n.Chapter)) : "option" === e2 && t3.value && (a3 = t3.value, r2 = "", C(n.Chapter)), void 0 !== a3) {
                  var o2 = new URL(a3, O.site);
                ...
                "a" !== t3 && "option" !== t3 || S() !== n.Chapter || (G.name && G.path && (G.name = G.name.trim(), G.releaseTime = null, H.push(e({}, G))), G = {}, N());
              }, "onclosetag") })).write(I), M.end(), c.chapters = H, a2.label = 7;
            case 7:
              return [2, c];
          }
        });
      ...
      return t(this, void 0, void 0, function() {
        var t2, i2, s3, l2, c, u, h, p, v, d, f, g, b, m;
        return a(this, function(a2) {
          switch (a2.label) {
            case 0:
            ...
            case 1:
              return [4, a2.sent().text()];
            case 2:
              return t2 = a2.sent(), l2 = [], c = false, u = "", h = [n.Idle], p = /* @__PURE__ */ __name(function() {
                return h[h.length - 1];
              }, "p"), v = /* @__PURE__ */ __name(function(e3) {
                return h.push(e3);
              }, "v"), d = /* @__PURE__ */ __name(function() {
                return h.length > 1 ? h.pop() : p();
              }, "d"), f = /[&<>"' ]/g, g = { "&": "&amp;", "<": "&lt;", ">": "&gt;", '"': "&quot;", "'": "&#39;", "\xA0": "&nbsp;" }, b = /* @__PURE__ */ __name(function(e3) {
                ...
                switch (r2) {
                  case n.Idle:
                    "txt" !== o2 && "chr-content" !== t3.id && "chapter-content" !== t3.id || (v(n.Chapter), i2 = 0);
                    break;
                  case n.Chapter:
                    "sub" === e3 ? v(n.Hidden) : "div" === e3 && (i2++, ((null == o2 ? void 0 : o2.includes("unlock-buttons")) || (null == o2 ? void 0 : o2.includes("ads"))) && (v(n.Hidden), s3 = 0));
                    break;
                  case n.Hidden:
                    "sub" === e3 ? v(n.Hidden) : "div" === e3 && s3++;
                    break;
                  default:
                    return;
                }
                if (p() === n.Chapter) {
                  ...
                  if (0 === h2.length) l2.push("<".concat(e3, ">"));
                    ...
                    l2.push(b("<".concat(d2, " ").concat(h2.join(" "), ">")));
                  } else {
                    var f2 = h2.map(function(e4) {
                      return " ".concat(e4, '="').concat(t3[e4].replace(/"/g, "&quot;"), '"');
                    }).join("");
                    l2.push("<".concat(e3).concat(f2, ">"));
                  }
                }
              }, "onopentag"), ontext: /* @__PURE__ */ __name(function(e3) {
                p() === n.Chapter && l2.push(b(e3));
              }, "ontext"), onclosetag: /* @__PURE__ */ __name(function(e3) {
                var t3 = p();
                t3 === n.Hidden && ("sub" === e3 ? d() : "div" === e3 && --s3 < 0 && (d(), i2--)), t3 === n.Chapter && (m.isVoidElement(e3) || (c && e3 === u ? (c = false, u = "") : l2.push("</".concat(e3, ">"))), "div" === e3 && --i2 < 0 && v(n.Stopped));
              }, "onclosetag") }), m.write(t2), m.end(), [2, l2.join("")];
          }
        });
      });
    }, s2.prototype.searchNovels = function(n2, r2) {
      return t(this, void 0, void 0, function() {
        var t2, i2, s3, l2, c, u, h, p, v, d, f, g, b, m, w, y, S, C, N, k;
        return a(this, function(a2) {
          switch (a2.label) {
            case 0:
            ...
            case 1:
              a2.sent(), a2.label = 2;
            case 2:
              return i2 = this.options, s3 = i2.pageParam, l2 = void 0 === s3 ? "page" : s3, c = i2.searchKey, u = void 0 === c ? "keyword" : c, h = i2.postSearch, p = i2.langParam, v = i2.urlLangCode, d = i2.searchPage, f = new URLSearchParams(e(e(((S = {})[u] = n2, S), p && v && ((C = {})[p] = v, C)), !h && ((N = {})[l2] = r2.toString(), N))), g = "".concat(this.site).concat(d).concat(h ? "" : "?".concat(f.toString())), b = h ? { method: "POST", body: f.toString(), headers: { "Content-Type": "application/x-www-form-urlencoded" } } : void 0, [4, (0, o.fetchApi)(g, b)];
            case 3:
