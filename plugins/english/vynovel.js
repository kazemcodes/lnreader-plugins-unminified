...
(() => {
  ...
  var n = (init_filterInputs(), __toCommonJS(filterInputs_exports)), i = (init_defaultCover(), __toCommonJS(defaultCover_exports)), a = (init_fetch2(), __toCommonJS(fetch_exports)), o = (init_novelStatus(), __toCommonJS(novelStatus_exports)), s = (init_browser(), __toCommonJS(browser_exports)), l = r(require_dayjs_min()), u = (function() {
    function r2() {
      var e2 = this;
      this.id = "vynovel", this.name = "VyNovel", this.site = "https://vynovel.com", this.version = "1.0.0", this.icon = "src/en/vynovel/icon.png", this.popularNovels = this.fetchNovels, this.parseDate = function(e3) {
        if (void 0 === e3 && (e3 = ""), !e3) return null;
        if (e3.includes("ago")) {
          var t2 = e3.split(" "), r3 = t2[0], n2 = t2[1];
          if (!r3 || !n2) return null;
          switch (n2.toLowerCase()) {
            case "minutes":
              var i2 = parseInt(r3, 10);
              e3 = Date.now() - 60 * i2 * 1e3;
              break;
            case "hour":
            case "hours":
              var a2 = parseInt(r3, 10);
              e3 = Date.now() - 60 * a2 * 60 * 1e3;
              break;
            case "day":
            case "days":
              var o2 = parseInt(r3, 10);
              e3 = Date.now() - 24 * o2 * 60 * 60 * 1e3;
              break;
            default:
              console.log(e3), e3 = void 0;
          }
          return (0, l.default)(e3).format("LLL");
        }
        return e3;
      }, this.resolveUrl = function(t2, r3) {
        return e2.site + (r3 ? "/novel/" : "/read/") + t2;
      }, this.filters = { sort: { label: "Sort By:", value: "viewed", options: [{ label: "Viewed", value: "viewed" }, { label: "Scored", value: "scored" }, { label: "Newest", value: "created_at" }, { label: "Latest Update", value: "updated_at" }], type: n.FilterTypes.Picker } };
    }
    __name(r2, "r");
    return r2.prototype.fetchNovels = function(r3, n2, o2) {
      return e(this, arguments, void 0, (function(e2, r4, n3) {
        var o3, l2, u2, c, v, h, f = r4.filters, d = r4.showLatestNovels;
        return t(this, (function(t2) {
          switch (t2.label) {
            case 0:
              return o3 = new URLSearchParams({ sort: d ? "updated_at" : (null === (h = null == f ? void 0 : f.sort) || void 0 === h ? void 0 : h.value) || "viewed", page: e2 }), n3 && o3.append("q", n3), l2 = this.site + "/search?" + o3.toString(), [4, (0, a.fetchApi)(l2).then((function(e3) {
                return e3.text();
              }))];
            case 1:
              return u2 = t2.sent(), c = (0, s.load)(u2), v = [], c('div[class="comic-item"] > a').each((function(e3, t3) {
                var r5, n4 = null === (r5 = c(t3).find('div[class="comic-title"]').text()) || void 0 === r5 ? void 0 : r5.trim(), a2 = c(t3).find('div[class="comic-image lozad "]').attr("data-background-image") || i.defaultCover, o4 = c(t3).attr("href");
                n4 && o4 && v.push({ name: n4, cover: a2, path: o4.replace("/novel/", "") });
              })), [2, v];
          }
        }));
      }));
      ...
      return e(this, void 0, void 0, (function() {
        var e2;
        return t(this, (function(t2) {
          return e2 = { filters: void 0, showLatestNovels: false }, [2, this.fetchNovels(n2, e2, r3)];
        }));
      }));
    }, r2.prototype.parseNovel = function(r3) {
      return e(this, void 0, void 0, (function() {
        var e2, n2, l2, u2, c, v = this;
        return t(this, (function(t2) {
          switch (t2.label) {
            case 0:
              return [4, (0, a.fetchApi)(this.resolveUrl(r3, true)).then((function(e3) {
                return e3.text();
              }))];
            case 1:
              return e2 = t2.sent(), n2 = (0, s.load)(e2), l2 = { path: r3, name: n2('h1[class="title"]').text().trim(), cover: n2('div[class="img-manga"] > img').attr("src") || i.defaultCover, summary: n2('div[class="summary"] > p[class="content"]').text().trim(), author: n2('div[class="col-md-7"] > p:nth-child(5) > a').text().trim(), status: "Ongoing" === n2('span[class="text-ongoing"]').text() ? o.NovelStatus.Ongoing : o.NovelStatus.Completed }, u2 = [], c = n2('div[class="list-group"] > a').length, n2('div[class="list-group"] > a').each((function(e3, t3) {
                var i2, a2 = n2(t3).find("span").text().trim(), o2 = null === (i2 = n2(t3).attr("id")) || void 0 === i2 ? void 0 : i2.replace(/\D/g, "");
                if (a2 && o2) {
                  var s2 = n2(t3).find("p").text();
                  u2.push({ name: a2, path: r3 + "/" + o2, releaseTime: v.parseDate(null == s2 ? void 0 : s2.trim()), chapterNumber: c - e3 });
                }
      ...
      return e(this, void 0, void 0, (function() {
        ...
        return t(this, (function(t2) {
          switch (t2.label) {
            case 0:
              return [4, (0, a.fetchApi)(this.resolveUrl(r3)).then((function(e3) {
                return e3.text();
              }))];
            case 1:
              return e2 = t2.sent(), n2 = (0, s.load)(e2), [2, n2(".content").html() || ""];
          }
        }));
      }));
    }, r2;
