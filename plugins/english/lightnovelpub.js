...
var LNReaderPlugin = (() => {
  ...
  init_buffer2();
  init_process2();
  var e = function(e2, a2, t2, r2) {
    return new (t2 || (t2 = Promise))(function(n2, l2) {
      function o2(e3) {
        try {
          i2(r2.next(e3));
        } catch (e4) {
      ...
      function i2(e3) {
        var a3;
        e3.done ? n2(e3.value) : (a3 = e3.value, a3 instanceof t2 ? a3 : new t2(function(e4) {
          e4(a3);
        })).then(o2, s2);
      }
      __name(i2, "i");
      i2((r2 = r2.apply(e2, a2 || [])).next());
    });
  }, a = function(e2, a2) {
    var t2, r2, n2, l2 = { label: 0, sent: /* @__PURE__ */ __name(function() {
    ...
    function s2(s3) {
      return function(i2) {
        return function(s4) {
          ...
          for (; o2 && (o2 = 0, s4[0] && (l2 = 0)), l2; ) try {
            if (t2 = 1, r2 && (n2 = 2 & s4[0] ? r2.return : s4[0] ? r2.throw || ((n2 = r2.return) && n2.call(r2), 0) : r2.next) && !(n2 = n2.call(r2, s4[1])).done) return n2;
            switch (r2 = 0, n2 && (s4 = [2 & s4[0], n2.value]), s4[0]) {
              ...
              case 7:
                ...
                continue;
              default:
                if (!(n2 = l2.trys, (n2 = n2.length > 0 && n2[n2.length - 1]) || 6 !== s4[0] && 2 !== s4[0])) {
                  l2 = 0;
                  continue;
                }
                ...
                if (6 === s4[0] && l2.label < n2[1]) {
                  l2.label = n2[1], n2 = s4;
                  break;
                }
                if (n2 && l2.label < n2[2]) {
                  l2.label = n2[2], l2.ops.push(s4);
                  break;
                }
  ...
  var r, n = require_lib6(), l = (init_fetch2(), __toCommonJS(fetch_exports)), o = (init_filterInputs(), __toCommonJS(filterInputs_exports)), s = t(require_dayjs_min()), i = function() {
    function t2() {
      this.id = "lightnovelpub", this.name = "LightNovelPub", this.version = "2.2.0", this.icon = "src/en/lightnovelpub/icon.png", this.site = "https://www.lightnovelpub.com/", this.headers = { Accept: "application/json", "Content-Type": "application/json" }, this.filters = { order: { value: "popular", label: "Order by", options: [{ label: "New", value: "new" }, { label: "Popular", value: "popular" }, { label: "Updates", value: "updated" }], type: o.FilterTypes.Picker }, status: { value: "all", label: "Status", options: [{ label: "All", value: "all" }, { label: "Completed", value: "completed" }, { label: "Ongoing", value: "ongoing" }], type: o.FilterTypes.Picker }, genres: { value: "all", label: "Genre", options: [{ label: "All", value: "all" }, { label: "Action", value: "action" }, { label: "Adventure", value: "adventure" }, { label: "Drama", value: "drama" }, { label: "Fantasy", value: "fantasy" }, { label: "Harem", value: "harem" }, { label: "Martial Arts", value: "martial-arts" }, { label: "Mature", value: "mature" }, { label: "Romance", value: "romance" }, { label: "Tragedy", value: "tragedy" }, { label: "Xuanhuan", value: "xuanhuan" }, { label: "Ecchi", value: "ecchi" }, { label: "Comedy", value: "comedy" }, { label: "Slice of Life", value: "slice-of-life" }, { label: "Mystery", value: "mystery" }, { label: "Supernatural", value: "supernatural" }, { label: "Psychological", value: "psychological" }, { label: "Sci-fi", value: "sci-fi" }, { label: "Xianxia", value: "xianxia" }, { label: "School Life", value: "school-life" }, { label: "Josei", value: "josei" }, { label: "Wuxia", value: "wuxia" }, { label: "Shounen", value: "shounen" }, { label: "Horror", value: "horror" }, { label: "Mecha", value: "mecha" }, { label: "Historical", value: "historical" }, { label: "Shoujo", value: "shoujo" }, { label: "Adult", value: "adult" }, { label: "Seinen", value: "seinen" }, { label: "Sports", value: "sports" }, { label: "Lolicon", value: "lolicon" }, { label: "Gender Bender", value: "gender-bender" }, { label: "Shounen Ai", value: "shounen-ai" }, { label: "Yaoi", value: "yaoi" }, { label: "Video Games", value: "video-games" }, { label: "Smut", value: "smut" }, { label: "Magical Realism", value: "magical-realism" }, { label: "Eastern Fantasy", value: "eastern-fantasy" }, { label: "Contemporary Romance", value: "contemporary-romance" }, { label: "Fantasy Romance", value: "fantasy-romance" }, { label: "Shoujo Ai", value: "shoujo-ai" }, { label: "Yuri", value: "yuri" }], type: o.FilterTypes.Picker } };
    }
    __name(t2, "t");
    return t2.prototype.parseNovels = function(e2) {
      var a2 = [], t3 = {}, l2 = r.Idle, o2 = new n.Parser({ onopentag: /* @__PURE__ */ __name(function(e3, a3) {
        if ("novel-item" === a3.class && (l2 = r.Novel), l2 === r.Novel) switch (e3) {
          case "a":
            t3.path = a3.href.slice(1), t3.name = a3.title;
            break;
          case "img":
            t3.cover = a3["data-src"] || a3.src;
        }
      }, "onopentag"), onclosetag: /* @__PURE__ */ __name(function(e3) {
        "li" === e3 && (t3.path && t3.cover && (a2.push(t3), t3 = {}), l2 = r.Idle);
      }, "onclosetag") });
      return o2.write(e2), o2.end(), a2;
    }, t2.prototype.popularNovels = function(t3, r2) {
      return e(this, arguments, void 0, function(e2, t4) {
        var r3, n2, o2 = t4.filters;
        return a(this, function(a2) {
          switch (a2.label) {
            case 0:
              return r3 = [this.site + "browse", o2.genres.value, o2.order.value, o2.status.value, e2.toString()], [4, (0, l.fetchApi)(r3.join("/")).then(function(e3) {
                return e3.text();
              })];
            case 1:
      ...
      return e(this, void 0, void 0, function() {
        ...
        return a(this, function(a2) {
          switch (a2.label) {
            case 0:
              return [4, (0, l.fetchApi)(this.site + t3).then(function(e3) {
                return e3.text();
              })];
            case 1:
              return e2 = a2.sent(), o2 = { path: t3, chapters: [] }, s2 = r.Idle, i2 = [], u = [], c = new n.Parser({ onopentag: /* @__PURE__ */ __name(function(e3, a3) {
                var t4, n2;
                switch (e3) {
                  case "h1":
                    (null === (t4 = a3.class) || void 0 === t4 ? void 0 : t4.includes("novel-title")) && (s2 = r.NovelName);
                    break;
                  case "figure":
                    "cover" === a3.class && (s2 = r.Cover);
                    break;
                  case "img":
                    s2 === r.Cover && (o2.cover = a3["data-src"] || a3.src);
                    break;
                  case "strong":
                    s2 === r.HeaderStats && (s2 = a3.class ? r.Status : r.TotalChapters);
                    break;
                  case "br":
                    s2 === r.Summary && i2.push("<LINE_BREAK>");
                    break;
                  case "a":
                    s2 === r.Genres && (s2 = r.Tags);
                    break;
                  case "div":
                    if (a3.class) if (a3.class.includes("content")) s2 = r.Summary;
                    else {
                      var l2 = { categories: r.Genres, "header-stats": r.HeaderStats, expand: r.Idle };
                      s2 = null !== (n2 = l2[a3.class]) && void 0 !== n2 ? n2 : s2;
                    }
                    break;
                  default:
                    "author" === a3.itemprop && (s2 = r.AuthorName);
                }
              }, "onopentag"), ontext: /* @__PURE__ */ __name(function(e3) {
                switch (s2) {
                  case r.TotalChapters:
                    o2.totalPages || (o2.totalPages = Math.ceil(parseInt(e3, 10) / 100));
                    break;
                  case r.Status:
                    o2.status = e3.trim();
                    break;
                  case r.NovelName:
                    o2.name = (o2.name || "") + e3.trim();
                    break;
                  case r.AuthorName:
                    o2.author = e3;
                    break;
                ...
                switch (e3) {
                  case "strong":
                    s2 === r.TotalChapters ? s2 = r.HeaderStats : s2 === r.Status && (s2 = r.Idle);
                    break;
                  case "i":
                    s2 === r.Status && (s2 = r.Idle);
                    break;
                  case "h1":
                    s2 === r.NovelName && (s2 = r.Idle);
                    break;
                  case "span":
                    s2 === r.AuthorName && (s2 = r.Idle);
                    break;
                  case "div":
                    s2 !== r.Summary && s2 !== r.Genres || (s2 = r.Idle);
                    break;
                  case "a":
                    s2 === r.Tags && (s2 = r.Genres);
                    break;
                  case "figure":
                    s2 === r.Cover && (s2 = r.Idle);
                    break;
                  case "p":
                    s2 === r.Summary && i2.push("<PARAGRAPH_BREAK>");
                }
              }, "onclosetag"), onend: /* @__PURE__ */ __name(function() {
                var e3 = i2.join("").replace(/<PARAGRAPH_BREAK>/g, "\n\n").replace(/<LINE_BREAK>/g, "\n").replace(/\r\n/g, "\n").replace(/&nbsp;/g, " ").split("\n\n").map(function(e4) {
                  return e4.trim().replace(/[ \t]+/g, " ");
                }).filter(function(e4) {
                  return e4.length > 0;
                });
                o2.summary = e3.join("\n\n"), i2.length = 0, o2.genres = u.join(", ");
              }, "onend") }), c.write(e2), c.end(), [2, o2];
          }
        });
      });
    }, t2.prototype.parsePage = function(t3, o2) {
      return e(this, void 0, void 0, function() {
        var e2, i2, u, c, p, h;
        return a(this, function(a2) {
          switch (a2.label) {
            case 0:
              return e2 = this.site + t3 + "/chapters/page-" + o2, [4, (0, l.fetchApi)(e2).then(function(e3) {
                return e3.text();
              })];
            case 1:
              return i2 = a2.sent(), u = [], c = {}, p = r.Idle, h = new n.Parser({ onopentag: /* @__PURE__ */ __name(function(e3, a3) {
                var t4;
                if ("chapter-list" !== a3.class) switch (p) {
                  case r.ChapterList:
                    "li" === e3 && (p = r.ChapterItem, c = { chapterNumber: Number(a3["data-orderno"] || 0) });
                    break;
                  case r.ChapterItem:
                    switch (e3) {
                      case "a":
                        c.name = a3.title, c.path = null === (t4 = a3.href) || void 0 === t4 ? void 0 : t4.slice(1);
                        break;
                      case "time":
                        c.releaseTime = (0, s.default)(a3.datetime).toISOString();
                    }
                }
                else p = r.ChapterList;
              }, "onopentag"), onclosetag: /* @__PURE__ */ __name(function(e3) {
                switch (p) {
                  case r.ChapterItem:
                    "li" === e3 && (void 0 !== c.chapterNumber && c.path && c.releaseTime && u.push(c), p = r.ChapterList);
                    break;
                  case r.ChapterList:
                    "ul" === e3 && (p = r.Idle);
                }
              }, "onclosetag") }), h.write(i2), h.end(), [2, { chapters: u }];
          }
        });
      });
    }, t2.prototype.parseChapter = function(t3) {
      return e(this, void 0, void 0, function() {
        var e2, o2, s2, i2, u, c, p, h;
        return a(this, function(a2) {
          switch (a2.label) {
            case 0:
              return [4, (0, l.fetchApi)(this.site + t3).then(function(e3) {
            ...
            case 1:
              return e2 = a2.sent(), o2 = 0, s2 = r.Idle, i2 = [], u = /[&<>"']/g, c = { "&": "&amp;", "<": "&lt;", ">": "&gt;", '"': "&quot;", "'": "&#39;" }, p = /* @__PURE__ */ __name(function(e3) {
                return e3.replace(u, function(e4) {
                  return c[e4];
                });
              }, "p"), (h = new n.Parser({ onopentag: /* @__PURE__ */ __name(function(e3, a3) {
                switch (s2) {
                  case r.Idle:
                    "div" === e3 && "chapter-container" === a3.id && (s2 = r.Chapter, o2++);
                    break;
                  case r.Chapter:
                    "div" === e3 && o2++;
                    break;
                ...
                if (s2 === r.Chapter) {
                  var t4 = Object.keys(a3).map(function(e4) {
                    var t5 = a3[e4].replace(/"/g, "&quot;");
                    return " ".concat(e4, '="').concat(t5, '"');
                  });
                  i2.push("<".concat(e3).concat(t4.join(""), ">"));
                }
              }, "onopentag"), ontext: /* @__PURE__ */ __name(function(e3) {
                s2 === r.Chapter && i2.push(p(e3));
              }, "ontext"), onclosetag: /* @__PURE__ */ __name(function(e3) {
                s2 === r.Chapter && (h.isVoidElement(e3) || i2.push("</".concat(e3, ">")), "div" === e3 && o2--, 0 === o2 && (s2 = r.Stopped));
              }, "onclosetag") })).write(e2), h.end(), [2, i2.join("")];
          }
        });
      });
    }, t2.prototype.searchNovels = function(t3) {
      return e(this, void 0, void 0, function() {
        var e2, r2, o2, s2, i2, u, c;
        return a(this, function(a2) {
          switch (a2.label) {
            case 0:
              return e2 = "".concat(this.site, "lnsearchlive"), r2 = "".concat(this.site, "search"), [4, (0, l.fetchApi)(r2).then(function(e3) {
                return e3.text();
              })];
            case 1:
              return o2 = a2.sent(), s2 = "", i2 = new n.Parser({ onopentag: /* @__PURE__ */ __name(function(e3, a3) {
                var t4;
                "input" === e3 && (null === (t4 = a3.name) || void 0 === t4 ? void 0 : t4.includes("LNRequestVerifyToken")) && (s2 = a3.value);
              }, "onopentag") }), i2.write(o2), i2.end(), (u = new FormData()).append("inputContent", t3), [4, (0, l.fetchApi)(e2, { method: "POST", headers: { LNRequestVerifyToken: s2 }, body: u }).then(function(e3) {
                return e3.json();
              })];
            case 2:
              return c = a2.sent(), [2, this.parseNovels(c.resultview)];
          }
        });
      });
    }, t2;
  }();
  exports.default = new i(), function(e2) {
    e2[e2.Idle = 0] = "Idle", e2[e2.Novel = 1] = "Novel", e2[e2.HeaderStats = 2] = "HeaderStats", e2[e2.Status = 3] = "Status", e2[e2.Stopped = 4] = "Stopped", e2[e2.Chapter = 5] = "Chapter", e2[e2.ChapterItem = 6] = "ChapterItem", e2[e2.ChapterList = 7] = "ChapterList", e2[e2.TotalChapters = 8] = "TotalChapters", e2[e2.NovelName = 9] = "NovelName", e2[e2.AuthorName = 10] = "AuthorName", e2[e2.Summary = 11] = "Summary", e2[e2.Genres = 12] = "Genres", e2[e2.Tags = 13] = "Tags", e2[e2.Cover = 14] = "Cover";
  }(r || (r = {}));
})();
