...
(() => {
          ...
          switch (e2.label) {
            ...
            case 2:
              return t2 = e2.sent(), s = (0, r.load)(t2), (a = { path: o3, name: s("h1.story__identity-title").text() }).author = s("div.story__identity-meta").text().split("|")[0].replace("Author: ", "").replace("by ", "").trim(), a.cover = s("figure.story__thumbnail > a").attr("href"), a.genres = s("div.tag-group > a, section.tag-group > a").map((function(t3, e3) {
                ...
                var r2;
                return { name: s(e3).find("a").text(), path: null === (r2 = s(e3).find("a").attr("href")) || void 0 === r2 ? void 0 : r2.replace(c.site + "/", "").replace(/\/$/, "") };
              })).toArray(), "Ongoing" === (u = s("span.story__status").text().trim()) && (a.status = i.NovelStatus.Ongoing), "Completed" === u && (a.status = i.NovelStatus.Completed), "Cancelled" === u && (a.status = i.NovelStatus.Cancelled), "Hiatus" === u && (a.status = i.NovelStatus.OnHiatus), [2, a];
          }
        }));
      }));
  ...
  })())({ id: "penguinsquad", sourceSite: "https://penguin-squad.com", sourceName: "Penguin Squad", options: { browsePage: "novels" } });
  exports.default = o;
})();
