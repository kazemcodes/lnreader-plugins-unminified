...
var LNReaderPlugin = (() => {
  ...
  // .js/plugins/english/DearestRosalie[fictioneer].js
  init_dirname();
  init_buffer2();
  init_process2();
  ...
  var r = (init_browser(), __toCommonJS(browser_exports)), n = (init_fetch2(), __toCommonJS(fetch_exports)), i = (init_novelStatus(), __toCommonJS(novelStatus_exports)), o = function() {
    function o2(t2) {
      var e2;
    ...
    return o2.prototype.parseNovels = function(t2, e2) {
      ...
      return t2(e2).map(function(e3, n2) {
        var i2 = t2(n2), o3 = i2.find("h3 > a").text(), s2 = i2.find("a.cell-img:has(img)").attr("href"), a = i2.find("h3 > a").attr("href");
        if (a) return { name: o3, cover: s2, path: new URL(a, r2.site).pathname.substring(1) };
      }).toArray();
    }, o2.prototype.popularNovels = function(i2) {
      return t(this, void 0, void 0, function() {
        var t2, o3;
        return e(this, function(e2) {
          switch (e2.label) {
            case 0:
              return [4, (0, n.fetchApi)(this.site + "/" + this.options.browsePage + "/" + (1 === i2 ? "" : "page/" + i2 + "/"))];
            case 1:
              return [4, e2.sent().text()];
            case 2:
              return t2 = e2.sent(), o3 = (0, r.load)(t2), [2, this.parseNovels(o3, "#featured-list > li > div > div, #list-of-stories > li > div > div")];
          }
        });
      });
    }, o2.prototype.parseNovel = function(o3) {
      return t(this, void 0, void 0, function() {
        var t2, s2, a, u, c = this;
        return e(this, function(e2) {
          switch (e2.label) {
            case 0:
            ...
            case 1:
              return [4, e2.sent().text()];
            case 2:
              return t2 = e2.sent(), s2 = (0, r.load)(t2), (a = { path: o3, name: s2("h1.story__identity-title").text() }).author = s2("div.story__identity-meta").text().split("|")[0].replace("Author: ", "").replace("by ", "").trim(), a.cover = s2("figure.story__thumbnail > a").attr("href"), a.genres = s2("div.tag-group > a, section.tag-group > a").map(function(t3, e3) {
                return s2(e3).text();
              }).toArray().join(","), s2("section.story__summary .related-stories-block").remove(), a.summary = s2("section.story__summary").text(), a.chapters = s2("li.chapter-group__list-item._publish").filter(function(t3, e3) {
                return !e3.attribs.class.includes("_password");
              }).filter(function(t3, e3) {
                return !s2(e3).find("i").first().attr("class").includes("fa-lock");
              }).map(function(t3, e3) {
                var r2 = s2(e3).find("a").text(), n2 = s2(e3).find("a").attr("href");
                if (n2) return { name: r2, path: new URL(n2, c.site).pathname.substring(1) };
              }).toArray(), "Ongoing" === (u = s2("span.story__status").text().trim()) && (a.status = i.NovelStatus.Ongoing), "Completed" === u && (a.status = i.NovelStatus.Completed), "Cancelled" === u && (a.status = i.NovelStatus.Cancelled), "Hiatus" === u && (a.status = i.NovelStatus.OnHiatus), [2, a];
          }
        });
      });
        ...
        return e(this, function(e2) {
          switch (e2.label) {
            ...
            case 1:
              return [4, e2.sent().text()];
            case 2:
              return t2 = e2.sent(), s2 = (0, r.load)(t2), [2, this.parseNovels(s2, "#search-result-list > li > div > div")];
          }
        });
      });
    }, o2;
  }();
  exports.FictioneerPlugin = o;
  var s = new o({ id: "dearestrosalie", sourceSite: "https://dearestrosalie.com", sourceName: "Dearest Rosalie", options: { browsePage: "stories", down: true, downSince: 1768289212907 } });
  exports.default = s;
})();
