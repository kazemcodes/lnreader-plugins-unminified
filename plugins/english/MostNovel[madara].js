...
(() => {
  ...
  // .js/plugins/english/MostNovel[madara].js
      ...
      return function(s2) {
        return (function(o4) {
          ...
          for (; i2 && (i2 = 0, o4[0] && (r2 = 0)), r2; ) try {
            if (a2 = 1, n2 && (l2 = 2 & o4[0] ? n2.return : o4[0] ? n2.throw || ((l2 = n2.return) && l2.call(n2), 0) : n2.next) && !(l2 = l2.call(n2, o4[1])).done) return l2;
  ...
  var n = (init_fetch2(), __toCommonJS(fetch_exports)), l = (init_browser(), __toCommonJS(browser_exports)), r = (init_defaultCover(), __toCommonJS(defaultCover_exports)), i = (init_novelStatus(), __toCommonJS(novelStatus_exports)), o = a(require_dayjs_min()), s = (init_storage2(), __toCommonJS(storage_exports)), u = /* @__PURE__ */ __name(function(e2, t2) {
    return new RegExp(t2.join("|")).test(e2);
  }, "u"), c = new ((function() {
    function a2(e2) {
      var t2, a3;
      this.hideLocked = s.storage.get("hideLocked"), this.parseData = function(e3) {
        var t3, a4 = (0, o.default)(), n3 = (null === (t3 = e3.match(/\d+/)) || void 0 === t3 ? void 0 : t3[0]) || "", l2 = parseInt(n3, 10);
        if (!n3) return e3;
    ...
    return a2.prototype.translateDragontea = function(e2) {
      ...
      return e2.html(a3.html()), e2.find("*").addBack().contents().filter((function(e3, t3) {
        ...
        var n2 = a3(t3), l2 = n2.text().normalize("NFD").split("").map((function(e4) {
      ...
      return e(this, void 0, void 0, (function() {
        ...
        return t(this, (function(t2) {
          switch (t2.label) {
            ...
            case 1:
              if (!(e2 = t2.sent()).ok && 1 != r2) throw new Error("Could not reach site (" + e2.status + ") try to open in webview.");
      ...
      return e2(".manga-title-badges").remove(), e2(".page-item-detail, .c-tabs-item__content").each((function(a3, n2) {
        var l2 = e2(n2).find(".post-title").text().trim(), i2 = e2(n2).find(".post-title").find("a").attr("href") || "";
        if (l2 && i2) {
          var o2 = e2(n2).find("img"), s2 = { name: l2, cover: o2.attr("data-src") || o2.attr("src") || o2.attr("data-lazy-srcset") || r.defaultCover, path: i2.replace(/https?:\/\/.*?\//, "/") };
          t2.push(s2);
        }
      })), t2;
    }, a2.prototype.popularNovels = function(a3, n2) {
      return e(this, arguments, void 0, (function(e2, a4) {
        var n3, l2, r2, i2, o2, s2, u2 = a4.filters, c2 = a4.showLatestNovels;
        return t(this, (function(t2) {
          switch (t2.label) {
            case 0:
              for (l2 in n3 = this.site + "/page/" + e2 + "/?s=&post_type=wp-manga", u2 || (u2 = this.filters || {}), c2 && (n3 += "&m_orderby=latest"), u2) if ("object" == typeof u2[l2].value) for (r2 = 0, i2 = u2[l2].value; r2 < i2.length; r2++) o2 = i2[r2], n3 += "&".concat(l2, "=").concat(o2);
              else u2[l2].value && (n3 += "&".concat(l2, "=").concat(u2[l2].value));
      ...
      return e(this, void 0, void 0, (function() {
        var e2, s2, u2, c2, h, v, m, p, d = this;
        return t(this, (function(t2) {
          switch (t2.label) {
            case 0:
            ...
            case 1:
              return (e2 = t2.sent())(".manga-title-badges, #manga-title span").remove(), (s2 = { path: a3, name: e2(".post-title h1").text().trim() || e2("#manga-title h1").text().trim() || e2(".manga-title").text().trim() || "" }).cover = e2(".summary_image > a > img").attr("data-lazy-src") || e2(".summary_image > a > img").attr("data-src") || e2(".summary_image > a > img").attr("src") || r.defaultCover, e2(".post-content_item, .post-content").each((function() {
                ...
                return e2(a4).text();
              })).get().join("\n\n").trim(), u2 = [], c2 = "", (null === (p = this.options) || void 0 === p ? void 0 : p.useNewChapterEndpoint) ? [4, (0, n.fetchApi)(this.site + a3 + "ajax/chapters/", { method: "POST", referrer: this.site + a3 }).then((function(e3) {
                return e3.text();
              }))] : [3, 3];
            case 2:
              return c2 = t2.sent(), [3, 5];
            case 3:
              return h = e2(".rating-post-id").attr("value") || e2("#manga-chapters-holder").attr("data-id") || "", (v = new FormData()).append("action", "manga_get_chapters"), v.append("manga", h), [4, (0, n.fetchApi)(this.site + "wp-admin/admin-ajax.php", { method: "POST", body: v }).then((function(e3) {
                return e3.text();
              }))];
            case 4:
              c2 = t2.sent(), t2.label = 5;
            case 5:
              return "0" !== c2 && (e2 = (0, l.load)(c2)), m = e2(".wp-manga-chapter").length, e2(".wp-manga-chapter").each((function(t3, a4) {
                var n2 = e2(a4).find("a").text().trim(), l2 = a4.attribs.class.includes("premium-block");
                l2 && (n2 = "\u{1F512} " + n2);
                var r2 = e2(a4).find("span.chapter-release-date").text().trim();
                r2 = r2 ? d.parseData(r2) : (0, o.default)().format("LL");
                var i2 = e2(a4).find("a").attr("href") || "";
                !i2 || "#" == i2 || l2 && d.hideLocked || u2.push({ name: n2, path: i2.replace(/https?:\/\/.*?\//, "/"), releaseTime: r2 || null, chapterNumber: m - t3 });
        ...
        return t(this, (function(t2) {
          switch (t2.label) {
            case 0:
              return [4, this.getCheerio(this.site + a3, false)];
            case 1:
              return e2 = t2.sent(), n2 = e2(".text-left") || e2(".text-right") || e2(".entry-content") || e2(".c-blog-post > div > div:nth-child(2)"), null === (l2 = this.options) || void 0 === l2 || l2.customJs, [2, this.translateDragontea(n2).html() || ""];
          }
        }));
      }));
