...
var LNReaderPlugin = function () {
  ...
  var require_decode = __commonJS({
    "node_modules/entities/lib/decode.js": function node_modules_entities_lib_decodeJs(exports4) {
      ...
      var __importDefault2 = exports4 && exports4.__importDefault || function (mod2) {
  ...
  // .js/plugins/russian/authortoday.js
  init_dirname();
  init_buffer2();
  init_process2();
  ...
  var AuthorToday = /** @class */
  function () {
    function AuthorToday2() {
      var _this = this;
      this.id = "AT";
      ...
      this.filters = {
        ...
        genre: {
          ...
          options: [{
            ...
            label: "\u041F\u043E\u043F\u0430\u0434\u0430\u043D\u0446\u044B \u0432 \u043A\u043E\u0441\u043C\u043E\u0441",
            value: "popadantsy-v-kosmos"
          }, {
            label: "\u041F\u043E\u043F\u0430\u0434\u0430\u043D\u0446\u044B \u0432 \u043C\u0430\u0433\u0438\u0447\u0435\u0441\u043A\u0438\u0435 \u043C\u0438\u0440\u044B",
            value: "popadantsy-v-magicheskie-miry"
          }, {
            label: "\u041F\u043E\u043F\u0430\u0434\u0430\u043D\u0446\u044B \u0432\u043E \u0432\u0440\u0435\u043C\u0435\u043D\u0438",
            value: "popadantsy-vo-vremeni"
          }, {
            ...
            value: "fanfiction-erotika"
          }, {
            label: "\u042D\u0440\u043E\u0442\u0438\u0447\u0435\u0441\u043A\u043E\u0435 \u0444\u044D\u043D\u0442\u0435\u0437\u0438",
            value: "fantasy-erotika"
          }, {
            label: "\u042E\u043C\u043E\u0440",
            value: "humor"
          }, {
    ...
    __name(AuthorToday2, "AuthorToday");
    AuthorToday2.prototype.parseNovels = function (url) {
      return (0, fetch_1.fetchApi)(url, {
        ...
        var parser = new htmlparser2_1.Parser({
          onopentag: /* @__PURE__ */__name(function (name, attribs) {
            if (name === "a" && attribs["class"] === "work-row item-link item-content" && attribs["href"]) {
              tempNovel.path = attribs["href"].replace(/\D/g, "");
              isParsingNovel = true;
            }
            if (isParsingNovel && name === "h4" && attribs["class"] === "work-title") {
              isParsingName = true;
            }
            if (isParsingNovel && name === "img" && attribs["alt"] === "\u041E\u0431\u043B\u043E\u0436\u043A\u0430") {
    ...
    AuthorToday2.prototype.popularNovels = function (pageNo_1, _a) {
      return __awaiter(this, arguments, void 0, function (pageNo, _b) {
        ...
        return __generator(this, function (_k) {
          ...
          url += "?sorting=" + (showLatestNovels ? "recent" : ((_d = filters === null || filters === void 0 ? void 0 : filters.sort) === null || _d === void 0 ? void 0 : _d.value) || "popular");
          if ((_e = filters === null || filters === void 0 ? void 0 : filters.form) === null || _e === void 0 ? void 0 : _e.value) url += "&form=" + filters.form.value;
          if ((_f = filters === null || filters === void 0 ? void 0 : filters.state) === null || _f === void 0 ? void 0 : _f.value) url += "&state=" + filters.state.value;
          if ((_g = filters === null || filters === void 0 ? void 0 : filters.series) === null || _g === void 0 ? void 0 : _g.value) url += "&series=" + filters.series.value;
          if ((_h = filters === null || filters === void 0 ? void 0 : filters.access) === null || _h === void 0 ? void 0 : _h.value) url += "&access=" + filters.access.value;
          if ((_j = filters === null || filters === void 0 ? void 0 : filters.promo) === null || _j === void 0 ? void 0 : _j.value) url += "&promo=" + filters.promo.value;
          url += "&page=" + pageNo;
          return [2, this.parseNovels(url)];
        });
      });
    };
    AuthorToday2.prototype.parseNovel = function (workID) {
      return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              return [4, (0, fetch_1.fetchApi)(this.resolveUrl(workID, true), {
                headers: {
                  "User-Agent": this.userAgent
                }
              }).then(function (res) {
            ...
            case 1:
              ...
              parser = new htmlparser2_1.Parser({
                onopentag: /* @__PURE__ */__name(function (name, attribs) {
                  ...
                  if (name === "a" && attribs["href"] && attribs["href"].endsWith("/works")) {
                  ...
                  if (name === "label" && attribs["class"] && attribs["class"].includes("label")) {
                ...
                onclosetag: /* @__PURE__ */__name(function (name) {
                  ...
                  if (name === "div" && isParsingAuthor) {
                    isParsingAuthor = false;
                    novel.author = (_a2 = novel.author) === null || _a2 === void 0 ? void 0 : _a2.slice(0, -2);
                  }
    ...
    AuthorToday2.prototype.parseChapter = function (chapterPath) {
      return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_f) {
          switch (_f.label) {
            case 0:
              return [4, (0, fetch_1.fetchApi)(this.resolveUrl(chapterPath), {
                headers: {
                  "User-Agent": this.userAgent
                }
              }).then(function (res) {
            ...
            case 1:
              ...
              return [4, (0, fetch_1.fetchApi)(this.site + "/reader/" + workID + "/chapter?id=" + chapterID, {
                headers: {
                  "User-Agent": this.userAgent
                }
              })];
            case 2:
              chapter = _f.sent();
              return [4, chapter.json()];
            case 3:
              chapterJson = _f.sent();
              key = chapter.headers.get("reader-secret");
              if (!key) throw new Error("Failed to find the token\n" + chapterJson.messages);
    ...
    AuthorToday2.prototype.searchNovels = function (searchTerm_1) {
  ...
  function decrypt(encrypt, encryptedKey, userId) {
    ...
    var keyBytes = key.split("").map(function (_char7) {
      return _char7.charCodeAt(0);
    });
