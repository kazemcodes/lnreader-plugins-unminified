...
var LNReaderPlugin = (() => {
  ...
  // .js/plugins/multisrc/lightnovelwp/template.js
    ...
    (function() {
      ...
      LightNovelWPPlugin2.prototype.safeFecth = function(url, search) {
        return __awaiter(this, void 0, void 0, function() {
          var urlParts, protocol, sanitizedUri, r, data2, title;
          var _a, _b;
          return __generator(this, function(_c) {
            switch (_c.label) {
              ...
              case 2:
                data2 = _c.sent();
                title = (_b = (_a = data2.match(/<title>(.*?)<\/title>/)) === null || _a === void 0 ? void 0 : _a[1]) === null || _b === void 0 ? void 0 : _b.trim();
                if (this.getHostname(url) != this.getHostname(r.url) || title && (title == "Bot Verification" || title == "You are being redirected..." || title == "Un instant..." || title == "Just a moment..." || title == "Redirecting..."))
