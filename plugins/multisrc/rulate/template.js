...
var LNReaderPlugin = (() => {
  ...
  var RulatePlugin = (
    ...
    (function() {
      ...
      RulatePlugin2.prototype.popularNovels = function(pageNo_1, _a) {
              ...
              case 4:
                ...
                if (this.id === "rulate") {
                  loadedCheerio("table > tbody > tr.chapter_row").each(function(chapterIndex, element) {
                    ...
                    var releaseDate = (_a2 = loadedCheerio(element).find("td > span").attr("title")) === null || _a2 === void 0 ? void 0 : _a2.trim();
