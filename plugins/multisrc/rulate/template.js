...
(() => {
  ...
  // .js/plugins/multisrc/rulate/template.js
  ...
  var RulatePlugin = (
    /** @class */
    (function() {
      function RulatePlugin2(metadata) {
        this.parseDate = function(dateString) {
          ...
          var _a2 = dateString.split(" "), day = _a2[0], month = _a2[1], year = _a2[2], time = _a2[4];
      ...
      __name(RulatePlugin2, "RulatePlugin");
      RulatePlugin2.prototype.popularNovels = function(pageNo_1, _a2) {
          ...
          return __generator(this, function(_k) {
            switch (_k.label) {
              case 0:
                ...
                url += "&cat=" + (((_c = filters2 === null || filters2 === void 0 ? void 0 : filters2.cat) === null || _c === void 0 ? void 0 : _c.value) || "0");
                url += "&s_lang=" + (((_d = filters2 === null || filters2 === void 0 ? void 0 : filters2.s_lang) === null || _d === void 0 ? void 0 : _d.value) || "0");
                url += "&t_lang=" + (((_e = filters2 === null || filters2 === void 0 ? void 0 : filters2.t_lang) === null || _e === void 0 ? void 0 : _e.value) || "0");
                url += "&type=" + (((_f = filters2 === null || filters2 === void 0 ? void 0 : filters2.type) === null || _f === void 0 ? void 0 : _f.value) || "0");
                url += "&sort=" + (showLatestNovels ? "4" : ((_g = filters2 === null || filters2 === void 0 ? void 0 : filters2.sort) === null || _g === void 0 ? void 0 : _g.value) || "6");
                url += "&atmosphere=" + (((_h = filters2 === null || filters2 === void 0 ? void 0 : filters2.atmosphere) === null || _h === void 0 ? void 0 : _h.value) || "0");
                url += "&adult=" + (((_j = filters2 === null || filters2 === void 0 ? void 0 : filters2.adult) === null || _j === void 0 ? void 0 : _j.value) || "0");
                Object.entries(filters2 || {}).forEach(function(_a3) {
                  var type = _a3[0], value = _a3[1].value;
                  if (value instanceof Array && value.length) {
                    url += "&" + value.map(function(val2) {
                      return type == "extra" ? val2 + "=1" : type + "[]=" + val2;
                    }).join("&");
                  }
                });
              ...
              case 1:
                ...
                loadedCheerio('ul[class="search-results"] > li:not([class="ad_type_catalog"])').each(function(index2, element) {
                  ...
                  if (!name || !path)
                    return;
                  novels.push({ name, cover: _this.site + cover, path });
                });
                return [2, novels];
            }
          });
      ...
      RulatePlugin2.prototype.parseNovel = function(novelPath) {
        return __awaiter(this, void 0, void 0, function() {
          ...
          return __generator(this, function(_c) {
            switch (_c.label) {
              ...
              case 1:
                result = _c.sent();
                if (!result.url.includes("mature?path=")) return [3, 3];
                formData = new FormData();
                formData.append("path", novelPath);
                formData.append("ok", "\u0414\u0430");
                return [4, (0, fetch_1.fetchApi)(result.url, {
                  method: "POST",
                  body: formData
                })];
              case 2:
              ...
              case 4:
                ...
                if ((_b = (_a2 = novel.name) === null || _a2 === void 0 ? void 0 : _a2.includes) === null || _b === void 0 ? void 0 : _b.call(_a2, "[")) {
                  novel.name = novel.name.split("[")[0].trim();
                }
                novel.cover = this.site + loadedCheerio('div[class="images"] > div img, .book__cover > img').attr("src");
                novel.summary = loadedCheerio("#Info > div:nth-child(4) > p:nth-child(1), .book__description").text().trim();
                genres = [];
                loadedCheerio("div.span5 > p").each(function() {
                  switch (loadedCheerio(this).find("strong").text()) {
                    case "\u0410\u0432\u0442\u043E\u0440:":
                      ...
                      break;
                    case "\u0412\u044B\u043F\u0443\u0441\u043A:":
                      novel.status = loadedCheerio(this).find("em").text().trim() === "\u043F\u0440\u043E\u0434\u043E\u043B\u0436\u0430\u0435\u0442\u0441\u044F" ? novelStatus_1.NovelStatus.Ongoing : novelStatus_1.NovelStatus.Completed;
                      break;
                    case "\u0422\u044D\u0433\u0438:":
                      loadedCheerio(this).find("em > a").each(function() {
                ...
                if (this.id === "rulate") {
                  loadedCheerio("table > tbody > tr.chapter_row").each(function(chapterIndex, element) {
                    ...
                    var releaseDate = (_a3 = loadedCheerio(element).find("td > span").attr("title")) === null || _a3 === void 0 ? void 0 : _a3.trim();
                    var chapterUrl = loadedCheerio(element).find('td[class="t"] > a').attr("href");
                    if (!loadedCheerio(element).find('td > span[class="disabled"]').length && releaseDate && chapterUrl) {
                      chapters.push({
                        name: chapterName,
                        path: chapterUrl,
                  ...
                  loadedCheerio("a.chapter").each(function(chapterIndex, element) {
                    var chapterName = loadedCheerio(element).find("div:nth-child(1) > span:nth-child(2)").text().trim();
      ...
      RulatePlugin2.prototype.parseChapter = function(chapterPath) {
        return __awaiter(this, void 0, void 0, function() {
      ...
      RulatePlugin2.prototype.searchNovels = function(searchTerm) {
        return __awaiter(this, void 0, void 0, function() {
          var novels, result;
          var _this = this;
          return __generator(this, function(_a2) {
            switch (_a2.label) {
              case 0:
                novels = [];
                return [4, (0, fetch_1.fetchApi)(this.site + "/search/autocomplete?query=" + encodeURIComponent(searchTerm)).then(function(res) {
                  return res.json();
                })];
              case 1:
                result = _a2.sent();
