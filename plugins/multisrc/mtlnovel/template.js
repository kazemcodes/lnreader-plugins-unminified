...
(() => {
  ...
  // .js/plugins/multisrc/mtlnovel/template.js
  ...
  var MTLNovelPlugin = (
    /** @class */
    (function() {
      function MTLNovelPlugin2(metadata) {
        var _a2;
        ...
        this.version = "1.1.3";
        this.options = (_a2 = metadata.options) !== null && _a2 !== void 0 ? _a2 : {};
        this.filters = metadata.filters;
      }
      __name(MTLNovelPlugin2, "MTLNovelPlugin");
      MTLNovelPlugin2.prototype.safeFecth = function(url_1) {
          ...
          return __generator(this, function(_a2) {
            switch (_a2.label) {
              case 0:
                ...
                return [4, (0, fetch_1.fetchApi)(url, { headers })];
              case 1:
                r = _a2.sent();
                if (!r.ok)
      ...
      MTLNovelPlugin2.prototype.popularNovels = function(page_1, _a2) {
          ...
          return __generator(this, function(_c) {
            switch (_c.label) {
              case 0:
                ...
                if (filters2) {
                  link += "orderby=".concat(filters2.order.value);
                  link += "&order=".concat(filters2.sort.value);
                  link += "&status=".concat(filters2.storyStatus.value);
                }
                if (showLatestNovels)
                  link += "&m_orderby=date";
                link += "&pg=".concat(page);
                return [4, this.safeFecth(link).then(function(r) {
                  return r.text();
                })];
              case 1:
                body = _c.sent();
                ...
                loadedCheerio("div.box.wide").each(function(i, el) {
                  ...
                  if (!novelCover || novelCover == "https://www.mtlnovel.net/no-image.jpg.webp")
      ...
      MTLNovelPlugin2.prototype.parseNovel = function(novelPath) {
        return __awaiter(this, void 0, void 0, function() {
          var headers, body, loadedCheerio, novel, chapterListUrl, getChapters, _a2, genresArray;
          var _this = this;
          return __generator(this, function(_b) {
            switch (_b.label) {
              case 0:
                ...
                return [4, this.safeFecth(this.site + novelPath, headers).then(function(r) {
                  return r.text();
                })];
              case 1:
                body = _b.sent();
                ...
                getChapters = /* @__PURE__ */ __name(function() {
                  return __awaiter(_this, void 0, void 0, function() {
                    ...
                    return __generator(this, function(_a3) {
                      switch (_a3.label) {
                        case 0:
                          return [4, this.safeFecth(chapterListUrl, headers).then(function(r) {
                            return r.text();
                          })];
                        case 1:
                          listBody = _a3.sent();
                          ...
                          chapter = [];
                          loadedCheerio("div.ch-list").find("a.ch-link").each(function(i, el) {
                            ...
                            if (!chapterUrl)
                              return;
                            chapter.push({
                              path: chapterUrl.replace(_this2.mainUrl, "").replace(_this2.site, ""),
                              name: chapterName,
                              releaseTime: releaseDate
                            });
                          });
                          return [2, chapter.reverse()];
                      }
                    });
                  });
                }, "getChapters");
                _a2 = novel;
                return [4, getChapters()];
              case 2:
                _a2.chapters = _b.sent();
                if (novel.genres) {
      ...
      MTLNovelPlugin2.prototype.parseChapter = function(chapterPath) {
        return __awaiter(this, void 0, void 0, function() {
          var body, loadedCheerio, chapterText;
          return __generator(this, function(_a2) {
            switch (_a2.label) {
              case 0:
                return [4, this.safeFecth(this.site + chapterPath).then(function(r) {
                  return r.text();
                })];
              case 1:
                body = _a2.sent();
      ...
      MTLNovelPlugin2.prototype.searchNovels = function(searchTerm, pageNo) {
        return __awaiter(this, void 0, void 0, function() {
          ...
          return __generator(this, function(_a2) {
            switch (_a2.label) {
              case 0:
                if (pageNo !== 1)
                  return [2, []];
                searchUrl = this.site + "wp-admin/admin-ajax.php?action=autosuggest&q=" + encodeURIComponent(searchTerm);
                return [4, this.safeFecth(searchUrl)];
              case 1:
                res = _a2.sent();
                return [4, res.json()];
              case 2:
                ...
                result.items[0].results.map(function(item) {
                  ...
                  var novelUrl = item.permalink.replace(_this.mainUrl, "").replace(_this.site, "");
