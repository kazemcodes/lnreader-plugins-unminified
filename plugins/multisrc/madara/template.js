...
(() => {
  ...
  var init_esm7 = __esm({
    "node_modules/css-select/lib/esm/index.js"() {
      ...
      init_subselects();
      init_pseudo_selectors();
      defaultEquals = /* @__PURE__ */ __name((a, b) => a === b, "defaultEquals");
      defaultOptions = {
      ...
      !(function(t, e) {
        ...
        var _ = (function() {
          ...
          return m2.parse = function(t2) {
            ...
            var d2, l2 = this;
            r2 = Number(r2);
            var $3 = b.p(f2), y2 = /* @__PURE__ */ __name(function(t2) {
              var e2 = O(l2);
            ...
            var $3, y2 = this, M3 = b.p(d2), m3 = O(r2), v2 = (m3.utcOffset() - this.utcOffset()) * e, g2 = this - m3, D2 = /* @__PURE__ */ __name(function() {
              return b.m(y2, m3);
            }, "D");
            switch (M3) {
              case h:
  ...
  // .js/plugins/multisrc/madara/template.js
  ...
  var __importDefault = function(mod2) {
  ...
  var includesAny = /* @__PURE__ */ __name(function(str, keywords) {
    return new RegExp(keywords.join("|")).test(str);
  }, "includesAny");
  var MadaraPlugin = (
    /** @class */
    (function() {
      function MadaraPlugin2(metadata) {
        var _a2, _b;
        this.hideLocked = storage_1.storage.get("hideLocked");
        this.parseData = function(date) {
          var _a3;
          var dayJSDate = (0, dayjs_1.default)();
          var timeAgo = ((_a3 = date.match(/\d+/)) === null || _a3 === void 0 ? void 0 : _a3[0]) || "";
          ...
          } else if (includesAny(date, ["year", "a\xF1o"])) {
        ...
        var versionIncrements = ((_a2 = metadata.options) === null || _a2 === void 0 ? void 0 : _a2.versionIncrements) || 0;
      ...
      __name(MadaraPlugin2, "MadaraPlugin");
      MadaraPlugin2.prototype.translateDragontea = function(text3) {
        var _a2;
        if (this.id !== "dragontea")
          return text3;
        var $2 = (0, cheerio_1.load)(((_a2 = text3.html()) === null || _a2 === void 0 ? void 0 : _a2.replace("\n", "").replace(/<br\s*\/?>/g, "\n")) || "");
        ...
        text3.html($2.html());
        text3.find("*").addBack().contents().filter(function(_, el) {
          return el.nodeType === 3;
        }).each(function(_, el) {
          var $el = $2(el);
          var translated = $el.text().normalize("NFD").split("").map(function(char) {
      ...
      MadaraPlugin2.prototype.getHostname = function(url) {
        url = url.split("/")[2];
        var url_parts = url.split(".");
        url_parts.pop();
        return url_parts.join(".");
      };
      MadaraPlugin2.prototype.getCheerio = function(url, search) {
          ...
          return __generator(this, function(_b) {
            switch (_b.label) {
              ...
              case 1:
                ...
                return [4, r.text()];
              case 2:
                $2 = _a2.apply(void 0, [_b.sent()]);
                title = $2("title").text().trim();
                if (this.getHostname(url) != this.getHostname(r.url) || title == "Bot Verification" || title == "You are being redirected..." || title == "Un instant..." || title == "Just a moment..." || title == "Redirecting...")
      ...
      MadaraPlugin2.prototype.parseNovels = function(loadedCheerio) {
        var novels = [];
        loadedCheerio(".manga-title-badges").remove();
        loadedCheerio(".page-item-detail, .c-tabs-item__content").each(function(index2, element) {
          var novelName = loadedCheerio(element).find(".post-title").text().trim();
          ...
          var novelCover = image.attr("data-src") || image.attr("src") || image.attr("data-lazy-srcset") || defaultCover_1.defaultCover;
          var novel = {
            name: novelName,
            cover: novelCover,
      ...
      MadaraPlugin2.prototype.popularNovels = function(pageNo_1, _a2) {
        return __awaiter(this, arguments, void 0, function(pageNo, _b) {
          var url, key, _i, _c, value, loadedCheerio;
          var filters2 = _b.filters, showLatestNovels = _b.showLatestNovels;
          return __generator(this, function(_d) {
            switch (_d.label) {
              case 0:
                url = this.site + "/page/" + pageNo + "/?s=&post_type=wp-manga";
                if (!filters2)
                  filters2 = this.filters || {};
                if (showLatestNovels)
                  url += "&m_orderby=latest";
                for (key in filters2) {
                  if (typeof filters2[key].value === "object")
                    for (_i = 0, _c = filters2[key].value; _i < _c.length; _i++) {
                      value = _c[_i];
                      url += "&".concat(key, "=").concat(value);
                    }
                  else if (filters2[key].value)
                    url += "&".concat(key, "=").concat(filters2[key].value);
                }
                return [4, this.getCheerio(url, pageNo != 1)];
              case 1:
                loadedCheerio = _d.sent();
                return [2, this.parseNovels(loadedCheerio)];
            }
          });
        });
      };
      MadaraPlugin2.prototype.parseNovel = function(novelPath) {
        return __awaiter(this, void 0, void 0, function() {
          var loadedCheerio, novel, chapters, html3, novelId, formData, totalChapters;
          var _this = this;
          var _a2;
          return __generator(this, function(_b) {
            switch (_b.label) {
              case 0:
                return [4, this.getCheerio(this.site + novelPath, false)];
              case 1:
                loadedCheerio = _b.sent();
                loadedCheerio(".manga-title-badges, #manga-title span").remove();
                novel = {
                  path: novelPath,
                  name: loadedCheerio(".post-title h1").text().trim() || loadedCheerio("#manga-title h1").text().trim() || loadedCheerio(".manga-title").text().trim() || ""
                };
                novel.cover = loadedCheerio(".summary_image > a > img").attr("data-lazy-src") || loadedCheerio(".summary_image > a > img").attr("data-src") || loadedCheerio(".summary_image > a > img").attr("src") || defaultCover_1.defaultCover;
                loadedCheerio(".post-content_item, .post-content").each(function() {
                  var detailName = loadedCheerio(this).find("h5").text().trim();
                  var detail = loadedCheerio(this).find(".summary-content") || loadedCheerio(this).find(".summary_content");
                  switch (detailName) {
                    case "Genre(s)":
                    case "Genre":
                    case "Tags(s)":
                    ...
                    case "\u0627\u0644\u062A\u0635\u0646\u064A\u0641\u0627\u062A":
                      if (novel.genres)
                        novel.genres += ", " + detail.find("a").map(function(i, el) {
                          return loadedCheerio(el).text();
                        }).get().join(", ");
                      else
                        novel.genres = detail.find("a").map(function(i, el) {
                          return loadedCheerio(el).text();
                    ...
                    case "Estado":
                    case "Durum":
                      novel.status = detail.text().trim().includes("OnGoing") || detail.text().trim().includes("\u0645\u0633\u062A\u0645\u0631\u0629") ? novelStatus_1.NovelStatus.Ongoing : novelStatus_1.NovelStatus.Completed;
                      break;
                    case "Artist(s)":
                ...
                });
                {
                  ...
                  if (!novel.status)
                    novel.status = loadedCheerio(".manga-status").text().trim().includes("OnGoing") ? novelStatus_1.NovelStatus.Ongoing : novelStatus_1.NovelStatus.Completed;
                  if (!novel.author)
                ...
                novel.summary = this.translateDragontea(loadedCheerio("div.summary__content")).text().trim() || loadedCheerio("#tab-manga-about").text().trim() || loadedCheerio('.post-content_item h5:contains("Summary")').next().find("span").map(function(i, el) {
                  return loadedCheerio(el).text();
                }).get().join("\n\n").trim() || loadedCheerio(".manga-summary p").map(function(i, el) {
                  return loadedCheerio(el).text();
                }).get().join("\n\n").trim() || loadedCheerio(".manga-excerpt p").map(function(i, el) {
                  return loadedCheerio(el).text();
                }).get().join("\n\n").trim();
                chapters = [];
                html3 = "";
                if (!((_a2 = this.options) === null || _a2 === void 0 ? void 0 : _a2.useNewChapterEndpoint)) return [3, 3];
                return [4, (0, fetch_1.fetchApi)(this.site + novelPath + "ajax/chapters/", {
                  method: "POST",
              ...
              case 2:
                ...
                return [3, 5];
              case 3:
                novelId = loadedCheerio(".rating-post-id").attr("value") || loadedCheerio("#manga-chapters-holder").attr("data-id") || "";
                formData = new FormData();
                formData.append("action", "manga_get_chapters");
                formData.append("manga", novelId);
                return [4, (0, fetch_1.fetchApi)(this.site + "wp-admin/admin-ajax.php", {
                  method: "POST",
                  body: formData
                }).then(function(res) {
                  return res.text();
              ...
              case 5:
                if (html3 !== "0") {
                  loadedCheerio = (0, cheerio_1.load)(html3);
                }
                ...
                loadedCheerio(".wp-manga-chapter").each(function(chapterIndex, element) {
                  ...
                  if (locked) {
                    chapterName = "\u{1F512} " + chapterName;
                  }
                  var releaseDate = loadedCheerio(element).find("span.chapter-release-date").text().trim();
                  if (releaseDate) {
      ...
      MadaraPlugin2.prototype.parseChapter = function(chapterPath) {
        return __awaiter(this, void 0, void 0, function() {
          ...
          return __generator(this, function(_b) {
            switch (_b.label) {
              case 0:
                return [4, this.getCheerio(this.site + chapterPath, false)];
              case 1:
                loadedCheerio = _b.sent();
                chapterText = loadedCheerio(".text-left") || loadedCheerio(".text-right") || loadedCheerio(".entry-content") || loadedCheerio(".c-blog-post > div > div:nth-child(2)");
                if ((_a2 = this.options) === null || _a2 === void 0 ? void 0 : _a2.customJs) {
                  try {
                  } catch (error) {
                ...
                return [2, this.translateDragontea(chapterText).html() || ""];
            }
          });
        });
      };
      MadaraPlugin2.prototype.searchNovels = function(searchTerm, pageNo) {
        return __awaiter(this, void 0, void 0, function() {
          var url, loadedCheerio;
          return __generator(this, function(_a2) {
            switch (_a2.label) {
              case 0:
                url = this.site + "/page/" + pageNo + "/?s=" + encodeURIComponent(searchTerm) + "&post_type=wp-manga";
                return [4, this.getCheerio(url, true)];
              case 1:
                loadedCheerio = _a2.sent();
                return [2, this.parseNovels(loadedCheerio)];
            }
          });
        });
      };
      return MadaraPlugin2;
    })()
  );
})();
