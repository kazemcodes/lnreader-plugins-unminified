...
var LNReaderPlugin = (() => {
  ...
  var require_filters = __commonJS({
    "node_modules/css-select/lib/pseudo-selectors/filters.js"(exports2) {
      ...
      var nth_check_1 = __importDefault2(require_lib6());
      var boolbase_1 = __importDefault2(require_boolbase());
    ...
    (function() {
      function MadaraPlugin2(metadata) {
        ...
        this.parseData = function(date) {
          ...
          var timeAgo = ((_a2 = date.match(/\d+/)) === null || _a2 === void 0 ? void 0 : _a2[0]) || "";
      ...
      MadaraPlugin2.prototype.translateDragontea = function(text3) {
        ...
        if (this.id !== "dragontea")
          return text3;
        var $2 = (0, cheerio_1.load)(((_a = text3.html()) === null || _a === void 0 ? void 0 : _a.replace("\n", "").replace(/<br\s*\/?>/g, "\n")) || "");
      ...
      MadaraPlugin2.prototype.popularNovels = function(pageNo_1, _a) {
          ...
          return __generator(this, function(_b) {
            switch (_b.label) {
              ...
              case 1:
                ...
                chapters = [];
                html3 = "";
                if (!((_a = this.options) === null || _a === void 0 ? void 0 : _a.useNewChapterEndpoint)) return [3, 3];
