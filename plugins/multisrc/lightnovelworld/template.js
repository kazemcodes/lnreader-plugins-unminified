...
(() => {
  ...
  // .js/plugins/multisrc/lightnovelworld/template.js
  ...
  var LightNovelWorld = (
    /** @class */
    (function() {
      function LightNovelWorld2(metadata) {
        var _a2;
        this.headers = {
      ...
      __name(LightNovelWorld2, "LightNovelWorld");
      LightNovelWorld2.prototype.popularNovels = function(page_1, _a2) {
        return __awaiter(this, arguments, void 0, function(page, _b) {
          var link, body, loadedCheerio, novels;
          var filters2 = _b.filters;
          return __generator(this, function(_c) {
            switch (_c.label) {
              case 0:
                link = "".concat(this.site, "browse/");
                link += "".concat(filters2.genres.value, "/");
                link += "".concat(filters2.order.value, "/");
                link += "".concat(filters2.status.value, "/");
                link += page;
              ...
              case 1:
                ...
                loadedCheerio(".novel-item").each(function(idx, ele) {
                  ...
                  var novelUrl = (_a3 = loadedCheerio(ele).find(".novel-title > a").attr("href")) === null || _a3 === void 0 ? void 0 : _a3.substring(1);
                  if (!novelUrl)
                    return;
                  var novel = {
                    name: novelName,
      ...
      LightNovelWorld2.prototype.parseNovel = function(novelPath) {
          ...
          return __generator(this, function(_a2) {
            switch (_a2.label) {
              ...
              case 1:
                ...
                novel.genres = loadedCheerio(".categories ul li").map(function(a, ex) {
                  return loadedCheerio(ex).text().trim();
                }).toArray().join(",");
                return [2, novel];
            }
          });
      ...
      LightNovelWorld2.prototype.parsePage = function(novelPath, page) {
        return __awaiter(this, void 0, void 0, function() {
            ...
            switch (_a2.label) {
              ...
              case 1:
                ...
                loadedCheerio(".chapter-list li").each(function() {
                  var _a3;
                  var chapterName = "Chapter " + loadedCheerio(this).find(".chapter-no").text().trim() + " - " + loadedCheerio(this).find(".chapter-title").text().trim();
                  var releaseDate = loadedCheerio(this).find(".chapter-update").attr("datetime");
                  var chapterUrl = (_a3 = loadedCheerio(this).find("a").attr("href")) === null || _a3 === void 0 ? void 0 : _a3.substring(1);
                  if (!chapterUrl)
                    return;
                  chapter.push({
                    name: chapterName,
      ...
      LightNovelWorld2.prototype.parseChapter = function(chapterPath) {
        return __awaiter(this, void 0, void 0, function() {
      ...
      LightNovelWorld2.prototype.searchNovels = function(searchTerm) {
        return __awaiter(this, void 0, void 0, function() {
            ...
            switch (_a2.label) {
              ...
              case 2:
                ...
                loadedCheerio(".novel-item").each(function(idx, ele) {
                  ...
                  var novelUrl = (_a3 = loadedCheerio(ele).find("a").attr("href")) === null || _a3 === void 0 ? void 0 : _a3.substring(1);
                  if (!novelUrl)
                    return;
                  novels.push({
                    name: novelName,
