...
(() => {
  ...
  // .js/plugins/multisrc/fictioneer/template.js
  ...
  var FictioneerPlugin = (
    /** @class */
    (function() {
      function FictioneerPlugin2(metadata) {
        var _this = this;
        var _a2;
        this.filters = void 0;
      ...
      __name(FictioneerPlugin2, "FictioneerPlugin");
      FictioneerPlugin2.prototype.popularNovels = function(pageNo_1, _a2) {
        return __awaiter(this, arguments, void 0, function(pageNo, _b) {
          var req, body, loadedCheerio;
          var _this = this;
          var showLatestNovels = _b.showLatestNovels, filters2 = _b.filters;
          return __generator(this, function(_c) {
            switch (_c.label) {
              case 0:
                return [4, (0, fetch_1.fetchApi)(this.site + "/" + this.options.browsePage + "/" + (pageNo === 1 ? "" : "page/" + pageNo + "/"))];
              case 1:
                req = _c.sent();
                return [4, req.text()];
              case 2:
                ...
                return [2, loadedCheerio("#featured-list > li > div > div, #list-of-stories > li > div > div").map(function(i, el) {
                  var novelName = loadedCheerio(el).find("h3 > a").text();
                  var novelCover = loadedCheerio(el).find("a.cell-img:has(img)").attr("href");
      ...
      FictioneerPlugin2.prototype.parseNovel = function(novelPath) {
          ...
          return __generator(this, function(_a2) {
            switch (_a2.label) {
              ...
              case 2:
                ...
                novel.author = loadedCheerio("div.story__identity-meta").text().split("|")[0].replace("Author: ", "").replace("by ", "").trim();
                novel.cover = loadedCheerio("figure.story__thumbnail > a").attr("href");
                novel.genres = loadedCheerio("div.tag-group > a, section.tag-group > a").map(function(i, el) {
                  return loadedCheerio(el).text();
                }).toArray().join(",");
                novel.summary = loadedCheerio("section.story__summary").text();
                novel.chapters = loadedCheerio("li.chapter-group__list-item._publish").filter(function(i, el) {
                  return !el.attribs["class"].includes("_password");
                }).filter(function(i, el) {
                  return !loadedCheerio(el).find("i").first().attr("class").includes("fa-lock");
                }).map(function(i, el) {
                  var _a3;
                  var chapterName = loadedCheerio(el).find("a").text();
                  var chapterUrl = (_a3 = loadedCheerio(el).find("a").attr("href")) === null || _a3 === void 0 ? void 0 : _a3.replace(_this.site + "/", "").replace(/\/$/, "");
                  return {
                    name: chapterName,
                    path: chapterUrl
                  };
      ...
      FictioneerPlugin2.prototype.parseChapter = function(chapterPath) {
        return __awaiter(this, void 0, void 0, function() {
          var req, body, loadedCheerio;
          return __generator(this, function(_a2) {
            switch (_a2.label) {
              ...
              case 2:
                body = _a2.sent();
                loadedCheerio = (0, cheerio_1.load)(body);
                return [2, loadedCheerio("section#chapter-content > div").html() || ""];
            }
          });
        });
      };
      FictioneerPlugin2.prototype.searchNovels = function(searchTerm, pageNo) {
        return __awaiter(this, void 0, void 0, function() {
          var req, body, loadedCheerio;
          var _this = this;
          return __generator(this, function(_a2) {
            switch (_a2.label) {
              case 0:
                return [4, (0, fetch_1.fetchApi)(this.site + "/".concat(pageNo === 1 ? "" : "page/" + pageNo + "/", "?s=").concat(encodeURIComponent(searchTerm), "&post_type=fcn_story"))];
              case 1:
                req = _a2.sent();
                return [4, req.text()];
              case 2:
                body = _a2.sent();
                loadedCheerio = (0, cheerio_1.load)(body);
                return [2, loadedCheerio("#search-result-list > li > div > div").map(function(i, el) {
                  var novelName = loadedCheerio(el).find("h3 > a").text();
                  var novelCover = loadedCheerio(el).find("a.cell-img:has(img)").attr("href");
                  var novelUrl = loadedCheerio(el).find("h3 > a").attr("href");
                  return {
