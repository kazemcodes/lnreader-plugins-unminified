...
(() => {
  ...
  // .js/plugins/multisrc/readwn/template.js
  ...
  var ReadwnPlugin = (
    /** @class */
    (function() {
      function ReadwnPlugin2(metadata) {
        var _a2;
        this.id = metadata.id;
      ...
      __name(ReadwnPlugin2, "ReadwnPlugin");
      ReadwnPlugin2.prototype.popularNovels = function(pageNo_1, _a2) {
        return __awaiter(this, arguments, void 0, function(pageNo, _b) {
          ...
          return __generator(this, function(_g) {
            switch (_g.label) {
              case 0:
                url = this.site + "/list/";
                url += (((_c = filters2 === null || filters2 === void 0 ? void 0 : filters2.genres) === null || _c === void 0 ? void 0 : _c.value) || "all") + "/";
                url += (((_d = filters2 === null || filters2 === void 0 ? void 0 : filters2.status) === null || _d === void 0 ? void 0 : _d.value) || "all") + "-";
                url += showLatestNovels ? "lastdotime" : ((_e = filters2 === null || filters2 === void 0 ? void 0 : filters2.sort) === null || _e === void 0 ? void 0 : _e.value) || "newstime";
                url += "-" + (pageNo - 1) + ".html";
                if ((_f = filters2 === null || filters2 === void 0 ? void 0 : filters2.tags) === null || _f === void 0 ? void 0 : _f.value) {
                  url = this.site + "/tags/" + filters2.tags.value + "-0.html";
                }
              ...
              case 1:
                ...
                novels = loadedCheerio("li.novel-item").map(function(index2, element) {
                  return {
                    name: loadedCheerio(element).find("h4").text() || "",
                    cover: _this.site + loadedCheerio(element).find(".novel-cover > img").attr("data-src"),
                    path: loadedCheerio(element).find("a").attr("href") || ""
                  };
                }).get().filter(function(novel) {
                  return novel.name && novel.path;
                });
                return [2, novels];
            }
          });
      ...
      ReadwnPlugin2.prototype.parseNovel = function(novelPath) {
        return __awaiter(this, void 0, void 0, function() {
          ...
          return __generator(this, function(_b) {
            switch (_b.label) {
              case 0:
                return [4, (0, fetch_1.fetchApi)(this.site + novelPath).then(function(res) {
                  return res.text();
                })];
              case 1:
                body = _b.sent();
                ...
                novel.summary = loadedCheerio(".summary").text().replace("Summary", "").trim();
                novel.genres = loadedCheerio("div.categories > ul > li").map(function(index2, element) {
                  var _a3;
                  return (_a3 = loadedCheerio(element).text()) === null || _a3 === void 0 ? void 0 : _a3.trim();
                }).get().join(",");
                loadedCheerio("div.header-stats > span").each(function() {
                  if (loadedCheerio(this).find("small").text() === "Status") {
                    novel.status = loadedCheerio(this).find("strong").text() === "Ongoing" ? novelStatus_1.NovelStatus.Ongoing : novelStatus_1.NovelStatus.Completed;
                  }
                });
                latestChapterNo = parseInt(loadedCheerio(".header-stats").find("span > strong").first().text().trim());
                chapters = loadedCheerio(".chapter-list li").map(function(chapterIndex, element) {
                  var _a3, _b2, _c;
                  var name = loadedCheerio(element).find("a .chapter-title").text().trim();
                  var path = (_a3 = loadedCheerio(element).find("a").attr("href")) === null || _a3 === void 0 ? void 0 : _a3.trim();
                  if (!name || !path)
                    return null;
                  var releaseTime = loadedCheerio(element).find("a .chapter-update").text().trim();
                  if ((_b2 = releaseTime === null || releaseTime === void 0 ? void 0 : releaseTime.includes) === null || _b2 === void 0 ? void 0 : _b2.call(releaseTime, "ago")) {
                    ...
                    if (timeAgoInt) {
                      ...
                      if (releaseTime.includes("hours ago") || releaseTime.includes("hour ago")) {
                        dayJSDate.subtract(timeAgoInt, "hours");
                      }
                      if (releaseTime.includes("days ago") || releaseTime.includes("day ago")) {
                        dayJSDate.subtract(timeAgoInt, "days");
                      }
                      if (releaseTime.includes("months ago") || releaseTime.includes("month ago")) {
                        dayJSDate.subtract(timeAgoInt, "months");
                      }
                ...
                }).get().filter(function(chapter) {
                  return chapter;
                });
                if (latestChapterNo > chapters.length) {
                  lastChapterNo = parseInt(((_a2 = chapters[chapters.length - 1].path.match(/_(\d+)\.html/)) === null || _a2 === void 0 ? void 0 : _a2[1]) || "", 10);
      ...
      ReadwnPlugin2.prototype.parseChapter = function(chapterPath) {
        return __awaiter(this, void 0, void 0, function() {
          var body, loadedCheerio, chapterText;
          return __generator(this, function(_a2) {
            switch (_a2.label) {
              case 0:
                return [4, (0, fetch_1.fetchApi)(this.site + chapterPath).then(function(res) {
                  return res.text();
                })];
              case 1:
                body = _a2.sent();
      ...
      ReadwnPlugin2.prototype.searchNovels = function(searchTerm) {
        return __awaiter(this, void 0, void 0, function() {
          ...
          return __generator(this, function(_a2) {
            switch (_a2.label) {
              case 0:
                return [4, (0, fetch_1.fetchApi)(this.site + "/e/search/index.php", {
                  headers: {
