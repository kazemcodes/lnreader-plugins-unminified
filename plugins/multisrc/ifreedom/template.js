...
(() => {
  ...
  // .js/plugins/multisrc/ifreedom/template.js
  ...
  var IfreedomPlugin = (
    /** @class */
    (function() {
      function IfreedomPlugin2(metadata) {
        this.parseDate = function(dateString) {
          ...
          if (dateString.includes(".")) {
            var _a2 = dateString.split("."), day = _a2[0], month = _a2[1], year = _a2[2];
            if (day && month && year) {
      ...
      __name(IfreedomPlugin2, "IfreedomPlugin");
      IfreedomPlugin2.prototype.popularNovels = function(page_1, _a2) {
        return __awaiter(this, arguments, void 0, function(page, _b) {
          ...
          return __generator(this, function(_d) {
            switch (_d.label) {
              case 0:
                url = this.site + "/vse-knigi/?sort=" + (showLatestNovels ? "\u041F\u043E \u0434\u0430\u0442\u0435 \u043E\u0431\u043D\u043E\u0432\u043B\u0435\u043D\u0438\u044F" : ((_c = filters2 === null || filters2 === void 0 ? void 0 : filters2.sort) === null || _c === void 0 ? void 0 : _c.value) || "\u041F\u043E \u0440\u0435\u0439\u0442\u0438\u043D\u0433\u0443");
              ...
              case 1:
                ...
                novels = loadedCheerio("div.one-book-home > div.img-home a").map(function(index2, element) {
                  var _a3, _b2;
                  return {
                    name: loadedCheerio(element).attr("title") || "",
                    cover: loadedCheerio(element).find("img").attr("src"),
                    path: ((_b2 = (_a3 = loadedCheerio(element).attr("href")) === null || _a3 === void 0 ? void 0 : _a3.replace) === null || _b2 === void 0 ? void 0 : _b2.call(_a3, _this.site, "")) || ""
                  };
      ...
      IfreedomPlugin2.prototype.parseNovel = function(novelPath) {
              ...
              case 1:
                ...
                loadedCheerio("div.data-ranobe").each(function() {
                  switch (loadedCheerio(this).find("b").text()) {
                    case "\u0410\u0432\u0442\u043E\u0440":
                      novel.author = loadedCheerio(this).find("div.data-value").text().trim();
                      break;
                    case "\u0416\u0430\u043D\u0440\u044B":
                      novel.genres = loadedCheerio("div.data-value > a").map(function(index2, element) {
                        var _a3;
                        return (_a3 = loadedCheerio(element).text()) === null || _a3 === void 0 ? void 0 : _a3.trim();
                      }).get().join(",");
                      break;
                    case "\u0421\u0442\u0430\u0442\u0443\u0441 \u043A\u043D\u0438\u0433\u0438":
                      novel.status = loadedCheerio("div.data-value").text().includes("\u0430\u043A\u0442\u0438\u0432\u0435\u043D") ? novelStatus_1.NovelStatus.Ongoing : novelStatus_1.NovelStatus.Completed;
                      break;
                  }
                });
                ...
                loadedCheerio("div.li-ranobe").each(function(chapterIndex, element) {
                  ...
                  if (!loadedCheerio(element).find("label.buy-ranobe").length && name && url) {
                    var releaseDate = loadedCheerio(element).find("div.li-col2-ranobe").text().trim();
                    chapters.push({
                      name,
      ...
      IfreedomPlugin2.prototype.parseChapter = function(chapterPath) {
        return __awaiter(this, void 0, void 0, function() {
          ...
          return __generator(this, function(_b) {
            switch (_b.label) {
              ...
              case 1:
                body = _b.sent();
                chapterText = ((_a2 = body.match(/<article id="([\s\S]*?)<\/article>/)) === null || _a2 === void 0 ? void 0 : _a2[0]) || "";
                chapterText = chapterText.replace(/<script[^>]*>[\s\S]*?<\/script>/gim, "");
                if (chapterText.includes("<img")) {
                  return [2, chapterText.replace(/srcset="([^"]+)"/g, function(match, src) {
                    if (!src)
                      return match;
                    var bestlink = src.split(" ").filter(function(url) {
      ...
      IfreedomPlugin2.prototype.searchNovels = function(searchTerm_1) {
        return __awaiter(this, arguments, void 0, function(searchTerm, page) {
          ...
          return __generator(this, function(_a2) {
            switch (_a2.label) {
              case 0:
                url = this.site + "/vse-knigi/?searchname=" + encodeURIComponent(searchTerm) + "&bpage=" + page;
                return [4, (0, fetch_1.fetchApi)(url).then(function(res) {
                  return res.text();
                })];
              case 1:
                ...
                novels = loadedCheerio("div.one-book-home > div.img-home a").map(function(index2, element) {
                  ...
                  return {
                    name: loadedCheerio(element).attr("title") || "",
                    cover: loadedCheerio(element).find("img").attr("src"),
                    path: ((_b = (_a3 = loadedCheerio(element).attr("href")) === null || _a3 === void 0 ? void 0 : _a3.replace) === null || _b === void 0 ? void 0 : _b.call(_a3, _this.site, "")) || ""
                  };
                }).get().filter(function(novel) {
                  return novel.name && novel.path;
                });
