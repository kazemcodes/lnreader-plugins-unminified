...
(() => {
  ...
  var t = function(t2, e2, a2, r2) {
    ...
    var a2, r2, n2, s2 = { label: 0, sent: /* @__PURE__ */ __name(function() {
    ...
    var a2 = {};
    for (var r2 in t2) Object.prototype.hasOwnProperty.call(t2, r2) && e2.indexOf(r2) < 0 && (a2[r2] = t2[r2]);
    if (null != t2 && "function" == typeof Object.getOwnPropertySymbols) {
      var n2 = 0;
      for (r2 = Object.getOwnPropertySymbols(t2); n2 < r2.length; n2++) e2.indexOf(r2[n2]) < 0 && Object.prototype.propertyIsEnumerable.call(t2, r2[n2]) && (a2[r2[n2]] = t2[r2[n2]]);
    }
    return a2;
  };
  Object.defineProperty(exports, "__esModule", { value: true });
  var r = (init_fetch2(), __toCommonJS(fetch_exports)), n = (init_filterInputs(), __toCommonJS(filterInputs_exports)), s = (init_novelStatus(), __toCommonJS(novelStatus_exports)), i = (init_browser(), __toCommonJS(browser_exports)), o = (init_storage2(), __toCommonJS(storage_exports)), l = (function() {
    function l2() {
      this.id = "komga", this.name = "Komga", this.icon = "src/multi/komga/icon.png", this.version = "1.0.1", this.site = o.storage.get("url"), this.email = o.storage.get("email"), this.password = o.storage.get("password"), this.filters = { status: { value: "", label: "Status", options: [{ label: "All", value: "" }, { label: "Completed", value: s.NovelStatus.Completed }, { label: "Ongoing", value: s.NovelStatus.Ongoing }, { label: "Cancelled", value: s.NovelStatus.Cancelled }, { label: "OnHiatus", value: s.NovelStatus.OnHiatus }], type: n.FilterTypes.Picker }, read_status: { value: "", label: "Read status", options: [{ label: "All", value: "" }, { label: "Unread", value: "UNREAD" }, { label: "Read", value: "READ" }, { label: "In progress", value: "IN_PROGRESS" }], type: n.FilterTypes.Picker } }, this.pluginSettings = { email: { value: "", label: "Email", type: "Text" }, password: { value: "", label: "Password" }, url: { value: "", label: "URL" } };
    }
    __name(l2, "l");
    return l2.prototype.makeRequest = function(a2) {
      return t(this, void 0, void 0, (function() {
        return e(this, (function(t2) {
          switch (t2.label) {
            case 0:
              return [4, (0, r.fetchApi)(a2, { headers: { Accept: "application/json, text/plain, */*", "Content-Type": "application/json;charset=utf-8", Authorization: "Basic ".concat(this.btoa(this.email + ":" + this.password)) }, Referer: this.site }).then((function(t3) {
                return t3.text();
              }))];
            case 1:
              return [2, t2.sent()];
    ...
    }, l2.prototype.btoa = function(t2) {
      void 0 === t2 && (t2 = "");
      for (var e2 = t2, a2 = "", r2 = 0, n2 = void 0, s2 = 0, i2 = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/="; e2.charAt(0 | s2) || (i2 = "=", s2 % 1); a2 += i2.charAt(63 & r2 >> 8 - s2 % 1 * 8)) {
        if ((n2 = e2.charCodeAt(s2 += 3 / 4)) > 255) throw new Error("'btoa' failed: The string to be encoded contains characters outside of the Latin1 range.");
        r2 = r2 << 8 | n2;
      }
      return a2;
    }, l2.prototype.flattenArray = function(t2) {
      var e2 = this;
      return t2.reduce((function(t3, r2) {
        var n2 = r2.children, s2 = a(r2, ["children"]);
        return t3.push(s2), n2 && t3.push.apply(t3, e2.flattenArray(n2)), t3;
      }), []);
    }, l2.prototype.getSeries = function(a2) {
      return t(this, void 0, void 0, (function() {
        var t2, r2, n2, s2, i2, o2;
        return e(this, (function(e2) {
          switch (e2.label) {
            case 0:
              return t2 = [], [4, this.makeRequest(a2)];
            case 1:
              for (r2 = e2.sent(), n2 = JSON.parse(r2).content, s2 = 0, i2 = n2; s2 < i2.length; s2++) o2 = i2[s2], t2.push({ name: o2.name, path: "api/v1/series/" + o2.id, cover: this.site + "api/v1/series/".concat(o2.id, "/thumbnail") });
              return [2, t2];
          }
        }));
      }));
    }, l2.prototype.popularNovels = function(a2, r2) {
      return t(this, arguments, void 0, (function(t2, a3) {
        var r3, n2, s2, i2, o2 = a3.showLatestNovels, l3 = a3.filters;
        return e(this, (function(e2) {
          switch (e2.label) {
            case 0:
              return r3 = (null == l3 ? void 0 : l3.read_status.value) ? "&read_status=" + (null == l3 ? void 0 : l3.read_status.value) : "", n2 = (null == l3 ? void 0 : l3.status.value) ? "&status=" + (null == l3 ? void 0 : l3.status.value) : "", s2 = o2 ? "lastModified,desc" : "name,asc", i2 = "".concat(this.site, "api/v1/series?page=").concat(t2 - 1).concat(r3).concat(n2, "&sort=").concat(s2), [4, this.getSeries(i2)];
            case 1:
              return [2, e2.sent()];
          }
        }));
      ...
      return t(this, void 0, void 0, (function() {
        var t2, r2, n2, i2, o2, l3, u, c, h, p, f, v, d, b, g, m, y, w, O;
        return e(this, (function(e2) {
          switch (e2.label) {
            case 0:
              return t2 = { path: a2, name: "Untitled" }, r2 = this.site + a2, [4, this.makeRequest(r2)];
            case 1:
              switch (n2 = e2.sent(), i2 = JSON.parse(n2), t2.name = i2.name, t2.author = i2.booksMetadata.authors.filter((function(t3) {
                return "writer" === t3.role;
              })).reduce((function(t3, e3) {
                return t3 + ("" !== t3 ? ", " : "") + e3.name;
              }), ""), t2.cover = this.site + "api/v1/series/".concat(i2.id, "/thumbnail"), t2.genres = i2.metadata.genres.join(", "), i2.metadata.status) {
                case "ENDED":
                  t2.status = s.NovelStatus.Completed;
                  break;
                case "ONGOING":
                  t2.status = s.NovelStatus.Ongoing;
                  break;
                case "ABANDONED":
                  t2.status = s.NovelStatus.Cancelled;
                  break;
                case "HIATUS":
                  t2.status = s.NovelStatus.OnHiatus;
                  break;
                default:
                  t2.status = s.NovelStatus.Unknown;
              }
              return t2.summary = i2.booksMetadata.summary, o2 = [], [4, this.makeRequest(this.site + "api/v1/series/".concat(i2.id, "/books?unpaged=true"))];
            case 2:
              l3 = e2.sent(), u = JSON.parse(l3).content, c = 0, h = u, e2.label = 3;
            case 3:
              return c < h.length ? (p = h[c], [4, this.makeRequest(this.site + "opds/v2/books/".concat(p.id, "/manifest"))]) : [3, 6];
            case 4:
              for (f = e2.sent(), v = JSON.parse(f), d = this.flattenArray(v.toc), b = 1, g = /* @__PURE__ */ __name(function(t3) {
                var e3 = d.find((function(e4) {
                  var a4;
                  return (null === (a4 = e4.href) || void 0 === a4 ? void 0 : a4.split("#")[0]) === t3.href;
                })), a3 = e3 ? e3.title : null;
                o2.push({ name: "".concat(b, "/").concat(v.readingOrder.length, " - ").concat(p.metadata.title).concat(a3 ? " - " + a3 : ""), path: "opds/v2" + (null === (O = t3.href) || void 0 === O ? void 0 : O.split("opds/v2").pop()) }), b++;
              }, "g"), m = 0, y = v.readingOrder; m < y.length; m++) w = y[m], g(w);
              e2.label = 5;
            case 5:
              return c++, [3, 3];
            case 6:
              return t2.chapters = o2, [2, t2];
          }
        }));
      }));
      ...
      return t(this, void 0, void 0, (function() {
        ...
        return e(this, (function(e2) {
          switch (e2.label) {
            case 0:
              return [4, this.makeRequest(this.site + a2)];
            case 1:
              return t2 = e2.sent(), [2, this.addUrlToImageHref(t2, this.site + a2.split("/").slice(0, -1).join("/") + "/")];
          }
        }));
      }));
    }, l2.prototype.addUrlToImageHref = function(t2, e2) {
      var a2 = (0, i.load)(t2, { xmlMode: true });
      return a2("svg image").each((function(t3, r2) {
        var n2 = a2(r2).attr("href") || a2(r2).attr("xlink:href"), s2 = a2(r2).attr("width"), i2 = a2(r2).attr("height");
        if (n2) {
          var o2 = a2("<img />").attr({ src: n2.startsWith("http") ? n2 : "".concat(e2).concat(n2), width: s2 || void 0, height: i2 || void 0 });
          a2(r2).closest("svg").replaceWith(o2);
        }
      })), a2("img").each((function(t3, r2) {
        var n2 = a2(r2).attr("src");
        n2 && !n2.startsWith("http") && a2(r2).attr("src", "".concat(e2).concat(n2));
      })), a2("a").each((function(t3, e3) {
        a2(e3).replaceWith(a2(e3).text());
      })), a2.xml();
      ...
      return t(this, void 0, void 0, (function() {
        ...
        return e(this, (function(e2) {
          switch (e2.label) {
            case 0:
              return t2 = "".concat(this.site, "api/v1/series?search=").concat(a2, "&page=").concat(r2 - 1), [4, this.getSeries(t2)];
            case 1:
              return [2, e2.sent()];
          }
        }));
