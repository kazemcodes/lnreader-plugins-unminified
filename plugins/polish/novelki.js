      ...
      return function(u) {
        return (function(o3) {
          ...
          for (; i2 && (i2 = 0, o3[0] && (r2 = 0)), r2; ) try {
            if (a2 = 1, l2 && (n2 = 2 & o3[0] ? l2.return : o3[0] ? l2.throw || ((n2 = l2.return) && n2.call(l2), 0) : l2.next) && !(n2 = n2.call(l2, o3[1])).done) return n2;
    ...
    return i2.prototype.popularNovels = function(l2, r2) {
      ...
      return e(this, void 0, void 0, (function() {
        ...
        return t(this, (function(t2) {
          switch (t2.label) {
            case 0:
              return [4, (0, a.fetchApi)(this.site + l2).then((function(e3) {
                return e3.text();
              }))];
            case 1:
              return e2 = t2.sent(), i3 = (0, n.load)(e2), o = { path: l2, name: "" }, i3("p.h5").each((function(e3, t3) {
                var a2 = i3(t3).text().trim();
                if (a2.includes("Autor:") && (o.author = a2.split(":")[1].trim()), a2.includes("Status projektu:")) switch ("".concat(a2.split(":")[1].trim()).toLowerCase()) {
                  case "wstrzymany":
                  ...
                  case "aktywny":
                    ...
                    break;
                  case "porzucony":
                    o.status = r.NovelStatus.Cancelled;
                    break;
                  case "zlicencjonowany":
                    o.status = r.NovelStatus.Licensed;
                    break;
                  default:
                    o.status = r.NovelStatus.Unknown;
                }
              })), o.name = i3("div.col-sm-12.col-md-6.col-lg-8.mb-5").find("h3").text().trim(), o.cover = this.site + i3(".img-fluid").attr("src"), o.genres = i3("span.badge").map((function(e3, t3) {
                return i3(t3).text();
              })).get().join(", "), o.summary = i3('.h5:contains("Opis:")').next("p").next("p").text().trim(), u = [], (s = i3(".chapters > .col-md-3 > div").get()).forEach((function(e3, t3) {
                var a2, l3 = i3(e3).find("a").attr("href") || "", n2 = { name: null === (a2 = i3(e3).find("a")) || void 0 === a2 ? void 0 : a2.text().trim(), path: l3, releaseTime: i3(e3).find(".card-footer > span").text().trim().split("-").reverse().join("-"), chapterNumber: s.length - t3 };
                u.push(n2);
              })), o.chapters = u.reverse(), [2, o];
          }
        }));
      }));
      ...
      return e(this, void 0, void 0, (function() {
        ...
        return t(this, (function(t2) {
          switch (t2.label) {
            case 0:
              return e2 = /\/projekty\/([^/]+)\/([^/]+)/.exec(l2) || "", [4, (0, a.fetchApi)("".concat(this.site, "/api/reader/chapters/").concat(e2[2])).then((function(e3) {
                if (e3.url == "".concat(r2.site, "/guest")) throw new Error("Failed to load chapter (open in web view and login)");
                return e3.json();
              }))];
            case 1:
              return n2 = t2.sent(), [2, n2.data.content];
          }
        }));
      }));
    }, i2.prototype.searchNovels = function(l2, r2) {
      return e(this, void 0, void 0, (function() {
        var e2, i3, o = this;
        return t(this, (function(t2) {
          switch (t2.label) {
            case 0:
              return [4, (0, a.fetchApi)("".concat(this.site, "/projekty?filter=t&title=").concat(l2, "+&page=").concat(r2)).then((function(e3) {
                if (e3.url == "".concat(o.site, "/guest")) throw new Error("Failed to search novels (open in web view and login)");
                return e3.text();
              }))];
            case 1:
              return e2 = t2.sent(), i3 = (0, n.load)(e2), [2, i3("#projects > div").map((function(e3, t3) {
                return { name: i3(t3).find(".card-title").attr("title"), cover: o.site + i3(t3).find(".card-img-top").attr("src"), path: i3(t3).find("a").attr("href") || "" };
              })).get().filter((function(e3) {
                return e3.name && e3.path;
              }))];
          }
