...
var LNReaderPlugin = function () {
  ...
  // .js/plugins/english/foxteller.js
  init_dirname();
  init_buffer2();
  init_process2();
  ...
  function () {
    ...
    __name(Foxteller2, "Foxteller");
    Foxteller2.prototype.safeFecth = function (url_1) {
    ...
    Foxteller2.prototype.popularNovels = function (pageNo_1, _a) {
    ...
    Foxteller2.prototype.parseNovel = function (novelPath) {
      return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              return [4, this.safeFecth(this.resolveUrl(novelPath))];
            case 1:
              body = _a.sent();
              novel = {
                path: novelPath,
              ...
              parser = new htmlparser2_1.Parser({
                onopentag: /* @__PURE__ */__name(function (name, attribs) {
                  ...
                  } else if (isReadingChapter && name === "i" && ((_a2 = attribs["class"]) === null || _a2 === void 0 ? void 0 : _a2.includes("lock"))) {
                    isPaidChapter = true;
                  }
                }, "onopentag"),
                ...
                onclosetag: /* @__PURE__ */__name(function (name) {
                  ...
                  if (isParsingGenres) {
                    if (isReadingGenre) {
                      ...
                      isParsingGenres = false;
                      novel.genres = (_a2 = novel.genres) === null || _a2 === void 0 ? void 0 : _a2.slice(0, -2);
                    }
                  } else if (isReadingSummary) {
                    if (name === "hr" || name === "p") {
                      novel.summary += "\n";
    ...
    Foxteller2.prototype.parseChapter = function (chapterPath) {
      return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
          switch (_b.label) {
            case 0:
              return [4, this.safeFecth(this.resolveUrl(chapterPath))];
            case 1:
              res = _b.sent();
              ...
              return [4, (0, fetch_1.fetchApi)(this.site + "/aux_dem", {
                method: "post",
                headers: {
            ...
            case 2:
              ...
              if (aux && typeof aux === "string") {
                ...
                return [2, decodeURIComponent(decodeBase64(base64))];
              }
    ...
    Foxteller2.prototype.searchNovels = function (searchTerm) {
      return __awaiter(this, void 0, void 0, function () {
        var body, novels, items;
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              return [4, this.safeFecth(this.site + "/search", {
                method: "post",
                headers: {
                  Accept: "application/json, text/plain, */*",
                  "Accept-Language": "ru-RU,ru;q=0.8,en-US;q=0.5,en;q=0.3",
            ...
            case 1:
              ...
              items.forEach(function (elements) {
                var _a2, _b, _c;
                var novelUrl = ((_a2 = elements.match(/<a href="(.*?)"/)) === null || _a2 === void 0 ? void 0 : _a2[1]) || "";
