      ...
      return e(this, void 0, void 0, function() {
        ...
        return t(this, function(t2) {
          switch (t2.label) {
            ...
            case 1:
              return r2 = t2.sent(), o2 = { path: a2, name: "", genres: "", summary: "", author: "", artist: "", status: "", chapters: [] }, c3 = false, u = false, v = 0, h = false, p = false, d = false, f = false, m = false, b = false, g = false, y = 0, w = false, k = false, N = [], x = {}, C = this.hideLocked, S = new s.Parser({ onopentag: /* @__PURE__ */ __name(function(t3, a3) {
                var s2;
              ...
              }, "onclosetag") }), S.write(r2), S.end(), N.length && ((null === (L = this.options) || void 0 === L ? void 0 : L.reverseChapters) && N.reverse(), o2.chapters = N), o2.summary = o2.summary.trim(), [2, o2];
          }
        });
      });
