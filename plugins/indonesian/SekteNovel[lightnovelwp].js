...
var LNReaderPlugin = (() => {
  ...
  // .js/plugins/indonesian/SekteNovel[lightnovelwp].js
  var e = function(e2, t2, a2, s2) {
    ...
    var a2, s2, r2, i2 = { label: 0, sent: function() {
  ...
  var a = (init_browser(), __toCommonJS(browser_exports)), s = require_lib9(), r = (init_fetch2(), __toCommonJS(fetch_exports)), i = (init_novelStatus(), __toCommonJS(novelStatus_exports)), l = (init_defaultCover(), __toCommonJS(defaultCover_exports)), o = (init_storage2(), __toCommonJS(storage_exports));
  function n(e2, t2) {
    var a2 = e2.match(/(\d+)$/);
    ...
    return c2.prototype.getHostname = function(e2) {
      ...
      return (e2.match(/<article([^]*?)<\/article>/g) || []).forEach((function(e3) {
        ...
        if (i2 && r2) {
          ...
          s2.push({ name: i2, cover: o2[2] || o2[1] || l.defaultCover, path: n2 });
        }
      })), s2;
    }, c2.prototype.popularNovels = function(a2, s2) {
      return e(this, arguments, void 0, (function(e2, a3) {
        var s3, r2, i2, l2, o2, n2, c3, u, v, h = a3.filters, p = a3.showLatestNovels;
        return t(this, (function(t2) {
          switch (t2.label) {
            case 0:
              for (i2 in s3 = null !== (v = null === (u = this.options) || void 0 === u ? void 0 : u.seriesPath) && void 0 !== v ? v : "/series/", r2 = this.site + s3 + "?page=" + e2, h || (h = this.filters || {}), p && (r2 += "&order=latest"), h) if ("object" == typeof h[i2].value) for (l2 = 0, o2 = h[i2].value; l2 < o2.length; l2++) n2 = o2[l2], r2 += "&".concat(i2, "=").concat(n2);
      ...
      return e(this, void 0, void 0, (function() {
        var e2, r2, o2, c3, u, v, h, p, d, f, m, b, g, y, w, k, N, x, C, S, L;
        return t(this, (function(t2) {
          switch (t2.label) {
            case 0:
              return e2 = this.site, [4, this.safeFecth(e2 + a2, false)];
            case 1:
              return r2 = t2.sent(), o2 = { path: a2, name: "", genres: "", summary: "", author: "", artist: "", status: "", chapters: [] }, c3 = false, u = false, v = 0, h = false, p = false, d = false, f = false, m = false, b = false, g = false, y = 0, w = false, k = false, N = [], x = {}, C = this.hideLocked, S = new s.Parser({ onopentag: function(t3, a3) {
                var s2;
                !o2.cover && (null === (s2 = a3.class) || void 0 === s2 ? void 0 : s2.includes("ts-post-image")) ? (o2.name = a3.title, o2.cover = a3["data-src"] || a3.src || l.defaultCover) : "genxed" === a3.class || "sertogenre" === a3.class ? c3 = true : c3 && "a" === t3 ? u = true : "div" !== t3 || "entry-content" !== a3.class && "description" !== a3.itemprop ? "spe" === a3.class || "serl" === a3.class ? h = true : h && "span" === t3 ? p = true : "div" === t3 && "sertostat" === a3.class ? (h = true, p = true, m = true) : a3.class && a3.class.includes("eplister") ? b = true : b && "li" === t3 ? g = true : g ? "a" === t3 && void 0 === x.path ? x.path = a3.href.replace(e2, "").trim() : "epl-num" === a3.class ? y = 1 : "epl-title" === a3.class ? y = 2 : "epl-date" === a3.class ? y = 3 : "epl-price" === a3.class && (y = 4) : !v || "div" !== t3 && "script" !== t3 || v++ : v++;
              }, ontext: function(e3) {
                var t3, a3;
