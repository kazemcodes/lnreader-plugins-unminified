...
(() => {
  ...
  // .js/plugins/indonesian/sakuranovel.js
    ...
    function o(o2) {
      return function(s) {
        return (function(o3) {
          ...
          for (; i && (i = 0, o3[0] && (n2 = 0)), n2; ) try {
            if (a2 = 1, l2 && (r2 = 2 & o3[0] ? l2.return : o3[0] ? l2.throw || ((r2 = l2.return) && r2.call(l2), 0) : l2.next) && !(r2 = r2.call(l2, o3[1])).done) return r2;
            switch (l2 = 0, r2 && (o3 = [2 & o3[0], r2.value]), o3[0]) {
              case 0:
              case 1:
                r2 = o3;
                break;
  ...
  var a = (init_browser(), __toCommonJS(browser_exports)), l = (init_fetch2(), __toCommonJS(fetch_exports)), r = (init_filterInputs(), __toCommonJS(filterInputs_exports)), n = (function() {
    ...
    return n2.prototype.parseNovels = function(e2) {
      ...
      return e(this, void 0, void 0, (function() {
        var e2, n3, i, o, s, u, c, v, p = this;
        return t(this, (function(t2) {
          switch (t2.label) {
            case 0:
              return [4, (0, l.fetchApi)(this.site + r2)];
            case 1:
              return [4, t2.sent().text()];
            case 2:
              return e2 = t2.sent(), (n3 = (0, a.load)(e2))(".series-synops div").remove(), (i = { path: r2, name: n3(".series-title h2").text().trim() || "Untitled", cover: n3(".series-thumb img").attr("src"), author: n3(".series-infolist > li b:contains('Author') +").text().trim(), status: n3(".status").text().trim(), summary: n3(".series-synops").text().trim(), chapters: [] }).genres = n3(".series-genres").children("a").map((function(e3, t3) {
                return n3(t3).text();
              })).toArray().join(","), o = null === (v = null === (c = i.cover) || void 0 === c ? void 0 : c.split("/").pop()) || void 0 === v ? void 0 : v.split("-").join(" ").split(".")[0], s = i.name.replace(/\(LN\)|\(WN\)/, "").split(",")[0].trim(), u = [], n3(".series-flexright li").each((function(e3, t3) {
                var a2 = n3(t3).find("a span").first().text().replace(s, "").replace(o, "").replace(/Bahasa Indonesia/, "").replace(/\s+/g, " ").trim(), l2 = n3(t3).find(".date").text().trim().split("/").map((function(e4) {
                  return Number(e4);
                })), r3 = n3(t3).find("a").attr("href");
                r3 && u.push({ name: a2, releaseTime: new Date(l2[2], l2[1], l2[0]).toISOString(), path: r3.replace(p.site, "") });
              })), i.chapters = u.reverse(), [2, i];
          }
        }));
      }));
        ...
        return t(this, (function(t2) {
          switch (t2.label) {
            ...
            case 1:
              return [4, t2.sent().text()];
            case 2:
              return e2 = t2.sent(), n3 = (0, a.load)(e2), i = n3("div:contains('Daftar Isi') +").find("div:first").attr("class"), n3(".".concat(i)).remove(), [2, n3("div:contains('Daftar Isi') +").html() || ""];
          }
        }));
      }));
    }, n2.prototype.searchNovels = function(r2, n3) {
      return e(this, void 0, void 0, (function() {
        var e2, i, o;
        return t(this, (function(t2) {
          switch (t2.label) {
            case 0:
              return e2 = "".concat(this.site, "page/").concat(n3, "/?s=").concat(r2), [4, (0, l.fetchApi)(e2)];
            case 1:
              return [4, t2.sent().text()];
            case 2:
              return i = t2.sent(), o = (0, a.load)(i), [2, this.parseNovels(o)];
