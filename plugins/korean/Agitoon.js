      ...
      return t(this, arguments, void 0, function(t2, n3) {
        ...
        return e(this, function(e2) {
          switch (e2.label) {
            ...
            case 1:
              return e2.sent(), [4, (0, r.fetchApi)(i2.url + "/novel/index.update.php", { headers: { "content-type": "application/x-www-form-urlencoded; charset=UTF-8" }, method: "POST", body: new URLSearchParams({ mode: "get_data_novel_list_p", novel_menu: u ? "1" : "3", np_day: (/* @__PURE__ */ new Date()).getDay().toString(), np_rank: "1", np_distributor: "0", np_genre: "00", np_order: "1", np_genre_ex_1: "00", np_genre_ex_2: "00", list_limit: (20 * (t2 - 1)).toString(), is_query_first: (1 == t2).toString() }).toString() })];
            case 2:
      ...
      return t(this, void 0, void 0, function() {
        ...
        return e(this, function(e2) {
          switch (e2.label) {
            ...
            case 2:
              return t2 = e2.sent(), s = (0, n.load)(t2), (a = { path: o, name: s("h5.pt-2").text(), cover: s("div.col-5.pr-0.pl-0 img").attr("src"), summary: s(".pt-1.mt-1.pb-1.mb-1").text() }).author = s(".post-item-list-cate-v").first().text().split(" : ")[1], (c = s(".col-7 > .post-item-list-cate > span").map(function(t3, e3) {
