...
(() => {
  ...
  // .js/plugins/korean/Agitoon.js
  var t = function(t2, e2, r2, n2) {
    return new (r2 || (r2 = Promise))((function(i2, o) {
      function s(t3) {
        try {
          c(n2.next(t3));
        } catch (t4) {
    ...
    var r2, n2, i2, o = { label: 0, sent: /* @__PURE__ */ __name(function() {
        ...
        return (function(a3) {
          ...
          for (; s && (s = 0, a3[0] && (o = 0)), o; ) try {
            ...
            switch (n2 = 0, i2 && (a3 = [2 & a3[0], i2.value]), a3[0]) {
              ...
              case 5:
                o.label++, n2 = a3[1], a3 = [0];
                continue;
              case 7:
                a3 = o.ops.pop(), o.trys.pop();
                continue;
              default:
                if (!(i2 = o.trys, (i2 = i2.length > 0 && i2[i2.length - 1]) || 6 !== a3[0] && 2 !== a3[0])) {
                  o = 0;
                  continue;
                }
  ...
  var r = (init_fetch2(), __toCommonJS(fetch_exports)), n = (init_browser(), __toCommonJS(browser_exports)), i = (function() {
    function i2() {
      this.id = "agit.xyz", this.name = "Agitoon", this.icon = "src/kr/agitoon/icon.png", this.site = "https://agit664.xyz", this.version = "3.1.0";
    }
    __name(i2, "i");
    return i2.prototype.checkUrl = function() {
      return t(this, void 0, void 0, (function() {
        var t2;
        return e(this, (function(e2) {
          switch (e2.label) {
            case 0:
              return i2.url ? [3, 2] : [4, (0, r.fetchApi)(this.site)];
            case 1:
              (t2 = e2.sent()).ok ? i2.url = t2.url.replace(/\/$/, "") : i2.url = this.site, e2.label = 2;
            case 2:
              return [2];
          }
        }));
      }));
    }, i2.prototype.popularNovels = function(n2, o) {
      return t(this, arguments, void 0, (function(t2, n3) {
        var o2, s, a, c, u = n3.showLatestNovels;
        return e(this, (function(e2) {
          switch (e2.label) {
            case 0:
              return [4, this.checkUrl()];
            case 1:
              return e2.sent(), [4, (0, r.fetchApi)(i2.url + "/novel/index.update.php", { headers: { "content-type": "application/x-www-form-urlencoded; charset=UTF-8" }, method: "POST", body: new URLSearchParams({ mode: "get_data_novel_list_p", novel_menu: u ? "1" : "3", np_day: (/* @__PURE__ */ new Date()).getDay(), np_rank: "1", np_distributor: "0", np_genre: "00", np_order: "1", np_genre_ex_1: "00", np_genre_ex_2: "00", list_limit: 20 * (t2 - 1), is_query_first: 1 == t2 }).toString() })];
            case 2:
              if (!(o2 = e2.sent()).ok) throw new Error("Failed to get popular novels: (".concat(o2.status, ": ").concat(o2.statusText, ") (try to open in webview)"));
              return [4, o2.json()];
            case 3:
              return s = e2.sent(), a = [], null === (c = null == s ? void 0 : s.list) || void 0 === c || c.forEach((function(t3) {
                return a.push({ name: t3.wr_subject, cover: i2.url + t3.np_dir + "/thumbnail/" + t3.np_thumbnail, path: t3.wr_id });
              })), [2, a];
          }
        }));
      }));
    }, i2.prototype.parseNovel = function(o) {
      return t(this, void 0, void 0, (function() {
        var t2, s, a, c, u, l, h;
        return e(this, (function(e2) {
          switch (e2.label) {
            case 0:
              return [4, this.checkUrl()];
            case 1:
              return e2.sent(), [4, (0, r.fetchApi)(this.resolveUrl(o, true)).then((function(t3) {
                return t3.text();
              }))];
            case 2:
              return t2 = e2.sent(), s = (0, n.load)(t2, { decodeEntities: false }), (a = { path: o, name: s("h5.pt-2").text(), cover: s("div.col-5.pr-0.pl-0 img").attr("src"), summary: s(".pt-1.mt-1.pb-1.mb-1").text() }).author = s(".post-item-list-cate-v").first().text().split(" : ")[1], (c = s(".col-7 > .post-item-list-cate > span").map((function(t3, e3) {
                return s(e3).text().trim();
              })).get()).length && (a.genres = c.join(", ")), u = [], [4, (0, r.fetchApi)(i2.url + "/novel/list.update.php", { headers: { "content-type": "application/x-www-form-urlencoded; charset=UTF-8" }, method: "POST", body: new URLSearchParams({ mode: "get_data_novel_list_c", wr_id_p: o, page_no: "1", cnt_list: "10000", order_type: "Asc" }).toString() })];
            case 3:
              return [4, e2.sent().json()];
            case 4:
              return l = e2.sent(), null === (h = null == l ? void 0 : l.list) || void 0 === h || h.forEach((function(t3) {
                return u.push({ name: t3.wr_subject, path: t3.wr_id + "/2", releaseTime: t3.wr_datetime });
              })), a.chapters = u, [2, a];
          }
        }));
      }));
    }, i2.prototype.parseChapter = function(i3) {
      return t(this, void 0, void 0, (function() {
        var t2, o;
        return e(this, (function(e2) {
          switch (e2.label) {
            case 0:
              return [4, this.checkUrl()];
            case 1:
              return e2.sent(), [4, (0, r.fetchApi)(this.resolveUrl(i3)).then((function(t3) {
                return t3.text();
              }))];
            case 2:
              return t2 = e2.sent(), o = (0, n.load)(t2), [2, (o("#id_wr_content").html() || "").replace("\uD31D\uC5C5\uBA54\uB274\uB294 \uBE48\uACF5\uAC04\uC744 \uB354\uCE58\uD558\uAC70\uB098 \uC2A4\uD06C\uB8F0\uC2DC \uC0AC\uB77C\uC9D1\uB2C8\uB2E4", "").trim()];
          }
        }));
      }));
    }, i2.prototype.searchNovels = function(n2, o) {
      return t(this, void 0, void 0, (function() {
        var t2, s, a;
        return e(this, (function(e2) {
          switch (e2.label) {
            case 0:
              return 1 !== o ? [2, []] : [4, this.checkUrl()];
            case 1:
              return e2.sent(), [4, (0, r.fetchApi)(i2.url + "/novel/search.php", { headers: { "content-type": "application/x-www-form-urlencoded; charset=UTF-8" }, method: "POST", body: new URLSearchParams({ mode: "get_data_novel_list_p_sch", search_novel: n2, list_limit: 0 }).toString() })];
            case 2:
              return [4, e2.sent().json()];
            case 3:
              return t2 = e2.sent(), s = [], null === (a = null == t2 ? void 0 : t2.list) || void 0 === a || a.forEach((function(t3) {
                return s.push({ name: t3.wr_subject, cover: i2.url + "/" + t3.np_dir + "/thumbnail/" + t3.np_thumbnail, path: t3.wr_id });
              })), [2, s];
          }
        }));
      }));
    }, i2.prototype.resolveUrl = function(t2, e2) {
      return i2.url || (0, r.fetchApi)(this.site).then((function(t3) {
        return i2.url = t3.url.replace(/\/$/, "");
      })), (i2.url ? i2.url : this.site) + (e2 ? "/novel/list/" : "/novel/view/") + t2;
    }, i2;
  })();
