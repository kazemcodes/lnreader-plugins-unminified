...
var LNReaderPlugin = (() => {
  ...
  // .js/plugins/thai/NovelLucky[madara].js
  ...
  var l = (init_fetch2(), __toCommonJS(fetch_exports)), n = (init_browser(), __toCommonJS(browser_exports)), r = (init_defaultCover(), __toCommonJS(defaultCover_exports)), i = (init_novelStatus(), __toCommonJS(novelStatus_exports)), o = a(require_dayjs_min()), s = (init_storage2(), __toCommonJS(storage_exports)), u = function(e2, t2) {
    return new RegExp(t2.join("|")).test(e2);
  }, c = new ((function() {
    function a2(e2) {
      var t2, a3;
      this.hideLocked = s.storage.get("hideLocked"), this.parseData = function(e3) {
        var t3, a4 = (0, o.default)(), l3 = (null === (t3 = e3.match(/\d+/)) || void 0 === t3 ? void 0 : t3[0]) || "", n2 = parseInt(l3, 10);
        if (!l3) return e3;
      ...
      this.version = "1.0.".concat(8 + l2), this.options = e2.options, this.filters = e2.filters, (null === (a3 = this.options) || void 0 === a3 ? void 0 : a3.hasLocked) && (this.pluginSettings = { hideLocked: { value: "", label: "Hide locked chapters", type: "Switch" } });
    }
    return a2.prototype.translateDragontea = function(e2) {
      ...
      return e2.html(a3.html()), e2.find("*").addBack().contents().filter((function(e3, t3) {
        ...
        var l2 = a3(t3), n2 = l2.text().normalize("NFD").split("").map((function(e4) {
      ...
      return e2(".manga-title-badges").remove(), e2(".page-item-detail, .c-tabs-item__content").each((function(a3, l2) {
        var n2 = e2(l2).find(".post-title").text().trim(), i2 = e2(l2).find(".post-title").find("a").attr("href") || "";
        if (n2 && i2) {
          var o2 = e2(l2).find("img"), s2 = { name: n2, cover: o2.attr("data-src") || o2.attr("src") || o2.attr("data-lazy-srcset") || r.defaultCover, path: i2.replace(/https?:\/\/.*?\//, "/") };
          t2.push(s2);
        }
      })), t2;
    }, a2.prototype.popularNovels = function(a3, l2) {
      return e(this, arguments, void 0, (function(e2, a4) {
        var l3, n2, r2, i2, o2, s2, u2 = a4.filters, c2 = a4.showLatestNovels;
        return t(this, (function(t2) {
          switch (t2.label) {
            case 0:
              for (n2 in l3 = this.site + "/page/" + e2 + "/?s=&post_type=wp-manga", u2 || (u2 = this.filters || {}), c2 && (l3 += "&m_orderby=latest"), u2) if ("object" == typeof u2[n2].value) for (r2 = 0, i2 = u2[n2].value; r2 < i2.length; r2++) o2 = i2[r2], l3 += "&".concat(n2, "=").concat(o2);
              else u2[n2].value && (l3 += "&".concat(n2, "=").concat(u2[n2].value));
          ...
          switch (t2.label) {
            ...
            case 1:
              return (e2 = t2.sent())(".manga-title-badges, #manga-title span").remove(), (s2 = { path: a3, name: e2(".post-title h1").text().trim() || e2("#manga-title h1").text().trim() || e2(".manga-title").text().trim() || "" }).cover = e2(".summary_image > a > img").attr("data-lazy-src") || e2(".summary_image > a > img").attr("data-src") || e2(".summary_image > a > img").attr("src") || r.defaultCover, e2(".post-content_item, .post-content").each((function() {
                ...
                return e2(a4).text();
              })).get().join("\n\n").trim(), u2 = [], c2 = "", (null === (d = this.options) || void 0 === d ? void 0 : d.useNewChapterEndpoint) ? [4, (0, l.fetchApi)(this.site + a3 + "ajax/chapters/", { method: "POST", referrer: this.site + a3 }).then((function(e3) {
                return e3.text();
              }))] : [3, 3];
            case 2:
              return c2 = t2.sent(), [3, 5];
            case 3:
              return h = e2(".rating-post-id").attr("value") || e2("#manga-chapters-holder").attr("data-id") || "", (v = new FormData()).append("action", "manga_get_chapters"), v.append("manga", h), [4, (0, l.fetchApi)(this.site + "wp-admin/admin-ajax.php", { method: "POST", body: v }).then((function(e3) {
                return e3.text();
              }))];
            case 4:
              c2 = t2.sent(), t2.label = 5;
            case 5:
              return "0" !== c2 && (e2 = (0, n.load)(c2)), p = e2(".wp-manga-chapter").length, e2(".wp-manga-chapter").each((function(t3, a4) {
                var l2 = e2(a4).find("a").text().trim(), n2 = a4.attribs.class.includes("premium-block");
                n2 && (l2 = "\u{1F512} " + l2);
                ...
                !i2 || "#" == i2 || n2 && m.hideLocked || u2.push({ name: l2, path: i2.replace(/https?:\/\/.*?\//, "/"), releaseTime: r2 || null, chapterNumber: p - t3 });
        ...
        return t(this, (function(t2) {
          switch (t2.label) {
            case 0:
              return [4, this.getCheerio(this.site + a3, false)];
            case 1:
              return e2 = t2.sent(), l2 = e2(".text-left") || e2(".text-right") || e2(".entry-content") || e2(".c-blog-post > div > div:nth-child(2)"), null === (n2 = this.options) || void 0 === n2 || n2.customJs, [2, this.translateDragontea(l2).html() || ""];
          }
        }));
      }));
      ...
      return e(this, void 0, void 0, (function() {
        ...
        return t(this, (function(t2) {
          switch (t2.label) {
            case 0:
              return e2 = this.site + "/page/" + l2 + "/?s=" + encodeURIComponent(a3) + "&post_type=wp-manga", [4, this.getCheerio(e2, true)];
            case 1:
