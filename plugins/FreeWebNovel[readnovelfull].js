...
var LNReaderPlugin = function () {
  ...
  // .js/plugins/english/FreeWebNovel[readnovelfull].js
  init_dirname();
  init_buffer2();
  init_process2();
  ...
  var plugin = new ReadNovelFullPlugin({
    "id": "FWN.com",
    "sourceSite": "https://freewebnovel.com/",
    "sourceName": "Free Web Novel",
    "options": {
    ...
    "filters": {
      "type": {
        ...
        "options": [{
          "label": "All",
          "value": "sort/latest-release"
        }, {
          "label": "Chinese Novel",
          "value": "sort/latest-release/chinese-novel"
        }, {
          "label": "Korean Novel",
          "value": "sort/latest-release/korean-novel"
        }, {
