...
var LNReaderPlugin = (() => {
  ...
  var n = (init_browser(), __toCommonJS(browser_exports)), r = (init_fetch2(), __toCommonJS(fetch_exports)), a = (init_defaultCover(), __toCommonJS(defaultCover_exports)), o = function() {
    function o2() {
      this.id = "dilartube", this.name = "dilar tube", this.version = "1.0.2", this.icon = "src/ar/dilartube/icon.png", this.site = "https://golden.rest/", this.filters = void 0;
    }
    __name(o2, "o");
    return o2.prototype.parseNovels = function(t2) {
      ...
      return t(this, void 0, void 0, function() {
        var t2, a2, o3, i, c, s, u, l, h, p, f, d, v, m, b;
        return e(this, function(e2) {
          switch (e2.label) {
            case 0:
            ...
            case 2:
              return c = e2.sent(), s = i.mangaData, u = c.releases, l = { path: n2, name: null !== (b = null !== (m = s.arabic_title) && void 0 !== m ? m : s.title) && void 0 !== b ? b : "Untitled", author: (s.authors.length > 0 ? s.authors[0].name : "") || "Unknown", summary: s.summary || "", cover: "".concat(this.site, "uploads/manga/cover/").concat(s.id, "/").concat(s.cover), chapters: [] }, h = s.translation_status.toString(), p = { 1: "\u0645\u0633\u062A\u0645\u0631\u0647", 0: "\u0645\u0646\u062A\u0647\u064A\u0629", 2: "\u0645\u062A\u0648\u0642\u0641\u0629", 3: "\u063A\u064A\u0631 \u0645\u062A\u0631\u062C\u0645\u0647" }[h] || "\u063A\u064A\u0631 \u0645\u0639\u0631\u0648\u0641", f = Array.from(new Set(s.categories.map(function(t3) {
                return t3.name;
              }))).filter(Boolean).join(","), l.genres = "".concat(p, ",").concat(f), d = s.story_status.toString(), v = { 2: "Ongoing", 3: "Completed" }[d] || "Unknown", l.status = v, u.map(function(e3) {
      ...
      return t(this, void 0, void 0, function() {
        ...
        return e(this, function(e2) {
          switch (e2.label) {
            ...
            case 2:
              return t2 = e2.sent(), o3 = (0, n.load)(t2), i = o3("script.js-react-on-rails-component").html(), c = JSON.parse(i), [2, c.readerDataAction.readerData.release.content.split(/\r?\n/).map(function(t3) {
                return t3.trim();
      ...
      return t(this, void 0, void 0, function() {
        ...
        return e(this, function(e2) {
          switch (e2.label) {
            ...
            case 1:
              return a2 = e2.sent(), o3 = a2[0], [2, this.parseNovels(o3)];
          }
        });
      });
    }, o2;
