...
(() => {
  ...
  // .js/plugins/arabic/dilartube.js
        ...
        return (function(c3) {
          ...
          for (; i && (i = 0, c3[0] && (o2 = 0)), o2; ) try {
            ...
            switch (r2 = 0, a2 && (c3 = [2 & c3[0], a2.value]), c3[0]) {
              ...
              case 5:
                o2.label++, r2 = c3[1], c3 = [0];
                continue;
              case 7:
                c3 = o2.ops.pop(), o2.trys.pop();
                continue;
              default:
                if (!(a2 = o2.trys, (a2 = a2.length > 0 && a2[a2.length - 1]) || 6 !== c3[0] && 2 !== c3[0])) {
                  o2 = 0;
                  continue;
                }
                ...
                if (6 === c3[0] && o2.label < a2[1]) {
                  o2.label = a2[1], a2 = c3;
                  break;
                }
                if (a2 && o2.label < a2[2]) {
                  o2.label = a2[2], o2.ops.push(c3);
                  break;
                }
  ...
  var n = (init_browser(), __toCommonJS(browser_exports)), r = (init_fetch2(), __toCommonJS(fetch_exports)), a = (init_defaultCover(), __toCommonJS(defaultCover_exports)), o = (function() {
    function o2() {
      this.id = "dilartube", this.name = "dilar tube", this.version = "1.0.1", this.icon = "src/ar/dilartube/icon.png", this.site = "https://golden.rest/";
    }
    __name(o2, "o");
    return o2.prototype.parseNovels = function(t2) {
      var e2 = this, n2 = [], r2 = /* @__PURE__ */ new Set();
      return t2.data && t2.data.length > 0 && t2.data.filter((function(t3) {
        return t3.is_novel;
      })).forEach((function(t3) {
        var o3 = t3;
        r2.has(t3.title) || (r2.add(o3.title), n2.push({ name: t3.title || "novel", path: "mangas/".concat(o3.id), cover: o3.cover ? "".concat(e2.site, "uploads/manga/cover/").concat(o3.id, "/").concat(o3.cover) : a.defaultCover }));
      })), t2.releases && t2.releases.length > 0 && t2.releases.filter((function(t3) {
        return t3.manga.is_novel;
      })).forEach((function(t3) {
        var o3 = t3.manga;
        r2.has(o3.title) || (r2.add(o3.title), n2.push({ name: o3.title || "novel", path: "mangas/".concat(o3.id), cover: o3.cover ? "".concat(e2.site, "uploads/manga/cover/").concat(o3.id, "/").concat(o3.cover) : a.defaultCover }));
      })), n2;
    }, o2.prototype.popularNovels = function(n2, a2) {
      return t(this, arguments, void 0, (function(t2, n3) {
        var a3, o3, i = n3.showLatestNovels;
        n3.filters;
        return e(this, (function(e2) {
          switch (e2.label) {
            case 0:
              return a3 = "".concat(this.site, "api/releases?page=").concat(t2), i && (a3 = "".concat(this.site, "api/releases?page=").concat(t2)), [4, (0, r.fetchApi)(a3).then((function(t3) {
                return t3.json();
              }))];
            case 1:
              return o3 = e2.sent(), [2, this.parseNovels(o3)];
          }
        }));
      }));
    }, o2.prototype.parseNovel = function(n2) {
      return t(this, void 0, void 0, (function() {
        var t2, a2, o3, i, c, s, u, l, h, p, f, d, v;
        return e(this, (function(e2) {
          switch (e2.label) {
            case 0:
              return t2 = [], a2 = this.site + "api/" + n2, o3 = this.site + "api/" + n2 + "/releases", [4, (0, r.fetchApi)(a2).then((function(t3) {
                return t3.json();
              }))];
            case 1:
              return i = e2.sent(), [4, (0, r.fetchApi)(o3).then((function(t3) {
                return t3.json();
              }))];
            case 2:
              return c = e2.sent(), s = i.mangaData, u = c.releases, l = { path: n2, name: s.arabic_title || "Untitled", author: (s.authors.length > 0 ? s.authors[0].name : "") || "Unknown", summary: s.summary || "", cover: "".concat(this.site, "uploads/manga/cover/").concat(s.id, "/").concat(s.cover), chapters: [] }, h = s.translation_status, p = { 1: "\u0645\u0633\u062A\u0645\u0631\u0647", 0: "\u0645\u0646\u062A\u0647\u064A\u0629", 2: "\u0645\u062A\u0648\u0642\u0641\u0629", 3: "\u063A\u064A\u0631 \u0645\u062A\u0631\u062C\u0645\u0647" }[h] || "\u063A\u064A\u0631 \u0645\u0639\u0631\u0648\u0641", /* @__PURE__ */ new Set(["\u0645\u0643\u062A\u0645\u0644", "\u062C\u062F\u064A\u062F", "\u0645\u0633\u062A\u0645\u0631"]), f = s.categories.map((function(t3) {
                return t3.name;
              })).join(","), l.genres = "".concat(p, ",").concat(f), d = s.story_status, v = { 2: "Ongoing", 3: "Completed" }[d] || "Unknown", l.status = v, u.map((function(e3) {
                t2.push({ name: e3.title, releaseTime: new Date(e3.created_at).toISOString(), path: "".concat(n2, "/").concat(s.title.replace(" ", "-"), "/").concat(e3.chapter), chapterNumber: e3.chapter });
              })), l.chapters = t2.reverse(), [2, l];
          }
        }));
      }));
      ...
      return t(this, void 0, void 0, (function() {
        ...
        return e(this, (function(e2) {
          switch (e2.label) {
            ...
            case 2:
              return t2 = e2.sent(), o3 = (0, n.load)(t2), i = o3("script.js-react-on-rails-component").html(), c = JSON.parse(i), [2, c.readerDataAction.readerData.release.content];
          }
        }));
      }));
    }, o2.prototype.searchNovels = function(n2, a2) {
      return t(this, void 0, void 0, (function() {
        var t2, a3, o3;
        return e(this, (function(e2) {
          switch (e2.label) {
            case 0:
              return (t2 = new FormData()).append("query", n2), t2.append("includes", '["Manga","Team","Member"]'), [4, (0, r.fetchApi)("https://dilar.tube/api/quick_search", { method: "POST", body: t2 }).then((function(t3) {
                return t3.json();
              }))];
            case 1:
              return a3 = e2.sent(), o3 = a3[0], [2, this.parseNovels(o3)];
          }
        }));
      }));
    }, o2;
