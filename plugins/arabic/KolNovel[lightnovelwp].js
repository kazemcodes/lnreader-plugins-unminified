      ...
      return e(this, void 0, void 0, (function() {
        ...
        return a(this, (function(a2) {
          switch (a2.label) {
            ...
            case 1:
              return s2 = a2.sent(), o2 = { path: l2, name: "", genres: "", summary: "", author: "", artist: "", status: "", chapters: [] }, n3 = false, c = false, v = 0, b = false, h = false, p = false, d = false, f = false, m = false, g = false, y = 0, w = false, k = false, x = [], N = {}, C = this.hideLocked, S = new t.Parser({ onopentag: /* @__PURE__ */ __name(function(a3, l3) {
                var t2;
              ...
              }, "onclosetag") }), S.write(s2), S.end(), x.length && ((null === (j = this.options) || void 0 === j ? void 0 : j.reverseChapters) && x.reverse(), o2.chapters = x), o2.summary = o2.summary.trim(), [2, o2];
          }
        }));
      }));
