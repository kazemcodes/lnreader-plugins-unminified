...
var LNReaderPlugin = function () {
  ...
  var ReaperScans = /** @class */
  function () {
    function ReaperScans2() {
    ...
    __name(ReaperScans2, "ReaperScans");
    ReaperScans2.prototype.popularNovels = function (page) {
      return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
          return [2, this.query(page)];
        });
      });
    };
    ReaperScans2.prototype.parseNovel = function (novelPath) {
      return __awaiter(this, void 0, void 0, function () {
        var novelResp, novel, chaptersResp, chapters;
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              return [4, (0, fetch_1.fetchApi)("".concat(API_BASE, "/series/").concat(novelPath))];
            case 1:
              novelResp = _a.sent();
              return [4, novelResp.json()];
            case 2:
              novel = _a.sent();
              return [4, (0, fetch_1.fetchApi)("".concat(API_BASE, "/chapters/").concat(novelPath, "?perPage=").concat(Number.MAX_SAFE_INTEGER))];
            case 3:
              chaptersResp = _a.sent();
              return [4, chaptersResp.json()];
            case 4:
              ...
              return [2, {
                ...
                path: novelPath,
                chapters: chapters.reverse().map(function (chapter) {
                  return {
    ...
    ReaperScans2.prototype.parseChapter = function (chapterPath) {
      return __awaiter(this, void 0, void 0, function () {
        var result, body;
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              return [4, (0, fetch_1.fetchApi)("".concat(this.site, "/series/").concat(chapterPath), {
                headers: {
                  RSC: "1"
                }
              })];
            ...
            case 2:
              body = _a.sent();
              return [2, this.extractChapterContent(body)];
          }
        });
      });
    };
    ReaperScans2.prototype.extractChapterContent = function (chapter) {
    ...
    ReaperScans2.prototype.searchNovels = function (searchTerm) {
      return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
          return [2, this.query(1, searchTerm)];
        });
      });
    };
    ReaperScans2.prototype.query = function () {
      return __awaiter(this, arguments, void 0, function (page, search) {
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            ...
            case 2:
              json = _a.sent();
              return [2, json.data.map(function (novel) {
                return {
                  name: novel.title,
                  cover: novel.thumbnail.startsWith("novels/") ? MEDIA_BASE + novel.thumbnail : novel.thumbnail,
    ...
    ReaperScans2.prototype.getCoverUrl = function (thumbnail) {
