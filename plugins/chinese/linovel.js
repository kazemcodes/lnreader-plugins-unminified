...
var LNReaderPlugin = (() => {
  ...
  var n = (init_fetch2(), __toCommonJS(fetch_exports)), r = (init_browser(), __toCommonJS(browser_exports)), i = (init_novelStatus(), __toCommonJS(novelStatus_exports)), o = function() {
    function o2() {
      this.id = "linovel", this.name = "linovel", this.icon = "src/cn/linovel/icon.png", this.site = "https://www.linovel.net", this.version = "1.0.1", this.filters = void 0, this.imageRequestInit = void 0, this.userAgent = "Mozilla/5.0 (X11; Linux x86_64; rv:136.0) Gecko/20100101 Firefox/136.0";
    }
    __name(o2, "o");
    return o2.prototype.fetchHTML = function(i2) {
      ...
      return t(this, void 0, void 0, function() {
        ...
        return e(this, function(e2) {
          switch (e2.label) {
            case 0:
              return t2 = [], [4, this.fetchHTML(this.site)];
            case 1:
              return (n2 = e2.sent())("a.book-item-inner").each(function(e3, r2) {
                var i2, o3, a = n2(r2).find(".book-item-name").text().trim(), c = null !== (i2 = n2(r2).attr("href")) && void 0 !== i2 ? i2 : "", s = (null !== (o3 = n2(r2).find("img").attr("data-original")) && void 0 !== o3 ? o3 : "").replace(/!min300jpg$/, "");
                t2.push({ name: a, path: c, cover: s });
              }), [2, t2];
          }
        });
      });
      ...
      return t(this, void 0, void 0, function() {
        ...
        return e(this, function(e2) {
          switch (e2.label) {
            ...
            case 1:
              return t2 = e2.sent(), r2 = [], t2(".rank-book-list").find("a.search-book").each(function(e3, n3) {
