...
(() => {
    ...
    function c(c2) {
      return function(s) {
        return (function(c3) {
          ...
          for (; a && (a = 0, c3[0] && (o2 = 0)), o2; ) try {
            if (n2 = 1, r2 && (i2 = 2 & c3[0] ? r2.return : c3[0] ? r2.throw || ((i2 = r2.return) && i2.call(r2), 0) : r2.next) && !(i2 = i2.call(r2, c3[1])).done) return i2;
            switch (r2 = 0, i2 && (c3 = [2 & c3[0], i2.value]), c3[0]) {
              case 0:
              case 1:
                i2 = c3;
                break;
  ...
  var n = (init_fetch2(), __toCommonJS(fetch_exports)), r = (init_browser(), __toCommonJS(browser_exports)), i = (init_novelStatus(), __toCommonJS(novelStatus_exports)), o = (function() {
    function o2() {
      this.id = "linovel", this.name = "linovel", this.icon = "src/cn/linovel/icon.png", this.site = "https://www.linovel.net", this.version = "1.0.0", this.filters = void 0, this.imageRequestInit = void 0, this.userAgent = "Mozilla/5.0 (X11; Linux x86_64; rv:136.0) Gecko/20100101 Firefox/136.0";
    }
    __name(o2, "o");
    return o2.prototype.fetchHTML = function(i2) {
      return t(this, void 0, void 0, (function() {
        var t2;
        return e(this, (function(e2) {
          switch (e2.label) {
            case 0:
              return [4, (0, n.fetchText)(i2, { headers: { "User-Agent": this.userAgent } })];
            case 1:
              if ("" === (t2 = e2.sent())) throw Error("\u65E0\u6CD5\u83B7\u53D6\u5185\u5BB9\uFF0C\u8BF7\u68C0\u67E5\u7F51\u7EDC");
              return [2, (0, r.load)(t2)];
          }
        }));
      }));
      ...
      return t(this, arguments, void 0, (function(t2, n3) {
        ...
        return e(this, (function(t3) {
          switch (t3.label) {
            case 0:
              return r3 = [], [4, this.fetchHTML(this.site)];
            case 1:
              return (i2 = t3.sent())("a.book-item-inner").each((function(t4, e2) {
                var n4, o3, a = i2(e2).find(".book-item-name").text().trim(), c = null !== (n4 = i2(e2).attr("href")) && void 0 !== n4 ? n4 : "", s = (null !== (o3 = i2(e2).find("img").attr("data-original")) && void 0 !== o3 ? o3 : "").replace(/!min300jpg$/, "");
                r3.push({ name: a, path: c, cover: s });
              })), [2, r3];
          }
        }));
      }));
      ...
      return t(this, void 0, void 0, (function() {
        ...
        return e(this, (function(e2) {
          switch (e2.label) {
            case 0:
              return t2 = { path: n2, name: "Untitled" }, [4, this.fetchHTML(this.site + n2)];
            case 1:
              return (r2 = e2.sent())("div.name").find("a").each((function(e3, n3) {
                t2.author = r2(n3).text().trim();
              })), r2(".book-title").each((function(e3, n3) {
                t2.name = r2(n3).text().trim();
              })), r2(".book-data").find("span").each((function(e3, n3) {
                var o4 = r2(n3).text().trim();
                o4.includes("\u5B57\u6570") || o4.includes("\u70ED\u5EA6") || o4.includes("\u6536\u85CF") || ("\u8FDE\u8F7D\u4E2D" === o4 ? t2.status = i.NovelStatus.Ongoing : "\u5DF2\u5B8C\u7ED3" === o4 && (t2.status = i.NovelStatus.Completed));
              })), r2(".book-cover").find("img").each((function(e3, n3) {
                var i2;
                t2.cover = null !== (i2 = r2(n3).attr("src")) && void 0 !== i2 ? i2 : "";
              })), t2.genres = r2(".book-cats").children("a").map((function(t3, e3) {
                return r2(e3).text();
              })).toArray().join(","), t2.summary = r2(".about-text").text().trim(), o3 = [], r2("div.chapter").find("a").each((function(t3, e3) {
                var n3, i2 = r2(e3).text().trim(), a = null !== (n3 = r2(e3).attr("href")) && void 0 !== n3 ? n3 : "";
                o3.push({ name: i2, path: a });
              })), t2.chapters = o3, [2, t2];
          }
        }));
      }));
      ...
      return t(this, void 0, void 0, (function() {
        ...
        return e(this, (function(e2) {
          switch (e2.label) {
            case 0:
              return [4, this.fetchHTML(this.site + n2)];
            case 1:
              if (t2 = e2.sent(), r2 = "", t2(".fufei-app-download-hint").length) throw Error("\u672C\u7AE0\u8282\u9700\u8BA2\u9605\u540E\u624D\u80FD\u9605\u89C8\uFF0C\u8BF7\u4E0B\u8F7D\u8F7B\u4E4B\u6587\u5E93App\u8BA2\u9605");
              return t2(".article-text").find("p, img").each((function(e3, n3) {
                if ("img" === n3.tagName) {
                  var i2 = t2(n3).attr("src");
                  r2 += '<img src="'.concat(i2, '">\n');
                } else {
                  var o3 = t2(n3).text().trim();
                  r2 += "&nbsp;" === o3 ? "<br>\n" : "<p>".concat(o3, "</p>\n");
                }
              })), [2, r2.trim()];
          }
      ...
      return t(this, void 0, void 0, (function() {
        ...
        return e(this, (function(e2) {
          switch (e2.label) {
            case 0:
              return [4, this.fetchHTML(this.site + "/search/?kw=" + n2)];
            case 1:
              return t2 = e2.sent(), r3 = [], t2(".rank-book-list").find("a.search-book").each((function(e3, n3) {
                var i2, o3, a = t2(n3).find(".book-name").text().trim(), c = null !== (i2 = t2(n3).attr("href")) && void 0 !== i2 ? i2 : "", s = (null !== (o3 = t2(n3).find("img").attr("src")) && void 0 !== o3 ? o3 : "").replace(/!min300jpg$/, "");
                r3.push({ name: a, path: c, cover: s });
              })), [2, r3];
          }
        }));
