...
(() => {
  ...
  var r = (init_browser(), __toCommonJS(browser_exports)), n = (init_fetch2(), __toCommonJS(fetch_exports)), i = (init_defaultCover(), __toCommonJS(defaultCover_exports)), o = (init_novelStatus(), __toCommonJS(novelStatus_exports)), a = /* @__PURE__ */ __name(function(t2, e2) {
    if (t2) try {
    ...
    function c2() {
      this.id = "ixdzs8", this.name = "\u7231\u4E0B\u7535\u5B50\u4E66", this.site = "https://ixdzs8.com/", this.version = "2.2.8", this.icon = "src/cn/ixdzs8/favicon.png", this.imageRequestInit = { headers: { Referer: this.site } };
    }
    __name(c2, "c");
    return c2.prototype.popularNovels = function(o2) {
      return t(this, void 0, void 0, (function() {
        var t2, c3, s, l, u, h, f = this;
        return e(this, (function(e2) {
          switch (e2.label) {
            case 0:
              return t2 = "".concat(this.site, "hot/?page=").concat(o2), [4, (0, n.fetchApi)(t2)];
            case 1:
              return (c3 = e2.sent()).ok ? (l = r.load, [4, c3.text()]) : [2, []];
            case 2:
              return s = l.apply(void 0, [e2.sent()]), u = [], h = /* @__PURE__ */ new Set(), s("ul.u-list > li.burl").each((function(t3, e3) {
                var r2, n2, o3, c4, l2, p = s(e3), d = p.find(".l-info h3 a");
                o3 = null === (r2 = d.attr("href")) || void 0 === r2 ? void 0 : r2.trim(), c4 = (d.attr("title") || d.text() || "").trim(), l2 = null === (n2 = p.find(".l-img img").attr("src")) || void 0 === n2 ? void 0 : n2.trim(), o3 && c4 && (u.push({ name: c4, path: o3, cover: a(l2, f.site) || i.defaultCover }), h.add(o3));
              })), [2, u];
          }
        }));
      }));
    }, c2.prototype.parseNovel = function(c3) {
      return t(this, void 0, void 0, (function() {
        var t2, s, l, u, h, f, p, d, v, m, g, w, b, y, x;
        return e(this, (function(e2) {
          switch (e2.label) {
            case 0:
              if (!(t2 = a(c3, this.site))) throw new Error("Invalid novel URL");
              return [4, (0, n.fetchApi)(t2)];
            case 1:
              if (!(s = e2.sent()).ok) throw new Error("Failed to fetch novel");
              return u = r.load, [4, s.text()];
            case 2:
              return l = u.apply(void 0, [e2.sent()]), h = l("div.novel"), (f = l("p#intro.pintro")).find("span.icon").remove(), p = null === (x = f.html()) || void 0 === x ? void 0 : x.replace(/<br\s*\/?>/gi, "\n").replace(/<[^>]+>/g, "").replace(/\u3000/g, " ").replace(/&nbsp;/g, " ").split("\n").map((function(t3) {
                return t3.trim();
              })).filter((function(t3) {
                return t3.length > 0;
              })).join(" "), d = l("div.panel div.tags"), v = h.find(".n-text p span.lz").text().trim(), m = h.find(".n-text p span.end").text().trim(), g = "Unknown", g = m.length > 0 ? "Completed" : v.length > 0 ? "Ongoing" : "Unknown", w = { path: c3, name: h.find(".n-text h1").text().trim() || "Untitled", cover: a(h.find(".n-img img").attr("src"), this.site) || i.defaultCover, summary: p, author: h.find(".n-text p a.bauthor").text().trim() || void 0, genres: d.find("em a").map((function(t3, e3) {
                return l(e3).text().trim();
              })).get().filter((function(t3) {
                return t3.length > 0;
              })).join(", "), status: "Ongoing" === g ? o.NovelStatus.Ongoing : "Completed" === g ? o.NovelStatus.Completed : o.NovelStatus.Unknown, chapters: [] }, (b = l("#bid").attr("value")) ? (y = w, [4, this.parseChapterList(b)]) : [3, 4];
            case 3:
              y.chapters = e2.sent(), e2.label = 4;
            case 4:
              return [2, w];
          }
        }));
      }));
    }, c2.prototype.parseChapterList = function(r2) {
      return t(this, void 0, void 0, (function() {
        var t2, n2, i2, o2;
        return e(this, (function(e2) {
          switch (e2.label) {
            case 0:
              return t2 = String(r2), n2 = "".concat(this.site, "novel/clist/"), [4, fetch(n2, { method: "POST", headers: { "Content-Type": "application/x-www-form-urlencoded" }, body: "bid=".concat(t2) })];
            case 1:
              if (!(i2 = e2.sent()).ok) throw new Error("Failed to fetch chapters for bid=".concat(t2));
              return [4, i2.json()];
            case 2:
              if (200 !== (o2 = e2.sent()).rs || !Array.isArray(o2.data)) throw new Error("Invalid response format from chapter list");
              return [2, o2.data.map((function(e3) {
                return { name: e3.title, path: "0" === e3.ctype ? "read/".concat(t2, "/p").concat(e3.ordernum, ".html") : "", releaseTime: void 0 };
              }))];
          }
        }));
      }));
    }, c2.prototype.parseChapter = function(i2) {
      return t(this, void 0, void 0, (function() {
        var t2, o2, c3, s, l, u, h, f;
        return e(this, (function(e2) {
          switch (e2.label) {
            case 0:
              if (!(t2 = a(i2, this.site))) throw new Error("Invalid chapter URL");
              return [4, (0, n.fetchApi)(t2)];
            case 1:
              if (!(o2 = e2.sent()).ok) throw new Error("Failed to fetch chapter at ".concat(t2));
              return [4, o2.text()];
            case 2:
              return ((c3 = e2.sent()).includes("\u6B63\u5728\u9032\u884C\u5B89\u5168\u9A57\u8B49") || c3.includes("challenge")) && (s = c3.match(/let token\s*=\s*"([^"]+)"/)) ? (l = t2 + "?challenge=" + encodeURIComponent(s[1]), [4, (0, n.fetchApi)(l)]) : [3, 5];
            case 3:
              if (!(o2 = e2.sent()).ok) throw new Error("Failed after challenge redirect: ".concat(l));
              return [4, o2.text()];
            case 4:
              c3 = e2.sent(), e2.label = 5;
            case 5:
              return u = (0, r.load)(c3), (h = u("article section")).length ? (h.find('script, style, ins, iframe, [class*="abg"], [class*="ads"], [id*="ads"], [class*="google"], [id*="google"], [class*="recommend"], div[align="center"], p:contains("\u63A8\u85A6\u672C\u66F8"), a[href*="javascript:"]').remove(), h.find("p").each((function(t3, e3) {
                var r2 = u(e3);
                r2.text().trim() || r2.remove();
              })), h.contents().filter((function() {
                return "comment" === this.type;
              })).remove(), h.find("font").each((function(t3, e3) {
                var r2 = u(e3);
                r2.replaceWith(r2.html() || "");
              })), (f = h.html()) ? (f = f.replace(/<\s*p[^>]*>/gi, "\n\n").replace(/<\s*br[^>]*>/gi, "\n"), [2, (f = (0, r.load)("<div>".concat(f, "</div>")).text()).replace(/[\t ]+/g, " ").replace(/\n{3,}/g, "\n\n").trim()]) : [2, "Error: Chapter content was empty"]) : [2, "Error: Could not find chapter content at ".concat(t2)];
          }
        }));
      }));
    }, c2.prototype.searchNovels = function(o2, c3) {
      return t(this, void 0, void 0, (function() {
        var t2, c4, s, l, u, h, f = this;
        return e(this, (function(e2) {
          switch (e2.label) {
            case 0:
              t2 = "".concat(this.site, "bsearch?q=").concat(encodeURIComponent(o2)), c4 = "", e2.label = 1;
            case 1:
              return e2.trys.push([1, 4, , 5]), [4, (0, n.fetchApi)(t2)];
            case 2:
              if (!(s = e2.sent()).ok) throw new Error("Failed to fetch search results: HTTP ".concat(s.status));
              return [4, s.text()];
            case 3:
              return c4 = e2.sent(), [3, 5];
            case 4:
              if ((l = e2.sent()) instanceof Error) throw new Error("Failed to fetch search results: ".concat(l.message));
              throw l;
            case 5:
              return u = (0, r.load)(c4), h = [], u("ul.u-list li.burl").each((function(t3, e3) {
                var r2, n2, o3 = u(e3), c5 = null === (r2 = o3.attr("data-url")) || void 0 === r2 ? void 0 : r2.trim(), s2 = o3.find("h3.bname a").text().trim(), l2 = null === (n2 = o3.find(".l-img img").attr("src")) || void 0 === n2 ? void 0 : n2.trim();
                c5 && s2 && h.push({ name: s2, path: c5, cover: a(l2, f.site) || i.defaultCover });
              })), [2, h];
          }
        }));
      }));
