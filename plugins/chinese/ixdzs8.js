...
var LNReaderPlugin = (() => {
  ...
  var r = (init_browser(), __toCommonJS(browser_exports)), n = (init_fetch2(), __toCommonJS(fetch_exports)), i = (init_defaultCover(), __toCommonJS(defaultCover_exports)), o = (init_novelStatus(), __toCommonJS(novelStatus_exports)), a = /* @__PURE__ */ __name(function(t2, e2) {
    ...
    function c2() {
      this.id = "ixdzs8", this.name = "\u7231\u4E0B\u7535\u5B50\u4E66", this.site = "https://ixdzs8.com/", this.version = "2.2.9", this.icon = "src/cn/ixdzs8/favicon.png", this.imageRequestInit = { headers: { Referer: this.site } };
    }
    __name(c2, "c");
          ...
          switch (e2.label) {
            ...
            case 2:
              return s = l.apply(void 0, [e2.sent()]), u = [], h = /* @__PURE__ */ new Set(), s("ul.u-list > li.burl").each(function(t3, e3) {
                var r2, n2, o3 = s(e3), c4 = o3.find(".l-info h3 a"), l2 = null === (r2 = c4.attr("href")) || void 0 === r2 ? void 0 : r2.trim(), p = (c4.attr("title") || c4.text() || "").trim(), d = null === (n2 = o3.find(".l-img img").attr("src")) || void 0 === n2 ? void 0 : n2.trim();
                l2 && p && (u.push({ name: p, path: l2, cover: a(d, f.site) || i.defaultCover }), h.add(l2));
              }), [2, u];
          }
        });
      });
    ...
    }, c2.prototype.searchNovels = function(o2) {
      return t(this, void 0, void 0, function() {
        var t2, c3, s, l, u, h, f = this;
        return e(this, function(e2) {
          switch (e2.label) {
            case 0:
              t2 = "".concat(this.site, "bsearch?q=").concat(encodeURIComponent(o2)), c3 = "", e2.label = 1;
            case 1:
            ...
            case 2:
              ...
              return [4, s.text()];
            case 3:
              return c3 = e2.sent(), [3, 5];
            case 4:
              if ((l = e2.sent()) instanceof Error) throw new Error("Failed to fetch search results: ".concat(l.message));
              throw l;
            case 5:
              return u = (0, r.load)(c3), h = [], u("ul.u-list li.burl").each(function(t3, e3) {
                var r2, n2, o3 = u(e3), c4 = null === (r2 = o3.attr("data-url")) || void 0 === r2 ? void 0 : r2.trim(), s2 = o3.find("h3.bname a").text().trim(), l2 = null === (n2 = o3.find(".l-img img").attr("src")) || void 0 === n2 ? void 0 : n2.trim();
                c4 && s2 && h.push({ name: s2, path: c4, cover: a(l2, f.site) || i.defaultCover });
              }), [2, h];
          }
        });
      });
