...
(() => {
  ...
  var t = function() {
    ...
    return new (n2 || (n2 = Promise))((function(a2, i2) {
      ...
      function s2(t3) {
        var e3;
        t3.done ? a2(t3.value) : (e3 = t3.value, e3 instanceof n2 ? e3 : new n2((function(t4) {
          t4(e3);
        }))).then(o2, l2);
      }
      __name(s2, "s");
  ...
  var r = (init_filterInputs(), __toCommonJS(filterInputs_exports)), a = (init_fetch2(), __toCommonJS(fetch_exports)), i = (init_novelStatus(), __toCommonJS(novelStatus_exports)), o = (init_browser(), __toCommonJS(browser_exports)), l = (init_defaultCover(), __toCommonJS(defaultCover_exports)), s = /* @__PURE__ */ __name(function(t2) {
    if (t2) try {
      return new URL(t2, "https://www.quanben.io");
    } catch (t3) {
      return;
    }
  }, "s"), u = /* @__PURE__ */ __name(function(t2) {
    var e2 = s(t2);
    if (e2) {
      var n2 = e2.pathname.match(/^(\/amp)?(\/n\/[^\/]+\/)/);
      return null == n2 ? void 0 : n2[2];
    }
  }, "u"), c = /* @__PURE__ */ __name(function(t2, e2) {
    if (t2 && e2) try {
      return t2.startsWith("//") ? "https:" + t2 : /^https?:\/\//.test(t2) ? t2 : new URL(t2, e2).href;
    } catch (t3) {
      return;
    }
  }, "c"), h = (function() {
    function h2() {
      this.id = "quanben", this.name = "Quanben", this.site = "https://www.quanben.io/", this.version = "1.0.1", this.icon = "src/cn/quanben/icon.png", this.defaultCover = l.defaultCover, this.filters = { genre: { label: "\u5206\u7C7B", value: "all", options: [{ label: "\u5168\u90E8", value: "all" }, { label: "\u7384\u5E7B", value: "xuanhuan" }, { label: "\u90FD\u5E02", value: "dushi" }, { label: "\u8A00\u60C5", value: "yanqing" }, { label: "\u7A7F\u8D8A", value: "chuanyue" }, { label: "\u9752\u6625", value: "qingchun" }, { label: "\u4ED9\u4FA0", value: "xianxia" }, { label: "\u7075\u5F02", value: "lingyi" }, { label: "\u60AC\u7591", value: "xuanyi" }, { label: "\u5386\u53F2", value: "lishi" }, { label: "\u519B\u4E8B", value: "junshi" }, { label: "\u6E38\u620F", value: "youxi" }, { label: "\u7ADE\u6280", value: "jingji" }, { label: "\u79D1\u5E7B", value: "kehuan" }, { label: "\u804C\u573A", value: "zhichang" }, { label: "\u5B98\u573A", value: "guanchang" }, { label: "\u73B0\u8A00", value: "xianyan" }, { label: "\u803D\u7F8E", value: "danmei" }, { label: "\u5176\u5B83", value: "qita" }], type: r.FilterTypes.Picker } };
    }
    __name(h2, "h");
    return h2.prototype.popularNovels = function(t2, r2) {
      return e(this, arguments, void 0, (function(t3, e2) {
        var r3, i2, l2, s2, h3, f = this, p = e2.filters;
        return n(this, (function(t4) {
          switch (t4.label) {
            case 0:
              return r3 = "all" === p.genre.value ? this.site : "".concat(this.site, "c/").concat(p.genre.value, ".html"), [4, (0, a.fetchApi)(r3)];
            case 1:
              if (!(i2 = t4.sent()).ok) throw new Error("[Quanben] Failed to fetch: ".concat(r3, " - ").concat(i2.status));
              return s2 = o.load, [4, i2.text()];
            case 2:
              return l2 = s2.apply(void 0, [t4.sent()]), h3 = [], l2("div.list2").each((function(t5, e3) {
                var n2, r4, a2, i3 = l2(e3), o2 = i3.find("h3 > a").first(), s3 = null === (n2 = o2.attr("href")) || void 0 === n2 ? void 0 : n2.trim(), p2 = o2.text().trim(), v = (null === (r4 = i3.find("img").attr("src")) || void 0 === r4 ? void 0 : r4.trim()) || (null === (a2 = i3.find("img").attr("data-src")) || void 0 === a2 ? void 0 : a2.trim()), d = c(v, f.site) || f.defaultCover;
                if (s3 && p2) {
                  var b = u(s3);
                  b && h3.push({ name: p2, path: b, cover: d });
                }
              })), l2("ul.list").each((function(t5, e3) {
                var n2, r4 = l2(e3).find("li").first(), a2 = r4.find("a").first(), i3 = null === (n2 = a2.attr("href")) || void 0 === n2 ? void 0 : n2.trim(), o2 = a2.text().trim() || r4.find("span.author").text().trim(), s3 = f.defaultCover;
                if (i3 && o2) {
                  var c2 = u(i3);
                  c2 && h3.push({ name: o2, path: c2, cover: s3 });
                }
              })), [2, h3];
          }
        }));
      }));
    }, h2.prototype.parseNovel = function(t2) {
      return e(this, void 0, void 0, (function() {
        var e2, r2, l2, s2, u2, h3, f, p, v;
        return n(this, (function(n2) {
          switch (n2.label) {
            case 0:
              if (!(e2 = t2.replace(/^\/amp/, "")).startsWith("/n/") || !e2.endsWith("/")) throw new Error("[Quanben parseNovel] Invalid path: ".concat(t2));
              if (!(r2 = c(e2, this.site))) throw new Error("[Quanben parseNovel] Could not construct full URL");
              return [4, (0, a.fetchApi)(r2)];
            case 1:
              if (!(l2 = n2.sent()).ok) throw new Error("[Quanben parseNovel] Failed to fetch: ".concat(r2));
              return u2 = o.load, [4, l2.text()];
            case 2:
              return s2 = u2.apply(void 0, [n2.sent()]), h3 = s2("div.list2").first(), f = s2("div.description").first(), v = { path: e2, name: h3.find("h3").text().trim() || "Unknown Novel", cover: c(h3.find("img").attr("src"), this.site) || this.defaultCover, summary: f.find("p").text().trim() || f.text().trim() || void 0, author: h3.find("p:contains('\u4F5C\u8005:') span").text().trim() || void 0, status: i.NovelStatus.Unknown, genres: h3.find("p:contains('\u7C7B\u522B:') span").text().trim() || void 0 }, [4, this.parseChapterList(e2)];
            case 3:
              return v.chapters = n2.sent(), (p = v).status = i.NovelStatus.Completed, [2, p];
          }
        }));
      }));
    }, h2.prototype.parseChapterList = function(r2) {
      return e(this, void 0, void 0, (function() {
        var e2, i2, l2, u2, h3, f, p, v, d = this;
        return n(this, (function(n2) {
          switch (n2.label) {
            case 0:
              return r2.startsWith("/n/") && r2.endsWith("/") && (e2 = c(r2 + "list.html", this.site)) ? [4, (0, a.fetchApi)(e2)] : [2, []];
            case 1:
              return (i2 = n2.sent()).ok ? (u2 = o.load, [4, i2.text()]) : [2, []];
            case 2:
              return l2 = u2.apply(void 0, [n2.sent()]), h3 = [], (f = null === (v = r2.match(/\/n\/([^\/]+)\//)) || void 0 === v ? void 0 : v[1]) ? (l2("ul.list3 li a").each((function(t2, e3) {
                var n3 = l2(e3), r3 = n3.text().trim(), a2 = n3.attr("href");
                if (r3 && a2) {
                  var i3 = (function(t3) {
                    var e4 = s(t3);
                    if (e4) {
                      var n4 = e4.pathname.split("/").pop();
                      return n4 && /^\d+\.html$/.test(n4) ? n4 : void 0;
                    }
                  })(c(a2, d.site));
                  i3 && h3.push({ name: r3, path: "".concat(f, "/").concat(i3) });
                }
              })), (p = Array.from(new Map(h3.map((function(t2) {
                return [t2.path, t2];
              }))).values())).sort((function(t2, e3) {
                var n3, r3;
                return parseInt((null === (n3 = t2.path.match(/(\d+)\.html$/)) || void 0 === n3 ? void 0 : n3[1]) || "0", 10) - parseInt((null === (r3 = e3.path.match(/(\d+)\.html$/)) || void 0 === r3 ? void 0 : r3[1]) || "0", 10);
              })), [2, p.map((function(e3, n3) {
                return t(t({}, e3), { chapterNumber: n3 + 1 });
              }))]) : [2, []];
          }
        }));
      }));
    }, h2.prototype.parseChapter = function(t2) {
      return e(this, void 0, void 0, (function() {
        var e2, r2, i2;
        return n(this, (function(n2) {
          switch (n2.label) {
            case 0:
              if (!t2.includes("/") || t2.endsWith("/")) throw new Error('[Quanben] Invalid chapter path: "'.concat(t2, '"'));
              return e2 = "".concat(this.site, "n/").concat(t2), [4, (0, a.fetchApi)(e2)];
            case 1:
              if (!(r2 = n2.sent()).ok) throw new Error("[Quanben] Failed to fetch chapter: ".concat(e2));
              return i2 = this.extractChapterContent, [4, r2.text()];
            case 2:
              return [2, i2.apply(this, [n2.sent()])];
          }
        }));
      }));
    }, h2.prototype.extractChapterContent = function(t2) {
      var e2 = (0, o.load)(t2)("#contentbody, #content, .content").first();
      return e2.length ? (e2.find('script, style, ins, iframe, [class*="ads"], [id*="ads"], [class*="google"], [id*="google"], [class*="recommend"], div[align="center"]').remove(), (e2.html() || "").replace(/[\t ]+/g, " ").trim() || "Error: Chapter content empty.") : "Error: Chapter content not found.";
    }, h2.prototype.searchNovels = function(t2) {
      return e(this, void 0, void 0, (function() {
        var e2, r2, i2, l2, s2, h3 = this;
        return n(this, (function(n2) {
          switch (n2.label) {
            case 0:
              return e2 = "".concat(this.site, "index.php?c=book&a=search&keywords=").concat(encodeURIComponent(t2)), [4, (0, a.fetchApi)(e2)];
            case 1:
              return (r2 = n2.sent()).ok ? (l2 = o.load, [4, r2.text()]) : [2, []];
            case 2:
              return i2 = l2.apply(void 0, [n2.sent()]), s2 = [], i2("div.list2").each((function(t3, e3) {
                var n3 = i2(e3), r3 = n3.find("h3 > a").first(), a2 = r3.attr("href"), o2 = r3.text().trim(), l3 = c(n3.find("img").attr("src") || n3.find("img").attr("data-src"), h3.site);
                if (a2 && o2) {
                  var f = u(c(a2, h3.site));
                  f && s2.push({ name: o2, path: "/amp" + f, cover: l3 || h3.defaultCover });
                }
              })), [2, s2];
          }
        }));
      }));
    }, h2.prototype.fetchImage = function(t2) {
      return e(this, void 0, void 0, (function() {
        return n(this, (function(e2) {
          return [2, (0, a.fetchApi)(t2)];
        }));
      }));
    }, h2;
  })();
