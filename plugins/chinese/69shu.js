...
(() => {
  ...
  var r = (init_browser(), __toCommonJS(browser_exports)), a = (init_fetch2(), __toCommonJS(fetch_exports)), i = (init_filterInputs(), __toCommonJS(filterInputs_exports)), o = (init_novelStatus(), __toCommonJS(novelStatus_exports)), s = (function() {
    function s2() {
      this.fetchOptions = { headers: { "User-Agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:137.0) Gecko/20100101 Firefox/137.0", Accept: "text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,*/*;q=0.8", "Accept-Language": "en-US,us;q=0.5", Referer: "https://www.69shu.xyz/", DNT: "1", "Upgrade-Insecure-Requests": "1" } }, this.id = "69shu", this.name = "69\u4E66\u5427", this.icon = "src/cn/69shu/icon.png", this.site = "https://www.69shu.xyz", this.version = "0.2.2", this.filters = { rank: { label: "\u6392\u884C\u699C", value: "allvisit", options: [{ label: "\u603B\u6392\u884C\u699C", value: "allvisit" }, { label: "\u6708\u6392\u884C\u699C", value: "monthvisit" }, { label: "\u5468\u6392\u884C\u699C", value: "weekvisit" }, { label: "\u65E5\u6392\u884C\u699C", value: "dayvisit" }, { label: "\u6536\u85CF\u699C", value: "goodnum" }, { label: "\u5B57\u6570\u699C", value: "words" }, { label: "\u63A8\u8350\u699C", value: "allvote" }, { label: "\u65B0\u4E66\u699C", value: "postdate" }, { label: "\u66F4\u65B0\u699C", value: "lastupdate" }], type: i.FilterTypes.Picker }, sort: { label: "\u5206\u7C7B", value: "none", options: [{ label: "\u65E0", value: "none" }, { label: "\u5168\u90E8", value: "all" }, { label: "\u7384\u5E7B", value: "xuanhuan" }, { label: "\u4ED9\u4FA0", value: "xianxia" }, { label: "\u90FD\u5E02", value: "dushi" }, { label: "\u5386\u53F2", value: "lishi" }, { label: "\u6E38\u620F", value: "youxi" }, { label: "\u79D1\u5E7B", value: "kehuan" }, { label: "\u7075\u5F02", value: "kongbu" }, { label: "\u8A00\u60C5", value: "nvsheng" }, { label: "\u5176\u5B83", value: "qita" }], type: i.FilterTypes.Picker } };
    }
    __name(s2, "s");
    return s2.prototype.popularNovels = function(t2, i2) {
      return e(this, arguments, void 0, (function(t3, e2) {
        var i3, o2, s3, l, c = this, u = e2.showLatestNovels, h = e2.filters;
        return n(this, (function(e3) {
          switch (e3.label) {
            case 0:
              return i3 = u ? "".concat(this.site, "/rank/lastupdate/").concat(t3, ".html") : "none" === h.sort.value ? "".concat(this.site, "/rank/").concat(h.rank.value, "/").concat(t3, ".html") : "".concat(this.site, "/sort/").concat(h.sort.value, "/").concat(t3, ".html"), [4, (0, a.fetchText)(i3, this.fetchOptions)];
            case 1:
              if ("" === (o2 = e3.sent())) throw Error("\u65E0\u6CD5\u83B7\u53D6\u5C0F\u8BF4\u5217\u8868\uFF0C\u8BF7\u68C0\u67E5\u7F51\u7EDC");
              return s3 = (0, r.load)(o2), l = [], s3("div.book-coverlist").each((function(t4, e4) {
                var n2 = s3(e4).find("a.cover").attr("href"), r2 = s3(e4).find("h4.name").text().trim(), a2 = s3(e4).find("a.cover > img").attr("src");
                if (n2) {
                  var i4 = { name: r2, cover: a2, path: n2.replace(c.site, "") };
                  l.push(i4);
                }
              })), [2, l];
          }
      ...
      return e(this, void 0, void 0, (function() {
        var e2, i2, s3, l, c, u, h, f, p, v, d, b, m = this;
        return n(this, (function(w) {
          switch (w.label) {
            case 0:
              return e2 = this.site + t2, [4, (0, a.fetchText)(e2, this.fetchOptions)];
            case 1:
              if ("" === (i2 = w.sent())) throw Error("\u65E0\u6CD5\u83B7\u53D6\u5C0F\u8BF4\u5185\u5BB9\uFF0C\u8BF7\u68C0\u67E5\u7F51\u7EDC");
              if (s3 = (0, r.load)(i2), (l = { path: t2, chapters: [], name: s3("h1").text().trim() }).cover = s3("div.cover > img").attr("src"), l.summary = s3("#bookIntro").text().trim(), c = s3("div.caption-bookinfo > p"), l.author = c.find("a").attr("title"), l.artist = void 0, l.status = c.text().includes("\u8FDE\u8F7D") ? o.NovelStatus.Ongoing : o.NovelStatus.Completed, l.genres = "", u = [], !(h = s3("dd.all > a").attr("href"))) return [3, 5];
              f = new URL(h, this.site).toString(), p = true, v = /* @__PURE__ */ __name(function() {
                var t3, e3, i3, o2, s4;
                return n(this, (function(n2) {
                  switch (n2.label) {
                    case 0:
                      return [4, (0, a.fetchText)(f, d.fetchOptions)];
                    case 1:
                      if (t3 = n2.sent(), (e3 = (0, r.load)(t3))("dl.panel-chapterlist dd").each((function(t4, n3) {
                        var r2 = e3(n3).find("a").attr("href"), a2 = e3(n3).find("a").text().trim();
                        if (r2) {
                          var i4 = r2.startsWith("http") ? r2.replace(m.site, "") : r2;
                          u.some((function(t5) {
                            return t5.path === i4;
                          })) || u.push({ name: a2, path: i4 });
                        }
                      })), i3 = e3("div.listpage a.onclick").filter((function(t4, n3) {
                        return e3(n3).text().includes("\u4E0B\u4E00\u9875");
                      })), (o2 = i3.attr("href")) && "javascript:void(0);" !== o2) try {
                        (s4 = new URL(o2, d.site).toString()) === f ? p = false : f = s4;
                      } catch (t4) {
                        console.warn("Invalid next page link found: ".concat(o2)), p = false;
                      }
                      else p = false;
                      return [2];
                  }
            ...
            case 4:
              return [3, 6];
            case 5:
              s3("div.panel.hidden-xs > dl.panel-chapterlist:nth-child(2) > dd").each((function(t3, e3) {
                var n2 = s3(e3).find("a").attr("href"), r2 = s3(e3).find("a").text().trim();
                if (n2) {
                  var a2 = n2.startsWith("http") ? n2.replace(m.site, "") : n2;
                  u.push({ name: r2, path: a2 });
                }
              })), w.label = 6;
            case 6:
              return b = u.filter((function(t3, e3, n2) {
                return e3 === n2.findIndex((function(e4) {
                  return e4.path === t3.path;
                }));
              })), l.chapters = b, [2, l];
          }
        }));
      }));
    }, s2.prototype.parseChapter = function(t2) {
      return e(this, void 0, void 0, (function() {
        var e2, i2, o2;
        return n(this, (function(n2) {
          switch (n2.label) {
            case 0:
              return e2 = new URL(t2, this.site).toString(), [4, (0, a.fetchText)(e2, this.fetchOptions)];
            case 1:
              return i2 = n2.sent(), o2 = (0, r.load)(i2), [2, o2("#chaptercontent p").map((function(t3, e3) {
                return o2(e3).text();
              })).get().map((function(t3) {
                return t3.trim();
              })).filter((function(t3) {
                return "" !== t3 && !t3.includes("69\u4E66\u5427");
              })).map((function(t3) {
                return "<p>".concat(t3, "</p>");
              })).join("\n")];
          }
        }));
      }));
    }, s2.prototype.searchNovels = function(i2, o2) {
      return e(this, void 0, void 0, (function() {
        var e2, s3, l, c, u, h, f = this;
        return n(this, (function(n2) {
          switch (n2.label) {
            case 0:
              return o2 > 1 ? [2, []] : (e2 = "".concat(this.site, "/search"), (s3 = new FormData()).append("searchkey", i2), l = t(t({}, this.fetchOptions), { method: "post", body: s3, headers: t({}, this.fetchOptions.headers) }), [4, (0, a.fetchText)(e2, l)]);
            case 1:
              if ("" === (c = n2.sent())) throw Error("\u65E0\u6CD5\u83B7\u53D6\u641C\u7D22\u7ED3\u679C\uFF0C\u8BF7\u68C0\u67E5\u7F51\u7EDC");
              return u = (0, r.load)(c), h = [], u("div.book-coverlist").each((function(t2, e3) {
                var n3 = u(e3).find("a.cover").attr("href"), r2 = u(e3).find("h4.name").text().trim(), a2 = u(e3).find("a.cover > img").attr("src");
                if (n3) {
                  var i3 = { name: r2, cover: a2, path: n3.replace(f.site, "") };
                  h.push(i3);
                }
              })), [2, h];
          }
