...
(() => {
  ...
  // .js/plugins/portuguese/tsundoku.js
  var e = function() {
    return e = Object.assign || function(e2) {
      for (var t2, a2 = 1, l2 = arguments.length; a2 < l2; a2++) for (var r2 in t2 = arguments[a2]) Object.prototype.hasOwnProperty.call(t2, r2) && (e2[r2] = t2[r2]);
      return e2;
    }, e.apply(this, arguments);
  }, t = function(e2, t2, a2, l2) {
        ...
        return (function(o4) {
          ...
          for (; i2 && (i2 = 0, o4[0] && (n2 = 0)), n2; ) try {
            ...
            switch (l2 = 0, r2 && (o4 = [2 & o4[0], r2.value]), o4[0]) {
              ...
              case 5:
                n2.label++, l2 = o4[1], o4 = [0];
                continue;
              case 7:
                o4 = n2.ops.pop(), n2.trys.pop();
                continue;
              default:
                if (!(r2 = n2.trys, (r2 = r2.length > 0 && r2[r2.length - 1]) || 6 !== o4[0] && 2 !== o4[0])) {
                  n2 = 0;
                  continue;
                }
                ...
                if (6 === o4[0] && n2.label < r2[1]) {
                  n2.label = r2[1], r2 = o4;
                  break;
                }
                if (r2 && n2.label < r2[2]) {
                  n2.label = r2[2], n2.ops.push(o4);
                  break;
                }
  ...
  var r = (init_browser(), __toCommonJS(browser_exports)), n = (init_fetch2(), __toCommonJS(fetch_exports)), i = (init_defaultCover(), __toCommonJS(defaultCover_exports)), o = l(require_dayjs_min()), u = (init_filterInputs(), __toCommonJS(filterInputs_exports)), s = (function() {
    function l2() {
      this.id = "tsundoku", this.name = "Tsundoku Tradu\xE7\xF5es", this.version = "1.0.1", this.icon = "src/pt-br/tsundoku/icon.png", this.site = "https://tsundoku.com.br", this.filters = { order: { label: "Ordenar por", value: "", options: [{ label: "Padr\xE3o", value: "" }, { label: "A-Z", value: "title" }, { label: "Z-A", value: "titlereverse" }, { label: "Atualizar", value: "update" }, { label: "Adicionar", value: "latest" }, { label: "Popular", value: "popular" }], type: u.FilterTypes.Picker }, genre: { label: "G\xEAnero", value: [], options: [{ label: "A\xE7\xE3o", value: "328" }, { label: "Adult", value: "343" }, { label: "Anatomia", value: "408" }, { label: "Artes Marciais", value: "340" }, { label: "Aventura", value: "315" }, { label: "Ci\xEAncia", value: "398" }, { label: "Com\xE9dia", value: "322" }, { label: "Com\xE9dia Rom\xE2ntica", value: "378" }, { label: "Cotidiano", value: "399" }, { label: "Drama", value: "311" }, { label: "Ecchi", value: "329" }, { label: "Fantasia", value: "316" }, { label: "Feminismo", value: "362" }, { label: "Gender Bender", value: "417" }, { label: "Guerra", value: "368" }, { label: "Har\xE9m", value: "350" }, { label: "Hentai", value: "344" }, { label: "Hist\xF3ria", value: "400" }, { label: "Hist\xF3rico", value: "380" }, { label: "Horror", value: "317" }, { label: "Humor Negro", value: "363" }, { label: "Isekai", value: "318" }, { label: "Josei", value: "356" }, { label: "Joshikousei", value: "364" }, { label: "LitRPG", value: "387" }, { label: "Maduro", value: "351" }, { label: "M\xE1gia", value: "372" }, { label: "Mecha", value: "335" }, { label: "Militar", value: "414" }, { label: "Mist\xE9rio", value: "319" }, { label: "Otaku", value: "365" }, { label: "Psicol\xF3gico", value: "320" }, { label: "Reencarna\xE7\xE3o", value: "358" }, { label: "Romance", value: "312" }, { label: "RPG", value: "366" }, { label: "S\xE1tira", value: "367" }, { label: "Sci-fi", value: "371" }, { label: "Seinen", value: "326" }, { label: "Sexo Expl\xEDcito", value: "345" }, { label: "Shoujo", value: "323" }, { label: "Shounen", value: "341" }, { label: "Slice-of-Life", value: "324" }, { label: "Sobrenatural", value: "359" }, { label: "Supernatural", value: "401" }, { label: "Suspense", value: "407" }, { label: "Thriller", value: "410" }, { label: "Trag\xE9dia", value: "352" }, { label: "Vida Escolar", value: "331" }, { label: "Webtoon", value: "381" }, { label: "Xianxia", value: "357" }, { label: "Xuanhuan", value: "395" }, { label: "Yuri", value: "313" }], type: u.FilterTypes.CheckboxGroup } };
    }
    __name(l2, "l");
    return l2.prototype.parseDate = function(e2) {
      var t2 = e2.split(/,?\s+/), a2 = t2[0], l3 = t2[1], r2 = t2[2];
      return (0, o.default)("".concat(r2, "-").concat({ janeiro: 1, fevereiro: 2, marco: 3, abril: 4, maio: 5, junho: 6, julho: 7, agosto: 8, setembro: 9, outubro: 10, novembro: 11, dezembro: 12 }[a2.normalize("NFD").replace(/[\u0300-\u036f]/g, "")], "-").concat(l3)).toISOString();
    }, l2.prototype.parseNovels = function(e2) {
      var t2 = this, a2 = [];
      return e2(".listupd .bsx").each((function(l3, r2) {
        var n2 = e2(r2).find(".tt").text().trim(), o2 = e2(r2).find("a").attr("href"), u2 = e2(r2).find("img").attr("src");
        if (o2) {
          var s2 = { name: n2, cover: u2 || i.defaultCover, path: o2.replace(t2.site, "") };
          a2.push(s2);
        }
      })), a2;
    }, l2.prototype.popularNovels = function(e2, l3) {
      return t(this, arguments, void 0, (function(e3, t2) {
        var l4, i2, o2, u2, s2 = t2.showLatestNovels, c = t2.filters;
        return a(this, (function(t3) {
          switch (t3.label) {
            case 0:
              return l4 = new URLSearchParams(), e3 > 1 && l4.append("page", "".concat(e3)), l4.append("type", "novel"), s2 ? l4.append("order", "latest") : c && (c.genre.value.length && c.genre.value.forEach((function(e4) {
                l4.append("genre[]", e4);
              })), l4.append("order", c.order.value)), i2 = "".concat(this.site, "/manga/?") + l4.toString(), [4, (0, n.fetchApi)(i2).then((function(e4) {
                return e4.text();
              }))];
            case 1:
              return o2 = t3.sent(), u2 = (0, r.load)(o2), [2, this.parseNovels(u2)];
          }
        }));
      }));
    }, l2.prototype.parseNovel = function(l3) {
      return t(this, void 0, void 0, (function() {
        var t2, i2, o2, u2, s2 = this;
        return a(this, (function(a2) {
          switch (a2.label) {
            case 0:
              return [4, (0, n.fetchApi)(this.site + l3).then((function(e2) {
                return e2.text();
              }))];
            case 1:
              return t2 = a2.sent(), i2 = (0, r.load)(t2), (o2 = { path: l3, name: i2("h1.entry-title").text() || "Untitled", cover: i2(".main-info .thumb img").attr("src"), summary: i2(".entry-content.entry-content-single div:eq(0)").text().trim(), chapters: [] }).author = i2('.tsinfo .imptdt:contains("Autor")').text().replace("Autor ", "").trim(), o2.artist = i2('.tsinfo .imptdt:contains("Artista")').text().replace("Artista ", "").trim(), o2.status = i2('.tsinfo .imptdt:contains("Status")').text().replace("Status ", "").trim(), o2.genres = i2(".mgen a").map((function(e2, t3) {
                return i2(t3).text();
              })).toArray().join(","), u2 = [], i2("#chapterlist ul > li").each((function(e2, t3) {
                var a3 = i2(t3).find(".chapternum").text().trim(), l4 = i2(t3).find("a").attr("href"), r2 = i2(t3).find(".chapterdate").text();
                l4 && u2.push({ name: a3, path: l4.replace(s2.site, ""), releaseTime: s2.parseDate(r2) });
              })), o2.chapters = u2.reverse().map((function(t3, a3) {
                return e(e({}, t3), { name: t3.name + " - Ch. ".concat(a3 + 1), chapterNumber: a3 + 1 });
              })), [2, o2];
          }
        }));
      }));
    }, l2.prototype.searchNovels = function(e2, l3) {
      return t(this, void 0, void 0, (function() {
        var t2, i2, o2, u2;
        return a(this, (function(a2) {
          switch (a2.label) {
            case 0:
              return t2 = new URLSearchParams(), l3 > 1 && t2.append("page", "".concat(l3)), t2.append("type", "novel"), t2.append("title", e2), i2 = "".concat(this.site, "/manga/?") + t2.toString(), [4, (0, n.fetchApi)(i2).then((function(e3) {
                return e3.text();
              }))];
            case 1:
              return o2 = a2.sent(), u2 = (0, r.load)(o2), [2, this.parseNovels(u2)];
          }
        }));
      }));
    }, l2.prototype.parseChapter = function(e2) {
      return t(this, void 0, void 0, (function() {
        var t2, l3, i2, o2, u2, s2, c, p, v, h, b = this;
        return a(this, (function(a2) {
          switch (a2.label) {
            case 0:
              return [4, (0, n.fetchApi)(this.site + e2).then((function(e3) {
                return e3.text();
              }))];
            case 1:
              return t2 = a2.sent(), l3 = (0, r.load)(t2), i2 = l3(".headpost .entry-title").text(), o2 = l3(".headpost a").text(), u2 = i2.replace(o2, "").replace(/^\W+/, "").trim(), (s2 = l3("#readerarea .collapseomatic_content").html()) ? [2, "<h1>".concat(u2, "</h1>\n").concat(s2)] : ((c = l3("#readerarea")).find("img.wp-image-15656").remove(), c.find("p").each((function(e3, t3) {
                var a3, r2, n2 = l3(t3), i3 = n2.find("img"), o3 = null === (r2 = null === (a3 = n2.text()) || void 0 === a3 ? void 0 : a3.replace(/\s|&nbsp;/g, "")) || void 0 === r2 ? void 0 : r2.replace(b.site, "");
                0 === (null == i3 ? void 0 : i3.length) && 0 === (null == o3 ? void 0 : o3.length) && n2.remove();
              })), p = c.html() || "", v = p.split(/<hr ?\/?>/), h = v[v.length - 1], v.length > 1 && h.includes("https://discord") && v.pop(), [2, "<h1>".concat(u2, "</h1>\n").concat(v.join("<hr />"))]);
          }
        }));
      }));
    }, l2;
