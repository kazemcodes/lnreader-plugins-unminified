  ...
  var a = (init_fetch2(), __toCommonJS(fetch_exports)), n = (init_filterInputs(), __toCommonJS(filterInputs_exports)), o = (init_novelStatus(), __toCommonJS(novelStatus_exports)), i = new (function() {
    ...
    return n2.prototype.popularNovels = function(n3, o2) {
      return e(this, arguments, void 0, function(e2, n4) {
        var o3, i2, r, s, l, u, c = this, h = n4.filters, p = n4.showLatestNovels;
        return t(this, function(t2) {
          switch (t2.label) {
            case 0:
              return o3 = this.apiSite + "/books/", o3 += p ? "new" : (null === (s = null == h ? void 0 : h.sort) || void 0 === s ? void 0 : s.value) || "hot", (null === (l = null == h ? void 0 : h.category) || void 0 === l ? void 0 : l.value) && (o3 = this.apiSite + "/category/" + h.category.value), o3 += "/?page=" + (e2 - 1) + "&limit=20", [4, (0, a.fetchApi)(o3, { headers: { lang: this.lang } }).then(function(e3) {
                return e3.json();
              })];
            case 1:
      ...
      return e(this, void 0, void 0, function() {
        ...
        return t(this, function(t2) {
          switch (t2.label) {
            ...
            case 1:
              return e2 = t2.sent(), i2 = { name: e2.data.book.name, path: n3, cover: this.site + e2.data.book.image, summary: e2.data.book.authorize.description, author: e2.data.book.authorize.name, status: "updating" === e2.data.book.status ? o.NovelStatus.Ongoing : o.NovelStatus.Completed }, (null === (s = e2.data.tags.tags_name) || void 0 === s ? void 0 : s.length) && (i2.genres = e2.data.tags.tags_name.join(",")), (null === (l = e2.data.chapters) || void 0 === l ? void 0 : l.length) && (r = [], e2.data.chapters.forEach(function(e3, t3) {
