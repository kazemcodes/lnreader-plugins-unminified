...
var LNReaderPlugin = (() => {
  ...
  // .js/plugins/portuguese/LaNovels[hotnovelpub].js
  init_dirname();
  init_buffer2();
  init_process2();
  var e = function(e2, t2, a2, n2) {
    ...
    return r.next = s(0), r.throw = s(1), r.return = s(2), "function" == typeof Symbol && (r[Symbol.iterator] = function() {
      return this;
    }), r;
    function s(s2) {
      return function(l) {
        return function(s3) {
          ...
          for (; r && (r = 0, s3[0] && (i2 = 0)), i2; ) try {
            if (a2 = 1, n2 && (o2 = 2 & s3[0] ? n2.return : s3[0] ? n2.throw || ((o2 = n2.return) && o2.call(n2), 0) : n2.next) && !(o2 = o2.call(n2, s3[1])).done) return o2;
            switch (n2 = 0, o2 && (s3 = [2 & s3[0], o2.value]), s3[0]) {
              case 0:
              case 1:
                o2 = s3;
                break;
  ...
  var a = (init_fetch2(), __toCommonJS(fetch_exports)), n = (init_novelStatus(), __toCommonJS(novelStatus_exports)), o = function() {
    ...
    return o2.prototype.popularNovels = function(n2, o3) {
      return e(this, arguments, void 0, function(e2, n3) {
        var o4, i2, r, s, l, u, c = this, h = n3.filters, p = n3.showLatestNovels;
        return t(this, function(t2) {
          switch (t2.label) {
            case 0:
              return o4 = this.apiSite + "/books/", o4 += p ? "new" : (null === (s = null == h ? void 0 : h.sort) || void 0 === s ? void 0 : s.value) || "hot", (null === (l = null == h ? void 0 : h.category) || void 0 === l ? void 0 : l.value) && (o4 = this.apiSite + "/category/" + h.category.value), o4 += "/?page=" + (e2 - 1) + "&limit=20", [4, (0, a.fetchApi)(o4, { headers: { lang: this.lang } }).then(function(e3) {
                return e3.json();
              })];
            case 1:
      ...
      return e(this, void 0, void 0, function() {
        ...
        return t(this, function(t2) {
          switch (t2.label) {
            ...
            case 1:
              return e2 = t2.sent(), i2 = { name: e2.data.book.name, path: o3, cover: this.site + e2.data.book.image, summary: e2.data.book.authorize.description, author: e2.data.book.authorize.name, status: "updating" === e2.data.book.status ? n.NovelStatus.Ongoing : n.NovelStatus.Completed }, (null === (s = e2.data.tags.tags_name) || void 0 === s ? void 0 : s.length) && (i2.genres = e2.data.tags.tags_name.join(",")), (null === (l = e2.data.chapters) || void 0 === l ? void 0 : l.length) && (r = [], e2.data.chapters.forEach(function(e3, t3) {
