...
var LNReaderPlugin = (() => {
  ...
  var e = function(e2, a2, t2, l2) {
    ...
    var t2, l2, o2, i2 = { label: 0, sent: /* @__PURE__ */ __name(function() {
      ...
      return e(this, void 0, void 0, function() {
        ...
        return a(this, function(a2) {
          switch (a2.label) {
            ...
            case 1:
              return o2 = a2.sent(), r2 = { path: t2, name: "", genres: "", summary: "", author: "", artist: "", status: "", chapters: [] }, u3 = false, c = false, v = 0, h = false, p = false, d = false, b = false, f = false, m = false, g = false, y = 0, w = false, k = false, C = [], N = {}, S = this.hideLocked, x = new l.Parser({ onopentag: /* @__PURE__ */ __name(function(a3, t3) {
                var l2;
              ...
              }, "onclosetag") }), x.write(o2), x.end(), C.length && ((null === (P = this.options) || void 0 === P ? void 0 : P.reverseChapters) && C.reverse(), r2.chapters = C), r2.summary = r2.summary.trim(), [2, r2];
          }
        });
      });
