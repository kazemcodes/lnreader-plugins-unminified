...
(() => {
  ...
  // .js/plugins/portuguese/novelmania.js
  var e = function(e2, a2, t2, l2) {
    return new (t2 || (t2 = Promise))((function(n2, i2) {
      function r2(e3) {
        try {
          u(l2.next(e3));
        } catch (e4) {
      ...
      __name(u, "u");
      u((l2 = l2.apply(e2, a2 || [])).next());
    }));
  }, a = function(e2, a2) {
    var t2, l2, n2, i2 = { label: 0, sent: /* @__PURE__ */ __name(function() {
      ...
      return function(u) {
        return (function(o4) {
          ...
          for (; r2 && (r2 = 0, o4[0] && (i2 = 0)), i2; ) try {
            if (t2 = 1, l2 && (n2 = 2 & o4[0] ? l2.return : o4[0] ? l2.throw || ((n2 = l2.return) && n2.call(l2), 0) : l2.next) && !(n2 = n2.call(l2, o4[1])).done) return n2;
  ...
  var t = (init_fetch2(), __toCommonJS(fetch_exports)), l = (init_filterInputs(), __toCommonJS(filterInputs_exports)), n = (init_browser(), __toCommonJS(browser_exports)), i = (init_defaultCover(), __toCommonJS(defaultCover_exports)), r = (init_novelStatus(), __toCommonJS(novelStatus_exports)), o = (function() {
    function o2() {
      var e2 = this;
      this.id = "novelmania.com.br", this.name = "Novel Mania", this.icon = "src/pt-br/novelmania/icon.png", this.site = "https://novelmania.com.br", this.version = "1.0.1", this.imageRequestInit = void 0, this.resolveUrl = function(a2, t2) {
        return e2.site + (t2 ? "/book/" : "/chapter/") + a2;
      }, this.filters = { genres: { value: "", label: "G\xEAneros", options: [{ label: "Todos", value: "" }, { label: "A\xE7\xE3o", value: "01" }, { label: "Adulto", value: "02" }, { label: "Artes Marciais", value: "07" }, { label: "Aventura", value: "03" }, { label: "Com\xE9dia", value: "04" }, { label: "Cotidiano", value: "16" }, { label: "Drama", value: "23" }, { label: "Ecchi", value: "27" }, { label: "Er\xF3tico", value: "22" }, { label: "Escolar", value: "13" }, { label: "Fantasia", value: "05" }, { label: "Har\xE9m", value: "21" }, { label: "Isekai", value: "30" }, { label: "Magia", value: "26" }, { label: "Mecha", value: "08" }, { label: "Medieval", value: "31" }, { label: "Militar", value: "24" }, { label: "Mist\xE9rio", value: "09" }, { label: "Mitologia", value: "10" }, { label: "Psicol\xF3gico", value: "11" }, { label: "Realidade Virtual", value: "36" }, { label: "Romance", value: "12" }, { label: "Sci-fi", value: "14" }, { label: "Sistema de Jogo", value: "15" }, { label: "Sobrenatural", value: "17" }, { label: "Suspense", value: "29" }, { label: "Terror", value: "06" }, { label: "Wuxia", value: "18" }, { label: "Xianxia", value: "19" }, { label: "Xuanhuan", value: "20" }, { label: "Yaoi", value: "35" }, { label: "Yuri", value: "37" }], type: l.FilterTypes.Picker }, status: { label: "Status", value: "", options: [{ label: "Todos", value: "" }, { label: "Ativo", value: "ativo" }, { label: "Completo", value: "Completo" }, { label: "Pausado", value: "pausado" }, { label: "Parado", value: "Parado" }], type: l.FilterTypes.Picker }, type: { label: "Type", value: "", options: [{ label: "Todas", value: "" }, { label: "Americana", value: "americana" }, { label: "Angolana", value: "angolana" }, { label: "Brasileira", value: "brasileira" }, { label: "Chinesa", value: "chinesa" }, { label: "Coreana", value: "coreana" }, { label: "Japonesa", value: "japonesa" }], type: l.FilterTypes.Picker }, ordem: { label: "Ordenar", value: "", options: [{ label: "Qualquer ordem", value: "" }, { label: "Ordem alfab\xE9tica", value: "1" }, { label: "N\xBA de Cap\xEDtulos", value: "2" }, { label: "Popularidade", value: "3" }, { label: "Novidades", value: "4" }], type: l.FilterTypes.Picker } };
    }
    __name(o2, "o");
    return o2.prototype.popularNovels = function(l2, i2) {
      return e(this, arguments, void 0, (function(e2, l3) {
        var i3, r2, o3, u, s = l3.filters;
        return a(this, (function(a2) {
          switch (a2.label) {
            case 0:
              return i3 = "".concat(this.site, "/novels?titulo="), i3 += "&categoria=".concat(null == s ? void 0 : s.genres.value), i3 += "&status=".concat(null == s ? void 0 : s.status.value), i3 += "&nacionalidade=".concat(null == s ? void 0 : s.type.value), i3 += "&ordem=".concat(null == s ? void 0 : s.ordem.value), i3 += "&page%5Bpage%5D=".concat(e2), [4, (0, t.fetchApi)(i3).then((function(e3) {
                return e3.text();
              }))];
            case 1:
              return r2 = a2.sent(), o3 = (0, n.load)(r2), u = o3("div.top-novels.dark.col-6 > div.row.mb-2"), [2, u.map((function(e3, a3) {
                return { name: o3(a3).find("a.novel-title > h5").text(), cover: o3(a3).find("a > div.card.c-size-1.border > img.card-image").attr("src"), path: o3(a3).find("a.novel-title").attr("href") || "" };
      ...
      return e(this, void 0, void 0, (function() {
        ...
        return a(this, (function(a2) {
          switch (a2.label) {
            case 0:
              return [4, (0, t.fetchApi)(this.site + l2).then((function(e3) {
                return e3.text();
              }))];
            case 1:
              switch (e2 = a2.sent(), o3 = (0, n.load)(e2), u = { path: l2, name: o3("div.col-md-8 > div.novel-info > div.d-flex.flex-row.align-items-center > h1").text().trim() || "Sem t\xEDtulo" }, o3("b").remove(), u.name = o3("div.col-md-8 > div.novel-info > div.d-flex.flex-row.align-items-center > h1").text().trim() || "Sem t\xEDtulo", u.summary = o3("div.tab-pane.fade.show.active > div.text > p").map((function(e3, a3) {
                return o3(a3).text();
              })).toArray().join("\n\n").trim() || "", u.cover = o3("div.novel-img > img.img-responsive").attr("src") || i.defaultCover, u.author = o3("div.novel-info > span.authors.mb-1").text().trim(), u.genres = o3("div.tags > ul.list-tags.mb-0 > li > a").map((function(e3, a3) {
                return o3(a3).text();
              })).toArray().join(","), o3("div.novel-info > span.authors.mb-3").text().trim()) {
                case "Ativo":
                  u.status = r.NovelStatus.Ongoing;
                  break;
                case "Pausado":
                  u.status = r.NovelStatus.OnHiatus;
                  break;
                case "Completo":
                  u.status = r.NovelStatus.Completed;
                  break;
                default:
                  u.status = r.NovelStatus.Unknown;
              }
              return s = [], o3("div.accordion.capitulo > div.card > div.collapse > div.card-body.p-0 > ol > li").each((function(e3, a3) {
                var t2 = "".concat(o3(a3).find("a > span.sub-vol").text().trim(), " - ").concat(o3(a3).find("a > strong").text().trim()), l3 = o3(a3).find("a").attr("href");
                l3 && s.push({ name: t2, path: l3 });
              })), u.chapters = s, [2, u];
          }
        }));
      }));
      ...
      return e(this, void 0, void 0, (function() {
        ...
        return a(this, (function(a2) {
          switch (a2.label) {
            case 0:
              return [4, (0, t.fetchApi)("".concat(this.site).concat(l2)).then((function(e3) {
                return e3.text();
              }))];
            case 1:
              return e2 = a2.sent(), [2, (0, n.load)(e2)("div#chapter-content").html() || ""];
          }
        }));
      }));
      ...
      return e(this, void 0, void 0, (function() {
        ...
        return a(this, (function(a2) {
          switch (a2.label) {
            case 0:
              return e2 = "".concat(this.site, "/novels?titulo=").concat(l2, "&page%5Bpage%5D=").concat(i2), [4, (0, t.fetchApi)(e2).then((function(e3) {
                return e3.text();
              }))];
            case 1:
              return r2 = a2.sent(), o3 = (0, n.load)(r2), u = o3("div.top-novels.dark.col-6 > div.row.mb-2"), [2, u.map((function(e3, a3) {
