...
var LNReaderPlugin = function () {
  ...
  function () {
    ...
    __name(RNRF2, "RNRF");
    RNRF2.prototype.popularNovels = function (pageNo_1, _a) {
        ...
        return __generator(this, function (_g) {
          switch (_g.label) {
            case 0:
              ...
              url += showLatestNovels ? "lastPublishedChapter" : ((_c = filters === null || filters === void 0 ? void 0 : filters.sort) === null || _c === void 0 ? void 0 : _c.value) || "popular";
              url += "&page=" + pageNo;
            ...
            case 1:
              ...
              if (jsonRaw instanceof Array && jsonRaw[1]) {
                ...
                (_f = (_e = (_d = json.props.pageProps) === null || _d === void 0 ? void 0 : _d.totalData) === null || _e === void 0 ? void 0 : _e.items) === null || _f === void 0 ? void 0 : _f.forEach(function (novel) {
                  ...
                  return novels.push({
                    name: novel.title,
                    cover: ((_a2 = novel === null || novel === void 0 ? void 0 : novel.verticalImage) === null || _a2 === void 0 ? void 0 : _a2.url) ? _this.site + novel.verticalImage.url : defaultCover_1.defaultCover,
                    path: "/" + novel.slug
                  });
                });
              }
    ...
    RNRF2.prototype.parseNovel = function (novelPath) {
          ...
          switch (_d.label) {
            ...
            case 1:
              ...
              if (jsonRaw instanceof Array && jsonRaw[1]) {
                ...
                novel.cover = ((_a = book_1.verticalImage) === null || _a === void 0 ? void 0 : _a.url) ? this.site + book_1.verticalImage.url : defaultCover_1.defaultCover;
                novel.status = (book_1 === null || book_1 === void 0 ? void 0 : book_1.additionalInfo.includes("\u0410\u043A\u0442\u0438\u0432\u0435\u043D")) ? novelStatus_1.NovelStatus.Ongoing : novelStatus_1.NovelStatus.Completed;
                if (book_1.author) novel.author = book_1.author;
                if ((_b = book_1.genres) === null || _b === void 0 ? void 0 : _b.length) novel.genres = book_1 === null || book_1 === void 0 ? void 0 : book_1.genres.map(function (item) {
                  return item.title;
                }).join(",");
    ...
    RNRF2.prototype.parseChapter = function (chapterPath) {
      return __awaiter(this, void 0, void 0, function () {
    ...
    RNRF2.prototype.searchNovels = function (searchTerm) {
      return __awaiter(this, void 0, void 0, function () {
