...
var LNReaderPlugin = (() => {
  ...
  // .js/plugins/ukrainian/uaranobeclub.js
  init_dirname();
  init_buffer2();
  init_process2();
  var n = function(n2, t2, e2, i2) {
    return new (e2 || (e2 = Promise))(function(r2, o2) {
      ...
      function a(n3) {
        var t3;
        n3.done ? r2(n3.value) : (t3 = n3.value, t3 instanceof e2 ? t3 : new e2(function(n4) {
          n4(t3);
        })).then(u, s);
      }
      __name(a, "a");
      a((i2 = i2.apply(n2, t2 || [])).next());
    });
  }, t = function(n2, t2) {
    var e2, i2, r2, o2 = { label: 0, sent: /* @__PURE__ */ __name(function() {
      if (1 & r2[0]) throw r2[1];
      return r2[1];
    }, "sent"), trys: [], ops: [] }, u = Object.create(("function" == typeof Iterator ? Iterator : Object).prototype);
    ...
    function s(s2) {
      return function(a) {
        return function(s3) {
          ...
          for (; u && (u = 0, s3[0] && (o2 = 0)), o2; ) try {
            if (e2 = 1, i2 && (r2 = 2 & s3[0] ? i2.return : s3[0] ? i2.throw || ((r2 = i2.return) && r2.call(i2), 0) : i2.next) && !(r2 = r2.call(i2, s3[1])).done) return r2;
            switch (i2 = 0, r2 && (s3 = [2 & s3[0], r2.value]), s3[0]) {
              case 0:
              case 1:
                r2 = s3;
                break;
              ...
              case 5:
                o2.label++, i2 = s3[1], s3 = [0];
                continue;
              case 7:
                s3 = o2.ops.pop(), o2.trys.pop();
                continue;
              default:
                if (!(r2 = o2.trys, (r2 = r2.length > 0 && r2[r2.length - 1]) || 6 !== s3[0] && 2 !== s3[0])) {
                  o2 = 0;
                  continue;
                }
                ...
                if (6 === s3[0] && o2.label < r2[1]) {
                  o2.label = r2[1], r2 = s3;
                  break;
                }
                if (r2 && o2.label < r2[2]) {
                  o2.label = r2[2], o2.ops.push(s3);
                  break;
                }
  ...
  var e = (init_fetch2(), __toCommonJS(fetch_exports)), i = "https://uaranobe.club/", r = function() {
    function r2() {
    }
    __name(r2, "r");
    return r2.fetch = function(r3, o2) {
      return n(this, void 0, void 0, function() {
        return t(this, function(n2) {
          switch (n2.label) {
            case 0:
              return [4, (0, e.fetchApi)("".concat(i, "graphql"), { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ query: r3, variables: o2 }) })];
            case 1:
    ...
    }, r2.fetchChapter = function(e2, i2) {
      return n(this, void 0, void 0, function() {
        var n2;
        return t(this, function(t2) {
          switch (t2.label) {
            case 0:
              return n2 = { slug: e2, writingSlug: i2 }, [4, r2.fetch("\n            query EpisodeBySlug($slug: String!, $writingSlug: String!) {\n                episodeBySlug(slug: $slug, writingSlug: $writingSlug) {\n                    text\n                }\n            }\n        ", n2)];
            case 1:
              return [2, t2.sent().data.episodeBySlug.text];
          }
        });
      });
    }, r2.fetchNovel = function(e2) {
      return n(this, void 0, void 0, function() {
        var n2, i2, o2, u;
        return t(this, function(t2) {
          switch (t2.label) {
            case 0:
              return n2 = { slug: e2 }, [4, r2.fetch("\n        query Writing($slug: String!) {\n          writingBySlug(slug: $slug) {\n            id\n            title\n            originalTitle\n            image\n            slug\n            description\n            scanlators {\n              scanlator {\n                scanlatorName\n                username\n                episodes(oldestFirst: false, slug: $slug) {\n                  id\n                  subId\n                  seqTitle\n                  title\n                  slug\n                  __typename\n                }\n                __typename\n              }\n              __typename\n            }\n            genres {\n              genreId\n              genre {\n                id\n                name\n                __typename\n              }\n              __typename\n            }\n            __typename\n          }\n        }\n      ", n2)];
            case 1:
              return i2 = t2.sent(), [2, null !== (u = null === (o2 = null == i2 ? void 0 : i2.data) || void 0 === o2 ? void 0 : o2.writingBySlug) && void 0 !== u ? u : ""];
          }
        });
      });
    }, r2.fetchListWithNovel = function() {
      return n(this, arguments, void 0, function(n2, e2) {
        var i2;
        return void 0 === n2 && (n2 = 0), void 0 === e2 && (e2 = ""), t(this, function(t2) {
          switch (t2.label) {
            case 0:
              return i2 = { skip: n2, search: e2 }, [4, r2.fetch("\n        query Writings($skip: Int!, $search: String) {\n          writingsCount(search: $search)\n          writings(skip: $skip, search: $search) {\n            id\n            title\n            image\n            slug\n            __typename\n          }\n        }\n      ", i2)];
            case 1:
              return [2, t2.sent().data];
          }
        });
      });
    }, r2;
    ...
    function e2() {
      this.id = "uaranobeclub", this.name = "UA Ranobe Club", this.site = i, this.version = "1.1.4", this.icon = "src/uk/".concat(this.id, "/icon.png");
    }
    __name(e2, "e");
    return e2.prototype.popularNovels = function(e3) {
      return n(this, void 0, void 0, function() {
        var n2, i2, o2;
        return t(this, function(t2) {
          switch (t2.label) {
            case 0:
              return n2 = 10 * (e3 - 1), [4, r.fetchListWithNovel(n2, "")];
            case 1:
              return i2 = t2.sent(), [2, (null !== (o2 = null == i2 ? void 0 : i2.writings) && void 0 !== o2 ? o2 : []).map(function(n3) {
                return { name: n3.title, cover: n3.image, path: n3.slug };
              })];
          }
        });
      });
      ...
      return n(this, void 0, void 0, function() {
        var n2, o2, u, s, a, c, l, h, f;
        return t(this, function(t2) {
          switch (t2.label) {
            case 0:
              return n2 = e3.split(i).join(""), [4, r.fetchNovel(n2)];
            case 1:
              return o2 = t2.sent(), u = (null === (h = null === (l = null === (c = null === (a = o2.scanlators) || void 0 === a ? void 0 : a[0]) || void 0 === c ? void 0 : c.scanlator) || void 0 === l ? void 0 : l.episodes) || void 0 === h ? void 0 : h.map(function(t3) {
                var e4 = t3.title, i2 = t3.seqTitle, r2 = t3.slug, o3 = t3.subId;
                return { name: "".concat(i2, ". ").concat(e4), path: r2 + "#".concat(n2), chapterNumber: parseInt(o3, 10) };
              })) || [], s = { genres: (null === (f = o2.genres) || void 0 === f ? void 0 : f.map(function(n3) {
                return n3.genre.name;
              }).join(",")) || "", chapters: u, name: o2.title, path: o2.slug, summary: o2.description, cover: o2.image }, [2, s];
          }
        });
      });
      ...
      return n(this, void 0, void 0, function() {
        ...
        return t(this, function(t2) {
          switch (t2.label) {
            case 0:
              return n2 = e3.split(i).join("").split("#"), o2 = n2[0], u = n2[1], [4, r.fetchChapter(o2, u)];
            case 1:
              return [2, t2.sent()];
          }
        });
      });
    }, e2.prototype.searchNovels = function(e3, i2) {
      return n(this, void 0, void 0, function() {
        var n2, o2, u;
        return t(this, function(t2) {
          switch (t2.label) {
            case 0:
              return n2 = 10 * (i2 - 1), [4, r.fetchListWithNovel(n2, e3)];
            case 1:
              return o2 = t2.sent(), [2, (null !== (u = null == o2 ? void 0 : o2.writings) && void 0 !== u ? u : []).map(function(n3) {
                return { name: n3.title, cover: n3.image, path: n3.slug };
              })];
          }
        });
