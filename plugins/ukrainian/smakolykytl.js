...
var LNReaderPlugin = (() => {
  ...
  var require_dayjs_min = __commonJS({
    "node_modules/dayjs/dayjs.min.js"(exports4, module) {
      ...
      !function(t2, e2) {
        ...
        "use strict";
        var t2 = 1e3, e2 = 6e4, n2 = 36e5, r2 = "millisecond", i2 = "second", s = "minute", u2 = "hour", a2 = "day", o2 = "week", c = "month", f = "quarter", h = "year", d = "date", l = "Invalid Date", $ = /^(\d{4})[-/]?(\d{1,2})?[-/]?(\d{0,2})[Tt\s]*(\d{1,2})?:?(\d{1,2})?:?(\d{1,2})?[.:]?(\d+)?$/, y = /\[([^\]]+)]|Y{1,4}|M{1,4}|D{1,2}|d{1,4}|H{1,2}|h{1,2}|a|A|m{1,2}|s{1,2}|Z{1,2}|SSS/g, M = { name: "en", weekdays: "Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"), months: "January_February_March_April_May_June_July_August_September_October_November_December".split("_"), ordinal: /* @__PURE__ */ __name(function(t3) {
        ...
        var _ = function() {
          ...
          return m2.parse = function(t3) {
            ...
            var n3, o3 = b.p(t3), f2 = "set" + (this.$u ? "UTC" : ""), l2 = (n3 = {}, n3[a2] = f2 + "Date", n3[d] = f2 + "Date", n3[c] = f2 + "Month", n3[h] = f2 + "FullYear", n3[u2] = f2 + "Hours", n3[s] = f2 + "Minutes", n3[i2] = f2 + "Seconds", n3[r2] = f2 + "Milliseconds", n3)[o3], $2 = o3 === a2 ? this.$D + (e3 - this.$W) : e3;
            if (o3 === c || o3 === h) {
  ...
  // .js/plugins/ukrainian/smakolykytl.js
  init_dirname();
  init_buffer2();
  init_process2();
  var t = function(t2, e2, n2, r2) {
    ...
    return u2.next = a2(0), u2.throw = a2(1), u2.return = a2(2), "function" == typeof Symbol && (u2[Symbol.iterator] = function() {
      return this;
    }), u2;
    function a2(a3) {
      return function(l) {
  ...
  var r = (init_fetch2(), __toCommonJS(fetch_exports)), i = (init_novelStatus(), __toCommonJS(novelStatus_exports)), o = n(require_dayjs_min()), u = function() {
    function n2() {
      this.id = "smakolykytl", this.name = "\u0421\u043C\u0430\u043A\u043E\u043B\u0438\u043A\u0438", this.site = "https://smakolykytl.site/", this.apiSite = "https://api.smakolykytl.site/api/user", this.version = "1.0.1", this.icon = "src/uk/smakolykytl/icon.png";
    }
    __name(n2, "n");
    return n2.prototype.popularNovels = function(n3, i2) {
      return t(this, arguments, void 0, function(t2, n4) {
        var i3, o2, u2, a2, l = n4.showLatestNovels;
        return e(this, function(t3) {
          switch (t3.label) {
            case 0:
              return i3 = l ? "/updates" : "/projects", [4, (0, r.fetchApi)(this.apiSite + i3)];
            case 1:
              return [4, t3.sent().json()];
            case 2:
              return o2 = t3.sent(), u2 = [], null === (a2 = (null == o2 ? void 0 : o2.projects) || (null == o2 ? void 0 : o2.updates)) || void 0 === a2 || a2.forEach(function(t4) {
                return u2.push({ name: t4.title, cover: t4.image.url, path: "titles/" + t4.id });
              }), [2, u2];
          }
        });
      });
      ...
      return t(this, void 0, void 0, function() {
        var t2, u2, a2, l, s, c, p, h, f, d, v, b, y, m, j;
        return e(this, function(e2) {
          switch (e2.label) {
            case 0:
              return t2 = n3.split("/").pop(), [4, (0, r.fetchApi)(this.apiSite + "/projects/" + t2)];
            case 1:
              return [4, e2.sent().json()];
            case 2:
              return u2 = e2.sent(), a2 = { path: n3, name: (null === (p = null == u2 ? void 0 : u2.project) || void 0 === p ? void 0 : p.title) || "", cover: null === (f = null === (h = null == u2 ? void 0 : u2.project) || void 0 === h ? void 0 : h.image) || void 0 === f ? void 0 : f.url, summary: null === (d = null == u2 ? void 0 : u2.project) || void 0 === d ? void 0 : d.description, author: null === (v = null == u2 ? void 0 : u2.project) || void 0 === v ? void 0 : v.author, status: (null === (b = null == u2 ? void 0 : u2.project) || void 0 === b ? void 0 : b.status_translate.includes("\u0422\u0440\u0438\u0432\u0430\u0454")) ? i.NovelStatus.Ongoing : i.NovelStatus.Completed }, (l = [null === (y = null == u2 ? void 0 : u2.project) || void 0 === y ? void 0 : y.genres, null === (m = null == u2 ? void 0 : u2.project) || void 0 === m ? void 0 : m.tags].flat().map(function(t3) {
                return null == t3 ? void 0 : t3.title;
              }).filter(function(t3) {
                return t3;
              })).length && (a2.genres = l.join(", ")), s = [], [4, (0, r.fetchApi)(this.apiSite + "/projects/" + t2 + "/books")];
            case 3:
              return [4, e2.sent().json()];
            case 4:
              return c = e2.sent(), null === (j = null == c ? void 0 : c.books) || void 0 === j || j.forEach(function(t3) {
                var e3;
                return null === (e3 = null == t3 ? void 0 : t3.chapters) || void 0 === e3 ? void 0 : e3.forEach(function(e4) {
                  return s.push({ name: t3.title + " " + e4.title, path: "read/" + e4.id, releaseTime: (0, o.default)(e4.modifiedAt).format("LLL"), chapterNumber: s.length + 1 });
                });
              }), a2.chapters = s, [2, a2];
          }
        });
      ...
      return t(this, void 0, void 0, function() {
        ...
        return e(this, function(e2) {
          switch (e2.label) {
            case 0:
              return t2 = n3.split("/").pop(), [4, (0, r.fetchApi)(this.apiSite + "/chapters/" + t2)];
            case 1:
              return [4, e2.sent().json()];
            case 2:
              return i2 = e2.sent(), o2 = JSON.parse((null === (u2 = null == i2 ? void 0 : i2.chapter) || void 0 === u2 ? void 0 : u2.content) || "[]"), [2, a(o2)];
          }
        });
      });
      ...
      return t(this, void 0, void 0, function() {
        ...
        return e(this, function(e2) {
          switch (e2.label) {
            case 0:
              return [4, (0, r.fetchApi)(this.apiSite + "/projects")];
            case 1:
              return [4, e2.sent().json()];
            case 2:
              return t2 = e2.sent(), i2 = n3.toLowerCase(), o2 = [], null === (a2 = null === (u2 = null == t2 ? void 0 : t2.projects) || void 0 === u2 ? void 0 : u2.filter(function(t3) {
                var e3 = t3.title, r2 = t3.id;
                return e3.toLowerCase().includes(i2) || String(r2) == n3;
              })) || void 0 === a2 || a2.forEach(function(t3) {
                return o2.push({ name: t3.title, cover: t3.image.url, path: "titles/" + t3.id });
              }), [2, o2];
          }
        });
      });
  ...
  function a(t2, e2) {
    return void 0 === e2 && (e2 = ""), t2.forEach(function(t3) {
      switch (t3.type) {
        case "hardBreak":
          e2 += "<br>";
          break;
        ...
        case "image":
          if (t3.attrs) {
            var n2 = Object.entries(t3.attrs).filter(function(t4) {
              return null == t4 ? void 0 : t4[1];
            }).map(function(t4) {
              return "".concat(t4[0], '="').concat(t4[1], '"');
            });
            e2 += "<img " + n2.join("; ") + ">";
          }
          break;
        case "paragraph":
          e2 += "<p>" + (t3.content ? a(t3.content) : "<br>") + "</p>";
          break;
        case "text":
          e2 += t3.text;
          break;
        default:
          e2 += JSON.stringify(t3, null, "	");
      }
    }), e2;
  }
  __name(a, "a");
