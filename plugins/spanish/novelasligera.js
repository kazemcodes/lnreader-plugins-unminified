...
(() => {
  ...
  // .js/plugins/spanish/novelasligera.js
  var e = function() {
  ...
  var n = (init_browser(), __toCommonJS(browser_exports)), i = (init_fetch2(), __toCommonJS(fetch_exports)), o = (function() {
    function o2() {
      this.id = "novelasligera", this.name = "Novelas Ligera", this.icon = "src/es/novelasligera/icon.png", this.site = "https://novelasligera.com/", this.version = "1.0.0";
    }
    __name(o2, "o");
    return o2.prototype.popularNovels = function() {
      return t(this, void 0, void 0, (function() {
        var e2, t2, o3, a = this;
        return r(this, (function(r2) {
          switch (r2.label) {
            case 0:
              return [4, (0, i.fetchApi)(this.site)];
            case 1:
              return [4, r2.sent().text()];
            case 2:
              return e2 = r2.sent(), t2 = (0, n.load)(e2), o3 = [], t2(".elementor-column").each((function(e3, r3) {
                var n2 = t2(r3).find(".widget-image-caption.wp-caption-text").text();
                if (n2) {
                  var i2 = t2(r3).find("a > img").attr("data-lazy-src"), s = t2(r3).find("a").attr("href");
                  if (!s) return;
                  var c = { name: n2, cover: i2, path: s.replace(a.site, "") };
                  o3.push(c);
                }
              })), [2, o3];
          }
    ...
    }, o2.prototype.parseNovel = function(e2) {
      return t(this, void 0, void 0, (function() {
        var t2, o3, a, s, c, u = this;
        return r(this, (function(r2) {
          switch (r2.label) {
            case 0:
              return t2 = this.site + e2, [4, (0, i.fetchApi)(t2)];
            case 1:
              return [4, r2.sent().text()];
            case 2:
              return o3 = r2.sent(), a = (0, n.load)(o3), (s = { path: e2, name: a("h1").text() }).cover = a(".elementor-widget-container").find("img").attr("data-lazy-src"), a(".elementor-row").find("p").each((function() {
                a(this).text().includes("Autor:") && (s.author = a(this).text().replace("Autor:", "").trim()), a(this).text().includes("Estado:") && (s.status = a(this).text().replace("Estado: ", "").trim()), a(this).text().includes("G\xE9nero:") && (a(this).find("span").remove(), s.genres = a(this).text().replace(/,\s/g, ","));
              })), s.summary = a(".elementor-text-editor.elementor-clearfix").text(), c = [], a(".elementor-accordion-item").remove(), a(".elementor-tab-content").find("li").each((function(e3, t3) {
                var r3 = a(t3).text(), n2 = a(t3).find("a").attr("href");
                if (n2) {
                  var i2 = { name: r3, releaseTime: null, path: n2.replace(u.site, "") };
                  c.push(i2);
                }
              })), s.chapters = c, [2, s];
          }
        ...
        return r(this, (function(r2) {
          switch (r2.label) {
            ...
            case 1:
              return [4, r2.sent().text()];
            case 2:
              return o3 = r2.sent(), (a = (0, n.load)(o3))(".osny-nightmode.osny-nightmode--left").remove(), a(".code-block.code-block-1").remove(), a(".adsb30").remove(), a(".saboxplugin-wrap").remove(), a(".wp-post-navigation").remove(), [2, a(".entry-content").html() || ""];
          }
        }));
      }));
      ...
      return t(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r2) {
          switch (r2.label) {
            case 0:
              return t2 = this.site + "?s=" + o3 + "&post_type=wp-manga", [4, (0, i.fetchApi)(t2)];
            case 1:
              return [4, r2.sent().text()];
            case 2:
              return a = r2.sent(), s = (0, n.load)(a), c = [], s(".inside-article").each((function(e2, t3) {
                var r3, n2 = s(t3).find("img").attr("src"), i2 = s(t3).find("a").attr("href");
                if (i2 && (r3 = i2.replace(/-/g, " ").replace(/^./, (function(e3) {
                  return e3.toUpperCase();
                }))), i2 += "/", r3 && i2) {
                  var o4 = { name: r3, cover: n2, path: i2.replace(u.site, "") };
                  c.push(o4);
                }
              })), [2, c = [e({}, c[1])]];
          }
