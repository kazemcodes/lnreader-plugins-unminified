...
var LNReaderPlugin = (() => {
  ...
  // .js/plugins/spanish/LightNovelDaily[hotnovelpub].js
  init_dirname();
  init_buffer2();
  init_process2();
  var e = function(e2, t2, a2, n2) {
    return new (a2 || (a2 = Promise))(function(o2, i2) {
      function r(e3) {
        try {
          s(n2.next(e3));
        } catch (e4) {
      ...
      function s(e3) {
        var t3;
        e3.done ? o2(e3.value) : (t3 = e3.value, t3 instanceof a2 ? t3 : new a2(function(e4) {
          e4(t3);
        })).then(r, l);
      }
      __name(s, "s");
    ...
    var a2, n2, o2, i2 = { label: 0, sent: /* @__PURE__ */ __name(function() {
      if (1 & o2[0]) throw o2[1];
      return o2[1];
    }, "sent"), trys: [], ops: [] }, r = Object.create(("function" == typeof Iterator ? Iterator : Object).prototype);
    ...
    function l(l2) {
      return function(s) {
        return function(l3) {
          ...
          for (; r && (r = 0, l3[0] && (i2 = 0)), i2; ) try {
            if (a2 = 1, n2 && (o2 = 2 & l3[0] ? n2.return : l3[0] ? n2.throw || ((o2 = n2.return) && o2.call(n2), 0) : n2.next) && !(o2 = o2.call(n2, l3[1])).done) return o2;
            switch (n2 = 0, o2 && (l3 = [2 & l3[0], o2.value]), l3[0]) {
              case 0:
              case 1:
                o2 = l3;
                break;
              ...
              case 5:
                i2.label++, n2 = l3[1], l3 = [0];
                continue;
              case 7:
                l3 = i2.ops.pop(), i2.trys.pop();
                continue;
              default:
                if (!(o2 = i2.trys, (o2 = o2.length > 0 && o2[o2.length - 1]) || 6 !== l3[0] && 2 !== l3[0])) {
                  i2 = 0;
                  continue;
                }
                if (3 === l3[0] && (!o2 || l3[1] > o2[0] && l3[1] < o2[3])) {
                  i2.label = l3[1];
                  break;
                }
                if (6 === l3[0] && i2.label < o2[1]) {
                  i2.label = o2[1], o2 = l3;
                  break;
                }
                if (o2 && i2.label < o2[2]) {
                  i2.label = o2[2], i2.ops.push(l3);
                  break;
                }
  ...
  Object.defineProperty(exports, "__esModule", { value: true }), exports.HotNovelPubPlugin = void 0;
  var a = (init_fetch2(), __toCommonJS(fetch_exports)), n = (init_novelStatus(), __toCommonJS(novelStatus_exports)), o = function() {
    function o2(e2) {
      var t2, a2 = this;
      this.resolveUrl = function(e3) {
        return a2.site + "/" + e3;
      }, this.id = e2.id, this.name = e2.sourceName, this.icon = "multisrc/hotnovelpub/".concat(e2.id.toLowerCase(), "/icon.png"), this.site = e2.sourceSite, this.apiSite = e2.sourceSite.replace("://", "://api."), this.version = "1.0.1", this.filters = e2.filters, this.lang = (null === (t2 = e2.options) || void 0 === t2 ? void 0 : t2.lang) || "en";
    }
    __name(o2, "o");
    return o2.prototype.popularNovels = function(n2, o3) {
      return e(this, arguments, void 0, function(e2, n3) {
        var o4, i2, r, l, s, u, c = this, h = n3.filters, p = n3.showLatestNovels;
        return t(this, function(t2) {
          switch (t2.label) {
            case 0:
              return o4 = this.apiSite + "/books/", o4 += p ? "new" : (null === (l = null == h ? void 0 : h.sort) || void 0 === l ? void 0 : l.value) || "hot", (null === (s = null == h ? void 0 : h.category) || void 0 === s ? void 0 : s.value) && (o4 = this.apiSite + "/category/" + h.category.value), o4 += "/?page=" + (e2 - 1) + "&limit=20", [4, (0, a.fetchApi)(o4, { headers: { lang: this.lang } }).then(function(e3) {
                return e3.json();
              })];
            case 1:
              return i2 = t2.sent(), r = [], i2.status && (null === (u = i2.data.books.data) || void 0 === u ? void 0 : u.length) && i2.data.books.data.forEach(function(e3) {
                return r.push({ name: e3.name, cover: c.site + e3.image, path: e3.slug });
              }), [2, r];
          }
        });
      });
      ...
      return e(this, void 0, void 0, function() {
        ...
        return t(this, function(t2) {
          switch (t2.label) {
            case 0:
              return [4, (0, a.fetchApi)(this.apiSite + "/book/" + o3, { headers: { lang: this.lang } }).then(function(e3) {
                return e3.json();
              })];
            case 1:
              return e2 = t2.sent(), i2 = { name: e2.data.book.name, path: o3, cover: this.site + e2.data.book.image, summary: e2.data.book.authorize.description, author: e2.data.book.authorize.name, status: "updating" === e2.data.book.status ? n.NovelStatus.Ongoing : n.NovelStatus.Completed }, (null === (l = e2.data.tags.tags_name) || void 0 === l ? void 0 : l.length) && (i2.genres = e2.data.tags.tags_name.join(",")), (null === (s = e2.data.chapters) || void 0 === s ? void 0 : s.length) && (r = [], e2.data.chapters.forEach(function(e3, t3) {
                return r.push({ name: e3.title, path: e3.slug, releaseTime: void 0, chapterNumber: (e3.index || t3) + 1 });
              }), i2.chapters = r), [2, i2];
          }
        });
      });
      ...
      return e(this, void 0, void 0, function() {
        ...
        return t(this, function(t2) {
          switch (t2.label) {
            case 0:
              return [4, (0, a.fetchApi)(this.resolveUrl(n2)).then(function(e3) {
                return e3.text();
              })];
            case 1:
              return e2 = t2.sent(), (o3 = (null === (r = e2.match(/<div id="content-item" ([\s\S]*?)<\/div>/)) || void 0 === r ? void 0 : r[0]) || "") ? [4, (0, a.fetchApi)(this.site + "/server/getContent?slug=" + n2)] : [3, 4];
            case 2:
              return [4, t2.sent().json()];
            case 3:
              (i2 = t2.sent()).data && (o3 += i2.data.map(function(e3) {
                return "<p>" + e3 + "</p>";
              }).join("").replace(/\n/g, "</p><p>").replace(/\s/g, " ")), t2.label = 4;
            case 4:
              return [2, o3.replace(/\.copy right hot novel pub/g, "")];
          }
        });
      });
    }, o2.prototype.searchNovels = function(n2) {
      return e(this, void 0, void 0, function() {
        var e2, o3, i2;
        return t(this, function(t2) {
          switch (t2.label) {
            case 0:
              return [4, (0, a.fetchApi)(this.apiSite + "/search", { headers: { "Content-Type": "application/json;charset=utf-8", Referer: this.site, Origin: this.site, lang: this.lang }, method: "POST", body: JSON.stringify({ key_search: n2 }) }).then(function(e3) {
                return e3.json();
              })];
            case 1:
              return e2 = t2.sent(), o3 = [], e2.status && (null === (i2 = e2.data.books) || void 0 === i2 ? void 0 : i2.length) && e2.data.books.forEach(function(e3) {
                return o3.push({ name: e3.name, path: e3.slug });
              }), [2, o3];
          }
        });
      });
  ...
  exports.HotNovelPubPlugin = o;
  var i = new o({ id: "lightnoveldaily", sourceSite: "https://lightnoveldaily.com", sourceName: "LightNovelDaily", filters: { sort: { type: "Picker", label: "Order", value: "hot", options: [{ label: "Historia caliente", value: "hot" }, { label: "Nuevas cuentos", value: "new" }, { label: "Historia completa", value: "full" }] }, category: { type: "Picker", label: "Categor\xEDa", value: "", options: [{ label: "NONE", value: "" }, { label: "Acci\xF3n/Aventura", value: "accinaventura" }, { label: "Fantas\xEDa", value: "fantasa" }, { label: "Ficci\xF3n adolescente", value: "ficcin-adolescente" }, { label: "Hombre lobo/Vampiro", value: "hombre-lobovampiro" }, { label: "LGBTQ+", value: "lgbtq" }, { label: "Mafia", value: "mafia" }, { label: "Nuevo Adulto", value: "nuevo-adulto" }, { label: "Pornograf\xEDa", value: "pornografa" }, { label: "Rom\xE1ntico", value: "romntico" }, { label: "Urbano", value: "urbano" }] } }, options: { lang: "es", down: true, downSince: 1768289212956 } });
  exports.default = i;
})();
