...
var LNReaderPlugin = (() => {
  ...
  var a = (init_fetch2(), __toCommonJS(fetch_exports)), n = (init_filterInputs(), __toCommonJS(filterInputs_exports)), o = (init_novelStatus(), __toCommonJS(novelStatus_exports)), i = new (function() {
    function n2(e2) {
      var t2, a2 = this;
    ...
    __name(n2, "n");
    return n2.prototype.popularNovels = function(n3, o2) {
      return e(this, arguments, void 0, function(e2, n4) {
        var o3, i2, r, l, s, u, c = this, h = n4.filters, p = n4.showLatestNovels;
        return t(this, function(t2) {
          switch (t2.label) {
            case 0:
              return o3 = this.apiSite + "/books/", o3 += p ? "new" : (null === (l = null == h ? void 0 : h.sort) || void 0 === l ? void 0 : l.value) || "hot", (null === (s = null == h ? void 0 : h.category) || void 0 === s ? void 0 : s.value) && (o3 = this.apiSite + "/category/" + h.category.value), o3 += "/?page=" + (e2 - 1) + "&limit=20", [4, (0, a.fetchApi)(o3, { headers: { lang: this.lang } }).then(function(e3) {
                return e3.json();
              })];
            case 1:
      ...
      return e(this, void 0, void 0, function() {
        ...
        return t(this, function(t2) {
          switch (t2.label) {
            case 0:
              return [4, (0, a.fetchApi)(this.apiSite + "/book/" + n3, { headers: { lang: this.lang } }).then(function(e3) {
                return e3.json();
              })];
            case 1:
              return e2 = t2.sent(), i2 = { name: e2.data.book.name, path: n3, cover: this.site + e2.data.book.image, summary: e2.data.book.authorize.description, author: e2.data.book.authorize.name, status: "updating" === e2.data.book.status ? o.NovelStatus.Ongoing : o.NovelStatus.Completed }, (null === (l = e2.data.tags.tags_name) || void 0 === l ? void 0 : l.length) && (i2.genres = e2.data.tags.tags_name.join(",")), (null === (s = e2.data.chapters) || void 0 === s ? void 0 : s.length) && (r = [], e2.data.chapters.forEach(function(e3, t3) {
      ...
      return e(this, void 0, void 0, function() {
        ...
        return t(this, function(t2) {
          switch (t2.label) {
            case 0:
              return [4, (0, a.fetchApi)(this.resolveUrl(n3)).then(function(e3) {
                return e3.text();
              })];
            case 1:
              return e2 = t2.sent(), (o2 = (null === (r = e2.match(/<div id="content-item" ([\s\S]*?)<\/div>/)) || void 0 === r ? void 0 : r[0]) || "") ? [4, (0, a.fetchApi)(this.site + "/server/getContent?slug=" + n3)] : [3, 4];
            case 2:
              return [4, t2.sent().json()];
            case 3:
              (i2 = t2.sent()).data && (o2 += i2.data.map(function(e3) {
                return "<p>" + e3 + "</p>";
              }).join("").replace(/\n/g, "</p><p>").replace(/\s/g, " ")), t2.label = 4;
            case 4:
              return [2, o2.replace(/\.copy right hot novel pub/g, "")];
          }
        });
      });
      ...
      return e(this, void 0, void 0, function() {
        ...
        return t(this, function(t2) {
          switch (t2.label) {
            case 0:
              return [4, (0, a.fetchApi)(this.apiSite + "/search", { headers: { "Content-Type": "application/json;charset=utf-8", Referer: this.site, Origin: this.site, lang: this.lang }, method: "POST", body: JSON.stringify({ key_search: n3 }) }).then(function(e3) {
                return e3.json();
              })];
            case 1:
              return e2 = t2.sent(), o2 = [], e2.status && (null === (i2 = e2.data.books) || void 0 === i2 ? void 0 : i2.length) && e2.data.books.forEach(function(e3) {
                return o2.push({ name: e3.name, path: e3.slug });
              }), [2, o2];
          }
        });
      });
