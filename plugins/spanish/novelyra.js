...
var LNReaderPlugin = (() => {
  ...
  // .js/plugins/spanish/novelyra.js
  init_dirname();
  init_buffer2();
  init_process2();
  var e = function(e2, t2, a2, r2) {
    return new (a2 || (a2 = Promise))(function(n2, o2) {
      function i2(e3) {
        try {
          s2(r2.next(e3));
        } catch (e4) {
    ...
    var a2, r2, n2, o2 = { label: 0, sent: /* @__PURE__ */ __name(function() {
      if (1 & n2[0]) throw n2[1];
      return n2[1];
    }, "sent"), trys: [], ops: [] }, i2 = Object.create(("function" == typeof Iterator ? Iterator : Object).prototype);
    return i2.next = l2(0), i2.throw = l2(1), i2.return = l2(2), "function" == typeof Symbol && (i2[Symbol.iterator] = function() {
      return this;
    }), i2;
    function l2(l3) {
      return function(s2) {
        return function(l4) {
          ...
          for (; i2 && (i2 = 0, l4[0] && (o2 = 0)), o2; ) try {
            ...
            switch (r2 = 0, n2 && (l4 = [2 & l4[0], n2.value]), l4[0]) {
              ...
              case 5:
                o2.label++, r2 = l4[1], l4 = [0];
                continue;
              case 7:
                l4 = o2.ops.pop(), o2.trys.pop();
                continue;
              default:
                if (!(n2 = o2.trys, (n2 = n2.length > 0 && n2[n2.length - 1]) || 6 !== l4[0] && 2 !== l4[0])) {
                  o2 = 0;
                  continue;
                }
                ...
                if (6 === l4[0] && o2.label < n2[1]) {
                  o2.label = n2[1], n2 = l4;
                  break;
                }
                if (n2 && o2.label < n2[2]) {
                  o2.label = n2[2], o2.ops.push(l4);
                  break;
                }
  ...
  var a = (init_fetch2(), __toCommonJS(fetch_exports)), r = (init_filterInputs(), __toCommonJS(filterInputs_exports)), n = (init_browser(), __toCommonJS(browser_exports)), o = (init_defaultCover(), __toCommonJS(defaultCover_exports)), i = (init_novelStatus(), __toCommonJS(novelStatus_exports));
  function l(e2) {
    if (!e2) return null;
    var t2 = /* @__PURE__ */ new Date(), a2 = e2.trim().toLowerCase(), r2 = a2.match(/^(\d{1,2})\s+de\s+([a-z]+)\s+de\s+(\d{4})$/i);
    if (r2) {
      var n2 = parseInt(r2[1], 10), o2 = r2[2], i2 = parseInt(r2[3], 10), l2 = { enero: 0, febrero: 1, marzo: 2, abril: 3, mayo: 4, junio: 5, julio: 6, agosto: 7, septiembre: 8, octubre: 9, noviembre: 10, diciembre: 11 }[o2];
      if (void 0 !== l2) return (h = new Date(i2, l2, n2)).toISOString();
    }
    if (a2.startsWith("hace")) {
      var s2 = a2.replace(/\b(un|una)\b/g, "1").replace("un momento", "0 segundos");
      if (s2.includes("momento")) return t2.toISOString();
      var c = s2.match(/(\d+)\s+([a-zñáéíóú]+)/i);
      if (c) {
        var u = parseInt(c[1], 10), p = c[2], h = new Date(t2);
        return p.startsWith("segundo") ? h.setSeconds(h.getSeconds() - u) : p.startsWith("minuto") ? h.setMinutes(h.getMinutes() - u) : p.startsWith("hora") ? h.setHours(h.getHours() - u) : p.startsWith("dia") || p.startsWith("d\xEDa") ? h.setDate(h.getDate() - u) : p.startsWith("mes") ? h.setMonth(h.getMonth() - u) : (p.startsWith("a\xF1o") || p.startsWith("ano")) && h.setFullYear(h.getFullYear() - u), h.toISOString();
      }
    }
    try {
      var v = new Date(e2);
    ...
    throw new Error('Formato de fecha no soportado: "'.concat(e2, '"'));
  }
  __name(l, "l");
  var s = function() {
    function s2() {
      this.id = "novelyra", this.name = "Novelyra", this.icon = "src/es/novelyra/icon.png", this.site = "https://novelyra.com/", this.version = "1.0.0", this.filters = { genres: { type: r.FilterTypes.Picker, label: "Generos", value: "", options: [{ label: "Todos", value: "" }, { label: "Acci\xF3n", value: "accion" }, { label: "Aventura", value: "aventura" }, { label: "Fantas\xEDa", value: "fantasia" }, { label: "Artes Marciales", value: "artes-marciales" }, { label: "Har\xE9n", value: "haren" }, { label: "Romance", value: "romance" }, { label: "Sobrenatural", value: "sobrenatural" }, { label: "Xuanhuan", value: "xuanhuan" }, { label: "Xianxia", value: "xianxia" }, { label: "Comedia", value: "comedia" }, { label: "Ciencia Ficci\xF3n", value: "ciencia-ficcion" }, { label: "Misterio", value: "misterio" }, { label: "Maduro", value: "maduro" }, { label: "Psicol\xF3gico", value: "psicologico" }, { label: "Shounen", value: "shounen" }, { label: "Reencarnaci\xF3n", value: "reencarnacion" }, { label: "Mecha", value: "mecha" }, { label: "Vida Escolar", value: "vida-escolar" }, { label: "Josei", value: "josei" }, { label: "Drama", value: "drama" }, { label: "Urbano", value: "urbano" }, { label: "Oriental", value: "oriental" }, { label: "Horror", value: "horror" }, { label: "Tragedia", value: "tragedia" }, { label: "Juegos", value: "juegos" }] }, browse: { type: r.FilterTypes.Picker, label: "Novelas Populares", value: "browse.php", options: [{ label: "Todas las Novelas", value: "browse.php" }, { label: "\u{1F525} Hoy", value: "popular.php?period=today" }, { label: "\u{1F4C5} Este Mes", value: "popular.php?period=month" }, { label: "\u{1F451} De Siempre", value: "popular.php?period=alltime" }] } };
    }
    __name(s2, "s");
    return s2.prototype.loadNovels = function(e2, t2) {
      var a2 = this, r2 = [];
      return e2(t2).each(function(t3, n2) {
        var i2, l2 = e2(n2);
        r2.push({ name: l2.find("h3").text(), path: (null === (i2 = l2.find("a").attr("href")) || void 0 === i2 ? void 0 : i2.replace(a2.site, "")) || "", cover: l2.find("img").attr("src") || o.defaultCover });
      }), r2;
    }, s2.prototype.popularNovels = function(r2, o2) {
      return e(this, arguments, void 0, function(e2, r3) {
        var o3, i2, l2, s3, c, u, p, h, v, d = r3.showLatestNovels, f = r3.filters;
        return t(this, function(t2) {
          switch (t2.label) {
            case 0:
              return o3 = this.site, i2 = "#novelas .novel-card", l2 = null === (h = f.genres) || void 0 === h ? void 0 : h.value, s3 = null === (v = f.browse) || void 0 === v ? void 0 : v.value, d || (s3.startsWith("popular.php") ? (o3 = "".concat(this.site).concat(s3), i2 = ".popular-item") : ((c = new URLSearchParams()).append("page", String(e2)), l2 && c.append("genre", l2), o3 = "".concat(this.site).concat(s3, "?").concat(c.toString()), i2 = ".novels-grid .novel-card")), [4, (0, a.fetchApi)(o3)];
            case 1:
              return [4, t2.sent().text()];
            case 2:
              return u = t2.sent(), p = (0, n.load)(u), [2, this.loadNovels(p, i2)];
          }
        });
      });
    }, s2.prototype.parseNovel = function(r2) {
      return e(this, void 0, void 0, function() {
        var e2, s3, c, u, p = this;
        return t(this, function(t2) {
          switch (t2.label) {
            case 0:
            ...
            case 1:
              return [4, t2.sent().text()];
            case 2:
              return e2 = t2.sent(), s3 = (0, n.load)(e2), (c = { path: r2, name: s3("h1").text() }).cover = s3("img").attr("src") || o.defaultCover, c.genres = s3(".novel-meta .novel-genres").text().trim().replace("\n", ", "), c.status = i.NovelStatus.Completed, c.summary = s3(".novel-description-detail").text().trim(), u = [], s3(".chapter-item-wrapper").each(function(e3, t3) {
                var a2, r3 = s3(t3), n2 = r3.find(".chapter-number").text().match(/(\d+)/), o2 = n2 ? parseInt(n2[1]) : 0, i2 = { name: r3.find(".chapter-title").text(), path: (null === (a2 = r3.find("a").attr("href")) || void 0 === a2 ? void 0 : a2.replace(p.site, "")) || "", releaseTime: l(r3.find(".chapter-date").text()), chapterNumber: o2 };
                u.push(i2);
              }), c.chapters = u, [2, c];
          }
        });
      ...
      return e(this, void 0, void 0, function() {
        var e2, o2, i2, l2, s3, c, u;
        return t(this, function(t2) {
          switch (t2.label) {
            case 0:
              return (e2 = new Headers()).set("User-Agent", "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/121.0.0.0 Safari/537.36"), e2.set("Accept", "text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8"), e2.set("Accept-Language", "es-ES,es;q=0.9"), e2.set("Referer", this.site), e2.set("Cache-Control", "no-cache"), [4, (0, a.fetchApi)(this.site + r2, { method: "GET", headers: e2 })];
            case 1:
              return [4, t2.sent().text()];
            case 2:
              return o2 = t2.sent(), (i2 = (0, n.load)(o2))("script").remove(), i2(".chapter-ad").remove(), i2("ins").remove(), l2 = i2(".chapter-content"), s3 = [], c = [], u = ["b", "i", "u", "strong", "em", "span"], l2.contents().each(function(e3, t3) {
                switch (t3.type) {
                  case "text":
                    t3.data.trim() && s3.push(t3.data.trim());
                    break;
                  case "tag":
                    var a2 = t3.tagName;
                    if (u.includes(a2)) s3.push(i2.html(t3));
                    else {
                      if (s3.length > 0 && (c.push("<p>".concat(s3.join(" ").trim(), "</p>")), s3 = [], "br" === a2)) break;
                      c.push(i2.html(t3));
                    }
                }
              }), s3.length > 0 && c.push("<p>".concat(s3.join(" ").trim(), "</p>")), [2, c.join("")];
          }
        });
      });
    }, s2.prototype.searchNovels = function(r2, o2) {
      return e(this, void 0, void 0, function() {
        var e2, o3, i2;
        return t(this, function(t2) {
          switch (t2.label) {
            case 0:
              return r2 = r2.toLowerCase(), e2 = "".concat(this.site, "?search=").concat(encodeURIComponent(r2)), [4, (0, a.fetchApi)(e2)];
            case 1:
              return [4, t2.sent().text()];
            case 2:
              return o3 = t2.sent(), i2 = (0, n.load)(o3), [2, this.loadNovels(i2, "#novelas .novel-card")];
          }
        });
      });
    }, s2;
