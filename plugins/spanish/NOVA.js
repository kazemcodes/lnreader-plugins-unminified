...
var LNReaderPlugin = (() => {
  ...
  // .js/plugins/spanish/NOVA.js
  init_dirname();
  init_buffer2();
  init_process2();
  var t, e = Object.create ? function(t2, e2, r2, n2) {
    void 0 === n2 && (n2 = r2);
    var a2 = Object.getOwnPropertyDescriptor(e2, r2);
    a2 && !("get" in a2 ? !e2.__esModule : a2.writable || a2.configurable) || (a2 = { enumerable: true, get: /* @__PURE__ */ __name(function() {
      return e2[r2];
    }, "get") }), Object.defineProperty(t2, n2, a2);
  } : function(t2, e2, r2, n2) {
    void 0 === n2 && (n2 = r2), t2[n2] = e2[r2];
  }, r = Object.create ? function(t2, e2) {
    Object.defineProperty(t2, "default", { enumerable: true, value: e2 });
  } : function(t2, e2) {
    t2.default = e2;
  }, n = (t = /* @__PURE__ */ __name(function(e2) {
    return t = Object.getOwnPropertyNames || function(t2) {
      var e3 = [];
      for (var r2 in t2) Object.prototype.hasOwnProperty.call(t2, r2) && (e3[e3.length] = r2);
      return e3;
    }, t(e2);
  }, "t"), function(n2) {
    if (n2 && n2.__esModule) return n2;
    var a2 = {};
    if (null != n2) for (var i2 = t(n2), o2 = 0; o2 < i2.length; o2++) "default" !== i2[o2] && e(a2, n2, i2[o2]);
    return r(a2, n2), a2;
  }), a = function(t2, e2, r2, n2) {
    ...
    return o2.next = c2(0), o2.throw = c2(1), o2.return = c2(2), "function" == typeof Symbol && (o2[Symbol.iterator] = function() {
      return this;
    }), o2;
    function c2(c3) {
      return function(s2) {
        return function(c4) {
          ...
          for (; o2 && (o2 = 0, c4[0] && (i2 = 0)), i2; ) try {
            if (r2 = 1, n2 && (a2 = 2 & c4[0] ? n2.return : c4[0] ? n2.throw || ((a2 = n2.return) && a2.call(n2), 0) : n2.next) && !(a2 = a2.call(n2, c4[1])).done) return a2;
            switch (n2 = 0, a2 && (c4 = [2 & c4[0], a2.value]), c4[0]) {
              case 0:
              case 1:
                a2 = c4;
                break;
              ...
              case 7:
                ...
                continue;
              default:
                if (!(a2 = i2.trys, (a2 = a2.length > 0 && a2[a2.length - 1]) || 6 !== c4[0] && 2 !== c4[0])) {
                  i2 = 0;
                  continue;
                }
                if (3 === c4[0] && (!a2 || c4[1] > a2[0] && c4[1] < a2[3])) {
                  i2.label = c4[1];
                  break;
                }
                if (6 === c4[0] && i2.label < a2[1]) {
                  i2.label = a2[1], a2 = c4;
                  break;
                }
                if (a2 && i2.label < a2[2]) {
                  i2.label = a2[2], i2.ops.push(c4);
                  break;
                }
  ...
  var o = (init_fetch2(), __toCommonJS(fetch_exports)), c = (init_novelStatus(), __toCommonJS(novelStatus_exports)), s = n((init_browser(), __toCommonJS(browser_exports))), u = function() {
    function t2() {
      this.id = "nova", this.name = "NOVA", this.icon = "src/es/nova/icon.png", this.site = "https://novelasligeras.net", this.version = "1.1.0", this.CHAPTER_REGEX = /(Parte \d+) . (.+?): (.+)/;
    }
    __name(t2, "t");
    return t2.prototype.bypassCloudflareImages = function(t3, e2) {
      return a(this, void 0, void 0, function() {
        return i(this, function(r2) {
          return e2.find("img").each(function(e3, r3) {
            var n2 = t3(r3), a2 = n2.attr("src") || n2.attr("data-src") || n2.attr("data-cfsrc");
            a2 && (n2.attr("src", a2), n2.removeAttr("data-src"), n2.removeAttr("data-cfsrc"));
          }), [2, e2.html() || ""];
        });
      });
    }, t2.prototype.htmlToText = function(t3) {
      if (!t3) return "";
      var e2 = s.load(t3);
      return e2("script, style").remove(), e2.text().trim();
    }, t2.prototype.popularNovels = function(t3, e2) {
      return a(this, void 0, void 0, function() {
        var e3, r2, n2, a2, c2 = this;
        return i(this, function(i2) {
          switch (i2.label) {
            case 0:
              return 1 === t3 ? [2, this.searchNovels("", 1)] : (e3 = "".concat(this.site, "/index.php/page/").concat(t3, "/?post_type=product&orderby=popularity"), [4, (0, o.fetchApi)(e3).then(function(t4) {
                return t4.text();
              })]);
            case 1:
              return r2 = i2.sent(), n2 = s.load(r2), a2 = [], n2(".dt-css-grid div.wf-cell").each(function(t4, e4) {
                var r3, i3 = n2(e4), o2 = i3.find("img"), s2 = i3.find("h4.entry-title a"), u2 = (null === (r3 = s2.attr("href")) || void 0 === r3 ? void 0 : r3.replace(c2.site, "")) || "", l = s2.text().trim(), p = o2.attr("data-src") || o2.attr("data-cfsrc") || o2.attr("src") || "";
                l && u2 && a2.push({ name: l, path: u2, cover: p });
              }), [2, a2];
          }
        });
      });
    }, t2.prototype.searchNovels = function(t3, e2) {
      return a(this, void 0, void 0, function() {
        var r2, n2, a2, c2, u2, l, p, d = this;
        return i(this, function(i2) {
          switch (i2.label) {
            case 0:
              return r2 = [], e2 > 1 ? (n2 = encodeURIComponent(t3), u2 = "".concat(this.site, "/index.php/page/").concat(e2, "/?s=").concat(n2, "&post_type=product&title=1&excerpt=1&content=0&categories=1&attributes=1&tags=1&sku=0&orderby=popularity&ixwps=1"), [4, (0, o.fetchApi)(u2).then(function(t4) {
                return t4.text();
              })]) : [3, 2];
            case 1:
              return a2 = i2.sent(), (c2 = s.load(a2))(".dt-css-grid div.wf-cell").each(function(t4, e3) {
                var n3, a3 = c2(e3), i3 = a3.find("img"), o2 = a3.find("h4.entry-title a"), s2 = (null === (n3 = o2.attr("href")) || void 0 === n3 ? void 0 : n3.replace(d.site, "")) || "", u3 = o2.text().trim(), l2 = i3.attr("data-src") || i3.attr("data-cfsrc") || i3.attr("src") || "";
                u3 && s2 && r2.push({ name: u3, path: s2, cover: l2 });
              }), [3, 5];
            case 2:
              return u2 = "".concat(this.site, "/wp-admin/admin-ajax.php?tags=1&sku=&limit=30&category_results=&order=DESC&category_limit=5&order_by=title&product_thumbnails=1&title=1&excerpt=1&content=&categories=1&attributes=1"), (l = new FormData()).append("action", "product_search"), l.append("product-search", "1"), l.append("product-query", t3), [4, (0, o.fetchApi)(u2, { method: "POST", body: l })];
            case 3:
              return [4, i2.sent().json()];
            case 4:
              p = i2.sent(), Array.isArray(p) && p.forEach(function(t4) {
                var e3, n3 = (null === (e3 = t4.url) || void 0 === e3 ? void 0 : e3.replace(d.site, "")) || "", a3 = t4.title || "", i3 = t4.thumbnail || "";
                a3 && n3 && r2.push({ name: a3, path: n3, cover: i3 });
              }), i2.label = 5;
            case 5:
              return [2, r2];
          }
      ...
      return a(this, void 0, void 0, function() {
        var e2, r2, n2, a2, u2, l, p, d, h, f, v, m, b, y, _ = this;
        return i(this, function(i2) {
          switch (i2.label) {
            case 0:
              return e2 = "".concat(this.site).concat(t3), [4, (0, o.fetchApi)(e2).then(function(t4) {
                return t4.text();
              })];
            case 1:
              return r2 = i2.sent(), n2 = s.load(r2), a2 = n2("h1").first().text().trim(), u2 = n2(".woocommerce-product-gallery").find("img").first(), l = u2.attr("src") || u2.attr("data-cfsrc") || u2.attr("data-src") || "", p = n2(".woocommerce-product-attributes-item--attribute_pa_escritor td").text().trim() || "Desconocido", d = n2(".woocommerce-product-attributes-item--attribute_pa_ilustrador td").text().trim() || "", h = n2(".woocommerce-product-details__short-description").html(), f = this.htmlToText(h), v = n2(".woocommerce-product-attributes-item--attribute_pa_estado td").text().trim().toLowerCase(), m = c.NovelStatus.Unknown, v.includes("en curso") || v.includes("ongoing") ? m = c.NovelStatus.Ongoing : (v.includes("completado") || v.includes("completed")) && (m = c.NovelStatus.Completed), b = [], y = 0, n2(".vc_row div.vc_column-inner > div.wpb_wrapper").each(function(t4, e3) {
                var r3 = n2(e3), a3 = r3.find(".dt-fancy-title").first().text().trim();
                a3.startsWith("Volumen") && r3.find(".wpb_tab a").each(function(t5, e4) {
                  var r4, i3 = n2(e4), o2 = i3.text().trim(), c2 = (null === (r4 = i3.attr("href")) || void 0 === r4 ? void 0 : r4.replace(_.site, "")) || "";
                  if (c2) {
                    var s2, u3 = _.CHAPTER_REGEX.exec(o2);
                    if (u3) {
                      var l2 = u3[1], p2 = u3[2], d2 = u3[3];
                      s2 = "".concat(a3, " - ").concat(p2, " - ").concat(l2, ": ").concat(d2);
                    } else s2 = "".concat(a3, " - ").concat(o2);
                    b.push({ name: s2, path: c2, releaseTime: "", chapterNumber: y + 1 }), y++;
                  }
                });
              }), [2, { path: t3, name: a2, cover: l, summary: f, author: p, artist: d, status: m, chapters: b }];
          }
        });
      });
    }, t2.prototype.parseChapter = function(t3) {
      return a(this, void 0, void 0, function() {
        var e2, r2, n2, a2, c2, u2;
        return i(this, function(i2) {
          switch (i2.label) {
            case 0:
              return e2 = "".concat(this.site).concat(t3), [4, (0, o.fetchApi)(e2).then(function(t4) {
            ...
            case 1:
              return r2 = i2.sent(), n2 = s.load(r2), (a2 = r2.includes("Nadie entra sin permiso en la Gran Tumba de Nazarick") ? n2("#content") : n2(".wpb_text_column.wpb_content_element > .wpb_wrapper")).find("center").remove(), a2.find("*").each(function(t4, e3) {
                var r3 = n2(e3), a3 = r3.attr("style") || "";
                /text-align:.?center/.test(a3) && r3.replaceWith("<center>".concat(r3.html(), "</center>"));
              }), [4, this.bypassCloudflareImages(n2, a2)];
            case 2:
              return c2 = i2.sent(), (u2 = s.load(c2))("script, style, iframe, .ads, .advertisement").remove(), [2, u2.html() || c2];
          }
        });
      });
    }, t2;
