...
var LNReaderPlugin = (() => {
  ...
  var o = (init_fetch2(), __toCommonJS(fetch_exports)), c = (init_novelStatus(), __toCommonJS(novelStatus_exports)), s = n((init_browser(), __toCommonJS(browser_exports))), u = function() {
    function t2() {
      this.id = "nova", this.name = "NOVA", this.icon = "src/es/nova/icon.png", this.site = "https://novelasligeras.net", this.version = "1.1.1", this.CHAPTER_REGEX = /(Parte \d+) . (.+?): (.+)/;
    }
    __name(t2, "t");
    ...
    }, t2.prototype.popularNovels = function(t3) {
      return a(this, void 0, void 0, function() {
        var e2, r2, n2, a2, c2 = this;
        return i(this, function(i2) {
          switch (i2.label) {
            case 0:
              return 1 === t3 ? [2, this.searchNovels("", 1)] : (e2 = "".concat(this.site, "/index.php/page/").concat(t3, "/?post_type=product&orderby=popularity"), [4, (0, o.fetchApi)(e2).then(function(t4) {
                return t4.text();
              })]);
            case 1:
              return r2 = i2.sent(), n2 = s.load(r2), a2 = [], n2(".dt-css-grid div.wf-cell").each(function(t4, e3) {
                var r3, i3 = n2(e3), o2 = i3.find("img"), s2 = i3.find("h4.entry-title a"), u2 = (null === (r3 = s2.attr("href")) || void 0 === r3 ? void 0 : r3.replace(c2.site, "")) || "", l = s2.text().trim(), p = o2.attr("data-src") || o2.attr("data-cfsrc") || o2.attr("src") || "";
      ...
      return a(this, void 0, void 0, function() {
        ...
        return i(this, function(i2) {
          switch (i2.label) {
            ...
            case 1:
              return r2 = i2.sent(), n2 = s.load(r2), a2 = n2("h1").first().text().trim(), u2 = n2(".woocommerce-product-gallery").find("img").first(), l = u2.attr("src") || u2.attr("data-cfsrc") || u2.attr("data-src") || "", p = n2(".woocommerce-product-attributes-item--attribute_pa_escritor td").text().trim() || "Desconocido", d = n2(".woocommerce-product-attributes-item--attribute_pa_ilustrador td").text().trim() || "", h = n2(".woocommerce-product-details__short-description").html(), f = this.htmlToText(h), v = n2(".woocommerce-product-attributes-item--attribute_pa_estado td").text().trim().toLowerCase(), m = "", m = v.includes("en curso") || v.includes("ongoing") ? c.NovelStatus.Ongoing : v.includes("completado") || v.includes("completed") ? c.NovelStatus.Completed : c.NovelStatus.Unknown, b = [], y = 0, n2(".vc_row div.vc_column-inner > div.wpb_wrapper").each(function(t4, e3) {
