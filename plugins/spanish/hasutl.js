...
(() => {
        ...
        return (function(s3) {
          ...
          for (; o && (o = 0, s3[0] && (a = 0)), a; ) try {
            ...
            switch (r2 = 0, i2 && (s3 = [2 & s3[0], i2.value]), s3[0]) {
              ...
              case 5:
                a.label++, r2 = s3[1], s3 = [0];
                continue;
              case 7:
                s3 = a.ops.pop(), a.trys.pop();
                continue;
              default:
                if (!(i2 = a.trys, (i2 = i2.length > 0 && i2[i2.length - 1]) || 6 !== s3[0] && 2 !== s3[0])) {
                  a = 0;
                  continue;
                }
  ...
  var n = (init_browser(), __toCommonJS(browser_exports)), r = (init_fetch2(), __toCommonJS(fetch_exports)), i = (function() {
    function i2() {
      this.id = "HasuTL", this.name = "Hasu Translations", this.icon = "src/es/hasutl/icon.jpg", this.site = "https://hasutl.wordpress.com/", this.version = "1.0.0";
    }
    __name(i2, "i");
    return i2.prototype.popularNovels = function() {
      return t(this, void 0, void 0, (function() {
        var t2, i3, a, o, s = this;
        return e(this, (function(e2) {
          switch (e2.label) {
            case 0:
              return t2 = this.site + "light-novels-activas/", [4, (0, r.fetchApi)(t2)];
            case 1:
              return [4, e2.sent().text()];
            case 2:
              return i3 = e2.sent(), a = (0, n.load)(i3), o = [], a("div.wp-block-columns").each((function(t3, e3) {
                var n2 = a(e3).find(".wp-block-button").text(), r2 = a(e3).find("img").attr("src"), i4 = a(e3).find(".wp-block-button > a").attr("href");
                if (i4) {
                  var c = { name: n2, cover: r2, path: i4.replace(s.site, "") };
                  o.push(c);
                }
              })), [2, o];
          }
        ...
        return e(this, (function(e2) {
          switch (e2.label) {
            ...
            case 1:
              return [4, e2.sent().text()];
            case 2:
              return a = e2.sent(), o = (0, n.load)(a), (s = { path: i3, name: o(".post-header").text() }).cover = o(".featured-media > img").attr("src"), c = o(".post-content").find("p").html(), s.summary = c, u = [], o(".wp-block-media-text__content").find("a").each((function(t3, e3) {
                var n2 = o(e3).text().trim(), r2 = o(e3).attr("href");
                if (r2) {
                  var i4 = { name: n2, releaseTime: null, path: r2.replace(l.site, "") };
                  u.push(i4);
                }
              })), s.chapters = u, [2, s];
          }
        ...
        return e(this, (function(e2) {
          switch (e2.label) {
            ...
            case 1:
              return [4, e2.sent().text()];
            case 2:
              return a = e2.sent(), o = (0, n.load)(a), [2, o(".post-content").html() || ""];
          }
        }));
      }));
      ...
      return t(this, void 0, void 0, (function() {
        ...
        return e(this, (function(e2) {
          switch (e2.label) {
            case 0:
              return t2 = "".concat(this.site, "?s=").concat(i3, "&post_type=wp-manga"), [4, (0, r.fetchApi)(t2)];
            case 1:
              return [4, e2.sent().text()];
            case 2:
              return a = e2.sent(), o = (0, n.load)(a), s = [], o(".post-container").each((function(t3, e3) {
                var n2 = o(e3).find(".post-header").text();
                if (!n2.includes("Cap") && !n2.includes("Vol") && !n2.includes("Light Novels")) {
                  var r2 = o(e3).find("img").attr("src"), i4 = o(e3).find("a").attr("href");
                  if (!i4) return;
                  var a2 = { name: n2, cover: r2, path: i4.replace(c.site, "") };
                  s.push(a2);
                }
              })), [2, s];
          }
