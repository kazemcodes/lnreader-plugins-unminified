...
(() => {
  ...
  // .js/plugins/spanish/yukitls.js
  var t = function(t2, e2, n2, r2) {
    return new (n2 || (n2 = Promise))((function(i2, a) {
      function s(t3) {
        try {
          c(r2.next(t3));
        } catch (t4) {
    ...
    var n2, r2, i2, a = { label: 0, sent: /* @__PURE__ */ __name(function() {
        ...
        return (function(o3) {
          ...
          for (; s && (s = 0, o3[0] && (a = 0)), a; ) try {
            ...
            switch (r2 = 0, i2 && (o3 = [2 & o3[0], i2.value]), o3[0]) {
              ...
              case 5:
                a.label++, r2 = o3[1], o3 = [0];
                continue;
              case 7:
                o3 = a.ops.pop(), a.trys.pop();
                continue;
              default:
                if (!(i2 = a.trys, (i2 = i2.length > 0 && i2[i2.length - 1]) || 6 !== o3[0] && 2 !== o3[0])) {
                  a = 0;
                  continue;
                }
                ...
                if (6 === o3[0] && a.label < i2[1]) {
                  a.label = i2[1], i2 = o3;
                  break;
                }
                if (i2 && a.label < i2[2]) {
                  a.label = i2[2], a.ops.push(o3);
                  break;
                }
  ...
  var n = (init_fetch2(), __toCommonJS(fetch_exports)), r = (init_browser(), __toCommonJS(browser_exports)), i = (function() {
    function i2() {
      this.id = "yuukitls", this.name = "Yuuki Tls", this.icon = "src/es/yuukitls/icon.png", this.site = "https://yuukitls.com/", this.version = "1.0.0";
    }
    __name(i2, "i");
    return i2.prototype.popularNovels = function() {
      return t(this, void 0, void 0, (function() {
        ...
        return e(this, (function(e2) {
          switch (e2.label) {
            case 0:
              return [4, (0, n.fetchApi)(this.site)];
            case 1:
              return [4, e2.sent().text()];
            case 2:
              return t2 = e2.sent(), i3 = (0, r.load)(t2), a = [], i3(".quadmenu-navbar-collapse ul li:nth-child(2)").find("li").each((function(t3, e3) {
                var n2 = i3(e3).text().replace(/[\s\n]+/g, " "), r2 = i3(e3).find("img").attr("src"), o = i3(e3).find("a").attr("href");
                if (o) {
                  var c = { name: n2, cover: r2, path: o.replace(s.site, "") };
                  a.push(c);
                }
              })), [2, a];
          }
        ...
        return e(this, (function(e2) {
          switch (e2.label) {
            ...
            case 1:
              return [4, e2.sent().text()];
            case 2:
              return a = e2.sent(), s = (0, r.load)(a), (o = { path: i3, name: s("h1.entry-title").text().replace(/[\t\n]/g, "").trim() }).cover = s('img[loading="lazy"]').attr("src"), s(".entry-content").find("div").each((function() {
                s(this).text().includes("Escritor:") && (o.author = s(this).text().replace("Escritor: ", "").trim()), s(this).text().includes("G\xE9nero:") && (o.genres = s(this).text().replace(/Género: |\s/g, "")), s(this).text().includes("Sinopsis:") && (o.summary = s(this).next().text());
              })), c = [], s(".entry-content").find("li").length ? s(".entry-content").find("li").each((function(t3, e3) {
                var n2 = s(e3).find("a").attr("href");
                if (n2 && n2.includes(u.site)) {
                  var r2 = { name: s(e3).text(), releaseTime: null, path: n2.replace(u.site, "") };
                  c.push(r2);
                }
              })) : s(".entry-content").find("p").each((function(t3, e3) {
                var n2 = s(e3).find("a").attr("href");
                if (n2 && n2.includes(u.site)) {
                  var r2 = { name: s(e3).text(), releaseTime: null, path: n2.replace(u.site, "") };
                  c.push(r2);
        ...
        return e(this, (function(e2) {
          switch (e2.label) {
            ...
            case 1:
              return [4, e2.sent().text()];
            case 2:
              return a = e2.sent(), s = (0, r.load)(a), [2, s(".entry-content").html() || ""];
          }
        }));
      }));
      ...
      return t(this, void 0, void 0, (function() {
        ...
        return e(this, (function(e2) {
          switch (e2.label) {
            case 0:
              return i3 = i3.toLowerCase(), [4, (0, n.fetchApi)(this.site)];
            case 1:
              return [4, e2.sent().text()];
            case 2:
              return t2 = e2.sent(), a = (0, r.load)(t2), s = [], a(".menu-item-2869").find(".menu-item.menu-item-type-post_type.menu-item-object-post").each((function(t3, e3) {
                var n2 = a(e3).text(), r2 = a(e3).find("img").attr("src"), i4 = a(e3).find("a").attr("href");
                if (i4) {
                  var c = { name: n2, cover: r2, path: i4.replace(o.site, "") };
                  s.push(c);
                }
              })), [2, s = s.filter((function(t3) {
                return t3.name.toLowerCase().includes(i3);
              }))];
          }
        }));
      }));
