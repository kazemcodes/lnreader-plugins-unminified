...
(() => {
  ...
  // .js/plugins/spanish/oasistranslations.js
  ...
  var n = (init_fetch2(), __toCommonJS(fetch_exports)), r = (init_browser(), __toCommonJS(browser_exports)), i = (function() {
    function i2() {
      this.id = "oasistranslations", this.name = "Oasis Translations", this.site = "https://oasistranslations.wordpress.com/", this.version = "1.0.0", this.icon = "src/es/oasistranslations/icon.png";
    }
    __name(i2, "i");
      ...
      return t(this, void 0, void 0, (function() {
        ...
        return e(this, (function(e2) {
          switch (e2.label) {
            ...
            case 2:
              return t2 = e2.sent(), i3 = (0, r.load)(t2), a = [], i3(".menu-item-1819").find(".sub-menu > li").each((function(t3, e3) {
                var n2 = i3(e3).text();
                if (!n2.match(/Activas|Finalizadas|Dropeadas/)) {
                  var r2 = i3(e3).find("img").attr("src"), o = i3(e3).find("a").attr("href");
                  if (!o) return;
        ...
        return e(this, (function(e2) {
          switch (e2.label) {
            ...
            case 1:
              return [4, e2.sent().text()];
            case 2:
              return a = e2.sent(), s = (0, r.load)(a), (o = { path: i3, name: s("h1.entry-title").text().replace(/[\t\n]/g, "").trim() }).cover = s('img[loading="lazy"]').attr("src"), s(".entry-content > p").each((function() {
                var t3, e3;
                if (s(u).text().includes("Autor")) {
                  var n2 = null === (e3 = null === (t3 = s(u).html()) || void 0 === t3 ? void 0 : t3.match(/<\/strong>(.|\n)*?<br>/g)) || void 0 === e3 ? void 0 : e3.map((function(t4) {
                    return t4.replace(/<strong>|<\/strong>|<br>|:\s/g, "");
                  }));
                  o.genres = "", n2 && (o.author = n2[2], o.genres = n2[4].replace(/\s|&nbsp;/g, ""));
                }
              })), o.summary = "", c = [], s(".entry-content").find("a").each((function(t3, e3) {
                var n2 = s(e3).attr("href");
        ...
        return e(this, (function(e2) {
          switch (e2.label) {
            ...
            case 1:
              return [4, e2.sent().text()];
            case 2:
              return a = e2.sent(), (s = (0, r.load)(a))("div#jp-post-flair").remove(), [2, s(".entry-content").html() || ""];
          }
        }));
      }));
        ...
        return e(this, (function(e2) {
          switch (e2.label) {
            ...
            case 1:
              return [4, e2.sent().text()];
            case 2:
              return t2 = e2.sent(), a = (0, r.load)(t2), s = [], a(".menu-item-1819").find(".sub-menu > li").each((function(t3, e3) {
                var n2 = a(e3).text();
                if (!n2.match(/Activas|Finalizadas|Dropeadas/)) {
                  var r2 = a(e3).find("img").attr("src"), i4 = a(e3).find("a").attr("href");
                  if (!i4) return;
