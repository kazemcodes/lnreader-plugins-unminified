...
var LNReaderPlugin = (() => {
  ...
  // .js/plugins/spanish/PanchoTranslations[madara].js
  ...
  var n = (init_fetch2(), __toCommonJS(fetch_exports)), r = (init_browser(), __toCommonJS(browser_exports)), i = (init_defaultCover(), __toCommonJS(defaultCover_exports)), l = (init_novelStatus(), __toCommonJS(novelStatus_exports)), o = a(require_dayjs_min()), s = (init_storage2(), __toCommonJS(storage_exports)), u = function(e2, t2) {
    ...
    return a2.prototype.translateDragontea = function(e2) {
      ...
      return e(this, void 0, void 0, (function() {
        var e2, s2, u2, c2, h, p, v, d, m = this;
        return t(this, (function(t2) {
          switch (t2.label) {
            case 0:
            ...
            case 5:
              return "0" !== c2 && (e2 = (0, r.load)(c2)), v = e2(".wp-manga-chapter").length, e2(".wp-manga-chapter").each((function(t3, a4) {
                ...
                i2 = i2 ? m.parseData(i2) : (0, o.default)().format("LL");
                var l2 = e2(a4).find("a").attr("href") || "";
                !l2 || "#" == l2 || r2 && m.hideLocked || u2.push({ name: n2, path: l2.replace(/https?:\/\/.*?\//, "/"), releaseTime: i2 || null, chapterNumber: v - t3 });
