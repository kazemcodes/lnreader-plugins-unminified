      ...
      return e(this, void 0, void 0, (function() {
        ...
        return a(this, (function(a2) {
          switch (a2.label) {
            ...
            case 1:
              return i2 = a2.sent(), n2 = { path: l2, name: "", genres: "", summary: "", author: "", artist: "", status: "", chapters: [] }, s3 = false, v = false, c = 0, b = false, d = false, m = false, p = false, h = false, f = false, g = false, y = 0, w = false, A = false, k = [], C = {}, E = this.hideLocked, R = new o.Parser({ onopentag: /* @__PURE__ */ __name(function(a3, l3) {
                var o2;
              ...
              }, "onclosetag") }), R.write(i2), R.end(), k.length && ((null === (x = this.options) || void 0 === x ? void 0 : x.reverseChapters) && k.reverse(), n2.chapters = k), n2.summary = n2.summary.trim(), [2, n2];
          }
        }));
      }));
