...
(() => {
  ...
  // .js/plugins/japanese/Syosetu.js
  var e = function(e2, t2, n2, a2) {
    return new (n2 || (n2 = Promise))((function(r2, l2) {
      function i2(e3) {
        try {
          s(a2.next(e3));
        } catch (e4) {
    ...
    var n2, a2, r2, l2 = { label: 0, sent: /* @__PURE__ */ __name(function() {
      ...
      return function(s) {
        return (function(o4) {
          ...
          for (; i2 && (i2 = 0, o4[0] && (l2 = 0)), l2; ) try {
            if (n2 = 1, a2 && (r2 = 2 & o4[0] ? a2.return : o4[0] ? a2.throw || ((r2 = a2.return) && r2.call(a2), 0) : a2.next) && !(r2 = r2.call(a2, o4[1])).done) return r2;
            switch (a2 = 0, r2 && (o4 = [2 & o4[0], r2.value]), o4[0]) {
              case 0:
              case 1:
                r2 = o4;
                break;
  ...
  var n = (init_browser(), __toCommonJS(browser_exports)), a = (init_fetch2(), __toCommonJS(fetch_exports)), r = (init_defaultCover(), __toCommonJS(defaultCover_exports)), l = (init_filterInputs(), __toCommonJS(filterInputs_exports)), i = (init_novelStatus(), __toCommonJS(novelStatus_exports)), o = (function() {
    function o2() {
      var e2 = this;
      this.id = "yomou.syosetu", this.name = "Syosetu", this.icon = "src/jp/syosetu/icon.png", this.site = "https://yomou.syosetu.com/", this.novelPrefix = "https://ncode.syosetu.com", this.version = "1.1.2", this.headers = { "User-Agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.0.0 Safari/537.36" }, this.searchUrl = function(t2, n2) {
        return "".concat(e2.site, "search.php?order=").concat(n2 || "hyoka").concat(void 0 !== t2 ? "&p=".concat(t2 <= 1 || t2 > 100 ? "1" : t2) : "");
      }, this.filters = { ranking: { type: l.FilterTypes.Picker, label: "Ranked by", options: [{ label: "\u65E5\u9593", value: "daily" }, { label: "\u9031\u9593", value: "weekly" }, { label: "\u6708\u9593", value: "monthly" }, { label: "\u56DB\u534A\u671F", value: "quarter" }, { label: "\u5E74\u9593", value: "yearly" }, { label: "\u7D2F\u8A08", value: "total" }], value: "total" }, genre: { type: l.FilterTypes.Picker, label: "Ranking Genre", options: [{ label: "\u7DCF\u30B8\u30E3\u30F3\u30EB", value: "" }, { label: "\u7570\u4E16\u754C\u8EE2\u751F/\u8EE2\u79FB\u3014\u604B\u611B\u3015\u3015", value: "1" }, { label: "\u7570\u4E16\u754C\u8EE2\u751F/\u8EE2\u79FB\u3014\u30D5\u30A1\u30F3\u30BF\u30B8\u30FC\u3015", value: "2" }, { label: "\u7570\u4E16\u754C\u8EE2\u751F/\u8EE2\u79FB\u3014\u6587\u82B8\u30FBSF\u30FB\u305D\u306E\u4ED6\u3015", value: "o" }, { label: "\u7570\u4E16\u754C\u3014\u604B\u611B\u3015", value: "101" }, { label: "\u73FE\u5B9F\u4E16\u754C\u3014\u604B\u611B\u3015", value: "102" }, { label: "\u30CF\u30A4\u30D5\u30A1\u30F3\u30BF\u30B8\u30FC\u3014\u30D5\u30A1\u30F3\u30BF\u30B8\u30FC\u3015", value: "201" }, { label: "\u30ED\u30FC\u30D5\u30A1\u30F3\u30BF\u30B8\u30FC\u3014\u30D5\u30A1\u30F3\u30BF\u30B8\u30FC\u3015", value: "202" }, { label: "\u7D14\u6587\u5B66\u3014\u6587\u82B8\u3015", value: "301" }, { label: "\u30D2\u30E5\u30FC\u30DE\u30F3\u30C9\u30E9\u30DE\u3014\u6587\u82B8\u3015", value: "302" }, { label: "\u6B74\u53F2\u3014\u6587\u82B8\u3015", value: "303" }, { label: "\u63A8\u7406\u3014\u6587\u82B8\u3015", value: "304" }, { label: "\u30DB\u30E9\u30FC\u3014\u6587\u82B8\u3015", value: "305" }, { label: "\u30A2\u30AF\u30B7\u30E7\u30F3\u3014\u6587\u82B8\u3015", value: "306" }, { label: "\u30B3\u30E1\u30C7\u30A3\u30FC\u3014\u6587\u82B8\u3015", value: "307" }, { label: "VR\u30B2\u30FC\u30E0\u3014SF\u3015", value: "401" }, { label: "\u5B87\u5B99\u3014SF\u3015", value: "402" }, { label: "\u7A7A\u60F3\u79D1\u5B66\u3014SF\u3015", value: "403" }, { label: "\u30D1\u30CB\u30C3\u30AF\u3014SF\u3015", value: "404" }, { label: "\u7AE5\u8A71\u3014\u305D\u306E\u4ED6\u3015", value: "9901" }, { label: "\u8A69\u3014\u305D\u306E\u4ED6\u3015", value: "9902" }, { label: "\u30A8\u30C3\u30BB\u30A4\u3014\u305D\u306E\u4ED6\u3015", value: "9903" }, { label: "\u305D\u306E\u4ED6\u3014\u305D\u306E\u4ED6\u3015", value: "9999" }], value: "" }, modifier: { type: l.FilterTypes.Picker, label: "Modifier", options: [{ label: "\u3059\u3079\u3066", value: "total" }, { label: "\u9023\u8F09\u4E2D", value: "r" }, { label: "\u5B8C\u7D50\u6E08", value: "er" }, { label: "\u77ED\u7DE8", value: "t" }], value: "total" } };
    }
    __name(o2, "o");
    return o2.prototype.popularNovels = function(l2, i2) {
      return e(this, arguments, void 0, (function(l3, i3) {
        var o3, s = this, u = i3.filters;
        return t(this, (function(i4) {
          switch (i4.label) {
            case 0:
              return o3 = /* @__PURE__ */ __name(function(l4) {
                return e(s, void 0, void 0, (function() {
                  var e2, i5, o4, s2, c = this;
                  return t(this, (function(t2) {
                    switch (t2.label) {
                      case 0:
                        return e2 = this.site, u.genre.value ? e2 += "rank/".concat(1 === u.genre.value.length ? "isekailist" : "genrelist", "/type/").concat(u.ranking.value, "_").concat(u.genre.value).concat("total" === u.modifier.value ? "" : "_".concat(u.modifier.value), "/?p=").concat(l4) : e2 += "rank/list/type/".concat(u.ranking.value, "_").concat(u.modifier.value, "/?p=").concat(l4), [4, (0, a.fetchApi)(e2)];
                      case 1:
                        return [4, t2.sent().text()];
                      case 2:
                        return i5 = t2.sent(), o4 = (0, n.load)(i5, { decodeEntities: false }), parseInt(o4(".is-current").html() || "1") !== l4 ? [2, []] : (s2 = [], o4(".c-card").each((function(e3, t3) {
                          var n2 = o4(t3).find(".p-ranklist-item__title a"), a2 = n2.attr("href");
                          if (a2) {
                            var l5 = n2.text(), i6 = { path: a2.replace(c.novelPrefix, ""), name: l5, cover: r.defaultCover };
                            s2.push(i6);
                          }
                        })), [2, s2]);
                    }
    ...
    }, o2.prototype.parseChaptersFromPage = function(n2) {
      return e(this, void 0, void 0, (function() {
        var e2, a2 = this;
        return t(this, (function(t2) {
          return e2 = [], n2(".p-eplist__sublist").each((function(t3, r2) {
            var l2 = n2(r2).find("a"), i2 = l2.attr("href"), o3 = l2.text().trim(), s = n2(r2).find(".p-eplist__update").text().trim().split(" ")[0].replace(/\//g, "-");
            i2 && e2.push({ name: o3, releaseTime: s, path: i2.replace(a2.novelPrefix, "") });
          })), [2, e2];
        }));
      }));
    }, o2.prototype.parseNovel = function(l2) {
      return e(this, void 0, void 0, (function() {
        var e2, o3, s, u, c, h, p, v, f, d, b = this;
        return t(this, (function(t2) {
          switch (t2.label) {
            case 0:
              return [4, (0, a.fetchApi)(this.novelPrefix + l2, { headers: this.headers })];
            case 1:
              return [4, t2.sent().text()];
            case 2:
              return e2 = t2.sent(), o3 = (0, n.load)(e2, { decodeEntities: false }), s = "Unknown", o3(".c-announce").text().includes("\u9023\u8F09\u4E2D") || o3(".c-announce").text().includes("\u672A\u5B8C\u7D50") ? s = i.NovelStatus.Ongoing : o3(".c-announce").text().includes("\u66F4\u65B0\u3055\u308C\u3066\u3044\u307E\u305B\u3093") ? s = i.NovelStatus.OnHiatus : o3(".c-announce").text().includes("\u5B8C\u7D50") && (s = i.NovelStatus.Completed), (u = { path: l2, name: o3(".p-novel__title").text(), author: o3(".p-novel__author").text().replace("\u4F5C\u8005\uFF1A", "").trim(), status: s, artist: "", cover: r.defaultCover, chapters: [], genres: null === (d = o3('meta[property="og:description"]').attr("content")) || void 0 === d ? void 0 : d.split(" ").join(",") }).summary = o3("#novel_ex").html() || "", c = [], (h = o3(".c-pager__item--last").attr("href")) ? [3, 3] : (o3(".p-eplist__sublist").each((function(e3, t3) {
                var n2 = o3(t3).find("a"), a2 = n2.attr("href"), r2 = n2.text().trim(), l3 = o3(t3).find(".p-eplist__update").text().trim().split(" ")[0].replace(/\//g, "-");
                a2 && c.push({ name: r2, releaseTime: l3, path: a2.replace(b.novelPrefix, "") });
              })), [3, 5]);
            case 3:
              return p = h.match(/\?p=(\d+)/), v = p ? parseInt(p[1]) : 1, f = Array.from({ length: v }, (function(e3, t3) {
                return (0, a.fetchApi)("".concat(b.novelPrefix).concat(l2, "?p=").concat(t3 + 1)).then((function(e4) {
                  return e4.text();
                }));
              })), [4, Promise.all(f)];
            case 4:
              t2.sent().forEach((function(e3) {
                var t3 = (0, n.load)(e3, { decodeEntities: false });
                t3(".p-eplist__sublist").each((function(e4, n2) {
                  var a2 = t3(n2).find("a"), r2 = a2.attr("href"), l3 = a2.text().trim(), i2 = t3(n2).find(".p-eplist__update").text().trim().split(" ")[0].replace(/\//g, "-");
                  r2 && c.push({ name: l3, releaseTime: i2, path: r2.replace(b.novelPrefix, "") });
                }));
              })), t2.label = 5;
            case 5:
              return u.chapters = c, [2, u];
          }
        }));
      }));
      ...
      return e(this, void 0, void 0, (function() {
        ...
        return t(this, (function(t2) {
          switch (t2.label) {
            case 0:
              return [4, (0, a.fetchApi)(this.novelPrefix + r2, { headers: this.headers })];
            case 1:
              return [4, t2.sent().text()];
            case 2:
              return e2 = t2.sent(), l2 = (0, n.load)(e2, { decodeEntities: false }), i2 = l2(".p-novel__title").html() || "", o3 = l2('.p-novel__body .p-novel__text:not([class*="p-novel__text--"])').html() || "", [2, "<h1>".concat(i2, "</h1>").concat(o3)];
          }
        }));
      }));
      ...
      return e(this, void 0, void 0, (function() {
        ...
        return t(this, (function(u) {
          switch (u.label) {
            case 0:
              return o3 = /* @__PURE__ */ __name(function(i3) {
                return e(s, void 0, void 0, (function() {
                  var e2, o4, s2, u2, c = this;
                  return t(this, (function(t2) {
                    switch (t2.label) {
                      case 0:
                        return e2 = this.searchUrl(i3) + "&word=".concat(l2), [4, (0, a.fetchApi)(e2, { headers: this.headers })];
                      case 1:
                        return [4, t2.sent().text()];
                      case 2:
                        return o4 = t2.sent(), s2 = (0, n.load)(o4, { decodeEntities: false }), u2 = [], s2(".searchkekka_box").each((function(e3, t3) {
                          var n2 = s2(t3).find(".novel_h"), a2 = n2.children()[0].attribs.href.replace(c.novelPrefix, "");
                          a2 && u2.push({ name: n2.text(), path: a2, cover: r.defaultCover });
                        })), [2, u2];
                    }
                  }));
                }));
    ...
    }, o2.prototype.resolveUrl = function(e2) {
      return this.novelPrefix + e2;
    }, o2;
  })();
