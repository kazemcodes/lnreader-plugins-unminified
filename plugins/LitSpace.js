...
var LNReaderPlugin = function () {
    ...
    "src/lib/fetch.ts": function src_lib_fetchTs() {
      ...
      _fetchProto = /* @__PURE__ */__name(/*#__PURE__*/function () {
        var _ref5 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee4(protoInit, url, init) {
          var protoRoot, RequestMessge, encodedrequest, requestLength, headers2, bodyArray;
          return _regenerator().w(function (_context4) {
            while (1) switch (_context4.n) {
              ...
              case 1:
                ...
                headers2 = new Uint8Array(Array(5).fill(0).map(function (v, idx) {
                  if (idx === 0) return 0;
              ...
              case 2:
                init = _context4.v;
                bodyArray = new Uint8Array(headers2.length + encodedrequest.length);
                bodyArray.set(headers2, 0);
                bodyArray.set(encodedrequest, headers2.length);
  ...
  function () {
    ...
    __name(freedlit2, "freedlit");
    freedlit2.prototype.popularNovels = function (page_1, _a) {
          ...
          switch (_f.label) {
            ...
            case 1:
              ...
              books.data.forEach(function (novel) {
                return novels.push({
                  name: novel.title,
                  cover: novel.cover ? _this.site + "/storage/" + novel.cover : defaultCover_1.defaultCover,
    ...
    freedlit2.prototype.parseNovel = function (novelPath) {
      return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_h) {
          switch (_h.label) {
            case 0:
              return [4, (0, fetch_1.fetchApi)(this.resolveUrl(novelPath, true), {
                headers: headers,
            ...
            case 1:
              ...
              novel = {
                ...
                genres: ((_f = (_e = (_d = (_c = book.tags) === null || _c === void 0 ? void 0 : _c.map) === null || _d === void 0 ? void 0 : _d.call(_c, function (tags) {
                  return tags.name;
                })) === null || _e === void 0 ? void 0 : _e.join) === null || _f === void 0 ? void 0 : _f.call(_e, ", ")) || ""
              };
              return [4, (0, fetch_1.fetchApi)(this.site + "/api/bookpage/get-chapters", {
                method: "post",
                headers: headers,
    ...
    freedlit2.prototype.parseChapter = function (chapterPath) {
      return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
          switch (_b.label) {
            case 0:
              ...
              if (!!headers["X-XSRF-TOKEN"]) return [3, 2];
              return [4, (0, fetch_1.fetchApi)(this.site).then(function (res) {
                return _this.getToken(res.headers);
              })];
            case 1:
              _b.sent();
              _b.label = 2;
            case 2:
              return [4, (0, fetch_1.fetchApi)(this.site + "/reader/get-content", {
                method: "post",
                headers: headers,
    ...
    freedlit2.prototype.searchNovels = function (searchTerm) {
      return __awaiter(this, void 0, void 0, function () {
        var success, novels;
        var _this = this;
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              return [4, (0, fetch_1.fetchApi)(this.site + "/api/search?query=" + searchTerm).then(function (res) {
                _this.getToken(res.headers);
                return res.json();
              })];
            case 1:
