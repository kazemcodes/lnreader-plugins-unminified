...
var LNReaderPlugin = function () {
  ...
  var Smakolykytl = /** @class */
  function () {
    function Smakolykytl2() {
      this.id = "smakolykytl";
      this.name = "\u0421\u043C\u0430\u043A\u043E\u043B\u0438\u043A\u0438";
      this.site = "https://smakolykytl.site/";
      this.apiSite = "https://api.smakolykytl.site/api/user";
      this.version = "1.0.1";
      this.icon = "src/uk/smakolykytl/icon.png";
    }
    __name(Smakolykytl2, "Smakolykytl");
    Smakolykytl2.prototype.popularNovels = function (pageNo_1, _a) {
      return __awaiter(this, arguments, void 0, function (pageNo, _b) {
        var sort, result, json, novels;
        var _c;
        var showLatestNovels = _b.showLatestNovels;
        return __generator(this, function (_d) {
          switch (_d.label) {
            case 0:
              sort = showLatestNovels ? "/updates" : "/projects";
              return [4, (0, fetch_1.fetchApi)(this.apiSite + sort)];
            case 1:
              result = _d.sent();
            ...
            case 2:
              json = _d.sent();
              novels = [];
              (_c = (json === null || json === void 0 ? void 0 : json.projects) || (json === null || json === void 0 ? void 0 : json.updates)) === null || _c === void 0 ? void 0 : _c.forEach(function (novel) {
                return novels.push({
                  name: novel.title,
    ...
    Smakolykytl2.prototype.parseNovel = function (novelPath) {
        ...
        return __generator(this, function (_k) {
          switch (_k.label) {
            case 0:
              ...
              return [4, (0, fetch_1.fetchApi)(this.apiSite + "/projects/" + id)];
            case 1:
              result = _k.sent();
              return [4, result.json()];
            case 2:
              ...
              novel = {
                ...
                status: ((_f = book === null || book === void 0 ? void 0 : book.project) === null || _f === void 0 ? void 0 : _f.status_translate.includes("\u0422\u0440\u0438\u0432\u0430\u0454")) ? novelStatus_1.NovelStatus.Ongoing : novelStatus_1.NovelStatus.Completed
              };
              tags = [(_g = book === null || book === void 0 ? void 0 : book.project) === null || _g === void 0 ? void 0 : _g.genres, (_h = book === null || book === void 0 ? void 0 : book.project) === null || _h === void 0 ? void 0 : _h.tags].flat().map(function (tags2) {
                return tags2 === null || tags2 === void 0 ? void 0 : tags2.title;
              ...
              chapters = [];
              return [4, (0, fetch_1.fetchApi)(this.apiSite + "/projects/" + id + "/books")];
            case 3:
              res = _k.sent();
              return [4, res.json()];
            case 4:
              ...
              (_j = data === null || data === void 0 ? void 0 : data.books) === null || _j === void 0 ? void 0 : _j.forEach(function (volume) {
                var _a2;
                return (_a2 = volume === null || volume === void 0 ? void 0 : volume.chapters) === null || _a2 === void 0 ? void 0 : _a2.forEach(function (chapter) {
    ...
    Smakolykytl2.prototype.parseChapter = function (chapterPath) {
      return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
          switch (_b.label) {
            case 0:
              id = chapterPath.split("/").pop();
              return [4, (0, fetch_1.fetchApi)(this.apiSite + "/chapters/" + id)];
            case 1:
              result = _b.sent();
              return [4, result.json()];
            case 2:
    ...
    Smakolykytl2.prototype.searchNovels = function (searchTerm) {
      return __awaiter(this, void 0, void 0, function () {
        var result, json, searchTitle, novels;
        var _a, _b;
        return __generator(this, function (_c) {
          switch (_c.label) {
            case 0:
              return [4, (0, fetch_1.fetchApi)(this.apiSite + "/projects")];
            case 1:
              result = _c.sent();
              return [4, result.json()];
            case 2:
              ...
              novels = [];
              (_b = (_a = json === null || json === void 0 ? void 0 : json.projects) === null || _a === void 0 ? void 0 : _a.filter(function (_a2) {
                var title2 = _a2.title,
                  id = _a2.id;
                return title2.toLowerCase().includes(searchTitle) || String(id) == searchTerm;
    ...
    json.forEach(function (element) {
      switch (element.type) {
        ...
        case "image":
          ...
          break;
        case "paragraph":
          html += "<p>" + (element.content ? jsonToHtml(element.content) : "<br>") + "</p>";
          break;
        case "text":
          html += element.text;
          break;
