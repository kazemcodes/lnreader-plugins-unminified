...
var LNReaderPlugin = (() => {
  ...
  var StorySeedlingPlugin = (
    /** @class */
    function() {
      function StorySeedlingPlugin2() {
      ...
      __name(StorySeedlingPlugin2, "StorySeedlingPlugin");
      StorySeedlingPlugin2.prototype.getCheerio = function(url, search) {
      ...
      StorySeedlingPlugin2.prototype.popularNovels = function(pageNo) {
        return __awaiter(this, void 0, void 0, function() {
          var novels, body, loadedCheerio, postValue, data2, response;
          var _this = this;
          var _a;
          return __generator(this, function(_b) {
            switch (_b.label) {
              case 0:
                novels = [];
                return [4, (0, fetch_1.fetchApi)(this.site + "browse").then(function(r) {
                  return r.text();
                })];
              case 1:
                body = _b.sent();
                loadedCheerio = (0, cheerio_1.load)(body);
                postValue = (_a = loadedCheerio("div[ax-load][x-data]").attr("x-data")) === null || _a === void 0 ? void 0 : _a.replace("browse('", "").replace("')", "");
                data2 = new FormData();
                data2.append("search", "");
                data2.append("orderBy", "recent");
                data2.append("curpage", pageNo.toString());
                data2.append("post", postValue);
                data2.append("action", "fetch_browse");
                return [4, (0, fetch_1.fetchApi)(this.site + "ajax", {
                  body: data2,
                  method: "POST"
                }).then(function(res) {
                  return res.json();
      ...
      StorySeedlingPlugin2.prototype.parseNovel = function(novelPath) {
        return __awaiter(this, void 0, void 0, function() {
          var $2, baseUrl, novel, coverUrl, genres, rawStatus, map2, summaryDiv, pTagSummary, chapters, xdata, listXdata, dataNovelId, dataNovelN, idMatch, novelId, chapterListing, formData, chaptersUrl, refererUrl, results;
          var _a;
          return __generator(this, function(_b) {
            switch (_b.label) {
              case 0:
              ...
              case 1:
                ...
                novel.name = $2("h1").text().trim();
                coverUrl = $2('img[x-ref="art"].w-full.rounded.shadow-md').attr("src");
                if (coverUrl) {
                  novel.cover = new URL(coverUrl, baseUrl).href;
                }
                genres = [];
                $2(`section[x-data="{ tab: location.hash.substr(1) || 'chapters' }"].relative > div > div > div.flex.flex-wrap > a`).each(function() {
                  genres.push($2(this).text().trim());
                });
                novel.genres = genres.join(", ");
                novel.author = $2("div.mb-1 a").text().trim();
                rawStatus = $2("div.gap-2 span.text-sm").text().trim();
                map2 = {
                ...
                novel.status = (_a = map2[rawStatus.toLowerCase()]) !== null && _a !== void 0 ? _a : novelStatus_1.NovelStatus.Unknown;
                summaryDiv = $2("div.mb-4.order-2:not(.lg\\:grid-in-buttons)");
                pTagSummary = summaryDiv.find("p");
                novel.summary = pTagSummary.length > 0 ? pTagSummary.map(function(_, el) {
                  return $2(el).text().trim();
                }).get().join("\n\n") : summaryDiv.text().trim();
                chapters = [];
                xdata = $2(".bg-accent div[ax-load][x-data]").attr("x-data");
                if (!xdata) return [3, 3];
                ...
                return [4, (0, fetch_1.fetchApi)(chaptersUrl, {
                  ...
                  return novel.summary = "Chapter Parse Error: " + e + "\n\n" + novel.summary;
                })];
              case 2:
                results = _b.sent();
                if (results.data) {
      ...
      StorySeedlingPlugin2.prototype.parseChapter = function(chapterPath) {
        return __awaiter(this, void 0, void 0, function() {
          var $2, xdata, t, chapterText;
          return __generator(this, function(_a) {
            switch (_a.label) {
              ...
              case 1:
                $2 = _a.sent();
                xdata = $2("div[ax-load][x-data]").attr("x-data");
                t = $2("div.justify-center > div.mb-4");
                chapterText = t.html() || "";
                if (xdata) {
      ...
      StorySeedlingPlugin2.prototype.searchNovels = function(searchTerm, pageNo) {
        return __awaiter(this, void 0, void 0, function() {
          var novels, body, loadedCheerio, postValue, data2, response;
          var _this = this;
          var _a;
          return __generator(this, function(_b) {
            switch (_b.label) {
              ...
              case 1:
                ...
                postValue = (_a = loadedCheerio("div[ax-load][x-data]").attr("x-data")) === null || _a === void 0 ? void 0 : _a.replace("browse('", "").replace("')", "");
                data2 = new FormData();
                data2.append("search", searchTerm);
                data2.append("orderBy", "recent");
                data2.append("curpage", pageNo.toString());
                data2.append("post", postValue);
                data2.append("action", "fetch_browse");
