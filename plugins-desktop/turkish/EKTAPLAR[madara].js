...
var LNReaderPlugin = (() => {
  ...
  // .js/plugins/turkish/EKTAPLAR[madara].js
  var e = function(e2, t2, a2, n2) {
    ...
    var a2, n2, r2, i2 = { label: 0, sent: function() {
  ...
  var n = (init_fetch2(), __toCommonJS(fetch_exports)), r = (init_browser(), __toCommonJS(browser_exports)), i = (init_defaultCover(), __toCommonJS(defaultCover_exports)), l = (init_novelStatus(), __toCommonJS(novelStatus_exports)), o = a(require_dayjs_min()), s = (init_storage2(), __toCommonJS(storage_exports)), u = function(e2, t2) {
    ...
    return a2.prototype.translateDragontea = function(e2) {
      ...
      return e(this, void 0, void 0, (function() {
        var e2, s2, u2, c2, m, h, p, v, d = this;
        return t(this, (function(t2) {
          switch (t2.label) {
            case 0:
            ...
            case 1:
              return (e2 = t2.sent())(".manga-title-badges, #manga-title span").remove(), (s2 = { path: a3, name: e2(".post-title h1").text().trim() || e2("#manga-title h1").text().trim() || e2(".manga-title").text().trim() || "" }).cover = e2(".summary_image > a > img").attr("data-lazy-src") || e2(".summary_image > a > img").attr("data-src") || e2(".summary_image > a > img").attr("src") || i.defaultCover, e2(".post-content_item, .post-content").each((function() {
                ...
                return e2(a4).text();
              })).get().join("\n\n").trim(), u2 = [], c2 = "", (null === (v = this.options) || void 0 === v ? void 0 : v.useNewChapterEndpoint) ? [4, (0, n.fetchApi)(this.site + a3 + "ajax/chapters/", { method: "POST", referrer: this.site + a3 }).then((function(e3) {
                return e3.text();
              }))] : [3, 3];
            case 2:
              return c2 = t2.sent(), [3, 5];
            case 3:
              return m = e2(".rating-post-id").attr("value") || e2("#manga-chapters-holder").attr("data-id") || "", (h = new FormData()).append("action", "manga_get_chapters"), h.append("manga", m), [4, (0, n.fetchApi)(this.site + "wp-admin/admin-ajax.php", { method: "POST", body: h }).then((function(e3) {
                return e3.text();
              }))];
            case 4:
              c2 = t2.sent(), t2.label = 5;
            case 5:
              return "0" !== c2 && (e2 = (0, r.load)(c2)), p = e2(".wp-manga-chapter").length, e2(".wp-manga-chapter").each((function(t3, a4) {
                ...
                i2 = i2 ? d.parseData(i2) : (0, o.default)().format("LL");
                var l2 = e2(a4).find("a").attr("href") || "";
                !l2 || "#" == l2 || r2 && d.hideLocked || u2.push({ name: n2, path: l2.replace(/https?:\/\/.*?\//, "/"), releaseTime: i2 || null, chapterNumber: p - t3 });
