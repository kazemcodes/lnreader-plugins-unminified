...
var LNReaderPlugin = (() => {
  ...
  // .js/plugins/turkish/kakikata[madara].js
  ...
  var r = (init_fetch2(), __toCommonJS(fetch_exports)), n = (init_browser(), __toCommonJS(browser_exports)), i = (init_defaultCover(), __toCommonJS(defaultCover_exports)), o = (init_novelStatus(), __toCommonJS(novelStatus_exports)), s = a(require_dayjs_min()), l = (init_storage2(), __toCommonJS(storage_exports)), u = function(t2, e2) {
    ...
    return a2.prototype.translateDragontea = function(t2) {
      ...
      return t2(".manga-title-badges").remove(), t2(".page-item-detail, .c-tabs-item__content").each((function(a3, r2) {
        ...
        if (n2 && o2) {
          var s2 = t2(r2).find("img"), l2 = { name: n2, cover: s2.attr("data-src") || s2.attr("src") || s2.attr("data-lazy-srcset") || i.defaultCover, path: o2.replace(/https?:\/\/.*?\//, "/") };
          e2.push(l2);
        }
      })), e2;
      ...
      return t(this, arguments, void 0, (function(t2, a4) {
        ...
        return e(this, (function(e2) {
          switch (e2.label) {
            case 0:
              for (n2 in r3 = this.site + "/page/" + t2 + "/?s=&post_type=wp-manga", u2 || (u2 = this.filters || {}), c2 && (r3 += "&m_orderby=latest"), u2) if ("object" == typeof u2[n2].value) for (i2 = 0, o2 = u2[n2].value; i2 < o2.length; i2++) s2 = o2[i2], r3 += "&".concat(n2, "=").concat(s2);
      ...
      return t(this, void 0, void 0, (function() {
        var t2, l2, u2, c2, p, h, m, d, f = this;
        return e(this, (function(e2) {
          switch (e2.label) {
            case 0:
            ...
            case 1:
              return (t2 = e2.sent())(".manga-title-badges, #manga-title span").remove(), (l2 = { path: a3, name: t2(".post-title h1").text().trim() || t2("#manga-title h1").text().trim() || t2(".manga-title").text().trim() || "" }).cover = t2(".summary_image > a > img").attr("data-lazy-src") || t2(".summary_image > a > img").attr("data-src") || t2(".summary_image > a > img").attr("src") || i.defaultCover, t2(".post-content_item, .post-content").each((function() {
                ...
                return t2(a4).text();
              })).get().join("\n\n").trim(), u2 = [], c2 = "", (null === (d = this.options) || void 0 === d ? void 0 : d.useNewChapterEndpoint) ? [4, (0, r.fetchApi)(this.site + a3 + "ajax/chapters/", { method: "POST", referrer: this.site + a3 }).then((function(t3) {
                return t3.text();
              }))] : [3, 3];
            case 2:
            ...
            case 5:
              return "0" !== c2 && (t2 = (0, n.load)(c2)), m = t2(".wp-manga-chapter").length, t2(".wp-manga-chapter").each((function(e3, a4) {
                ...
                !o2 || "#" == o2 || n2 && f.hideLocked || u2.push({ name: r2, path: o2.replace(/https?:\/\/.*?\//, "/"), releaseTime: i2 || null, chapterNumber: m - e3 });
  ...
  })())({ id: "Kakikata", sourceSite: "https://kakikata.com.tr/", sourceName: "kakikata", options: { lang: "Turkish", useNewChapterEndpoint: true }, filters: { "genre[]": { type: "Checkbox", label: "Genre", value: [], options: [{ label: "Aksiyon", value: "aksiyon" }, { label: "LitRPG", value: "litrpg" }, { label: "Macera", value: "macera" }] }, op: { type: "Switch", label: "VE se\xE7ilen t\xFCm t\xFCrlere sahip olmak", value: false }, author: { type: "Text", label: "Yazar", value: "" }, artist: { type: "Text", label: "Sanat\xE7\u0131", value: "" }, release: { type: "Text", label: "Yay\u0131nland\u0131\u011F\u0131 Y\u0131l", value: "" }, adult: { type: "Picker", label: "Yeti\u015Fkinlere y\xF6nelik i\xE7erik", value: "", options: [{ label: "T\xFCm\xFC", value: "" }, { label: "Yeti\u015Fkin i\xE7eri\u011Fi yok", value: "0" }, { label: "Sadece yeti\u015Fkinlere y\xF6nelik i\xE7erik", value: "1" }] }, "status[]": { type: "Checkbox", label: "Durum", value: [], options: [{ label: "Devam Ediyor", value: "on-going" }, { label: "Tamamland\u0131", value: "end" }, { label: "\u0130ptal edildi", value: "canceled" }, { label: "Beklemede", value: "on-hold" }, { label: "Yakla\u015Fan", value: "upcoming" }] }, m_orderby: { type: "Picker", label: "S\u0131rala", value: "", options: [{ label: "Alaka d\xFCzeyi", value: "" }, { label: "En son", value: "latest" }, { label: "A-Z", value: "alphabet" }, { label: "De\u011Ferlendirme", value: "rating" }, { label: "En \xC7ok G\xF6r\xFCnt\xFCleme", value: "views" }] } } });
  exports.default = c;
})();
