...
var LNReaderPlugin = (() => {
  ...
  // .js/plugins/turkish/NABSCANS[madara].js
  ...
  var n = (init_fetch2(), __toCommonJS(fetch_exports)), r = (init_browser(), __toCommonJS(browser_exports)), i = (init_defaultCover(), __toCommonJS(defaultCover_exports)), o = (init_novelStatus(), __toCommonJS(novelStatus_exports)), s = a(require_dayjs_min()), l = (init_storage2(), __toCommonJS(storage_exports)), u = function(e2, t2) {
    return new RegExp(t2.join("|")).test(e2);
  }, c = new ((function() {
    function a2(e2) {
      var t2, a3;
      this.hideLocked = l.storage.get("hideLocked"), this.parseData = function(e3) {
        var t3, a4 = (0, s.default)(), n3 = (null === (t3 = e3.match(/\d+/)) || void 0 === t3 ? void 0 : t3[0]) || "", r2 = parseInt(n3, 10);
        if (!n3) return e3;
    ...
    return a2.prototype.translateDragontea = function(e2) {
      ...
      return e2(".manga-title-badges").remove(), e2(".page-item-detail, .c-tabs-item__content").each((function(a3, n2) {
        ...
        if (r2 && o2) {
          var s2 = e2(n2).find("img"), l2 = { name: r2, cover: s2.attr("data-src") || s2.attr("src") || s2.attr("data-lazy-srcset") || i.defaultCover, path: o2.replace(/https?:\/\/.*?\//, "/") };
          t2.push(l2);
        }
      })), t2;
      ...
      return e(this, arguments, void 0, (function(e2, a4) {
        ...
        return t(this, (function(t2) {
          switch (t2.label) {
            case 0:
              for (r2 in n3 = this.site + "/page/" + e2 + "/?s=&post_type=wp-manga", u2 || (u2 = this.filters || {}), c2 && (n3 += "&m_orderby=latest"), u2) if ("object" == typeof u2[r2].value) for (i2 = 0, o2 = u2[r2].value; i2 < o2.length; i2++) s2 = o2[i2], n3 += "&".concat(r2, "=").concat(s2);
      ...
      return e(this, void 0, void 0, (function() {
        var e2, l2, u2, c2, p, h, m, d, v = this;
        return t(this, (function(t2) {
          switch (t2.label) {
            case 0:
            ...
            case 3:
              return p = e2(".rating-post-id").attr("value") || e2("#manga-chapters-holder").attr("data-id") || "", (h = new FormData()).append("action", "manga_get_chapters"), h.append("manga", p), [4, (0, n.fetchApi)(this.site + "wp-admin/admin-ajax.php", { method: "POST", body: h }).then((function(e3) {
                return e3.text();
              }))];
            case 4:
            ...
            case 5:
              return "0" !== c2 && (e2 = (0, r.load)(c2)), m = e2(".wp-manga-chapter").length, e2(".wp-manga-chapter").each((function(t3, a4) {
                ...
                i2 = i2 ? v.parseData(i2) : (0, s.default)().format("LL");
  ...
  })())({ id: "nabiscans", sourceSite: "https://nabiscans.com/", sourceName: "NAB\u0130 SCANS", options: { useNewChapterEndpoint: true, lang: "Turkish" }, filters: { "genre[]": { type: "Checkbox", label: "Genre", value: [], options: [{ label: "Aksiyon", value: "aksiyon" }, { label: "B\xFCy\xFC", value: "buyu" }, { label: "CocaColastic", value: "cocacolastic" }, { label: "Do\u011Fa\xFCst\xFC", value: "dogaustu" }, { label: "D\xF6v\xFC\u015F Sanatlar\u0131", value: "dovus-sanatlari" }, { label: "Drama", value: "drama" }, { label: "Fantastik", value: "fantastik" }, { label: "Final", value: "final" }, { label: "Harem", value: "harem" }, { label: "Komedi", value: "komedi" }, { label: "Macera", value: "macera" }, { label: "Murim", value: "murim" }, { label: "novel", value: "novel" }, { label: "Okul Hayat\u0131", value: "okul-hayati" }, { label: "Ptj Serisi", value: "ptj-serisi" }, { label: "Reenkarnasyon", value: "reenkarnasyon" }, { label: "Romantizm", value: "romantizm" }, { label: "Spor", value: "spor" }, { label: "Sstem", value: "sstem" }] }, op: { type: "Switch", label: "having all selected genres", value: false }, author: { type: "Text", label: "Yazar", value: "" }, artist: { type: "Text", label: "\xC7izer", value: "" }, release: { type: "Text", label: "Yay\u0131nlanma Y\u0131l\u0131", value: "" }, adult: { type: "Picker", label: "Adult content", value: "", options: [{ label: "Hepsi", value: "" }, { label: "None adult content", value: "0" }, { label: "Only adult content", value: "1" }] }, "status[]": { type: "Checkbox", label: "Durumu", value: [], options: [{ label: "Devam Ediyor", value: "on-going" }, { label: "Tamamland\u0131", value: "end" }, { label: "\u0130ptal Edildi", value: "canceled" }, { label: "Ask\u0131ya Al\u0131nd\u0131", value: "on-hold" }, { label: "Gelecek", value: "upcoming" }] }, m_orderby: { type: "Picker", label: "S\u0131rala;", value: "", options: [{ label: "\u0130li\u015Fkin", value: "" }, { label: "En Sondan", value: "latest" }, { label: "A-Z", value: "alphabet" }, { label: "Oylama", value: "rating" }, { label: "Pop\xFCler", value: "trending" }, { label: "En \xC7ok Okunan", value: "views" }, { label: "Yeni", value: "new-manga" }] } } });
  exports.default = c;
})();
