...
var LNReaderPlugin = (() => {
  ...
  // .js/plugins/turkish/Namevt[lightnovelwp].js
  var e = function(e2, t2, a2, s2) {
    ...
    var a2, s2, i2, r2 = { label: 0, sent: function() {
    ...
    function o2(o3) {
      return function(n2) {
        return (function(o4) {
          ...
          for (; l2 && (l2 = 0, o4[0] && (r2 = 0)), r2; ) try {
            if (a2 = 1, s2 && (i2 = 2 & o4[0] ? s2.return : o4[0] ? s2.throw || ((i2 = s2.return) && i2.call(s2), 0) : s2.next) && !(i2 = i2.call(s2, o4[1])).done) return i2;
            switch (s2 = 0, i2 && (o4 = [2 & o4[0], i2.value]), o4[0]) {
              case 0:
              case 1:
                i2 = o4;
                break;
  ...
  var a = (init_browser(), __toCommonJS(browser_exports)), s = require_lib9(), i = (init_fetch2(), __toCommonJS(fetch_exports)), r = (init_novelStatus(), __toCommonJS(novelStatus_exports)), l = (init_defaultCover(), __toCommonJS(defaultCover_exports)), o = (init_storage2(), __toCommonJS(storage_exports));
  function n(e2, t2) {
    var a2 = e2.match(/(\d+)$/);
  ...
  var c = new ((function() {
    function c2(e2) {
      ...
      this.version = "1.1.".concat(9 + i2), this.options = null !== (a2 = e2.options) && void 0 !== a2 ? a2 : {}, this.filters = e2.filters, (null === (s2 = this.options) || void 0 === s2 ? void 0 : s2.hasLocked) && (this.pluginSettings = { hideLocked: { value: "", label: "Hide locked chapters", type: "Switch" } });
    }
    return c2.prototype.getHostname = function(e2) {
        ...
        return t(this, (function(t2) {
          switch (t2.label) {
            ...
            case 1:
              ...
              return [4, o2.text()];
            case 2:
              if (n2 = t2.sent(), c3 = null === (v = null === (u = n2.match(/<title>(.*?)<\/title>/)) || void 0 === u ? void 0 : u[1]) || void 0 === v ? void 0 : v.trim(), this.getHostname(a2) != this.getHostname(o2.url) || c3 && ("Bot Verification" == c3 || "You are being redirected..." == c3 || "Un instant..." == c3 || "Just a moment..." == c3 || "Redirecting..." == c3)) throw new Error("Captcha error, please open in webview (or the website has changed url)");
              return [2, n2];
          }
        }));
      }));
      ...
      return (e2.match(/<article([^]*?)<\/article>/g) || []).forEach((function(e3) {
        ...
        if (r2 && i2) {
          ...
          if (i2.includes(t2.site)) n2 = i2.replace(t2.site, "");
          else {
            var c3 = i2.split("/");
            c3.shift(), c3.shift(), c3.shift(), n2 = c3.join("/");
          }
          s2.push({ name: r2, cover: o2[2] || o2[1] || l.defaultCover, path: n2 });
        }
      })), s2;
    }, c2.prototype.popularNovels = function(a2, s2) {
      return e(this, arguments, void 0, (function(e2, a3) {
        var s3, i2, r2, l2, o2, n2, c3, u, v, h = a3.filters, p = a3.showLatestNovels;
        return t(this, (function(t2) {
          switch (t2.label) {
            case 0:
              for (r2 in s3 = null !== (v = null === (u = this.options) || void 0 === u ? void 0 : u.seriesPath) && void 0 !== v ? v : "/series/", i2 = this.site + s3 + "?page=" + e2, h || (h = this.filters || {}), p && (i2 += "&order=latest"), h) if ("object" == typeof h[r2].value) for (l2 = 0, o2 = h[r2].value; l2 < o2.length; l2++) n2 = o2[l2], i2 += "&".concat(r2, "=").concat(n2);
      ...
      return e(this, void 0, void 0, (function() {
        var e2, i2, o2, c3, u, v, h, p, d, m, f, b, g, y, k, w, N, S, C, j, x;
        return t(this, (function(t2) {
          switch (t2.label) {
            case 0:
              return e2 = this.site, [4, this.safeFecth(e2 + a2, false)];
            case 1:
              return i2 = t2.sent(), o2 = { path: a2, name: "", genres: "", summary: "", author: "", artist: "", status: "", chapters: [] }, c3 = false, u = false, v = 0, h = false, p = false, d = false, m = false, f = false, b = false, g = false, y = 0, k = false, w = false, N = [], S = {}, C = this.hideLocked, j = new s.Parser({ onopentag: function(t3, a3) {
                var s2;
                !o2.cover && (null === (s2 = a3.class) || void 0 === s2 ? void 0 : s2.includes("ts-post-image")) ? (o2.name = a3.title, o2.cover = a3["data-src"] || a3.src || l.defaultCover) : "genxed" === a3.class || "sertogenre" === a3.class ? c3 = true : c3 && "a" === t3 ? u = true : "div" !== t3 || "entry-content" !== a3.class && "description" !== a3.itemprop ? "spe" === a3.class || "serl" === a3.class ? h = true : h && "span" === t3 ? p = true : "div" === t3 && "sertostat" === a3.class ? (h = true, p = true, f = true) : a3.class && a3.class.includes("eplister") ? b = true : b && "li" === t3 ? g = true : g ? "a" === t3 && void 0 === S.path ? S.path = a3.href.replace(e2, "").trim() : "epl-num" === a3.class ? y = 1 : "epl-title" === a3.class ? y = 2 : "epl-date" === a3.class ? y = 3 : "epl-price" === a3.class && (y = 4) : !v || "div" !== t3 && "script" !== t3 || v++ : v++;
              }, ontext: function(e3) {
                var t3, a3;
                if (c3) u && (o2.genres += e3 + ", ");
                else if (1 === v && e3.trim()) o2.summary += e3;
                else if (h) {
                  if (p) {
                    var s2 = e3.toLowerCase().replace(":", "").trim();
                    if (d) o2.author += e3 || "Unknown";
                    else if (m) o2.artist += e3 || "Unknown";
                    else if (f) switch (s2) {
                      case "\u0645\u0643\u062A\u0645\u0644\u0629":
                      case "completed":
                      case "compl\xE9t\xE9":
                  ...
                  if (1 === y) e3.includes("\u{1F512}") ? (k = true, w = true) : w && (k = false), n(e3, S);
                  else if (2 === y) S.name = (null === (a3 = null === (t3 = e3.match(RegExp("^".concat(o2.name.replace(/[.*+?^${}()|[\]\\]/g, "\\$&"), "\\s*(.+)")))) || void 0 === t3 ? void 0 : t3[1]) || void 0 === a3 ? void 0 : a3.trim()) || e3.trim(), S.chapterNumber || n(e3, S);
                ...
                var t3, a3, s2;
                c3 ? u ? u = false : (c3 = false, o2.genres = null === (t3 = o2.genres) || void 0 === t3 ? void 0 : t3.slice(0, -2)) : v ? "p" === e3 ? o2.summary += "\n\n" : "br" === e3 ? o2.summary += "\n" : "div" !== e3 && "script" !== e3 || v-- : h ? p ? "span" === e3 && (p = false, d && o2.author ? d = false : m && o2.artist ? m = false : f && "" !== o2.status && (f = false)) : "div" === e3 && (h = false, o2.author = null === (a3 = o2.author) || void 0 === a3 ? void 0 : a3.trim(), o2.artist = null === (s2 = o2.artist) || void 0 === s2 ? void 0 : s2.trim()) : b && (g ? 1 === y || 2 === y || 3 === y || 4 === y ? y = 0 : "li" === e3 && (g = false, S.chapterNumber || (S.chapterNumber = 0), k && (S.name = "\u{1F512} " + S.name), C && k || N.push(S), S = {}) : "ul" === e3 && (b = false));
              } }), j.write(i2), j.end(), N.length && ((null === (x = this.options) || void 0 === x ? void 0 : x.reverseChapters) && N.reverse(), o2.chapters = N), o2.summary = o2.summary.trim(), [2, o2];
          }
        }));
      }));
        ...
        return t(this, (function(t2) {
          switch (t2.label) {
            ...
            case 1:
              ...
              return [2, (null === (o2 = null === (l2 = e2.match(/<div.*?class="epcontent ([^]*?)<div.*?class="?bottomnav/g)) || void 0 === l2 ? void 0 : l2[0].match(/<p[^>]*>([^]*?)<\/p>/g)) || void 0 === o2 ? void 0 : o2.join("\n")) || ""];
          }
        }));
      }));
  ...
  })())({ id: "namevt", sourceSite: "https://namevt.com/", sourceName: "Namevt", options: { reverseChapters: true, seriesPath: "seri", lang: "Turkish" }, filters: { "genre[]": { type: "Checkbox", label: "T\xFCrler", value: [], options: [{ label: "Aksiyon", value: "aksiyon" }, { label: "Bilimkurgu", value: "bilimkurgu" }, { label: "Do\u011Fa\xFCst\xFC", value: "dogaustu" }, { label: "Dram", value: "dram" }, { label: "Ecchi", value: "ecchi" }, { label: "Fantastik", value: "fantastik" }, { label: "Gizem", value: "gizem" }, { label: "Harem", value: "harem" }, { label: "Hayattan Kesitler", value: "hayattan-kesitler" }, { label: "Komedi", value: "komedi" }, { label: "Macera", value: "macera" }, { label: "Mecha", value: "mecha" }, { label: "Okul hayat\u0131", value: "okul-hayati" }, { label: "Psikolojik", value: "psikolojik" }, { label: "Romantik", value: "romantik" }, { label: "Seinen", value: "seinen" }, { label: "Shoujo", value: "shoujo" }, { label: "Shounen", value: "shounen" }, { label: "Tarihi", value: "tarihi" }, { label: "Trajedi", value: "trajedi" }, { label: "Yeti\u015Fkin", value: "yetiskin" }] }, "type[]": { type: "Checkbox", label: "Yaz\u0131m \u015Eekli", value: [], options: [{ label: "Light Novel (JP)", value: "light-novel-jp" }, { label: "Web Novel", value: "web-novel" }] }, status: { type: "Picker", label: "Durum", value: "", options: [{ label: "T\xFCm\xFC", value: "" }, { label: "Devam Ediyor", value: "ongoing" }, { label: "Ara Verildi", value: "hiatus" }, { label: "Tamamland\u0131", value: "completed" }] }, order: { type: "Picker", label: "S\u0131ralama", value: "", options: [{ label: "Varsay\u0131lan", value: "" }, { label: "A-Z", value: "title" }, { label: "Z-A", value: "titlereverse" }, { label: "Son G\xFCncellemeler", value: "update" }, { label: "Son Eklenenler", value: "latest" }, { label: "Pop\xFCler", value: "popular" }, { label: "Puanlama", value: "rating" }] } } });
  exports.default = c;
})();
