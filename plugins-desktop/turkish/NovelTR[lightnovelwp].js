...
var LNReaderPlugin = (() => {
  ...
  // .js/plugins/turkish/NovelTR[lightnovelwp].js
  var e = function(e2, a2, t2, l2) {
    return new (t2 || (t2 = Promise))((function(s2, i2) {
      function r2(e3) {
        try {
          n2(l2.next(e3));
        } catch (e4) {
      ...
      function n2(e3) {
        var a3;
        e3.done ? s2(e3.value) : (a3 = e3.value, a3 instanceof t2 ? a3 : new t2((function(e4) {
          e4(a3);
        }))).then(r2, o2);
      }
    ...
    var t2, l2, s2, i2 = { label: 0, sent: function() {
    ...
    function o2(o3) {
      return function(n2) {
        return (function(o4) {
          ...
          for (; r2 && (r2 = 0, o4[0] && (i2 = 0)), i2; ) try {
            if (t2 = 1, l2 && (s2 = 2 & o4[0] ? l2.return : o4[0] ? l2.throw || ((s2 = l2.return) && s2.call(l2), 0) : l2.next) && !(s2 = s2.call(l2, o4[1])).done) return s2;
            switch (l2 = 0, s2 && (o4 = [2 & o4[0], s2.value]), o4[0]) {
              case 0:
              case 1:
                s2 = o4;
                break;
              ...
              case 7:
                ...
                continue;
              default:
                if (!(s2 = i2.trys, (s2 = s2.length > 0 && s2[s2.length - 1]) || 6 !== o4[0] && 2 !== o4[0])) {
                  i2 = 0;
                  continue;
                }
                ...
                if (6 === o4[0] && i2.label < s2[1]) {
                  i2.label = s2[1], s2 = o4;
                  break;
                }
                if (s2 && i2.label < s2[2]) {
                  i2.label = s2[2], i2.ops.push(o4);
                  break;
                }
  ...
  var t = (init_browser(), __toCommonJS(browser_exports)), l = require_lib9(), s = (init_fetch2(), __toCommonJS(fetch_exports)), i = (init_novelStatus(), __toCommonJS(novelStatus_exports)), r = (init_defaultCover(), __toCommonJS(defaultCover_exports)), o = (init_storage2(), __toCommonJS(storage_exports));
  function n(e2, a2) {
    var t2 = e2.match(/(\d+)$/);
  ...
  var u = new ((function() {
    function u2(e2) {
      ...
      this.version = "1.1.".concat(9 + s2), this.options = null !== (t2 = e2.options) && void 0 !== t2 ? t2 : {}, this.filters = e2.filters, (null === (l2 = this.options) || void 0 === l2 ? void 0 : l2.hasLocked) && (this.pluginSettings = { hideLocked: { value: "", label: "Hide locked chapters", type: "Switch" } });
    }
    return u2.prototype.getHostname = function(e2) {
      ...
      return e(this, void 0, void 0, (function() {
        var e2, i2, r2, o2, n2, u3, c, v;
        return a(this, (function(a2) {
          switch (a2.label) {
            case 0:
              return e2 = t2.split("://"), i2 = e2.shift(), r2 = e2[0].replace(/\/\//g, "/"), [4, (0, s.fetchApi)(i2 + "://" + r2)];
            case 1:
      ...
      return (e2.match(/<article([^]*?)<\/article>/g) || []).forEach((function(e3) {
        var t2 = e3.match(/<a href="([^\"]*)".*? title="([^\"]*)"/) || [], s2 = t2[1], i2 = t2[2];
        if (i2 && s2) {
          var o2 = e3.match(/<img [^>]*?src="([^\"]*)"[^>]*?(?: data-src="([^\"]*)")?[^>]*>/) || [], n2 = void 0;
          if (s2.includes(a2.site)) n2 = s2.replace(a2.site, "");
          else {
            var u3 = s2.split("/");
            u3.shift(), u3.shift(), u3.shift(), n2 = u3.join("/");
          }
          l2.push({ name: i2, cover: o2[2] || o2[1] || r.defaultCover, path: n2 });
        }
      })), l2;
    }, u2.prototype.popularNovels = function(t2, l2) {
      return e(this, arguments, void 0, (function(e2, t3) {
        var l3, s2, i2, r2, o2, n2, u3, c, v, h = t3.filters, p = t3.showLatestNovels;
        return a(this, (function(a2) {
          switch (a2.label) {
            case 0:
              for (i2 in l3 = null !== (v = null === (c = this.options) || void 0 === c ? void 0 : c.seriesPath) && void 0 !== v ? v : "/series/", s2 = this.site + l3 + "?page=" + e2, h || (h = this.filters || {}), p && (s2 += "&order=latest"), h) if ("object" == typeof h[i2].value) for (r2 = 0, o2 = h[i2].value; r2 < o2.length; r2++) n2 = o2[r2], s2 += "&".concat(i2, "=").concat(n2);
      ...
      return e(this, void 0, void 0, (function() {
        var e2, s2, o2, u3, c, v, h, p, d, f, m, b, y, g, k, w, x, S, N, C, j;
        return a(this, (function(a2) {
          switch (a2.label) {
            case 0:
              return e2 = this.site, [4, this.safeFecth(e2 + t2, false)];
            case 1:
              return s2 = a2.sent(), o2 = { path: t2, name: "", genres: "", summary: "", author: "", artist: "", status: "", chapters: [] }, u3 = false, c = false, v = 0, h = false, p = false, d = false, f = false, m = false, b = false, y = false, g = 0, k = false, w = false, x = [], S = {}, N = this.hideLocked, C = new l.Parser({ onopentag: function(a3, t3) {
                var l2;
                !o2.cover && (null === (l2 = t3.class) || void 0 === l2 ? void 0 : l2.includes("ts-post-image")) ? (o2.name = t3.title, o2.cover = t3["data-src"] || t3.src || r.defaultCover) : "genxed" === t3.class || "sertogenre" === t3.class ? u3 = true : u3 && "a" === a3 ? c = true : "div" !== a3 || "entry-content" !== t3.class && "description" !== t3.itemprop ? "spe" === t3.class || "serl" === t3.class ? h = true : h && "span" === a3 ? p = true : "div" === a3 && "sertostat" === t3.class ? (h = true, p = true, m = true) : t3.class && t3.class.includes("eplister") ? b = true : b && "li" === a3 ? y = true : y ? "a" === a3 && void 0 === S.path ? S.path = t3.href.replace(e2, "").trim() : "epl-num" === t3.class ? g = 1 : "epl-title" === t3.class ? g = 2 : "epl-date" === t3.class ? g = 3 : "epl-price" === t3.class && (g = 4) : !v || "div" !== a3 && "script" !== a3 || v++ : v++;
              }, ontext: function(e3) {
                var a3, t3;
                if (u3) c && (o2.genres += e3 + ", ");
                  ...
                  if (1 === g) e3.includes("\u{1F512}") ? (k = true, w = true) : w && (k = false), n(e3, S);
                  else if (2 === g) S.name = (null === (t3 = null === (a3 = e3.match(RegExp("^".concat(o2.name.replace(/[.*+?^${}()|[\]\\]/g, "\\$&"), "\\s*(.+)")))) || void 0 === a3 ? void 0 : a3[1]) || void 0 === t3 ? void 0 : t3.trim()) || e3.trim(), S.chapterNumber || n(e3, S);
                  else if (3 === g) S.releaseTime = e3;
                  else if (4 === g) {
