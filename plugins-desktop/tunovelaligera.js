...
var LNReaderPlugin = (() => {
  ...
  // .js/plugins/spanish/tunovelaligera.js
  init_dirname();
  init_buffer2();
  init_process2();
  ...
  var TuNovelaLigera = (
    ...
    function() {
        ...
        this.filters = {
          order: {
            ...
            options: [
              ...
              { label: "Clasificaci\xF3n", value: "rating" },
          ...
          genres: {
            ...
            options: [
              { label: "None", value: "" },
              { label: "Acci\xF3n", value: "accion" },
              { label: "Adulto", value: "adulto" },
              { label: "Artes Marciales", value: "artes-marciales" },
              { label: "Aventura", value: "aventura" },
              { label: "Ciencia Ficci\xF3n", value: "ciencia-ficcion" },
              ...
              { label: "Fantas\xEDa", value: "fantasia" },
              { label: "Fantas\xEDa oriental", value: "fantasia-oriental" },
              { label: "Ficci\xF3n Rom\xE1ntica", value: "ficcion-romantica" },
              { label: "Gender Bender", value: "gender-bender" },
              { label: "Harem", value: "harem" },
              { label: "Hist\xF3rico", value: "historico" },
              ...
              { label: "Psicol\xF3gico", value: "psicologico" },
              { label: "Realismo M\xE1gico", value: "realismo-magico" },
              { label: "Recuento de vida", value: "recuento-de-vida" },
              { label: "Romance", value: "romance" },
              { label: "Romance contempor\xE1neo", value: "romance-contemporaneo" },
      ...
      __name(TuNovelaLigera2, "TuNovelaLigera");
      TuNovelaLigera2.prototype.sleep = function(ms) {
      ...
      TuNovelaLigera2.prototype.popularNovels = function(pageNo_1, _a) {
        return __awaiter(this, arguments, void 0, function(pageNo, _b) {
          ...
          return __generator(this, function(_e) {
            switch (_e.label) {
              case 0:
                link = this.site;
                link += ((_c = filters === null || filters === void 0 ? void 0 : filters.genres) === null || _c === void 0 ? void 0 : _c.value) ? "/genero" + filters.genres.value : "/novelas";
              ...
              case 1:
                ...
                loadedCheerio(".page-item-detail").each(function(i, el) {
                  ...
                  if (!url)
                    return;
                  novels.push({ name, cover, path: url.replace(_this.site, "") });
                });
                return [2, novels];
            }
          });
      ...
      TuNovelaLigera2.prototype.parseChapters = function(loadedCheerio) {
        var _this = this;
        var chapters = [];
        loadedCheerio("#lcp_instance_0 li").each(function(i, el) {
          var chapterName = loadedCheerio(el).find("a").text().replace(/[\t\n]/g, "").trim();
      ...
      TuNovelaLigera2.prototype.parseNovel = function(novelPath) {
        return __awaiter(this, void 0, void 0, function() {
          ...
          return __generator(this, function(_a) {
            switch (_a.label) {
              ...
              case 2:
                ...
                novel.cover = novelCover.attr("data-src") || novelCover.attr("src") || novelCover.attr("data-cfsrc") || defaultCover_1.defaultCover;
                loadedCheerio(".post-content_item").each(function() {
                  var detailName = loadedCheerio(this).find(".summary-heading > h5").text().trim();
                  ...
                  switch (detailName) {
                    ...
                    case "Autor(es)":
                      ...
                      break;
                    case "Estado":
                      novel.status = detail.includes("OnGoing") || detail.includes("Updating") ? novelStatus_1.NovelStatus.Ongoing : novelStatus_1.NovelStatus.Completed;
                      break;
                  }
                });
                ...
                latestChapterUrl = loadedCheerio(latestChapterEle).find("a").attr("href");
                latestChapterName = loadedCheerio(latestChapterEle).find("a").text().replace(/[\t\n]/g, "").trim();
      ...
      TuNovelaLigera2.prototype.parsePage = function(novelPath, page) {
        return __awaiter(this, void 0, void 0, function() {
          ...
          return __generator(this, function(_a) {
            switch (_a.label) {
              case 0:
                ...
                return [4, (0, fetch_1.fetchApi)(pageUrl).then(function(res) {
                  return res.text();
                })];
              case 1:
                pageText = _a.sent();
      ...
      TuNovelaLigera2.prototype.parseChapter = function(chapterPath) {
        return __awaiter(this, void 0, void 0, function() {
      ...
      TuNovelaLigera2.prototype.searchNovels = function(searchTerm) {
        return __awaiter(this, void 0, void 0, function() {
            ...
            switch (_a.label) {
              ...
              case 2:
                ...
                loadedCheerio(".c-tabs-item__content").each(function(i, el) {
                  ...
                  var cover = loadedCheerio(el).find("img").attr("src");
                  var url2 = loadedCheerio(el).find(".h4 > a").attr("href");
                  if (!url2)
                    return;
                  novels.push({ name, cover, path: url2.replace(_this.site, "") });
                });
                return [2, novels];
            }
          });
