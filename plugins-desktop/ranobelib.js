      ...
      RLIB2.prototype.parseNovel = function(novelPath) {
        return __awaiter(this, void 0, void 0, function() {
          ...
          return __generator(this, function(_l) {
            switch (_l.label) {
              case 0:
                return [4, (0, fetch_1.fetchApi)("".concat(this.apiSite).concat(novelPath, "?fields[]=summary&fields[]=genres&fields[]=tags&fields[]=teams&fields[]=authors&fields[]=status_id&fields[]=artists"), { headers: __assign(__assign({}, (_a = this.user) === null || _a === void 0 ? void 0 : _a.token), { "Site-Id": "3" }) }).then(function(res) {
                  return res.json();
                })];
              case 1:
                data = _l.sent().data;
                ...
                branch_name = ((_g = data.teams) === null || _g === void 0 ? void 0 : _g.reduce(function(acc, _a2) {
                  var _b2;
                  var name = _a2.name, details = _a2.details;
                ...
                return [4, (0, fetch_1.fetchApi)("".concat(this.apiSite).concat(novelPath, "/chapters"), { headers: (_h = this.user) === null || _h === void 0 ? void 0 : _h.token }).then(function(res) {
                  return res.json();
                })];
              case 2:
                ...
                if ((_j = chaptersJSON.data) === null || _j === void 0 ? void 0 : _j.length) {
                  chapters = chaptersJSON.data.flatMap(function(chapter) {
                    return chapter.branches.map(function(_a2) {
                      var branch_id = _a2.branch_id, created_at = _a2.created_at;
                  ...
                  if (chapters.length) {
                    ...
                    if (uniquePages.size === 1) {
                      chapters = chapters.map(function(chapter) {
                        return __assign(__assign({}, chapter), { page: void 0 });
                      });
          ...
          return __generator(this, function(_f) {
            switch (_f.label) {
              case 0:
                ...
                return [4, (0, fetch_1.fetchApi)(this.apiSite + slug + "/chapter?" + (branch_id ? "branch_id=" + branch_id + "&" : "") + "number=" + number + "&volume=" + volume, { headers: (_b = this.user) === null || _b === void 0 ? void 0 : _b.token }).then(function(res) {
                  return res.json();
                })];
              case 1:
                result = _f.sent();
