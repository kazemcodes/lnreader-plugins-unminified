...
var LNReaderPlugin = (() => {
  ...
  var LNTPlugin = (
    ...
    function() {
      ...
      __name(LNTPlugin2, "LNTPlugin");
      LNTPlugin2.prototype.popularNovels = function(pageNo_1, _a) {
        return __awaiter(this, arguments, void 0, function(pageNo, _b) {
          var link, body, html3, loadedCheerio, baseUrl, novels;
            ...
            switch (_c.label) {
              ...
              case 2:
                ...
                loadedCheerio("div.read_list-story-item").each(function(i, el) {
                  var tempNovel = {};
                  var img = loadedCheerio(el).find(".item_thumb").find("img").first().attr("src");
                  var path = loadedCheerio(el).find(".item_thumb").find("a").first().attr("href");
                  path = path ? path.slice(baseUrl.length) : "";
                  var title2 = loadedCheerio(el).find(".item_thumb").find("a").first().attr("title");
                  tempNovel.name = title2 ? title2 : "";
                  tempNovel.path = path;
                  tempNovel.cover = img;
      ...
      LNTPlugin2.prototype.parseNovel = function(novelPath) {
        return __awaiter(this, void 0, void 0, function() {
          var url, body, html3, novel, loadedCheerio, body2, html22, loadedCheerio2, baseUrl, chapters;
          return __generator(this, function(_a) {
            switch (_a.label) {
              ...
              case 2:
                ...
                novel.name = loadedCheerio("div.novel_title").find("h3").first().text().trim();
                novel.author = loadedCheerio("div.novel_detail_info").find("li").filter(function() {
                  return loadedCheerio(this).text().includes("Author");
                }).first().text().trim();
                return [4, (0, fetch_1.fetchApi)(url.replace("?tab=table_contents", ""))];
              case 3:
                body2 = _a.sent();
                return [4, body2.text().then(function(r) {
                  return r.replace(/>\s+</g, "><");
                })];
              case 4:
                html22 = _a.sent();
                loadedCheerio2 = (0, cheerio_1.load)(html22);
                novel.summary = loadedCheerio2("div.novel_text").find("p").first().text().trim();
                baseUrl = this.site;
                chapters = [];
      ...
      LNTPlugin2.prototype.parseChapter = function(chapterPath) {
        return __awaiter(this, void 0, void 0, function() {
          var body, html3, loadedCheerio, chapterText;
          return __generator(this, function(_a) {
            switch (_a.label) {
              case 0:
              ...
              case 2:
                ...
                return [2, chapterText.html() || ""];
            }
          });
        });
      };
      LNTPlugin2.prototype.searchNovels = function(searchTerm, pageNo) {
        return __awaiter(this, void 0, void 0, function() {
