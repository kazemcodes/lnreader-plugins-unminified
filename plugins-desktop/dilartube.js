...
var LNReaderPlugin = (() => {
  ...
  var dilartube = (
    ...
    function() {
      ...
      __name(dilartube2, "dilartube");
      dilartube2.prototype.parseNovels = function(data2) {
        var _this = this;
        var novels = [];
        var seenTitles = /* @__PURE__ */ new Set();
        if (data2.data && data2.data.length > 0) {
          data2.data.filter(function(dataItem) {
            return dataItem.is_novel;
            ...
            if (!seenTitles.has(dataItem.title)) {
              ...
              novels.push({
                ...
                cover: manga.cover ? "".concat(_this.site, "uploads/manga/cover/").concat(manga.id, "/").concat(manga.cover) : defaultCover_1.defaultCover
              });
            }
          });
        }
        if (data2.releases && data2.releases.length > 0) {
          data2.releases.filter(function(release2) {
            return release2.manga.is_novel;
          }).forEach(function(release2) {
            var manga = release2.manga;
      ...
      dilartube2.prototype.popularNovels = function(page_1, _a) {
        return __awaiter(this, arguments, void 0, function(page, _b) {
          ...
          return __generator(this, function(_c) {
            switch (_c.label) {
              ...
              case 1:
                response = _c.sent();
                return [2, this.parseNovels(response)];
            }
          });
        });
      };
      dilartube2.prototype.parseNovel = function(novelUrl) {
          ...
          return __generator(this, function(_a) {
            switch (_a.label) {
              case 0:
                ...
                return [4, (0, fetch_1.fetchApi)(fullUrl).then(function(r) {
                  return r.json();
                })];
              case 1:
                manga = _a.sent();
                return [4, (0, fetch_1.fetchApi)(chapterUrl).then(function(r) {
                  return r.json();
                })];
              case 2:
                chapters = _a.sent();
                ...
                mainGenres = mangaData.categories.map(function(category) {
      ...
      dilartube2.prototype.parseChapter = function(chapterUrl) {
        return __awaiter(this, void 0, void 0, function() {
      ...
      dilartube2.prototype.searchNovels = function(searchTerm, page) {
        return __awaiter(this, void 0, void 0, function() {
          var formData, response, data2;
          return __generator(this, function(_a) {
            switch (_a.label) {
              case 0:
                ...
                return [4, (0, fetch_1.fetchApi)("https://dilar.tube/api/quick_search", {
                  method: "POST",
                  body: formData
                }).then(function(r) {
                  return r.json();
