...
var LNReaderPlugin = (() => {
  ...
  var Yuuki = (
    ...
    function() {
      ...
      __name(Yuuki2, "Yuuki");
      Yuuki2.prototype.popularNovels = function() {
          ...
          return __generator(this, function(_a) {
            switch (_a.label) {
              ...
              case 2:
                ...
                novels = [];
                loadedCheerio(".quadmenu-navbar-collapse ul li:nth-child(2)").find("li").each(function(idx, ele) {
                  var novelName = loadedCheerio(ele).text().replace(/[\s\n]+/g, " ");
      ...
      Yuuki2.prototype.parseNovel = function(novelPath) {
        return __awaiter(this, void 0, void 0, function() {
          ...
          return __generator(this, function(_a) {
            switch (_a.label) {
              ...
              case 2:
                ...
                novel = {
                  path: novelPath,
                  name: loadedCheerio("h1.entry-title").text().replace(/[\t\n]/g, "").trim()
                };
                novel.cover = loadedCheerio('img[loading="lazy"]').attr("src");
                loadedCheerio(".entry-content").find("div").each(function() {
                  if (loadedCheerio(this).text().includes("Escritor:")) {
                    novel.author = loadedCheerio(this).text().replace("Escritor: ", "").trim();
                  }
                  if (loadedCheerio(this).text().includes("G\xE9nero:")) {
                    novel.genres = loadedCheerio(this).text().replace(/Género: |\s/g, "");
                  }
                ...
                if (loadedCheerio(".entry-content").find("li").length) {
                  loadedCheerio(".entry-content").find("li").each(function(idx, ele) {
                  ...
                  loadedCheerio(".entry-content").find("p").each(function(idx, ele) {
                    var chapterUrl = loadedCheerio(ele).find("a").attr("href");
                    if (chapterUrl && chapterUrl.includes(_this.site)) {
                      var chapterName = loadedCheerio(ele).text();
                      var releaseDate = null;
      ...
      Yuuki2.prototype.parseChapter = function(chapterPath) {
        return __awaiter(this, void 0, void 0, function() {
      ...
      Yuuki2.prototype.searchNovels = function(searchTerm) {
        return __awaiter(this, void 0, void 0, function() {
          var result, body, loadedCheerio, novels;
          var _this = this;
          return __generator(this, function(_a) {
            switch (_a.label) {
              ...
              case 2:
                ...
                loadedCheerio = (0, cheerio_1.load)(body);
                novels = [];
                loadedCheerio(".menu-item-2869").find(".menu-item.menu-item-type-post_type.menu-item-object-post").each(function(idx, ele) {
