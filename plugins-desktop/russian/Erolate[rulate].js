...
var LNReaderPlugin = (() => {
  ...
  var require_dayjs_min = __commonJS({
    "node_modules/dayjs/dayjs.min.js"(exports2, module2) {
      !(function(t2, e2) {
        ...
        "use strict";
        var t2 = 1e3, e2 = 6e4, n2 = 36e5, r2 = "millisecond", i = "second", s = "minute", u2 = "hour", a2 = "day", o = "week", c = "month", f = "quarter", h = "year", d = "date", l2 = "Invalid Date", $2 = /^(\d{4})[-/]?(\d{1,2})?[-/]?(\d{0,2})[Tt\s]*(\d{1,2})?:?(\d{1,2})?:?(\d{1,2})?[.:]?(\d+)?$/, y = /\[([^\]]+)]|Y{1,4}|M{1,4}|D{1,2}|d{1,4}|H{1,2}|h{1,2}|a|A|m{1,2}|s{1,2}|Z{1,2}|SSS/g, M = { name: "en", weekdays: "Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"), months: "January_February_March_April_May_June_July_August_September_October_November_December".split("_"), ordinal: function(t3) {
          ...
          return { M: c, y: h, w: o, d: a2, D: d, h: u2, m: s, s: i, ms: r2, Q: f }[t3] || String(t3 || "").toLowerCase().replace(/s$/, "");
        }, u: function(t3) {
          return void 0 === t3;
        } }, g = "en", D = {};
        D[g] = M;
        ...
        var _ = (function() {
          ...
          return m2.parse = function(t3) {
            ...
            var n3 = this, r3 = !!b2.u(e3) || e3, f2 = b2.p(t3), l3 = function(t4, e4) {
            ...
            var n3, o2 = b2.p(t3), f2 = "set" + (this.$u ? "UTC" : ""), l3 = (n3 = {}, n3[a2] = f2 + "Date", n3[d] = f2 + "Date", n3[c] = f2 + "Month", n3[h] = f2 + "FullYear", n3[u2] = f2 + "Hours", n3[s] = f2 + "Minutes", n3[i] = f2 + "Seconds", n3[r2] = f2 + "Milliseconds", n3)[o2], $3 = o2 === a2 ? this.$D + (e3 - this.$W) : e3;
            if (o2 === c || o2 === h) {
            ...
            if ($3 === a2) return y2(1);
            if ($3 === o) return y2(7);
            var M3 = (d2 = {}, d2[s] = e2, d2[u2] = n2, d2[i] = t2, d2)[$3] || 1, m3 = this.$d.getTime() + r3 * M3;
            return b2.w(m3, this);
            ...
            var r3 = t3 || "YYYY-MM-DDTHH:mm:ssZ", i2 = b2.z(this), s2 = this.$H, u3 = this.$m, a3 = this.$M, o2 = n3.weekdays, c2 = n3.months, f2 = n3.meridiem, h2 = function(t4, n4, i3, s3) {
            ...
            var $3, y2 = this, M3 = b2.p(d2), m3 = O(r3), v3 = (m3.utcOffset() - this.utcOffset()) * e2, g2 = this - m3, D2 = function() {
              return b2.m(y2, m3);
            };
            switch (M3) {
              case h:
        ...
        return O.prototype = k, [["$ms", r2], ["$s", i], ["$m", s], ["$H", u2], ["$W", a2], ["$M", c], ["$y", h], ["$D", d]].forEach((function(t3) {
          k[t3[1]] = function(e3) {
  ...
  // .js/plugins/russian/Erolate[rulate].js
  var l = function(l2, e2, a2, u2) {
    ...
    return t2.next = r2(0), t2.throw = r2(1), t2.return = r2(2), "function" == typeof Symbol && (t2[Symbol.iterator] = function() {
      return this;
    }), t2;
    function r2(r3) {
      return function(n2) {
        return (function(r4) {
          ...
          for (; t2 && (t2 = 0, r4[0] && (b2 = 0)), b2; ) try {
            if (a2 = 1, u2 && (v2 = 2 & r4[0] ? u2.return : r4[0] ? u2.throw || ((v2 = u2.return) && v2.call(u2), 0) : u2.next) && !(v2 = v2.call(u2, r4[1])).done) return v2;
            switch (u2 = 0, v2 && (r4 = [2 & r4[0], v2.value]), r4[0]) {
              case 0:
              case 1:
                v2 = r4;
                break;
              case 4:
                return b2.label++, { value: r4[1], done: false };
              case 5:
                b2.label++, u2 = r4[1], r4 = [0];
                continue;
              case 7:
                r4 = b2.ops.pop(), b2.trys.pop();
                continue;
              default:
                if (!(v2 = b2.trys, (v2 = v2.length > 0 && v2[v2.length - 1]) || 6 !== r4[0] && 2 !== r4[0])) {
                  b2 = 0;
                  continue;
                }
                if (3 === r4[0] && (!v2 || r4[1] > v2[0] && r4[1] < v2[3])) {
                  b2.label = r4[1];
                  break;
                }
                if (6 === r4[0] && b2.label < v2[1]) {
                  b2.label = v2[1], v2 = r4;
                  break;
                }
                if (v2 && b2.label < v2[2]) {
                  b2.label = v2[2], b2.ops.push(r4);
                  break;
                }
  ...
  var u = (init_fetch2(), __toCommonJS(fetch_exports)), v = (init_filterInputs(), __toCommonJS(filterInputs_exports)), b = (init_novelStatus(), __toCommonJS(novelStatus_exports)), t = (init_browser(), __toCommonJS(browser_exports)), r = a(require_dayjs_min()), n = new ((function() {
    function a2(l2) {
      this.parseDate = function(l3) {
        void 0 === l3 && (l3 = "");
        var e2 = { "\u044F\u043D\u0432.": 1, "\u0444\u0435\u0432\u0440.": 2, "\u043C\u0430\u0440.": 3, "\u0430\u043F\u0440.": 4, "\u043C\u0430\u044F": 5, "\u0438\u044E\u043D.": 6, "\u0438\u044E\u043B.": 7, "\u0430\u0432\u0433.": 8, "\u0441\u0435\u043D\u0442.": 9, "\u043E\u043A\u0442.": 10, "\u043D\u043E\u044F\u0431.": 11, "\u0434\u0435\u043A.": 12 }, a3 = l3.split(" "), u2 = a3[0], v2 = a3[1], b2 = a3[2], t2 = a3[4];
        return u2 && e2[v2] && b2 && t2 ? (0, r.default)(b2 + "-" + e2[v2] + "-" + u2 + " " + t2).format("LLL") : l3 || null;
      }, this.id = l2.id, this.name = l2.sourceName, this.icon = "multisrc/rulate/".concat(l2.id.toLowerCase(), "/icon.png"), this.site = l2.sourceSite, this.version = "1.0." + (2 + l2.versionIncrements), this.filters = l2.filters;
    }
    return a2.prototype.popularNovels = function(a3, v2) {
      return l(this, arguments, void 0, (function(l2, a4) {
        var v3, b2, r2, n2, i, o, s, c, h, p, d, f = this, m = a4.filters, y = a4.showLatestNovels;
        return e(this, (function(e2) {
          switch (e2.label) {
            case 0:
              return v3 = [], b2 = this.site + "/search?t=", b2 += "&cat=" + ((null === (i = null == m ? void 0 : m.cat) || void 0 === i ? void 0 : i.value) || "0"), b2 += "&s_lang=" + ((null === (o = null == m ? void 0 : m.s_lang) || void 0 === o ? void 0 : o.value) || "0"), b2 += "&t_lang=" + ((null === (s = null == m ? void 0 : m.t_lang) || void 0 === s ? void 0 : s.value) || "0"), b2 += "&type=" + ((null === (c = null == m ? void 0 : m.type) || void 0 === c ? void 0 : c.value) || "0"), b2 += "&sort=" + (y ? "4" : (null === (h = null == m ? void 0 : m.sort) || void 0 === h ? void 0 : h.value) || "6"), b2 += "&atmosphere=" + ((null === (p = null == m ? void 0 : m.atmosphere) || void 0 === p ? void 0 : p.value) || "0"), b2 += "&adult=" + ((null === (d = null == m ? void 0 : m.adult) || void 0 === d ? void 0 : d.value) || "0"), Object.entries(m || {}).forEach((function(l3) {
                var e3 = l3[0], a5 = l3[1].value;
                a5 instanceof Array && a5.length && (b2 += "&" + a5.map((function(l4) {
                  return "extra" == e3 ? l4 + "=1" : e3 + "[]=" + l4;
                })).join("&"));
              })), b2 += "&Book_page=" + l2, [4, (0, u.fetchApi)(b2).then((function(l3) {
                return l3.text();
              }))];
            case 1:
              return r2 = e2.sent(), (n2 = (0, t.load)(r2))('ul[class="search-results"] > li:not([class="ad_type_catalog"])').each((function(l3, e3) {
                n2(e3).find("p > a").text();
                var a5 = n2(e3).find("p > a").text(), u2 = n2(e3).find("img").attr("src"), b3 = n2(e3).find("p > a").attr("href");
                a5 && b3 && v3.push({ name: a5, cover: f.site + u2, path: b3 });
              })), [2, v3];
          }
        }));
      }));
      ...
      return l(this, void 0, void 0, (function() {
        var l2, v2, r2, n2, i, o, s, c, h, p = this;
        return e(this, (function(e2) {
          switch (e2.label) {
            case 0:
              return [4, (0, u.fetchApi)(this.site + a3)];
            case 1:
              return (l2 = e2.sent()).url.includes("mature?path=") ? ((v2 = new FormData()).append("path", a3), v2.append("ok", "\u0414\u0430"), [4, (0, u.fetchApi)(l2.url, { method: "POST", body: v2 })]) : [3, 3];
            case 2:
              l2 = e2.sent(), e2.label = 3;
            case 3:
              return [4, l2.text()];
            case 4:
              return r2 = e2.sent(), n2 = (0, t.load)(r2), i = { path: a3, name: n2(".span8 > h1, .book__title").text().trim() }, (null === (h = null === (c = i.name) || void 0 === c ? void 0 : c.includes) || void 0 === h ? void 0 : h.call(c, "[")) && (i.name = i.name.split("[")[0].trim()), i.cover = this.site + n2('div[class="images"] > div img, .book__cover > img').attr("src"), i.summary = n2("#Info > div:nth-child(4) > p:nth-child(1), .book__description").text().trim(), o = [], n2("div.span5 > p").each((function() {
                switch (n2(this).find("strong").text()) {
                  case "\u0410\u0432\u0442\u043E\u0440:":
                    i.author = n2(this).find("em > a").text().trim();
                    break;
                  case "\u0412\u044B\u043F\u0443\u0441\u043A:":
                    i.status = "\u043F\u0440\u043E\u0434\u043E\u043B\u0436\u0430\u0435\u0442\u0441\u044F" === n2(this).find("em").text().trim() ? b.NovelStatus.Ongoing : b.NovelStatus.Completed;
                    break;
                  case "\u0422\u044D\u0433\u0438:":
                  case "\u0416\u0430\u043D\u0440\u044B:":
                    n2(this).find("em > a").each((function() {
                      o.push(n2(this).text());
                    }));
                }
              })), o.length && (i.genres = o.reverse().join(",")), s = [], "rulate" === this.id ? n2("table > tbody > tr.chapter_row").each((function(l3, e3) {
                var a4, u2 = n2(e3).find('td[class="t"] > a').text().trim(), v3 = null === (a4 = n2(e3).find("td > span").attr("title")) || void 0 === a4 ? void 0 : a4.trim(), b2 = n2(e3).find('td[class="t"] > a').attr("href");
                !n2(e3).find('td > span[class="disabled"]').length && v3 && b2 && s.push({ name: u2, path: b2, releaseTime: p.parseDate(v3), chapterNumber: l3 + 1 });
              })) : n2("a.chapter").each((function(l3, e3) {
                var a4 = n2(e3).find("div:nth-child(1) > span:nth-child(2)").text().trim(), u2 = n2(e3).attr("href");
                !n2(e3).find('span[data-can-buy="true"]').length && u2 && s.push({ name: a4, path: u2, chapterNumber: l3 + 1 });
              })), i.chapters = s, [2, i];
          }
        }));
      }));
        ...
        return e(this, (function(e2) {
          switch (e2.label) {
            case 0:
              return [4, (0, u.fetchApi)(this.site + a3)];
            case 1:
              return (l2 = e2.sent()).url.includes("mature?path=") ? ((v2 = new FormData()).append("path", a3.split("/").slice(0, 3).join("/")), v2.append("ok", "\u0414\u0430"), [4, (0, u.fetchApi)(l2.url, { method: "POST", body: v2 })]) : [3, 3];
            case 2:
              l2 = e2.sent(), e2.label = 3;
            case 3:
              return [4, l2.text()];
            case 4:
              return b2 = e2.sent(), r2 = (0, t.load)(b2), [2, r2(".content-text, #read-text").html() || ""];
          }
        }));
      }));
