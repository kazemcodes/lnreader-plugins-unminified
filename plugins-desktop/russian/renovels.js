...
var LNReaderPlugin = (() => {
      ...
      !(function(t2, e2) {
        ...
        var _ = (function() {
          ...
          return m2.parse = function(t3) {
            ...
            var n3 = this, r2 = !!b2.u(e3) || e3, f2 = b2.p(t3), l3 = function(t4, e4) {
            ...
            var r2 = t3 || "YYYY-MM-DDTHH:mm:ssZ", i2 = b2.z(this), s2 = this.$H, u3 = this.$m, a3 = this.$M, o2 = n3.weekdays, c2 = n3.months, f2 = n3.meridiem, h2 = function(t4, n4, i3, s3) {
            ...
            var $2, y2 = this, M3 = b2.p(d2), m3 = O(r2), v3 = (m3.utcOffset() - this.utcOffset()) * e2, g2 = this - m3, D2 = function() {
              return b2.m(y2, m3);
            };
            switch (M3) {
              case h:
  ...
  var u = (init_filterInputs(), __toCommonJS(filterInputs_exports)), v = (init_fetch2(), __toCommonJS(fetch_exports)), b = (init_novelStatus(), __toCommonJS(novelStatus_exports)), t = a(require_dayjs_min()), n = (function() {
    function a2() {
      var l2 = this;
      this.id = "ReN", this.name = "Renovels", this.icon = "src/ru/renovels/icon.png", this.site = "https://renovels.org", this.version = "1.0.3", this.resolveUrl = function(e2) {
    ...
    return a2.prototype.popularNovels = function(a3, u2) {
      return l(this, arguments, void 0, (function(l2, a4) {
        var u3, b2, t2, n2 = this, r = a4.showLatestNovels, i = a4.filters;
        return e(this, (function(e2) {
          switch (e2.label) {
            case 0:
              return u3 = this.site + "/api/v2/search/catalog/?count=30&ordering=-", u3 += r ? "chapter_date" : (null === (t2 = null == i ? void 0 : i.sort) || void 0 === t2 ? void 0 : t2.value) || "rating", Object.entries(i || {}).forEach((function(l3) {
                var e3 = l3[0], a5 = l3[1].value;
                a5 instanceof Array && a5.length && (u3 += "&" + e3 + "=" + a5.join("&" + e3 + "=")), (null == a5 ? void 0 : a5.include) instanceof Array && a5.include.length && (u3 += "&" + e3 + "=" + a5.include.join("&" + e3 + "=")), (null == a5 ? void 0 : a5.exclude) instanceof Array && a5.exclude.length && (u3 += "&exclude_" + e3 + "=" + a5.exclude.join("&exclude_" + e3 + "="));
              })), u3 += "&page=" + l2, [4, (0, v.fetchApi)(u3).then((function(l3) {
                return l3.json();
              }))];
            case 1:
              return b2 = e2.sent().results, [2, b2.map((function(l3) {
                return { name: l3.main_name || l3.secondary_name, cover: n2.site + (l3.cover.high || l3.cover.mid || l3.cover.low), path: l3.dir };
              }))];
          }
        }));
      }));
      ...
      return l(this, void 0, void 0, (function() {
        var l2, u2, n2, r, i, o, s, c, h, p, f, d, y;
          ...
          switch (m.label) {
            ...
            case 1:
              l2 = m.sent().content, u2 = { path: a3, name: l2.main_name || l2.secondary_name || l2.another_name, summary: l2.description, cover: this.site + "/media/" + (l2.cover.high || l2.cover.mid || l2.cover.low), status: "\u041F\u0440\u043E\u0434\u043E\u043B\u0436\u0430\u0435\u0442\u0441\u044F" === l2.status.name ? b.NovelStatus.Ongoing : b.NovelStatus.Completed }, (n2 = [null == l2 ? void 0 : l2.genres, null == l2 ? void 0 : l2.categories].flat().map((function(l3) {
                ...
                return l3;
              }))).length && (u2.genres = n2.join(",")), r = ((null === (f = null === (p = l2.branches) || void 0 === p ? void 0 : p[0]) || void 0 === f ? void 0 : f.count_chapters) || l2.count_chapters) / 100, i = (null === (y = null === (d = l2.branches) || void 0 === d ? void 0 : d[0]) || void 0 === y ? void 0 : y.id) || l2.id, o = [], s = function(l3) {
                var u3, b2;
                return e(this, (function(e2) {
                  switch (e2.label) {
                    case 0:
              ...
              }, c = this, h = 0, m.label = 2;
            case 2:
              return h < r ? [5, s(h)] : [3, 5];
            case 3:
