...
var LNReaderPlugin = (() => {
  ...
  var BlogDoAnonNovelsPlugin = (
    /** @class */
    function() {
      function BlogDoAnonNovelsPlugin2() {
      ...
      __name(BlogDoAnonNovelsPlugin2, "BlogDoAnonNovelsPlugin");
      BlogDoAnonNovelsPlugin2.prototype.parseNovels = function(json) {
        var _this = this;
        var novels = [];
        ...
        result.feed.entry.forEach(function(n) {
          ...
          var novelUrl = n.link.find(function(t) {
      ...
      BlogDoAnonNovelsPlugin2.prototype.popularNovels = function(pageNo_1, _a) {
        return __awaiter(this, arguments, void 0, function(pageNo, _b) {
          ...
          return __generator(this, function(_c) {
            switch (_c.label) {
              case 0:
                if (showLatestNovels) {
                  return [2, this.searchNovels("", pageNo)];
                }
                if (pageNo > 1) {
                  return [2, []];
                }
                return [4, (0, fetch_1.fetchApi)(this.site).then(function(result) {
                  return result.text();
                })];
              case 1:
                body = _c.sent();
      ...
      BlogDoAnonNovelsPlugin2.prototype.parseNovel = function(novelPath) {
          ...
          return __generator(this, function(_a) {
            switch (_a.label) {
              ...
              case 1:
                ...
                novel.genres = loadedCheerio('dt:contains("G\xEAnero:")').parent().find("a").map(function(_, ex) {
                ...
                if (!cat) {
                  ...
                  novel.chapters = chapters_1.reverse().map(function(c, i) {
              ...
              case 2:
                ...
                return [4, (0, fetch_1.fetchApi)(jsonUrl).then(function(result2) {
                  return result2.text();
                })];
              case 3:
                ...
                result.feed.entry.forEach(function(n) {
                  ...
                  var chapterUrl = n.link.find(function(t) {
                    return "alternate" == t.rel;
                  }).href;
                ...
                _a.label = 4;
              case 4:
                if (length >= maxResults) return [3, 2];
                _a.label = 5;
              case 5:
      ...
      BlogDoAnonNovelsPlugin2.prototype.searchNovels = function(searchTerm, pageNo) {
        return __awaiter(this, void 0, void 0, function() {
          ...
          return __generator(this, function(_a) {
            switch (_a.label) {
              case 0:
                ...
                return [4, (0, fetch_1.fetchApi)(jsonUrl).then(function(result) {
                  return result.text();
                })];
              case 1:
                json = _a.sent();
                return [2, this.parseNovels(json)];
            }
          });
        });
      };
      BlogDoAnonNovelsPlugin2.prototype.parseChapter = function(chapterPath) {
        return __awaiter(this, void 0, void 0, function() {
          ...
          return __generator(this, function(_a) {
            switch (_a.label) {
              ...
              case 1:
                ...
                return [2, $readerarea.html() || ""];
            }
          });
        });
      };
      return BlogDoAnonNovelsPlugin2;
    }()
  );
