...
var LNReaderPlugin = (() => {
  ...
  var ixdzs8Plugin = (
    ...
    function() {
      ...
      __name(ixdzs8Plugin2, "ixdzs8Plugin");
      ixdzs8Plugin2.prototype.popularNovels = function(pageNo) {
        return __awaiter(this, void 0, void 0, function() {
          var url, result, $2, _a, novels, processedPaths;
          var _this = this;
          return __generator(this, function(_b) {
            switch (_b.label) {
              ...
              case 2:
                ...
                $2("ul.u-list > li.burl").each(function(_i, el) {
                  var _a2, _b2;
                  var $el = $2(el);
                  var novelPath;
                  var novelName;
                  ...
                  novelCover = (_b2 = $el.find(".l-img img").attr("src")) === null || _b2 === void 0 ? void 0 : _b2.trim();
      ...
      ixdzs8Plugin2.prototype.parseNovel = function(novelPath) {
        return __awaiter(this, void 0, void 0, function() {
          var novelUrl, result, $2, _a, $novel, $intro, summary, $tagsDiv, statOngoing, statEnd, detail, novel, chapterListPath, _b;
          var _c;
          return __generator(this, function(_d) {
            switch (_d.label) {
              ...
              case 1:
                ...
                return [4, result.text()];
              case 2:
                $2 = _a.apply(void 0, [_d.sent()]);
                $novel = $2("div.novel");
                $intro = $2("p#intro.pintro");
                $intro.find("span.icon").remove();
                summary = (_c = $intro.html()) === null || _c === void 0 ? void 0 : _c.replace(/<br\s*\/?>/gi, "\n").replace(/<[^>]+>/g, "").replace(/\u3000/g, " ").replace(/&nbsp;/g, " ").split("\n").map(function(line) {
                  return line.trim();
                }).filter(function(line) {
                  return line.length > 0;
                }).join(" ");
                $tagsDiv = $2("div.panel div.tags");
                ...
                novel = {
                  ...
                  cover: makeAbsolute($novel.find(".n-img img").attr("src"), this.site) || defaultCover_1.defaultCover,
                  summary,
                  author: $novel.find(".n-text p a.bauthor").text().trim() || void 0,
                  genres: $tagsDiv.find("em a").map(function(_i, el) {
                    return $2(el).text().trim();
                  }).get().filter(function(tag) {
                    return tag.length > 0;
                  }).join(", "),
                  status: detail === "Ongoing" ? novelStatus_1.NovelStatus.Ongoing : detail === "Completed" ? novelStatus_1.NovelStatus.Completed : novelStatus_1.NovelStatus.Unknown,
                  chapters: []
                };
                chapterListPath = $2("#bid").attr("value");
      ...
      ixdzs8Plugin2.prototype.parseChapterList = function(bid) {
        return __awaiter(this, void 0, void 0, function() {
            ...
            switch (_a.label) {
              ...
              case 2:
                ...
                chapters = json.data.map(function(ch) {
                  return {
                    name: ch.title,
                    path: ch.ctype === "0" ? "read/".concat(bookId, "/p").concat(ch.ordernum, ".html") : "",
                    // only normal chapters get link
                    releaseTime: void 0
                    // optional, not provided here
                  };
                });
                return [2, chapters];
            }
      ...
      ixdzs8Plugin2.prototype.parseChapter = function(chapterPath) {
        return __awaiter(this, void 0, void 0, function() {
          var chapterUrl, result, html3, tokenMatch, challengeUrl, $2, $content, chapterText;
          return __generator(this, function(_a) {
            switch (_a.label) {
              case 0:
              ...
              case 2:
                html3 = _a.sent();
                if (!(html3.includes("\u6B63\u5728\u9032\u884C\u5B89\u5168\u9A57\u8B49") || html3.includes("challenge"))) return [3, 5];
                tokenMatch = html3.match(/let token\s*=\s*"([^"]+)"/);
                if (!tokenMatch) return [3, 5];
                challengeUrl = chapterUrl + "?challenge=" + encodeURIComponent(tokenMatch[1]);
                return [4, (0, fetch_1.fetchApi)(challengeUrl)];
              case 3:
                result = _a.sent();
                if (!result.ok)
              ...
              case 5:
                ...
                $content = $2("article section");
                if (!$content.length) {
                  return [2, "Error: Could not find chapter content at ".concat(chapterUrl)];
                }
                $content.find('script, style, ins, iframe, [class*="abg"], [class*="ads"], [id*="ads"], [class*="google"], [id*="google"], [class*="recommend"], div[align="center"], p:contains("\u63A8\u85A6\u672C\u66F8"), a[href*="javascript:"]').remove();
      ...
      ixdzs8Plugin2.prototype.searchNovels = function(searchTerm, pageNo) {
        return __awaiter(this, void 0, void 0, function() {
          var searchUrl, body, result, error_1, $2, novels;
          var _this = this;
          return __generator(this, function(_a) {
            switch (_a.label) {
              case 0:
              ...
              case 5:
                ...
                $2("ul.u-list li.burl").each(function(_i, el) {
                  var _a2, _b;
                  var $el = $2(el);
                  var novelPath = (_a2 = $el.attr("data-url")) === null || _a2 === void 0 ? void 0 : _a2.trim();
