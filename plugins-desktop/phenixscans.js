...
var LNReaderPlugin = (() => {
  ...
  var PhenixScansTradPlugin = (
    /** @class */
    function() {
      function PhenixScansTradPlugin2() {
        this.id = "phenixscans";
        ...
        this.filters = {
          genre: {
            ...
            options: [
              ...
              { label: "Action Drame Sh\xF4nen", value: "action-drame-shonen" },
              { label: "Adult", value: "adult" },
              { label: "Adventure", value: "adventure" },
              { label: "amiti\xE9", value: "amitie" },
              ...
              { label: "myst\xE8re", value: "mystere" },
              ...
              { label: "r\xE9gression", value: "regression" },
              { label: "R\xE9incarnation", value: "reincarnation" },
              { label: "Returner", value: "returner" },
              { label: "Romance", value: "romance" },
              { label: "School Life", value: "school-life" },
              { label: "Sci-fi", value: "sci-fi" },
              { label: "Seinen", value: "seinen" },
              { label: "Sh\xF4jo", value: "shojo" },
              { label: "Sh\xF4nen", value: "shonen" },
              ...
              { label: "Syst\xE8me", value: "systeme" },
              { label: "Trag\xE9die", value: "tragedie" },
      ...
      __name(PhenixScansTradPlugin2, "PhenixScansTradPlugin");
      PhenixScansTradPlugin2.prototype.getCheerio = function(url) {
      ...
      PhenixScansTradPlugin2.prototype.popularNovels = function(pageNo_1, _a) {
        return __awaiter(this, arguments, void 0, function(pageNo, _b) {
          var novels, novel, filter3, key, _i, _c, value, order, url, $2;
          var _this = this;
                ...
                for (key in filters) {
                  if (typeof filters[key].value === "object") {
                    for (_i = 0, _c = filters[key].value; _i < _c.length; _i++) {
                      value = _c[_i];
                      filter3 += "&genre%5B%5D=".concat(value);
                    }
                  }
                }
                order = showLatestNovels ? "update" : "popular";
                url = "".concat(this.site, "/manga/?page=").concat(pageNo).concat(filter3, "&status=&type=novel&order=").concat(order);
                return [4, this.getCheerio(url)];
              case 1:
                $2 = _d.sent();
                $2("div div div div a").each(function(i, elem) {
                  var _a2;
                  var novelName = (_a2 = $2(elem).attr("title")) === null || _a2 === void 0 ? void 0 : _a2.trim();
                  var novelUrl = $2(elem).attr("href");
                  var novelCover = $2(elem).find("div img").attr("src") || defaultCover_1.defaultCover;
      ...
      PhenixScansTradPlugin2.prototype.parseNovel = function(novelPath) {
        return __awaiter(this, void 0, void 0, function() {
          var novel, $2, chapters;
          var _this = this;
          return __generator(this, function(_a) {
            switch (_a.label) {
              case 0:
              ...
              case 1:
                $2 = _a.sent();
                novel.name = $2("h1[itemprop=name]").text().replace("\u2013 Novel", "").trim();
                novel.cover = $2("div[itemprop=image] img").first().attr("src") || defaultCover_1.defaultCover;
                novel.author = $2(".fmed b:contains(Auteur)+span").text().trim();
                novel.genres = $2(".mgen a").map(function() {
                  return $2(this).text();
                }).get().join(", ");
                novel.summary = $2(".entry-content[itemprop=description]").text().trim();
                novel.status = this.getStatus($2(".tsinfo .imptdt:contains(Statut)").text().replace("Statut", "").trim());
                chapters = [];
                $2("ul li:has(div.chbox):has(div.eph-num)").each(function(i, elem) {
                  var chapterName = $2(elem).find("a .chapternum").text().trim();
                  var chapterUrl = $2(elem).find("a").attr("href");
                  var releaseDate = _this.parseDate($2(elem).find("a .chapterdate").text());
      ...
      PhenixScansTradPlugin2.prototype.parseDate = function(date) {
        var monthMapping = {
          janvier: 1,
          fevrier: 2,
          mars: 3,
      ...
      PhenixScansTradPlugin2.prototype.getStatus = function(status) {
        var lowerCaseStatus = status.toLowerCase();
        var ongoing = ["en cours", "en cours de publication"];
        var onhiatus = ["en pause", "en attente"];
        var completed = ["compl\xE9t\xE9", "fini", "achev\xE9", "termin\xE9"];
        var cancelled = ["abandonn\xE9"];
      ...
      PhenixScansTradPlugin2.prototype.parseChapter = function(chapterPath) {
        return __awaiter(this, void 0, void 0, function() {
          var $2;
          return __generator(this, function(_a) {
            switch (_a.label) {
              ...
              case 1:
                $2 = _a.sent();
                return [2, $2("#readerarea").html() || ""];
            }
          });
        });
      };
      PhenixScansTradPlugin2.prototype.searchNovels = function(searchTerm, pageNo) {
        return __awaiter(this, void 0, void 0, function() {
