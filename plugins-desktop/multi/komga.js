...
var LNReaderPlugin = (() => {
  ...
  var t = function(t2, e2, a2, r2) {
    ...
    var a2, r2, n2, s2 = { label: 0, sent: function() {
      ...
      return t(this, void 0, void 0, (function() {
        ...
        return e(this, (function(e2) {
          switch (e2.label) {
            ...
            case 4:
              for (f = e2.sent(), v = JSON.parse(f), d = this.flattenArray(v.toc), b = 1, g = function(t3) {
              ...
              }, m = 0, y = v.readingOrder; m < y.length; m++) w = y[m], g(w);
              e2.label = 5;
            case 5:
              return c++, [3, 3];
            case 6:
