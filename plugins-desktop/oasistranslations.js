...
var LNReaderPlugin = (() => {
  ...
  var Oasis = (
    ...
    function() {
      ...
      __name(Oasis2, "Oasis");
      Oasis2.prototype.popularNovels = function() {
          ...
          return __generator(this, function(_a) {
            switch (_a.label) {
              ...
              case 2:
                ...
                novels = [];
                loadedCheerio(".menu-item-1819").find(".sub-menu > li").each(function(idx, ele) {
      ...
      Oasis2.prototype.parseNovel = function(novelPath) {
        return __awaiter(this, void 0, void 0, function() {
              ...
              case 2:
                ...
                loadedCheerio(".entry-content > p").each(function() {
                  ...
                  if (loadedCheerio(_this).text().includes("Autor")) {
                    var details = (_b = (_a2 = loadedCheerio(_this).html()) === null || _a2 === void 0 ? void 0 : _a2.match(/<\/strong>(.|\n)*?<br>/g)) === null || _b === void 0 ? void 0 : _b.map(function(detail) {
                      return detail.replace(/<strong>|<\/strong>|<br>|:\s/g, "");
                    });
                    novel.genres = "";
                    if (details) {
                ...
                novel.summary = "";
                novelChapters = [];
                loadedCheerio(".entry-content").find("a").each(function(idx, ele) {
      ...
      Oasis2.prototype.parseChapter = function(chapterPath) {
        return __awaiter(this, void 0, void 0, function() {
      ...
      Oasis2.prototype.searchNovels = function(searchTerm) {
        return __awaiter(this, void 0, void 0, function() {
          var result, body, loadedCheerio, novels;
          var _this = this;
          return __generator(this, function(_a) {
