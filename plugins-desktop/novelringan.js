...
var LNReaderPlugin = (() => {
  ...
  var NovelRingan = (
    ...
    function() {
      ...
      __name(NovelRingan2, "NovelRingan");
      NovelRingan2.prototype.parseNovels = function(loadedCheerio) {
        var _this = this;
        var novels = [];
      ...
      NovelRingan2.prototype.popularNovels = function(page_1, _a) {
            ...
            switch (_c.label) {
              case 0:
                ...
                if (filters.type.value.length)
                  link += filters.type.value.map(function(i) {
                    return "&type[]=".concat(i);
                  }).join("");
      ...
      NovelRingan2.prototype.parseNovel = function(novelPath) {
          ...
          return __generator(this, function(_b) {
            switch (_b.label) {
              ...
              case 2:
                body = _b.sent();
                loadedCheerio = (0, cheerio_1.load)(body);
                styletag = Array.from(((_a = loadedCheerio("meta[name=msapplication-TileImage] + style").html()) === null || _a === void 0 ? void 0 : _a.matchAll(/"(.*?)"/g)) || [], function(m) {
                  return m[1];
                });
                novel = {
                  path: novelPath,
                ...
                novel.cover = this.coverUriPrefix + loadedCheerio("img.ts-post-image").attr("data-sxrx");
      ...
      NovelRingan2.prototype.parseChapter = function(chapterPath) {
        return __awaiter(this, void 0, void 0, function() {
      ...
      NovelRingan2.prototype.searchNovels = function(searchTerm, page) {
        return __awaiter(this, void 0, void 0, function() {
