...
var LNReaderPlugin = (() => {
  ...
  var Shu69 = (
    ...
    function() {
      ...
      __name(Shu692, "Shu69");
      Shu692.prototype.popularNovels = function(pageNo_1, _a) {
          ...
          return __generator(this, function(_c) {
            switch (_c.label) {
              case 0:
                ...
                return [4, (0, fetch_1.fetchText)(url, this.fetchOptions)];
              case 1:
                body = _c.sent();
                if (body === "")
                ...
                loadedCheerio("div.book-coverlist").each(function(i, el) {
                  var url2 = loadedCheerio(el).find("a.cover").attr("href");
      ...
      Shu692.prototype.parseNovel = function(novelPath) {
            ...
            switch (_a.label) {
                    ...
                    switch (_b.label) {
                      ...
                      case 1:
                        ...
                        chaptersLoadedCheerio("dl.panel-chapterlist dd").each(function(i, el) {
                          ...
                          if (chapterUrl) {
                            var relativeChapterUrl_1 = chapterUrl.startsWith("http") ? chapterUrl.replace(_this.site, "") : chapterUrl;
                            if (!chapters.some(function(chap) {
                              return chap.path === relativeChapterUrl_1;
                            })) {
                              chapters.push({
                                name: chapterName,
              ...
              case 5:
                loadedCheerio("div.panel.hidden-xs > dl.panel-chapterlist:nth-child(2) > dd").each(function(i, el) {
                  ...
                  if (chapterUrl) {
                    var relativeChapterUrl = chapterUrl.startsWith("http") ? chapterUrl.replace(_this.site, "") : chapterUrl;
                    chapters.push({
                      name: chapterName,
                ...
                _a.label = 6;
              case 6:
                uniqueChapters = chapters.filter(function(chapter, index2, self2) {
                  return index2 === self2.findIndex(function(c) {
                    return c.path === chapter.path;
                  });
                });
      ...
      Shu692.prototype.parseChapter = function(chapterPath) {
        return __awaiter(this, void 0, void 0, function() {
          ...
          return __generator(this, function(_a) {
            switch (_a.label) {
              case 0:
                ...
                return [4, (0, fetch_1.fetchText)(chapterUrl, this.fetchOptions)];
              case 1:
                body = _a.sent();
                loadedCheerio = (0, cheerio_1.load)(body);
                chapterText = loadedCheerio("#chaptercontent p").map(function(i, el) {
                  return loadedCheerio(el).text();
                }).get().map(function(line) {
                  return line.trim();
                }).filter(function(line) {
                  return line !== "" && !line.includes("69\u4E66\u5427");
                }).map(function(line) {
      ...
      Shu692.prototype.searchNovels = function(searchTerm, pageNo) {
        return __awaiter(this, void 0, void 0, function() {
          ...
          return __generator(this, function(_a) {
            switch (_a.label) {
              case 0:
                ...
                return [4, (0, fetch_1.fetchText)(searchUrl, searchOptions)];
              case 1:
                body = _a.sent();
                if (body === "")
