...
var LNReaderPlugin = (() => {
  ...
  var KDTNovels = (
    ...
    function() {
      ...
      __name(KDTNovels2, "KDTNovels");
      KDTNovels2.prototype.parseNovelItems = function(html3) {
        var _this = this;
        var $2 = (0, cheerio_1.load)(html3);
        var novels = [];
        $2("div.c-tabs-item__content").each(function(_, element) {
      ...
      KDTNovels2.prototype.parseNovelStatus = function(statusText) {
        if (!statusText) {
          return novelStatus_1.NovelStatus.Unknown;
        }
        var normalizedStatus = statusText.toLowerCase().trim();
        if (normalizedStatus.includes("ongoing") || normalizedStatus.includes("on going")) {
        ...
        if (normalizedStatus.includes("finished") || normalizedStatus.includes("publishing finished")) {
        ...
        if (normalizedStatus.includes("hiatus") || normalizedStatus.includes("on hiatus")) {
          return novelStatus_1.NovelStatus.OnHiatus;
        }
        return statusText || novelStatus_1.NovelStatus.Unknown;
      };
      KDTNovels2.prototype.popularNovels = function(pageNo, options) {
        return __awaiter(this, void 0, void 0, function() {
          var orderBy, url, response, html3, error_1;
          return __generator(this, function(_a) {
            switch (_a.label) {
              ...
              case 3:
                html3 = _a.sent();
                return [2, this.parseNovelItems(html3)];
              case 4:
                error_1 = _a.sent();
      ...
      KDTNovels2.prototype.searchNovels = function(searchTerm, pageNo) {
        return __awaiter(this, void 0, void 0, function() {
          var url, response, html3, novels, error_2;
          return __generator(this, function(_a) {
            switch (_a.label) {
              case 0:
              ...
              case 3:
                html3 = _a.sent();
                novels = this.parseNovelItems(html3);
                if (novels.length === 0) {
      ...
      KDTNovels2.prototype.parseNovel = function(novelPath) {
        return __awaiter(this, void 0, void 0, function() {
          var novelUrl, response, html3, $_1, novel, titleElement, coverElement, coverSrc, genreElements, genres_1, summaryElements, summaryParts_1, statusElement, rawStatus, chapters_1, ajaxUrl, chapterResponse, chapterHtml, $chapters_1, chapterElements_1, chapterError_1, error_3;
          return __generator(this, function(_a) {
            switch (_a.label) {
              case 0:
              ...
              case 3:
                ...
                summaryElements.each(function(_, element) {
                  var text3 = $_1(element).text().trim();
                  if (text3) {
                    summaryParts_1.push(text3);
                  }
                });
              ...
              case 4:
                ...
                return [4, (0, fetch_1.fetchApi)(ajaxUrl, {
                  method: "POST"
                })];
              case 5:
                chapterResponse = _a.sent();
                return [4, chapterResponse.text()];
              case 6:
                chapterHtml = _a.sent();
                $chapters_1 = (0, cheerio_1.load)(chapterHtml);
                chapterElements_1 = $chapters_1("li.free-chap");
                chapterElements_1.each(function(index2, element) {
                  ...
                  var releaseDateElement = $element.find("span.chapter-release-date").first();
                  var releaseTime = releaseDateElement.text().trim() || null;
                  var chapterNumber = chapterElements_1.length - index2;
      ...
      KDTNovels2.prototype.parseChapter = function(chapterPath) {
        return __awaiter(this, void 0, void 0, function() {
          var chapterUrl, response, html3, $_2, contentContainer, chapterContent, error_4;
          return __generator(this, function(_a) {
            switch (_a.label) {
              case 0:
              ...
              case 3:
                ...
                contentContainer.find("p, div, br").each(function(_, element) {
                  ...
                  if (((_a2 = element.tagName) === null || _a2 === void 0 ? void 0 : _a2.toLowerCase()) === "p" && $element.text().trim()) {
                  }
                  if (((_b = element.tagName) === null || _b === void 0 ? void 0 : _b.toLowerCase()) === "div" && $element.text().trim()) {
                  }
                });
                ...
                return [2, (chapterContent === null || chapterContent === void 0 ? void 0 : chapterContent.trim()) || ""];
              case 4:
                error_4 = _a.sent();
