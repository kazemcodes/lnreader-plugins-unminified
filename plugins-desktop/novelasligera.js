...
var LNReaderPlugin = (() => {
  ...
  var Ligera = (
    ...
    function() {
      ...
      __name(Ligera2, "Ligera");
      Ligera2.prototype.popularNovels = function() {
            ...
            switch (_a.label) {
              ...
              case 2:
                ...
                loadedCheerio(".elementor-column").each(function(idx, ele) {
                  var novelName = loadedCheerio(ele).find(".widget-image-caption.wp-caption-text").text();
                  if (novelName) {
                    var novelCover = loadedCheerio(ele).find("a > img").attr("data-lazy-src");
      ...
      Ligera2.prototype.parseNovel = function(novelPath) {
        return __awaiter(this, void 0, void 0, function() {
          ...
          return __generator(this, function(_a) {
            switch (_a.label) {
              ...
              case 2:
                ...
                novel.cover = loadedCheerio(".elementor-widget-container").find("img").attr("data-lazy-src");
                loadedCheerio(".elementor-row").find("p").each(function() {
                  ...
                  if (loadedCheerio(this).text().includes("Estado:")) {
                    novel.status = loadedCheerio(this).text().replace("Estado: ", "").trim();
                  }
                ...
                loadedCheerio(".elementor-tab-content").find("li").each(function(idx, ele) {
      ...
      Ligera2.prototype.parseChapter = function(chapterPath) {
        return __awaiter(this, void 0, void 0, function() {
      ...
      Ligera2.prototype.searchNovels = function(searchTerm) {
        return __awaiter(this, void 0, void 0, function() {
