        ...
        this.filters = {
          ...
          type: {
            ...
            options: [
              ...
              { label: "Truy\u1EC7n s\xE1ng t\xE1c", value: "sangtac" },
          ...
          status: {
            ...
            value: [],
            options: [
              { label: "\u0110ang ti\u1EBFn h\xE0nh", value: "dangtienhanh" },
              { label: "T\u1EA1m ng\u01B0ng", value: "tamngung" },
              { label: "\u0110\xE3 ho\xE0n th\xE0nh", value: "hoanthanh" }
            ]
          },
          sort: {
            type: filterInputs_1.FilterTypes.Picker,
            ...
            options: [
              ...
              { label: "Theo d\xF5i", value: "theodoi" },
              { label: "Top to\xE0n th\u1EDDi gian", value: "top" },
              { label: "Top th\xE1ng", value: "topthang" },
