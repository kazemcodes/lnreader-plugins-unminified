...
var LNReaderPlugin = (() => {
  ...
  var XiaowazPlugin = (
    ...
    function() {
      ...
      __name(XiaowazPlugin2, "XiaowazPlugin");
      XiaowazPlugin2.prototype.getCheerio = function(url) {
        return __awaiter(this, void 0, void 0, function() {
          var retries, returnError, r, body, $2, error_1;
      ...
      XiaowazPlugin2.prototype.getAllNovels = function() {
        return __awaiter(this, void 0, void 0, function() {
          var novels, novel, $2, categories;
          var _this = this;
          return __generator(this, function(_a) {
            switch (_a.label) {
              case 0:
              ...
              case 1:
                $2 = _a.sent();
                categories = [
                  $2("li.page_item").find('a:contains("S\xE9ries")').parent(),
                  $2("li.page_item").find('a:contains("Cr\xE9ations")').parent(),
                  $2("li.page_item").find('a:contains("\u2020")').parent()
                ];
                categories.forEach(function(cheerio) {
                  cheerio.find("ul.children li").each(function(i, elem) {
                    var novelName = $2(elem).first().text().trim().replace("\u2714", "");
      ...
      XiaowazPlugin2.prototype.getNovelsCovers = function(novels) {
        return __awaiter(this, void 0, void 0, function() {
          var _this = this;
          return __generator(this, function(_a) {
            switch (_a.label) {
                ...
                return [4, Promise.all(novels.map(function(novel) {
                  return __awaiter(_this, void 0, void 0, function() {
                    ...
                    return __generator(this, function(_a2) {
                      switch (_a2.label) {
                        case 0:
                          return [4, this.getCheerio(this.site + novel.path)];
                        case 1:
                          $novel = _a2.sent();
                          novel.cover = $novel('img[fetchpriority = "high"]').first().attr("src") || $novel("img.aligncenter").first().attr("src") || defaultCover_1.defaultCover;
                          return [
                            2
                            /*return*/
                          ];
      ...
      XiaowazPlugin2.prototype.popularNovels = function(pageNo) {
        return __awaiter(this, void 0, void 0, function() {
          ...
          return __generator(this, function(_b) {
            switch (_b.label) {
              case 0:
                PAGE_SIZE = 5;
                if (!!XiaowazPlugin2.novels) return [3, 2];
                _a = XiaowazPlugin2;
      ...
      XiaowazPlugin2.prototype.parseNovel = function(novelPath) {
        return __awaiter(this, void 0, void 0, function() {
          var novel, $2, entryContentText, listeParagraphe, PARAGRAPH_EXCLUDE_LIST, pathChapter, chapters;
          var _this = this;
          return __generator(this, function(_a) {
            switch (_a.label) {
              case 0:
              ...
              case 1:
                $2 = _a.sent();
                novel.name = $2(".card_title").text().trim();
                novel.cover = $2('img[fetchpriority = "high"]').first().attr("src") || $2("img.aligncenter").first().attr("src") || defaultCover_1.defaultCover;
                ...
                entryContentText = $2(".entry-content").text();
                ...
                $2(".entry-content > p").each(function(index2, element) {
                  var balise = $2(element);
                  if (balise.find('a[href*="xiaowaz.fr/articles"]').length !== 0)
                    return false;
                  var textbalise = balise.text();
                  if (PARAGRAPH_EXCLUDE_LIST.some(function(keyword) {
                    return textbalise.includes(keyword);
                  }))
                    return false;
                  if (!textbalise.includes("Genre") && !textbalise.includes("Synopsis") && //Managing the novel 'Rebirth of The Thief Who Roamed The World' to remove these three fields.
                  !textbalise.includes("\u91CD\u751F\u4E4B\u8CCA\u884C\u5929\u4E0B") && !textbalise.includes("Rebirth of The Thief Who Roamed The World") && !textbalise.includes("Romance, Com\xE9die, Action, VRMMO, R\xE9incarnation, Futuriste"))
                    listeParagraphe.push(textbalise);
                });
                novel.summary = listeParagraphe.join("\n").trim();
                pathChapter = $2(".entry-content ul li a");
                if (pathChapter.length === 0) {
                  pathChapter = $2(".entry-content p a");
                }
                chapters = [];
      ...
      XiaowazPlugin2.prototype.getAuthor = function(text3) {
        var regexAuthors = [
          /Écrit par([^\n]*). Traduction/i,
          /Écrit par([^\n]*)./i,
      ...
      XiaowazPlugin2.prototype.getGenres = function(text3) {
        var regex = /Genre((?:.*?\n)*?)\s*Synopsis\s*/;
        var match = regex.exec(text3);
        var genre = "";
        if (match !== null) {
          genre = match[1].replace("\xA0", " ").replace("s :", "").replace(":", "").trim();
      ...
      XiaowazPlugin2.prototype.parseChapter = function(chapterPath) {
        return __awaiter(this, void 0, void 0, function() {
          var $2, startTag, endTag, elementsBetweenTags, footnotesElement, currentElement, htmlCurrentElement;
          return __generator(this, function(_a) {
            switch (_a.label) {
              case 0:
              ...
              case 1:
                $2 = _a.sent();
                startTag = $2(".wp-post-navigation");
                endTag = $2(".abh_box.abh_box_down.abh_box_business");
                elementsBetweenTags = [];
                ...
                if (startTag.length > 0 && endTag.length > 0) {
                  ...
                  while (currentElement.length > 0 && !currentElement.is(endTag)) {
                    if (currentElement.find('p > a[href="https://ko-fi.com/wazouille"]').length > 0) {
                      break;
                    }
                    if (currentElement.hasClass("footnote_container_prepare")) {
                      footnotesElement = $2.html(currentElement);
                    } else {
                      htmlCurrentElement = $2.html(currentElement);
                      htmlCurrentElement = htmlCurrentElement === "<p>&nbsp;</p>" ? "<p/>" : htmlCurrentElement;
                ...
                return [2, elementsBetweenTags.join("\n").trim()];
            }
          });
        });
      };
      XiaowazPlugin2.prototype.searchNovels = function(searchTerm, pageNo) {
        return __awaiter(this, void 0, void 0, function() {
          ...
          return __generator(this, function(_b) {
            switch (_b.label) {
              ...
              case 1:
                ...
                _b.label = 2;
              case 2:
                popularNovels = XiaowazPlugin2.novels;
