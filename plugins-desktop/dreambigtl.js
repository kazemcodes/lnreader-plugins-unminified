...
var LNReaderPlugin = (() => {
  ...
  var DreamBigTL = (
    ...
    function() {
      ...
      __name(DreamBigTL2, "DreamBigTL");
      DreamBigTL2.prototype.popularNovels = function(pageNo_1, _a) {
            ...
            switch (_c.label) {
              ...
              case 2:
                ...
                loadedCheerio("#webify-pro-main-nav-menu > li.has-sub").each(function(_, categoryElem) {
                  var categoryName = loadedCheerio(categoryElem).children("a").first().text().trim();
                  if (categories.includes(categoryName)) {
                    var subMenu = loadedCheerio(categoryElem).find("ul.sub-menu.m-sub");
                    subMenu.find("li > a").each(function(_2, novelElem) {
                ...
                novels.forEach(function(novel) {
                  return console.log("Novel:", novel.name, novel.path);
                });
                if (novels.length === 0) {
      ...
      DreamBigTL2.prototype.parseNovel = function(novelPath) {
            ...
            switch (_d.label) {
              ...
              case 2:
                ...
                _a = {
                  ...
                  author: ((_c = (_b = loadedCheerio(".post-body").text().match(/Author:\s*(.+)/i)) === null || _b === void 0 ? void 0 : _b[1]) === null || _c === void 0 ? void 0 : _c.trim()) || "Unknown",
                  status: this.getNovelStatus(novelPath)
                };
                return [4, this.parseChapters(loadedCheerio)];
              case 3:
                novel = (_a.chapters = _d.sent(), _a);
                return [2, novel];
            }
          });
        });
      };
      DreamBigTL2.prototype.parseChapters = function(loadedCheerio) {
        return __awaiter(this, void 0, void 0, function() {
          var chapters;
          var _this = this;
          return __generator(this, function(_a) {
            ...
            loadedCheerio(".chapter-panel").each(function(_, panel) {
              ...
              if (panelTitle === "Free Tier") {
                loadedCheerio(panel).find("ul li a").each(function(_2, chapterEle) {
            ...
            if (chapters.length === 0) {
              loadedCheerio('h2:contains("List of Chapters"), span:contains("List of Chapters")').each(function(_, header) {
                ...
                chapterList.find("li a").each(function(_2, chapterEle) {
                  var chapterName = loadedCheerio(chapterEle).text().trim();
                  var chapterUrl = loadedCheerio(chapterEle).attr("href");
                  if (chapterUrl) {
                    chapters.push({
            ...
            return [2, chapters.reverse()];
          });
        });
      };
      DreamBigTL2.prototype.getNovelStatus = function(novelPath) {
        if (novelPath.includes("completed"))
          return "Completed";
        return "Ongoing";
      };
      DreamBigTL2.prototype.parseChapter = function(chapterPath) {
        return __awaiter(this, void 0, void 0, function() {
      ...
      DreamBigTL2.prototype.searchNovels = function(searchTerm) {
        return __awaiter(this, void 0, void 0, function() {
