...
var LNReaderPlugin = (() => {
  ...
  var Agitoon = (
    ...
    function() {
      ...
      __name(Agitoon2, "Agitoon");
      Agitoon2.prototype.checkUrl = function() {
        return __awaiter(this, void 0, void 0, function() {
          var res;
          return __generator(this, function(_a) {
            switch (_a.label) {
              case 0:
                if (!!Agitoon2.url) return [3, 2];
                return [4, (0, fetch_1.fetchApi)(this.site)];
              case 1:
                res = _a.sent();
                if (!res.ok)
                  Agitoon2.url = this.site;
                else
                  Agitoon2.url = res.url.replace(/\/$/, "");
                _a.label = 2;
              case 2:
                return [
                  2
      ...
      Agitoon2.prototype.popularNovels = function(pageNo_1, _a) {
        return __awaiter(this, arguments, void 0, function(pageNo, _b) {
          ...
          return __generator(this, function(_d) {
            switch (_d.label) {
              ...
              case 1:
                _d.sent();
                return [4, (0, fetch_1.fetchApi)(Agitoon2.url + "/novel/index.update.php", {
                  headers: {
                  ...
                  body: new URLSearchParams({
                    ...
                    np_day: (/* @__PURE__ */ new Date()).getDay(),
                    np_rank: "1",
                    np_distributor: "0",
                    np_genre: "00",
                    np_order: "1",
              ...
              case 3:
                ...
                (_c = resJson === null || resJson === void 0 ? void 0 : resJson.list) === null || _c === void 0 ? void 0 : _c.forEach(function(novel) {
                  return novels.push({
                    ...
                    cover: Agitoon2.url + novel.np_dir + "/thumbnail/" + novel.np_thumbnail,
                    path: novel.wr_id
                  });
                });
                return [2, novels];
      ...
      Agitoon2.prototype.parseNovel = function(novelPath) {
        return __awaiter(this, void 0, void 0, function() {
          ...
          return __generator(this, function(_b) {
            switch (_b.label) {
              ...
              case 1:
                _b.sent();
                return [4, (0, fetch_1.fetchApi)(this.resolveUrl(novelPath, true)).then(function(res2) {
                  return res2.text();
                })];
              case 2:
                result = _b.sent();
                ...
                novel.author = loadedCheerio(".post-item-list-cate-v").first().text().split(" : ")[1];
                genres = loadedCheerio(".col-7 > .post-item-list-cate > span").map(function(index2, element) {
                ...
                chapters = [];
                return [4, (0, fetch_1.fetchApi)(Agitoon2.url + "/novel/list.update.php", {
                  headers: {
                    "content-type": "application/x-www-form-urlencoded; charset=UTF-8"
                  },
                  method: "POST",
      ...
      Agitoon2.prototype.parseChapter = function(chapterPath) {
        return __awaiter(this, void 0, void 0, function() {
      ...
      Agitoon2.prototype.searchNovels = function(searchTerm, pageNo) {
        return __awaiter(this, void 0, void 0, function() {
          ...
          return __generator(this, function(_b) {
            switch (_b.label) {
              ...
              case 1:
                _b.sent();
                return [4, (0, fetch_1.fetchApi)(Agitoon2.url + "/novel/search.php", {
                  headers: {
                    "content-type": "application/x-www-form-urlencoded; charset=UTF-8"
                  },
                  method: "POST",
      ...
      Agitoon2.prototype.resolveUrl = function(path, isNovel) {
        if (!Agitoon2.url)
          (0, fetch_1.fetchApi)(this.site).then(function(res) {
            return Agitoon2.url = res.url.replace(/\/$/, "");
          });
        return (Agitoon2.url ? Agitoon2.url : this.site) + (isNovel ? "/novel/list/" : "/novel/view/") + path;
      };
      return Agitoon2;
    }()
  );
