...
var LNReaderPlugin = (() => {
  ...
  var NovelMania = (
    ...
    function() {
        ...
        this.filters = {
          ...
          ordem: {
            ...
            options: [
              ...
              { label: "Ordem alfab\xE9tica", value: "1" },
              { label: "N\xBA de Cap\xEDtulos", value: "2" },
      ...
      __name(NovelMania2, "NovelMania");
      NovelMania2.prototype.popularNovels = function(pageNo_1, _a) {
        return __awaiter(this, arguments, void 0, function(pageNo, _b) {
          var url, body, loadedCheerio, load2, novels;
          ...
          return __generator(this, function(_c) {
            switch (_c.label) {
              case 0:
                ...
                url += "&page%5Bpage%5D=".concat(pageNo);
              ...
              case 1:
                ...
                load2 = loadedCheerio("div.top-novels.dark.col-6 > div.row.mb-2");
                novels = load2.map(function(index2, element) {
                  return {
                    name: loadedCheerio(element).find("a.novel-title > h5").text(),
                    cover: loadedCheerio(element).find("a > div.card.c-size-1.border > img.card-image").attr("src"),
      ...
      NovelMania2.prototype.parseNovel = function(novelPath) {
          ...
          return __generator(this, function(_a) {
            switch (_a.label) {
              ...
              case 1:
                ...
                novel = {
                  path: novelPath,
                  name: loadedCheerio("div.col-md-8 > div.novel-info > div.d-flex.flex-row.align-items-center > h1").text().trim() || "Sem t\xEDtulo"
                };
                loadedCheerio("b").remove();
                novel.name = loadedCheerio("div.col-md-8 > div.novel-info > div.d-flex.flex-row.align-items-center > h1").text().trim() || "Sem t\xEDtulo";
                novel.summary = loadedCheerio("div.tab-pane.fade.show.active > div.text > p").map(function(i, el) {
                  return loadedCheerio(el).text();
                }).toArray().join("\n\n").trim() || "";
                novel.cover = loadedCheerio("div.novel-img > img.img-responsive").attr("src") || defaultCover_1.defaultCover;
                novel.author = loadedCheerio("div.novel-info > span.authors.mb-1").text().trim();
                novel.genres = loadedCheerio("div.tags > ul.list-tags.mb-0 > li > a").map(function(i, el) {
                  return loadedCheerio(el).text();
                }).toArray().join(",");
                status = loadedCheerio("div.novel-info > span.authors.mb-3").text().trim();
                switch (status) {
                  case "Ativo":
      ...
      NovelMania2.prototype.parseChapter = function(chapterPath) {
        return __awaiter(this, void 0, void 0, function() {
          var response, loadedCheerio;
          return __generator(this, function(_a) {
            switch (_a.label) {
              case 0:
                return [4, (0, fetch_1.fetchApi)("".concat(this.site).concat(chapterPath)).then(function(res) {
                  return res.text();
                })];
              case 1:
                response = _a.sent();
      ...
      NovelMania2.prototype.searchNovels = function(searchTerm, pageNo) {
        return __awaiter(this, void 0, void 0, function() {
          var url, body, loadedCheerio, load2, novels;
          return __generator(this, function(_a) {
            switch (_a.label) {
              case 0:
                url = "".concat(this.site, "/novels?titulo=").concat(searchTerm, "&page%5Bpage%5D=").concat(pageNo);
                return [4, (0, fetch_1.fetchApi)(url).then(function(res) {
                  return res.text();
                })];
              case 1:
