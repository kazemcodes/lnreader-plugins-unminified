    ...
    function() {
      function Syosetu2() {
        ...
        this.searchUrl = function(pagenum, order) {
          return "".concat(_this.site, "search.php?order=").concat(order || "hyoka").concat(
            pagenum !== void 0 ? "&p=".concat(pagenum <= 1 || pagenum > 100 ? "1" : pagenum) : ""
      ...
      __name(Syosetu2, "Syosetu");
      Syosetu2.prototype.popularNovels = function(pageNo_1, _a) {
        return __awaiter(this, arguments, void 0, function(pageNo, _b) {
          ...
          return __generator(this, function(_c) {
            switch (_c.label) {
              case 0:
                getNovelsFromPage = /* @__PURE__ */ __name(function(pagenumber) {
                  return __awaiter(_this, void 0, void 0, function() {
                    var url, html3, loadedCheerio, novels2;
                    var _this2 = this;
                      ...
                      switch (_a2.label) {
                        ...
                        case 2:
                          ...
                          loadedCheerio(".c-card").each(function(_, e) {
                            ...
                            var url2 = anchor.attr("href");
                            if (!url2)
                              return;
                            var name = anchor.text();
                            var novel = {
                              path: url2.replace(_this2.novelPrefix, ""),
                              name,
                ...
                return [4, getNovelsFromPage(pageNo)];
              case 1:
                novels = _c.sent();
                return [2, novels];
            }
      ...
      Syosetu2.prototype.parseChaptersFromPage = function(loadedCheerio) {
        return __awaiter(this, void 0, void 0, function() {
          ...
          return __generator(this, function(_a) {
            ...
            loadedCheerio(".p-eplist__sublist").each(function(_, element) {
              ...
              var releaseDate = loadedCheerio(element).find(".p-eplist__update").text().trim().split(" ")[0].replace(/\//g, "-");
              if (chapterUrl) {
                chapters.push({
                  name: chapterName,
      ...
      Syosetu2.prototype.parseNovel = function(novelPath) {
        return __awaiter(this, void 0, void 0, function() {
          ...
          return __generator(this, function(_b) {
            switch (_b.label) {
              case 0:
                return [4, (0, fetch_1.fetchApi)(this.novelPrefix + novelPath, {
              ...
              case 2:
                ...
                novel = {
                  ...
                  author: loadedCheerio(".p-novel__author").text().replace("\u4F5C\u8005\uFF1A", "").trim(),
                  status,
                  artist: "",
                  cover: defaultCover_1.defaultCover,
                  chapters: [],
                  genres: (_a = loadedCheerio('meta[property="og:description"]').attr("content")) === null || _a === void 0 ? void 0 : _a.split(" ").join(",")
                  // Get genres from meta tag
                };
                novel.summary = loadedCheerio("#novel_ex").html() || "";
                chapters = [];
                lastPageLink = loadedCheerio(".c-pager__item--last").attr("href");
                if (!!lastPageLink) return [3, 3];
                loadedCheerio(".p-eplist__sublist").each(function(_, element) {
                  var chapterLink = loadedCheerio(element).find("a");
                  var chapterUrl = chapterLink.attr("href");
                  var chapterName = chapterLink.text().trim();
              ...
              case 3:
                ...
                return [4, Promise.all(pagePromises)];
              case 4:
                pageResults = _b.sent();
                pageResults.forEach(function(pageBody) {
                  ...
                  pageCheerio(".p-eplist__sublist").each(function(_, element) {
                    ...
                    var chapterUrl = chapterLink.attr("href");
                    var chapterName = chapterLink.text().trim();
                    var releaseDate = pageCheerio(element).find(".p-eplist__update").text().trim().split(" ")[0].replace(/\//g, "-");
                    if (chapterUrl) {
                      chapters.push({
                        name: chapterName,
                        releaseTime: releaseDate,
      ...
      Syosetu2.prototype.parseChapter = function(chapterPath) {
        return __awaiter(this, void 0, void 0, function() {
          var result, body, cheerioQuery, chapterTitle, chapterContent;
          return __generator(this, function(_a) {
            switch (_a.label) {
              case 0:
                return [4, (0, fetch_1.fetchApi)(this.novelPrefix + chapterPath, {
                  headers: this.headers
                })];
              case 1:
                result = _a.sent();
              ...
              case 2:
                ...
                return [2, "<h1>".concat(chapterTitle, "</h1>").concat(chapterContent)];
            }
          });
        });
      };
      Syosetu2.prototype.searchNovels = function(searchTerm, pageNo) {
        return __awaiter(this, void 0, void 0, function() {
                    ...
                    return __generator(this, function(_a2) {
                      switch (_a2.label) {
                        case 0:
                          ...
                          return [4, (0, fetch_1.fetchApi)(url, { headers: this.headers })];
                        case 1:
                          result = _a2.sent();
                          return [4, result.text()];
                        case 2:
                          ...
                          cheerioQuery(".searchkekka_box").each(function(i, e) {
                            ...
                            var novelPath = novelA.attribs.href.replace(_this2.novelPrefix, "");
                            if (novelPath) {
                              pageNovels.push({
                                name: novelDIV.text(),
                                // get the name
      ...
      Syosetu2.prototype.resolveUrl = function(path) {
