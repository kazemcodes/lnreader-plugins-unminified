...
var LNReaderPlugin = (() => {
  ...
  var Sunovels = (
    ...
    function() {
      ...
      __name(Sunovels2, "Sunovels");
      Sunovels2.prototype.parseNovels = function(loadedCheerio) {
        var _this = this;
        var novels = [];
        var imageUrlList = [];
        ...
        loadedCheerio(".list-item").each(function(idx, ele) {
          loadedCheerio(ele).find("a").each(function(idx2, ele2) {
            var _a;
            var novelName = loadedCheerio(ele2).find("h4").text().trim();
            var novelUrl = ((_a = loadedCheerio(ele2).attr("href")) === null || _a === void 0 ? void 0 : _a.trim().replace(/^\/*/, "")) || "";
            var novelCover = defaultCover_1.defaultCover;
            if (imageUrlList.length > 0) {
              novelCover = _this.site + imageUrlList[counter].slice(1);
            } else {
              var imageUrl = loadedCheerio(ele2).find("img").attr("src");
      ...
      Sunovels2.prototype.popularNovels = function(page_1, _a) {
          ...
          return __generator(this, function(_c) {
            switch (_c.label) {
              case 0:
                ...
                if (filters) {
                  if (Array.isArray(filters.categories.value) && filters.categories.value.length > 0) {
      ...
      Sunovels2.prototype.parseNovel = function(novelUrl) {
          ...
          return __generator(this, function(_a) {
            switch (_a.label) {
              ...
              case 2:
                ...
                statusWords = /* @__PURE__ */ new Set(["\u0645\u0643\u062A\u0645\u0644", "\u062C\u062F\u064A\u062F", "\u0645\u0633\u062A\u0645\u0631"]);
                mainGenres = Array.from(loadedCheerio("div.categories li.tag")).map(function(el) {
                  return loadedCheerio(el).text().trim();
                }).join(",");
                statusGenre = Array.from(loadedCheerio("div.header-stats span").eq(3).find("strong")).map(function(el) {
                  return loadedCheerio(el).text().trim();
                }).filter(function(text3) {
                  return statusWords.has(text3);
                });
                novel.genres = "".concat(statusGenre, ",").concat(mainGenres);
                statusText = Array.from(loadedCheerio("div.header-stats span").eq(3).find("strong")).map(function(el) {
                  return loadedCheerio(el).text().trim();
                }).filter(function(text3) {
                  return statusWords.has(text3);
                }).join();
                ...
                chapterNumberStr = loadedCheerio("div.header-stats span").first().text().replace(/[^\d]/g, "");
      ...
      Sunovels2.prototype.parseChapters = function(data2) {
        var chapter = [];
        data2.chapters.map(function(item) {
          chapter.push({
      ...
      Sunovels2.prototype.parsePage = function(novelPath, page) {
        return __awaiter(this, void 0, void 0, function() {
            ...
            switch (_a.label) {
              ...
              case 1:
                ...
                loadedCheerio("ul.chaptersList a").each(function(i, el) {
                  var _a2, _b;
                  var chapterName = (_a2 = loadedCheerio(el).attr("title")) !== null && _a2 !== void 0 ? _a2 : "";
                  var chapterUrl = (_b = loadedCheerio(el).attr("href")) === null || _b === void 0 ? void 0 : _b.trim().replace(/^\/*/, "");
                  var dateAttr = loadedCheerio(el).find("time.chapter-update").attr("datetime");
                  var date = new Date(dateAttr);
                  var releaseTime = date.toISOString();
                  var chapternumber = loadedCheerio(el).find("strong.chapter-title").text().replace(/[^\d٠-٩]/g, "");
      ...
      Sunovels2.prototype.parseChapter = function(chapterUrl) {
        return __awaiter(this, void 0, void 0, function() {
            ...
            switch (_a.label) {
              ...
              case 2:
                ...
                loadedCheerio("div.chapter-content").each(function(idx, ele) {
                  loadedCheerio(ele).find("p").not(".d-none").each(function(idx2, textEle) {
                    chapterText += loadedCheerio(textEle).map(function(_, pEle) {
                      return loadedCheerio(pEle).text().trim();
                    }).get().join(" ") + " ";
                  });
                });
      ...
      Sunovels2.prototype.searchNovels = function(searchTerm, page) {
        return __awaiter(this, void 0, void 0, function() {
