...
var LNReaderPlugin = (() => {
  ...
  var NovelBuddy = (
    ...
    function() {
      ...
      __name(NovelBuddy2, "NovelBuddy");
      NovelBuddy2.prototype.parseNovels = function(loadedCheerio) {
        var novels = [];
        loadedCheerio(".book-item").each(function(idx, ele) {
          ...
          var novelUrl = (_a = loadedCheerio(ele).find(".title a").attr("href")) === null || _a === void 0 ? void 0 : _a.substring(1);
          if (!novelUrl)
            return;
      ...
      NovelBuddy2.prototype.popularNovels = function(pageNo_1, _a) {
      ...
      NovelBuddy2.prototype.parseNovel = function(novelPath) {
            ...
            switch (_b.label) {
              ...
              case 2:
                ...
                loadedCheerio(".meta.box p").each(function(i, el) {
                  ...
                  switch (detailName) {
                    case "Authors :":
                      novel.author = detail.find("span").map(function(a, ex) {
                ...
                novelId = loadedCheerio("script").text().match(/bookId = (\d+);/)[1];
                chapter = [];
                getChapters = /* @__PURE__ */ __name(function(id) {
                  return __awaiter(_this, void 0, void 0, function() {
                    var chapterListUrl, data2, chapterlist;
                    return __generator(this, function(_a2) {
                      switch (_a2.label) {
                        ...
                        case 1:
                          ...
                          return [4, data2.text()];
                        case 2:
                          chapterlist = _a2.sent();
                          loadedCheerio = (0, cheerio_1.load)(chapterlist);
                          loadedCheerio("li").each(function(i, el) {
                            var _a3;
                            var chapterName = loadedCheerio(el).find(".chapter-title").text().trim();
                            var releaseDate = loadedCheerio(el).find(".chapter-update").text().trim();
                            var months = [
                              "jan",
                              "feb",
                              "mar",
                            ...
                            var day = +rx[2];
                            var chapterUrl = (_a3 = loadedCheerio(el).find("a").attr("href")) === null || _a3 === void 0 ? void 0 : _a3.slice(1);
                            if (!chapterUrl)
                              return;
                            chapter.push({
                              name: chapterName,
      ...
      NovelBuddy2.prototype.parseChapter = function(chapterPath) {
        return __awaiter(this, void 0, void 0, function() {
      ...
      NovelBuddy2.prototype.searchNovels = function(searchTerm, page) {
        return __awaiter(this, void 0, void 0, function() {
