...
var LNReaderPlugin = (() => {
  ...
  var WTRLAB = (
    ...
    function() {
      ...
      __name(WTRLAB2, "WTRLAB");
      WTRLAB2.prototype.popularNovels = function(page_1, _a) {
          ...
          return __generator(this, function(_c) {
            switch (_c.label) {
              case 0:
                ...
                if (!showLatestNovels) return [3, 3];
                return [4, (0, fetch_1.fetchApi)(this.site + "api/home/recent", {
                  method: "POST",
                  headers: {
              ...
              case 2:
                recentNovel = _c.sent();
                novels = recentNovel.data.map(function(datum) {
                  return {
                    name: datum.serie.data.title || "",
                    cover: datum.serie.data.image,
                    path: _this.sourceLang + "serie-" + datum.serie.raw_id + "/" + datum.serie.slug || ""
                  };
                });
                return [2, novels];
              case 3:
              ...
              case 4:
                ...
                novels = loadedCheerio_1(".serie-item").map(function(index2, element) {
                  return {
                    name: loadedCheerio_1(element).find(".title-wrap > a").text().replace(loadedCheerio_1(element).find(".rawtitle").text(), "") || "",
      ...
      WTRLAB2.prototype.parseNovel = function(novelPath) {
          ...
          return __generator(this, function(_a) {
            switch (_a.label) {
              ...
              case 1:
                ...
                novel.genres = loadedCheerio('td:contains("Genre")').next().find("a").map(function(i, el) {
                  return loadedCheerio(el).text();
                }).toArray().join(",");
                novel.author = loadedCheerio('td:contains("Author")').next().text().replace(/[\t\n]/g, "");
                novel.status = loadedCheerio('td:contains("Status")').next().text().replace(/[\t\n]/g, "");
                ...
                chapters = jsonData.props.pageProps.serie.chapters.map(function(jsonChapter, chapterIndex) {
                  ...
                  return {
                    ...
                    path: _this.sourceLang + "serie-" + jsonData.props.pageProps.serie.serie_data.raw_id + "/" + jsonData.props.pageProps.serie.serie_data.slug + "/chapter-" + jsonChapter.order,
                    // Assuming 'slug' is the intended path
                    releaseTime: (_a2 = (jsonChapter === null || jsonChapter === void 0 ? void 0 : jsonChapter.created_at) || (jsonChapter === null || jsonChapter === void 0 ? void 0 : jsonChapter.updated_at)) === null || _a2 === void 0 ? void 0 : _a2.substring(0, 10),
      ...
      WTRLAB2.prototype.parseChapter = function(chapterPath) {
        return __awaiter(this, void 0, void 0, function() {
          var body, loadedCheerio, chapterJson, jsonData, chapterContent, parsedArray, htmlString, _i, parsedArray_1, text3;
          return __generator(this, function(_a) {
            switch (_a.label) {
              case 0:
              ...
              case 1:
                ...
                for (_i = 0, parsedArray_1 = parsedArray; _i < parsedArray_1.length; _i++) {
                  text3 = parsedArray_1[_i];
                  htmlString += "<p>".concat(text3, "</p>");
                }
                return [2, htmlString];
            }
          });
      ...
      WTRLAB2.prototype.searchNovels = function(searchTerm) {
        return __awaiter(this, void 0, void 0, function() {
          ...
          return __generator(this, function(_a) {
            switch (_a.label) {
              case 0:
                return [4, (0, fetch_1.fetchApi)(this.site + "api/search", {
                  headers: {
                    "Content-Type": "application/json",
