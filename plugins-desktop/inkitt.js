...
var LNReaderPlugin = (() => {
  ...
  var InkittPlugin = (
    ...
    function() {
      ...
      __name(InkittPlugin2, "InkittPlugin");
      InkittPlugin2.prototype.popularNovels = function(pageNo_1, _a) {
        return __awaiter(this, arguments, void 0, function(pageNo, _b) {
          ...
          return __generator(this, function(_d) {
            switch (_d.label) {
              case 0:
                if (!((_c = filters === null || filters === void 0 ? void 0 : filters.genres) === null || _c === void 0 ? void 0 : _c.value)) return [3, 2];
                return [4, (0, fetch_1.fetchApi)(this.site + "/genre/".concat(filters.genres.value, "/").concat(pageNo, "?period=alltime&sort=popular"))];
              case 1:
                req = _d.sent();
                return [3, 4];
              case 2:
                return [4, (0, fetch_1.fetchApi)(this.site + "/trending_stories?page=".concat(pageNo, "&period=alltime"))];
              case 3:
                req = _d.sent();
                _d.label = 4;
              case 4:
              ...
              case 7:
                return [2, data2.stories.map(function(novel) {
                  return {
                    name: novel.title,
                    path: _this.getPath(novel),
                    cover: novel.vertical_cover.url || novel.vertical_cover.iphone || novel.cover.url
                  };
                })];
            }
          });
      ...
      InkittPlugin2.prototype.getPath = function(novel) {
        return (novel.category_one || novel.genres[0]) + "/" + novel.id;
      };
      InkittPlugin2.prototype.parseNovel = function(novelPath) {
        return __awaiter(this, void 0, void 0, function() {
          var req, text3, loadedCheerio, novel, status, apiReq, apiData;
          return __generator(this, function(_a) {
            switch (_a.label) {
              case 0:
                return [4, (0, fetch_1.fetchApi)(this.site + "/stories/".concat(novelPath))];
              case 1:
                req = _a.sent();
                return [4, req.text()];
              case 2:
                ...
                novel.genres = loadedCheerio("dd.genres > a").map(function(i, el) {
                  return loadedCheerio(el).text();
                }).toArray().join(", ");
                status = loadedCheerio('div.dlc > dl:has(dt:contains("Status")) > dd').text().trim();
                if (status === "Complete")
                  novel.status = novelStatus_1.NovelStatus.Completed;
                if (status === "Ongoing")
                  novel.status = novelStatus_1.NovelStatus.Ongoing;
                return [4, (0, fetch_1.fetchApi)(this.site + "/api/stories/".concat(novelPath.split("/")[1]))];
              case 3:
                apiReq = _a.sent();
                return [4, apiReq.json()];
              case 4:
                apiData = _a.sent();
      ...
      InkittPlugin2.prototype.parseChapter = function(chapterPath) {
        return __awaiter(this, void 0, void 0, function() {
          var req, text3, loadedCheerio;
          return __generator(this, function(_a) {
            switch (_a.label) {
              case 0:
                return [4, (0, fetch_1.fetchApi)(this.site + "/stories/" + chapterPath)];
              case 1:
                req = _a.sent();
                return [4, req.text()];
              case 2:
                text3 = _a.sent();
                loadedCheerio = (0, cheerio_1.load)(text3);
                return [2, loadedCheerio("div#chapterText").html() || ""];
            }
          });
        });
      };
      InkittPlugin2.prototype.searchNovels = function(searchTerm, pageNo) {
        return __awaiter(this, void 0, void 0, function() {
          var req, data2, e_2;
          var _this = this;
          return __generator(this, function(_a) {
            switch (_a.label) {
              case 0:
                return [4, (0, fetch_1.fetchApi)(this.site + "/api/2/search/title?q=".concat(encodeURIComponent(searchTerm), "&page=").concat(pageNo))];
              case 1:
                req = _a.sent();
                _a.label = 2;
              case 2:
