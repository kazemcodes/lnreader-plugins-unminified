...
var LNReaderPlugin = (() => {
  ...
  var NovhellPlugin = (
    ...
    function() {
      ...
      __name(NovhellPlugin2, "NovhellPlugin");
      NovhellPlugin2.prototype.getCheerio = function(url) {
      ...
      NovhellPlugin2.prototype.popularNovels = function(pageNo) {
        return __awaiter(this, void 0, void 0, function() {
          ...
          return __generator(this, function(_a) {
            switch (_a.label) {
              ...
              case 1:
                $2 = _a.sent();
                $2("article div div div figure").each(function(i, elem) {
                  var novelName = $2(elem).find("figcaption span strong").first().text().trim();
                  if (!novelName || novelName.trim() === "") {
                    novelName = $2(elem).find("figcaption a strong").first().text().trim();
                  }
                  var novelCover = $2(elem).find("a img").attr("src");
      ...
      NovhellPlugin2.prototype.parseNovel = function(novelPath) {
        return __awaiter(this, void 0, void 0, function() {
          ...
          return __generator(this, function(_b) {
            switch (_b.label) {
              ...
              case 1:
                $2 = _b.sent();
                novel.name = ((_a = $2('meta[property="og:title"]').attr("content")) === null || _a === void 0 ? void 0 : _a.replace("- NovHell", "")) || "";
                novel.cover = $2("section div div div div div img").first().attr("src") || defaultCover_1.defaultCover;
                novel.status = novelStatus_1.NovelStatus.Ongoing;
                novel.author = $2("strong:contains('Ecrit par ')").parent().text().replace("Ecrit par ", "").trim();
                if (!novel.author) {
                  novel.author = $2("div p:contains('Auteur')").text().replace("Auteur", "").replace(":", "").trim();
                }
                if (!novel.author) {
                  novel.author = $2("div p:contains('Ecrit par :')").text().replace("Ecrit par :", "").trim();
                }
                novel.genres = $2("strong:contains('Genre')").parent().text().replace("Genre", "").replace(":", "").trim();
                if (!novel.genres) {
                  novel.genres = $2("div p:contains('Genre')").text().replace("Genre", "").replace(":", "").trim();
                }
                novel.summary = $2("strong:contains('Synopsis')").parent().parent().text().replace("Synopsis", "").replace("Synopsis", "").replace(":", "").trim();
                chapters = [];
                $2("main div article div div section div div div div div p a").each(function(i, elem) {
                  var chapterName = $2(elem).text().replace(/\u00A0/g, " ").trim();
                ...
                novel.chapters = chapters.sort(function(chapterA, chapterB) {
                  if (chapterA.chapterNumber !== void 0 && chapterB.chapterNumber !== void 0) {
                    return chapterA.chapterNumber - chapterB.chapterNumber;
                  }
                  if (chapterA.chapterNumber === void 0) {
                    return 1;
                  } else {
                    return -1;
                  }
      ...
      NovhellPlugin2.prototype.parseChapter = function(chapterPath) {
        return __awaiter(this, void 0, void 0, function() {
          var $2, sections, numberOfSection, title2, positionChapter, i, chapter;
          return __generator(this, function(_a) {
            switch (_a.label) {
              case 0:
              ...
              case 1:
                $2 = _a.sent();
                sections = $2("main article div div section");
                if (sections) {
                  numberOfSection = sections.length;
                  title2 = void 0;
                  positionChapter = 2;
                  for (i = 3; i <= 5; i++) {
                    title2 = sections.eq(numberOfSection - i);
                    if (title2.find("h4").length !== 0) {
                      positionChapter = i - 1;
                      break;
                    }
                  }
                  ...
                  if (title2 && chapter) {
                    return [2, (title2.html() || "") + (chapter.html() || "")];
                  }
                }
                return [2, ""];
            }
      ...
      NovhellPlugin2.prototype.searchNovels = function(searchTerm, pageNo) {
        return __awaiter(this, void 0, void 0, function() {
