  ...
  var DDLPlugin = (
    ...
    function() {
      function DDLPlugin2() {
        ...
        this.novelItemCache = /* @__PURE__ */ new Map();
      }
      __name(DDLPlugin2, "DDLPlugin");
      DDLPlugin2.prototype.getPath = function(url) {
      ...
      DDLPlugin2.prototype.asyncMap = function(collection, callbackfn) {
        return __awaiter(this, void 0, void 0, function() {
          return __generator(this, function(_a) {
            switch (_a.label) {
              case 0:
                return [4, Promise.allSettled(collection.map(callbackfn))];
              case 1:
                return [2, _a.sent().filter(function(p) {
                  return p.status === "fulfilled" && p.value !== void 0;
                }).map(function(_a2) {
                  var value = _a2.value;
                  return value;
                })];
      ...
      DDLPlugin2.prototype.findLatestChapter = function(novelPath) {
        return __awaiter(this, void 0, void 0, function() {
          ...
          return __generator(this, function(_a) {
            switch (_a.label) {
              case 0:
                ...
                return [4, (0, fetch_1.fetchApi)(link).then(function(res) {
                  return res.json();
                })];
              case 1:
                ...
                return [4, (0, fetch_1.fetchApi)(chapterLink).then(function(res) {
                  return res.json();
                })];
              case 2:
                lastChapter = _a.sent();
                ...
                return [2, lastChapter[0].slug];
            }
          });
        });
      };
      DDLPlugin2.prototype.grabNovel = function(path_1) {
        return __awaiter(this, arguments, void 0, function(path, getChapters) {
          var link, data2, content, excerpt, image, chapters, linkedChapters, lastChapterPath_1;
          var _this = this;
          var _a, _b;
          if (getChapters === void 0) {
            getChapters = false;
          }
          return __generator(this, function(_c) {
            switch (_c.label) {
              ...
              case 1:
                ...
                content = (0, cheerio_1.load)(data2[0].content.rendered);
                excerpt = (0, cheerio_1.load)(data2[0].excerpt.rendered);
                image = content("img").first();
                chapters = [];
                if (!getChapters) return [3, 3];
                linkedChapters = content("li > span > a").map(function(_, anchorEl) {
                ...
                return [4, this.findLatestChapter(path)];
              case 2:
                lastChapterPath_1 = _c.sent();
                if (lastChapterPath_1) {
                  chapters = linkedChapters.slice(0, 1 + linkedChapters.findIndex(function(chapter) {
                    return chapter.path === lastChapterPath_1;
                  }));
                } else {
              ...
              case 3:
                return [2, {
                  name: data2[0].title.rendered,
                  path,
                  cover: (_b = (_a = image.attr("data-lazy-src")) !== null && _a !== void 0 ? _a : image.attr("src")) !== null && _b !== void 0 ? _b : defaultCover_1.defaultCover,
                  author: content("h3").first().text().replace(/^Author:\s*/g, ""),
                  summary: excerpt("p").first().text().replace(/^.+Description\s*/g, ""),
                  chapters
                }];
            }
          });
      ...
      DDLPlugin2.prototype.grabCachedNovel = function(path) {
        return __awaiter(this, void 0, void 0, function() {
          ...
          return __generator(this, function(_a) {
            switch (_a.label) {
              case 0:
                ...
                return [4, this.grabNovel(path, false)];
              case 1:
                sourceNovel = _a.sent();
                if (sourceNovel === void 0) {
                  return [2, void 0];
                }
                novel = {
      ...
      DDLPlugin2.prototype.grabCachedNovels = function() {
        return __awaiter(this, void 0, void 0, function() {
            ...
            switch (_a.label) {
              case 0:
                if (this.allNovelsCache) {
                  return [2, this.allNovelsCache];
                }
                return [4, (0, fetch_1.fetchApi)(this.site + "novels").then(function(res) {
                  return res.text();
                })];
              case 1:
                body = _a.sent();
                loadedCheerio = (0, cheerio_1.load)(body);
                novels = loadedCheerio(".entry-content ul").map(function(_, listEl) {
                  var list = loadedCheerio(listEl);
                  var category = list.prev().text();
                  return list.find("a").map(function(_2, anchorEl) {
      ...
      DDLPlugin2.prototype.latestNovels = function() {
        return __awaiter(this, void 0, void 0, function() {
          ...
          return __generator(this, function(_a) {
            switch (_a.label) {
              case 0:
                return [4, (0, fetch_1.fetchApi)(this.site).then(function(res) {
                  return res.text();
                })];
              case 1:
                body = _a.sent();
                loadedCheerio = (0, cheerio_1.load)(body);
                novelPaths = loadedCheerio("#main").find('a[rel="category tag"]').map(function(_, anchorEl) {
                  var path = _this.getPath(anchorEl.attribs["href"]);
                  return path;
                }).toArray();
                uniqueNovelPaths = new Set(novelPaths);
                return [2, Array.from(uniqueNovelPaths)];
            }
          });
        });
      };
      DDLPlugin2.prototype.allNovels = function(categoryFilter) {
        return __awaiter(this, void 0, void 0, function() {
          var allNovels;
          return __generator(this, function(_a) {
            switch (_a.label) {
              ...
              case 1:
                ...
                if (!allNovels)
                  return [2, []];
                return [2, allNovels.filter(function(_a2) {
                  var category = _a2[0];
      ...
      DDLPlugin2.prototype.popularNovels = function(pageNo, options) {
        return __awaiter(this, void 0, void 0, function() {
          var novelsList, _a;
          return __generator(this, function(_b) {
            switch (_b.label) {
              case 0:
                ...
                novelsList = options.showLatestNovels ? this.latestNovels() : this.allNovels(options.filters.category);
                _a = this.asyncMap;
                return [4, novelsList];
              case 1:
                return [4, _a.apply(this, [_b.sent(), this.grabCachedNovel.bind(this)])];
              case 2:
                return [2, _b.sent()];
            }
          });
      ...
      DDLPlugin2.prototype.parseNovel = function(novelPath) {
        return __awaiter(this, void 0, void 0, function() {
          var sourceNovel;
          return __generator(this, function(_a) {
            switch (_a.label) {
              case 0:
                return [4, this.grabNovel(novelPath, true)];
              case 1:
                sourceNovel = _a.sent();
                if (sourceNovel === void 0) {
                  throw new Error('The path "'.concat(novelPath, '" could not be resolved.'));
                }
                return [2, sourceNovel];
            }
          });
        });
      };
      DDLPlugin2.prototype.parseChapter = function(chapterPath) {
        return __awaiter(this, void 0, void 0, function() {
          var chapterLink, chapter, title2, content;
          return __generator(this, function(_a) {
            switch (_a.label) {
              case 0:
              ...
              case 1:
                ...
                title2 = "<h1>".concat(chapter[0].title.rendered, "</h1>");
                content = chapter[0].content.rendered;
                return [2, "".concat(title2).concat(content)];
            }
          });
        });
      };
      DDLPlugin2.prototype.searchNovels = function(searchTerm, pageNo) {
        return __awaiter(this, void 0, void 0, function() {
          ...
          return __generator(this, function(_b) {
            switch (_b.label) {
              ...
              case 1:
                ...
                if (!allNovels)
                  return [2, []];
                foundNovels = allNovels.filter(function(_a2) {
                  var name = _a2[1];
