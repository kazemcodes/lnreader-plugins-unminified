...
var LNReaderPlugin = (() => {
  ...
  var TopLiba = (
    ...
    function() {
      ...
      __name(TopLiba2, "TopLiba");
      TopLiba2.prototype.fetchNovels = function(page_1, _a, searchTerm_1) {
        return __awaiter(this, arguments, void 0, function(page, _b, searchTerm) {
          var data2, body, novels, elements;
          var _this = this;
          var _c, _d;
          ...
          return __generator(this, function(_e) {
            switch (_e.label) {
              case 0:
                ...
                return [4, (0, fetch_1.fetchApi)(this.site + "/?" + data2.toString()).then(function(res) {
                  return res.text();
                })];
              case 1:
                body = _e.sent();
                ...
                elements.forEach(function(element) {
                  var _a2 = element.match(/data-original=".*covers\/(.*?)_.*title="(.*?)"/) || [], path = _a2[1], name = _a2[2];
                  if (path && name) {
                    novels.push({
                      name,
      ...
      TopLiba2.prototype.searchNovels = function(searchTerm, page) {
      ...
      TopLiba2.prototype.parseNovel = function(novelPath) {
        return __awaiter(this, void 0, void 0, function() {
            ...
            switch (_c.label) {
              ...
              case 1:
                ...
                novel = {
                  ...
                  genres: loadedCheerio(".book-genres > div > a").map(function(index2, element) {
                    return loadedCheerio(element).text();
                  }).get().join(",")
                };
                return [4, (0, fetch_1.fetchApi)(this.resolveUrl(novelPath)).then(function(res) {
                  return res.text();
                })];
              case 2:
                chaptersHTML = _c.sent();
                this._token = ((_a = chaptersHTML.match(/<meta name="_token" content="(.*?)"/)) === null || _a === void 0 ? void 0 : _a[1]) || ((_b = body.match(/<meta name="_token" content="(.*?)"/)) === null || _b === void 0 ? void 0 : _b[1]) || this._token;
                chapters = [];
                elements = chaptersHTML.match(/<li class="padding-\d+" data-capter="\d+">([\s\S]*?)</g) || [];
                elements.forEach(function(chapter, chapterIndex) {
                  var _a2 = chapter.match(/class="padding-(\d+)" data-capter="(\d+)">([\s\S]*?)</) || [], padding = _a2[1], capter = _a2[2], name = _a2[3];
      ...
      TopLiba2.prototype.parseChapter = function(chapterPath) {
        return __awaiter(this, void 0, void 0, function() {
          ...
          return __generator(this, function(_c) {
            switch (_c.label) {
              case 0:
                ...
                return [4, (0, fetch_1.fetchApi)(this.resolveUrl(bookID)).then(function(res) {
                  return res.text();
                })];
              case 1:
                chaptersHTML = _c.sent();
                ...
                _c.label = 2;
              case 2:
                return [4, (0, fetch_1.fetchApi)(this.resolveUrl(bookID) + "/chapter", {
                  headers: {
