...
var LNReaderPlugin = (() => {
  ...
  // .js/plugins/arabic/KolNovel[lightnovelwp].js
  var e = function(e2, a2, l2, t2) {
    ...
    var l2, t2, s2, r2 = { label: 0, sent: function() {
  ...
  var l = (init_browser(), __toCommonJS(browser_exports)), t = require_lib9(), s = (init_fetch2(), __toCommonJS(fetch_exports)), r = (init_novelStatus(), __toCommonJS(novelStatus_exports)), i = (init_defaultCover(), __toCommonJS(defaultCover_exports)), o = (init_storage2(), __toCommonJS(storage_exports));
  function u(e2, a2) {
    var l2 = e2.match(/(\d+)$/);
  ...
  var n = new ((function() {
    function n2(e2) {
      ...
      this.version = "1.1.".concat(9 + s2), this.options = null !== (l2 = e2.options) && void 0 !== l2 ? l2 : {}, this.filters = e2.filters, (null === (t2 = this.options) || void 0 === t2 ? void 0 : t2.hasLocked) && (this.pluginSettings = { hideLocked: { value: "", label: "Hide locked chapters", type: "Switch" } });
    }
    return n2.prototype.getHostname = function(e2) {
        ...
        return a(this, (function(a2) {
          switch (a2.label) {
            ...
            case 1:
              ...
              return [4, o2.text()];
            case 2:
              if (u2 = a2.sent(), n3 = null === (v = null === (c = u2.match(/<title>(.*?)<\/title>/)) || void 0 === c ? void 0 : c[1]) || void 0 === v ? void 0 : v.trim(), this.getHostname(l2) != this.getHostname(o2.url) || n3 && ("Bot Verification" == n3 || "You are being redirected..." == n3 || "Un instant..." == n3 || "Just a moment..." == n3 || "Redirecting..." == n3)) throw new Error("Captcha error, please open in webview (or the website has changed url)");
              return [2, u2];
          }
        }));
      }));
      ...
      return (e2.match(/<article([^]*?)<\/article>/g) || []).forEach((function(e3) {
        ...
        if (r2 && s2) {
          var o2 = e3.match(/<img [^>]*?src="([^\"]*)"[^>]*?(?: data-src="([^\"]*)")?[^>]*>/) || [], u2 = void 0;
          if (s2.includes(a2.site)) u2 = s2.replace(a2.site, "");
          else {
            var n3 = s2.split("/");
            n3.shift(), n3.shift(), n3.shift(), u2 = n3.join("/");
          }
          t2.push({ name: r2, cover: o2[2] || o2[1] || i.defaultCover, path: u2 });
        }
      })), t2;
    }, n2.prototype.popularNovels = function(l2, t2) {
      return e(this, arguments, void 0, (function(e2, l3) {
        var t3, s2, r2, i2, o2, u2, n3, c, v, b = l3.filters, h = l3.showLatestNovels;
        return a(this, (function(a2) {
          switch (a2.label) {
            case 0:
              for (r2 in t3 = null !== (v = null === (c = this.options) || void 0 === c ? void 0 : c.seriesPath) && void 0 !== v ? v : "/series/", s2 = this.site + t3 + "?page=" + e2, b || (b = this.filters || {}), h && (s2 += "&order=latest"), b) if ("object" == typeof b[r2].value) for (i2 = 0, o2 = b[r2].value; i2 < o2.length; i2++) u2 = o2[i2], s2 += "&".concat(r2, "=").concat(u2);
              else b[r2].value && (s2 += "&".concat(r2, "=").concat(b[r2].value));
              return [4, this.safeFecth(s2, false)];
            case 1:
              return n3 = a2.sent(), [2, this.parseNovels(n3)];
          }
        }));
      }));
    }, n2.prototype.parseNovel = function(l2) {
      return e(this, void 0, void 0, (function() {
        var e2, s2, o2, n3, c, v, b, h, p, d, f, m, g, y, w, k, x, N, C, S, j;
        return a(this, (function(a2) {
          switch (a2.label) {
            case 0:
              return e2 = this.site, [4, this.safeFecth(e2 + l2, false)];
            case 1:
              return s2 = a2.sent(), o2 = { path: l2, name: "", genres: "", summary: "", author: "", artist: "", status: "", chapters: [] }, n3 = false, c = false, v = 0, b = false, h = false, p = false, d = false, f = false, m = false, g = false, y = 0, w = false, k = false, x = [], N = {}, C = this.hideLocked, S = new t.Parser({ onopentag: function(a3, l3) {
                var t2;
                !o2.cover && (null === (t2 = l3.class) || void 0 === t2 ? void 0 : t2.includes("ts-post-image")) ? (o2.name = l3.title, o2.cover = l3["data-src"] || l3.src || i.defaultCover) : "genxed" === l3.class || "sertogenre" === l3.class ? n3 = true : n3 && "a" === a3 ? c = true : "div" !== a3 || "entry-content" !== l3.class && "description" !== l3.itemprop ? "spe" === l3.class || "serl" === l3.class ? b = true : b && "span" === a3 ? h = true : "div" === a3 && "sertostat" === l3.class ? (b = true, h = true, f = true) : l3.class && l3.class.includes("eplister") ? m = true : m && "li" === a3 ? g = true : g ? "a" === a3 && void 0 === N.path ? N.path = l3.href.replace(e2, "").trim() : "epl-num" === l3.class ? y = 1 : "epl-title" === l3.class ? y = 2 : "epl-date" === l3.class ? y = 3 : "epl-price" === l3.class && (y = 4) : !v || "div" !== a3 && "script" !== a3 || v++ : v++;
              }, ontext: function(e3) {
                var a3, l3;
                if (n3) c && (o2.genres += e3 + ", ");
                else if (1 === v && e3.trim()) o2.summary += e3;
                else if (b) {
                  if (h) {
                    var t2 = e3.toLowerCase().replace(":", "").trim();
                    if (p) o2.author += e3 || "Unknown";
                    else if (d) o2.artist += e3 || "Unknown";
                    else if (f) switch (t2) {
                      case "\u0645\u0643\u062A\u0645\u0644\u0629":
                      case "completed":
                      case "compl\xE9t\xE9":
        ...
        return a(this, (function(a2) {
          switch (a2.label) {
            ...
            case 1:
              ...
              return [2, (null === (u2 = null === (o2 = e2.match(/<div.*?class="epcontent ([^]*?)<div.*?class="?bottomnav/g)) || void 0 === o2 ? void 0 : o2[0].match(/<p[^>]*>([^]*?)<\/p>/g)) || void 0 === u2 ? void 0 : u2.join("\n")) || ""];
          }
        }));
      }));
