...
var LNReaderPlugin = (() => {
  ...
  // .js/plugins/arabic/HizoManga[madara].js
  ...
  var r = (init_fetch2(), __toCommonJS(fetch_exports)), n = (init_browser(), __toCommonJS(browser_exports)), i = (init_defaultCover(), __toCommonJS(defaultCover_exports)), l = (init_novelStatus(), __toCommonJS(novelStatus_exports)), o = a(require_dayjs_min()), s = (init_storage2(), __toCommonJS(storage_exports)), u = function(e2, t2) {
    ...
    return a2.prototype.translateDragontea = function(e2) {
      ...
      return e2(".manga-title-badges").remove(), e2(".page-item-detail, .c-tabs-item__content").each((function(a3, r2) {
        var n2 = e2(r2).find(".post-title").text().trim(), l2 = e2(r2).find(".post-title").find("a").attr("href") || "";
        if (n2 && l2) {
          var o2 = e2(r2).find("img"), s2 = { name: n2, cover: o2.attr("data-src") || o2.attr("src") || o2.attr("data-lazy-srcset") || i.defaultCover, path: l2.replace(/https?:\/\/.*?\//, "/") };
          t2.push(s2);
        }
      })), t2;
    }, a2.prototype.popularNovels = function(a3, r2) {
      return e(this, arguments, void 0, (function(e2, a4) {
        var r3, n2, i2, l2, o2, s2, u2 = a4.filters, c2 = a4.showLatestNovels;
        return t(this, (function(t2) {
          switch (t2.label) {
            case 0:
              for (n2 in r3 = this.site + "/page/" + e2 + "/?s=&post_type=wp-manga", u2 || (u2 = this.filters || {}), c2 && (r3 += "&m_orderby=latest"), u2) if ("object" == typeof u2[n2].value) for (i2 = 0, l2 = u2[n2].value; i2 < l2.length; i2++) o2 = l2[i2], r3 += "&".concat(n2, "=").concat(o2);
      ...
      return e(this, void 0, void 0, (function() {
        var e2, s2, u2, c2, h, p, m, v, d = this;
        return t(this, (function(t2) {
          switch (t2.label) {
            case 0:
            ...
            case 5:
              return "0" !== c2 && (e2 = (0, n.load)(c2)), m = e2(".wp-manga-chapter").length, e2(".wp-manga-chapter").each((function(t3, a4) {
                ...
                !l2 || "#" == l2 || n2 && d.hideLocked || u2.push({ name: r2, path: l2.replace(/https?:\/\/.*?\//, "/"), releaseTime: i2 || null, chapterNumber: m - t3 });
