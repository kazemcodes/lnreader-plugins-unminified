...
var LNReaderPlugin = (() => {
  ...
  // .js/plugins/arabic/Azora[madara].js
  ...
  var l = (init_fetch2(), __toCommonJS(fetch_exports)), r = (init_browser(), __toCommonJS(browser_exports)), n = (init_defaultCover(), __toCommonJS(defaultCover_exports)), i = (init_novelStatus(), __toCommonJS(novelStatus_exports)), o = a(require_dayjs_min()), u = (init_storage2(), __toCommonJS(storage_exports)), s = function(e2, t2) {
    ...
    return a2.prototype.translateDragontea = function(e2) {
      ...
      return e2.html(a3.html()), e2.find("*").addBack().contents().filter((function(e3, t3) {
        ...
        var l2 = a3(t3), r2 = l2.text().normalize("NFD").split("").map((function(e4) {
      ...
      return e(this, void 0, void 0, (function() {
        var e2, u2, s2, c2, v, b, p, h, m = this;
        return t(this, (function(t2) {
          switch (t2.label) {
            case 0:
            ...
            case 1:
              return (e2 = t2.sent())(".manga-title-badges, #manga-title span").remove(), (u2 = { path: a3, name: e2(".post-title h1").text().trim() || e2("#manga-title h1").text().trim() || e2(".manga-title").text().trim() || "" }).cover = e2(".summary_image > a > img").attr("data-lazy-src") || e2(".summary_image > a > img").attr("data-src") || e2(".summary_image > a > img").attr("src") || n.defaultCover, e2(".post-content_item, .post-content").each((function() {
                ...
                return e2(a4).text();
              })).get().join("\n\n").trim(), s2 = [], c2 = "", (null === (h = this.options) || void 0 === h ? void 0 : h.useNewChapterEndpoint) ? [4, (0, l.fetchApi)(this.site + a3 + "ajax/chapters/", { method: "POST", referrer: this.site + a3 }).then((function(e3) {
                return e3.text();
              }))] : [3, 3];
            case 2:
            ...
            case 5:
              return "0" !== c2 && (e2 = (0, r.load)(c2)), p = e2(".wp-manga-chapter").length, e2(".wp-manga-chapter").each((function(t3, a4) {
                var l2 = e2(a4).find("a").text().trim(), r2 = a4.attribs.class.includes("premium-block");
                r2 && (l2 = "\u{1F512} " + l2);
                var n2 = e2(a4).find("span.chapter-release-date").text().trim();
                n2 = n2 ? m.parseData(n2) : (0, o.default)().format("LL");
                var i2 = e2(a4).find("a").attr("href") || "";
                !i2 || "#" == i2 || r2 && m.hideLocked || s2.push({ name: l2, path: i2.replace(/https?:\/\/.*?\//, "/"), releaseTime: n2 || null, chapterNumber: p - t3 });
        ...
        return t(this, (function(t2) {
          switch (t2.label) {
            case 0:
              return [4, this.getCheerio(this.site + a3, false)];
            case 1:
              return e2 = t2.sent(), l2 = e2(".text-left") || e2(".text-right") || e2(".entry-content") || e2(".c-blog-post > div > div:nth-child(2)"), null === (r2 = this.options) || void 0 === r2 || r2.customJs, [2, this.translateDragontea(l2).html() || ""];
          }
        }));
      }));
