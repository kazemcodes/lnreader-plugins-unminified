...
var LNReaderPlugin = (() => {
  ...
  var l = new ((function() {
    ...
    return l2.prototype.getHostname = function(e2) {
      ...
      return e(this, void 0, void 0, (function() {
        var e2, a2, n2, l3, u, h, p, v, d, f, m, g, b, w, y, k, N, x, C, S, L;
        return t(this, (function(t2) {
          switch (t2.label) {
            case 0:
              return e2 = this.site, [4, this.safeFecth(e2 + s2, false)];
            case 1:
              return a2 = t2.sent(), n2 = { path: s2, name: "", genres: "", summary: "", author: "", artist: "", status: "", chapters: [] }, l3 = false, u = false, h = 0, p = false, v = false, d = false, f = false, m = false, g = false, b = false, w = 0, y = false, k = false, N = [], x = {}, C = this.hideLocked, S = new r.Parser({ onopentag: function(t3, s3) {
                var r2;
        ...
        return t(this, (function(t2) {
          switch (t2.label) {
            ...
            case 1:
              ...
              return [2, (null === (c2 = null === (n2 = e2.match(/<div.*?class="epcontent ([^]*?)<div.*?class="?bottomnav/g)) || void 0 === n2 ? void 0 : n2[0].match(/<p[^>]*>([^]*?)<\/p>/g)) || void 0 === c2 ? void 0 : c2.join("\n")) || ""];
          }
        }));
      }));
  ...
  })())({ id: "freekolnovel", sourceSite: "https://free.kolnovel.com/", sourceName: "Free Kol Novel", options: { lang: "Arabic", reverseChapters: true, customJs: "$('article > style').text().match(/\\.\\w+(?=\\s*[,{])/g)?.forEach(tag => $(`p${tag}`).remove());$('.epcontent .code-block').remove();" } });
  exports.default = l;
})();
