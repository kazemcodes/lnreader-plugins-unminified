...
var LNReaderPlugin = (() => {
  ...
  // .js/plugins/arabic/NovelsParadise[lightnovelwp].js
  ...
  var u = new ((function() {
    ...
    return u2.prototype.getHostname = function(e2) {
      ...
      return e(this, arguments, void 0, (function(e2, a3) {
        var l3, s2, r2, i2, o2, n2, u3, c, v, h = a3.filters, p = a3.showLatestNovels;
        return t(this, (function(t2) {
          switch (t2.label) {
            case 0:
              for (r2 in l3 = null !== (v = null === (c = this.options) || void 0 === c ? void 0 : c.seriesPath) && void 0 !== v ? v : "/series/", s2 = this.site + l3 + "?page=" + e2, h || (h = this.filters || {}), p && (s2 += "&order=latest"), h) if ("object" == typeof h[r2].value) for (i2 = 0, o2 = h[r2].value; i2 < o2.length; i2++) n2 = o2[i2], s2 += "&".concat(r2, "=").concat(n2);
      ...
      return e(this, void 0, void 0, (function() {
        var e2, s2, o2, u3, c, v, h, p, d, f, b, m, g, y, w, k, N, C, x, _, S;
        return t(this, (function(t2) {
          switch (t2.label) {
            case 0:
              return e2 = this.site, [4, this.safeFecth(e2 + a2, false)];
            case 1:
              return s2 = t2.sent(), o2 = { path: a2, name: "", genres: "", summary: "", author: "", artist: "", status: "", chapters: [] }, u3 = false, c = false, v = 0, h = false, p = false, d = false, f = false, b = false, m = false, g = false, y = 0, w = false, k = false, N = [], C = {}, x = this.hideLocked, _ = new l.Parser({ onopentag: function(t3, a3) {
                var l2;
                ...
                if (u3) c && (o2.genres += e3 + ", ");
                  ...
                  else if (2 === y) C.name = (null === (a3 = null === (t3 = e3.match(RegExp("^".concat(o2.name.replace(/[.*+?^${}()|[\]\\]/g, "\\$&"), "\\s*(.+)")))) || void 0 === t3 ? void 0 : t3[1]) || void 0 === a3 ? void 0 : a3.trim()) || e3.trim(), C.chapterNumber || n(e3, C);
