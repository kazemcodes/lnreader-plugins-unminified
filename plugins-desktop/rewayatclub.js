...
var LNReaderPlugin = (() => {
  ...
  var RewayatClub = (
    ...
    function() {
      function RewayatClub2() {
        ...
        this.filters = {
          genre: {
            ...
            label: "Genres",
            options: [
              { label: "\u0643\u0648\u0645\u064A\u062F\u064A\u0627", value: "1" },
              // Comedy
              { label: "\u0623\u0643\u0634\u0646", value: "2" },
              // Action
              { label: "\u062F\u0631\u0627\u0645\u0627", value: "3" },
              // Drama
              { label: "\u0641\u0627\u0646\u062A\u0627\u0632\u064A\u0627", value: "4" },
              // Fantasy
              { label: "\u0645\u0647\u0627\u0631\u0627\u062A \u0627\u0644\u0642\u062A\u0627\u0644", value: "5" },
              // Combat Skills
              { label: "\u0645\u063A\u0627\u0645\u0631\u0629", value: "6" },
              // Adventure
              { label: "\u0631\u0648\u0645\u0627\u0646\u0633\u064A", value: "7" },
              // Romance
              { label: "\u062E\u064A\u0627\u0644 \u0639\u0644\u0645\u064A", value: "8" },
              // Science Fiction
              { label: "\u0627\u0644\u062D\u064A\u0627\u0629 \u0627\u0644\u0645\u062F\u0631\u0633\u064A\u0629", value: "9" },
              // School Life
              { label: "\u0642\u0648\u0649 \u062E\u0627\u0631\u0642\u0629", value: "10" },
              // Super Powers
              { label: "\u0633\u062D\u0631", value: "11" },
              // Magic
              { label: "\u0631\u064A\u0627\u0636\u0629", value: "12" },
              // Sports
              { label: "\u0631\u0639\u0628", value: "13" },
              // Horror
              { label: "\u062D\u0631\u064A\u0645", value: "14" }
      ...
      __name(RewayatClub2, "RewayatClub");
      RewayatClub2.prototype.parseNovels = function(data2) {
        var novels = [];
        if (data2.results === void 0)
          return novels;
        data2.results.map(function(item) {
          var _a;
          novels.push({
            name: item.arabic || ((_a = item.novel) === null || _a === void 0 ? void 0 : _a.arabic) || "novel",
            path: item.slug ? "novel/".concat(item.slug) : item.novel ? "novel/".concat(item.novel.slug) : "novel",
            cover: item.poster_url ? "https://api.rewayat.club/".concat(item.poster_url.slice(1)) : item.novel ? "https://api.rewayat.club/".concat(item.novel.poster_url.slice(1)) : defaultCover_1.defaultCover
          });
        });
        return novels;
      };
      RewayatClub2.prototype.popularNovels = function(page_1, _a) {
          ...
          return __generator(this, function(_c) {
            switch (_c.label) {
              case 0:
                ...
                if (!showLatestNovels) return [3, 2];
      ...
      RewayatClub2.prototype.parseNovel = function(novelUrl) {
          ...
          return __generator(this, function(_a) {
            switch (_a.label) {
              ...
              case 2:
                ...
                statusWords = /* @__PURE__ */ new Set(["\u0645\u0643\u062A\u0645\u0644\u0629", "\u0645\u062A\u0648\u0642\u0641\u0629", "\u0645\u0633\u062A\u0645\u0631\u0629"]);
                mainGenres = Array.from(loadedCheerio(".v-slide-group__content a")).map(function(el) {
                  return loadedCheerio(el).text().trim();
                }).join(",");
                statusGenre = Array.from(loadedCheerio("div.v-slide-group__content span.v-chip__content")).map(function(el) {
                  return loadedCheerio(el).text().trim();
                }).filter(function(text3) {
                  return statusWords.has(text3);
                });
                novel.genres = "".concat(statusGenre, ",").concat(mainGenres);
                statusText = Array.from(loadedCheerio("div.v-slide-group__content span.v-chip__content")).map(function(el) {
                  return loadedCheerio(el).text().trim();
                }).filter(function(text3) {
                  return statusWords.has(text3);
                }).join();
                ...
                imageRaw = loadedCheerio('body script:contains("__NUXT__")').first().text();
                imageUrlRegex = /poster_url:"(\\u002F[^"]+)"/;
                imageUrlMatch = imageRaw === null || imageRaw === void 0 ? void 0 : imageRaw.match(imageUrlRegex);
                ImageUrlShort = imageUrlMatch ? imageUrlMatch[1].replace(/\\u002F/g, "/").replace(/^\/*/, "") : defaultCover_1.defaultCover;
                imageUrl = "https://api.rewayat.club/".concat(ImageUrlShort);
                novel.cover = imageUrl;
                chapterNumberStr = loadedCheerio("div.v-tab--active span.mr-1").text().replace(/[^\d]/g, "");
      ...
      RewayatClub2.prototype.parseChapters = function(data2, novelPath) {
        var chapter = [];
        data2.results.map(function(item) {
          chapter.push({
            name: item.title,
      ...
      RewayatClub2.prototype.parsePage = function(novelPath, page) {
        return __awaiter(this, void 0, void 0, function() {
          ...
          return __generator(this, function(_a) {
            switch (_a.label) {
              case 0:
                ...
                return [4, (0, fetch_1.fetchApi)(pageUrl).then(function(r) {
                  return r.json();
                })];
              case 1:
                dataJson = _a.sent();
      ...
      RewayatClub2.prototype.parseChapter = function(chapterUrl) {
        return __awaiter(this, void 0, void 0, function() {
          ...
          return __generator(this, function(_a) {
            switch (_a.label) {
              ...
              case 1:
                result = _a.sent();
                chapterText = result.content.flat().join("<br>").replace(/\n/g, "").replace(/<p>/g, "\n");
      ...
      RewayatClub2.prototype.searchNovels = function(searchTerm, page) {
        return __awaiter(this, void 0, void 0, function() {
          ...
          return __generator(this, function(_a) {
            switch (_a.label) {
              case 0:
                ...
                return [4, (0, fetch_1.fetchApi)(searchUrl).then(function(r) {
                  return r.json();
                })];
              case 1:
                result = _a.sent();
                return [2, this.parseNovels(result)];
            }
          });
        });
      };
