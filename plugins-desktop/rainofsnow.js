...
var LNReaderPlugin = (() => {
  ...
  var Rainofsnow = (
    ...
    function() {
      ...
      __name(Rainofsnow2, "Rainofsnow");
      Rainofsnow2.prototype.parseNovels = function(loadedCheerio) {
        var _this = this;
        var novels = [];
        loadedCheerio(".minbox").each(function(index2, element) {
          var _a;
          var name = loadedCheerio(element).find("h3").text();
          var cover = loadedCheerio(element).find("img").attr("data-src");
          var path = (_a = loadedCheerio(element).find("h3 > a").attr("href")) === null || _a === void 0 ? void 0 : _a.replace(_this.site, "").replace(/\/+$/, "");
          if (!path) {
            return;
          }
      ...
      Rainofsnow2.prototype.popularNovels = function(pageNo_1, _a) {
      ...
      Rainofsnow2.prototype.parseNovel = function(novelPath) {
          ...
          return __generator(this, function(_a) {
            switch (_a.label) {
              ...
              case 1:
                ...
                novel.genres = loadedCheerio('span:contains("Genre(s)")').next().text().trim();
      ...
      Rainofsnow2.prototype.parsePage = function(novelPath, page) {
        return __awaiter(this, void 0, void 0, function() {
      ...
      Rainofsnow2.prototype.parseChapters = function(loadedCheerio) {
        var _this = this;
        var chapter = [];
        loadedCheerio("#chapter .march1 li").each(function(i, el) {
          var _a;
          var path = (_a = loadedCheerio(el).find("a").attr("href")) === null || _a === void 0 ? void 0 : _a.slice(_this.site.length);
          if (!path)
            return;
          ...
          var releaseTime = monthName && month !== -1 ? new Date(+year, month, +day).toISOString() : null;
          chapter.push({
            name,
            path,
            releaseTime
      ...
      Rainofsnow2.prototype.parseChapter = function(chapterPath) {
        return __awaiter(this, void 0, void 0, function() {
          var result, body, loadedCheerio, chapterName, chapterText;
          return __generator(this, function(_a) {
            switch (_a.label) {
              case 0:
                return [4, fetch(this.site + chapterPath)];
              case 1:
                result = _a.sent();
              ...
              case 2:
                ...
                if (!chapterText)
                  return [2, ""];
                return [2, chapterName + "\n" + chapterText];
            }
          });
        });
      };
      Rainofsnow2.prototype.searchNovels = function(searchTerm) {
        return __awaiter(this, void 0, void 0, function() {
