...
var LNReaderPlugin = (() => {
  ...
  var Chrysanthemumgarden = (
    /** @class */
    function() {
      function Chrysanthemumgarden2() {
        var _this = this;
      ...
      __name(Chrysanthemumgarden2, "Chrysanthemumgarden");
      Chrysanthemumgarden2.prototype.popularNovels = function(pageNo_1, _a) {
        return __awaiter(this, arguments, void 0, function(pageNo, _b) {
          ...
          return __generator(this, function(_c) {
            switch (_c.label) {
              case 0:
                return [4, (0, fetch_1.fetchApi)(this.site + (pageNo === 1 ? "/books" : "/books/page/" + pageNo) + "/")];
              case 1:
                req = _c.sent();
                return [4, req.text()];
              case 2:
                ...
                return [2, loadedCheerio("article").map(function(i, el) {
                  if (loadedCheerio(el).find("div.series-genres > a").text().includes("Manhua"))
                    return;
                  var href = loadedCheerio(el).find("h2.novel-title > a").attr("href");
                  if (!href)
                    return;
                  return {
                    name: loadedCheerio(el).find("h2.novel-title > a").text(),
                    path: href.replace(_this.site, "").replace(/^\//, "").replace(/\/$/, ""),
                    cover: loadedCheerio(el).find("div.novel-cover > img").attr("data-breeze") || defaultCover_1.defaultCover
                  };
      ...
      Chrysanthemumgarden2.prototype.parseNovel = function(novelPath) {
        return __awaiter(this, void 0, void 0, function() {
          var req, body, loadedCheerio, novel, novelInfoHtml;
          var _this = this;
          var _a, _b;
          return __generator(this, function(_c) {
            switch (_c.label) {
              ...
              case 2:
                ...
                novel = {
                  ...
                  summary: loadedCheerio("div.entry-content > p").map(function(i, el) {
                    return loadedCheerio(el).text();
                  }).toArray().join("\n\n")
                };
                novelInfoHtml = loadedCheerio("div.novel-info").html();
                novel.author = novelInfoHtml ? (_b = (_a = novelInfoHtml.match(/Author:\s*([^<]*)<br>/)) === null || _a === void 0 ? void 0 : _a[1]) === null || _b === void 0 ? void 0 : _b.trim() : void 0;
                novel.genres = __spreadArray(__spreadArray([], loadedCheerio("div.series-genres > a").map(function(i, el) {
                  return loadedCheerio(el).text();
                }).toArray(), true), loadedCheerio("a.series-tag").map(function(i, el) {
                  return loadedCheerio(el).text().split("(")[0].trim();
                }).toArray(), true).join(", ");
      ...
      Chrysanthemumgarden2.prototype.parseChapter = function(chapterPath) {
        return __awaiter(this, void 0, void 0, function() {
          var req, body, loadedCheerio;
          return __generator(this, function(_a) {
            switch (_a.label) {
              ...
              case 2:
                body = _a.sent();
                loadedCheerio = (0, cheerio_1.load)(body);
                return [2, loadedCheerio("div#novel-content").html() || ""];
            }
          });
        });
      };
      Chrysanthemumgarden2.prototype.searchNovels = function(searchTerm, pageNo) {
        return __awaiter(this, void 0, void 0, function() {
          var req, body, allNovels;
          var _this = this;
          return __generator(this, function(_a) {
            switch (_a.label) {
              case 0:
                if (pageNo !== 1)
                  return [2, []];
                return [4, (0, fetch_1.fetchApi)(this.site + "/wp-json/cg/novels")];
              case 1:
                req = _a.sent();
                return [4, req.json()];
              case 2:
                body = _a.sent();
                allNovels = body.map(function(novel) {
                  return {
                    name: novel.name,
                    path: novel.link.replace(_this.site, "").replace(/\/$/, "").replace(/^\//, ""),
                    cover: defaultCover_1.defaultCover
                  };
                });
                if (!allNovels)
                  return [2, []];
                return [2, allNovels.filter(function(novel) {
      ...
      Chrysanthemumgarden2.prototype.getAllNovels = function() {
        return __awaiter(this, void 0, void 0, function() {
          return __generator(this, function(_a) {
            return [
              2
