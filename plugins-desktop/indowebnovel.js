...
var LNReaderPlugin = (() => {
  ...
  // .js/plugins/indonesian/indowebnovel.js
  init_dirname();
  init_buffer2();
  init_process2();
  ...
  var IndoWebNovel = (
    ...
    function() {
      ...
      __name(IndoWebNovel2, "IndoWebNovel");
      IndoWebNovel2.prototype.parseNovels = function(loadedCheerio) {
        var _this = this;
        var novels = [];
      ...
      IndoWebNovel2.prototype.popularNovels = function() {
      ...
      IndoWebNovel2.prototype.parseNovel = function(novelPath) {
            ...
            switch (_a.label) {
              ...
              case 2:
                ...
                novel = {
                  ...
                  author: loadedCheerio(".series-infolist li:contains('Author') span").text().trim(),
                  status: loadedCheerio(".status").text().trim() === "Completed" ? novelStatus_1.NovelStatus.Completed : novelStatus_1.NovelStatus.Ongoing,
                  summary: loadedCheerio(".series-synops").text().trim(),
                  chapters: []
                };
                novel.genres = loadedCheerio(".series-genres a").map(function(i, el) {
      ...
      IndoWebNovel2.prototype.parseChapter = function(chapterPath) {
        return __awaiter(this, void 0, void 0, function() {
      ...
      IndoWebNovel2.prototype.searchNovels = function(searchTerm_1) {
