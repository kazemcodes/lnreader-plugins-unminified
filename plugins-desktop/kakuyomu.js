...
var LNReaderPlugin = (() => {
  ...
  var KakuyomuPlugin = (
    ...
    function() {
      ...
      __name(KakuyomuPlugin2, "KakuyomuPlugin");
      KakuyomuPlugin2.prototype.popularNovels = function(pageNo_1, _a) {
        return __awaiter(this, arguments, void 0, function(pageNo, _b) {
          var url, html3, $2, novels;
          ...
          return __generator(this, function(_c) {
            switch (_c.label) {
              case 0:
                ...
                return [4, (0, fetch_1.fetchText)(url.toString())];
              case 1:
                html3 = _c.sent();
                $2 = (0, cheerio_1.load)(html3);
                novels = [];
                $2(".widget-media-genresWorkList-right > .widget-work").each(function(_, elem) {
                  var anchor = $2(elem).find("a.widget-workCard-titleLabel");
      ...
      KakuyomuPlugin2.prototype.parseNovel = function(novelPath) {
        return __awaiter(this, void 0, void 0, function() {
          var url, html3, $2, json, apolloState, work, author, chapters, tableOfContentsChapter, episodes, joinChapters, novel;
          var _a, _b, _c, _d, _e;
          return __generator(this, function(_f) {
            switch (_f.label) {
              ...
              case 1:
                html3 = _f.sent();
                $2 = (0, cheerio_1.load)(html3);
                json = JSON.parse($2('script#__NEXT_DATA__[type="application/json"]').html() || "{}");
                ...
                work = Object.values(apolloState).find(function(v) {
                  return typeof v === "object" && v !== null && "__typename" in v && v.__typename === "Work" && "id" in v && v.id === novelPath.replace("/works/", "");
                });
                author = Object.values(apolloState).find(function(v) {
                  return typeof v === "object" && v !== null && "__typename" in v && v.__typename === "UserAccount" && "id" in v && v.id === work.author.__ref.replace("UserAccount:", "");
                });
                chapters = Object.values(apolloState).filter(function(v) {
                  if (typeof v === "object" && v !== null && "__typename" in v && v.__typename === "Chapter") {
                    return true;
                  }
                });
                tableOfContentsChapter = Object.values(apolloState).filter(function(v) {
                  if (typeof v === "object" && v !== null && "__typename" in v && v.__typename === "TableOfContentsChapter") {
                    return true;
                  }
                });
                episodes = Object.values(apolloState).filter(function(v) {
                  if (typeof v === "object" && v !== null && "__typename" in v && v.__typename === "Episode") {
                    return true;
                  }
                });
                joinChapters = episodes.map(function(v) {
                  var _a2;
                  var chapter = (_a2 = tableOfContentsChapter.find(function(c) {
                    return c.episodeUnions.some(function(e) {
                      return e.__ref === "Episode:".concat(v.id);
                    });
                  })) === null || _a2 === void 0 ? void 0 : _a2.chapter;
                  return {
                    chapter: chapters.find(function(c) {
                      return c.id === (chapter === null || chapter === void 0 ? void 0 : chapter.__ref.replace("Chapter:", ""));
                    }),
                    episode: v
                  };
                });
                novel = {
                  ...
                  status: work.serialStatus === "COMPLETED" ? novelStatus_1.NovelStatus.Completed : novelStatus_1.NovelStatus.Ongoing,
                  summary: work.introduction,
                  chapters: joinChapters.map(function(v) {
                    var _a2, _b2, _c2, _d2, _e2, _f2, _g, _h;
                    return {
                      name: ((_a2 = v.chapter) === null || _a2 === void 0 ? void 0 : _a2.title) ? "".concat((_b2 = v.chapter) === null || _b2 === void 0 ? void 0 : _b2.title, " - ").concat((_c2 = v.episode) === null || _c2 === void 0 ? void 0 : _c2.title) : (_e2 = (_d2 = v.episode) === null || _d2 === void 0 ? void 0 : _d2.title) !== null && _e2 !== void 0 ? _e2 : "",
                      path: "".concat(novelPath, "/episodes/").concat((_f2 = v.episode) === null || _f2 === void 0 ? void 0 : _f2.id),
      ...
      KakuyomuPlugin2.prototype.parseChapter = function(chapterPath) {
        return __awaiter(this, void 0, void 0, function() {
          var url, html3, $2, chapterTitle, episodeTitle, episodeBody, chapterText;
          var _a, _b, _c;
          return __generator(this, function(_d) {
            switch (_d.label) {
              ...
              case 1:
                html3 = _d.sent();
                $2 = (0, cheerio_1.load)(html3);
                chapterTitle = (_a = $2(".chapterTitle").text()) !== null && _a !== void 0 ? _a : "";
                episodeTitle = (_b = $2(".widget-episodeTitle").html()) !== null && _b !== void 0 ? _b : "";
                episodeBody = (_c = $2(".widget-episodeBody").html()) !== null && _c !== void 0 ? _c : "";
      ...
      KakuyomuPlugin2.prototype.searchNovels = function(searchTerm, pageNo) {
        return __awaiter(this, void 0, void 0, function() {
          var url, html3, $2, json, works, novels;
          var _a, _b, _c;
          return __generator(this, function(_d) {
            switch (_d.label) {
              case 0:
              ...
              case 1:
                ...
                works = Object.values((_c = (_b = (_a = json === null || json === void 0 ? void 0 : json.props) === null || _a === void 0 ? void 0 : _a.pageProps) === null || _b === void 0 ? void 0 : _b.__APOLLO_STATE__) !== null && _c !== void 0 ? _c : {}).filter(function(v) {
                  if (typeof v === "object" && v !== null && "__typename" in v && v.__typename === "Work") {
                    return true;
                  }
                });
                novels = works.map(function(v) {
                  var _a2, _b2;
                  return {
                    name: (_a2 = v.title) !== null && _a2 !== void 0 ? _a2 : "",
                    path: "/works/".concat(v.id),
                    cover: (_b2 = v.adminCoverImageUrl) !== null && _b2 !== void 0 ? _b2 : defaultCover_1.defaultCover
                  };
                });
                return [2, novels];
            }
