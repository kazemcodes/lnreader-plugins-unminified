...
var LNReaderPlugin = (() => {
  ...
  // .js/plugins/french/WorldNovel[madara].js
  ...
  var r = (init_fetch2(), __toCommonJS(fetch_exports)), n = (init_browser(), __toCommonJS(browser_exports)), i = (init_defaultCover(), __toCommonJS(defaultCover_exports)), o = (init_novelStatus(), __toCommonJS(novelStatus_exports)), l = a(require_dayjs_min()), s = (init_storage2(), __toCommonJS(storage_exports)), u = function(e2, t2) {
    ...
    return a2.prototype.translateDragontea = function(e2) {
      ...
      return e(this, void 0, void 0, (function() {
        var e2, s2, u2, c2, h, p, d, v, m = this;
        return t(this, (function(t2) {
          switch (t2.label) {
            case 0:
            ...
            case 1:
              return (e2 = t2.sent())(".manga-title-badges, #manga-title span").remove(), (s2 = { path: a3, name: e2(".post-title h1").text().trim() || e2("#manga-title h1").text().trim() || e2(".manga-title").text().trim() || "" }).cover = e2(".summary_image > a > img").attr("data-lazy-src") || e2(".summary_image > a > img").attr("data-src") || e2(".summary_image > a > img").attr("src") || i.defaultCover, e2(".post-content_item, .post-content").each((function() {
                ...
                return e2(a4).text();
              })).get().join("\n\n").trim(), u2 = [], c2 = "", (null === (v = this.options) || void 0 === v ? void 0 : v.useNewChapterEndpoint) ? [4, (0, r.fetchApi)(this.site + a3 + "ajax/chapters/", { method: "POST", referrer: this.site + a3 }).then((function(e3) {
                return e3.text();
              }))] : [3, 3];
            case 2:
              return c2 = t2.sent(), [3, 5];
            case 3:
              return h = e2(".rating-post-id").attr("value") || e2("#manga-chapters-holder").attr("data-id") || "", (p = new FormData()).append("action", "manga_get_chapters"), p.append("manga", h), [4, (0, r.fetchApi)(this.site + "wp-admin/admin-ajax.php", { method: "POST", body: p }).then((function(e3) {
                return e3.text();
              }))];
            case 4:
              c2 = t2.sent(), t2.label = 5;
            case 5:
              return "0" !== c2 && (e2 = (0, n.load)(c2)), d = e2(".wp-manga-chapter").length, e2(".wp-manga-chapter").each((function(t3, a4) {
                ...
                i2 = i2 ? m.parseData(i2) : (0, l.default)().format("LL");
                var o2 = e2(a4).find("a").attr("href") || "";
                !o2 || "#" == o2 || n2 && m.hideLocked || u2.push({ name: r2, path: o2.replace(/https?:\/\/.*?\//, "/"), releaseTime: i2 || null, chapterNumber: d - t3 });
  ...
  })())({ id: "worldnovel", sourceSite: "https://world-novel.fr/", sourceName: "WorldNovel", options: { useNewChapterEndpoint: true, lang: "French" }, filters: { "genre[]": { type: "Checkbox", label: "Genre", value: [], options: [{ label: "Action", value: "action" }, { label: "Arts martiaux", value: "arts-martiaux" }, { label: "Aventure", value: "aventure" }, { label: "Com\xE9die", value: "comedie" }, { label: "Drame", value: "drame" }, { label: "Ecchi", value: "ecchi" }, { label: "Fantaisie", value: "fantaisie" }, { label: "Horreur", value: "horreur" }, { label: "Isekai", value: "isekai" }, { label: "Light Novel", value: "light-novel" }, { label: "Myst\xE8re", value: "mystere" }, { label: "Novel Originaux", value: "novel-originaux" }, { label: "Novel Publi\xE9", value: "novel-publie" }, { label: "Psychologique", value: "psychologique" }, { label: "Romance", value: "romance" }, { label: "School Life", value: "school-life" }, { label: "Sci-fi", value: "sci-fi" }, { label: "Sport", value: "sport" }, { label: "Surnaturel", value: "surnaturel" }, { label: "Thriller", value: "thriller" }, { label: "Trag\xE9die", value: "tragedie" }, { label: "Tranche de vie", value: "tranche-de-vie" }, { label: "Web Novel", value: "web-novel" }] }, op: { type: "Switch", label: "ET avoir tous les genres s\xE9lectionn\xE9s", value: false }, author: { type: "Text", label: "Auteur", value: "" }, artist: { type: "Text", label: "Artiste", value: "" }, release: { type: "Text", label: "Ann\xE9e de sortie", value: "" }, adult: { type: "Picker", label: "Contenu pour adultes", value: "", options: [{ label: "Tous", value: "" }, { label: "Aucun contenu adulte", value: "0" }, { label: "Contenu pour adultes uniquement", value: "1" }] }, "status[]": { type: "Checkbox", label: "Statut", value: [], options: [{ label: "OnGoing", value: "on-going" }, { label: "Completed", value: "end" }, { label: "Canceled", value: "canceled" }, { label: "On Hold", value: "on-hold" }, { label: "Upcoming", value: "upcoming" }] }, m_orderby: { type: "Picker", label: "Trier par", value: "", options: [{ label: "Pertinence", value: "" }, { label: "Les plus r\xE9cents", value: "latest" }, { label: "A-Z", value: "alphabet" }, { label: "Classement", value: "rating" }, { label: "Tendance", value: "trending" }, { label: "La plupart des vues", value: "views" }, { label: "Nouveau", value: "new-manga" }] } } });
  exports.default = c;
})();
