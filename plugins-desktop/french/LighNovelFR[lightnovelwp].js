...
var LNReaderPlugin = (() => {
  ...
  // .js/plugins/french/LighNovelFR[lightnovelwp].js
  var e = function(e2, t2, a2, l2) {
    return new (a2 || (a2 = Promise))((function(s2, i2) {
      function r2(e3) {
        try {
          o2(l2.next(e3));
        } catch (e4) {
      ...
      function o2(e3) {
        var t3;
        e3.done ? s2(e3.value) : (t3 = e3.value, t3 instanceof a2 ? t3 : new a2((function(e4) {
          e4(t3);
        }))).then(r2, n2);
      }
    ...
    var a2, l2, s2, i2 = { label: 0, sent: function() {
        ...
        return (function(n4) {
          ...
          for (; r2 && (r2 = 0, n4[0] && (i2 = 0)), i2; ) try {
            ...
            switch (l2 = 0, s2 && (n4 = [2 & n4[0], s2.value]), n4[0]) {
              ...
              case 5:
                i2.label++, l2 = n4[1], n4 = [0];
                continue;
              case 7:
                n4 = i2.ops.pop(), i2.trys.pop();
                continue;
              default:
                if (!(s2 = i2.trys, (s2 = s2.length > 0 && s2[s2.length - 1]) || 6 !== n4[0] && 2 !== n4[0])) {
                  i2 = 0;
                  continue;
                }
                ...
                if (6 === n4[0] && i2.label < s2[1]) {
                  i2.label = s2[1], s2 = n4;
                  break;
                }
                if (s2 && i2.label < s2[2]) {
                  i2.label = s2[2], i2.ops.push(n4);
                  break;
                }
  ...
  var a = (init_browser(), __toCommonJS(browser_exports)), l = require_lib9(), s = (init_fetch2(), __toCommonJS(fetch_exports)), i = (init_novelStatus(), __toCommonJS(novelStatus_exports)), r = (init_defaultCover(), __toCommonJS(defaultCover_exports)), n = (init_storage2(), __toCommonJS(storage_exports));
  function o(e2, t2) {
    var a2 = e2.match(/(\d+)$/);
  ...
  var u = new ((function() {
    function u2(e2) {
      ...
      this.version = "1.1.".concat(9 + s2), this.options = null !== (a2 = e2.options) && void 0 !== a2 ? a2 : {}, this.filters = e2.filters, (null === (l2 = this.options) || void 0 === l2 ? void 0 : l2.hasLocked) && (this.pluginSettings = { hideLocked: { value: "", label: "Hide locked chapters", type: "Switch" } });
    }
    return u2.prototype.getHostname = function(e2) {
      var t2 = (e2 = e2.split("/")[2]).split(".");
      return t2.pop(), t2.join(".");
    }, u2.prototype.safeFecth = function(a2, l2) {
      return e(this, void 0, void 0, (function() {
        var e2, i2, r2, n2, o2, u3, c, v;
        return t(this, (function(t2) {
          switch (t2.label) {
            case 0:
              return e2 = a2.split("://"), i2 = e2.shift(), r2 = e2[0].replace(/\/\//g, "/"), [4, (0, s.fetchApi)(i2 + "://" + r2)];
            case 1:
              if (!(n2 = t2.sent()).ok && 1 != l2) throw new Error("Could not reach site (" + n2.status + ") try to open in webview.");
              return [4, n2.text()];
            case 2:
              if (o2 = t2.sent(), u3 = null === (v = null === (c = o2.match(/<title>(.*?)<\/title>/)) || void 0 === c ? void 0 : c[1]) || void 0 === v ? void 0 : v.trim(), this.getHostname(a2) != this.getHostname(n2.url) || u3 && ("Bot Verification" == u3 || "You are being redirected..." == u3 || "Un instant..." == u3 || "Just a moment..." == u3 || "Redirecting..." == u3)) throw new Error("Captcha error, please open in webview (or the website has changed url)");
              return [2, o2];
          }
        }));
      }));
      ...
      return (e2.match(/<article([^]*?)<\/article>/g) || []).forEach((function(e3) {
        var a2 = e3.match(/<a href="([^\"]*)".*? title="([^\"]*)"/) || [], s2 = a2[1], i2 = a2[2];
        if (i2 && s2) {
          var n2 = e3.match(/<img [^>]*?src="([^\"]*)"[^>]*?(?: data-src="([^\"]*)")?[^>]*>/) || [], o2 = void 0;
          if (s2.includes(t2.site)) o2 = s2.replace(t2.site, "");
          else {
            var u3 = s2.split("/");
            u3.shift(), u3.shift(), u3.shift(), o2 = u3.join("/");
          }
          l2.push({ name: i2, cover: n2[2] || n2[1] || r.defaultCover, path: o2 });
        }
      })), l2;
    }, u2.prototype.popularNovels = function(a2, l2) {
      return e(this, arguments, void 0, (function(e2, a3) {
        var l3, s2, i2, r2, n2, o2, u3, c, v, h = a3.filters, p = a3.showLatestNovels;
        return t(this, (function(t2) {
          switch (t2.label) {
            case 0:
              for (i2 in l3 = null !== (v = null === (c = this.options) || void 0 === c ? void 0 : c.seriesPath) && void 0 !== v ? v : "/series/", s2 = this.site + l3 + "?page=" + e2, h || (h = this.filters || {}), p && (s2 += "&order=latest"), h) if ("object" == typeof h[i2].value) for (r2 = 0, n2 = h[i2].value; r2 < n2.length; r2++) o2 = n2[r2], s2 += "&".concat(i2, "=").concat(o2);
              else h[i2].value && (s2 += "&".concat(i2, "=").concat(h[i2].value));
              return [4, this.safeFecth(s2, false)];
            case 1:
              return u3 = t2.sent(), [2, this.parseNovels(u3)];
          }
        }));
      }));
    }, u2.prototype.parseNovel = function(a2) {
      return e(this, void 0, void 0, (function() {
        var e2, s2, n2, u3, c, v, h, p, d, b, f, m, g, y, w, k, x, C, N, S, j;
        return t(this, (function(t2) {
          switch (t2.label) {
            case 0:
              return e2 = this.site, [4, this.safeFecth(e2 + a2, false)];
            case 1:
              return s2 = t2.sent(), n2 = { path: a2, name: "", genres: "", summary: "", author: "", artist: "", status: "", chapters: [] }, u3 = false, c = false, v = 0, h = false, p = false, d = false, b = false, f = false, m = false, g = false, y = 0, w = false, k = false, x = [], C = {}, N = this.hideLocked, S = new l.Parser({ onopentag: function(t3, a3) {
                var l2;
                !n2.cover && (null === (l2 = a3.class) || void 0 === l2 ? void 0 : l2.includes("ts-post-image")) ? (n2.name = a3.title, n2.cover = a3["data-src"] || a3.src || r.defaultCover) : "genxed" === a3.class || "sertogenre" === a3.class ? u3 = true : u3 && "a" === t3 ? c = true : "div" !== t3 || "entry-content" !== a3.class && "description" !== a3.itemprop ? "spe" === a3.class || "serl" === a3.class ? h = true : h && "span" === t3 ? p = true : "div" === t3 && "sertostat" === a3.class ? (h = true, p = true, f = true) : a3.class && a3.class.includes("eplister") ? m = true : m && "li" === t3 ? g = true : g ? "a" === t3 && void 0 === C.path ? C.path = a3.href.replace(e2, "").trim() : "epl-num" === a3.class ? y = 1 : "epl-title" === a3.class ? y = 2 : "epl-date" === a3.class ? y = 3 : "epl-price" === a3.class && (y = 4) : !v || "div" !== t3 && "script" !== t3 || v++ : v++;
              }, ontext: function(e3) {
                var t3, a3;
                if (u3) c && (n2.genres += e3 + ", ");
                  ...
                  if (1 === y) e3.includes("\u{1F512}") ? (w = true, k = true) : k && (w = false), o(e3, C);
                  else if (2 === y) C.name = (null === (a3 = null === (t3 = e3.match(RegExp("^".concat(n2.name.replace(/[.*+?^${}()|[\]\\]/g, "\\$&"), "\\s*(.+)")))) || void 0 === t3 ? void 0 : t3[1]) || void 0 === a3 ? void 0 : a3.trim()) || e3.trim(), C.chapterNumber || o(e3, C);
                ...
                var t3, a3, l2;
                u3 ? c ? c = false : (u3 = false, n2.genres = null === (t3 = n2.genres) || void 0 === t3 ? void 0 : t3.slice(0, -2)) : v ? "p" === e3 ? n2.summary += "\n\n" : "br" === e3 ? n2.summary += "\n" : "div" !== e3 && "script" !== e3 || v-- : h ? p ? "span" === e3 && (p = false, d && n2.author ? d = false : b && n2.artist ? b = false : f && "" !== n2.status && (f = false)) : "div" === e3 && (h = false, n2.author = null === (a3 = n2.author) || void 0 === a3 ? void 0 : a3.trim(), n2.artist = null === (l2 = n2.artist) || void 0 === l2 ? void 0 : l2.trim()) : m && (g ? 1 === y || 2 === y || 3 === y || 4 === y ? y = 0 : "li" === e3 && (g = false, C.chapterNumber || (C.chapterNumber = 0), w && (C.name = "\u{1F512} " + C.name), N && w || x.push(C), C = {}) : "ul" === e3 && (m = false));
              } }), S.write(s2), S.end(), x.length && ((null === (j = this.options) || void 0 === j ? void 0 : j.reverseChapters) && x.reverse(), n2.chapters = x), n2.summary = n2.summary.trim(), [2, n2];
          }
        }));
      }));
        ...
        return t(this, (function(t2) {
          switch (t2.label) {
            ...
            case 1:
              ...
              return [2, (null === (n2 = null === (r2 = e2.match(/<div.*?class="epcontent ([^]*?)<div.*?class="?bottomnav/g)) || void 0 === r2 ? void 0 : r2[0].match(/<p[^>]*>([^]*?)<\/p>/g)) || void 0 === n2 ? void 0 : n2.join("\n")) || ""];
          }
        }));
      }));
    }, u2.prototype.searchNovels = function(a2, l2) {
      return e(this, void 0, void 0, (function() {
        var e2, s2;
        return t(this, (function(t2) {
          switch (t2.label) {
  ...
  })())({ id: "lightnovelfr", sourceSite: "https://lightnovelfr.com/", sourceName: "Ligh Novel FR", options: { lang: "French", reverseChapters: true }, filters: { "genre[]": { type: "Checkbox", label: "Genre", value: [], options: [{ label: "action", value: "action" }, { label: "alchimie", value: "alchimie" }, { label: "Arts martiaux", value: "arts-martiaux" }, { label: "Aventure", value: "aventure" }, { label: "C\xE9l\xE9brit\xE9s", value: "celebrites" }, { label: "chinese", value: "chinese" }, { label: "Combat", value: "combat" }, { label: "comedie", value: "comedie" }, { label: "Cultivation", value: "cultivation" }, { label: "dark fantasy", value: "dark-fantasy" }, { label: "Demon", value: "demon" }, { label: "Drame", value: "drame" }, { label: "Fantasie", value: "fantasie" }, { label: "Fantastique", value: "fantastique" }, { label: "Guildes", value: "guildes" }, { label: "harem", value: "harem" }, { label: "Idole", value: "idole" }, { label: "japan", value: "japan" }, { label: "jeux vid\xE9os", value: "jeux-videos" }, { label: "Josei", value: "josei" }, { label: "korean", value: "korean" }, { label: "light Novel", value: "light-novel" }, { label: "Magic", value: "magic" }, { label: "mature", value: "mature" }, { label: "Myst\xE8re", value: "mystere" }, { label: "novel", value: "novel" }, { label: "Renaissance", value: "renaissance" }, { label: "Roman", value: "roman" }, { label: "romance", value: "romance" }, { label: "School life", value: "school-life" }, { label: "Science-fiction", value: "science-fiction" }, { label: "Seinen", value: "seinen" }, { label: "Shonen", value: "shonen" }, { label: "showbiz", value: "showbiz" }, { label: "Surnaturel", value: "surnaturel" }, { label: "syst\xE8me", value: "systeme" }, { label: "Syst\xE8me de niveau", value: "systeme-de-niveau" }, { label: "tranche de vie", value: "tranche-de-vie" }, { label: "webnovel", value: "webnovel" }, { label: "xp", value: "xp" }, { label: "Xuanhuan", value: "xuanhuan" }] }, "type[]": { type: "Checkbox", label: "Type", value: [], options: [{ label: "Korean", value: "korean" }, { label: "Light novel", value: "light-novel" }, { label: "novel chinois", value: "novel-chinois" }] }, status: { type: "Picker", label: "Statut", value: "", options: [{ label: "Tout", value: "" }, { label: "Ongoing", value: "ongoing" }, { label: "Hiatus", value: "hiatus" }, { label: "Completed", value: "completed" }] }, order: { type: "Picker", label: "Par ordre", value: "", options: [{ label: "Par d\xE9faut", value: "" }, { label: "A-Z", value: "title" }, { label: "Z-A", value: "titlereverse" }, { label: "Dernier mise \xE0 jour", value: "update" }, { label: "Derniers Ajouts", value: "latest" }, { label: "Populaire", value: "popular" }] } } });
  exports.default = u;
})();
