...
var LNReaderPlugin = (() => {
  ...
  // .js/plugins/french/MassNovel[madara].js
  ...
  var n = (init_fetch2(), __toCommonJS(fetch_exports)), r = (init_browser(), __toCommonJS(browser_exports)), i = (init_defaultCover(), __toCommonJS(defaultCover_exports)), l = (init_novelStatus(), __toCommonJS(novelStatus_exports)), o = a(require_dayjs_min()), s = (init_storage2(), __toCommonJS(storage_exports)), u = function(e2, t2) {
    ...
    return a2.prototype.translateDragontea = function(e2) {
      ...
      return e(this, void 0, void 0, (function() {
        var e2, s2, u2, c2, h, p, v, m, d = this;
        return t(this, (function(t2) {
          switch (t2.label) {
            case 0:
            ...
            case 5:
              return "0" !== c2 && (e2 = (0, r.load)(c2)), v = e2(".wp-manga-chapter").length, e2(".wp-manga-chapter").each((function(t3, a4) {
                ...
                !l2 || "#" == l2 || r2 && d.hideLocked || u2.push({ name: n2, path: l2.replace(/https?:\/\/.*?\//, "/"), releaseTime: i2 || null, chapterNumber: v - t3 });
  ...
  })())({ id: "massnovel", sourceSite: "https://massnovel.fr/", sourceName: "MassNovel", options: { lang: "French", useNewChapterEndpoint: true }, filters: { "genre[]": { type: "Checkbox", label: "Genre", value: [], options: [{ label: "action", value: "action" }, { label: "Adulte", value: "adulte" }, { label: "adventure", value: "adventure" }, { label: "Alchimie", value: "alchimie" }, { label: "Arts Martiaux", value: "arts-martiaux" }, { label: "boys", value: "boys" }, { label: "chinese", value: "chinese" }, { label: "Com\xE9die", value: "comedie" }, { label: "Cultivation", value: "cultivation" }, { label: "drama", value: "drama" }, { label: "Eastern", value: "eastern" }, { label: "ecchi", value: "ecchi" }, { label: "Fantasy", value: "fantasy" }, { label: "fighting", value: "fighting" }, { label: "fun", value: "fun" }, { label: "Games", value: "games" }, { label: "General", value: "general" }, { label: "girl", value: "girl" }, { label: "Harem", value: "harem" }, { label: "History", value: "history" }, { label: "Horror", value: "horror" }, { label: "horrow", value: "horrow" }, { label: "Idole", value: "idole" }, { label: "Isekai", value: "isekai" }, { label: "Jeux-vid\xE9os", value: "jeux-videos" }, { label: "LGBT+", value: "lgbt" }, { label: "Male Lead", value: "male-lead" }, { label: "manhwa", value: "manhwa" }, { label: "Mature", value: "mature" }, { label: "Mecha", value: "mecha" }, { label: "Myst\xE8re", value: "mystere" }, { label: "Paranormal", value: "paranormal" }, { label: "Psychologique", value: "psychologique" }, { label: "Realistic", value: "realistic" }, { label: "R\xE9incarnation", value: "reincarnation" }, { label: "Romance", value: "romance" }, { label: "School-Life", value: "school-life" }, { label: "Sci-fi", value: "sci-fi" }, { label: "Seinen", value: "seinen" }, { label: "Shounen", value: "shounen" }, { label: "Slice of Life", value: "slice-of-life" }, { label: "Smut", value: "smut" }, { label: "Sports", value: "sports" }, { label: "Surnaturel", value: "surnaturel" }, { label: "Teen", value: "teen" }, { label: "Trag\xE9die", value: "tragedie" }, { label: "Urban", value: "urban" }, { label: "War", value: "war" }, { label: "Wuxia&Xianxia", value: "wuxiaxianxia" }, { label: "Xuanhuan", value: "xuanhuan" }, { label: "Yaoi", value: "yaoi" }] }, op: { type: "Switch", label: "having all selected genres", value: false }, author: { type: "Text", label: "Author", value: "" }, artist: { type: "Text", label: "Artist", value: "" }, release: { type: "Text", label: "Year of Released", value: "" }, adult: { type: "Picker", label: "Adult content", value: "", options: [{ label: "All", value: "" }, { label: "None adult content", value: "0" }, { label: "Only adult content", value: "1" }] }, "status[]": { type: "Checkbox", label: "Status", value: [], options: [{ label: "OnGoing", value: "on-going" }, { label: "Completed", value: "end" }, { label: "Canceled", value: "canceled" }, { label: "On Hold", value: "on-hold" }, { label: "Upcoming", value: "upcoming" }] }, m_orderby: { type: "Picker", label: "Order by", value: "", options: [{ label: "Relevance", value: "" }] } } });
  exports.default = c;
})();
