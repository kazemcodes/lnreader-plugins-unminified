...
var LNReaderPlugin = (() => {
  ...
  var SakuraNovel = (
    ...
    function() {
      ...
      __name(SakuraNovel2, "SakuraNovel");
      SakuraNovel2.prototype.parseNovels = function(loadedCheerio) {
        var _this = this;
        var novels = [];
        loadedCheerio(".flexbox2-item").each(function(i, el) {
          var novelName = loadedCheerio(el).find(".flexbox2-title span").first().text();
          var novelCover = loadedCheerio(el).find("img").attr("src");
          var novelUrl = loadedCheerio(el).find(".flexbox2-content > a").attr("href");
          if (!novelUrl)
            return;
          novels.push({
            name: novelName,
      ...
      SakuraNovel2.prototype.popularNovels = function(page_1, _a) {
            ...
            switch (_c.label) {
              case 0:
                ...
                if (filters.lang.value.length)
                  link += filters.lang.value.map(function(i) {
                    return "&country[]=".concat(i);
                  }).join("");
                if (filters.genre.value.length)
                  link += filters.genre.value.map(function(i) {
                    return "&genre[]=".concat(i);
                  }).join("");
      ...
      SakuraNovel2.prototype.parseNovel = function(novelPath) {
          ...
          return __generator(this, function(_c) {
            switch (_c.label) {
              ...
              case 2:
                ...
                novel.genres = loadedCheerio(".series-genres").children("a").map(function(i, el) {
                ...
                chapterTitle = novel.name.replace(/\(LN\)|\(WN\)/, "").split(",")[0].trim();
                chapter = [];
                loadedCheerio(".series-flexright li").each(function(i, el) {
                  var chapterName = loadedCheerio(el).find("a span").first().text().replace(chapterTitle, "").replace(imageTitle, "").replace(/Bahasa Indonesia/, "").replace(/\s+/g, " ").trim();
                  var releaseDate = loadedCheerio(el).find(".date").text().trim().split("/").map(function(x) {
                    return Number(x);
                  });
      ...
      SakuraNovel2.prototype.parseChapter = function(chapterPath) {
        return __awaiter(this, void 0, void 0, function() {
          ...
          return __generator(this, function(_a) {
            switch (_a.label) {
              ...
              case 2:
                body = _a.sent();
                loadedCheerio = (0, cheerio_1.load)(body);
                divi = loadedCheerio("div:contains('Daftar Isi') +").find("div:first").attr("class");
      ...
      SakuraNovel2.prototype.searchNovels = function(searchTerm, page) {
        return __awaiter(this, void 0, void 0, function() {
