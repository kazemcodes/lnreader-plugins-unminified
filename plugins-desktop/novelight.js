...
var LNReaderPlugin = (() => {
  ...
  var Novelight = (
    ...
    function() {
      ...
      __name(Novelight2, "Novelight");
      Novelight2.prototype.popularNovels = function(page) {
            ...
            switch (_a.label) {
              ...
              case 1:
                ...
                loadedCheerio("a.item").each(function(idx, ele) {
                  ...
                  var novelCover = bareNovelCover ? _this.site + bareNovelCover : defaultCover_1.defaultCover;
                  if (!novelUrl)
                    return;
                  var novel = {
                    name: novelName,
      ...
      Novelight2.prototype.parseNovel = function(novelPath) {
        return __awaiter(this, void 0, void 0, function() {
            ...
            switch (_a.label) {
              ...
              case 1:
                ...
                for (_i = 0, info_1 = info; _i < info_1.length; _i++) {
                  ...
                  if (type === "Genres") {
                    novel.genres = loadedCheerio(child).find("div.info > a").map(function(i, el) {
      ...
      Novelight2.prototype.parsePage = function(novelPath, page) {
        return __awaiter(this, void 0, void 0, function() {
          ...
          return __generator(this, function(_g) {
            switch (_g.label) {
              ...
              case 1:
                ...
                return [4, (0, fetch_1.fetchApi)("".concat(this.site, "/book/ajax/chapter-pagination?csrfmiddlewaretoken=").concat(csrftoken, "&book_id=").concat(bookId, "&page=").concat(totalPages - parseInt(page) + 1), {
                  headers: {
              ...
              case 2:
                ...
                (0, cheerio_1.load)("<html>" + chaptersRaw + "</html>")("a").each(function(idx, ele) {
                  var title2 = (0, cheerio_1.load)(ele)(".title").text().trim();
                  ...
                  var chapterName = isLocked ? "\u{1F512} " + title2 : title2;
      ...
      Novelight2.prototype.parseChapter = function(chapterPath) {
        return __awaiter(this, void 0, void 0, function() {
          ...
          return __generator(this, function(_c) {
            switch (_c.label) {
              ...
              case 1:
                ...
                return [4, (0, fetch_1.fetchApi)(this.site + "book/ajax/read-chapter/" + chapterId, {
                  method: "GET",
                  headers: {
              ...
              case 2:
                ...
                return [2, chapterText.replace(/class="advertisment"/g, 'style="display:none;"')];
            }
          });
        });
      };
      Novelight2.prototype.searchNovels = function(searchTerm) {
        return __awaiter(this, void 0, void 0, function() {
          var url, body, loadedCheerio, novels;
          var _this = this;
          return __generator(this, function(_a) {
