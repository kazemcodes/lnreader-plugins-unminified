...
var LNReaderPlugin = (() => {
  ...
  var EarlyNovelPlugin = (
    /** @class */
    function() {
      function EarlyNovelPlugin2() {
        this.id = "earlynovel";
      ...
      __name(EarlyNovelPlugin2, "EarlyNovelPlugin");
      EarlyNovelPlugin2.prototype.parseNovels = function(loadedCheerio) {
        var novels = [];
      ...
      EarlyNovelPlugin2.prototype.parseChapters = function(loadedCheerio) {
        var chapter = [];
      ...
      EarlyNovelPlugin2.prototype.popularNovels = function(pageNo_1, _a) {
      ...
      EarlyNovelPlugin2.prototype.parseNovel = function(novelPath) {
            ...
            switch (_b.label) {
              ...
              case 2:
                ...
                loadedCheerio(".info > div > h3").each(function() {
                  ...
                  var detail = loadedCheerio(this).siblings().map(function(i, el) {
      ...
      EarlyNovelPlugin2.prototype.parsePage = function(novelPath, page) {
        return __awaiter(this, void 0, void 0, function() {
      ...
      EarlyNovelPlugin2.prototype.parseChapter = function(chapterPath) {
        return __awaiter(this, void 0, void 0, function() {
      ...
      EarlyNovelPlugin2.prototype.searchNovels = function(searchTerm) {
        return __awaiter(this, void 0, void 0, function() {
