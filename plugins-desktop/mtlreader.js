...
var LNReaderPlugin = (() => {
  ...
  var MTLReader = (
    ...
    function() {
      ...
      __name(MTLReader2, "MTLReader");
      MTLReader2.prototype.parseNovels = function(loadedCheerio) {
        var _this = this;
        var novels = [];
      ...
      MTLReader2.prototype.popularNovels = function(pageNo) {
      ...
      MTLReader2.prototype.parseNovel = function(novelPath) {
        return __awaiter(this, void 0, void 0, function() {
          ...
          return __generator(this, function(_a) {
            switch (_a.label) {
              ...
              case 1:
                ...
                novel.author = loadedCheerio("i.fa-user").parent().text().replace("Author: ", "").trim();
                chapter = [];
      ...
      MTLReader2.prototype.parseChapter = function(chapterPath) {
        return __awaiter(this, void 0, void 0, function() {
      ...
      MTLReader2.prototype.searchNovels = function(searchTerm) {
        return __awaiter(this, void 0, void 0, function() {
          var body, tokenCheerio, token, searchUrl, seacrhBody, loadedCheerio;
          return __generator(this, function(_a) {
            switch (_a.label) {
              case 0:
                return [4, (0, fetch_1.fetchApi)(this.site).then(function(r) {
                  return r.text();
                })];
              case 1:
                body = _a.sent();
