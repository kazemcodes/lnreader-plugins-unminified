...
var LNReaderPlugin = (() => {
  ...
  var KomgaPlugin = (
    ...
    function() {
      ...
      __name(KomgaPlugin2, "KomgaPlugin");
      KomgaPlugin2.prototype.makeRequest = function(url) {
      ...
      KomgaPlugin2.prototype.btoa = function(input) {
        if (input === void 0) {
          input = "";
        }
        ...
        var str = input;
        var output = "";
        for (var block = 0, charCode = void 0, i = 0, map2 = chars; str.charAt(i | 0) || (map2 = "=", i % 1); output += map2.charAt(63 & block >> 8 - i % 1 * 8)) {
      ...
      KomgaPlugin2.prototype.flattenArray = function(arr) {
        var _this = this;
        return arr.reduce(function(acc, obj) {
          var children2 = obj.children, rest = __rest(obj, ["children"]);
          acc.push(rest);
          if (children2) {
            acc.push.apply(acc, _this.flattenArray(children2));
          }
          return acc;
        }, []);
      };
      KomgaPlugin2.prototype.getSeries = function(url) {
        return __awaiter(this, void 0, void 0, function() {
      ...
      KomgaPlugin2.prototype.popularNovels = function(pageNo_1, _a) {
        return __awaiter(this, arguments, void 0, function(pageNo, _b) {
          ...
          return __generator(this, function(_c) {
            switch (_c.label) {
              case 0:
                read_status = (filters === null || filters === void 0 ? void 0 : filters.read_status.value) ? "&read_status=" + (filters === null || filters === void 0 ? void 0 : filters.read_status.value) : "";
                status = (filters === null || filters === void 0 ? void 0 : filters.status.value) ? "&status=" + (filters === null || filters === void 0 ? void 0 : filters.status.value) : "";
      ...
      KomgaPlugin2.prototype.parseNovel = function(novelPath) {
        return __awaiter(this, void 0, void 0, function() {
          ...
          return __generator(this, function(_d) {
            switch (_d.label) {
              ...
              case 1:
                ...
                novel.author = series.booksMetadata.authors.filter(function(author) {
                ...
                chapters = [];
                return [4, this.makeRequest(this.site + "api/v1/series/".concat(series.id, "/books?unpaged=true"))];
              case 2:
                ...
                _d.label = 3;
              case 3:
                if (!(_i < booksData_1.length)) return [3, 6];
                book = booksData_1[_i];
                return [4, this.makeRequest(this.site + "opds/v2/books/".concat(book.id, "/manifest"))];
              case 4:
                ...
                _loop_1 = /* @__PURE__ */ __name(function(page2) {
                  var tocItem = toc.find(function(v) {
                    var _a2;
                    return ((_a2 = v.href) === null || _a2 === void 0 ? void 0 : _a2.split("#")[0]) === page2.href;
                  });
                  var title2 = tocItem ? tocItem.title : null;
                  chapters.push({
                    name: "".concat(i, "/").concat(bookManifest.readingOrder.length, " - ").concat(book.metadata.title).concat(title2 ? " - " + title2 : ""),
                    path: "opds/v2" + ((_c = page2.href) === null || _c === void 0 ? void 0 : _c.split("opds/v2").pop())
                  });
                  i++;
                }, "_loop_1");
      ...
      KomgaPlugin2.prototype.parseChapter = function(chapterPath) {
        return __awaiter(this, void 0, void 0, function() {
          var chapterText;
          return __generator(this, function(_a) {
            switch (_a.label) {
              case 0:
                return [4, this.makeRequest(this.site + chapterPath)];
              case 1:
                chapterText = _a.sent();
                return [2, this.addUrlToImageHref(chapterText, this.site + chapterPath.split("/").slice(0, -1).join("/") + "/")];
            }
          });
        });
      };
      KomgaPlugin2.prototype.addUrlToImageHref = function(htmlString, baseUrl) {
        var $2 = (0, cheerio_1.load)(htmlString, { xmlMode: true });
        $2("svg image").each(function(_, image) {
          var href = $2(image).attr("href") || $2(image).attr("xlink:href");
          var width = $2(image).attr("width");
          var height = $2(image).attr("height");
          if (href) {
            var img = $2("<img />").attr({
            ...
            $2(image).closest("svg").replaceWith(img);
          }
        });
        $2("img").each(function(_, img) {
          var src = $2(img).attr("src");
          if (src && !src.startsWith("http")) {
            $2(img).attr("src", "".concat(baseUrl).concat(src));
          }
        });
        $2("a").each(function(_, a) {
          $2(a).replaceWith($2(a).text());
        });
        return $2.xml();
      };
      KomgaPlugin2.prototype.searchNovels = function(searchTerm, pageNo) {
        return __awaiter(this, void 0, void 0, function() {
          var url;
          return __generator(this, function(_a) {
            switch (_a.label) {
