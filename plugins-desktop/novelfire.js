...
var LNReaderPlugin = (() => {
  ...
  var require_node = __commonJS({
    "node_modules/domhandler/lib/node.js"(exports4) {
      ...
      init_buffer2();
      init_process2();
      var __extends2 = exports4 && exports4.__extends || /* @__PURE__ */ function() {
  ...
  var NovelFire = (
    ...
    function() {
      ...
      __name(NovelFire2, "NovelFire");
      NovelFire2.prototype.getCheerio = function(url, search) {
      ...
      NovelFire2.prototype.popularNovels = function(pageNo_1, _a) {
          ...
          return __generator(this, function(_f) {
            switch (_f.label) {
              case 0:
                ...
                return [4, this.getCheerio(url, false)];
              case 1:
                loadedCheerio = _f.sent();
                return [2, loadedCheerio(".novel-item").map(function(index2, ele) {
                  var novelName = loadedCheerio(ele).find(".novel-title > a").attr("title") || "No Title Found";
                  var novelCover = loadedCheerio(ele).find(".novel-cover > img").attr("data-src");
                  var novelPath = loadedCheerio(ele).find(".novel-title > a").attr("href");
                  if (!novelPath)
                    return null;
                  return {
                    name: novelName,
      ...
      NovelFire2.prototype.parseChapters = function(novelPath, pages) {
        return __awaiter(this, void 0, void 0, function() {
          ...
          return __generator(this, function(_a) {
            switch (_a.label) {
              case 0:
                pagesArray = Array.from({ length: pages }, function(_, i2) {
                  return i2 + 1;
                });
                allChapters = [];
                parsePage = /* @__PURE__ */ __name(function(page) {
                  return __awaiter(_this, void 0, void 0, function() {
                    var url, result, body, loadedCheerio, chapters2;
                    var _this2 = this;
                    return __generator(this, function(_a2) {
                      switch (_a2.label) {
                        ...
                        case 2:
                          ...
                          chapters2 = loadedCheerio(".chapter-list li").map(function(index2, ele) {
                            ...
                            return {
                              name: chapterName,
                              path: chapterPath.replace(_this2.site, "")
                            };
                ...
                _a.label = 1;
              case 1:
                if (!(i < pagesArray.length)) return [3, 11];
                ...
                _a.label = 2;
              case 2:
                if (!(attempt < retryCount)) return [3, 10];
                _a.label = 3;
              case 3:
                _a.trys.push([3, 5, , 9]);
                return [4, Promise.all(pagesArrayChunk.map(parsePage))];
              case 4:
              ...
              case 5:
                err_1 = _a.sent();
                if (!(err_1 instanceof NovelFireThrottlingError)) return [3, 7];
                attempt += 1;
              ...
              case 11:
                ...
                return [2, allChapters.length === 0 ? [] : allChapters];
            }
          });
        });
      };
      NovelFire2.prototype.parseNovel = function(novelPath) {
        return __awaiter(this, void 0, void 0, function() {
          var $2, baseUrl, novel, coverUrl, summary, rawStatus, map2, totalChapters, pages, _a;
          var _b, _c, _d, _e;
          return __generator(this, function(_f) {
            switch (_f.label) {
              case 0:
              ...
              case 1:
                ...
                novel.name = (_c = (_b = $2(".novel-title").text().trim()) !== null && _b !== void 0 ? _b : $2(".cover > img").attr("alt")) !== null && _c !== void 0 ? _c : "No Titled Found";
                coverUrl = (_d = $2(".cover > img").attr("data-src")) !== null && _d !== void 0 ? _d : $2(".cover > img").attr("src");
                if (coverUrl) {
                  novel.cover = new URL(coverUrl, baseUrl).href;
                }
                novel.genres = $2(".categories .property-item").map(function(i, el) {
                  return $2(el).text();
                }).toArray().join(",");
                summary = $2(".summary .content").text().trim();
                if (summary) {
                ...
                novel.author = $2(".author .property-item > span").text() || "No Author Found";
                rawStatus = $2(".header-stats .ongoing").text() || $2(".header-stats .completed").text() || "Unknown";
                map2 = {
                ...
                novel.status = (_e = map2[rawStatus.toLowerCase()]) !== null && _e !== void 0 ? _e : novelStatus_1.NovelStatus.Unknown;
                totalChapters = $2(".header-stats .icon-book-open").parent().text().trim();
                pages = Math.ceil(parseInt(totalChapters) / 100);
                _a = novel;
                return [4, this.parseChapters(novelPath, pages)];
              case 2:
                _a.chapters = _f.sent();
                return [2, novel];
            }
      ...
      NovelFire2.prototype.parseChapter = function(chapterPath) {
        return __awaiter(this, void 0, void 0, function() {
            ...
            switch (_a.label) {
              ...
              case 2:
                ...
                bloatElements = [
                  ...
                  ".box-notification",
                  /^nf/
                  // Regular expression to match tags starting with 'nf'
                ];
                bloatElements.forEach(function(tag) {
                  if (tag instanceof RegExp) {
                    loadedCheerio("*").filter(function(_, el) {
                ...
                return [2, loadedCheerio("#content").html()];
            }
          });
        });
      };
      NovelFire2.prototype.searchNovels = function(searchTerm, page) {
        return __awaiter(this, void 0, void 0, function() {
          ...
          return __generator(this, function(_a) {
            switch (_a.label) {
              ...
              case 2:
                body = _a.sent();
                loadedCheerio = (0, cheerio_1.load)(body);
                return [2, loadedCheerio(".novel-list.chapters .novel-item").map(function(index2, ele) {
                  var novelName = loadedCheerio(ele).find("a").attr("title") || "No Title Found";
                  var novelCover = loadedCheerio(ele).find(".novel-cover > img").attr("src");
  ...
  var NovelFireThrottlingError = (
    /** @class */
    function(_super) {
      __extends(NovelFireThrottlingError2, _super);
      function NovelFireThrottlingError2(message) {
        if (message === void 0) {
          message = "Novel Fire is rate limiting requests";
        }
        var _this = _super.call(this, message) || this;
        _this.name = "NovelFireError";
        return _this;
      }
      __name(NovelFireThrottlingError2, "NovelFireThrottlingError");
      return NovelFireThrottlingError2;
    }(Error)
  );
})();
