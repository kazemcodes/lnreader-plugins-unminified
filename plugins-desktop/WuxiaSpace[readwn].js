...
var LNReaderPlugin = (() => {
  ...
  var ReadwnPlugin = (
    ...
    function() {
      ...
      ReadwnPlugin2.prototype.popularNovels = function(pageNo_1, _a) {
            ...
            switch (_b.label) {
              ...
              case 1:
                ...
                novel.genres = loadedCheerio("div.categories > ul > li").map(function(index2, element) {
                  var _a2;
                  return (_a2 = loadedCheerio(element).text()) === null || _a2 === void 0 ? void 0 : _a2.trim();
                }).get().join(",");
                ...
                chapters = loadedCheerio(".chapter-list li").map(function(chapterIndex, element) {
                  ...
                  var path = (_a2 = loadedCheerio(element).find("a").attr("href")) === null || _a2 === void 0 ? void 0 : _a2.trim();
                  if (!name || !path)
                    return null;
  ...
  var plugin = new ReadwnPlugin({ "id": "wuxiaspace", "sourceSite": "https://www.wuxiaspot.com", "sourceName": "Wuxia Space", "options": { "versionIncrements": 1 } });
