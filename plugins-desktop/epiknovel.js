...
var LNReaderPlugin = (() => {
  ...
  var EpikNovel = (
    ...
    function() {
      ...
      __name(EpikNovel2, "EpikNovel");
      EpikNovel2.prototype.popularNovels = function(pageNo) {
      ...
      EpikNovel2.prototype.parseNovel = function(novelPath) {
        return __awaiter(this, void 0, void 0, function() {
          ...
          return __generator(this, function(_a) {
            switch (_a.label) {
              ...
              case 2:
                ...
                novel.summary = loadedCheerio("#wrapper > div.row > div.col-md-9 > div:nth-child(6) > p:nth-child(3)").text().trim();
                novel.status = loadedCheerio("#wrapper > div.row > div.col-md-9 > div.row > div.col-md-9 > h4:nth-child(3) > a").text().trim();
                novel.author = loadedCheerio("#NovelInfo > p:nth-child(4)").text().replace(/Publisher:|\s/g, "").trim();
                novelChapters = [];
                loadedCheerio("table").find("tr").first().remove();
                loadedCheerio("table").find("tr").each(function(idx, ele) {
                  ...
                  var chapterUrl = loadedCheerio(ele).find(" td:nth-child(1) > a").attr("href");
                  if (!chapterUrl)
                    return;
                  novelChapters.push({
                    name: chapterName,
      ...
      EpikNovel2.prototype.parseChapter = function(chapterPath) {
        return __awaiter(this, void 0, void 0, function() {
      ...
      EpikNovel2.prototype.searchNovels = function(searchTerm, pageNo) {
        return __awaiter(this, void 0, void 0, function() {
          var url, result, body, loadedCheerio, novels;
          var _this = this;
          return __generator(this, function(_a) {
