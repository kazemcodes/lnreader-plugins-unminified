...
var LNReaderPlugin = (() => {
  ...
  var NovelHall = (
    ...
    function() {
      ...
      __name(NovelHall2, "NovelHall");
      NovelHall2.prototype.popularNovels = function(page) {
      ...
      NovelHall2.prototype.parseNovel = function(novelPath) {
        return __awaiter(this, void 0, void 0, function() {
          ...
          return __generator(this, function(_a) {
            switch (_a.label) {
              ...
              case 1:
                ...
                novel.author = loadedCheerio('.total span:contains("Author")').text().replace("Author\uFF1A", "").trim();
                novel.status = loadedCheerio('.total span:contains("Status")').text().replace("Status\uFF1A", "").replace("Active", "Ongoing").trim();
                novel.genres = loadedCheerio(".total a").map(function(a, ex) {
      ...
      NovelHall2.prototype.parseChapter = function(chapterPath) {
        return __awaiter(this, void 0, void 0, function() {
          ...
          return __generator(this, function(_a) {
            switch (_a.label) {
              ...
              case 1:
                body = _a.sent();
                loadedCheerio = (0, cheerio_1.load)(body);
                chapterText = loadedCheerio("#htmlContent").html() || "";
                return [2, chapterText];
            }
          });
        });
      };
      NovelHall2.prototype.searchNovels = function(searchTerm) {
        return __awaiter(this, void 0, void 0, function() {
          var url, body, loadedCheerio, novels;
          return __generator(this, function(_a) {
            switch (_a.label) {
              ...
              case 1:
                ...
                loadedCheerio("table tr").each(function(idx, ele) {
                  var novelName = loadedCheerio(ele).find("td:nth-child(2)").text().replace(/\t+/g, "").replace(/\n/g, " ");
                  var novelUrl = loadedCheerio(ele).find("td:nth-child(2) a").attr("href");
                  if (!novelUrl)
                    return;
                  var novel = {
                    name: novelName,
