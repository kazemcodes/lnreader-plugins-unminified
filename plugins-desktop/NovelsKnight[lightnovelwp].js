...
var LNReaderPlugin = (() => {
  ...
  // .js/plugins/english/NovelsKnight[lightnovelwp].js
  init_dirname();
  init_buffer2();
  init_process2();
            ...
            switch (_d.label) {
              ...
              case 1:
                ...
                if ((_a = this.options) === null || _a === void 0 ? void 0 : _a.customJs) {
                  try {
                    $_1 = (0, cheerio_1.load)(data2);
                    $_1(".announ").remove();
                    return [2, $_1(".epcontent").eq(-1).find("p").map(function(i, el) {
                      return "<p>" + $_1(this).text() + "</p>";
                    }).toArray().join("\n") || ""];
                    data2 = $_1.html();
                  } catch (error) {
