...
var LNReaderPlugin = (() => {
  ...
  var KissWoodPlugin = (
    ...
    function() {
      ...
      __name(KissWoodPlugin2, "KissWoodPlugin");
      KissWoodPlugin2.prototype.getCheerio = function(url) {
      ...
      KissWoodPlugin2.prototype.getNovelsCovers = function(novels, listUrlCover) {
        return __awaiter(this, void 0, void 0, function() {
          var _this = this;
          return __generator(this, function(_a) {
            switch (_a.label) {
              case 0:
                return [4, Promise.all(novels.map(function(novel, index2) {
                  return __awaiter(_this, void 0, void 0, function() {
                    var urlCover, _a2, _b;
                    return __generator(this, function(_c) {
                      switch (_c.label) {
                        case 0:
                          urlCover = listUrlCover[index2];
                          if (!urlCover) return [3, 2];
                          _a2 = novel;
                          _b = this.findCoverImage;
                          return [4, this.getCheerio(urlCover)];
                        case 1:
                          _a2.cover = _b.apply(this, [_c.sent()]);
                          _c.label = 2;
                        case 2:
                          return [
                            2
      ...
      KissWoodPlugin2.prototype.getNovelInfo = function(novel, url) {
        return __awaiter(this, void 0, void 0, function() {
          var $2, textArray, index2;
          return __generator(this, function(_a) {
            switch (_a.label) {
              case 0:
              ...
              case 1:
                $2 = _a.sent();
                textArray = $2(".entry-content p").map(function(_, element) {
                  return $2(element).text().trim();
                }).get().join("\n").split("\n");
                index2 = textArray.findIndex(function(element) {
                  return [
                    "Traducteur Anglais- Fran\xE7ais",
                    "Titre en fran\xE7ais",
                    "\u2014\u2014\u2014",
                    "Titre :",
                ...
                novel.summary = (index2 !== -1 ? textArray.slice(0, index2) : textArray).join("\n").replace("Synopsis :", "");
                novel.author = this.extractInfo(textArray.join("\n"), this.regexAuthors);
                novel.cover = this.findCoverImage($2);
                return [2, novel];
            }
          });
        });
      };
      KissWoodPlugin2.prototype.findCoverImage = function($2) {
        return $2("div p img").first().attr("src") || $2("figure a img").first().attr("src") || $2("figure img").first().attr("src") || defaultCover_1.defaultCover;
      };
      KissWoodPlugin2.prototype.extractInfo = function(text3, regexes) {
        for (var _i = 0, regexes_1 = regexes; _i < regexes_1.length; _i++) {
          var regex = regexes_1[_i];
          var match = regex.exec(text3);
          if (match !== null) {
            return match[1].trim();
          }
        }
      ...
      KissWoodPlugin2.prototype.popularNovels = function(pageNo) {
        return __awaiter(this, void 0, void 0, function() {
          var novels, $2, listUrlCover;
          var _this = this;
          return __generator(this, function(_a) {
            switch (_a.label) {
              case 0:
                if (pageNo > 1)
                  return [2, []];
                novels = [];
                return [4, this.getCheerio(this.site)];
              case 1:
                $2 = _a.sent();
                listUrlCover = [];
                $2("nav div div ul li ul li").each(function(i, elem) {
                  if ($2(elem).text().trim() === "Sommaire") {
                    var novelName = $2(elem).closest("ul").siblings("a").first().text().trim();
                    var novelUrl = $2(elem).find("a").attr("href");
                    if (novelUrl && novelName) {
                      var urlCover = $2(elem).parent().find("a").attr("href");
                      if (urlCover) {
                ...
                return [4, this.getNovelsCovers(novels, listUrlCover)];
              case 2:
                return [2, _a.sent()];
            }
          });
      ...
      KissWoodPlugin2.prototype.parseNovel = function(novelPath) {
        return __awaiter(this, void 0, void 0, function() {
          var novel, $2, novelUrl, chapterSelectors, chapters;
          var _this = this;
          return __generator(this, function(_a) {
            switch (_a.label) {
              case 0:
              ...
              case 1:
                ...
                novelUrl = null;
                $2("nav div div ul li ul li").each(function(i, elem) {
                  if ($2(elem).find("a").attr("href") === _this.site + novelPath) {
                    novelUrl = $2(elem).parent().find("a").first().attr("href");
                    novel.name = $2(elem).closest("ul").siblings("a").first().text().trim();
                    return;
                  }
                });
                if (!novelUrl) return [3, 3];
                return [4, this.getNovelInfo(novel, novelUrl)];
              case 2:
                novel = _a.sent();
                _a.label = 3;
              case 3:
                ...
                chapters = [];
                $2(chapterSelectors).each(function(i, elem) {
                  var _a2;
                  var chapterName = $2(elem).text().trim();
                  var chapterUrl = (_a2 = $2(elem).attr("href")) === null || _a2 === void 0 ? void 0 : _a2.replace("http://", "https://");
                  if (chapterUrl && chapterName && chapterUrl.includes(_this.site) && // We remove the unnecessary links to Facebook, X, and the homepage from the chapters.
                  !chapterUrl.includes("share=facebook") && !chapterUrl.includes("share=x") && !chapterUrl.includes("/category/traductions/") && !chapterUrl.includes("/category/tour-des-mondes/") && // Removal of duplicates
                  !chapters.some(function(chapter) {
                    return _this.site + chapter.path === chapterUrl;
                  })) {
                    chapters.push({
                      name: chapterName,
      ...
      KissWoodPlugin2.prototype.parseChapter = function(chapterPath) {
        return __awaiter(this, void 0, void 0, function() {
          var $2, elements, hrIndexes;
          return __generator(this, function(_a) {
            switch (_a.label) {
              case 0:
                return [4, this.getCheerio(this.site + chapterPath)];
              case 1:
                $2 = _a.sent();
                elements = $2(".entry-content").contents().map(function(_, el) {
                  return $2.html(el);
                }).get();
                hrIndexes = elements.map(function(elem, index2) {
                  return elem.includes("<hr>") ? index2 : -1;
                ...
                if (hrIndexes.length === 0) {
                  hrIndexes = [
                    ...
                    elements.findIndex(function(element) {
                      return element.includes("https://fr.tipeee.com/kisswood/") || element.includes(">Sommaire</a>") || element.includes(">Chapitre Suivant</a>") || element.includes("\u2014\u2014\u2014\u2014\u2014\u2014\u2014\u2014\u2014\u2014\u2014\u2014\u2014\u2014\u2014\u2014\u2014\u2014\u2014\u2014\u2014\u2014\u2014\u2014\u2014\u2014\u2014-") || element.includes("share=facebook");
                    })
                  ];
                ...
                return [2, elements.slice(hrIndexes[0], hrIndexes[1]).join("\n")];
            }
          });
        });
      };
      KissWoodPlugin2.prototype.searchNovels = function(searchTerm, pageNo) {
        return __awaiter(this, void 0, void 0, function() {
          ...
          return __generator(this, function(_a) {
            switch (_a.label) {
              case 0:
                ...
                return [4, popularNovels];
              case 1:
                novels = _a.sent().filter(function(novel) {
                  return novel.name.toLowerCase().normalize("NFD").replace(/[\u0300-\u036f]/g, "").trim().includes(searchTerm.toLowerCase().normalize("NFD").replace(/[\u0300-\u036f]/g, "").trim());
                });
                return [2, novels];
            }
          });
