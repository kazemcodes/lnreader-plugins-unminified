...
var LNReaderPlugin = (() => {
  ...
  var TruyenFull = (
    ...
    function() {
      function TruyenFull2() {
        ...
        this.filters = {
          status: {
            ...
            label: "T\xECnh tr\u1EA1ng",
            value: [],
            options: [{ label: "\u0110\xE3 ho\xE0n th\xE0nh", value: "hoan" }]
          },
          sort: {
            ...
            options: [
              ...
              { label: "Ti\xEAn hi\u1EC7p hay", value: "tien-hiep-hay" },
              { label: "Ki\u1EBFm hi\u1EC7p hay", value: "kiem-hiep-hay" },
              { label: "Truy\u1EC7n teen hay", value: "truyen-teen-hay" },
              { label: "Ng\xF4n t\xECnh hay", value: "ngon-tinh-hay" },
              { label: "Ng\xF4n t\xECnh ng\u01B0\u1EE3c", value: "ngon-tinh-nguoc" },
              { label: "Ng\xF4n t\xECnh s\u1EE7ng", value: "ngon-tinh-sung" },
              { label: "Ng\xF4n t\xECnh h\xE0i", value: "ngon-tinh-hai" },
              { label: "\u0110am m\u1EF9 hay", value: "dam-my-hay" },
              { label: "\u0110am m\u1EF9 h\xE0i", value: "dam-my-hai" },
      ...
      __name(TruyenFull2, "TruyenFull");
      TruyenFull2.prototype.parseNovels = function(loadedCheerio) {
        var _this = this;
        var novels = [];
        loadedCheerio(".list-truyen .row").each(function(idx, ele) {
          ...
          var novelUrl = loadedCheerio(ele).find("h3.truyen-title > a").attr("href");
          if (novelUrl) {
            novels.push({
              name: novelName,
              cover: novelCover,
      ...
      TruyenFull2.prototype.parseChapters = function(loadedCheerio) {
        var _this = this;
        return loadedCheerio("ul.list-chapter > li > a").toArray().map(function(ele) {
          var _a;
      ...
      TruyenFull2.prototype.popularNovels = function(pageNo_1, _a) {
      ...
      TruyenFull2.prototype.parseNovel = function(novelPath) {
            ...
            switch (_a.label) {
              ...
              case 2:
                ...
                loadedCheerio("ul.pagination.pagination-sm > li > a").each(function() {
                  var _a2;
                  var page = Number((_a2 = this.attribs["href"].match(/\/trang-(\d+)\//)) === null || _a2 === void 0 ? void 0 : _a2[1]);
                  if (page && page > lastPage)
                    lastPage = page;
                });
                novel = {
                  path: novelPath,
                  name: loadedCheerio("div.book > img").attr("alt") || "Kh\xF4ng c\xF3 ti\xEAu \u0111\u1EC1",
                  chapters: [],
                  totalPages: lastPage
                };
                novel.cover = loadedCheerio("div.book > img").attr("src");
                novel.summary = loadedCheerio("div.desc-text").text().trim();
                novel.author = loadedCheerio('h3:contains("T\xE1c gi\u1EA3:")').parent().contents().text().replace("T\xE1c gi\u1EA3:", "");
                novel.genres = loadedCheerio('h3:contains("Th\u1EC3 lo\u1EA1i")').siblings().map(function(i, el) {
                  return loadedCheerio(el).text();
                }).toArray().join(",");
                novel.status = loadedCheerio('h3:contains("Tr\u1EA1ng th\xE1i")').next().text();
      ...
      TruyenFull2.prototype.parsePage = function(novelPath, page) {
        return __awaiter(this, void 0, void 0, function() {
      ...
      TruyenFull2.prototype.parseChapter = function(chapterPath) {
        return __awaiter(this, void 0, void 0, function() {
      ...
      TruyenFull2.prototype.searchNovels = function(searchTerm, pageNo) {
        return __awaiter(this, void 0, void 0, function() {
