...
var LNReaderPlugin = (() => {
  ...
  var FictioneerPlugin = (
    ...
    function() {
      ...
      FictioneerPlugin2.prototype.popularNovels = function(pageNo_1, _a) {
            ...
            switch (_a.label) {
              ...
              case 2:
                ...
                novel.chapters = loadedCheerio("li.chapter-group__list-item._publish").filter(function(i, el) {
                  ...
                  var chapterUrl = (_a2 = loadedCheerio(el).find("a").attr("href")) === null || _a2 === void 0 ? void 0 : _a2.replace(_this.site + "/", "").replace(/\/$/, "");
                  return {
                    name: chapterName,
                    path: chapterUrl
                  };
  ...
  var plugin = new FictioneerPlugin({ "id": "daoistquest", "sourceSite": "https://daoist.quest", "sourceName": "Daoist Quest", "options": { "browsePage": "collection/novels", "versionIncrements": 1 } });
