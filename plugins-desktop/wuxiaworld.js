...
var LNReaderPlugin = (() => {
  ...
  (function(NovelItem_Status2) {
    NovelItem_Status2[NovelItem_Status2["Finished"] = 0] = "Finished";
    NovelItem_Status2[NovelItem_Status2["Active"] = 1] = "Active";
    NovelItem_Status2[NovelItem_Status2["Hiatus"] = 2] = "Hiatus";
    NovelItem_Status2[NovelItem_Status2["All"] = -1] = "All";
  })(NovelItem_Status || (NovelItem_Status = {}));
  var WuxiaWorld = (
    /** @class */
    function() {
      function WuxiaWorld2() {
        this.id = "wuxiaworld";
      ...
      __name(WuxiaWorld2, "WuxiaWorld");
      WuxiaWorld2.prototype.parseNovels = function(data2) {
        var novels = [];
        data2.items.map(function(novel) {
          var name = novel.name;
      ...
      WuxiaWorld2.prototype.popularNovels = function() {
        return __awaiter(this, void 0, void 0, function() {
          var link, result, data2;
          return __generator(this, function(_a) {
            switch (_a.label) {
              ...
              case 2:
                data2 = _a.sent();
                return [2, this.parseNovels(data2)];
            }
          });
        });
      };
      WuxiaWorld2.prototype.parseNovel = function(novelPath) {
        return __awaiter(this, void 0, void 0, function() {
          var data2, novel, status, list, freeChapter, chapter;
          var _a, _b, _c, _d, _e, _f, _g, _h, _j, _k, _l, _m, _o, _p, _q, _r, _s, _t;
          return __generator(this, function(_u) {
            switch (_u.label) {
              case 0:
                return [4, (0, fetch_1.fetchProto)({
                  proto: this.proto,
              ...
              case 1:
                ...
                novel = {
                  path: novelPath,
                  name: ((_a = data2.item) === null || _a === void 0 ? void 0 : _a.name) || "Untitled",
                  cover: (_c = (_b = data2.item) === null || _b === void 0 ? void 0 : _b.coverUrl) === null || _c === void 0 ? void 0 : _c.value,
                  summary: (0, cheerio_1.load)(((_e = (_d = data2.item) === null || _d === void 0 ? void 0 : _d.description) === null || _e === void 0 ? void 0 : _e.value) + "\n\n" + ((_g = (_f = data2.item) === null || _f === void 0 ? void 0 : _f.synopsis) === null || _g === void 0 ? void 0 : _g.value)).text(),
                  author: (_j = (_h = data2.item) === null || _h === void 0 ? void 0 : _h.authorName) === null || _j === void 0 ? void 0 : _j.value,
                  genres: (_k = data2.item) === null || _k === void 0 ? void 0 : _k.genres.join(","),
                  chapters: []
                };
                status = (_l = data2.item) === null || _l === void 0 ? void 0 : _l.status;
                switch (status) {
                ...
                return [4, (0, fetch_1.fetchProto)({
                  ...
                  requestData: { novelId: (_m = data2.item) === null || _m === void 0 ? void 0 : _m.id }
              ...
              case 2:
                list = _u.sent();
                freeChapter = Number((_q = (_p = (_o = data2.item) === null || _o === void 0 ? void 0 : _o.karmaInfo) === null || _p === void 0 ? void 0 : _p.maxFreeChapter) === null || _q === void 0 ? void 0 : _q.units) + (((_t = (_s = (_r = data2.item) === null || _r === void 0 ? void 0 : _r.karmaInfo) === null || _s === void 0 ? void 0 : _s.maxFreeChapter) === null || _t === void 0 ? void 0 : _t.nanos) || 0) / 1e9 || 50;
                chapter = list.items.flatMap(function(ChapterGroupItem) {
                  return ChapterGroupItem.chapterList.map(function(chapterItem) {
                    ...
                    return {
                      ...
                      name: chapterItem.name + (((_b2 = (_a2 = chapterItem.relatedUserInfo) === null || _a2 === void 0 ? void 0 : _a2.isChapterUnlocked) === null || _b2 === void 0 ? void 0 : _b2.value) === false || !chapterItem.relatedUserInfo && Number((_c2 = chapterItem.number) === null || _c2 === void 0 ? void 0 : _c2.units) + (((_d2 = chapterItem.number) === null || _d2 === void 0 ? void 0 : _d2.nanos) || 0) / 1e9 > freeChapter ? " \u{1F512}" : ""),
                      path: novelPath + chapterItem.slug,
                      chapterNumber: chapterItem.offset,
                      releaseTime: new Date((((_e2 = chapterItem.publishedAt) === null || _e2 === void 0 ? void 0 : _e2.seconds) || 0) * 1e3 + (((_f2 = chapterItem.publishedAt) === null || _f2 === void 0 ? void 0 : _f2.nanos) || 0) / 1e6).toISOString()
                    };
                  });
                });
      ...
      WuxiaWorld2.prototype.parseChapter = function(chapterPath) {
        return __awaiter(this, void 0, void 0, function() {
          var paths, data2, chapterText;
          var _a, _b;
          return __generator(this, function(_c) {
            switch (_c.label) {
              ...
              case 1:
                data2 = _c.sent();
                chapterText = ((_b = (_a = data2.item) === null || _a === void 0 ? void 0 : _a.content) === null || _b === void 0 ? void 0 : _b.value) || "";
                return [2, chapterText];
            }
          });
        });
      };
      WuxiaWorld2.prototype.searchNovels = function(searchTerm) {
        return __awaiter(this, void 0, void 0, function() {
          var url, result, data2;
          return __generator(this, function(_a) {
            switch (_a.label) {
              case 0:
