...
var LNReaderPlugin = (() => {
  ...
  var ScribbleHubPlugin = (
    /** @class */
    function() {
      function ScribbleHubPlugin2() {
        this.id = "scribblehub";
      ...
      __name(ScribbleHubPlugin2, "ScribbleHubPlugin");
      ScribbleHubPlugin2.prototype.parseNovels = function(loadedCheerio) {
        var _this = this;
        var novels = [];
        loadedCheerio(".search_main_box").each(function(i, el) {
          var novelName = loadedCheerio(el).find(".search_title > a").text();
          var novelCover = loadedCheerio(el).find(".search_img > img").attr("src");
      ...
      ScribbleHubPlugin2.prototype.popularNovels = function(page_1, _a) {
            ...
            switch (_l.label) {
              case 0:
                ...
                if (showLatestNovels) {
                  ...
                  if (((_h = filters.content_warning.value.include) === null || _h === void 0 ? void 0 : _h.length) || ((_j = filters.content_warning.value.exclude) === null || _j === void 0 ? void 0 : _j.length)) {
      ...
      ScribbleHubPlugin2.prototype.parseNovel = function(novelPath) {
        return __awaiter(this, void 0, void 0, function() {
          var result, body, loadedCheerio, novel, formData, data2, text3, chapter, parseISODate;
          var _this = this;
          return __generator(this, function(_a) {
            switch (_a.label) {
              ...
              case 2:
                ...
                novel.genres = loadedCheerio(".fic_genre").map(function(i, el) {
                ...
                return [4, (0, fetch_1.fetchApi)("".concat(this.site, "wp-admin/admin-ajax.php"), {
                  method: "POST",
                  body: formData
                })];
              case 3:
              ...
              case 4:
                ...
                chapter = [];
                parseISODate = /* @__PURE__ */ __name(function(date) {
                  var _a2;
      ...
      ScribbleHubPlugin2.prototype.parseChapter = function(chapterPath) {
        return __awaiter(this, void 0, void 0, function() {
      ...
      ScribbleHubPlugin2.prototype.searchNovels = function(searchTerm) {
        return __awaiter(this, void 0, void 0, function() {
