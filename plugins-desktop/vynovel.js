...
var LNReaderPlugin = (() => {
  ...
  var VyNovel = (
    ...
    function() {
          ...
          if (date.includes("ago")) {
            ...
            switch (type.toLowerCase()) {
              case "minutes": {
                ...
                date = Date.now() - minutes * 60 * 1e3;
                break;
              }
              case "hour":
              case "hours": {
                var hours = parseInt(value, 10);
                date = Date.now() - hours * 60 * 60 * 1e3;
                break;
              }
              case "day":
              case "days": {
                var days = parseInt(value, 10);
                date = Date.now() - days * 24 * 60 * 60 * 1e3;
                break;
              }
              default:
                console.log(date);
      ...
      __name(VyNovel2, "VyNovel");
      VyNovel2.prototype.fetchNovels = function(page_1, _a, searchTerm_1) {
        return __awaiter(this, arguments, void 0, function(page, _b, searchTerm) {
          var data2, url, body, loadedCheerio, novels;
          var _c;
          var filters = _b.filters, showLatestNovels = _b.showLatestNovels;
          return __generator(this, function(_d) {
            switch (_d.label) {
              case 0:
                data2 = new URLSearchParams({
                ...
                if (searchTerm)
                  data2.append("q", searchTerm);
                url = this.site + "/search?" + data2.toString();
              ...
              case 1:
                ...
                novels = [];
                loadedCheerio('div[class="comic-item"] > a').each(function(index2, element) {
                  var _a2;
                  var name = (_a2 = loadedCheerio(element).find('div[class="comic-title"]').text()) === null || _a2 === void 0 ? void 0 : _a2.trim();
                  var cover = loadedCheerio(element).find('div[class="comic-image lozad "]').attr("data-background-image") || defaultCover_1.defaultCover;
                  var url2 = loadedCheerio(element).attr("href");
                  if (!name || !url2)
                    return;
                  novels.push({ name, cover, path: url2.replace("/novel/", "") });
                });
                return [2, novels];
            }
          });
      ...
      VyNovel2.prototype.searchNovels = function(searchTerm, page) {
      ...
      VyNovel2.prototype.parseNovel = function(novelPath) {
        return __awaiter(this, void 0, void 0, function() {
            ...
            switch (_a.label) {
              ...
              case 1:
                ...
                novel = {
                  ...
                  cover: loadedCheerio('div[class="img-manga"] > img').attr("src") || defaultCover_1.defaultCover,
                  summary: loadedCheerio('div[class="summary"] > p[class="content"]').text().trim(),
                  author: loadedCheerio('div[class="col-md-7"] > p:nth-child(5) > a').text().trim(),
                  status: loadedCheerio('span[class="text-ongoing"]').text() === "Ongoing" ? novelStatus_1.NovelStatus.Ongoing : novelStatus_1.NovelStatus.Completed
                };
                chapters = [];
                ...
                loadedCheerio('div[class="list-group"] > a').each(function(chapterIndex, element) {
                  ...
                  var id = (_a2 = loadedCheerio(element).attr("id")) === null || _a2 === void 0 ? void 0 : _a2.replace(/\D/g, "");
                  if (!name || !id)
                    return;
      ...
      VyNovel2.prototype.parseChapter = function(chapterPath) {
        return __awaiter(this, void 0, void 0, function() {
