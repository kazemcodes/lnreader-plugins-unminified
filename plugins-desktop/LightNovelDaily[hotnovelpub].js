...
var LNReaderPlugin = (() => {
  ...
  var HotNovelPubPlugin = (
    /** @class */
    function() {
      function HotNovelPubPlugin2(metadata) {
        var _this = this;
        var _a;
      ...
      __name(HotNovelPubPlugin2, "HotNovelPubPlugin");
      HotNovelPubPlugin2.prototype.popularNovels = function(pageNo_1, _a) {
      ...
      HotNovelPubPlugin2.prototype.parseNovel = function(novelPath) {
        return __awaiter(this, void 0, void 0, function() {
          ...
          return __generator(this, function(_c) {
            switch (_c.label) {
              case 0:
                return [4, (0, fetch_1.fetchApi)(this.apiSite + "/book/" + novelPath, {
                  headers: {
                    lang: this.lang
                  }
                }).then(function(res) {
              ...
              case 1:
                ...
                novel = {
                  ...
                  status: json.data.book.status === "updating" ? novelStatus_1.NovelStatus.Ongoing : novelStatus_1.NovelStatus.Completed
                };
      ...
      HotNovelPubPlugin2.prototype.parseChapter = function(chapterPath) {
        return __awaiter(this, void 0, void 0, function() {
          ...
          return __generator(this, function(_b) {
            switch (_b.label) {
              ...
              case 1:
                ...
                if (!chapterText) return [3, 4];
                return [4, (0, fetch_1.fetchApi)(this.site + "/server/getContent?slug=" + chapterPath)];
              case 2:
                result = _b.sent();
              ...
              case 3:
                json = _b.sent();
                if (json.data) {
                  chapterText += json.data.map(function(item) {
                    return "<p>" + item + "</p>";
                  }).join("").replace(/\n/g, "</p><p>").replace(/\s/g, " ");
                }
                _b.label = 4;
              case 4:
                return [2, chapterText.replace(/\.copy right hot novel pub/g, "")];
            }
          });
        });
      };
      HotNovelPubPlugin2.prototype.searchNovels = function(searchTerm) {
        return __awaiter(this, void 0, void 0, function() {
          var result, novels;
          var _a;
          return __generator(this, function(_b) {
            switch (_b.label) {
              case 0:
                return [4, (0, fetch_1.fetchApi)(this.apiSite + "/search", {
                  headers: {
