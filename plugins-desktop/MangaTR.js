...
var LNReaderPlugin = (() => {
  ...
  var require_subselects = __commonJS({
    "node_modules/css-select/lib/pseudo-selectors/subselects.js"(exports4) {
      ...
      init_buffer2();
      init_process2();
      var __spreadArray2 = exports4 && exports4.__spreadArray || function(to, from, pack) {
        ...
        has: /* @__PURE__ */ __name(function(next2, subselect, options, _context, compileToken) {
          ...
          if (context && compiled !== boolbase_1.default.trueFunc) {
            ...
            return function(elem) {
              ...
              var nextElements = shouldTestNextSiblings_1 ? __spreadArray2(__spreadArray2([], childs, true), getNextSiblings(elem, adapter2), true) : childs;
  ...
  var MangaTR = (
    ...
    function() {
        ...
        this.filters = {
          sort: {
            ...
            options: [
              ...
              { label: "Pop\xFClarite", value: "views" },
              { label: "Son G\xFCncelleme", value: "last_update" }
            ],
            type: filterInputs_1.FilterTypes.Picker
          },
          sort_type: {
            value: "DESC",
            label: "S\u0131rala T\xFCr\xFC",
            options: [
              { label: "ASC", value: "ASC" },
          ...
          translation: {
            value: "",
            label: "\xC7eviri Durumu",
            options: [
              { label: "Hepsi", value: "" },
              { label: "\xC7evirisi Tamamlanan", value: "1" },
          ...
          genre: {
            ...
            options: [
              ...
              { label: "T\xFCrk\xE7e Novel", value: "T\xFCrk\xE7e Novel" },
      ...
      __name(MangaTR2, "MangaTR");
      MangaTR2.prototype.parseNovel = function(novelPath) {
        return __awaiter(this, void 0, void 0, function() {
          var body, loadedCheerio, novel, summary, chapters, title2, url, response, page1, _a, firstPage, lastPage, pageDatas, novelTitle, _loop_1, _i, pageDatas_1, page;
          var _this = this;
          var _b;
            ...
            switch (_c.label) {
              ...
              case 1:
                ...
                novel = {
                  ...
                  chapters: [],
                  author: loadedCheerio("#tab1 > table:nth-child(3) > tbody > tr:nth-child(2) > td:nth-child(1) > a").map(function(i, el) {
                    return loadedCheerio(el).text();
                  }).get().join(","),
                  artist: loadedCheerio("#tab1 > table:nth-child(3) > tbody > tr:nth-child(2) > td:nth-child(2) > a").map(function(i, el) {
                    return loadedCheerio(el).text();
                  }).get().join(","),
                  genres: loadedCheerio("#tab1 > table:nth-child(3) > tbody > tr:nth-child(2) > td:nth-child(3) > a").map(function(i, el) {
                    return loadedCheerio(el).text();
                  }).get().join(",")
                };
                ...
                chapters = [];
                title2 = novelPath.split(".html")[0].slice(6);
                url = "".concat(this.site, "cek/fetch_pages_manga.php?manga_cek=").concat(title2);
                return [4, (0, fetch_1.fetchApi)(url, __assign(__assign({}, this.opts), { body: "page=1" }))];
              case 2:
                response = _c.sent();
                _a = cheerio_1.load;
              ...
              case 3:
                ...
                return [4, Promise.all(Array.from({ length: lastPage - firstPage }, function(_, i) {
                  return (0, fetch_1.fetchApi)(url, __assign(__assign({}, _this.opts), { body: "page=".concat(firstPage + i + 1) })).then(function(r) {
                    return r.text();
                  });
                })).then(function(pages) {
                  return pages.map(function(p) {
                    return (0, cheerio_1.load)(p);
                  });
                })];
              case 4:
                pageDatas = _c.sent();
                pageDatas = __spreadArray([page1], pageDatas, true);
                novelTitle = novel.name.toLocaleLowerCase().replace(/\([0-9]+\)/g, "").trim();
                _loop_1 = /* @__PURE__ */ __name(function(page2) {
                  page2("body > ul > table > tbody > tr").each(function(_, el) {
                    var _a2;
                    var chap = page2(el);
                    var chapTitle1 = chap.find("td:nth-child(1) > a").text();
                    var updatedChapTitle1 = chapTitle1.toLocaleLowerCase().replace(novelTitle, "Ch").trim();
                    var chapTitle2 = chap.find("td:nth-child(1) > div").text();
                    var chapPath = (_a2 = chap.find("td:nth-child(1) > a").attr("href")) !== null && _a2 !== void 0 ? _a2 : "";
                    if (chapPath === "")
                      return;
                    chapters.push({
                      name: chapTitle2 !== "" ? "".concat(updatedChapTitle1, ": ").concat(chapTitle2) : updatedChapTitle1,
                      path: chapPath,
      ...
      MangaTR2.prototype.popularNovels = function(pageNo, _a) {
        ...
        var parseNovels = /* @__PURE__ */ __name(function(loadedCheerio) {
          return loadedCheerio("#myCarousel > div.container > div:nth-child(3) > div.col-lg-9.col-md-8 > div.col-md-12").map(function(_, el) {
            var _a2, _b;
            var novel = loadedCheerio(el);
            return {
              name: novel.find("#tables").text(),
              path: (_a2 = novel.find("#tables > a").attr("href")) !== null && _a2 !== void 0 ? _a2 : "",
              cover: (_b = novel.find("img.img-thumb").first().attr("src")) !== null && _b !== void 0 ? _b : ""
            };
          }).toArray();
        }, "parseNovels");
        return (0, fetch_1.fetchApi)(url).then(function(r) {
          return r.text();
        }).then(function(body) {
      ...
      MangaTR2.prototype.parseChapter = function(chapterPath) {
        return __awaiter(this, void 0, void 0, function() {
          ...
          return __generator(this, function(_b) {
            switch (_b.label) {
              ...
              case 1:
                ...
                return [2, (_a = content.html()) !== null && _a !== void 0 ? _a : ""];
            }
          });
        });
      };
      MangaTR2.prototype.searchNovels = function(searchTerm, pageNo) {
        return __awaiter(this, void 0, void 0, function() {
          ...
          return __generator(this, function(_a) {
            ...
            parseNovels = /* @__PURE__ */ __name(function(loadedCheerio) {
              return __awaiter(_this, void 0, void 0, function() {
                var novels, curr, _i, _a2, el, novelCheerio, mangaSlug;
                var _this2 = this;
                var _b, _c;
                return __generator(this, function(_d) {
                  switch (_d.label) {
                    case 0:
                      novels = [];
                      curr = 0;
                      for (_i = 0, _a2 = loadedCheerio("div.char > a + span").toArray(); _i < _a2.length; _i++) {
                        el = _a2[_i];
                        if (novels.length === ITEMS_PER_PAGE)
                          break;
                        if (loadedCheerio(el).text().trim().toLowerCase() != "novel" && loadedCheerio(el).next().text().trim().toLowerCase() != "novel") {
                          continue;
                        }
                        ...
                        novels.push({
                          ...
                          cover: mangaSlug
                          // NOTE: This slug gets replaced with the actual cover image later (see below)
                        });
                      }
                      return [4, Promise.all(novels.map(function(novel) {
                        return __awaiter(_this2, void 0, void 0, function() {
                          var url2, response, body, imgCheerio, img;
                          return __generator(this, function(_a3) {
                            switch (_a3.label) {
                              case 0:
                                url2 = "".concat(this.site, "app/manga/controllers/cont.pop.php");
                                return [4, (0, fetch_1.fetchApi)(url2, __assign(__assign({}, this.opts), { body: "slug=".concat(novel.cover) }))];
                              case 1:
                                response = _a3.sent();
                                return [4, response.text()];
                              case 2:
            ...
            return [2, (0, fetch_1.fetchApi)(url).then(function(r) {
              return r.text();
            }).then(function(body) {
              var loadedCheerio = (0, cheerio_1.load)(body);
              return parseNovels(loadedCheerio);
      ...
      MangaTR2.prototype.resolveUrl = function(path, isNovel) {
