...
var LNReaderPlugin = (() => {
  ...
  var FaqWikiUs = (
    ...
    function() {
      ...
      __name(FaqWikiUs2, "FaqWikiUs");
      FaqWikiUs2.prototype.parseNovels = function(loadedCheerio, searchTerm) {
        var _this = this;
        var novels = [];
        loadedCheerio(".plt-page-item").each(function(index2, element) {
          var _a, _b, _c;
          var name = loadedCheerio(element).text().replace("Novel \u2013 All Chapters", "").trim();
          var cover = loadedCheerio(element).find("img").attr("data-ezsrc");
          if (cover) {
            cover = cover.replace(/\?ezimgfmt=.*$/, "");
          } else {
            cover = loadedCheerio(element).find("img").attr("src");
          }
          var path = (_c = (_b = (_a = loadedCheerio(element).find("a").attr("href")) === null || _a === void 0 ? void 0 : _a.replace("tp:", "tps:")) === null || _b === void 0 ? void 0 : _b.replace(_this.site, "")) === null || _c === void 0 ? void 0 : _c.replace(/\/+$/, "");
          if (!path)
            return;
      ...
      FaqWikiUs2.prototype.popularNovels = function() {
      ...
      FaqWikiUs2.prototype.parseNovel = function(path) {
        return __awaiter(this, void 0, void 0, function() {
          ...
          return __generator(this, function(_a) {
            switch (_a.label) {
              case 0:
                return [4, (0, fetch_1.fetchApi)(this.site + path).then(function(res) {
                  return res.text();
                })];
              case 1:
                body = _a.sent();
                ...
                novel.cover = cover === null || cover === void 0 ? void 0 : cover.replace(/\?ezimgfmt=.*$/, "");
                ...
                loadedCheerio(".entry-content strong").each(function(i, el) {
                  ...
                  var parent2 = loadedCheerio(el).parent();
                  var values = [parent2.text().slice(key.length).trim()].concat(parent2.nextUntil("p:has(strong)").map(function(e, ax) {
                    return loadedCheerio(ax).text().trim();
                  }).get());
                  ...
                  var genres = genreText.split(/\s+/).map(function(word) {
                ...
                loadedCheerio(".lcp_catlist li a").each(function(chapterIndex, element) {
                  var _a2, _b;
                  var name = loadedCheerio(element).text().replace(novel.name + "", "").replace("Novel", "").trim();
                  var path2 = (_b = (_a2 = loadedCheerio(element).attr("href")) === null || _a2 === void 0 ? void 0 : _a2.replace(_this.site, "")) === null || _b === void 0 ? void 0 : _b.replace(/\/+$/, "");
      ...
      FaqWikiUs2.prototype.parseChapter = function(chapterPath) {
        return __awaiter(this, void 0, void 0, function() {
      ...
      FaqWikiUs2.prototype.searchNovels = function(searchTerm) {
        return __awaiter(this, void 0, void 0, function() {
          var body, loadedCheerio;
          return __generator(this, function(_a) {
            switch (_a.label) {
              ...
              case 1:
                body = _a.sent();
                loadedCheerio = (0, cheerio_1.load)(body);
                return [2, this.parseNovels(loadedCheerio, searchTerm)];
            }
          });
        });
      };
