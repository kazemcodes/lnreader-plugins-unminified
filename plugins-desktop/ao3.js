...
var LNReaderPlugin = (() => {
  ...
  var ArchiveOfOurOwn = (
    ...
    function() {
        ...
        this.filters = {
          ...
          language: {
            ...
            options: [
              ...
              { label: "\u{1308B}\u{133FA}\u{13216} \u{1318E}\u{13153}\u{133CF}\u{13296}", value: "egy" },
              ...
              { label: "\u{12174}\u{120A0}", value: "sux" },
              ...
              { label: "G\xE0idhlig", value: "gd" },
              { label: "Galego", value: "gl" },
              { label: "\u{10332}\u{1033F}\u{10344}\u{10339}\u{10343}\u{1033A}\u{10330}", value: "got" },
              ...
              { label: "krey\xF2l ayisyen", value: "ht" },
              { label: "Kurd\xEE | \u06A9\u0648\u0631\u062F\u06CC", value: "ku" },
              { label: "\u041A\u044B\u0440\u0433\u044B\u0437\u0447\u0430", value: "kir" },
              { label: "Langue des signes qu\xE9b\xE9coise", value: "fcs" },
              { label: "Latvie\u0161u valoda", value: "lv" },
              { label: "L\xEBtzebuergesch", value: "lb" },
              ...
              { label: "Mikis\xFAk\xEE", value: "mik" },
              ...
              { label: "\u2018O\u2019odham \xD1iok", value: "ood" },
              { label: "\u0644\u0633\u0627\u0646 \u0639\u062B\u0645\u0627\u0646\u0649", value: "ota" },
              { label: "\u067E\u069A\u062A\u0648", value: "ps" },
              { label: "Plattd\xFC\xFCtsch", value: "nds" },
              { label: "Polski", value: "pl" },
              { label: "Portugu\xEAs brasileiro", value: "ptBR" },
              { label: "Portugu\xEAs europeu", value: "ptPT" },
              { label: "\u0A2A\u0A70\u0A1C\u0A3E\u0A2C\u0A40", value: "pa" },
              { label: "qazaq\u015Fa | \u049B\u0430\u0437\u0430\u049B\u0448\u0430", value: "kaz" },
              { label: "Uncategorized Constructed Languages", value: "qlq" },
              { label: "Quenya", value: "qya" },
              { label: "Rom\xE2n\u0103", value: "ro" },
              ...
              { label: "Spr\u0113k\u014D \xDEiudisk\u014D", value: "gem" },
      ...
      __name(ArchiveOfOurOwn2, "ArchiveOfOurOwn");
      ArchiveOfOurOwn2.prototype.parseNovels = function(loadedCheerio) {
        var novels = [];
        loadedCheerio("li.work").each(function(idx, ele) {
          var _a;
          var novelName = loadedCheerio(ele).find("h4.heading > a").first().text().trim();
          var novelUrl = (_a = loadedCheerio(ele).find("h4.heading > a").first().attr("href")) === null || _a === void 0 ? void 0 : _a.trim();
          if (!novelUrl)
            return;
          var novel = {
            name: novelName,
      ...
      ArchiveOfOurOwn2.prototype.popularNovels = function(page_1, _a) {
      ...
      ArchiveOfOurOwn2.prototype.parseNovel = function(novelUrl) {
        return __awaiter(this, void 0, void 0, function() {
          ...
          return __generator(this, function(_a) {
            switch (_a.label) {
              case 0:
                return [4, (0, fetch_1.fetchApi)(new URL(novelUrl, this.site).toString())];
              case 1:
                result = _a.sent();
                urlchapter = novelUrl + "/navigate";
                return [4, (0, fetch_1.fetchApi)(new URL(urlchapter, this.site).toString())];
              case 2:
                chapters = _a.sent();
                return [4, result.text()];
              case 3:
                body = _a.sent();
                return [4, chapters.text()];
              case 4:
                ...
                novel = {
                  ...
                  status: loadedCheerio("dt.status").text().includes("Updated") ? "Ongoing" : "Completed",
                  chapters: []
                };
                novel.author = loadedCheerio('a[rel="author"]').map(function(i, el) {
                  return loadedCheerio(el).text().trim();
                }).get().join(", ");
                novel.genres = Array.from(loadedCheerio("dd.freeform.tags li a.tag")).map(function(el) {
                  return loadedCheerio(el).text().trim();
                }).join(",");
                summary = loadedCheerio("blockquote.userstuff").text().trim();
                fandom = Array.from(loadedCheerio("dd.fandom.tags li a.tag")).map(function(el) {
                  return loadedCheerio(el).text().trim();
                }).join(",");
                rating = Array.from(loadedCheerio("dd.rating.tags li a.tag")).map(function(el) {
                  return loadedCheerio(el).text().trim();
                }).join(",");
                warning = Array.from(loadedCheerio("dd.warning.tags li a.tag")).map(function(el) {
                  return loadedCheerio(el).text().trim();
                }).join(",");
                series = Array.from(loadedCheerio("dd.series li a.tag")).map(function(el) {
                  return loadedCheerio(el).text().trim();
                }).join(",");
                relation = Array.from(loadedCheerio("dd.relationship.tags li a.tag")).map(function(el) {
                  return loadedCheerio(el).text().trim();
                }).join(",");
                character = Array.from(loadedCheerio("dd.character.tags li a.tag")).map(function(el) {
                  return loadedCheerio(el).text().trim();
                }).join(",");
                stats = Array.from(loadedCheerio("dd.stats li a.tag")).map(function(el) {
                  return loadedCheerio(el).text().trim();
                }).join(",");
                ...
                chapterlistload("ol.index").each(function(i, ele) {
                  chapterlistload(ele).find("li").each(function(i2, el) {
                    var chapterNameMatch = chapterlistload(el).find("a").text().trim();
                    var releaseTimeText2 = chapterlistload(el).find("span.datetime").text().replace(/\(([^)]+)\)/g, "$1").trim();
                    var releaseTime2 = releaseTimeText2 ? new Date(releaseTimeText2).toISOString() : "";
                    longReleaseDate.push(releaseTime2);
                  });
                });
                releaseTimeText = loadedCheerio(".wrapper dd.published").text().trim();
                releaseTime = releaseTimeText ? new Date(releaseTimeText).toISOString() : "";
                dateCounter = 0;
                if (loadedCheerio("#chapter_index select").length > 0) {
                  loadedCheerio("#chapter_index select").each(function(i, selectEl) {
                    loadedCheerio(selectEl).find("option").each(function(i2, el) {
                      var _a2;
                      var chapterName = loadedCheerio(el).text().trim();
                      var chapterUrlCode = (_a2 = loadedCheerio(el).attr("value")) === null || _a2 === void 0 ? void 0 : _a2.trim();
                ...
                if (chapterItems.length === 0) {
                  loadedCheerio("#chapters h3.title").each(function(i, titleEl) {
                    ...
                    var chapterUrlRaw = (_a2 = loadedCheerio(titleEl).find("a").attr("href")) === null || _a2 === void 0 ? void 0 : _a2.trim();
                    ...
                    if (chapterUrl) {
                      if (chapterName === "") {
                        var novelTitle = loadedCheerio(".work .title.heading").text().trim();
                  ...
                  if (chapterItems.length === 0) {
                    loadedCheerio(".work.navigation.actions li a").each(function(i, el) {
                      ...
                      if (href && href.includes("/downloads/")) {
                        ...
                        var chapterUrlCode = chapterUrlCodeMatch ? chapterUrlCodeMatch[1] : null;
      ...
      ArchiveOfOurOwn2.prototype.parseChapter = function(chapterUrl) {
        return __awaiter(this, void 0, void 0, function() {
          var result, body, loadedCheerio, chapterText;
          return __generator(this, function(_a) {
            switch (_a.label) {
              case 0:
                return [4, (0, fetch_1.fetchApi)(new URL(chapterUrl, this.site).toString())];
              case 1:
                result = _a.sent();
                return [4, result.text()];
              case 2:
                ...
                loadedCheerio("h3.title").each(function(i, el) {
                  ...
                  var nextSiblingText = $h3.contents().filter(function(_, node) {
      ...
      ArchiveOfOurOwn2.prototype.searchNovels = function(searchTerm, page) {
        return __awaiter(this, void 0, void 0, function() {
