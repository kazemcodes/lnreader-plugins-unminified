...
var LNReaderPlugin = (() => {
  ...
  var RV = (
    ...
    function() {
      ...
      __name(RV2, "RV");
      RV2.prototype.fetchNovels = function(page_1, _a, searchTerm_1) {
        return __awaiter(this, arguments, void 0, function(page, _b, searchTerm) {
          var url, data2, novels;
          var _this = this;
          var _c;
      ...
      RV2.prototype.searchNovels = function(searchTerm, page) {
      ...
      RV2.prototype.parseNovel = function(novelPath) {
        return __awaiter(this, void 0, void 0, function() {
            ...
            switch (_a.label) {
              ...
              case 1:
                ...
                novel = {
                  ...
                  genres: loadedCheerio(".genres > a").map(function(index2, element) {
                    var _a2;
                    return (_a2 = loadedCheerio(element).text()) === null || _a2 === void 0 ? void 0 : _a2.trim();
                  }).get().join(","),
                  status: loadedCheerio(".status_row > div:nth-child(1) > a").text().includes("\u0412 \u0440\u0430\u0431\u043E\u0442\u0435") ? novelStatus_1.NovelStatus.Ongoing : novelStatus_1.NovelStatus.Completed
                };
                bookId = loadedCheerio("comments-list").attr("commentable-id");
                return [4, (0, fetch_1.fetchApi)(this.site + "api/books/" + bookId + "/chapters/all").then(function(res) {
                  return res.json();
                })];
              case 2:
      ...
      RV2.prototype.parseChapter = function(chapterPath) {
        return __awaiter(this, void 0, void 0, function() {
          var body, encrypted;
          var _a;
          return __generator(this, function(_b) {
            switch (_b.label) {
              ...
              case 1:
                body = _b.sent();
                encrypted = (_a = body.match(new RegExp(`(mobile-books|books)-chapters-text-component.*:text='"(.*?)"'`, "s"))) === null || _a === void 0 ? void 0 : _a[2];
                if (!encrypted)
                  throw new Error("No chapter found");
                return [2, unicodeToUtf8(encrypted)];
            }
          });
        });
      };
