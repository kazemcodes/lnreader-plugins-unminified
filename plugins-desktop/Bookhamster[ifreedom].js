...
var LNReaderPlugin = (() => {
  ...
  var IfreedomPlugin = (
    ...
    function() {
      ...
      IfreedomPlugin2.prototype.popularNovels = function(page_1, _a) {
        return __awaiter(this, arguments, void 0, function(page, _b) {
          ...
          return __generator(this, function(_d) {
            switch (_d.label) {
              case 0:
                url = this.site + "/vse-knigi/?sort=" + (showLatestNovels ? "\u041F\u043E \u0434\u0430\u0442\u0435 \u043E\u0431\u043D\u043E\u0432\u043B\u0435\u043D\u0438\u044F" : ((_c = filters === null || filters === void 0 ? void 0 : filters.sort) === null || _c === void 0 ? void 0 : _c.value) || "\u041F\u043E \u0440\u0435\u0439\u0442\u0438\u043D\u0433\u0443");
                Object.entries(filters || {}).forEach(function(_a2) {
                  var type = _a2[0], value = _a2[1].value;
              ...
              case 1:
                ...
                novels = loadedCheerio("div.one-book-home > div.img-home a").map(function(index2, element) {
                  ...
                  return {
                    ...
                    path: ((_b2 = (_a2 = loadedCheerio(element).attr("href")) === null || _a2 === void 0 ? void 0 : _a2.replace) === null || _b2 === void 0 ? void 0 : _b2.call(_a2, _this.site, "")) || ""
                  };
              ...
              case 1:
                ...
                novels = loadedCheerio("div.one-book-home > div.img-home a").map(function(index2, element) {
                  ...
                  return {
                    name: loadedCheerio(element).attr("title") || "",
                    cover: loadedCheerio(element).find("img").attr("src"),
                    path: ((_b = (_a2 = loadedCheerio(element).attr("href")) === null || _a2 === void 0 ? void 0 : _a2.replace) === null || _b === void 0 ? void 0 : _b.call(_a2, _this.site, "")) || ""
                  };
                }).get().filter(function(novel) {
                  return novel.name && novel.path;
                });
