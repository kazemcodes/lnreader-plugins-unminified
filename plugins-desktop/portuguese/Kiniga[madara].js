...
var LNReaderPlugin = (() => {
  ...
  // .js/plugins/portuguese/Kiniga[madara].js
  var e = function(e2, t2, a2, r2) {
    ...
    var a2, r2, i2, n2 = { label: 0, sent: function() {
  ...
  var r = (init_fetch2(), __toCommonJS(fetch_exports)), i = (init_browser(), __toCommonJS(browser_exports)), n = (init_defaultCover(), __toCommonJS(defaultCover_exports)), o = (init_novelStatus(), __toCommonJS(novelStatus_exports)), l = a(require_dayjs_min()), s = (init_storage2(), __toCommonJS(storage_exports)), u = function(e2, t2) {
    ...
    return a2.prototype.translateDragontea = function(e2) {
      ...
      return e(this, void 0, void 0, (function() {
        var e2, s2, u2, c2, p, h, v, d, m = this;
        return t(this, (function(t2) {
          switch (t2.label) {
            case 0:
            ...
            case 1:
              return (e2 = t2.sent())(".manga-title-badges, #manga-title span").remove(), (s2 = { path: a3, name: e2(".post-title h1").text().trim() || e2("#manga-title h1").text().trim() || e2(".manga-title").text().trim() || "" }).cover = e2(".summary_image > a > img").attr("data-lazy-src") || e2(".summary_image > a > img").attr("data-src") || e2(".summary_image > a > img").attr("src") || n.defaultCover, e2(".post-content_item, .post-content").each((function() {
                ...
                return e2(a4).text();
              })).get().join("\n\n").trim(), u2 = [], c2 = "", (null === (d = this.options) || void 0 === d ? void 0 : d.useNewChapterEndpoint) ? [4, (0, r.fetchApi)(this.site + a3 + "ajax/chapters/", { method: "POST", referrer: this.site + a3 }).then((function(e3) {
                return e3.text();
              }))] : [3, 3];
            case 2:
              return c2 = t2.sent(), [3, 5];
            case 3:
              return p = e2(".rating-post-id").attr("value") || e2("#manga-chapters-holder").attr("data-id") || "", (h = new FormData()).append("action", "manga_get_chapters"), h.append("manga", p), [4, (0, r.fetchApi)(this.site + "wp-admin/admin-ajax.php", { method: "POST", body: h }).then((function(e3) {
                return e3.text();
              }))];
            case 4:
              c2 = t2.sent(), t2.label = 5;
            case 5:
              return "0" !== c2 && (e2 = (0, i.load)(c2)), v = e2(".wp-manga-chapter").length, e2(".wp-manga-chapter").each((function(t3, a4) {
                ...
                n2 = n2 ? m.parseData(n2) : (0, l.default)().format("LL");
                var o2 = e2(a4).find("a").attr("href") || "";
                !o2 || "#" == o2 || i2 && m.hideLocked || u2.push({ name: r2, path: o2.replace(/https?:\/\/.*?\//, "/"), releaseTime: n2 || null, chapterNumber: v - t3 });
  ...
  })())({ id: "kiniga", sourceSite: "https://kiniga.com/", sourceName: "Kiniga", options: { lang: "Portuguese" }, filters: { "genre[]": { type: "Checkbox", label: "Genre", value: [], options: [{ label: "A\xE7\xE3o", value: "action" }, { label: "Artes Marciais", value: "artes-marciais" }, { label: "Aventura", value: "aventura" }, { label: "Com\xE9dia", value: "comedia" }, { label: "Contempor\xE2neo", value: "contemporaneo" }, { label: "Contos", value: "contos-originais" }, { label: "Crime", value: "crime" }, { label: "Cyberpunk", value: "cyberpunk" }, { label: "Destaque", value: "destaque" }, { label: "Distopia", value: "distopia" }, { label: "Drama", value: "drama" }, { label: "Ecchi", value: "ecchi" }, { label: "Espacial", value: "espacial" }, { label: "Esportes", value: "esportes" }, { label: "Fanfic", value: "fanfic" }, { label: "Fantasia", value: "fantasia" }, { label: "Fic\xE7\xE3o Cient\xEDfica", value: "ficcao-cientifica" }, { label: "Gastronomia", value: "gastronomia" }, { label: "Har\xE9m", value: "harem" }, { label: "Hist\xF3rico", value: "historico" }, { label: "Horror", value: "horror" }, { label: "Infantil", value: "infantil" }, { label: "Isekai", value: "isekai" }, { label: "Jogos", value: "jogos" }, { label: "LGBT+", value: "lgbt" }, { label: "Magia", value: "magia" }, { label: "Mecha", value: "mecha" }, { label: "Medieval", value: "medieval" }, { label: "Militar", value: "militar" }, { label: "Mist\xE9rio", value: "misterio" }, { label: "Mitologia", value: "mitologia" }, { label: "Moderno", value: "moderno" }, { label: "P\xF3s-apocal\xEDptico", value: "pos-apocaliptico" }, { label: "Psicol\xF3gico", value: "psicologico" }, { label: "Realidade Virtual", value: "realidade-virtual" }, { label: "Recomendado", value: "recomendado" }, { label: "Romance", value: "romance" }, { label: "RPG", value: "rpg" }, { label: "Sci-fi", value: "sci-fi" }, { label: "Seinen", value: "seinen" }, { label: "Shounen", value: "shounen" }, { label: "Sistema de Jogo", value: "sistema-de-jogo" }, { label: "Slice of Life", value: "slice-of-life" }, { label: "snkhome", value: "snkhome" }, { label: "Sobrenatural", value: "sobrenatural" }, { label: "Somente na Kiniga", value: "somente-na-kiniga" }, { label: "Suspense", value: "suspense" }, { label: "Terror", value: "terror" }, { label: "Terror Psicol\xF3gico", value: "terror-psicologico" }, { label: "Tradu\xE7\xF5es", value: "traducoes" }, { label: "Trag\xE9dia", value: "tragedia" }, { label: "Urbano", value: "urbano" }, { label: "Vida Escolar", value: "vida-escolar" }] }, op: { type: "Switch", label: "Ter todos g\xEAneros selecionados", value: false }, author: { type: "Text", label: "Autor", value: "" }, artist: { type: "Text", label: "Artista", value: "" }, release: { type: "Text", label: "Ano", value: "" }, adult: { type: "Picker", label: "Conte\xFAdo", value: "", options: [{ label: "Ambas op\xE7\xF5es", value: "" }, { label: "Para todas idades", value: "0" }, { label: "Para maiores de idade", value: "1" }] }, "status[]": { type: "Checkbox", label: "Status", value: [], options: [{ label: "Completo", value: "complete" }, { label: "Ativo", value: "on-going" }, { label: "Cancelado", value: "canceled" }, { label: "Pausado", value: "on-hold" }] }, m_orderby: { type: "Picker", label: "Ordem por", value: "", options: [{ label: "Relev\xE2ncia", value: "" }, { label: "Mais antigo", value: "latest" }, { label: "A-Z", value: "alphabet" }, { label: "Avalia\xE7\xE3o", value: "rating" }, { label: "Tend\xEAncia", value: "trending" }, { label: "Mais Visualizado", value: "views" }, { label: "Novo", value: "new-manga" }] } } });
  exports.default = c;
})();
