...
var LNReaderPlugin = (() => {
  ...
  var e = function(e2, t2, s2, r2) {
    ...
    var s2, r2, a2, i2 = { label: 0, sent: function() {
  ...
  var s = (init_browser(), __toCommonJS(browser_exports)), r = require_lib9(), a = (init_fetch2(), __toCommonJS(fetch_exports)), i = (init_novelStatus(), __toCommonJS(novelStatus_exports)), o = (init_defaultCover(), __toCommonJS(defaultCover_exports)), n = (init_storage2(), __toCommonJS(storage_exports));
  function c(e2, t2) {
    var s2 = e2.match(/(\d+)$/);
  ...
  var l = new ((function() {
    function l2(e2) {
      ...
      this.version = "1.1.".concat(9 + a2), this.options = null !== (s2 = e2.options) && void 0 !== s2 ? s2 : {}, this.filters = e2.filters, (null === (r2 = this.options) || void 0 === r2 ? void 0 : r2.hasLocked) && (this.pluginSettings = { hideLocked: { value: "", label: "Hide locked chapters", type: "Switch" } });
    }
    return l2.prototype.getHostname = function(e2) {
      var t2 = (e2 = e2.split("/")[2]).split(".");
      return t2.pop(), t2.join(".");
    }, l2.prototype.safeFecth = function(s2, r2) {
      return e(this, void 0, void 0, (function() {
        var e2, i2, o2, n2, c2, l3, u, h;
        return t(this, (function(t2) {
          switch (t2.label) {
            ...
            case 1:
              ...
              return [4, n2.text()];
            case 2:
              if (c2 = t2.sent(), l3 = null === (h = null === (u = c2.match(/<title>(.*?)<\/title>/)) || void 0 === u ? void 0 : u[1]) || void 0 === h ? void 0 : h.trim(), this.getHostname(s2) != this.getHostname(n2.url) || l3 && ("Bot Verification" == l3 || "You are being redirected..." == l3 || "Un instant..." == l3 || "Just a moment..." == l3 || "Redirecting..." == l3)) throw new Error("Captcha error, please open in webview (or the website has changed url)");
              return [2, c2];
          }
        }));
      }));
      ...
      return (e2.match(/<article([^]*?)<\/article>/g) || []).forEach((function(e3) {
        ...
        if (i2 && a2) {
          var n2 = e3.match(/<img [^>]*?src="([^\"]*)"[^>]*?(?: data-src="([^\"]*)")?[^>]*>/) || [], c2 = void 0;
          if (a2.includes(t2.site)) c2 = a2.replace(t2.site, "");
          else {
            var l3 = a2.split("/");
            l3.shift(), l3.shift(), l3.shift(), c2 = l3.join("/");
          }
          r2.push({ name: i2, cover: n2[2] || n2[1] || o.defaultCover, path: c2 });
        }
      })), r2;
    }, l2.prototype.popularNovels = function(s2, r2) {
      return e(this, arguments, void 0, (function(e2, s3) {
        var r3, a2, i2, o2, n2, c2, l3, u, h, p = s3.filters, v = s3.showLatestNovels;
        return t(this, (function(t2) {
          switch (t2.label) {
            case 0:
              for (i2 in r3 = null !== (h = null === (u = this.options) || void 0 === u ? void 0 : u.seriesPath) && void 0 !== h ? h : "/series/", a2 = this.site + r3 + "?page=" + e2, p || (p = this.filters || {}), v && (a2 += "&order=latest"), p) if ("object" == typeof p[i2].value) for (o2 = 0, n2 = p[i2].value; o2 < n2.length; o2++) c2 = n2[o2], a2 += "&".concat(i2, "=").concat(c2);
              else p[i2].value && (a2 += "&".concat(i2, "=").concat(p[i2].value));
              return [4, this.safeFecth(a2, false)];
            case 1:
              return l3 = t2.sent(), [2, this.parseNovels(l3)];
          }
        }));
      }));
    }, l2.prototype.parseNovel = function(s2) {
      return e(this, void 0, void 0, (function() {
        var e2, a2, n2, l3, u, h, p, v, d, f, m, b, g, w, y, k, N, x, C, S, L;
        return t(this, (function(t2) {
          switch (t2.label) {
            case 0:
              return e2 = this.site, [4, this.safeFecth(e2 + s2, false)];
            case 1:
              return a2 = t2.sent(), n2 = { path: s2, name: "", genres: "", summary: "", author: "", artist: "", status: "", chapters: [] }, l3 = false, u = false, h = 0, p = false, v = false, d = false, f = false, m = false, b = false, g = false, w = 0, y = false, k = false, N = [], x = {}, C = this.hideLocked, S = new r.Parser({ onopentag: function(t3, s3) {
                var r2;
                !n2.cover && (null === (r2 = s3.class) || void 0 === r2 ? void 0 : r2.includes("ts-post-image")) ? (n2.name = s3.title, n2.cover = s3["data-src"] || s3.src || o.defaultCover) : "genxed" === s3.class || "sertogenre" === s3.class ? l3 = true : l3 && "a" === t3 ? u = true : "div" !== t3 || "entry-content" !== s3.class && "description" !== s3.itemprop ? "spe" === s3.class || "serl" === s3.class ? p = true : p && "span" === t3 ? v = true : "div" === t3 && "sertostat" === s3.class ? (p = true, v = true, m = true) : s3.class && s3.class.includes("eplister") ? b = true : b && "li" === t3 ? g = true : g ? "a" === t3 && void 0 === x.path ? x.path = s3.href.replace(e2, "").trim() : "epl-num" === s3.class ? w = 1 : "epl-title" === s3.class ? w = 2 : "epl-date" === s3.class ? w = 3 : "epl-price" === s3.class && (w = 4) : !h || "div" !== t3 && "script" !== t3 || h++ : h++;
              }, ontext: function(e3) {
                var t3, s3;
                if (l3) u && (n2.genres += e3 + ", ");
                  ...
                  if (1 === w) e3.includes("\u{1F512}") ? (y = true, k = true) : k && (y = false), c(e3, x);
                  else if (2 === w) x.name = (null === (s3 = null === (t3 = e3.match(RegExp("^".concat(n2.name.replace(/[.*+?^${}()|[\]\\]/g, "\\$&"), "\\s*(.+)")))) || void 0 === t3 ? void 0 : t3[1]) || void 0 === s3 ? void 0 : s3.trim()) || e3.trim(), x.chapterNumber || c(e3, x);
                ...
                var t3, s3, r2;
                l3 ? u ? u = false : (l3 = false, n2.genres = null === (t3 = n2.genres) || void 0 === t3 ? void 0 : t3.slice(0, -2)) : h ? "p" === e3 ? n2.summary += "\n\n" : "br" === e3 ? n2.summary += "\n" : "div" !== e3 && "script" !== e3 || h-- : p ? v ? "span" === e3 && (v = false, d && n2.author ? d = false : f && n2.artist ? f = false : m && "" !== n2.status && (m = false)) : "div" === e3 && (p = false, n2.author = null === (s3 = n2.author) || void 0 === s3 ? void 0 : s3.trim(), n2.artist = null === (r2 = n2.artist) || void 0 === r2 ? void 0 : r2.trim()) : b && (g ? 1 === w || 2 === w || 3 === w || 4 === w ? w = 0 : "li" === e3 && (g = false, x.chapterNumber || (x.chapterNumber = 0), y && (x.name = "\u{1F512} " + x.name), C && y || N.push(x), x = {}) : "ul" === e3 && (b = false));
              } }), S.write(a2), S.end(), N.length && ((null === (L = this.options) || void 0 === L ? void 0 : L.reverseChapters) && N.reverse(), n2.chapters = N), n2.summary = n2.summary.trim(), [2, n2];
          }
        }));
      }));
    ...
    }, l2.prototype.searchNovels = function(s2, r2) {
      return e(this, void 0, void 0, (function() {
        var e2, a2;
        return t(this, (function(t2) {
          switch (t2.label) {
