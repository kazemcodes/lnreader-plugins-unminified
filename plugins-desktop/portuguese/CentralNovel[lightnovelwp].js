...
var LNReaderPlugin = (() => {
  ...
  // .js/plugins/portuguese/CentralNovel[lightnovelwp].js
  var e = function(e2, a2, t2, l2) {
    return new (t2 || (t2 = Promise))((function(o2, i2) {
      ...
      function n2(e3) {
        var a3;
        e3.done ? o2(e3.value) : (a3 = e3.value, a3 instanceof t2 ? a3 : new t2((function(e4) {
          e4(a3);
        }))).then(s2, r2);
      }
    ...
    var t2, l2, o2, i2 = { label: 0, sent: function() {
      if (1 & o2[0]) throw o2[1];
      return o2[1];
    }, trys: [], ops: [] }, s2 = Object.create(("function" == typeof Iterator ? Iterator : Object).prototype);
    return s2.next = r2(0), s2.throw = r2(1), s2.return = r2(2), "function" == typeof Symbol && (s2[Symbol.iterator] = function() {
      return this;
    }), s2;
    function r2(r3) {
      return function(n2) {
        return (function(r4) {
          ...
          for (; s2 && (s2 = 0, r4[0] && (i2 = 0)), i2; ) try {
            if (t2 = 1, l2 && (o2 = 2 & r4[0] ? l2.return : r4[0] ? l2.throw || ((o2 = l2.return) && o2.call(l2), 0) : l2.next) && !(o2 = o2.call(l2, r4[1])).done) return o2;
            switch (l2 = 0, o2 && (r4 = [2 & r4[0], o2.value]), r4[0]) {
              case 0:
              case 1:
                o2 = r4;
                break;
              case 4:
                return i2.label++, { value: r4[1], done: false };
              case 5:
                i2.label++, l2 = r4[1], r4 = [0];
                continue;
              case 7:
                r4 = i2.ops.pop(), i2.trys.pop();
                continue;
              default:
                if (!(o2 = i2.trys, (o2 = o2.length > 0 && o2[o2.length - 1]) || 6 !== r4[0] && 2 !== r4[0])) {
                  i2 = 0;
                  continue;
                }
                ...
                if (6 === r4[0] && i2.label < o2[1]) {
                  i2.label = o2[1], o2 = r4;
                  break;
                }
                if (o2 && i2.label < o2[2]) {
                  i2.label = o2[2], i2.ops.push(r4);
                  break;
                }
  ...
  var t = (init_browser(), __toCommonJS(browser_exports)), l = require_lib9(), o = (init_fetch2(), __toCommonJS(fetch_exports)), i = (init_novelStatus(), __toCommonJS(novelStatus_exports)), s = (init_defaultCover(), __toCommonJS(defaultCover_exports)), r = (init_storage2(), __toCommonJS(storage_exports));
  function n(e2, a2) {
    var t2 = e2.match(/(\d+)$/);
  ...
  var u = new ((function() {
    function u2(e2) {
      ...
      var o2 = (null === (a2 = e2.options) || void 0 === a2 ? void 0 : a2.versionIncrements) || 0;
      this.version = "1.1.".concat(9 + o2), this.options = null !== (t2 = e2.options) && void 0 !== t2 ? t2 : {}, this.filters = e2.filters, (null === (l2 = this.options) || void 0 === l2 ? void 0 : l2.hasLocked) && (this.pluginSettings = { hideLocked: { value: "", label: "Hide locked chapters", type: "Switch" } });
    }
    return u2.prototype.getHostname = function(e2) {
      var a2 = (e2 = e2.split("/")[2]).split(".");
      return a2.pop(), a2.join(".");
    }, u2.prototype.safeFecth = function(t2, l2) {
      return e(this, void 0, void 0, (function() {
        var e2, i2, s2, r2, n2, u3, c, v;
        return a(this, (function(a2) {
          switch (a2.label) {
            case 0:
              return e2 = t2.split("://"), i2 = e2.shift(), s2 = e2[0].replace(/\/\//g, "/"), [4, (0, o.fetchApi)(i2 + "://" + s2)];
            case 1:
              if (!(r2 = a2.sent()).ok && 1 != l2) throw new Error("Could not reach site (" + r2.status + ") try to open in webview.");
              return [4, r2.text()];
            case 2:
              if (n2 = a2.sent(), u3 = null === (v = null === (c = n2.match(/<title>(.*?)<\/title>/)) || void 0 === c ? void 0 : c[1]) || void 0 === v ? void 0 : v.trim(), this.getHostname(t2) != this.getHostname(r2.url) || u3 && ("Bot Verification" == u3 || "You are being redirected..." == u3 || "Un instant..." == u3 || "Just a moment..." == u3 || "Redirecting..." == u3)) throw new Error("Captcha error, please open in webview (or the website has changed url)");
              return [2, n2];
          }
        }));
      }));
      ...
      return (e2.match(/<article([^]*?)<\/article>/g) || []).forEach((function(e3) {
        var t2 = e3.match(/<a href="([^\"]*)".*? title="([^\"]*)"/) || [], o2 = t2[1], i2 = t2[2];
        if (i2 && o2) {
          var r2 = e3.match(/<img [^>]*?src="([^\"]*)"[^>]*?(?: data-src="([^\"]*)")?[^>]*>/) || [], n2 = void 0;
          if (o2.includes(a2.site)) n2 = o2.replace(a2.site, "");
          else {
            var u3 = o2.split("/");
            u3.shift(), u3.shift(), u3.shift(), n2 = u3.join("/");
          }
          l2.push({ name: i2, cover: r2[2] || r2[1] || s.defaultCover, path: n2 });
        }
      })), l2;
    }, u2.prototype.popularNovels = function(t2, l2) {
      return e(this, arguments, void 0, (function(e2, t3) {
        var l3, o2, i2, s2, r2, n2, u3, c, v, h = t3.filters, p = t3.showLatestNovels;
        return a(this, (function(a2) {
          switch (a2.label) {
            case 0:
              for (i2 in l3 = null !== (v = null === (c = this.options) || void 0 === c ? void 0 : c.seriesPath) && void 0 !== v ? v : "/series/", o2 = this.site + l3 + "?page=" + e2, h || (h = this.filters || {}), p && (o2 += "&order=latest"), h) if ("object" == typeof h[i2].value) for (s2 = 0, r2 = h[i2].value; s2 < r2.length; s2++) n2 = r2[s2], o2 += "&".concat(i2, "=").concat(n2);
              else h[i2].value && (o2 += "&".concat(i2, "=").concat(h[i2].value));
              return [4, this.safeFecth(o2, false)];
            case 1:
              return u3 = a2.sent(), [2, this.parseNovels(u3)];
          }
        }));
      }));
    }, u2.prototype.parseNovel = function(t2) {
      return e(this, void 0, void 0, (function() {
        var e2, o2, r2, u3, c, v, h, p, d, b, f, m, g, y, w, k, C, N, S, x, P;
        return a(this, (function(a2) {
          switch (a2.label) {
            case 0:
              return e2 = this.site, [4, this.safeFecth(e2 + t2, false)];
            case 1:
              return o2 = a2.sent(), r2 = { path: t2, name: "", genres: "", summary: "", author: "", artist: "", status: "", chapters: [] }, u3 = false, c = false, v = 0, h = false, p = false, d = false, b = false, f = false, m = false, g = false, y = 0, w = false, k = false, C = [], N = {}, S = this.hideLocked, x = new l.Parser({ onopentag: function(a3, t3) {
                var l2;
                !r2.cover && (null === (l2 = t3.class) || void 0 === l2 ? void 0 : l2.includes("ts-post-image")) ? (r2.name = t3.title, r2.cover = t3["data-src"] || t3.src || s.defaultCover) : "genxed" === t3.class || "sertogenre" === t3.class ? u3 = true : u3 && "a" === a3 ? c = true : "div" !== a3 || "entry-content" !== t3.class && "description" !== t3.itemprop ? "spe" === t3.class || "serl" === t3.class ? h = true : h && "span" === a3 ? p = true : "div" === a3 && "sertostat" === t3.class ? (h = true, p = true, f = true) : t3.class && t3.class.includes("eplister") ? m = true : m && "li" === a3 ? g = true : g ? "a" === a3 && void 0 === N.path ? N.path = t3.href.replace(e2, "").trim() : "epl-num" === t3.class ? y = 1 : "epl-title" === t3.class ? y = 2 : "epl-date" === t3.class ? y = 3 : "epl-price" === t3.class && (y = 4) : !v || "div" !== a3 && "script" !== a3 || v++ : v++;
              }, ontext: function(e3) {
                var a3, t3;
                if (u3) c && (r2.genres += e3 + ", ");
                else if (1 === v && e3.trim()) r2.summary += e3;
                else if (h) {
                  if (p) {
                    var l2 = e3.toLowerCase().replace(":", "").trim();
                    if (d) r2.author += e3 || "Unknown";
                      ...
                      case "completado":
                      case "tamamland\u0131":
                        r2.status = i.NovelStatus.Completed;
                        break;
                      case "\u0645\u0633\u062A\u0645\u0631\u0629":
                      case "ongoing":
                      case "en cours":
                      ...
                      case "en progreso":
                      case "devam ediyor":
                        r2.status = i.NovelStatus.Ongoing;
                        break;
                      case "\u0645\u062A\u0648\u0642\u0641\u0629":
                      case "hiatus":
                      case "en pause":
                      ...
                      case "pausado":
                      case "duraklat\u0131ld\u0131":
                        r2.status = i.NovelStatus.OnHiatus;
                        break;
                      default:
                        r2.status = i.NovelStatus.Unknown;
                    }
                    switch (l2) {
                      case "\u0627\u0644\u0643\u0627\u062A\u0628":
                      case "author":
                  ...
                  else if (2 === y) N.name = (null === (t3 = null === (a3 = e3.match(RegExp("^".concat(r2.name.replace(/[.*+?^${}()|[\]\\]/g, "\\$&"), "\\s*(.+)")))) || void 0 === a3 ? void 0 : a3[1]) || void 0 === t3 ? void 0 : t3.trim()) || e3.trim(), N.chapterNumber || n(e3, N);
                ...
                var a3, t3, l2;
                u3 ? c ? c = false : (u3 = false, r2.genres = null === (a3 = r2.genres) || void 0 === a3 ? void 0 : a3.slice(0, -2)) : v ? "p" === e3 ? r2.summary += "\n\n" : "br" === e3 ? r2.summary += "\n" : "div" !== e3 && "script" !== e3 || v-- : h ? p ? "span" === e3 && (p = false, d && r2.author ? d = false : b && r2.artist ? b = false : f && "" !== r2.status && (f = false)) : "div" === e3 && (h = false, r2.author = null === (t3 = r2.author) || void 0 === t3 ? void 0 : t3.trim(), r2.artist = null === (l2 = r2.artist) || void 0 === l2 ? void 0 : l2.trim()) : m && (g ? 1 === y || 2 === y || 3 === y || 4 === y ? y = 0 : "li" === e3 && (g = false, N.chapterNumber || (N.chapterNumber = 0), w && (N.name = "\u{1F512} " + N.name), S && w || C.push(N), N = {}) : "ul" === e3 && (m = false));
              } }), x.write(o2), x.end(), C.length && ((null === (P = this.options) || void 0 === P ? void 0 : P.reverseChapters) && C.reverse(), r2.chapters = C), r2.summary = r2.summary.trim(), [2, r2];
          }
        }));
      }));
    }, u2.prototype.parseChapter = function(l2) {
      return e(this, void 0, void 0, (function() {
        var e2, o2, i2, s2, r2;
        return a(this, (function(a2) {
          switch (a2.label) {
            ...
            case 1:
              if (e2 = a2.sent(), null === (i2 = this.options) || void 0 === i2 ? void 0 : i2.customJs) try {
                o2 = (0, t.load)(e2), e2 = o2.html();
              } catch (e3) {
                throw console.error("Error executing customJs:", e3), e3;
              }
              return [2, (null === (r2 = null === (s2 = e2.match(/<div.*?class="epcontent ([^]*?)<div.*?class="?bottomnav/g)) || void 0 === s2 ? void 0 : s2[0].match(/<p[^>]*>([^]*?)<\/p>/g)) || void 0 === r2 ? void 0 : r2.join("\n")) || ""];
          }
        }));
      }));
    }, u2.prototype.searchNovels = function(t2, l2) {
      return e(this, void 0, void 0, (function() {
        var e2, o2;
        return a(this, (function(a2) {
          switch (a2.label) {
  ...
  })())({ id: "centralnovel", sourceSite: "https://centralnovel.com/", sourceName: "Central Novel", options: { lang: "Portuguese", reverseChapters: true }, filters: { "genre[]": { type: "Checkbox", label: "G\xEAnero", value: [], options: [{ label: "A\xE7\xE3o", value: "acao" }, { label: "Action", value: "action" }, { label: "Adulto", value: "adulto" }, { label: "Adventure", value: "adventure" }, { label: "Artes Marciais", value: "artes-marciais" }, { label: "Aventura", value: "aventura" }, { label: "Com\xE9dia", value: "comedia" }, { label: "Cotidiano", value: "cotidiano" }, { label: "Cultivo", value: "cultivo" }, { label: "Drama", value: "drama" }, { label: "Ecchi", value: "ecchi" }, { label: "Escolar", value: "escolar" }, { label: "Esportes", value: "esportes" }, { label: "Evolu\xE7\xE3o", value: "evolucao" }, { label: "Fantasia", value: "fantasia" }, { label: "Fantasy", value: "fantasy" }, { label: "Fic\xE7\xE3o Cient\xEDfica", value: "ficcao-cientifica" }, { label: "Gender Bender", value: "gender-bender" }, { label: "Har\xE9m", value: "harem" }, { label: "Hist\xF3rico", value: "historico" }, { label: "Isekai", value: "isekai" }, { label: "Josei", value: "josei" }, { label: "LitRPG", value: "litrpg" }, { label: "Magia", value: "magia" }, { label: "Mecha", value: "mecha" }, { label: "Medieval", value: "medieval" }, { label: "Mist\xE9rio", value: "misterio" }, { label: "Mitologia", value: "mitologia" }, { label: "Monstros", value: "monstros" }, { label: "Pet", value: "pet" }, { label: "Protagonista Feminina", value: "protagonista-feminina" }, { label: "Protagonista Maligno", value: "protagonista-maligno" }, { label: "Psicol\xF3gico", value: "psicologico" }, { label: "Psychological", value: "psychological" }, { label: "Reencarna\xE7\xE3o", value: "reencarnacao" }, { label: "Romance", value: "romance" }, { label: "Seinen", value: "seinen" }, { label: "Shoujo", value: "shoujo" }, { label: "Shounen", value: "shounen" }, { label: "Shounen BL", value: "shounen-bl" }, { label: "Sistema", value: "sistema" }, { label: "Sistema de Jogo", value: "sistema-de-jogo" }, { label: "Slice of Life", value: "slice-of-life" }, { label: "Sobrenatural", value: "sobrenatural" }, { label: "Supernatural", value: "supernatural" }, { label: "Terror", value: "terror" }, { label: "Trag\xE9dia", value: "tragedia" }, { label: "Transmigra\xE7\xE3o", value: "transmigracao" }, { label: "Vida Escolar", value: "vida-escolar" }, { label: "VRMMO", value: "vrmmo" }, { label: "Wuxia", value: "wuxia" }, { label: "Xianxia", value: "xianxia" }, { label: "Xuanhuan", value: "xuanhuan" }] }, "type[]": { type: "Checkbox", label: "Tipo", value: [], options: [{ label: "Light Novel", value: "light-novel" }, { label: "Novel Chinesa", value: "novel-chinesa" }, { label: "Novel Coreana", value: "novel-coreana" }, { label: "Novel Japonesa", value: "novel-japonesa" }, { label: "Novel Ocidental", value: "novel-ocidental" }, { label: "Webnovel", value: "webnovel" }] }, status: { type: "Picker", label: "Status", value: "", options: [{ label: "Todos", value: "" }, { label: "Em andamento", value: "em andamento" }, { label: "Hiato", value: "hiato" }, { label: "Completo", value: "completo" }] }, order: { type: "Picker", label: "Ordenar por", value: "", options: [{ label: "Padr\xE3o", value: "" }, { label: "A-Z", value: "title" }, { label: "Z-A", value: "titlereverse" }, { label: "\xDAlt. Att", value: "update" }, { label: "\xDAlt. Add", value: "latest" }, { label: "Populares", value: "popular" }, { label: "Avalia\xE7\xE3o", value: "rating" }] } } });
  exports.default = u;
})();
