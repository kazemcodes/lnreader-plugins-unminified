...
var LNReaderPlugin = (() => {
  ...
  // .js/plugins/portuguese/LightNovelBrasil[lightnovelwp].js
  var e = function(e2, a2, t2, l2) {
    ...
    var t2, l2, i2, r2 = { label: 0, sent: function() {
  ...
  var t = (init_browser(), __toCommonJS(browser_exports)), l = require_lib9(), i = (init_fetch2(), __toCommonJS(fetch_exports)), r = (init_novelStatus(), __toCommonJS(novelStatus_exports)), s = (init_defaultCover(), __toCommonJS(defaultCover_exports)), o = (init_storage2(), __toCommonJS(storage_exports));
  function n(e2, a2) {
    var t2 = e2.match(/(\d+)$/);
  ...
  var u = new ((function() {
    function u2(e2) {
      ...
      this.version = "1.1.".concat(9 + i2), this.options = null !== (t2 = e2.options) && void 0 !== t2 ? t2 : {}, this.filters = e2.filters, (null === (l2 = this.options) || void 0 === l2 ? void 0 : l2.hasLocked) && (this.pluginSettings = { hideLocked: { value: "", label: "Hide locked chapters", type: "Switch" } });
    }
    return u2.prototype.getHostname = function(e2) {
      ...
      return (e2.match(/<article([^]*?)<\/article>/g) || []).forEach((function(e3) {
        ...
        if (r2 && i2) {
          ...
          if (i2.includes(a2.site)) n2 = i2.replace(a2.site, "");
          else {
            var u3 = i2.split("/");
            u3.shift(), u3.shift(), u3.shift(), n2 = u3.join("/");
          }
          l2.push({ name: r2, cover: o2[2] || o2[1] || s.defaultCover, path: n2 });
        }
      })), l2;
    }, u2.prototype.popularNovels = function(t2, l2) {
      return e(this, arguments, void 0, (function(e2, t3) {
        var l3, i2, r2, s2, o2, n2, u3, c, v, h = t3.filters, p = t3.showLatestNovels;
        return a(this, (function(a2) {
          switch (a2.label) {
            case 0:
              for (r2 in l3 = null !== (v = null === (c = this.options) || void 0 === c ? void 0 : c.seriesPath) && void 0 !== v ? v : "/series/", i2 = this.site + l3 + "?page=" + e2, h || (h = this.filters || {}), p && (i2 += "&order=latest"), h) if ("object" == typeof h[r2].value) for (s2 = 0, o2 = h[r2].value; s2 < o2.length; s2++) n2 = o2[s2], i2 += "&".concat(r2, "=").concat(n2);
      ...
      return e(this, void 0, void 0, (function() {
        var e2, i2, o2, u3, c, v, h, p, d, f, b, m, g, y, w, k, N, x, C, S, L;
        return a(this, (function(a2) {
          switch (a2.label) {
            case 0:
              return e2 = this.site, [4, this.safeFecth(e2 + t2, false)];
            case 1:
              return i2 = a2.sent(), o2 = { path: t2, name: "", genres: "", summary: "", author: "", artist: "", status: "", chapters: [] }, u3 = false, c = false, v = 0, h = false, p = false, d = false, f = false, b = false, m = false, g = false, y = 0, w = false, k = false, N = [], x = {}, C = this.hideLocked, S = new l.Parser({ onopentag: function(a3, t3) {
                var l2;
                ...
                if (u3) c && (o2.genres += e3 + ", ");
                  ...
                  if (1 === y) e3.includes("\u{1F512}") ? (w = true, k = true) : k && (w = false), n(e3, x);
                  else if (2 === y) x.name = (null === (t3 = null === (a3 = e3.match(RegExp("^".concat(o2.name.replace(/[.*+?^${}()|[\]\\]/g, "\\$&"), "\\s*(.+)")))) || void 0 === a3 ? void 0 : a3[1]) || void 0 === t3 ? void 0 : t3.trim()) || e3.trim(), x.chapterNumber || n(e3, x);
                ...
                var a3, t3, l2;
                u3 ? c ? c = false : (u3 = false, o2.genres = null === (a3 = o2.genres) || void 0 === a3 ? void 0 : a3.slice(0, -2)) : v ? "p" === e3 ? o2.summary += "\n\n" : "br" === e3 ? o2.summary += "\n" : "div" !== e3 && "script" !== e3 || v-- : h ? p ? "span" === e3 && (p = false, d && o2.author ? d = false : f && o2.artist ? f = false : b && "" !== o2.status && (b = false)) : "div" === e3 && (h = false, o2.author = null === (t3 = o2.author) || void 0 === t3 ? void 0 : t3.trim(), o2.artist = null === (l2 = o2.artist) || void 0 === l2 ? void 0 : l2.trim()) : m && (g ? 1 === y || 2 === y || 3 === y || 4 === y ? y = 0 : "li" === e3 && (g = false, x.chapterNumber || (x.chapterNumber = 0), w && (x.name = "\u{1F512} " + x.name), C && w || N.push(x), x = {}) : "ul" === e3 && (m = false));
              } }), S.write(i2), S.end(), N.length && ((null === (L = this.options) || void 0 === L ? void 0 : L.reverseChapters) && N.reverse(), o2.chapters = N), o2.summary = o2.summary.trim(), [2, o2];
          }
        }));
      }));
        ...
        return a(this, (function(a2) {
          switch (a2.label) {
            ...
            case 1:
              ...
              return [2, (null === (o2 = null === (s2 = e2.match(/<div.*?class="epcontent ([^]*?)<div.*?class="?bottomnav/g)) || void 0 === s2 ? void 0 : s2[0].match(/<p[^>]*>([^]*?)<\/p>/g)) || void 0 === o2 ? void 0 : o2.join("\n")) || ""];
          }
        }));
      }));
  ...
  })())({ id: "lightnovelbrasil", sourceSite: "https://lightnovelbrasil.com/", sourceName: "Light Novel Brasil", options: { lang: "Portuguese", reverseChapters: true }, filters: { "genre[]": { type: "Checkbox", label: "Genre", value: [], options: [{ label: "+18", value: "18" }, { label: "A\xE7\xE3o", value: "acao" }, { label: "Artes Marciais", value: "artes-marciais" }, { label: "Aventura", value: "aventura" }, { label: "Com\xE9dia", value: "comedia" }, { label: "Cultivo", value: "cultivo" }, { label: "Cyberpunk", value: "cyberpunk" }, { label: "Drama", value: "drama" }, { label: "Ecchi", value: "ecchi" }, { label: "Esportes", value: "esportes" }, { label: "Fanfiction", value: "fanfiction" }, { label: "Fantasia", value: "fantasia" }, { label: "Fic\xE7\xE3o Cient\xEDfica", value: "ficcao-cientifica" }, { label: "Games", value: "games" }, { label: "Harem", value: "harem" }, { label: "Horror", value: "horror" }, { label: "Isekai", value: "isekai" }, { label: "Magia", value: "magia" }, { label: "Mecha", value: "mecha" }, { label: "Militar", value: "militar" }, { label: "Mist\xE9rio", value: "misterio" }, { label: "Novel Nacional", value: "novel-nacional" }, { label: "Psicol\xF3gico", value: "psicologico" }, { label: "Romance", value: "romance" }, { label: "Sci-fi", value: "sci-fi" }, { label: "Seinen", value: "seinen" }, { label: "Shoujo", value: "shoujo" }, { label: "Shounen", value: "shounen" }, { label: "Shounen BL", value: "shounen-bl" }, { label: "Slice of Life", value: "slice-of-life" }, { label: "Sobrenatural", value: "sobrenatural" }, { label: "Terror", value: "terror" }, { label: "Trag\xE9dia", value: "tragedia" }, { label: "Vida Escolar", value: "vida-escolar" }, { label: "Wuxia", value: "wuxia" }, { label: "Xianxia", value: "xianxia" }, { label: "Xuanhuan", value: "xuanhuan" }, { label: "Yaoi", value: "yaoi" }, { label: "Yuri", value: "yuri" }] }, "type[]": { type: "Checkbox", label: "Tipo", value: [], options: [{ label: "Light Novel", value: "light-novel" }, { label: "Livro", value: "livro" }, { label: "One-Shot", value: "one-shot" }, { label: "Web Novel", value: "web-novel" }] }, status: { type: "Picker", label: "Status", value: "", options: [{ label: "Tudo", value: "" }, { label: "Ongoing", value: "ongoing" }, { label: "Hiatus", value: "hiatus" }, { label: "Completed", value: "completed" }] }, order: { type: "Picker", label: "Ordenar por", value: "", options: [{ label: "Padr\xE3o", value: "" }, { label: "A-Z", value: "title" }, { label: "Z-A", value: "titlereverse" }, { label: "\xDAltimos Lan\xE7amentos", value: "update" }, { label: "\xDAltima Adi\xE7\xE3o", value: "latest" }, { label: "Popular", value: "popular" }] } } });
  exports.default = u;
})();
