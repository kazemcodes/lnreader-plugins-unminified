  ...
  var LightNovelWPPlugin = (
    ...
    function() {
      ...
      LightNovelWPPlugin2.prototype.parseChapter = function(chapterPath) {
        return __awaiter(this, void 0, void 0, function() {
          var data2, $2, url, offsets, idx, _a, _, offsetLower_1, offsetCap_1, asciiA_1, asciiz_1;
          var _b, _c, _d, _e;
          return __generator(this, function(_f) {
            switch (_f.label) {
              case 0:
              ...
              case 1:
                data2 = _f.sent();
                if ((_b = this.options) === null || _b === void 0 ? void 0 : _b.customJs) {
                  try {
                    $2 = (0, cheerio_1.load)(data2);
                    $2("div.entry-content script").remove();
                    url = this.site + chapterPath.slice(0, -1);
                    offsets = [[0, 12368, 12462], [1, 6960, 7054], [2, 4176, 4270]];
                    idx = url.length * url.charCodeAt(url.length - 1) * 2 % 3;
                    _a = (_c = offsets[idx]) !== null && _c !== void 0 ? _c : offsets[0], _ = _a[0], offsetLower_1 = _a[1], offsetCap_1 = _a[2];
                    asciiA_1 = "A".charCodeAt(0);
                    asciiz_1 = "z".charCodeAt(0);
                    $2("div.entry-content > p").text(function(_2, txt) {
                      return txt.split("").map(function(char) {
                        var code = char.charCodeAt(0);
                        var offset = code >= offsetLower_1 + asciiA_1 && code <= offsetLower_1 + asciiz_1 ? offsetLower_1 : offsetCap_1;
                ...
                return [2, ((_e = (_d = data2.match(/<div.*?class="epcontent ([^]*?)<div.*?class="?bottomnav/g)) === null || _d === void 0 ? void 0 : _d[0].match(/<p[^>]*>([^]*?)<\/p>/g)) === null || _e === void 0 ? void 0 : _e.join("\n")) || ""];
            }
          });
        });
      };
