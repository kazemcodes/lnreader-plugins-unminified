...
var LNReaderPlugin = (() => {
  ...
  var LightNovelVN = (
    ...
    function() {
      ...
      __name(LightNovelVN2, "LightNovelVN");
      LightNovelVN2.prototype.popularNovels = function(pageNo) {
            ...
            switch (_a.label) {
              ...
              case 1:
                ...
                loadedCheerio(".flex.flex-col[itemtype='https://schema.org/Book']").each(function(idx, ele) {
                  var _a2;
                  var novelName = loadedCheerio(ele).find('h3[itemprop="name"] > a').text().trim();
                  var img = loadedCheerio(ele).find("noscript").html();
                  var novelCover = (_a2 = img === null || img === void 0 ? void 0 : img.match(/srcSet="([^\s]+)/)) === null || _a2 === void 0 ? void 0 : _a2[1];
                  var novelUrl = loadedCheerio(ele).find('h3[itemprop="name"] > a').attr("href");
                  if (novelUrl)
                    novels.push({
                      name: novelName,
                      cover: novelCover,
      ...
      LightNovelVN2.prototype.parseChapters = function(loadedCheerio) {
        var _this = this;
        var chapters = [];
      ...
      LightNovelVN2.prototype.parseNovel = function(novelPath) {
        return __awaiter(this, void 0, void 0, function() {
            ...
            switch (_b.label) {
              ...
              case 1:
                ...
                novel = {
                  path: novelPath,
                  chapters: [],
                  name: "Kh\xF4ng c\xF3 ti\xEAu \u0111\u1EC1",
                  totalPages: 1
                };
                novel.name = loadedCheerio('h1[itemprop="name"]').text().trim();
                novel.cover = (_a = loadedCheerio("header div:nth-child(2) img").attr("srcset")) === null || _a === void 0 ? void 0 : _a.split(/\s+/)[0];
                genres = [];
                ...
                } else if (novel.status === "Ho\xE0n th\xE0nh") {
                ...
                delay = /* @__PURE__ */ __name(function(ms) {
              ...
              case 2:
                ...
                return [4, (0, fetch_1.fetchApi)(chapterListUrl).then(function(r) {
                  return r.text();
                })];
              case 3:
                ...
                loadedChapterList('nav[aria-label="Pagination"] a').each(function(index2, ele) {
                  var _a2;
                  var href = ele.attribs["href"];
                  if (href) {
                    var page = Number((_a2 = href.match(/\?page=(\d+)/)) === null || _a2 === void 0 ? void 0 : _a2[1]);
      ...
      LightNovelVN2.prototype.parsePage = function(novelPath, page) {
        return __awaiter(this, void 0, void 0, function() {
      ...
      LightNovelVN2.prototype.parseChapter = function(chapterPath) {
        return __awaiter(this, void 0, void 0, function() {
      ...
      LightNovelVN2.prototype.searchNovels = function(searchTerm, pageNo) {
        return __awaiter(this, void 0, void 0, function() {
