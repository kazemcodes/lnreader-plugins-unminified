...
var LNReaderPlugin = (() => {
  ...
  var FictionZonePlugin = (
    /** @class */
    function() {
      function FictionZonePlugin2() {
        var _this = this;
        this.id = "fictionzone";
        ...
        this.cachedNovelIds = /* @__PURE__ */ new Map();
        this.resolveUrl = function(path, isNovel) {
          return _this.site + "/" + path;
        };
      }
      __name(FictionZonePlugin2, "FictionZonePlugin");
      FictionZonePlugin2.prototype.popularNovels = function(pageNo_1, _a) {
        return __awaiter(this, arguments, void 0, function(pageNo, _b) {
          var showLatestNovels = _b.showLatestNovels, filters = _b.filters;
          return __generator(this, function(_c) {
            switch (_c.label) {
              case 0:
                return [4, this.getPage(this.site + "/library?page=" + pageNo)];
              case 1:
                return [2, _c.sent()];
            }
          });
      ...
      FictionZonePlugin2.prototype.getPage = function(url) {
          ...
          return __generator(this, function(_a) {
            switch (_a.label) {
              ...
              case 2:
                ...
                return [2, loadedCheerio("div.novel-card").map(function(i, el) {
      ...
      FictionZonePlugin2.prototype.parseNovel = function(novelPath) {
        return __awaiter(this, void 0, void 0, function() {
          var req, body, loadedCheerio, novel, status, nuxtData, parsed, last2, _i, parsed_1, a;
          var _this = this;
          return __generator(this, function(_a) {
            switch (_a.label) {
              case 0:
              ...
              case 2:
                ...
                novel.genres = __spreadArray(__spreadArray([], loadedCheerio("div.genres > .items > span").map(function(i, el) {
                  return loadedCheerio(el).text();
                }).toArray(), true), loadedCheerio("div.tags > .items > a").map(function(i, el) {
                  return loadedCheerio(el).text();
                }).toArray(), true).join(",");
                status = loadedCheerio("div.novel-status > div.content").text().trim();
                if (status === "Ongoing")
                ...
                this.cachedNovelIds.set(novelPath, last2.toString());
                novel.chapters = loadedCheerio("div.chapters > div.list-wrapper > div.items > a.chapter").map(function(i, el) {
                  var _a2;
                  var chapterName = loadedCheerio(el).find("span.chapter-title").text();
                  var chapterUrl = (_a2 = loadedCheerio(el).attr("href")) === null || _a2 === void 0 ? void 0 : _a2.replace(/^\//, "").replace(/\/$/, "");
      ...
      FictionZonePlugin2.prototype.parsePage = function(novelPath, page) {
        return __awaiter(this, void 0, void 0, function() {
          var id, data2;
          return __generator(this, function(_a) {
            switch (_a.label) {
              ...
              case 1:
                ...
                _a.label = 2;
              case 2:
                return [4, (0, fetch_1.fetchApi)(this.site + "/api/__api_party/api-v1", {
                  method: "POST",
                  headers: {
              ...
              case 3:
                data2 = _a.sent();
                return [2, {
                  chapters: data2._data.map(function(c) {
                    return {
                      name: c.title,
      ...
      FictionZonePlugin2.prototype.parseChapter = function(chapterPath) {
        return __awaiter(this, void 0, void 0, function() {
          var req, body, loadedCheerio;
          return __generator(this, function(_a) {
            switch (_a.label) {
              ...
              case 2:
                body = _a.sent();
                loadedCheerio = (0, cheerio_1.load)(body);
                return [2, loadedCheerio("div.chapter-content").html() || ""];
            }
          });
        });
      };
      FictionZonePlugin2.prototype.searchNovels = function(searchTerm, pageNo) {
        return __awaiter(this, void 0, void 0, function() {
          return __generator(this, function(_a) {
            switch (_a.label) {
              case 0:
                return [4, this.getPage(this.site + "/library?query=" + encodeURIComponent(searchTerm) + "&page=" + pageNo + "&sort=views-all")];
              case 1:
                return [2, _a.sent()];
            }
          });
      ...
      FictionZonePlugin2.prototype.parseAgoDate = function(date) {
        var _a;
        if (date === null || date === void 0 ? void 0 : date.includes("ago")) {
          var dayJSDate = (0, dayjs_1.default)(/* @__PURE__ */ new Date());
          ...
          if (date.includes("years ago") || date.includes("year ago")) {
            dayJSDate.subtract(timeAgoInt, "years");
          }
          return dayJSDate.toISOString();
        }
        return null;
      };
      return FictionZonePlugin2;
    }()
  );
