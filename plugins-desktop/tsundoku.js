...
var LNReaderPlugin = (() => {
  ...
  var TsundokuPlugin = (
    /** @class */
    function() {
      function TsundokuPlugin2() {
        this.id = "tsundoku";
        this.name = "Tsundoku Tradu\xE7\xF5es";
        this.version = "1.0.1";
        ...
        this.filters = {
          ...
          genre: {
            ...
            value: [],
            options: [
              { label: "A\xE7\xE3o", value: "328" },
              { label: "Adult", value: "343" },
              { label: "Anatomia", value: "408" },
              { label: "Artes Marciais", value: "340" },
              { label: "Aventura", value: "315" },
              { label: "Ci\xEAncia", value: "398" },
              { label: "Com\xE9dia", value: "322" },
              { label: "Com\xE9dia Rom\xE2ntica", value: "378" },
              ...
              { label: "Har\xE9m", value: "350" },
              { label: "Hentai", value: "344" },
              { label: "Hist\xF3ria", value: "400" },
              { label: "Hist\xF3rico", value: "380" },
              ...
              { label: "M\xE1gia", value: "372" },
              { label: "Mecha", value: "335" },
              { label: "Militar", value: "414" },
              { label: "Mist\xE9rio", value: "319" },
              { label: "Otaku", value: "365" },
              { label: "Psicol\xF3gico", value: "320" },
              { label: "Reencarna\xE7\xE3o", value: "358" },
              { label: "Romance", value: "312" },
              { label: "RPG", value: "366" },
              { label: "S\xE1tira", value: "367" },
              { label: "Sci-fi", value: "371" },
              { label: "Seinen", value: "326" },
              { label: "Sexo Expl\xEDcito", value: "345" },
      ...
      __name(TsundokuPlugin2, "TsundokuPlugin");
      TsundokuPlugin2.prototype.parseDate = function(date) {
        var monthMapping = {
          janeiro: 1,
          fevereiro: 2,
          marco: 3,
      ...
      TsundokuPlugin2.prototype.parseNovels = function(loadedCheerio) {
        var _this = this;
        var novels = [];
      ...
      TsundokuPlugin2.prototype.popularNovels = function(page_1, _a) {
          ...
          return __generator(this, function(_c) {
            switch (_c.label) {
              case 0:
                ...
                return [4, (0, fetch_1.fetchApi)(url).then(function(result) {
                  return result.text();
                })];
              case 1:
                body = _c.sent();
      ...
      TsundokuPlugin2.prototype.parseNovel = function(novelPath) {
            ...
            switch (_a.label) {
              ...
              case 1:
                ...
                novel = {
                  ...
                  summary: loadedCheerio(".entry-content.entry-content-single div:eq(0)").text().trim(),
                  chapters: []
                };
                novel.author = loadedCheerio('.tsinfo .imptdt:contains("Autor")').text().replace("Autor ", "").trim();
                novel.artist = loadedCheerio('.tsinfo .imptdt:contains("Artista")').text().replace("Artista ", "").trim();
                novel.status = loadedCheerio('.tsinfo .imptdt:contains("Status")').text().replace("Status ", "").trim();
                novel.genres = loadedCheerio(".mgen a").map(function(_, ex) {
                  return loadedCheerio(ex).text();
                }).toArray().join(",");
                chapters = [];
                ...
                novel.chapters = chapters.reverse().map(function(c, i) {
                  return __assign(__assign({}, c), { name: c.name + " - Ch. ".concat(i + 1), chapterNumber: i + 1 });
                });
                return [2, novel];
            }
          });
      ...
      TsundokuPlugin2.prototype.searchNovels = function(searchTerm, pageNo) {
        return __awaiter(this, void 0, void 0, function() {
          var params, url, body, loadedCheerio;
          return __generator(this, function(_a) {
            switch (_a.label) {
      ...
      TsundokuPlugin2.prototype.parseChapter = function(chapterPath) {
        return __awaiter(this, void 0, void 0, function() {
          var body, loadedCheerio, chapterTitle, novelTitle, title2, spoilerContent, $readerarea, chapterText, parts, lastPart;
          var _this = this;
          return __generator(this, function(_a) {
            switch (_a.label) {
              case 0:
              ...
              case 1:
                ...
                title2 = chapterTitle.replace(novelTitle, "").replace(/^\W+/, "").trim();
                spoilerContent = loadedCheerio("#readerarea .collapseomatic_content").html();
                if (spoilerContent) {
                  return [2, "<h1>".concat(title2, "</h1>\n").concat(spoilerContent)];
                }
                $readerarea = loadedCheerio("#readerarea");
                $readerarea.find("img.wp-image-15656").remove();
                $readerarea.find("p").each(function(i, el) {
                  var _a2, _b;
                  var $this = loadedCheerio(el);
                  var $imgs = $this.find("img");
                  var cleanContent = (_b = (_a2 = $this.text()) === null || _a2 === void 0 ? void 0 : _a2.replace(/\s|&nbsp;/g, "")) === null || _b === void 0 ? void 0 : _b.replace(_this.site, "");
