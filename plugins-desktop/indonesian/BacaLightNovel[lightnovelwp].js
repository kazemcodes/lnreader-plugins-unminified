...
var LNReaderPlugin = (() => {
  ...
  // .js/plugins/indonesian/BacaLightNovel[lightnovelwp].js
  ...
  var t = (init_browser(), __toCommonJS(browser_exports)), l = require_lib9(), r = (init_fetch2(), __toCommonJS(fetch_exports)), s = (init_novelStatus(), __toCommonJS(novelStatus_exports)), i = (init_defaultCover(), __toCommonJS(defaultCover_exports)), o = (init_storage2(), __toCommonJS(storage_exports));
  function n(e2, a2) {
    var t2 = e2.match(/(\d+)$/);
    ...
    return u2.prototype.getHostname = function(e2) {
      ...
      return (e2.match(/<article([^]*?)<\/article>/g) || []).forEach((function(e3) {
        ...
        if (s2 && r2) {
          ...
          if (r2.includes(a2.site)) n2 = r2.replace(a2.site, "");
          else {
            var u3 = r2.split("/");
            u3.shift(), u3.shift(), u3.shift(), n2 = u3.join("/");
          }
          l2.push({ name: s2, cover: o2[2] || o2[1] || i.defaultCover, path: n2 });
        }
      })), l2;
    }, u2.prototype.popularNovels = function(t2, l2) {
      return e(this, arguments, void 0, (function(e2, t3) {
        var l3, r2, s2, i2, o2, n2, u3, c, v, h = t3.filters, p = t3.showLatestNovels;
        return a(this, (function(a2) {
          switch (a2.label) {
            case 0:
              for (s2 in l3 = null !== (v = null === (c = this.options) || void 0 === c ? void 0 : c.seriesPath) && void 0 !== v ? v : "/series/", r2 = this.site + l3 + "?page=" + e2, h || (h = this.filters || {}), p && (r2 += "&order=latest"), h) if ("object" == typeof h[s2].value) for (i2 = 0, o2 = h[s2].value; i2 < o2.length; i2++) n2 = o2[i2], r2 += "&".concat(s2, "=").concat(n2);
        ...
        return a(this, (function(a2) {
          switch (a2.label) {
            ...
            case 1:
              ...
              } }), C.write(r2), C.end(), S.length && ((null === (j = this.options) || void 0 === j ? void 0 : j.reverseChapters) && S.reverse(), o2.chapters = S), o2.summary = o2.summary.trim(), [2, o2];
          }
        }));
      }));
