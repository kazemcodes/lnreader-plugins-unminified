...
var LNReaderPlugin = (() => {
  ...
  var FenrirRealmPlugin = (
    /** @class */
    function() {
      function FenrirRealmPlugin2() {
        var _this = this;
        this.id = "fenrir";
      ...
      __name(FenrirRealmPlugin2, "FenrirRealmPlugin");
      FenrirRealmPlugin2.prototype.popularNovels = function(pageNo_1, _a) {
          ...
          return __generator(this, function(_c) {
            switch (_c.label) {
              case 0:
                ...
                if (showLatestNovels)
                  sort = "latest";
                genresFilter = filters.genres.value.map(function(g) {
                  return "&genres%5B%5D=" + g;
                }).join("");
                return [4, (0, fetch_1.fetchApi)("".concat(this.site, "/api/series/filter?page=").concat(pageNo, "&per_page=20&status=").concat(filters.status.value, "&order=").concat(sort).concat(genresFilter)).then(function(r) {
              ...
              case 1:
                res = _c.sent();
                return [2, res.data.map(function(r) {
                  return _this.parseNovelFromApi(r);
                })];
            }
          });
        });
      };
      FenrirRealmPlugin2.prototype.parseNovel = function(novelPath) {
        return __awaiter(this, void 0, void 0, function() {
          var html3, loadedCheerio, novel, coverMatch, chapters;
          return __generator(this, function(_a) {
            switch (_a.label) {
              case 0:
                return [4, (0, fetch_1.fetchApi)("".concat(this.site, "/series/").concat(novelPath), {}).then(function(r) {
                  return r.text();
                })];
              case 1:
                html3 = _a.sent();
                ...
                novel = {
                  ...
                  summary: loadedCheerio("div.overflow-hidden.transition-all.max-h-\\[108px\\] p").map(function(i, el) {
                    return (0, cheerio_1.load)(el).text();
                  }).get().join("\n\n")
                };
                novel.author = loadedCheerio("div.flex-1 > div.mb-3 > a.inline-flex").text();
                coverMatch = html3.match(/,cover:"storage\/(.+?)",cover_data_url/);
                novel.cover = coverMatch ? this.site + "/storage/" + coverMatch[1] : defaultCover_1.defaultCover;
                novel.genres = loadedCheerio("div.flex-1 > div.flex:not(.mb-3, .mt-5) > a").map(function(i, el) {
                  return (0, cheerio_1.load)(el).text();
                }).toArray().join(",");
                novel.status = loadedCheerio("div.flex-1 > div.mb-3 > span.rounded-md").first().text();
                return [4, (0, fetch_1.fetchApi)(this.site + "/api/novels/chapter-list/" + novelPath).then(function(r) {
                  return r.json();
                })];
              case 2:
                chapters = _a.sent();
                if (this.hideLocked) {
                  chapters = chapters.filter(function(c) {
                    var _a2;
                    return !((_a2 = c.locked) === null || _a2 === void 0 ? void 0 : _a2.price);
                  });
                }
                novel.chapters = chapters.map(function(c) {
                  var _a2, _b, _c, _d, _e, _f;
                  return {
                    name: (((_a2 = c.locked) === null || _a2 === void 0 ? void 0 : _a2.price) ? "\u{1F512} " : "") + (((_b = c.group) === null || _b === void 0 ? void 0 : _b.index) === null ? "" : "Vol " + ((_c = c.group) === null || _c === void 0 ? void 0 : _c.index) + " ") + "Chapter " + c.number + (c.title && c.title.trim() != "Chapter " + c.number ? " - " + c.title.replace(/^chapter [0-9]+ . /i, "") : ""),
                    path: novelPath + (((_d = c.group) === null || _d === void 0 ? void 0 : _d.index) === null ? "" : "/" + ((_e = c.group) === null || _e === void 0 ? void 0 : _e.slug)) + "/chapter-" + c.number,
                    releaseTime: c.created_at,
                    chapterNumber: c.number + (((_f = c.group) === null || _f === void 0 ? void 0 : _f.index) || 0) * 1e12
                  };
                }).sort(function(a, b) {
      ...
      FenrirRealmPlugin2.prototype.parseChapter = function(chapterPath) {
        return __awaiter(this, void 0, void 0, function() {
          var page, chapter;
          return __generator(this, function(_a) {
            switch (_a.label) {
              case 0:
                return [4, (0, fetch_1.fetchApi)(this.site + "/series/" + chapterPath, {}).then(function(r) {
                  return r.text();
                })];
              case 1:
                page = _a.sent();
                chapter = (0, cheerio_1.load)(page)('[id^="reader-area-"]');
                chapter.contents().filter(function(_, node) {
                  return node.type === "comment";
                }).remove();
                return [2, chapter.html() || ""];
            }
          });
        });
      };
      FenrirRealmPlugin2.prototype.searchNovels = function(searchTerm, pageNo) {
        return __awaiter(this, void 0, void 0, function() {
          var _this = this;
          return __generator(this, function(_a) {
            switch (_a.label) {
              case 0:
                return [4, (0, fetch_1.fetchApi)("".concat(this.site, "/api/series/filter?page=").concat(pageNo, "&per_page=20&search=").concat(encodeURIComponent(searchTerm))).then(function(r) {
                  return r.json();
                }).then(function(r) {
                  return r.data.map(function(novel) {
      ...
      FenrirRealmPlugin2.prototype.parseNovelFromApi = function(apiData) {
        return {
          name: apiData.title,
          path: apiData.slug,
          ...
          genres: apiData.genres.map(function(g) {
            return g.name;
          }).join(",")
        };
      };
      return FenrirRealmPlugin2;
    }()
  );
  ...
  function getUpdatedGenres() {
    return __awaiter(this, void 0, void 0, function() {
      ...
      return __generator(this, function(_a) {
        switch (_a.label) {
          case 0:
            return [4, fetch("https://fenrirealm.com/api/novels/taxonomy/genres").then(function(d) {
              return d.json();
            })];
          case 1:
            data2 = _a.sent();
            genreData = data2.map(function(g) {
              return {
                label: g.name,
                value: g.id.toString()
              };
  ...
  __name(getUpdatedGenres, "getUpdatedGenres");
})();
