...
var LNReaderPlugin = (() => {
  ...
  var WarriorLegendTradPlugin = (
    /** @class */
    function() {
      function WarriorLegendTradPlugin2() {
      ...
      __name(WarriorLegendTradPlugin2, "WarriorLegendTradPlugin");
      WarriorLegendTradPlugin2.prototype.getCheerio = function(url) {
      ...
      WarriorLegendTradPlugin2.prototype.popularNovels = function(pageNo) {
        return __awaiter(this, void 0, void 0, function() {
          ...
          return __generator(this, function(_a) {
            switch (_a.label) {
              ...
              case 1:
                $2 = _a.sent();
                $2("div div div article").each(function(i, elem) {
                  var novelName = $2(elem).find(".entry-wrapper h2").first().text().trim();
                  var novelUrl = $2(elem).find(".entry-wrapper h2 a").attr("href");
                  var novelCover = $2(elem).find("figure a img").attr("src") || defaultCover_1.defaultCover;
      ...
      WarriorLegendTradPlugin2.prototype.parseNovel = function(novelPath) {
        return __awaiter(this, void 0, void 0, function() {
          var novel, $2, entryContentText, chapters;
          var _this = this;
          return __generator(this, function(_a) {
            switch (_a.label) {
              case 0:
              ...
              case 1:
                $2 = _a.sent();
                novel.name = $2(".site-main article header h1").text().trim();
                novel.cover = $2(".site-main article figure img").first().attr("src") || defaultCover_1.defaultCover;
                ...
                chapters = [];
                $2("div div article div").find("h2 a, h3 a").each(function(i, elem) {
      ...
      WarriorLegendTradPlugin2.prototype.extractInfo = function(text3, regexes) {
      ...
      WarriorLegendTradPlugin2.prototype.getStatus = function(text3) {
        var regexSummary = [
          /État sur le site :([^\n]*)/i,
          /état sur le site:([^\n]*)/i
        ];
        var status = this.extractInfo(text3, regexSummary);
        ...
        } else if (status.includes("termin\xE9")) {
          return novelStatus_1.NovelStatus.Completed;
        } else if (status.includes("abandonn\xE9")) {
          return novelStatus_1.NovelStatus.Cancelled;
        }
        return novelStatus_1.NovelStatus.Ongoing;
      };
      WarriorLegendTradPlugin2.prototype.parseChapter = function(chapterPath) {
        return __awaiter(this, void 0, void 0, function() {
          var $2, contenuHtml;
          return __generator(this, function(_a) {
            switch (_a.label) {
              ...
              case 1:
                ...
                $2(".entry-content").contents().each(function() {
                  var _a2, _b, _c;
                  if (!((_a2 = $2.html(this)) === null || _a2 === void 0 ? void 0 : _a2.startsWith("<div")) && !((_b = $2.html(this)) === null || _b === void 0 ? void 0 : _b.startsWith("<hr")) && !((_c = $2.html(this)) === null || _c === void 0 ? void 0 : _c.includes("<script"))) {
      ...
      WarriorLegendTradPlugin2.prototype.searchNovels = function(searchTerm, pageNo) {
        return __awaiter(this, void 0, void 0, function() {
      ...
      return WarriorLegendTradPlugin2;
    }()
  );
