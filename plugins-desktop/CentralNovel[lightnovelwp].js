...
var LNReaderPlugin = (() => {
  ...
  var cheerio_1 = (init_browser(), __toCommonJS(browser_exports));
  ...
  var storage_1 = (init_storage2(), __toCommonJS(storage_exports));
  var LightNovelWPPlugin = (
    /** @class */
    function() {
      function LightNovelWPPlugin2(metadata) {
        var _a, _b, _c;
      ...
      __name(LightNovelWPPlugin2, "LightNovelWPPlugin");
      LightNovelWPPlugin2.prototype.getHostname = function(url) {
        url = url.split("/")[2];
        var url_parts = url.split(".");
        url_parts.pop();
        return url_parts.join(".");
      };
      LightNovelWPPlugin2.prototype.safeFecth = function(url, search) {
        return __awaiter(this, void 0, void 0, function() {
          var urlParts, protocol, sanitizedUri, r, data2, title2;
          var _a, _b;
          return __generator(this, function(_c) {
            switch (_c.label) {
              case 0:
                ...
                return [4, (0, fetch_1.fetchApi)(protocol + "://" + sanitizedUri)];
              case 1:
                r = _c.sent();
                if (!r.ok && search != true)
              ...
              case 2:
                data2 = _c.sent();
                title2 = (_b = (_a = data2.match(/<title>(.*?)<\/title>/)) === null || _a === void 0 ? void 0 : _a[1]) === null || _b === void 0 ? void 0 : _b.trim();
                if (this.getHostname(url) != this.getHostname(r.url) || title2 && (title2 == "Bot Verification" || title2 == "You are being redirected..." || title2 == "Un instant..." || title2 == "Just a moment..." || title2 == "Redirecting..."))
      ...
      LightNovelWPPlugin2.prototype.parseNovels = function(html3) {
        var _this = this;
        html3 = (0, cheerio_1.load)(html3).html();
        var novels = [];
        var articles = html3.match(/<article([^]*?)<\/article>/g) || [];
      ...
      LightNovelWPPlugin2.prototype.popularNovels = function(pageNo_1, _a) {
        return __awaiter(this, arguments, void 0, function(pageNo, _b) {
          var seriesPath, url, key, _i, _c, value, html3;
          var _d, _e;
          ...
          return __generator(this, function(_f) {
            switch (_f.label) {
              case 0:
                ...
                return [4, this.safeFecth(url, false)];
              case 1:
                html3 = _f.sent();
                return [2, this.parseNovels(html3)];
            }
          });
        });
      };
      LightNovelWPPlugin2.prototype.parseNovel = function(novelPath) {
        return __awaiter(this, void 0, void 0, function() {
          var baseURL, html3, novel, isParsingGenres, isReadingGenre, isReadingSummary, isParsingInfo, isReadingInfo, isReadingAuthor, isReadingArtist, isReadingStatus, isParsingChapterList, isReadingChapter, isReadingChapterInfo, isPaidChapter, hasLockItemOnChapterNum, chapters, tempChapter, hideLocked, parser;
          var _a;
          return __generator(this, function(_b) {
            switch (_b.label) {
              case 0:
                baseURL = this.site;
                return [4, this.safeFecth(baseURL + novelPath, false)];
              case 1:
                html3 = _b.sent();
                novel = {
                  path: novelPath,
                ...
                parser = new htmlparser2_1.Parser({
                  onopentag: /* @__PURE__ */ __name(function(name, attribs) {
                    var _a2;
                    if (!novel.cover && ((_a2 = attribs["class"]) === null || _a2 === void 0 ? void 0 : _a2.includes("ts-post-image"))) {
                      novel.name = attribs["title"];
                      novel.cover = attribs["data-src"] || attribs["src"] || defaultCover_1.defaultCover;
                    } else if (attribs["class"] === "genxed" || attribs["class"] === "sertogenre") {
                      isParsingGenres = true;
                    } else if (isParsingGenres && name === "a") {
                      isReadingGenre = true;
                    } else if (name === "div" && (attribs["class"] === "entry-content" || attribs["itemprop"] === "description")) {
                      isReadingSummary++;
                      ...
                      if (name === "a" && tempChapter.path === void 0) {
                  ...
                  ontext: /* @__PURE__ */ __name(function(data2) {
                    ...
                    if (isParsingGenres) {
                    ...
                    } else if (isReadingSummary === 1 && data2.trim()) {
                      novel.summary += data2;
                    } else if (isParsingInfo) {
                      if (isReadingInfo) {
                        var detailName = data2.toLowerCase().replace(":", "").trim();
                        if (isReadingAuthor) {
                          novel.author += data2 || "Unknown";
                        } else if (isReadingArtist) {
                          novel.artist += data2 || "Unknown";
                      ...
                      if (isReadingChapter) {
                        if (isReadingChapterInfo === 1) {
                          if (data2.includes("\u{1F512}")) {
                            isPaidChapter = true;
                            hasLockItemOnChapterNum = true;
                          } else if (hasLockItemOnChapterNum) {
                            isPaidChapter = false;
                          }
                          extractChapterNumber(data2, tempChapter);
                        } else if (isReadingChapterInfo === 2) {
                          tempChapter.name = ((_b2 = (_a2 = data2.match(RegExp("^".concat(novel.name.replace(/[.*+?^${}()|[\]\\]/g, "\\$&"), "\\s*(.+)")))) === null || _a2 === void 0 ? void 0 : _a2[1]) === null || _b2 === void 0 ? void 0 : _b2.trim()) || data2.trim();
                          if (!tempChapter.chapterNumber) {
                            extractChapterNumber(data2, tempChapter);
                          }
                        } else if (isReadingChapterInfo === 3) {
                          tempChapter.releaseTime = data2;
                        } else if (isReadingChapterInfo === 4) {
                          var detailName = data2.toLowerCase().trim();
                          switch (detailName) {
                            case "free":
                            case "gratuit":
                            case "\u0645\u062C\u0627\u0646\u064A":
                  ...
                  onclosetag: /* @__PURE__ */ __name(function(name) {
                    ...
                    if (isParsingGenres) {
                      ...
                      if (isReadingInfo) {
                        ...
                        isParsingInfo = false;
                        novel.author = (_b2 = novel.author) === null || _b2 === void 0 ? void 0 : _b2.trim();
                      ...
                      if (isReadingChapter) {
                        if (isReadingChapterInfo === 1) {
                          ...
                          if (isPaidChapter)
                            tempChapter.name = "\u{1F512} " + tempChapter.name;
      ...
      LightNovelWPPlugin2.prototype.parseChapter = function(chapterPath) {
        return __awaiter(this, void 0, void 0, function() {
          var data2, $2;
          var _a, _b, _c;
          return __generator(this, function(_d) {
            switch (_d.label) {
              case 0:
                return [4, this.safeFecth(this.site + chapterPath, false)];
              case 1:
                data2 = _d.sent();
                if ((_a = this.options) === null || _a === void 0 ? void 0 : _a.customJs) {
                  try {
                    $2 = (0, cheerio_1.load)(data2);
                    data2 = $2.html();
                  } catch (error) {
                ...
                return [2, ((_c = (_b = data2.match(/<div.*?class="epcontent ([^]*?)<div.*?class="?bottomnav/g)) === null || _b === void 0 ? void 0 : _b[0].match(/<p[^>]*>([^]*?)<\/p>/g)) === null || _c === void 0 ? void 0 : _c.join("\n")) || ""];
            }
          });
        });
      };
      LightNovelWPPlugin2.prototype.searchNovels = function(searchTerm, page) {
        return __awaiter(this, void 0, void 0, function() {
          var url, html3;
          return __generator(this, function(_a) {
            switch (_a.label) {
              case 0:
                ...
                return [4, this.safeFecth(url, true)];
              case 1:
                html3 = _a.sent();
                return [2, this.parseNovels(html3)];
            }
