...
var LNReaderPlugin = (() => {
  ...
  var ReadFromPlugin = (
    ...
    function() {
      ...
      __name(ReadFromPlugin2, "ReadFromPlugin");
      ReadFromPlugin2.prototype.parseNovels = function(loadedCheerio, isSearch) {
        var _a;
        var ret = loadedCheerio((isSearch ? "div.text" : "#dle-content") + " > article.box").map(function(i, el) {
          ...
          return {
            ...
            path: loadedCheerio(el).find("h2.title > a").attr("href").replace("https://readfrom.net/", "").replace(/^\//, ""),
            cover: loadedCheerio(el).find("img").attr("src") || defaultCover_1.defaultCover,
            summary: loadedCheerio(summary).text().trim() + loadedCheerio(summary).find("span.coll-hidden").text(),
            genres: loadedCheerio(el).find(isSearch ? "h5.title > a" : "h2 > a").filter(function(i2, el2) {
              var _a2, _b;
              return (_b = (_a2 = el2.attribs["title"]) === null || _a2 === void 0 ? void 0 : _a2.startsWith) === null || _b === void 0 ? void 0 : _b.call(_a2, "Genre - ");
            }).map(function(i2, el2) {
              return loadedCheerio(el2).text();
            }).toArray().join(", "),
            author: isSearch ? loadedCheerio(el).find("h5.title > a").filter(function(i2, el2) {
              var _a2, _b;
              return (_b = (_a2 = el2.attribs["title"]) === null || _a2 === void 0 ? void 0 : _a2.startsWith) === null || _b === void 0 ? void 0 : _b.call(_a2, "Book author - ");
            }).text() : loadedCheerio(el).find("h4 > a").text()
          };
        }).toArray();
      ...
      ReadFromPlugin2.prototype.popularNovels = function(pageNo_1, _a) {
          ...
          return __generator(this, function(_c) {
            switch (_c.label) {
              case 0:
                ...
                return [4, (0, fetch_1.fetchApi)("https://readfrom.net/" + type + "/page/" + pageNo + "/")];
              case 1:
                res = _c.sent();
                return [4, res.text()];
              case 2:
                text3 = _c.sent();
                return [2, this.parseNovels((0, cheerio_1.load)(text3))];
            }
          });
        });
      };
      ReadFromPlugin2.prototype.parseNovel = function(novelPath) {
        return __awaiter(this, void 0, void 0, function() {
          var data2, text3, loadedCheerio, novel, moreNovelInfo, seriesElm, seriesText;
          return __generator(this, function(_a) {
            switch (_a.label) {
              case 0:
                return [4, (0, fetch_1.fetchApi)("https://readfrom.net/" + novelPath)];
              case 1:
                data2 = _a.sent();
                return [4, data2.text()];
              case 2:
                text3 = _a.sent();
                loadedCheerio = (0, cheerio_1.load)(text3);
                novel = {
                  path: novelPath,
                  name: "Untitled"
                };
                novel.name = loadedCheerio("center > h2.title").text().split(", \n\n")[0].trim();
                novel.cover = loadedCheerio("article.box > div > center > div > a > img").attr("src") || defaultCover_1.defaultCover;
                novel.chapters = loadedCheerio(loadedCheerio("div.pages").get()[0]).find("> a").map(function(i, el) {
                  return {
                    name: loadedCheerio(el).text().trim(),
                    path: loadedCheerio(el).attr("href").replace("https://readfrom.net/", "").replace(/^\//, ""),
                    // releaseTime: '',
                    chapterNumber: i + 2
                  };
                }).toArray();
                ...
                moreNovelInfo = this.loadedNovelCache.find(function(novel2) {
                  return novel2.path === novelPath;
                });
                if (!!moreNovelInfo) return [3, 4];
                return [4, this.searchNovels(novel.name, 1)];
              case 3:
                moreNovelInfo = _a.sent().find(function(novel2) {
                  return novel2.path === novelPath;
                });
                _a.label = 4;
              case 4:
      ...
      ReadFromPlugin2.prototype.parseChapter = function(chapterPath) {
        return __awaiter(this, void 0, void 0, function() {
          var data2, text3, loadedCheerio, textToRead, paragraph, chapterHtml;
          return __generator(this, function(_a) {
            switch (_a.label) {
              case 0:
                return [4, (0, fetch_1.fetchApi)("https://readfrom.net/" + chapterPath)];
              case 1:
                data2 = _a.sent();
                return [4, data2.text()];
              case 2:
      ...
      ReadFromPlugin2.prototype.searchNovels = function(searchTerm, pageNo) {
        return __awaiter(this, void 0, void 0, function() {
          var res, text3;
          return __generator(this, function(_a) {
            switch (_a.label) {
              case 0:
                if (pageNo !== 1)
                  return [2, []];
                return [4, (0, fetch_1.fetchApi)("https://readfrom.net/build_in_search/?q=" + encodeURIComponent(searchTerm))];
              case 1:
                res = _a.sent();
                return [4, res.text()];
              case 2:
                text3 = _a.sent();
                return [2, this.parseNovels((0, cheerio_1.load)(text3), true)];
            }
          });
        });
      };
      return ReadFromPlugin2;
    }()
  );
