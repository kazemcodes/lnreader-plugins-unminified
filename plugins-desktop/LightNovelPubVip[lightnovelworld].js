...
var LNReaderPlugin = (() => {
  ...
  var LightNovelWorld = (
    ...
    function() {
      ...
      LightNovelWorld2.prototype.popularNovels = function(page_1, _a) {
            ...
            switch (_c.label) {
              ...
              case 1:
                ...
                loadedCheerio(".novel-item").each(function(idx, ele) {
                  ...
                  var novelUrl = (_a2 = loadedCheerio(ele).find(".novel-title > a").attr("href")) === null || _a2 === void 0 ? void 0 : _a2.substring(1);
                  if (!novelUrl)
                    return;
                  var novel = {
                    name: novelName,
            ...
            switch (_a.label) {
              ...
              case 1:
                ...
                loadedCheerio(".chapter-list li").each(function() {
                  ...
                  var chapterUrl = (_a2 = loadedCheerio(this).find("a").attr("href")) === null || _a2 === void 0 ? void 0 : _a2.substring(1);
                  if (!chapterUrl)
                    return;
                  chapter.push({
                    name: chapterName,
            ...
            switch (_a.label) {
              ...
              case 2:
                ...
                loadedCheerio(".novel-item").each(function(idx, ele) {
                  ...
                  var novelUrl = (_a2 = loadedCheerio(ele).find("a").attr("href")) === null || _a2 === void 0 ? void 0 : _a2.substring(1);
                  if (!novelUrl)
                    return;
                  novels.push({
                    name: novelName,
  ...
  var plugin = new LightNovelWorld({ "id": "lightnovelpubvip", "sourceName": "LightNovelPub Vip", "sourceSite": "https://lightnovelpub.vip/" });
