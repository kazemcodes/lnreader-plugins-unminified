...
var LNReaderPlugin = (() => {
  ...
  var Linovelib = (
    ...
    function() {
      ...
      __name(Linovelib2, "Linovelib");
      Linovelib2.prototype.popularNovels = function(pageNo_1, _a) {
          ...
          return __generator(this, function(_c) {
            switch (_c.label) {
              case 0:
                ...
                return [4, (0, fetch_1.fetchText)(url)];
              case 1:
                body = _c.sent();
                if (body === "")
                ...
                loadedCheerio(".module-rank-booklist .book-layout").each(function(i, el) {
                  var url2 = loadedCheerio(el).attr("href");
                  var novelName = loadedCheerio(el).find(".book-title").text();
                  var novelCover = loadedCheerio(el).find("div.book-cover > img").attr("data-src");
                  if (!url2)
                    return;
                  var novel = {
                    name: novelName,
      ...
      Linovelib2.prototype.parseNovel = function(novelPath) {
          ...
          return __generator(this, function(_b) {
            switch (_b.label) {
              ...
              case 1:
                ...
                novel.status = meta.includes("\u5B8C\u7ED3") ? novelStatus_1.NovelStatus.Completed : novelStatus_1.NovelStatus.Ongoing;
                novel.genres = loadedCheerio(".tag-small.red").children("a").map(function(i, el) {
                ...
                return [4, (0, fetch_1.fetchText)(chaptersUrl)];
              case 2:
                ...
                chaptersLoadedCheerio("#volumes .chapter-li:not(.volume-cover)").each(function(i, el) {
                  if (chaptersLoadedCheerio(el).hasClass("chapter-bar")) {
                    ...
                    var urlPart = chaptersLoadedCheerio(el).find(".chapter-li-a").attr("href");
                  ...
                  var chapterName = volumeName + " \u2014 " + chaptersLoadedCheerio(el).find(".chapter-index").text().trim();
      ...
      Linovelib2.prototype.parseChapter = function(chapterPath) {
        return __awaiter(this, void 0, void 0, function() {
          ...
          return __generator(this, function(_a) {
            switch (_a.label) {
              case 0:
                ...
                addPage = /* @__PURE__ */ __name(function(pageCheerio) {
                  return __awaiter(_this, void 0, void 0, function() {
                    ...
                    return __generator(this, function(_a2) {
                      switch (_a2.label) {
                        case 0:
                          formatPage = /* @__PURE__ */ __name(function() {
                            return __awaiter(_this2, void 0, void 0, function() {
                              return __generator(this, function(_a3) {
                                pageCheerio("#acontent .adsbygoogle, #acontent script, center").remove();
                                pageCheerio("#acontent img.imagecontent").each(function(i, el) {
                                  var imgSrc = pageCheerio(el).attr("data-src") || pageCheerio(el).attr("src");
                                  if (imgSrc) {
                                    pageCheerio(el).attr("src", imgSrc).removeAttr("data-src").removeClass("lazyload");
                                  }
                                });
                                pageText = pageCheerio("#acontent").html() || "";
                                pageText = pageText.replace(/./g, function(char) {
                                  return skillgg[char] || char;
                                });
                        ...
                        case 1:
                          _a2.sent();
                          chapterName = pageCheerio("#atitle + h3").text() + " \u2014 " + pageCheerio("#atitle").text();
                          if (chapterText === "") {
                ...
                loadPage = /* @__PURE__ */ __name(function(url2) {
                  return __awaiter(_this, void 0, void 0, function() {
                    ...
                    return __generator(this, function(_a2) {
                      switch (_a2.label) {
                        case 0:
                          ...
                          return [4, (0, fetch_1.fetchText)(url2, { headers })];
                        case 1:
                          body = _a2.sent();
                          pageCheerio = (0, cheerio_1.load)(body);
                          return [4, addPage(pageCheerio)];
                        case 2:
                          _a2.sent();
                          pageHasNextPage = pageCheerio("#footlink a:last").text() === "\u4E0B\u4E00\u9875" || pageCheerio("#footlink a:last").text() === "\u4E0B\u4E00\u9801" ? true : false;
                          return [2, { pageCheerio, pageHasNextPage }];
                      }
                    });
                  });
                }, "loadPage");
              ...
              case 2:
                ...
                _a.label = 3;
              case 3:
                if (hasNextPage === true) return [3, 1];
                _a.label = 4;
              case 4:
      ...
      Linovelib2.prototype.searchNovels = function(searchTerm, pageNo) {
        return __awaiter(this, void 0, void 0, function() {
            ...
            switch (_a.label) {
              ...
              case 1:
                ...
                pageCheerio(".book-ol .book-layout").each(function(i, el) {
                  ...
                  var novelCover = pageCheerio(el).find("div.book-cover > img").attr("data-src");
                  if (!nUrl)
                    return;
                  novels.push({
                    name: novelName,
