...
var LNReaderPlugin = (() => {
  ...
  // .js/plugins/spanish/TC&Sega[lightnovelwp].js
  ...
  var c = new ((function() {
    ...
    return c2.prototype.getHostname = function(e2) {
      ...
      return e(this, arguments, void 0, (function(e2, a3) {
        var s3, l2, r2, i2, o2, n2, c3, u, v, h = a3.filters, p = a3.showLatestNovels;
        return t(this, (function(t2) {
          switch (t2.label) {
            case 0:
              for (r2 in s3 = null !== (v = null === (u = this.options) || void 0 === u ? void 0 : u.seriesPath) && void 0 !== v ? v : "/series/", l2 = this.site + s3 + "?page=" + e2, h || (h = this.filters || {}), p && (l2 += "&order=latest"), h) if ("object" == typeof h[r2].value) for (i2 = 0, o2 = h[r2].value; i2 < o2.length; i2++) n2 = o2[i2], l2 += "&".concat(r2, "=").concat(n2);
            ...
            case 1:
              return l2 = t2.sent(), o2 = { path: a2, name: "", genres: "", summary: "", author: "", artist: "", status: "", chapters: [] }, c3 = false, u = false, v = 0, h = false, p = false, d = false, f = false, b = false, m = false, g = false, y = 0, w = false, k = false, N = [], S = {}, C = this.hideLocked, x = new s.Parser({ onopentag: function(t3, a3) {
                ...
                if (c3) u && (o2.genres += e3 + ", ");
                  ...
                  if (1 === y) e3.includes("\u{1F512}") ? (w = true, k = true) : k && (w = false), n(e3, S);
