...
var LNReaderPlugin = (() => {
  ...
  var n = (init_fetch2(), __toCommonJS(fetch_exports)), a = (init_browser(), __toCommonJS(browser_exports)), i = (init_defaultCover(), __toCommonJS(defaultCover_exports)), s = (init_novelStatus(), __toCommonJS(novelStatus_exports)), o = r(require_dayjs_min()), c = (init_storage2(), __toCommonJS(storage_exports)), u = function(t2, e2) {
