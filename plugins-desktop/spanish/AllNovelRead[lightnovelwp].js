...
var LNReaderPlugin = (() => {
  ...
  // src/lib/storage.ts
  var Storage, storage, LocalStorage, localStorage, sessionStorage;
    ...
    "src/lib/storage.ts"() {
      ...
      Storage = class {
        ...
        get(key, raw) {
          ...
          if ((item == null ? void 0 : item.expires) && Date.now() > item.expires) {
            this.delete(key);
            return void 0;
          }
          return raw ? item : item == null ? void 0 : item.value;
        }
        /**
  ...
  // .js/plugins/spanish/AllNovelRead[lightnovelwp].js
  var e = function(e2, a2, l2, o2) {
    ...
    var l2, o2, i2, r2 = { label: 0, sent: function() {
  ...
  var l = (init_browser(), __toCommonJS(browser_exports)), o = require_lib9(), i = (init_fetch2(), __toCommonJS(fetch_exports)), r = (init_novelStatus(), __toCommonJS(novelStatus_exports)), t = (init_defaultCover(), __toCommonJS(defaultCover_exports)), n = (init_storage2(), __toCommonJS(storage_exports));
  function u(e2, a2) {
    var l2 = e2.match(/(\d+)$/);
  ...
  var s = new ((function() {
    function s2(e2) {
      ...
      this.version = "1.1.".concat(9 + i2), this.options = null !== (l2 = e2.options) && void 0 !== l2 ? l2 : {}, this.filters = e2.filters, (null === (o2 = this.options) || void 0 === o2 ? void 0 : o2.hasLocked) && (this.pluginSettings = { hideLocked: { value: "", label: "Hide locked chapters", type: "Switch" } });
    }
    return s2.prototype.getHostname = function(e2) {
      var a2 = (e2 = e2.split("/")[2]).split(".");
      return a2.pop(), a2.join(".");
    }, s2.prototype.safeFecth = function(l2, o2) {
      return e(this, void 0, void 0, (function() {
        var e2, r2, t2, n2, u2, s3, v, c;
        return a(this, (function(a2) {
          switch (a2.label) {
            ...
            case 1:
              ...
              return [4, n2.text()];
            case 2:
              if (u2 = a2.sent(), s3 = null === (c = null === (v = u2.match(/<title>(.*?)<\/title>/)) || void 0 === v ? void 0 : v[1]) || void 0 === c ? void 0 : c.trim(), this.getHostname(l2) != this.getHostname(n2.url) || s3 && ("Bot Verification" == s3 || "You are being redirected..." == s3 || "Un instant..." == s3 || "Just a moment..." == s3 || "Redirecting..." == s3)) throw new Error("Captcha error, please open in webview (or the website has changed url)");
              return [2, u2];
          }
        }));
      }));
      ...
      return (e2.match(/<article([^]*?)<\/article>/g) || []).forEach((function(e3) {
        ...
        if (r2 && i2) {
          var n2 = e3.match(/<img [^>]*?src="([^\"]*)"[^>]*?(?: data-src="([^\"]*)")?[^>]*>/) || [], u2 = void 0;
          if (i2.includes(a2.site)) u2 = i2.replace(a2.site, "");
          else {
            var s3 = i2.split("/");
            s3.shift(), s3.shift(), s3.shift(), u2 = s3.join("/");
          }
          o2.push({ name: r2, cover: n2[2] || n2[1] || t.defaultCover, path: u2 });
        }
      })), o2;
    }, s2.prototype.popularNovels = function(l2, o2) {
      return e(this, arguments, void 0, (function(e2, l3) {
        var o3, i2, r2, t2, n2, u2, s3, v, c, b = l3.filters, d = l3.showLatestNovels;
        return a(this, (function(a2) {
          switch (a2.label) {
            case 0:
              for (r2 in o3 = null !== (c = null === (v = this.options) || void 0 === v ? void 0 : v.seriesPath) && void 0 !== c ? c : "/series/", i2 = this.site + o3 + "?page=" + e2, b || (b = this.filters || {}), d && (i2 += "&order=latest"), b) if ("object" == typeof b[r2].value) for (t2 = 0, n2 = b[r2].value; t2 < n2.length; t2++) u2 = n2[t2], i2 += "&".concat(r2, "=").concat(u2);
              else b[r2].value && (i2 += "&".concat(r2, "=").concat(b[r2].value));
              return [4, this.safeFecth(i2, false)];
            case 1:
              return s3 = a2.sent(), [2, this.parseNovels(s3)];
          }
        }));
      }));
    }, s2.prototype.parseNovel = function(l2) {
      return e(this, void 0, void 0, (function() {
        var e2, i2, n2, s3, v, c, b, d, m, p, h, f, g, y, w, A, k, C, E, R, x;
        return a(this, (function(a2) {
          switch (a2.label) {
            case 0:
              return e2 = this.site, [4, this.safeFecth(e2 + l2, false)];
            case 1:
              return i2 = a2.sent(), n2 = { path: l2, name: "", genres: "", summary: "", author: "", artist: "", status: "", chapters: [] }, s3 = false, v = false, c = 0, b = false, d = false, m = false, p = false, h = false, f = false, g = false, y = 0, w = false, A = false, k = [], C = {}, E = this.hideLocked, R = new o.Parser({ onopentag: function(a3, l3) {
                var o2;
                !n2.cover && (null === (o2 = l3.class) || void 0 === o2 ? void 0 : o2.includes("ts-post-image")) ? (n2.name = l3.title, n2.cover = l3["data-src"] || l3.src || t.defaultCover) : "genxed" === l3.class || "sertogenre" === l3.class ? s3 = true : s3 && "a" === a3 ? v = true : "div" !== a3 || "entry-content" !== l3.class && "description" !== l3.itemprop ? "spe" === l3.class || "serl" === l3.class ? b = true : b && "span" === a3 ? d = true : "div" === a3 && "sertostat" === l3.class ? (b = true, d = true, h = true) : l3.class && l3.class.includes("eplister") ? f = true : f && "li" === a3 ? g = true : g ? "a" === a3 && void 0 === C.path ? C.path = l3.href.replace(e2, "").trim() : "epl-num" === l3.class ? y = 1 : "epl-title" === l3.class ? y = 2 : "epl-date" === l3.class ? y = 3 : "epl-price" === l3.class && (y = 4) : !c || "div" !== a3 && "script" !== a3 || c++ : c++;
              }, ontext: function(e3) {
                var a3, l3;
                if (s3) v && (n2.genres += e3 + ", ");
                else if (1 === c && e3.trim()) n2.summary += e3;
                else if (b) {
                  if (d) {
                    var o2 = e3.toLowerCase().replace(":", "").trim();
                    if (m) n2.author += e3 || "Unknown";
                  ...
                  if (1 === y) e3.includes("\u{1F512}") ? (w = true, A = true) : A && (w = false), u(e3, C);
                  else if (2 === y) C.name = (null === (l3 = null === (a3 = e3.match(RegExp("^".concat(n2.name.replace(/[.*+?^${}()|[\]\\]/g, "\\$&"), "\\s*(.+)")))) || void 0 === a3 ? void 0 : a3[1]) || void 0 === l3 ? void 0 : l3.trim()) || e3.trim(), C.chapterNumber || u(e3, C);
                  else if (3 === y) C.releaseTime = e3;
                  else if (4 === y) {
                    switch (o2 = e3.toLowerCase().trim()) {
                      case "free":
                      case "gratuit":
                      case "\u0645\u062C\u0627\u0646\u064A":
                      case "livre":
                ...
                var a3, l3, o2;
                s3 ? v ? v = false : (s3 = false, n2.genres = null === (a3 = n2.genres) || void 0 === a3 ? void 0 : a3.slice(0, -2)) : c ? "p" === e3 ? n2.summary += "\n\n" : "br" === e3 ? n2.summary += "\n" : "div" !== e3 && "script" !== e3 || c-- : b ? d ? "span" === e3 && (d = false, m && n2.author ? m = false : p && n2.artist ? p = false : h && "" !== n2.status && (h = false)) : "div" === e3 && (b = false, n2.author = null === (l3 = n2.author) || void 0 === l3 ? void 0 : l3.trim(), n2.artist = null === (o2 = n2.artist) || void 0 === o2 ? void 0 : o2.trim()) : f && (g ? 1 === y || 2 === y || 3 === y || 4 === y ? y = 0 : "li" === e3 && (g = false, C.chapterNumber || (C.chapterNumber = 0), w && (C.name = "\u{1F512} " + C.name), E && w || k.push(C), C = {}) : "ul" === e3 && (f = false));
              } }), R.write(i2), R.end(), k.length && ((null === (x = this.options) || void 0 === x ? void 0 : x.reverseChapters) && k.reverse(), n2.chapters = k), n2.summary = n2.summary.trim(), [2, n2];
          }
        }));
      }));
    }, s2.prototype.parseChapter = function(o2) {
      return e(this, void 0, void 0, (function() {
        var e2, i2, r2, t2, n2;
        return a(this, (function(a2) {
          switch (a2.label) {
    ...
    }, s2.prototype.searchNovels = function(l2, o2) {
      return e(this, void 0, void 0, (function() {
        var e2, i2;
        return a(this, (function(a2) {
          switch (a2.label) {
  ...
  })())({ id: "allnovelread", sourceSite: "https://allnovelread.com/", sourceName: "AllNovelRead", options: { lang: "Spanish", reverseChapters: true }, filters: { "genre[]": { type: "Checkbox", label: "Genre", value: [], options: [{ label: "16+", value: "16" }, { label: "Abogado/Abogada", value: "abogado-abogada" }, { label: "Action", value: "action" }, { label: "Advogdo", value: "advogdo" }, { label: "affair of the heart", value: "affair-of-the-heart" }, { label: "alfa", value: "alfa" }, { label: "Alpha", value: "alpha" }, { label: "Amable", value: "amable" }, { label: "Amar", value: "amar" }, { label: "Amor", value: "amor" }, { label: "Amor caliente", value: "amor-caliente" }, { label: "amor depois do casamento", value: "amor-depois-do-casamento" }, { label: "Amor despu\xE9s del matrimonio", value: "amor-despues-del-matrimonio" }, { label: "Amor destinado", value: "amor-destinado" }, { label: "Amor doloroso", value: "amor-doloroso" }, { label: "Amor dulce", value: "amor-dulce" }, { label: "Amor e \xF3dio", value: "amor-e-odio" }, { label: "Amor e \xF3dio Gravidez", value: "amor-e-odio-gravidez" }, { label: "amor entre ex", value: "amor-entre-ex" }, { label: "Amor forzado", value: "amor-forzado" }, { label: "Amor Inocente", value: "amor-inocente" }, { label: "amor predestinado", value: "amor-predestinado" }, { label: "Amor y odio", value: "amor-y-odio" }, { label: "arrepentirse del divorcio", value: "arrepentirse-del-divorcio" }, { label: "Arrepentirse Despu\xE9s de Herir a Su Mujer", value: "arrepentirse-despues-de-herir-a-su-mujer" }, { label: "Arrogante", value: "arrogante" }, { label: "Asesinato", value: "asesinato" }, { label: "Babby", value: "babby" }, { label: "BABY", value: "baby" }, { label: "Beauty", value: "beauty" }, { label: "Beb\xEA fofo", value: "bebe-fofo" }, { label: "Beb\xE9 inteligente", value: "bebe-inteligente" }, { label: "belleza", value: "belleza" }, { label: "Belleza inusual", value: "belleza-inusual" }, { label: "Bilion\xE1rio", value: "bilionario" }, { label: "Billionair", value: "billionair" }, { label: "billionaire", value: "billionaire" }, { label: "Billonario/Billonaria", value: "billonario-billonaria" }, { label: "brilliant", value: "brilliant" }, { label: "bxg", value: "bxg" }, { label: "Bxg-novela", value: "bxg-novela" }, { label: "Campus", value: "campus" }, { label: "Casamiento", value: "casamiento" }, { label: "CEO", value: "ceo" }, { label: "city", value: "city" }, { label: "Colegiala", value: "colegiala" }, { label: "Comedia", value: "comedia" }, { label: "Comedia-novela", value: "comedia-novela" }, { label: "Comedy", value: "comedy" }, { label: "contempor\xE1neo", value: "contemporaneo" }, { label: "Contract marriage", value: "contract-marriage" }, { label: "c\xF3nyuge", value: "conyuge" }, { label: "Coraz\xF3n roto", value: "corazon-roto" }, { label: "courtship", value: "courtship" }, { label: "Crecimiento del personaje", value: "crecimiento-del-personaje" }, { label: "Crimen organizado", value: "crimen-organizado" }, { label: "Critical", value: "critical" }, { label: "cruel", value: "cruel" }, { label: "De pobre a rico", value: "de-pobre-a-rico" }, { label: "Divertido", value: "divertido" }, { label: "Divorce", value: "divorce" }, { label: "Divorcio", value: "divorcio" }, { label: "Doce", value: "doce" }, { label: "Doctor", value: "doctor" }, { label: "Dominador", value: "dominador" }, { label: "Dominante", value: "dominante" }, { label: "Dominante-novela", value: "dominante-novela" }, { label: "drama", value: "drama" }, { label: "dulce", value: "dulce" }, { label: "Dulce\xA0Embarazada", value: "dulce-embarazada" }, { label: "elegante", value: "elegante" }, { label: "Embarazada", value: "embarazada" }, { label: "En la actualidad", value: "en-la-actualidad" }, { label: "Enemigos a los amantes", value: "enemigos-a-los-amantes" }, { label: "existente", value: "existente" }, { label: "Family", value: "family" }, { label: "Fantasy", value: "fantasy" }, { label: "Fated", value: "fated" }, { label: "Fraco para forte/Pob", value: "fraco-para-forte-pob" }, { label: "fuerte", value: "fuerte" }, { label: "Goodgirl", value: "goodgirl" }, { label: "Gravidez", value: "gravidez" }, { label: "HE", value: "he" }, { label: "heir/heiress", value: "heir-heiress" }, { label: "hermoso", value: "hermoso" }, { label: "H\xE9roe pateador", value: "heroe-pateador" }, { label: "Heroina", value: "heroina" }, { label: "hero\xEDna Kickass", value: "heroina-kickass" }, { label: "heterose*ual", value: "heteroseual" }, { label: "historia de amor", value: "historia-de-amor" }, { label: "Hot Romance", value: "hot-romance" }, { label: "Humor", value: "humor" }, { label: "Identidad secreta", value: "identidad-secreta" }, { label: "Independente", value: "independente" }, { label: "Independiente", value: "independiente" }, { label: "Inocente", value: "inocente" }, { label: "jefe", value: "jefe" }, { label: "Jefe / CEO", value: "jefe-ceo" }, { label: "kicking", value: "kicking" }, { label: "king", value: "king" }, { label: "legend", value: "legend" }, { label: "Literature", value: "literature" }, { label: "loser", value: "loser" }, { label: "Love", value: "love" }, { label: "Love & Culture", value: "love-culture" }, { label: "love after marriage", value: "love-after-marriage" }, { label: "love story", value: "love-story" }, { label: "LOVEAFTERMARRIAGE", value: "loveaftermarriage" }, { label: "lucky dog", value: "lucky-dog" }, { label: "Lugar para voc\xEA Allnovelread", value: "lugar-para-voce-allnovelread" }, { label: "luna", value: "luna" }, { label: "Madre soltera", value: "madre-soltera" }, { label: "Mafia", value: "mafia" }, { label: "magical world", value: "magical-world" }, { label: "Malentendido", value: "malentendido" }, { label: "Maquinaci\xF3n", value: "maquinacion" }, { label: "Marriage", value: "marriage" }, { label: "Matrimonio", value: "matrimonio" }, { label: "Matrimonio por Contrato", value: "matrimonio-por-contrato" }, { label: "Matrimonio rel\xE1mpago", value: "matrimonio-relampago" }, { label: "Medico", value: "medico" }, { label: "M\xE9dico/M\xE9dica", value: "medico-medica" }, { label: "millonaria", value: "millonaria" }, { label: "modificaci\xF3n", value: "modificacion" }, { label: "most millions", value: "most-millions" }, { label: "Mucama", value: "mucama" }, { label: "Mujer s\xFAper poderosa", value: "mujer-super-poderosa" }, { label: "Multi-Millionairo", value: "multi-millionairo" }, { label: "Multimillionairo", value: "multimillionairo" }, { label: "Multimillonaria", value: "multimillonaria" }, { label: "multimillonario", value: "multimillonario" }, { label: "Multimillonario-novela", value: "multimillonario-novela" }, { label: "MULTIPLEIDENTITIES", value: "multipleidentities" }, { label: "M\xFAltiples identidades", value: "multiples-identidades" }, { label: "musculoso", value: "musculoso" }, { label: "Nacimiento m\xFAltiple", value: "nacimiento-multiple" }, { label: "Novia embarazada a la fuga", value: "novia-embarazada-a-la-fuga" }, { label: "Obsesi\xF3n", value: "obsesion" }, { label: "Ocultar", value: "ocultar" }, { label: "Optimista", value: "optimista" }, { label: "others", value: "others" }, { label: "Pasi\xF3n de una noche", value: "pasion-de-una-noche" }, { label: "Perao/Segunda chance", value: "perao-segunda-chance" }, { label: "Perdedor", value: "perdedor" }, { label: "Playboy", value: "playboy" }, { label: "poderoso", value: "poderoso" }, { label: "polygamy", value: "polygamy" }, { label: "Posesivo", value: "posesivo" }, { label: "possessive", value: "possessive" }, { label: "Possessivo", value: "possessivo" }, { label: "Powerful", value: "powerful" }, { label: "presente", value: "presente" }, { label: "Presidente", value: "presidente" }, { label: "princess", value: "princess" }, { label: "Protective", value: "protective" }, { label: "Protectormadre soltera", value: "protectormadre-soltera" }, { label: "Reconquistar a mi pareja", value: "reconquistar-a-mi-pareja" }, { label: "rejected", value: "rejected" }, { label: "relaci\xF3n", value: "relacion" }, { label: "relationship", value: "relationship" }, { label: "Renacido", value: "renacido" }, { label: "Rey/Reina", value: "rey-reina" }, { label: "Rich", value: "rich" }, { label: "Rico", value: "rico" }, { label: "Ricos", value: "ricos" }, { label: "Romance", value: "romance" }, { label: "romance caliente", value: "romance-caliente" }, { label: "Romance/Rom\xE2ntico", value: "romance-romantico" }, { label: "Rom\xE1ntic", value: "romantic" }, { label: "Romantica", value: "romantica" }, { label: "Romanticas", value: "romanticas" }, { label: "Romantico", value: "romantico" }, { label: "Secretos", value: "secretos" }, { label: "secrets", value: "secrets" }, { label: "seductive", value: "seductive" }, { label: "Segunda Chance", value: "segunda-chance" }, { label: "Segunda oportunidad", value: "segunda-oportunidad" }, { label: "STRONGFEMALELEAD", value: "strongfemalelead" }, { label: "Subrogaci\xF3n", value: "subrogacion" }, { label: "Suspense", value: "suspense" }, { label: "Sweet", value: "sweet" }, { label: "SWEETLOVE", value: "sweetlove" }, { label: "Teenager", value: "teenager" }, { label: "Tierno", value: "tierno" }, { label: "Tragedia", value: "tragedia" }, { label: "Traici\xF3n", value: "traicion" }, { label: "Traici\xF3nReconquistar a mi pareja", value: "traicionreconquistar-a-mi-pareja" }, { label: "Tri\xE1ngulo amoroso", value: "triangulo-amoroso" }, { label: "Trillizos", value: "trillizos" }, { label: "Trio", value: "trio" }, { label: "Una noche de pasion", value: "una-noche-de-pasion" }, { label: "Universidad", value: "universidad" }, { label: "Valente", value: "valente" }, { label: "Valiente", value: "valiente" }, { label: "Venanza", value: "venanza" }, { label: "Werewolf", value: "werewolf" }, { label: "Ya", value: "ya" }, { label: "Youth", value: "youth" }] }, "type[]": { type: "Checkbox", label: "Type", value: [], options: [{ label: "16+", value: "16" }, { label: "alfa", value: "alfa" }, { label: "Allnovelread Sin vuelta atr\xE1s", value: "allnovelread-sin-vuelta-atras" }, { label: "Alpha", value: "alpha" }, { label: "Amor dulce", value: "amor-dulce" }, { label: "Amor y odio", value: "amor-y-odio" }, { label: "Arrogante-novela", value: "arrogante-novela" }, { label: "Billionaire", value: "billionaire" }, { label: "Billonario", value: "billonario" }, { label: "bxg", value: "bxg" }, { label: "CEO", value: "ceo" }, { label: "Contempor\xE2neo", value: "contemporaneo" }, { label: "Contract marriage", value: "contract-marriage" }, { label: "crecimiento-del-personaje-novela", value: "crecimiento-del-personaje-novela" }, { label: "Divorce", value: "divorce" }, { label: "drama", value: "drama" }, { label: "dulce", value: "dulce" }, { label: "El incesante acoso de mi ex marido", value: "el-incesante-acoso-de-mi-ex-marido" }, { label: "Enganar al mejor amigo de mi novio", value: "enganar-al-mejor-amigo-de-mi-novio" }, { label: "Fantasy", value: "fantasy" }, { label: "HE", value: "he" }, { label: "heterosexual", value: "heterosexual" }, { label: "Historia-triste-novela", value: "historia-triste-novela" }, { label: "Hombre lobo", value: "hombre-lobo" }, { label: "Hot Romance", value: "hot-romance" }, { label: "Independiente", value: "independiente" }, { label: "Inocente", value: "inocente" }, { label: "king", value: "king" }, { label: "Love", value: "love" }, { label: "love after marriage", value: "love-after-marriage" }, { label: "Luna", value: "luna" }, { label: "Magical world", value: "magical-world" }, { label: "millonaria", value: "millonaria" }, { label: "Multi-Millionaire", value: "multi-millionaire" }, { label: "Multimillionairo", value: "multimillionairo" }, { label: "Multimillonario", value: "multimillonario" }, { label: "Nunca Longe Allnovelread", value: "nunca-longe-allnovelread" }, { label: "Posesivo", value: "posesivo" }, { label: "Querida ex esposa", value: "querida-ex-esposa" }, { label: "Romance", value: "romance" }, { label: "Romane", value: "romane" }, { label: "Rom\xE1ntica", value: "romantica" }, { label: "Romanticas", value: "romanticas" }, { label: "Romantico", value: "romantico" }, { label: "Sweet", value: "sweet" }, { label: "SWEETLOVE", value: "sweetlove" }, { label: "Te Quero de Volta Allnovelread", value: "te-quero-de-volta-allnovelread" }, { label: "Traicion en altar", value: "traicion-en-altar" }, { label: "Uma Ferida Que Nunca Se Cura Allnovelread", value: "uma-ferida-que-nunca-se-cura-allnovelread" }, { label: "Urban", value: "urban" }, { label: "Urban/Realistic", value: "urban-realistic" }, { label: "vuelva a m\xED", value: "vuelva-a-mi" }, { label: "Werewolf", value: "werewolf" }] }, status: { type: "Picker", label: "Status", value: "", options: [{ label: "All", value: "" }, { label: "Ongoing", value: "ongoing" }, { label: "Hiatus", value: "hiatus" }, { label: "Completed", value: "completed" }] }, order: { type: "Picker", label: "Order by", value: "", options: [{ label: "Default", value: "" }, { label: "A-Z", value: "title" }, { label: "Z-A", value: "titlereverse" }, { label: "Latest Update", value: "update" }, { label: "Latest Added", value: "latest" }, { label: "Popular", value: "popular" }] } } });
  exports.default = s;
})();
