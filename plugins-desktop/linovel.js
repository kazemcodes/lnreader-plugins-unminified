...
var LNReaderPlugin = (() => {
  ...
  var LinovelPlugin = (
    ...
    function() {
      ...
      __name(LinovelPlugin2, "LinovelPlugin");
      LinovelPlugin2.prototype.fetchHTML = function(url) {
          ...
          return __generator(this, function(_a) {
            switch (_a.label) {
              ...
              case 1:
                ...
                return [2, (0, cheerio_1.load)(body)];
            }
          });
        });
      };
      LinovelPlugin2.prototype.popularNovels = function(pageNo_1, _a) {
        return __awaiter(this, arguments, void 0, function(pageNo, _b) {
          ...
          return __generator(this, function(_c) {
            switch (_c.label) {
              case 0:
                novels = [];
                return [4, this.fetchHTML(this.site)];
              case 1:
                ...
                loadedCheerio("a.book-item-inner").each(function(i, elem) {
                  ...
                  var path = (_a2 = loadedCheerio(elem).attr("href")) !== null && _a2 !== void 0 ? _a2 : "";
                  var cover = ((_b2 = loadedCheerio(elem).find("img").attr("data-original")) !== null && _b2 !== void 0 ? _b2 : "").replace(/!min300jpg$/, "");
      ...
      LinovelPlugin2.prototype.parseNovel = function(novelPath) {
        return __awaiter(this, void 0, void 0, function() {
          ...
          return __generator(this, function(_a) {
            switch (_a.label) {
              case 0:
                ...
                return [4, this.fetchHTML(this.site + novelPath)];
              case 1:
                loadedCheerio = _a.sent();
                loadedCheerio("div.name").find("a").each(function(_i, elem) {
                ...
                loadedCheerio(".book-data").find("span").each(function(_i, elem) {
                  var text3 = loadedCheerio(elem).text().trim();
                  if (text3.includes("\u5B57\u6570")) {
                  } else if (text3.includes("\u70ED\u5EA6")) {
                  } else if (text3.includes("\u6536\u85CF")) {
                  } else if (text3 === "\u8FDE\u8F7D\u4E2D") {
                ...
                loadedCheerio(".book-cover").find("img").each(function(_i, elem) {
                  var _a2;
                  novel.cover = (_a2 = loadedCheerio(elem).attr("src")) !== null && _a2 !== void 0 ? _a2 : "";
                });
                novel.genres = loadedCheerio(".book-cats").children("a").map(function(i, el) {
                  return loadedCheerio(el).text();
                }).toArray().join(",");
                novel.summary = loadedCheerio(".about-text").text().trim();
                chapters = [];
                loadedCheerio("div.chapter").find("a").each(function(i, elem) {
                  var _a2;
      ...
      LinovelPlugin2.prototype.parseChapter = function(chapterPath) {
        return __awaiter(this, void 0, void 0, function() {
          var loadedCheerio, chapterText;
          return __generator(this, function(_a) {
            switch (_a.label) {
              case 0:
                return [4, this.fetchHTML(this.site + chapterPath)];
              case 1:
                loadedCheerio = _a.sent();
                chapterText = "";
                ...
                loadedCheerio(".article-text").find("p, img").each(function(i, elem) {
                  if (elem.tagName === "img") {
                    ...
                    if (text3 === "&nbsp;") {
                      ...
                      chapterText += "<p>".concat(text3, "</p>\n");
                    }
                  }
                });
                return [2, chapterText.trim()];
            }
          });
        });
      };
      LinovelPlugin2.prototype.searchNovels = function(searchTerm, pageNo) {
        return __awaiter(this, void 0, void 0, function() {
          var loadedCheerio, novels;
          return __generator(this, function(_a) {
            switch (_a.label) {
              case 0:
                return [4, this.fetchHTML(this.site + "/search/?kw=" + searchTerm)];
              case 1:
                loadedCheerio = _a.sent();
                novels = [];
                loadedCheerio(".rank-book-list").find("a.search-book").each(function(i, elem) {
                  var _a2, _b;
