...
var LNReaderPlugin = (() => {
  ...
  var FuzzySearch = (
    /** @class */
    function() {
      function FuzzySearch2(getItems, options) {
        this.haystack = [];
      ...
      __name(FuzzySearch2, "FuzzySearch");
      FuzzySearch2.prototype.getOptions = function() {
        return this.options;
      };
      FuzzySearch2.prototype.setOptions = function(options) {
        this.options = Object.assign(this.options, options);
      };
      FuzzySearch2.prototype.setHaystack = function(items) {
        this.haystack = items;
      };
      FuzzySearch2.prototype.getHaystack = function() {
        return this.haystack;
      };
      FuzzySearch2.prototype.search = function(query) {
        if (query.length === 0) {
          return this.haystack;
        }
        var results = [];
      ...
      FuzzySearch2.prototype.isMatch = function(item, query) {
      ...
      FuzzySearch2.prototype.nearestIndexesFor = function(item, query) {
        ...
        for (var _a = 0, idxFL_1 = idxFL; _a < idxFL_1.length; _a++) {
          ...
          for (var i = 1; i < letters.length; i++) {
            ...
            var index2 = item.indexOf(letter, idx + 1);
            if (index2 === -1) {
              indexes.pop();
              break;
            }
            indexes[indexes.length - 1].push(index2);
            index2++;
          }
        }
        if (indexes.length === 0) {
      ...
      FuzzySearch2.prototype.idxFirstLetter = function(item, query) {
        var match = query[0];
        return item.split("").map(function(letter, index2) {
          if (letter !== match) {
            return;
          }
          return index2;
  ...
  var ReLibraryPlugin = (
    ...
    function() {
      function ReLibraryPlugin2() {
        ...
        this.searchFunc = new FuzzySearch(function(item) {
          return [item.name];
        }, {
          sort: true,
          caseSensitive: false
      ...
      __name(ReLibraryPlugin2, "ReLibraryPlugin");
      ReLibraryPlugin2.prototype.popularNovelsInner = function(url) {
            ...
            switch (_a.label) {
              ...
              case 2:
                ...
                loadedCheerio(".entry-content > ol > li").each(function(_i, el) {
                  ...
                  if (novel.name === void 0 || novel.path === void 0)
                    return;
                  novel.cover = loadedCheerio(el).find("table > tbody > tr > td > a > img").attr("data-cfsrc") || loadedCheerio(el).find("table > tbody > tr > td > a > img").attr("src") || defaultCover_1.defaultCover;
      ...
      ReLibraryPlugin2.prototype.lastestNovelsInner = function(url) {
        return __awaiter(this, void 0, void 0, function() {
          var novels, result, body, loadedCheerio;
          var _this = this;
          return __generator(this, function(_a) {
            switch (_a.label) {
              ...
              case 2:
                ...
                loadedCheerio("article.type-page.page").each(function(_i, el) {
                  ...
                  if (novel.path === void 0 || novel.name === void 0)
                    return;
                  novel.cover = loadedCheerio(el).find(".entry-content > table > tbody > tr > td > a >img").attr("data-cfsrc") || loadedCheerio(el).find(".entry-content > table > tbody > tr > td > a >img").attr("src") || defaultCover_1.defaultCover;
                  if (novel.path.startsWith(_this.site)) {
                    novel.path = novel.path.slice(_this.site.length);
                  }
                  novels.push(novel);
      ...
      ReLibraryPlugin2.prototype.popularNovels = function(pageNo_1, _a) {
        return __awaiter(this, arguments, void 0, function(pageNo, _b) {
          var showLatestNovels = _b.showLatestNovels;
          return __generator(this, function(_c) {
            if (showLatestNovels)
              return [2, this.lastestNovelsInner("".concat(this.site, "/tag/translations/page/").concat(pageNo))];
            else if (pageNo === 1)
              return [2, this.popularNovelsInner("".concat(this.site, "/translations/most-popular/"))];
            else
              return [2, []];
            return [
              2
      ...
      ReLibraryPlugin2.prototype.parseNovel = function(novelPath) {
        return __awaiter(this, void 0, void 0, function() {
          ...
          return __generator(this, function(_a) {
            switch (_a.label) {
              case 0:
                ...
                return [4, (0, fetch_1.fetchApi)("".concat(this.site, "/").concat(novelPath))];
              case 1:
                result = _a.sent();
                return [4, result.text()];
              case 2:
                ...
                if (novel.name === void 0 || novel.name === "404 \u2013 Page not found")
                  throw new Error("Invalid novel for url ".concat(novelPath));
                novel.cover = loadedCheerio(".entry-content > table img").attr("data-cfsrc") || loadedCheerio(".entry-content > table img").attr("src") || defaultCover_1.defaultCover;
                ...
                loadedCheerio(".entry-content > table > tbody > tr > td > p").each(function(_i, el) {
                  if (loadedCheerio(el).find("strong").text().toLowerCase().trim().startsWith("status")) {
                    ...
                    var status_1 = loadedCheerio(el).text().toLowerCase().trim();
                  ...
                  } else if (loadedCheerio(el).find("strong").text().toLowerCase().trim().startsWith("Category")) {
                    loadedCheerio(el).find("strong").remove();
                ...
                loadedCheerio(".entry-content > div.su-accordion").each(function(_i1, el) {
                  loadedCheerio(el).find("li > a").each(function(_i2, chap_el) {
                    var _a2;
                    chapter_idx += 1;
                    var chap_path = (_a2 = loadedCheerio(chap_el).attr("href")) === null || _a2 === void 0 ? void 0 : _a2.trim();
                    if (loadedCheerio(chap_el).text() === void 0 || chap_path === void 0)
                      return;
      ...
      ReLibraryPlugin2.prototype.parseChapter = function(chapterPath) {
        return __awaiter(this, void 0, void 0, function() {
          var result, body, loadedCheerio, entryContent, pageLinkHr, prev2, pageLink, hrAfterPageLink, next2, temp;
          return __generator(this, function(_a) {
            switch (_a.label) {
              case 0:
                return [4, (0, fetch_1.fetchApi)("".concat(this.site, "/").concat(chapterPath))];
              case 1:
                result = _a.sent();
                return [4, result.text()];
              case 2:
                body = _a.sent();
                loadedCheerio = (0, cheerio_1.load)(body);
                entryContent = loadedCheerio(".entry-content");
                pageLinkHr = entryContent.find(".PageLink + hr").first();
                if (pageLinkHr.length) {
                  prev2 = pageLinkHr.prev();
                  while (prev2.length) {
                    prev2.remove();
                    prev2 = pageLinkHr.prev();
                  }
                  pageLink = pageLinkHr.prev(".PageLink");
                  if (pageLink.length) {
                    pageLink.remove();
                  }
                ...
                hrAfterPageLink = entryContent.find("hr + .PageLink").first();
                if (hrAfterPageLink.length) {
                  next2 = hrAfterPageLink.next();
                  while (next2.length) {
                    temp = next2.next();
                    next2.remove();
                    next2 = temp;
                ...
                return [2, entryContent.html() || ""];
            }
          });
        });
      };
      ReLibraryPlugin2.prototype.searchNovels = function(searchTerm, pageNo) {
        return __awaiter(this, void 0, void 0, function() {
            ...
            switch (_a.label) {
              case 0:
                if (pageNo !== 1)
                  return [2, []];
                novels = [];
                return [4, (0, fetch_1.fetchApi)("".concat(this.site, "/translations/"))];
              case 1:
                req = _a.sent();
                return [4, req.text()];
              case 2:
                body = _a.sent();
                loadedCheerio = (0, cheerio_1.load)(body);
                loadedCheerio("article article").each(function(_i, el) {
                  var _a2;
                  var e = loadedCheerio(el);
                  if (e.find("a").attr("href") && e.find("a").text()) {
                    novels.push({
                      name: e.find("h4").text(),
                      path: ((_a2 = e.find("a").attr("href")) === null || _a2 === void 0 ? void 0 : _a2.replace(_this.site, "")) || "",
                      cover: e.find("img").attr("data-cfsrc") || e.find("img").attr("src") || defaultCover_1.defaultCover
                    });
                  }
                });
                this.searchFunc.setHaystack(novels);
                return [2, this.searchFunc.search(searchTerm)];
            }
          });
        });
      };
      return ReLibraryPlugin2;
    }()
  );
