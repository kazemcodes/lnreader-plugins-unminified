...
var LNReaderPlugin = (() => {
  ...
  // .js/plugins/arabic/FreeKolNovel[lightnovelwp].js
  init_dirname();
  init_buffer2();
  init_process2();
              ...
              case 1:
                ...
                if ((_a = this.options) === null || _a === void 0 ? void 0 : _a.customJs) {
                  try {
                    ...
                    (_b = $_1("article > style").text().match(/\.\w+(?=\s*[,{])/g)) === null || _b === void 0 ? void 0 : _b.forEach(function(tag) {
                      return $_1("p".concat(tag)).remove();
                    });
                ...
                return [2, ((_d = (_c = data2.match(/<div.*?class="epcontent ([^]*?)<div.*?class="?bottomnav/g)) === null || _c === void 0 ? void 0 : _c[0].match(/<p[^>]*>([^]*?)<\/p>/g)) === null || _d === void 0 ? void 0 : _d.join("\n")) || ""];
            }
          });
        });
      };
  ...
  var plugin = new LightNovelWPPlugin({ "id": "freekolnovel", "sourceSite": "https://free.kolnovel.com/", "sourceName": "Free Kol Novel", "options": { "lang": "Arabic", "reverseChapters": true, "customJs": "$('article > style').text().match(/\\.\\w+(?=\\s*[,{])/g)?.forEach(tag => $(`p${tag}`).remove());$('.epcontent .code-block').remove();" } });
