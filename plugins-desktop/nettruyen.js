...
var LNReaderPlugin = (() => {
  ...
  var Nettruyen = (
    ...
    function() {
      ...
      __name(Nettruyen2, "Nettruyen");
      Nettruyen2.prototype.parseNovels = function(loadedCheerio) {
        var _this = this;
        var novels = [];
      ...
      Nettruyen2.prototype.popularNovels = function(pageNo) {
        return __awaiter(this, void 0, void 0, function() {
          ...
          return __generator(this, function(_a) {
            switch (_a.label) {
              ...
              case 1:
                body = _a.sent();
                return [2, this.parseNovels((0, cheerio_1.load)(body))];
            }
          });
        });
      };
      Nettruyen2.prototype.parseChapters = function(loadedCheerio) {
        var chapters = [];
      ...
      Nettruyen2.prototype.parseNovel = function(novelPath) {
        return __awaiter(this, void 0, void 0, function() {
          ...
          return __generator(this, function(_a) {
            switch (_a.label) {
              ...
              case 1:
                ...
                novel.cover = this.site + "/" + loadedCheerio(".img-thumb > img").attr("src");
                loadedCheerio(".thongtintruyen.note.note-info").each(function(idx, ele) {
                  var strong = loadedCheerio(ele).find("strong").text().trim();
                  switch (strong) {
                    case "T\xE1c gi\u1EA3":
                      novel.author = loadedCheerio(ele).text().replace(/Tác giả\s+\n?:/, "");
                      break;
                    case "Tr\u1EA1ng th\xE1i": {
                      var text3 = loadedCheerio(ele).text();
                      if (text3.includes("\u0110ang ra")) {
                        novel.status = novelStatus_1.NovelStatus.Ongoing;
                      } else if (text3.includes("Ho\xE0n th\xE0nh")) {
                    ...
                    case "Th\u1EC3 lo\u1EA1i":
                      novel.genres = loadedCheerio("a > span").toArray().map(function(gEle) {
                        return loadedCheerio(gEle).text();
                      }).join(",");
                      break;
                    default:
                      break;
                ...
                novel.summary = loadedCheerio(".gioithieutruyen > .gioithieutruyen").text().trim();
      ...
      Nettruyen2.prototype.parsePage = function(novelPath, page) {
        return __awaiter(this, void 0, void 0, function() {
      ...
      Nettruyen2.prototype.parseChapter = function(chapterPath) {
        return __awaiter(this, void 0, void 0, function() {
          ...
          return __generator(this, function(_a) {
            switch (_a.label) {
              ...
              case 1:
                body = _a.sent();
                loadedCheerio = (0, cheerio_1.load)(body);
                return [2, loadedCheerio("#noidungchap").html() || ""];
            }
          });
        });
      };
      Nettruyen2.prototype.searchNovels = function() {
        return __awaiter(this, void 0, void 0, function() {
          return __generator(this, function(_a) {
