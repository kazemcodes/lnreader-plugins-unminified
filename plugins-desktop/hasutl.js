...
var LNReaderPlugin = (() => {
  ...
  var HasulTL = (
    ...
    function() {
      ...
      __name(HasulTL2, "HasulTL");
      HasulTL2.prototype.popularNovels = function() {
            ...
            switch (_a.label) {
              ...
              case 2:
                ...
                loadedCheerio("div.wp-block-columns").each(function(idx, ele) {
                  ...
                  var novelUrl = loadedCheerio(ele).find(".wp-block-button > a").attr("href");
                  if (!novelUrl)
                    return;
                  var novel = {
                    name: novelName,
      ...
      HasulTL2.prototype.parseNovel = function(novelPath) {
        return __awaiter(this, void 0, void 0, function() {
          ...
          return __generator(this, function(_a) {
            switch (_a.label) {
              ...
              case 2:
                ...
                novelChapters = [];
                loadedCheerio(".wp-block-media-text__content").find("a").each(function(idx, ele) {
      ...
      HasulTL2.prototype.parseChapter = function(chapterPath) {
        return __awaiter(this, void 0, void 0, function() {
      ...
      HasulTL2.prototype.searchNovels = function(searchTerm) {
        return __awaiter(this, void 0, void 0, function() {
          var url, result, body, loadedCheerio, novels;
          var _this = this;
          return __generator(this, function(_a) {
