...
var LNReaderPlugin = (() => {
  ...
  var WuxialnscantradPlugin = (
    /** @class */
    function() {
      function WuxialnscantradPlugin2() {
      ...
      __name(WuxialnscantradPlugin2, "WuxialnscantradPlugin");
      WuxialnscantradPlugin2.prototype.getCheerio = function(url) {
      ...
      WuxialnscantradPlugin2.prototype.popularNovels = function(pageNo) {
        return __awaiter(this, void 0, void 0, function() {
          var novels, novel, url, $2;
          var _this = this;
          return __generator(this, function(_a) {
            switch (_a.label) {
              case 0:
              ...
              case 1:
                $2 = _a.sent();
                $2("#menu-item-2210 ul li").each(function(i, elem) {
                  var novelName = $2(elem).first().text().trim();
      ...
      WuxialnscantradPlugin2.prototype.parseNovel = function(novelPath) {
        return __awaiter(this, void 0, void 0, function() {
          var novel, $2, entryContentText, pathChapter, chapters;
          var _this = this;
          return __generator(this, function(_a) {
            switch (_a.label) {
              case 0:
              ...
              case 1:
                $2 = _a.sent();
                novel.name = $2(".entry-title").text().trim();
                novel.cover = $2(".entry-content p strong img").first().attr("src") || $2(".entry-content p img").first().attr("src");
                ...
                pathChapter = $2(".entry-content ul").first().children("li");
                chapters = [];
                pathChapter.each(function(i, elem) {
                  ...
                  if (chapterUrl && chapterUrl.includes(_this.site) && chapterName) {
                    ...
                    if (!chapters.some(function(chap) {
                      return chap.path === pathchapter_1;
                    })) {
      ...
      WuxialnscantradPlugin2.prototype.getAuthor = function(text3) {
      ...
      WuxialnscantradPlugin2.prototype.getGenres = function(text3) {
        var regex = /Genres:\s*(.*)/;
        var match = regex.exec(text3);
        var genre = "";
        if (match !== null) {
      ...
      WuxialnscantradPlugin2.prototype.getArtist = function(text3) {
      ...
      WuxialnscantradPlugin2.prototype.getSummary = function(text3) {
        var regexAuthors = [
      ...
      WuxialnscantradPlugin2.prototype.getStatus = function(text3) {
        var regex = /Statut:\s*(.*)/;
        var match = regex.exec(text3);
        var status = "";
        if (match !== null) {
      ...
      WuxialnscantradPlugin2.prototype.parseChapter = function(chapterPath) {
        return __awaiter(this, void 0, void 0, function() {
          var $2, contenuHtml;
          return __generator(this, function(_a) {
            switch (_a.label) {
              ...
              case 1:
                $2 = _a.sent();
                contenuHtml = "";
                $2(".entry-content").contents().each(function() {
                  var _a2, _b, _c, _d;
                  if ((_a2 = $2(this).html()) === null || _a2 === void 0 ? void 0 : _a2.includes("<script")) {
                    return false;
                  }
                  if (!((_b = $2(this).html()) === null || _b === void 0 ? void 0 : _b.includes('data-attachment-id="480')) && !((_c = $2.html(this)) === null || _c === void 0 ? void 0 : _c.includes("<hr>")) && !((_d = $2.html(this)) === null || _d === void 0 ? void 0 : _d.includes("<p>&nbsp;</p>"))) {
                    contenuHtml += $2.html(this);
                  }
                });
                return [2, contenuHtml];
            }
          });
        });
      };
      WuxialnscantradPlugin2.prototype.searchNovels = function(searchTerm, pageNo) {
        return __awaiter(this, void 0, void 0, function() {
