...
var LNReaderPlugin = (() => {
  ...
  var NovelDeGlacePlugin = (
    /** @class */
    function() {
      function NovelDeGlacePlugin2() {
        ...
        this.filters = {
          categorie_genre: {
            ...
            label: "Cat\xE9gorie/Genre",
            value: "all",
            options: [
              { label: "Tous", value: "all" },
              { label: "\u2550\u2550\u2550CAT\xC9GORIES\u2550\u2550\u2550", value: "categorie_roman" },
              ...
              { label: "Myst\xE8re", value: "g_mystere" },
              ...
              { label: "Trag\xE9die", value: "g_tragedie" },
      ...
      __name(NovelDeGlacePlugin2, "NovelDeGlacePlugin");
      NovelDeGlacePlugin2.prototype.getCheerio = function(url) {
          ...
          return __generator(this, function(_a) {
            switch (_a.label) {
              ...
              case 2:
                ...
                return [2, loadedCheerio];
            }
          });
        });
      };
      NovelDeGlacePlugin2.prototype.parseNovels = function($2, showLatestNovels) {
        var _this = this;
        var novels = [];
        $2("article").each(function(i, el) {
          var cheerio = $2(el);
      ...
      NovelDeGlacePlugin2.prototype.popularNovels = function(pageNo_1, _a) {
          ...
          return __generator(this, function(_c) {
            switch (_c.label) {
              ...
              case 1:
                ...
                if (!$2)
                  return [2, []];
                return [2, this.parseNovels($2, showLatestNovels)];
            }
          });
        });
      };
      NovelDeGlacePlugin2.prototype.parseNovel = function(novelPath) {
        return __awaiter(this, void 0, void 0, function() {
          var $2, novel, novelInfos, categorie, genres, status, novelChapters, volumes, hasMultipleVolumes, chapterName, site;
          var _a, _b;
          return __generator(this, function(_c) {
            switch (_c.label) {
              case 0:
              ...
              case 1:
                ...
                novel.name = ((_b = (_a = $2("div.entry-content > div > strong")[0].nextSibling) === null || _a === void 0 ? void 0 : _a.nodeValue) === null || _b === void 0 ? void 0 : _b.trim()) || "Untitled";
                novel.cover = $2(".su-row > div > div > img").attr("src") || defaultCover_1.defaultCover;
                novelInfos = $2("div[data-title=Tomes] >").toArray();
                novelInfos.pop();
                novelInfos.shift();
                novel.summary = $2("div[data-title=Synopsis]").text().trim() + "\n\n" + novelInfos.map(function(el) {
                  return $2(el).text();
                }).join("\n").trim();
                novel.author = $2("strong:contains('Auteur :')").parent().text().replace("Auteur : ", "").trim();
                novel.artist = $2("strong:contains('Illustrateur :')").parent().text().replace("Illustrateur :", "").trim();
                categorie = $2(".categorie").text().replace("Cat\xE9gorie :", "").trim();
                genres = $2(".genre").text().replace("Genre :", "").replace(/, /g, ",").trim();
                if (categorie && categorie != "Autre")
                  novel.genres = categorie;
                if (genres)
                  novel.genres = novel.genres ? novel.genres + "," + genres : genres;
                status = $2("strong:contains('Statut :')").parent().attr("class");
                switch (status) {
                  case "type etat0":
                  case "type etat1":
                ...
                novelChapters = [];
                volumes = $2("div[data-title=Tomes] > div").last().contents();
                ...
                volumes.each(function(volumeIndex, el) {
                  ...
                  $2(el).find(".chpt").each(function(chapterIndex, el2) {
                    var _a2, _b2, _c2;
                    var cheerio = $2(el2);
                    var newChapterName = chapterName + cheerio.find("a").first().text().trim() || "";
                    if (!cheerio.find("i.fa").length) {
                      var dateHtml = ((_a2 = cheerio.html()) === null || _a2 === void 0 ? void 0 : _a2.substring(((_b2 = cheerio.html()) === null || _b2 === void 0 ? void 0 : _b2.indexOf("</a>")) || 0)) || "";
                      var releaseDate = (dateHtml === null || dateHtml === void 0 ? void 0 : dateHtml.substring(dateHtml.indexOf("(") + 1, dateHtml.indexOf(")"))) || void 0;
                      ...
                      var items = ((_c2 = cheerio.find("i").parent().next().html()) === null || _c2 === void 0 ? void 0 : _c2.split("</a>")) || [];
                      ...
                      var hrefs_1 = [];
                      cheerio.find("i").parent().next().find("a").each(function() {
                        hrefs_1.push(this["attribs"]["href"]);
                      });
                      if (dates_1.length == hrefs_1.length)
                        dates_1.forEach(function(date, index2) {
                          var chapter2 = {
                            name: newChapterName + " (" + (index2 + 1) + ")",
                            releaseTime: date,
                            path: hrefs_1[index2].replace(site, ""),
                            chapterNumber: chapterIndex + (index2 + 1) / 1e3
                          };
                          novelChapters.push(chapter2);
                        });
                    }
                  });
                });
      ...
      NovelDeGlacePlugin2.prototype.parseChapter = function(chapterPath) {
        return __awaiter(this, void 0, void 0, function() {
          var $2, chapterText;
          return __generator(this, function(_a) {
            switch (_a.label) {
              ...
              case 1:
                ...
                if (!$2)
                  throw new Error("Failed to load page (open in web view)");
                $2(".mistape_caption").remove();
                chapterText = $2(".chapter-content").html() || $2(".entry-content").html() || "";
                return [2, chapterText];
            }
          });
        });
      };
      NovelDeGlacePlugin2.prototype.searchNovels = function(searchTerm, num) {
        return __awaiter(this, void 0, void 0, function() {
          var url, $2, novels;
          return __generator(this, function(_a) {
            switch (_a.label) {
              ...
              case 1:
                ...
                if (!$2)
                  throw new Error("Failed to load page (open in web view)");
                novels = this.parseNovels($2, false);
