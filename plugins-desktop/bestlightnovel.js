...
var LNReaderPlugin = (() => {
  ...
  var BLN = (
    ...
    function() {
      ...
      __name(BLN2, "BLN");
      BLN2.prototype.parseNovels = function(loadedCheerio) {
        var _this = this;
        var novels = [];
      ...
      BLN2.prototype.popularNovels = function(page_1, _a) {
      ...
      BLN2.prototype.parseNovel = function(novelPath) {
            ...
            switch (_b.label) {
              ...
              case 2:
                ...
                loadedCheerio("ul.truyen_info_right > li").each(function() {
                  ...
                  var detail = loadedCheerio(this).find("a").map(function(a, ex) {
                  ...
                  switch (detailName) {
                    ...
                    case "GENRES: ":
                      ...
                      break;
                    case "STATUS : ":
                      novel.status = detail === "Ongoing" ? novelStatus_1.NovelStatus.Ongoing : detail === "Completed" ? novelStatus_1.NovelStatus.Completed : novelStatus_1.NovelStatus.Unknown;
                  }
                });
                chapter = [];
      ...
      BLN2.prototype.parseChapter = function(chapterPath) {
        return __awaiter(this, void 0, void 0, function() {
      ...
      BLN2.prototype.searchNovels = function(searchTerm, page) {
        return __awaiter(this, void 0, void 0, function() {
