...
var LNReaderPlugin = (() => {
  ...
  var HarkenEliwoodPlugin = (
    /** @class */
    function() {
      function HarkenEliwoodPlugin2() {
      ...
      __name(HarkenEliwoodPlugin2, "HarkenEliwoodPlugin");
      HarkenEliwoodPlugin2.prototype.getCheerio = function(url) {
      ...
      HarkenEliwoodPlugin2.prototype.popularNovels = function(pageNo) {
        return __awaiter(this, void 0, void 0, function() {
          ...
          return __generator(this, function(_a) {
            switch (_a.label) {
              case 0:
                ...
                novels = [];
                url = this.site;
                return [4, this.getCheerio(url + "/projets/")];
              case 1:
                $2 = _a.sent();
                $2("#content .entry-content [href]").not('[rel="nofollow noopener noreferrer"]').each(function(i, elem) {
      ...
      HarkenEliwoodPlugin2.prototype.parseNovel = function(novelPath) {
        return __awaiter(this, void 0, void 0, function() {
          ...
          return __generator(this, function(_a) {
            switch (_a.label) {
              ...
              case 1:
                $2 = _a.sent();
                novel.name = $2("#content h1.entry-title").text().trim();
                novel.cover = $2("#content .entry-content p img").first().attr("src") || defaultCover_1.defaultCover;
                novel.summary = this.getSummary($2("#content .entry-content").text());
                novel.author = this.getAuthor($2("#content .entry-content").text());
                novel.status = novelStatus_1.NovelStatus.Ongoing;
                chapters = [];
                $2("#content .entry-content p a").each(function(i, elem) {
      ...
      HarkenEliwoodPlugin2.prototype.getSummary = function(text3) {
        var resume = "";
        ...
        var match1 = regexResume1.exec(text3);
        var match2 = regexResume2.exec(text3);
        var match3 = regexResume3.exec(text3);
        var match4 = regexResume4.exec(text3);
        var match5 = regexResume5.exec(text3);
        if (match1 !== null) {
          resume = match1[1];
        } else if (match2 !== null) {
          resume = match2[1];
      ...
      HarkenEliwoodPlugin2.prototype.getAuthor = function(text3) {
        var regexAuteur = /Auteur\s*:\s*(.*?)\s*(?:\r?\n|$)/i;
        var match = regexAuteur.exec(text3);
        if (match !== null && match[1].trim() !== "") {
          return match[1].trim();
        }
        return "";
      };
      HarkenEliwoodPlugin2.prototype.parseChapter = function(chapterPath) {
        return __awaiter(this, void 0, void 0, function() {
          var $2, title2, chapter;
          return __generator(this, function(_a) {
            switch (_a.label) {
              case 0:
              ...
              case 1:
                $2 = _a.sent();
                title2 = $2("h1.entry-title");
                chapter = $2("div.entry-content");
                return [2, (title2.html() || "") + (chapter.html() || "")];
            }
          });
        });
      };
      HarkenEliwoodPlugin2.prototype.searchNovels = function(searchTerm, pageNo) {
        return __awaiter(this, void 0, void 0, function() {
