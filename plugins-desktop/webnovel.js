...
var LNReaderPlugin = (() => {
  ...
  var Webnovel = (
    ...
    function() {
      ...
      __name(Webnovel2, "Webnovel");
      Webnovel2.prototype.parseNovels = function(loadedCheerio, category_bool, search_bool) {
        return __awaiter(this, void 0, void 0, function() {
          var selector, attribute;
          return __generator(this, function(_a) {
            selector = category_bool ? ".j_category_wrapper" : search_bool ? ".j_list_container" : "";
            attribute = category_bool ? "data-original" : search_bool ? "src" : "";
            return [2, loadedCheerio("".concat(selector, " li")).map(function(i_, ele) {
              var novelName = loadedCheerio(ele).find(".g_thumb").attr("title") || "No Title Found";
              var novelCover = loadedCheerio(ele).find(".g_thumb > img").attr(attribute);
      ...
      Webnovel2.prototype.popularNovels = function(pageNo_1, _a) {
            ...
            switch (_c.label) {
              case 0:
                if (filters === null || filters === void 0 ? void 0 : filters.fanfic_search.value) {
                  return [2, this.searchNovelsInternal(filters.fanfic_search.value, pageNo, "fanfic")];
                }
              ...
              case 2:
                ...
                return [2, this.parseNovels(loadedCheerio, true, false)];
            }
          });
        });
      };
      Webnovel2.prototype.parseChapters = function(novelPath) {
        return __awaiter(this, void 0, void 0, function() {
            ...
            switch (_a.label) {
              ...
              case 2:
                ...
                loadedCheerio(".volume-item").each(function(i_v_, ele_v) {
                  ...
                  var volumeName = volumeNameMatch ? "Volume ".concat(volumeNameMatch[1]) : "Unknown Volume";
                  loadedCheerio(ele_v).find("li").each(function(i_c_, ele_c) {
                    var _a2;
                    var chapterName = "".concat(volumeName, ": ") + (((_a2 = loadedCheerio(ele_c).find("a").attr("title")) === null || _a2 === void 0 ? void 0 : _a2.trim()) || "No Title Found");
                    ...
                    if (chapterPath && !(locked && _this.hideLocked)) {
                      chapters.push({
                        name: locked ? "".concat(chapterName, " \u{1F512}") : chapterName,
                        path: chapterPath
                      });
                    }
                  });
      ...
      Webnovel2.prototype.parseNovel = function(novelPath) {
        return __awaiter(this, void 0, void 0, function() {
            ...
            switch (_b.label) {
              ...
              case 2:
                ...
                _a = {
                  ...
                  summary: loadedCheerio(".j_synopsis > p").find("br").replaceWith("\n").end().text().trim() || "No Summary Found",
                  author: loadedCheerio(".det-info .c_s").filter(function(i_, ele) {
                    return loadedCheerio(ele).text().trim() === "Author:";
                  }).next().text().trim() || "No Author Found",
                  status: loadedCheerio(".det-hd-detail svg").filter(function(i_, ele) {
                    return loadedCheerio(ele).attr("title") === "Status";
                  }).next().text().trim() || "Unknown Status"
                };
                return [4, this.parseChapters(novelPath)];
              case 3:
                novel = (_a.chapters = _b.sent(), _a);
                return [2, novel];
            }
          });
        });
      };
      Webnovel2.prototype.parseChapter = function(chapterPath) {
        return __awaiter(this, void 0, void 0, function() {
          ...
          return __generator(this, function(_a) {
            switch (_a.label) {
              ...
              case 2:
                ...
                return [2, loadedCheerio(".cha-tit").html() + loadedCheerio(".cha-words").html()];
            }
          });
        });
      };
      Webnovel2.prototype.searchNovels = function(searchTerm, pageNo) {
        return __awaiter(this, void 0, void 0, function() {
          return __generator(this, function(_a) {
            return [2, this.searchNovelsInternal(searchTerm, pageNo)];
          });
        });
      };
      Webnovel2.prototype.searchNovelsInternal = function(searchTerm, pageNo, type) {
        return __awaiter(this, void 0, void 0, function() {
          ...
          return __generator(this, function(_a) {
            switch (_a.label) {
              ...
              case 2:
                body = _a.sent();
                loadedCheerio = (0, cheerio_1.load)(body);
                return [2, this.parseNovels(loadedCheerio, false, true)];
            }
          });
        });
      };
