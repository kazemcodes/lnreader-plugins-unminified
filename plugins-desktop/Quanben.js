...
var LNReaderPlugin = (() => {
  ...
  var getStandardNovelPath = /* @__PURE__ */ __name(function(url) {
    var parsedUrl = parseUrl(url);
    if (!parsedUrl)
      return void 0;
    var match = parsedUrl.pathname.match(/^(\/amp)?(\/n\/[^\/]+\/)/);
    return match === null || match === void 0 ? void 0 : match[2];
  }, "getStandardNovelPath");
  var getChapterFileName = /* @__PURE__ */ __name(function(url) {
    var parsedUrl = parseUrl(url);
    if (!parsedUrl)
      return void 0;
  ...
  var QuanbenPlugin = (
    ...
    function() {
      ...
      __name(QuanbenPlugin2, "QuanbenPlugin");
      QuanbenPlugin2.prototype.popularNovels = function(_pageNo_1, _a) {
        return __awaiter(this, arguments, void 0, function(_pageNo, _b) {
          var url, res, $2, _c, novels;
          var _this = this;
          var filters = _b.filters;
          return __generator(this, function(_d) {
            switch (_d.label) {
              case 0:
                url = filters.genre.value === "all" ? this.site : "".concat(this.site, "c/").concat(filters.genre.value, ".html");
              ...
              case 1:
                ...
                return [4, res.text()];
              case 2:
                $2 = _c.apply(void 0, [_d.sent()]);
                novels = [];
                $2("div.list2").each(function(_i, list2) {
                  var _a2, _b2, _c2;
                  var $list2 = $2(list2);
                  var $link = $list2.find("h3 > a").first();
                  var href = (_a2 = $link.attr("href")) === null || _a2 === void 0 ? void 0 : _a2.trim();
                  var name = $link.text().trim();
                  var rawCover = ((_b2 = $list2.find("img").attr("src")) === null || _b2 === void 0 ? void 0 : _b2.trim()) || ((_c2 = $list2.find("img").attr("data-src")) === null || _c2 === void 0 ? void 0 : _c2.trim());
                ...
                $2("ul.list").each(function(_i, ul) {
                  var _a2;
                  var $firstLi = $2(ul).find("li").first();
                  var $a = $firstLi.find("a").first();
                  var href = (_a2 = $a.attr("href")) === null || _a2 === void 0 ? void 0 : _a2.trim();
      ...
      QuanbenPlugin2.prototype.parseNovel = function(novelPath) {
        return __awaiter(this, void 0, void 0, function() {
          var standardPath, fullUrl, res, $2, _a, $info, $desc, novel;
          var _b;
          return __generator(this, function(_c) {
            switch (_c.label) {
              case 0:
                ...
                return [4, (0, fetch_1.fetchApi)(fullUrl)];
              case 1:
                res = _c.sent();
                if (!res.ok)
              ...
              case 2:
                ...
                $info = $2("div.list2").first();
                $desc = $2("div.description").first();
                _b = {
                  path: standardPath,
                  name: $info.find("h3").text().trim() || "Unknown Novel",
                  cover: makeAbsolute($info.find("img").attr("src"), this.site) || this.defaultCover,
                  summary: $desc.find("p").text().trim() || $desc.text().trim() || void 0,
                  author: $info.find("p:contains('\u4F5C\u8005:') span").text().trim() || void 0,
                  status: novelStatus_1.NovelStatus.Unknown,
                  genres: $info.find("p:contains('\u7C7B\u522B:') span").text().trim() || void 0
                };
                return [4, this.parseChapterList(standardPath)];
              case 3:
                novel = (_b.chapters = _c.sent(), _b);
      ...
      QuanbenPlugin2.prototype.parseChapterList = function(novelPath) {
        return __awaiter(this, void 0, void 0, function() {
          var url, res, $2, _a, chapters, novelName, uniqueChapters;
          var _this = this;
          var _b;
          return __generator(this, function(_c) {
            switch (_c.label) {
              ...
              case 2:
                ...
                if (!novelName)
                  return [2, []];
                $2("ul.list3 li a").each(function(_i, el) {
                  var $el = $2(el);
                ...
                uniqueChapters = Array.from(new Map(chapters.map(function(c) {
                  return [c.path, c];
                })).values());
                uniqueChapters.sort(function(a, b) {
                  var _a2, _b2;
                  var numA = parseInt(((_a2 = a.path.match(/(\d+)\.html$/)) === null || _a2 === void 0 ? void 0 : _a2[1]) || "0", 10);
                  var numB = parseInt(((_b2 = b.path.match(/(\d+)\.html$/)) === null || _b2 === void 0 ? void 0 : _b2[1]) || "0", 10);
                  return numA - numB;
                });
                return [2, uniqueChapters.map(function(c, idx) {
                  return __assign(__assign({}, c), { chapterNumber: idx + 1 });
                })];
            }
          });
        });
      };
      QuanbenPlugin2.prototype.parseChapter = function(chapterPath) {
        return __awaiter(this, void 0, void 0, function() {
          var url, res, _a;
      ...
      QuanbenPlugin2.prototype.extractChapterContent = function(body) {
        var $2 = (0, cheerio_1.load)(body);
        var $content = $2("#contentbody, #content, .content").first();
        if (!$content.length)
          return "Error: Chapter content not found.";
        $content.find('script, style, ins, iframe, [class*="ads"], [id*="ads"], [class*="google"], [id*="google"], [class*="recommend"], div[align="center"]').remove();
        return ($content.html() || "").replace(/[\t ]+/g, " ").trim() || "Error: Chapter content empty.";
      };
      QuanbenPlugin2.prototype.searchNovels = function(searchTerm) {
        return __awaiter(this, void 0, void 0, function() {
          var url, res, $2, _a, novels;
          var _this = this;
          return __generator(this, function(_b) {
            switch (_b.label) {
              case 0:
              ...
              case 2:
                ...
                novels = [];
                $2("div.list2").each(function(_i, el) {
                  var $el = $2(el);
      ...
      QuanbenPlugin2.prototype.fetchImage = function(url) {
        return __awaiter(this, void 0, void 0, function() {
          return __generator(this, function(_a) {
            return [2, (0, fetch_1.fetchApi)(url)];
          });
        });
      };
      return QuanbenPlugin2;
    }()
  );
