...
var LNReaderPlugin = (() => {
  ...
  var ReinoWuxia = (
    /** @class */
    function() {
      function ReinoWuxia2() {
        this.id = "reinowuxia";
        this.name = "ReinoWuxia";
        this.icon = "src/es/reinowuxia/icon.png";
        this.version = "1.0.0";
        this.site = "http://www.reinowuxia.com/";
      }
      __name(ReinoWuxia2, "ReinoWuxia");
      ReinoWuxia2.prototype.getNovelName = function(y) {
        return y === null || y === void 0 ? void 0 : y.replace(/-/g, " ").replace(/(?:^|\s)\S/g, function(a) {
          return a.toUpperCase();
        });
      };
      ReinoWuxia2.prototype.popularNovels = function() {
        return __awaiter(this, void 0, void 0, function() {
          ...
          return __generator(this, function(_a) {
            switch (_a.label) {
              case 0:
                url = this.site + "p/todas-las-novelas.html";
              ...
              case 2:
                ...
                novels = [];
                loadedCheerio(".post-body.entry-content").find("a").each(function(idx, ele) {
                  var _a2, _b;
                  var novelName = (_b = (_a2 = loadedCheerio(ele).attr("href")) === null || _a2 === void 0 ? void 0 : _a2.split("/").pop()) === null || _b === void 0 ? void 0 : _b.replace(".html", "");
      ...
      ReinoWuxia2.prototype.parseNovel = function(novelPath) {
        return __awaiter(this, void 0, void 0, function() {
              ...
              case 2:
                ...
                loadedCheerio("div > b").each(function() {
                  ...
                  if (detailName && detail) {
                    var text3 = loadedCheerio(detail).text();
                    if (detailName.includes("Autor")) {
                      novel.author = text3.replace("Autor:", "");
                    }
                    if (detailName.includes("Estatus")) {
                      novel.status = text3.replace("Estatus: ", "");
                    }
                    if (detailName.includes("G\xE9neros:")) {
                      novel.genres = text3.replace("G\xE9neros: ", "").replace(/,\s/g, ",");
                    }
                  }
                });
                novelChapters = [];
                loadedCheerio("div").each(function(idx, rootEle) {
                  var detailName = loadedCheerio(rootEle).text();
                  if (detailName.includes("Sinopsis")) {
                    novel.summary = loadedCheerio(rootEle).next().text() !== "" ? loadedCheerio(rootEle).next().text().replace("Sinopsis", "").trim() : loadedCheerio(rootEle).next().next().text().replace("Sinopsis", "").trim();
                  }
                  if (detailName.includes("Lista de Cap\xEDtulos")) {
                    loadedCheerio(rootEle).find("a").each(function(idx2, ele) {
                      var _a2;
                      var chapterName = loadedCheerio(ele).text();
                      var chapterPath = (_a2 = loadedCheerio(ele).attr("href")) === null || _a2 === void 0 ? void 0 : _a2.replace(_this.site, "");
                      var releaseDate = null;
                      if (chapterName && chapterPath && chapterPath !== "/" && !novelChapters.some(function(chap) {
                        return chap.name === chapterName;
                      })) {
                        var chapter = {
                          name: chapterName,
      ...
      ReinoWuxia2.prototype.parseChapter = function(chapterPath) {
        return __awaiter(this, void 0, void 0, function() {
      ...
      ReinoWuxia2.prototype.searchNovels = function(searchTerm) {
        return __awaiter(this, void 0, void 0, function() {
          var url, result, body, loadedCheerio, novels;
          var _this = this;
          return __generator(this, function(_a) {
            switch (_a.label) {
              case 0:
                url = "".concat(this.site, "search?q=").concat(searchTerm);
                return [4, (0, fetch_1.fetchApi)(url)];
              case 1:
                result = _a.sent();
                return [4, result.text()];
              case 2:
                ...
                loadedCheerio(".date-outer").each(function(idx, ele) {
                  var _a2, _b;
                  var novelName = (_b = (_a2 = loadedCheerio(ele).find("a").attr("href")) === null || _a2 === void 0 ? void 0 : _a2.split("/").pop()) === null || _b === void 0 ? void 0 : _b.replace(/-capitulo(.*?).html/, "");
                  var novelUrl = novelName + ".html/";
                  novelName = _this.getNovelName(novelName);
                  var exists = novels.some(function(novel2) {
                    return novel2.name === novelName;
                  });
                  if (!exists) {
