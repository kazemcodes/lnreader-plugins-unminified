...
var LNReaderPlugin = (() => {
  ...
  var NovelkiPL = (
    ...
    function() {
      ...
      __name(NovelkiPL2, "NovelkiPL");
      NovelkiPL2.prototype.popularNovels = function(page_1, _a) {
        return __awaiter(this, arguments, void 0, function(page, _b) {
          var link, body, loadedCheerio, load2, novels;
          var _this = this;
          ...
          return __generator(this, function(_c) {
            switch (_c.label) {
              ...
              case 1:
                ...
                load2 = loadedCheerio("#projects > div");
                novels = load2.map(function(index2, element) {
                  return {
                    name: loadedCheerio(element).find(".card-title").attr("title"),
      ...
      NovelkiPL2.prototype.parseNovel = function(novelPath) {
            ...
            switch (_a.label) {
              ...
              case 1:
                ...
                loadedCheerio("p.h5").each(function(i, e) {
                  var text3 = loadedCheerio(e).text().trim();
                  if (text3.includes("Autor:"))
                    novel.author = text3.split(":")[1].trim();
                  if (text3.includes("Status projektu:")) {
                    switch ("".concat(text3.split(":")[1].trim()).toLowerCase()) {
                      case "wstrzymany":
                ...
                novel.name = loadedCheerio("div.col-sm-12.col-md-6.col-lg-8.mb-5").find("h3").text().trim();
                novel.cover = this.site + loadedCheerio(".img-fluid").attr("src");
                novel.genres = loadedCheerio("span.badge").map(function(i, e) {
                  return loadedCheerio(e).text();
                }).get().join(", ");
                ...
                chaptersList.forEach(function(e, i) {
                  ...
                  var chapter = {
                    name: (_a2 = loadedCheerio(e).find("a")) === null || _a2 === void 0 ? void 0 : _a2.text().trim(),
                    path: urlChapters,
      ...
      NovelkiPL2.prototype.parseChapter = function(chapterPath) {
        return __awaiter(this, void 0, void 0, function() {
          ...
          return __generator(this, function(_a) {
            switch (_a.label) {
              case 0:
                ...
                return [4, (0, fetch_1.fetchApi)("".concat(this.site, "/api/reader/chapters/").concat(codeChapter[2])).then(function(res) {
                  if (res.url == "".concat(_this.site, "/guest"))
      ...
      NovelkiPL2.prototype.searchNovels = function(searchTerm, page) {
        return __awaiter(this, void 0, void 0, function() {
          ...
          return __generator(this, function(_a) {
            switch (_a.label) {
              case 0:
                return [4, (0, fetch_1.fetchApi)("".concat(this.site, "/projekty?filter=t&title=").concat(searchTerm, "+&page=").concat(page)).then(function(res) {
                  if (res.url == "".concat(_this.site, "/guest"))
              ...
              case 1:
                body = _a.sent();
                loadedCheerio = (0, cheerio_1.load)(body);
                novels = loadedCheerio("#projects > div").map(function(index2, element) {
                  return {
                    name: loadedCheerio(element).find(".card-title").attr("title"),
                    cover: _this.site + loadedCheerio(element).find(".card-img-top").attr("src"),
                    path: loadedCheerio(element).find("a").attr("href") || ""
