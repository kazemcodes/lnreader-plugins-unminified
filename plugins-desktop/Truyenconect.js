...
var LNReaderPlugin = (() => {
  ...
  var TruyenConect = (
    ...
    function() {
        ...
        this.filters = {
          ...
          genre: {
            ...
            options: [
              ...
              { label: "Ti\xEAn hi\u1EC7p", value: "tien-hiep" },
              { label: "Ki\u1EBFm Hi\u1EC7p", value: "kiem-hiep" },
              { label: "Ng\xF4n T\xECnh", value: "ngon-tinh" },
              { label: "Isekai", value: "isekai" },
              { label: "L\u1ECBch S\u1EED", value: "lich-su" },
              { label: "Web Novel", value: "web-novel" },
              { label: "Xuy\xEAn kh\xF4ng", value: "xuyen-khong" },
              { label: "Tr\u1ECDng sinh", value: "trong-sinh" },
              { label: "Trinh th\xE1m", value: "trinh-tham" },
              ...
              { label: "V\xF5ng Du", value: "vong-du" },
              { label: "\u0110\u1ED3ng Nh\xE2n", value: "dong-nhan" }
            ]
          }
        };
      }
      __name(TruyenConect2, "TruyenConect");
      TruyenConect2.prototype.sleep = function(ms) {
      ...
      TruyenConect2.prototype.parseNovels = function(loadedCheerio, selector) {
        var _this = this;
        var novels = [];
      ...
      TruyenConect2.prototype.popularNovels = function(pageNo_1, _a) {
          ...
          return __generator(this, function(_c) {
            switch (_c.label) {
              ...
              case 1:
                ...
                return [2, this.parseNovels(loadedCheerio, selector)];
            }
          });
        });
      };
      TruyenConect2.prototype.parseChapters = function(loadedCheerio) {
        var _this = this;
        var chapters = [];
        loadedCheerio("option").each(function(idx, ele) {
          ...
          chapters.push({
            ...
            chapterNumber: Number(num) || void 0
          });
        });
        return chapters.reverse();
      };
      TruyenConect2.prototype.parseVolumes = function(loadedCheerio) {
        var volumes = [];
        loadedCheerio("option").each(function(idx, ele) {
          volumes.push({
      ...
      TruyenConect2.prototype.getVolumes = function(firstChapterUrl) {
        return __awaiter(this, void 0, void 0, function() {
          var chapterId, url, data2, volumeList;
          var _a;
          return __generator(this, function(_b) {
            switch (_b.label) {
              case 0:
                ...
                if (!chapterId)
                  throw new Error("Kh\xF4ng t\xECm th\u1EA5y ch\u01B0\u01A1ng");
                url = this.site + "/truyen/get-chap-selector?chap=" + chapterId;
                return [4, (0, fetch_1.fetchApi)(url).then(function(r) {
                  return r.json();
                })];
              case 1:
                data2 = _b.sent();
                volumeList = {
                  chapters: this.parseChapters((0, cheerio_1.load)(data2.chap_selector))
                };
                if (data2.eps_selector) {
                  volumeList.volumes = this.parseVolumes((0, cheerio_1.load)(data2.eps_selector));
                }
                return [2, volumeList];
            }
          });
      ...
      TruyenConect2.prototype.parseNovel = function(novelPath) {
        return __awaiter(this, void 0, void 0, function() {
            ...
            switch (_a.label) {
              ...
              case 2:
                ...
                loadedCheerio(".post-content_item").each(function() {
                  ...
                  switch (detailName) {
                    case "Th\u1EC3 lo\u1EA1i":
                      novel.genres = loadedCheerio(detail).children("a").map(function(i, el) {
                ...
                novel.summary = loadedCheerio(".description-summary > div.summary__content").text().trim();
                firstChapLink = loadedCheerio("#init-links > a").first().attr("href");
                if (!firstChapLink)
                  throw new Error("Kh\xF4ng t\xECm th\u1EA5y truy\u1EC7n");
                return [4, this.sleep(1e3)];
              case 3:
                _a.sent();
                return [4, this.getVolumes(firstChapLink)];
              case 4:
                volumeList = _a.sent();
      ...
      TruyenConect2.prototype.parsePage = function(novelPath, page) {
        return __awaiter(this, void 0, void 0, function() {
            ...
            switch (_a.label) {
              ...
              case 4:
                ...
                if (volumeIndex >= volumeList.volumes.length)
                  throw new Error("Kh\xF4ng t\xECm th\u1EA5y volume");
              ...
              case 5:
                _a.sent();
                return [4, (0, fetch_1.fetchApi)(chaptersUrl).then(function(r) {
                  return r.json();
                })];
              case 6:
                res = _a.sent();
      ...
      TruyenConect2.prototype.parseChapter = function(chapterPath) {
        return __awaiter(this, void 0, void 0, function() {
      ...
      TruyenConect2.prototype.searchNovels = function(searchTerm, pageNo) {
        return __awaiter(this, void 0, void 0, function() {
