...
var LNReaderPlugin = (() => {
  ...
  // .js/plugins/ukrainian/bakainua.js
  init_dirname();
  init_buffer2();
  init_process2();
  ...
  var BakaInUa = (
    ...
    function() {
      ...
      __name(BakaInUa2, "BakaInUa");
      BakaInUa2.prototype.popularNovels = function(pageNo_1, _a) {
        return __awaiter(this, arguments, void 0, function(pageNo, _b) {
          var fictionIds, url, result, body, $2, requests;
          var _this = this;
          ...
          return __generator(this, function(_c) {
            switch (_c.label) {
              case 0:
                ...
                return [4, (0, fetch_1.fetchApi)(url.toString())];
              case 1:
                result = _c.sent();
              ...
              case 2:
                ...
                $2("div#fiction-list-page > div > div > div > img").each(function(index2, elem) {
                  var fictionId = $2(elem).attr("data-fiction-picker-id-param");
                  if (fictionId) {
                    fictionIds.push(fictionId);
                  }
                });
                requests = fictionIds.map(function(id) {
                  return __awaiter(_this, void 0, void 0, function() {
                    var res, $3, _a2, elem;
                    return __generator(this, function(_b2) {
                      switch (_b2.label) {
                        case 0:
                          return [4, (0, fetch_1.fetchApi)("".concat(this.site, "/fictions/").concat(id, "/details"), {
                            headers: {
                        ...
                        case 1:
                          ...
                          return [4, res.text()];
                        case 2:
                          $3 = _a2.apply(void 0, [_b2.sent()]);
                          elem = $3("a").first();
                          return [2, {
                            name: $3("h3").text().trim(),
                            path: elem.attr("href") || "",
                            cover: this.site + $3(elem).find("img").attr("src")
                          }];
                      }
                    });
                  });
      ...
      BakaInUa2.prototype.parseNovel = function(novelUrl) {
        return __awaiter(this, void 0, void 0, function() {
          var result, body, $2, novel, chapters;
          return __generator(this, function(_a) {
            switch (_a.label) {
              case 0:
                return [4, (0, fetch_1.fetchApi)(this.site + "/" + novelUrl)];
              case 1:
                result = _a.sent();
                return [4, result.text()];
              case 2:
                ...
                novel = {
                  path: novelUrl,
                  name: $2("main div > h1").text().trim(),
                  author: $2("button#fictions-author-search").text().trim(),
                  cover: this.site + $2("main div > img").attr("src"),
                  summary: $2("main div > h3").first().parent().find("div").text().trim(),
                  genres: $2('h4:contains("\u0416\u0430\u043D\u0440\u0438")').last().siblings().last().find("span").map(function(_, el) {
                    return $2(el).text().trim();
                  }).get().join(", ")
                };
                switch ($2('div:contains("\u0421\u0442\u0430\u0442\u0443\u0441")').last().siblings().text().trim()) {
                  case "\u0412\u0438\u0434\u0430\u0454\u0442.":
                ...
                chapters = [];
                $2("li.group a").each(function(index2, elem) {
                  var chapter = {
                    name: $2(elem).find("span").eq(1).text().trim(),
                    path: $2(elem).attr("href") || "",
                    chapterNumber: parseInt($2(elem).find("span").eq(0).text().trim()),
                    releaseTime: $2(elem).find("span").eq(2).text().trim()
                  };
      ...
      BakaInUa2.prototype.parseChapter = function(chapterUrl) {
        return __awaiter(this, void 0, void 0, function() {
          var result, body, $2;
          return __generator(this, function(_a) {
            switch (_a.label) {
              case 0:
                return [4, (0, fetch_1.fetchApi)(this.site + "/" + chapterUrl)];
              case 1:
                result = _a.sent();
                return [4, result.text()];
              case 2:
                body = _a.sent();
                $2 = (0, cheerio_1.load)(body);
                return [2, $2("#user-content").html() || ""];
            }
          });
        });
      };
      BakaInUa2.prototype.searchNovels = function(searchTerm) {
        return __awaiter(this, void 0, void 0, function() {
          var novels, result, body, $2;
          var _this = this;
          return __generator(this, function(_a) {
            switch (_a.label) {
              case 0:
                novels = [];
                return [4, (0, fetch_1.fetchApi)(this.site + "/search?search%5B%5D=" + searchTerm + "&only_fictions=true")];
              case 1:
                result = _a.sent();
                return [4, result.text()];
              case 2:
                body = _a.sent();
                $2 = (0, cheerio_1.load)(body);
                $2("ul > section").each(function(index2, elem) {
                  novels.push({
                    path: $2(elem).find("a").first().attr("href") || "",
                    name: $2(elem).find("a > h2").first().text().trim(),
                    cover: _this.site + $2(elem).find("img").first().attr("src")
                  });
                });
                return [2, novels];
            }
