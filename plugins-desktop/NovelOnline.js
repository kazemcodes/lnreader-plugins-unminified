...
var LNReaderPlugin = (() => {
  ...
  var NovelsOnline = (
    ...
    function() {
      ...
      __name(NovelsOnline2, "NovelsOnline");
      NovelsOnline2.prototype.safeFetch = function(url_1) {
        return __awaiter(this, arguments, void 0, function(url, init) {
          var r, body, $2, hasElementNodes;
          if (init === void 0) {
            init = void 0;
          }
          return __generator(this, function(_a) {
            switch (_a.label) {
              ...
              case 2:
                ...
                hasElementNodes = $2("title") !== void 0;
                if (!hasElementNodes)
      ...
      NovelsOnline2.prototype.parseNovels = function(loadedCheerio) {
        return __awaiter(this, void 0, void 0, function() {
          ...
          return __generator(this, function(_a) {
            ...
            loadedCheerio(".top-novel-block").each(function(i, el) {
              ...
              var novelCover = loadedCheerio(el).find(".top-novel-cover img").attr("src");
      ...
      NovelsOnline2.prototype.popularNovels = function(page_1, _a) {
        return __awaiter(this, arguments, void 0, function(page, _b) {
          var form, key, _i, _c, value, $2;
            ...
            switch (_d.label) {
              case 0:
                ...
                if (form.toString()) {
                  ...
                  return [2, page == 1 ? this.detailedSearch(form) : []];
                }
                return [4, this.safeFetch(this.site + "/top-novel/" + page)];
              case 1:
                $2 = _d.sent();
                return [2, this.parseNovels($2)];
            }
          });
        });
      };
      NovelsOnline2.prototype.searchNovels = function(searchTerm) {
        return __awaiter(this, void 0, void 0, function() {
          var form;
          return __generator(this, function(_a) {
            form = new URLSearchParams();
            ...
            form.append("search", "1");
            return [2, this.detailedSearch(form)];
          });
        });
      };
      NovelsOnline2.prototype.detailedSearch = function(form) {
        return __awaiter(this, void 0, void 0, function() {
          var $2;
          return __generator(this, function(_a) {
            switch (_a.label) {
              case 0:
                return [4, this.safeFetch(this.site + "/detailed-search", {
                  method: "POST",
                  headers: {
      ...
      NovelsOnline2.prototype.parseNovel = function(novelPath) {
        return __awaiter(this, void 0, void 0, function() {
          var $2, novel;
          var _this = this;
          return __generator(this, function(_a) {
            switch (_a.label) {
              case 0:
                return [4, this.safeFetch(this.site + novelPath)];
              case 1:
                $2 = _a.sent();
                novel = {
                  path: novelPath,
                  name: $2("h1").text() || "Untitled",
                  cover: $2(".novel-cover").find("a > img").attr("src"),
                  chapters: []
                };
                $2(".novel-detail-item").each(function(i, el) {
                  var detailName = $2(el).find("h6").text();
                  var detail = $2(el).find(".novel-detail-body");
                  switch (detailName) {
                    case "Description":
                      novel.summary = detail.text();
                      break;
                    case "Genre":
                      novel.genres = detail.find("li").map(function(_, el2) {
                        return $2(el2).text();
                      }).get().join(", ");
                      break;
                    case "Author(s)":
                      novel.author = detail.find("li").map(function(_, el2) {
                        return $2(el2).text();
                      }).get().join(", ");
                      break;
                    case "Artist(s)":
                      var artist = detail.find("li").map(function(_, el2) {
                        return $2(el2).text();
                      }).get().join(", ");
                ...
                novel.chapters = $2("ul.chapter-chs > li > a").map(function(_, el) {
                  var chapterUrl = $2(el).attr("href");
                  var chapterName = $2(el).text();
                  return {
                    name: chapterName,
      ...
      NovelsOnline2.prototype.parseChapter = function(chapterPath) {
        return __awaiter(this, void 0, void 0, function() {
          var loadedCheerio, chapterText;
          return __generator(this, function(_a) {
            switch (_a.label) {
              case 0:
                return [4, this.safeFetch(this.site + chapterPath)];
              case 1:
