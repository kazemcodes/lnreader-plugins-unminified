    ...
    function() {
      ...
      TruyenFull2.prototype.parseNovels = function(loadedCheerio) {
        ...
        loadedCheerio(".list-truyen .row").each(function(idx, ele) {
          ...
          var novelCover = _this.site + loadedCheerio(ele).find("div[data-classname='cover']").attr("data-image");
      ...
      TruyenFull2.prototype.parseChapters = function(html3) {
        var _this = this;
        var _a;
        var listChapterHTML = (_a = html3.match(/("list_chapter":\s?\\{0}"(.+)\\{0}"),/)) === null || _a === void 0 ? void 0 : _a[1];
        if (!listChapterHTML)
          throw new Error("Kh\xF4ng t\u1EA3i \u0111\u01B0\u1EE3c ch\u01B0\u01A1ng");
        ...
        loadedChapterList("ul > li > a").each(function(idx, ele) {
          ...
          if (path) {
            chapters.push({
              ...
              path,
              chapterNumber: Number((_a2 = path.match(/\/chuong-(\d+)/)) === null || _a2 === void 0 ? void 0 : _a2[1])
            });
          }
        });
        return chapters;
      };
      TruyenFull2.prototype.popularNovels = function(pageNo) {
            ...
            switch (_b.label) {
              ...
              case 2:
                ...
                (_a = body.match(regex)) === null || _a === void 0 ? void 0 : _a.forEach(function(v) {
                  var _a2;
                  var page = Number((_a2 = v.match(/\?page=(\d+)/)) === null || _a2 === void 0 ? void 0 : _a2[1]);
