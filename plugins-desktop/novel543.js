...
var LNReaderPlugin = (() => {
  ...
  var makeAbsolute = /* @__PURE__ */ __name(function(relativeUrl, baseUrl) {
    if (!relativeUrl)
      return void 0;
    try {
  ...
  var Novel543Plugin = (
    ...
    function() {
      ...
      __name(Novel543Plugin2, "Novel543Plugin");
      Novel543Plugin2.prototype.popularNovels = function(pageNo) {
        return __awaiter(this, void 0, void 0, function() {
          var result, $2, _a, novels, processedPaths;
          var _this = this;
          return __generator(this, function(_b) {
            switch (_b.label) {
              case 0:
                if (pageNo > 1)
                  return [2, []];
                return [4, (0, fetch_1.fetchApi)(this.site)];
              case 1:
                result = _b.sent();
                if (!result.ok)
                  return [2, []];
              ...
              case 2:
                ...
                $2('ul.list > li.media, ul.list li > a[href^="/"][href$="/"]').each(function(_i, el) {
                  ...
                  if ($el.is("li.media")) {
                    ...
                    novelPath = (_a2 = $link.attr("href")) === null || _a2 === void 0 ? void 0 : _a2.trim();
                    novelName = $link.text().trim();
                    novelCover = (_b2 = $el.find(".media-left img").attr("src")) === null || _b2 === void 0 ? void 0 : _b2.trim();
                  } else if ($el.is("a")) {
                    novelPath = (_c = $el.attr("href")) === null || _c === void 0 ? void 0 : _c.trim();
                    novelName = $el.find("h3, b, span").first().text().trim() || $el.parent().find("h3").text().trim() || $el.text().trim();
                    novelCover = ((_d = $el.find("img").attr("src")) === null || _d === void 0 ? void 0 : _d.trim()) || ((_e = $el.parent().find("img").attr("src")) === null || _e === void 0 ? void 0 : _e.trim());
                  }
                  if (novelPath && novelName && novelPath.match(/^\/\d+\/$/) && !processedPaths.has(novelPath)) {
                    novels.push({
                      name: novelName,
                      path: novelPath,
      ...
      Novel543Plugin2.prototype.parseNovel = function(novelPath) {
        return __awaiter(this, void 0, void 0, function() {
          var novelUrl, result, $2, _a, $infoSection, $modSection, novel, chapterListPath, _b;
          return __generator(this, function(_c) {
            switch (_c.label) {
              case 0:
                ...
                return [4, (0, fetch_1.fetchApi)(novelUrl)];
              case 1:
                result = _c.sent();
                if (!result.ok)
                ...
                return [4, result.text()];
              case 2:
                $2 = _a.apply(void 0, [_c.sent()]);
                $infoSection = $2("section#detail div.media-content.info");
                $modSection = $2("section#detail div.mod");
                novel = {
                  path: novelPath,
                  name: $infoSection.find("h1.title").text().trim() || "Untitled",
                  cover: makeAbsolute($2("section#detail div.cover img").attr("src"), this.site) || defaultCover_1.defaultCover,
                  summary: $modSection.find("div.intro").text().trim() || void 0,
                  author: $infoSection.find("p.meta span.author").text().trim() || void 0,
                  genres: $infoSection.find('p.meta a[href*="/bookstack/"]').map(function(_i, el) {
                    return $2(el).text().trim();
                  }).get().join(", ") || void 0,
                  status: novelStatus_1.NovelStatus.Unknown,
                  chapters: []
                };
                chapterListPath = $modSection.find('p.action.buttons a.button.is-info[href$="/dir"]').attr("href") || $infoSection.find('a.button.is-info[href$="/dir"]').attr("href");
                if (!chapterListPath) return [3, 4];
                _b = novel;
                return [4, this.parseChapterList(chapterListPath)];
              case 3:
                _b.chapters = _c.sent();
                _c.label = 4;
              case 4:
      ...
      Novel543Plugin2.prototype.parseChapterList = function(chapterListPath) {
        return __awaiter(this, void 0, void 0, function() {
          var chapterListUrl, result, $2, _a, chapters, sortButtonText;
          return __generator(this, function(_b) {
            switch (_b.label) {
              case 0:
                ...
                if (!chapterListUrl)
                  return [2, []];
                return [4, (0, fetch_1.fetchApi)(chapterListUrl)];
              case 1:
                result = _b.sent();
                if (!result.ok)
                  return [2, []];
              ...
              case 2:
                $2 = _a.apply(void 0, [_b.sent()]);
                chapters = [];
                $2("div.chaplist ul.all li a").each(function(index2, el) {
                  var _a2;
                  var $el = $2(el);
                  var chapterName = $el.text().trim();
                  var chapterUrl = (_a2 = $el.attr("href")) === null || _a2 === void 0 ? void 0 : _a2.trim();
                  if (chapterName && chapterUrl) {
                    chapters.push({
                      name: chapterName,
                      path: chapterUrl,
                      chapterNumber: index2 + 1
                    });
                  }
                });
                sortButtonText = $2("div.chaplist .header button.reverse span").last().text().trim();
                if (sortButtonText === "\u5012\u5E8F") {
                  chapters.reverse();
                  chapters.forEach(function(chap, index2) {
                    return chap.chapterNumber = index2 + 1;
                  });
                }
                return [2, chapters];
            }
      ...
      Novel543Plugin2.prototype.parseChapter = function(chapterPath) {
        return __awaiter(this, void 0, void 0, function() {
          var chapterUrl, result, $2, _a, $content, chapterText;
          return __generator(this, function(_b) {
            switch (_b.label) {
              case 0:
                ...
                return [4, (0, fetch_1.fetchApi)(chapterUrl)];
              case 1:
                result = _b.sent();
                if (!result.ok)
              ...
              case 2:
                $2 = _a.apply(void 0, [_b.sent()]);
                $content = $2("div.content.py-5");
                if (!$content.length)
                  return [2, "Error: Could not find chapter content"];
                $content.find('script, style, ins, iframe, [class*="ads"], [id*="ads"], [class*="google"], [id*="google"], [class*="recommend"], div[align="center"], p:contains("\u63A8\u85A6\u672C\u66F8"), a[href*="javascript:"]').remove();
                $content.find("p").each(function(_i, el) {
                  var _a2;
                  var $p = $2(el);
                  var pText = $p.text().trim();
                  if (pText.includes("\u8ACB\u8A18\u4F4F\u672C\u7AD9\u57DF\u540D") || pText.includes("\u624B\u6A5F\u7248\u95B1\u8B80\u7DB2\u5740") || pText.includes("novel543") || pText.includes("\u7A37\u4E0B\u66F8\u9662") || pText.includes("\u6700\u5FEB\u66F4\u65B0") || pText.includes("\u6700\u65B0\u7AE0\u7BC0") || pText.includes("\u7AE0\u7BC0\u5831\u932F") || pText.match(/app|APP|下載|客户端|关注微信|公众号/i) || pText.length === 0 || ((_a2 = $p.html()) === null || _a2 === void 0 ? void 0 : _a2.replace(/&nbsp;/g, "").trim()) === "" && $p.find("img").length === 0 || pText.includes("\u6EAB\u99A8\u63D0\u793A")) {
                    $p.remove();
                  }
                });
                ...
                if (!chapterText)
                  return [2, "Error: Chapter content was empty"];
                chapterText = chapterText.replace(/<\s*p[^>]*>/gi, "\n\n").replace(/<\s*br[^>]*>/gi, "\n");
                chapterText = (0, cheerio_1.load)("<div>".concat(chapterText, "</div>")).text();
                return [2, chapterText.replace(/[\t ]+/g, " ").replace(/\n{3,}/g, "\n\n").trim()];
            }
          });
        });
      };
      Novel543Plugin2.prototype.searchNovels = function(searchTerm, pageNo) {
        return __awaiter(this, void 0, void 0, function() {
          var novelPath, novel, _a, searchUrl, body, result, $_1, pageTitle, error_1, $2, novels;
          var _this = this;
          return __generator(this, function(_b) {
            switch (_b.label) {
              case 0:
                if (pageNo > 1)
                  return [2, []];
                if (!/^\d+$/.test(searchTerm)) return [3, 4];
                _b.label = 1;
              case 1:
                _b.trys.push([1, 3, , 4]);
                novelPath = "/".concat(searchTerm, "/");
                return [4, this.parseNovel(novelPath)];
              case 2:
                novel = _b.sent();
                return [2, [
                  {
              ...
              case 5:
                _b.trys.push([5, 8, , 9]);
                return [4, (0, fetch_1.fetchApi)(searchUrl)];
              case 6:
                result = _b.sent();
                if (!result.ok) {
              ...
              case 7:
                ...
                if (pageTitle.includes("attention required") || pageTitle.includes("just a moment") || pageTitle.includes("please wait") || pageTitle.includes("verifying") || body.includes("Verifying you are human") || body.includes("cf-browser-verification") || body.includes("cf_captcha_container")) {
              ...
              case 8:
                ...
                throw error_1;
              case 9:
                $2 = (0, cheerio_1.load)(body);
                novels = [];
                $2("div.search-list ul.list > li.media").each(function(_i, el) {
                  var _a2, _b2;
                  var $el = $2(el);
                  var $link = $el.find(".media-content h3 a");
                  var novelPath2 = (_a2 = $link.attr("href")) === null || _a2 === void 0 ? void 0 : _a2.trim();
                  var novelName = $link.text().trim();
                  var novelCover = (_b2 = $el.find(".media-left img").attr("src")) === null || _b2 === void 0 ? void 0 : _b2.trim();
                  if (novelPath2 && novelName && novelPath2.match(/^\/\d+\/$/)) {
                    novels.push({
                      name: novelName,
                      path: novelPath2,
                      cover: makeAbsolute(novelCover, _this.site) || defaultCover_1.defaultCover
