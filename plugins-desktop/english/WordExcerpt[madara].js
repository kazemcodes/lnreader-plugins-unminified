...
var LNReaderPlugin = (() => {
  ...
  // .js/plugins/english/WordExcerpt[madara].js
  ...
  var r = (init_fetch2(), __toCommonJS(fetch_exports)), n = (init_browser(), __toCommonJS(browser_exports)), i = (init_defaultCover(), __toCommonJS(defaultCover_exports)), o = (init_novelStatus(), __toCommonJS(novelStatus_exports)), s = a(require_dayjs_min()), u = (init_storage2(), __toCommonJS(storage_exports)), l = function(t2, e2) {
    return new RegExp(e2.join("|")).test(t2);
  }, c = new ((function() {
    function a2(t2) {
      var e2, a3;
      this.hideLocked = u.storage.get("hideLocked"), this.parseData = function(t3) {
        var e3, a4 = (0, s.default)(), r3 = (null === (e3 = t3.match(/\d+/)) || void 0 === e3 ? void 0 : e3[0]) || "", n2 = parseInt(r3, 10);
        if (!r3) return t3;
        if (l(t3, ["detik", "segundo", "second", "\u0E27\u0E34\u0E19\u0E32\u0E17\u0E35"])) a4 = a4.subtract(n2, "second");
        else if (l(t3, ["menit", "dakika", "min", "minute", "minuto", "\u0E19\u0E32\u0E17\u0E35", "\u062F\u0642\u0627\u0626\u0642"])) a4 = a4.subtract(n2, "minute");
        else if (l(t3, ["jam", "saat", "heure", "hora", "hour", "\u0E0A\u0E31\u0E48\u0E27\u0E42\u0E21\u0E07", "gi\u1EDD", "ore", "\u0633\u0627\u0639\u0629", "\u5C0F\u65F6"])) a4 = a4.subtract(n2, "hours");
        else if (l(t3, ["hari", "g\xFCn", "jour", "d\xEDa", "dia", "day", "\u0E27\u0E31\u0E19", "ng\xE0y", "giorni", "\u0623\u064A\u0627\u0645", "\u5929"])) a4 = a4.subtract(n2, "days");
        else if (l(t3, ["week", "semana"])) a4 = a4.subtract(n2, "week");
        else if (l(t3, ["month", "mes"])) a4 = a4.subtract(n2, "month");
        else {
          if (!l(t3, ["year", "a\xF1o"])) return "Invalid Date" !== (0, s.default)(t3).format("LL") ? (0, s.default)(t3).format("LL") : t3;
      ...
      this.version = "1.0.".concat(8 + r2), this.options = t2.options, this.filters = t2.filters, (null === (a3 = this.options) || void 0 === a3 ? void 0 : a3.hasLocked) && (this.pluginSettings = { hideLocked: { value: "", label: "Hide locked chapters", type: "Switch" } });
    }
    return a2.prototype.translateDragontea = function(t2) {
      ...
      return t(this, void 0, void 0, (function() {
        ...
        return e(this, (function(e2) {
          switch (e2.label) {
            ...
            case 2:
              if (o2 = s2.apply(void 0, [e2.sent()]), u2 = o2("title").text().trim(), this.getHostname(a3) != this.getHostname(t2.url) || "Bot Verification" == u2 || "You are being redirected..." == u2 || "Un instant..." == u2 || "Just a moment..." == u2 || "Redirecting..." == u2) throw new Error("Captcha error, please open in webview");
              return [2, o2];
          }
        }));
      }));
      ...
      return t2(".manga-title-badges").remove(), t2(".page-item-detail, .c-tabs-item__content").each((function(a3, r2) {
        var n2 = t2(r2).find(".post-title").text().trim(), o2 = t2(r2).find(".post-title").find("a").attr("href") || "";
        if (n2 && o2) {
          var s2 = t2(r2).find("img"), u2 = { name: n2, cover: s2.attr("data-src") || s2.attr("src") || s2.attr("data-lazy-srcset") || i.defaultCover, path: o2.replace(/https?:\/\/.*?\//, "/") };
          e2.push(u2);
        }
      })), e2;
    }, a2.prototype.popularNovels = function(a3, r2) {
      return t(this, arguments, void 0, (function(t2, a4) {
        var r3, n2, i2, o2, s2, u2, l2 = a4.filters, c2 = a4.showLatestNovels;
        return e(this, (function(e2) {
          switch (e2.label) {
            case 0:
              for (n2 in r3 = this.site + "/page/" + t2 + "/?s=&post_type=wp-manga", l2 || (l2 = this.filters || {}), c2 && (r3 += "&m_orderby=latest"), l2) if ("object" == typeof l2[n2].value) for (i2 = 0, o2 = l2[n2].value; i2 < o2.length; i2++) s2 = o2[i2], r3 += "&".concat(n2, "=").concat(s2);
              else l2[n2].value && (r3 += "&".concat(n2, "=").concat(l2[n2].value));
      ...
      return t(this, void 0, void 0, (function() {
        var t2, u2, l2, c2, p, h, d, m, f = this;
        return e(this, (function(e2) {
          switch (e2.label) {
            case 0:
              return [4, this.getCheerio(this.site + a3, false)];
            case 1:
              return (t2 = e2.sent())(".manga-title-badges, #manga-title span").remove(), (u2 = { path: a3, name: t2(".post-title h1").text().trim() || t2("#manga-title h1").text().trim() || t2(".manga-title").text().trim() || "" }).cover = t2(".summary_image > a > img").attr("data-lazy-src") || t2(".summary_image > a > img").attr("data-src") || t2(".summary_image > a > img").attr("src") || i.defaultCover, t2(".post-content_item, .post-content").each((function() {
                ...
                switch (e3) {
                  ...
                  case "Kategori":
                  case "\u0627\u0644\u062A\u0635\u0646\u064A\u0641\u0627\u062A":
                    u2.genres ? u2.genres += ", " + a4.find("a").map((function(e4, a5) {
                      return t2(a5).text();
                    })).get().join(", ") : u2.genres = a4.find("a").map((function(e4, a5) {
                      return t2(a5).text();
                    })).get().join(", ");
                    break;
                  case "Author(s)":
                  ...
                  case "Estado":
                  case "Durum":
                    u2.status = a4.text().trim().includes("OnGoing") || a4.text().trim().includes("\u0645\u0633\u062A\u0645\u0631\u0629") ? o.NovelStatus.Ongoing : o.NovelStatus.Completed;
                    break;
                  case "Artist(s)":
                    u2.artist = a4.text().trim();
                }
              })), u2.genres || (u2.genres = t2(".genres-content").text().trim()), u2.status || (u2.status = t2(".manga-status").text().trim().includes("OnGoing") ? o.NovelStatus.Ongoing : o.NovelStatus.Completed), u2.author || (u2.author = t2(".manga-author a").text().trim()), u2.rating || (u2.rating = parseFloat(t2(".post-rating span").text().trim())), u2.author || (u2.author = t2(".manga-authors").text().trim()), t2("div.summary__content .code-block,script,noscript").remove(), u2.summary = this.translateDragontea(t2("div.summary__content")).text().trim() || t2("#tab-manga-about").text().trim() || t2('.post-content_item h5:contains("Summary")').next().find("span").map((function(e3, a4) {
                return t2(a4).text();
              })).get().join("\n\n").trim() || t2(".manga-summary p").map((function(e3, a4) {
                return t2(a4).text();
              })).get().join("\n\n").trim() || t2(".manga-excerpt p").map((function(e3, a4) {
                return t2(a4).text();
              })).get().join("\n\n").trim(), l2 = [], c2 = "", (null === (m = this.options) || void 0 === m ? void 0 : m.useNewChapterEndpoint) ? [4, (0, r.fetchApi)(this.site + a3 + "ajax/chapters/", { method: "POST", referrer: this.site + a3 }).then((function(t3) {
                return t3.text();
              }))] : [3, 3];
            case 2:
              return c2 = e2.sent(), [3, 5];
            case 3:
              return p = t2(".rating-post-id").attr("value") || t2("#manga-chapters-holder").attr("data-id") || "", (h = new FormData()).append("action", "manga_get_chapters"), h.append("manga", p), [4, (0, r.fetchApi)(this.site + "wp-admin/admin-ajax.php", { method: "POST", body: h }).then((function(t3) {
                return t3.text();
              }))];
            case 4:
              c2 = e2.sent(), e2.label = 5;
            case 5:
              return "0" !== c2 && (t2 = (0, n.load)(c2)), d = t2(".wp-manga-chapter").length, t2(".wp-manga-chapter").each((function(e3, a4) {
                ...
                !o2 || "#" == o2 || n2 && f.hideLocked || l2.push({ name: r2, path: o2.replace(/https?:\/\/.*?\//, "/"), releaseTime: i2 || null, chapterNumber: d - e3 });
              })), u2.chapters = l2.reverse(), [2, u2];
          }
        }));
      }));
