...
var LNReaderPlugin = (() => {
  ...
  // .js/plugins/english/mvlempyr.js
  var e = function(e2, l2, a2, t2) {
    return new (a2 || (a2 = Promise))((function(i2, o2) {
      function r2(e3) {
        try {
          n(t2.next(e3));
        } catch (e4) {
      ...
      n((t2 = t2.apply(e2, l2 || [])).next());
    }));
  }, l = function(e2, l2) {
    var a2, t2, i2, o2 = { label: 0, sent: function() {
      if (1 & i2[0]) throw i2[1];
      return i2[1];
    }, trys: [], ops: [] }, r2 = Object.create(("function" == typeof Iterator ? Iterator : Object).prototype);
    return r2.next = s(0), r2.throw = s(1), r2.return = s(2), "function" == typeof Symbol && (r2[Symbol.iterator] = function() {
      return this;
    }), r2;
    function s(s2) {
      return function(n) {
        return (function(s3) {
          ...
          for (; r2 && (r2 = 0, s3[0] && (o2 = 0)), o2; ) try {
            if (a2 = 1, t2 && (i2 = 2 & s3[0] ? t2.return : s3[0] ? t2.throw || ((i2 = t2.return) && i2.call(t2), 0) : t2.next) && !(i2 = i2.call(t2, s3[1])).done) return i2;
            switch (t2 = 0, i2 && (s3 = [2 & s3[0], i2.value]), s3[0]) {
              case 0:
              case 1:
                i2 = s3;
                break;
        ...
        return l(this, (function(l2) {
          switch (l2.label) {
            case 0:
              return [4, this.getAllNovels()];
            case 1:
              return e2 = l2.sent(), i2 = e2.filter((function(e3) {
                return e3.name.toLowerCase().includes(a2.toLowerCase());
              })), [2, this.paginate(i2, t2)];
          }
        }));
      }));
    }, r2.prototype.paginate = function(e2, l2) {
      var a2 = 20 * (l2 - 1), t2 = a2 + 20;
      return e2.slice(a2, t2);
    }, r2.prototype.getAllNovels = function() {
      return e(this, void 0, void 0, (function() {
        var e2;
        return l(this, (function(l2) {
          switch (l2.label) {
            case 0:
              return this._allNovelsPromise ? [4, this._allNovelsPromise] : [3, 2];
            case 1:
              l2.sent(), l2.label = 2;
            case 2:
              if (this._allNovels) return [2, this._allNovels];
              this._allNovelsPromise = this.loadAll(), l2.label = 3;
            case 3:
              return l2.trys.push([3, , 5, 6]), e2 = this, [4, this._allNovelsPromise];
            case 4:
              return e2._allNovels = l2.sent(), [3, 6];
            case 5:
              return this._allNovelsPromise = void 0, [7];
            case 6:
              return [2, this._allNovels];
          }
        }));
      }));
    }, r2.prototype.loadAll = function() {
      return e(this, void 0, void 0, (function() {
        return l(this, (function(e2) {
          switch (e2.label) {
            case 0:
              return [4, (0, i.fetchApi)(this._chapSite + "wp-json/wp/v2/mvl-novels?per_page=10000").then((function(e3) {
                return e3.json();
              }))];
            case 1:
              return [2, e2.sent().map((function(e3) {
                return { name: e3.name, path: "novel/" + e3.slug, cover: "https://assets.mvlempyr.app/images/600/".concat(e3["novel-code"], ".webp"), avgReview: e3["average-review"], reviewCount: e3["total-reviews"], chapterCount: e3["total-chapters"], created: new Date(e3.createdOn).getTime(), genres: e3.genre, tags: e3.tags };
              }))];
          }
        }));
      }));
