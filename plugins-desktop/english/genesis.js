...
var LNReaderPlugin = (() => {
  ...
  var e = function(e2, t2, n2, r2) {
    ...
    var n2, r2, a2, o = { label: 0, sent: function() {
    ...
    function l(l2) {
      return function(s) {
        return (function(l3) {
          ...
          for (; i && (i = 0, l3[0] && (o = 0)), o; ) try {
            if (n2 = 1, r2 && (a2 = 2 & l3[0] ? r2.return : l3[0] ? r2.throw || ((a2 = r2.return) && a2.call(r2), 0) : r2.next) && !(a2 = a2.call(r2, l3[1])).done) return a2;
            switch (r2 = 0, a2 && (l3 = [2 & l3[0], a2.value]), l3[0]) {
              case 0:
              case 1:
                a2 = l3;
                break;
              case 4:
                return o.label++, { value: l3[1], done: false };
              case 5:
                o.label++, r2 = l3[1], l3 = [0];
                continue;
              case 7:
                l3 = o.ops.pop(), o.trys.pop();
                continue;
              default:
                if (!(a2 = o.trys, (a2 = a2.length > 0 && a2[a2.length - 1]) || 6 !== l3[0] && 2 !== l3[0])) {
                  o = 0;
                  continue;
                }
                ...
                if (6 === l3[0] && o.label < a2[1]) {
                  o.label = a2[1], a2 = l3;
                  break;
                }
                if (a2 && o.label < a2[2]) {
                  o.label = a2[2], o.ops.push(l3);
                  break;
                }
  ...
  var n = (init_fetch2(), __toCommonJS(fetch_exports)), r = (init_filterInputs(), __toCommonJS(filterInputs_exports)), a = (function() {
    function a2() {
      this.id = "genesistudio", this.name = "Genesis", this.icon = "src/en/genesis/icon.png", this.customCSS = "src/en/genesis/customCSS.css", this.site = "https://genesistudio.com", this.version = "1.1.2", this.imageRequestInit = { headers: { referrer: this.site } }, this.filters = { sort: { label: "Sort Results By", value: "Popular", options: [{ label: "Popular", value: "Popular" }, { label: "Recent", value: "Recent" }, { label: "Views", value: "Views" }], type: r.FilterTypes.Picker }, storyStatus: { label: "Status", value: "All", options: [{ label: "All", value: "All" }, { label: "Ongoing", value: "Ongoing" }, { label: "Completed", value: "Completed" }], type: r.FilterTypes.Picker }, genres: { label: "Genres", value: [], options: [{ label: "Action", value: "Action" }, { label: "Comedy", value: "Comedy" }, { label: "Drama", value: "Drama" }, { label: "Fantasy", value: "Fantasy" }, { label: "Harem", value: "Harem" }, { label: "Martial Arts", value: "Martial Arts" }, { label: "Modern", value: "Modern" }, { label: "Mystery", value: "Mystery" }, { label: "Psychological", value: "Psychological" }, { label: "Romance", value: "Romance" }, { label: "Slice of life", value: "Slice of Life" }, { label: "Tragedy", value: "Tragedy" }], type: r.FilterTypes.CheckboxGroup } };
    }
    return a2.prototype.parseNovels = function(n2) {
      return e(this, void 0, void 0, (function() {
        return t(this, (function(e2) {
          return [2, n2.map((function(e3) {
            return { name: e3.novel_title, path: "/novels/".concat(e3.abbreviation), cover: e3.cover };
          }))];
        }));
      }));
    }, a2.prototype.popularNovels = function(r2, a3) {
      return e(this, arguments, void 0, (function(e2, r3) {
        var a4, o, i = r3.showLatestNovels, l = r3.filters;
        return t(this, (function(t2) {
          switch (t2.label) {
            case 0:
              return 1 !== e2 ? [2, []] : (a4 = "".concat(this.site, "/api/novels/search?"), i ? a4 += "serialization=All&sort=Recent" : ((null == l ? void 0 : l.genres.value.length) && (a4 += "genres=" + l.genres.value.join("&genres=") + "&"), (null == l ? void 0 : l.storyStatus.value) && (a4 += "serialization=" + "".concat(l.storyStatus.value) + "&"), (null == l ? void 0 : l.sort.value) && (a4 += "sort=" + "".concat(l.sort.value))), [4, (0, n.fetchApi)(a4).then((function(e3) {
                return e3.json();
              }))]);
            case 1:
              return o = t2.sent(), [2, this.parseNovels(o)];
          }
        }));
      }));
    }, a2.prototype.extractData = function(e2) {
      ...
      return e(this, void 0, void 0, (function() {
        ...
        return t(this, (function(t2) {
          switch (t2.label) {
            case 0:
              return e2 = "".concat(this.site).concat(r2, "/__data.json?x-sveltekit-invalidated=001"), [4, (0, n.fetchApi)(e2).then((function(e3) {
                return e3.json();
              }))];
            case 1:
              return a3 = t2.sent(), o = a3.nodes, i = this.extractData(o), l = { path: r2, name: "", cover: "", summary: "", author: "", status: "Unknown", chapters: [] }, this.populateNovelMetadata(l, i), l.chapters = this.extractChapters(i), [2, l];
          }
        }));
      }));
    }, a2.prototype.populateNovelMetadata = function(e2, t2) {
      for (var n2 in t2) {
        var r2 = t2[n2];
        if ("object" == typeof r2 && null !== r2 && "novel_title" in r2) {
          e2.name = t2[r2.novel_title] || "Unknown Title", e2.cover = t2[r2.cover] || "", e2.summary = t2[r2.synopsis] || "", e2.author = t2[r2.author] || "Unknown Author", e2.genres = t2[r2.genres].map((function(e3) {
            return t2[e3];
          })).join(", ") || "Unknown Genre", e2.status = r2.release_days ? "Ongoing" : "Completed";
          break;
        }
      }
    }, a2.prototype.extractChapters = function(e2) {
      var t2 = this, n2 = "chapters", r2 = [];
      for (var a3 in e2) {
        var o = e2[a3];
        if (o && "object" == typeof o && n2 in o) {
          var i = o[n2], l = e2[i];
          if (!l || "object" != typeof l) continue;
          for (var s = [], u = 0, c = Object.keys(l); u < c.length; u++) {
            var p = c[u], h = e2[l[p]];
            Array.isArray(h) && (s = s.concat(h));
          }
          var f = s.map((function(t3) {
            return e2[t3];
          })).map((function(n3) {
            return t2.formatChapter(n3, e2);
          })).filter((function(e3) {
            return null !== e3;
          }));
          r2.push.apply(r2, f);
      ...
      return r2;
    }, a2.prototype.formatChapter = function(e2, t2) {
      var n2 = e2.id, r2 = e2.chapter_title, a3 = e2.chapter_number, o = e2.required_tier, i = e2.date_created, l = t2, s = l[n2], u = l[r2], c = l[a3], p = l[o], h = l[i];
      if (s && u && c >= 0 && null !== p && h) {
        var f = parseInt(String(c), 10) || 0;
        if (0 === (parseInt(String(p), 10) || 0)) return { name: "Chapter ".concat(f, " - ").concat(u), path: "/viewer/".concat(s), releaseTime: h, chapterNumber: f };
      }
      return null;
    }, a2.prototype.parseChapter = function(r2) {
      return e(this, void 0, void 0, (function() {
        var e2, a3, o, i, l, s, u, c, p, h, f, v;
        return t(this, (function(t2) {
          switch (t2.label) {
            case 0:
              return e2 = "".concat(this.site).concat(r2, "/__data.json?x-sveltekit-invalidated=001"), [4, (0, n.fetchApi)(e2).then((function(e3) {
            ...
            case 1:
              for (c in a3 = t2.sent(), o = a3.nodes, i = this.extractData(o), l = "content", s = "notes", u = "footnotes", i) if ((p = i[c]) && "object" == typeof p && l in p && s in p && u in p) return h = i[p[l]], f = i[p[s]], v = i[p[u]], [2, h + (f ? "<h2>Notes</h2><br>".concat(f) : "") + (null != v ? v : "")];
              return [2, ""];
          }
        }));
      }));
    }, a2.prototype.searchNovels = function(r2, a3) {
      return e(this, void 0, void 0, (function() {
        var e2, o;
        return t(this, (function(t2) {
          switch (t2.label) {
            case 0:
              return 1 !== a3 ? [2, []] : (e2 = "".concat(this.site, "/api/novels/search?serialization=All&sort=Popular&title=").concat(encodeURIComponent(r2)), [4, (0, n.fetchApi)(e2).then((function(e3) {
                return e3.json();
              }))]);
            case 1:
              return o = t2.sent(), [2, this.parseNovels(o)];
