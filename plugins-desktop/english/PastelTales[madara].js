...
var LNReaderPlugin = (() => {
  ...
  // .js/plugins/english/PastelTales[madara].js
  ...
  var n = (init_fetch2(), __toCommonJS(fetch_exports)), r = (init_browser(), __toCommonJS(browser_exports)), i = (init_defaultCover(), __toCommonJS(defaultCover_exports)), o = (init_novelStatus(), __toCommonJS(novelStatus_exports)), s = a(require_dayjs_min()), l = (init_storage2(), __toCommonJS(storage_exports)), u = function(t2, e2) {
    ...
    return a2.prototype.translateDragontea = function(t2) {
      ...
      return t(this, void 0, void 0, (function() {
        var t2, l2, u2, c2, p, h, d, m, f = this;
        return e(this, (function(e2) {
          switch (e2.label) {
            case 0:
            ...
            case 3:
              return p = t2(".rating-post-id").attr("value") || t2("#manga-chapters-holder").attr("data-id") || "", (h = new FormData()).append("action", "manga_get_chapters"), h.append("manga", p), [4, (0, n.fetchApi)(this.site + "wp-admin/admin-ajax.php", { method: "POST", body: h }).then((function(t3) {
                return t3.text();
              }))];
            case 4:
