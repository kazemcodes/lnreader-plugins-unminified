...
var LNReaderPlugin = (() => {
  ...
  var n, r = require_lib6(), o = (init_fetch2(), __toCommonJS(fetch_exports)), s = (init_novelStatus(), __toCommonJS(novelStatus_exports)), l = (function() {
    ...
    return l2.prototype.sleep = function(e2) {
      ...
      var a2, o2 = this, s2 = [], l3 = {}, i2 = [n.Idle], c = function() {
      ...
      return t(this, void 0, void 0, (function() {
        ...
        return a(this, (function(a2) {
          switch (a2.label) {
            ...
            case 2:
              return i2 = a2.sent(), c = { path: l3, chapters: [] }, u = [], h = [], p = [], v = [], d = [], f = [], g = null, m = {}, b = 0, y = [n.Idle], S = function() {
                return y[y.length - 1];
              }, N = function(e2) {
                return y.push(e2);
              }, C = function() {
                ...
                c.summary = u.join("\n\n").trim();
              } }), k.write(i2), k.end(), this.options.noAjax && f.length > 0 ? (c.chapters = f, [3, 7]) : [3, 3];
            case 3:
            ...
            case 5:
              return [4, I.text()];
            case 6:
              A = a2.sent(), H = [], G = {}, (O = new r.Parser({ onopentag: function(e2, t3) {
                var a3, r2;
              ...
              } })).write(A), O.end(), c.chapters = H, a2.label = 7;
            case 7:
              return [2, c];
          }
        }));
        ...
        return a(this, (function(a2) {
          switch (a2.label) {
            ...
            case 1:
              return [4, a2.sent().text()];
            case 2:
              return t2 = a2.sent(), i2 = [], c = false, u = "", h = [n.Idle], p = function() {
                return h[h.length - 1];
              }, v = function(e3) {
                return h.push(e3);
              }, d = function() {
                return h.length > 1 ? h.pop() : p();
              }, f = /[&<>"' ]/g, g = { "&": "&amp;", "<": "&lt;", ">": "&gt;", '"': "&quot;", "'": "&#39;", "\xA0": "&nbsp;" }, m = function(e3) {
                return e3.replace(f, (function(e4) {
                  return g[e4];
                }));
              }, b = new r.Parser({ onopentag: function(e3, t3) {
