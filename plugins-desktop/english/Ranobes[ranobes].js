...
var LNReaderPlugin = (() => {
  ...
  var t = function() {
    ...
    var r2, n2, s2, a2 = { label: 0, sent: function() {
  ...
  var n = require_lib6(), s = (init_fetch2(), __toCommonJS(fetch_exports)), a = (init_novelStatus(), __toCommonJS(novelStatus_exports)), i = new ((function() {
    ...
    return i2.prototype.safeFecth = function(t2) {
      ...
      var e2 = [], r2 = { name: "" }, s2 = this.site, a2 = false, i3 = false, o = false, c = new n.Parser({ onopentag: function(t3, n2) {
        var c2, l;
      ...
      return e(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r2) {
          switch (r2.label) {
            ...
            case 1:
              return i3 = r2.sent(), o = { path: s2, name: "", summary: "", chapters: [], totalPages: 1 }, c = false, l = false, u = false, h = false, p = false, f = false, d = false, v = false, g = false, m = false, b = false, w = [], y = [], S = {}, O = 0, _ = this.parseDate, (I = new n.Parser({ onopentag: function(t2, r3) {
              ...
              }, onopentagname: function(t2) {
                u && "br" === t2 && (o.summary += "\n"), h && "a" === t2 && (p = true), f && "a" === t2 && (d = true);
              }, onattribute: function(t2, e3) {
              ...
              } })).write(i3), I.end(), o.genres = w.join(", "), o.totalPages = Math.ceil((O || 1) / 25), o.chapters = y, o.chapters[0].path && (o.latestChapter = o.chapters[0]), [2, o];
          }
        }));
      }));
      ...
      return e(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r2) {
          switch (r2.label) {
            ...
            case 1:
              return i3 = r2.sent(), o = this.site, c = false, l = false, u = false, h = false, p = [], f = {}, d = this.parseDate, v = { pages_count: "", chapters: [] }, (g = new n.Parser({ onopentag: function(t3, e3) {
              ...
              } })).write(i3), g.end(), (null === (m = v.chapters) || void 0 === m ? void 0 : m.length) && (p = this.parseChapters(v)), [2, { chapters: p }];
          }
        }));
      }));
