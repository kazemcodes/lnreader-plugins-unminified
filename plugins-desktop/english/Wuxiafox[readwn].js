...
var LNReaderPlugin = (() => {
      ...
      !(function(t, e2) {
        ...
        var _ = (function() {
          ...
          return m2.parse = function(t2) {
            ...
            var n2 = this, r2 = !!b2.u(e3) || e3, f2 = b2.p(t2), l3 = function(t3, e4) {
            ...
            var r2 = t2 || "YYYY-MM-DDTHH:mm:ssZ", i3 = b2.z(this), s2 = this.$H, u3 = this.$m, a3 = this.$M, o3 = n2.weekdays, c2 = n2.months, f2 = n2.meridiem, h2 = function(t3, n3, i4, s3) {
              return t3 && (t3[n3] || t3(e3, r2)) || i4[n3].slice(0, s3);
            }, d2 = function(t3) {
              return b2.s(s2 % 12 || 12, t3, "0");
            }, $3 = f2 || function(t3, e4, n3) {
              var r3 = t3 < 12 ? "AM" : "PM";
  ...
  // .js/plugins/english/Wuxiafox[readwn].js
  ...
  var u = (init_fetch2(), __toCommonJS(fetch_exports)), v = (init_novelStatus(), __toCommonJS(novelStatus_exports)), b = (init_browser(), __toCommonJS(browser_exports)), i = a(require_dayjs_min()), o = new ((function() {
    ...
    return a2.prototype.popularNovels = function(a3, v2) {
      return l(this, arguments, void 0, (function(l2, a4) {
        var v3, i2, o2, n, r, t, s, h = this, c = a4.filters, d = a4.showLatestNovels;
        return e(this, (function(e2) {
          switch (e2.label) {
            case 0:
              return v3 = this.site + "/list/", v3 += ((null === (n = null == c ? void 0 : c.genres) || void 0 === n ? void 0 : n.value) || "all") + "/", v3 += ((null === (r = null == c ? void 0 : c.status) || void 0 === r ? void 0 : r.value) || "all") + "-", v3 += d ? "lastdotime" : (null === (t = null == c ? void 0 : c.sort) || void 0 === t ? void 0 : t.value) || "newstime", v3 += "-" + (l2 - 1) + ".html", (null === (s = null == c ? void 0 : c.tags) || void 0 === s ? void 0 : s.value) && (v3 = this.site + "/tags/" + c.tags.value + "-0.html"), [4, (0, u.fetchApi)(v3).then((function(l3) {
                return l3.text();
              }))];
            case 1:
              return i2 = e2.sent(), o2 = (0, b.load)(i2), [2, o2("li.novel-item").map((function(l3, e3) {
                return { name: o2(e3).find("h4").text() || "", cover: h.site + o2(e3).find(".novel-cover > img").attr("data-src"), path: o2(e3).find("a").attr("href") || "" };
            ...
            case 1:
              if (l2 = e2.sent(), o2 = (0, b.load)(l2), (n = { path: a3, name: o2("h1.novel-title").text() || "" }).author = o2("span[itemprop=author]").text(), n.cover = this.site + o2("figure.cover > img").attr("data-src"), n.summary = o2(".summary").text().replace("Summary", "").trim(), n.genres = o2("div.categories > ul > li").map((function(l3, e3) {
                ...
                if (null === (u2 = null == r2 ? void 0 : r2.includes) || void 0 === u2 ? void 0 : u2.call(r2, "ago")) {
                  ...
                  if (s2) {
                    var h2 = (0, i.default)();
                    (r2.includes("hours ago") || r2.includes("hour ago")) && h2.subtract(s2, "hours"), (r2.includes("days ago") || r2.includes("day ago")) && h2.subtract(s2, "days"), (r2.includes("months ago") || r2.includes("month ago")) && h2.subtract(s2, "months"), r2 = h2.format("LL");
                  }
                }
                return { name: b2, path: n2, releaseTime: r2, chapterNumber: l3 + 1 };
              })).get().filter((function(l3) {
                return l3;
              })), r > t.length) for (s = parseInt((null === (c = t[t.length - 1].path.match(/_(\d+)\.html/)) || void 0 === c ? void 0 : c[1]) || "", 10), h = (s || t.length) + 1; h <= r; h++) t.push({ name: "Chapter " + h, path: a3.replace(".html", "_" + h + ".html"), releaseTime: null, chapterNumber: h });
