...
var LNReaderPlugin = (() => {
  ...
  var e = function(e2, a2, t2, l2) {
    ...
    var t2, l2, i2, n2 = { label: 0, sent: function() {
  ...
  var t = (init_browser(), __toCommonJS(browser_exports)), l = require_lib9(), i = (init_fetch2(), __toCommonJS(fetch_exports)), n = (init_novelStatus(), __toCommonJS(novelStatus_exports)), o = (init_defaultCover(), __toCommonJS(defaultCover_exports)), r = (init_storage2(), __toCommonJS(storage_exports));
  function s(e2, a2) {
    var t2 = e2.match(/(\d+)$/);
  ...
  var u = new ((function() {
    ...
    return u2.prototype.getHostname = function(e2) {
      ...
      return (e2.match(/<article([^]*?)<\/article>/g) || []).forEach((function(e3) {
        ...
        if (n2 && i2) {
          var r2 = e3.match(/<img [^>]*?src="([^\"]*)"[^>]*?(?: data-src="([^\"]*)")?[^>]*>/) || [], s2 = void 0;
          if (i2.includes(a2.site)) s2 = i2.replace(a2.site, "");
          else {
            var u3 = i2.split("/");
            u3.shift(), u3.shift(), u3.shift(), s2 = u3.join("/");
          }
          l2.push({ name: n2, cover: r2[2] || r2[1] || o.defaultCover, path: s2 });
        }
      })), l2;
    }, u2.prototype.popularNovels = function(t2, l2) {
      return e(this, arguments, void 0, (function(e2, t3) {
        var l3, i2, n2, o2, r2, s2, u3, c, v, h = t3.filters, p = t3.showLatestNovels;
        return a(this, (function(a2) {
          switch (a2.label) {
            case 0:
              for (n2 in l3 = null !== (v = null === (c = this.options) || void 0 === c ? void 0 : c.seriesPath) && void 0 !== v ? v : "/series/", i2 = this.site + l3 + "?page=" + e2, h || (h = this.filters || {}), p && (i2 += "&order=latest"), h) if ("object" == typeof h[n2].value) for (o2 = 0, r2 = h[n2].value; o2 < r2.length; o2++) s2 = r2[o2], i2 += "&".concat(n2, "=").concat(s2);
            ...
            case 1:
              return i2 = a2.sent(), r2 = { path: t2, name: "", genres: "", summary: "", author: "", artist: "", status: "", chapters: [] }, u3 = false, c = false, v = 0, h = false, p = false, f = false, b = false, d = false, m = false, g = false, y = 0, w = false, k = false, q = [], N = {}, x = this.hideLocked, S = new l.Parser({ onopentag: function(a3, t3) {
                ...
                if (u3) c && (r2.genres += e3 + ", ");
                  ...
                  if (1 === y) e3.includes("\u{1F512}") ? (w = true, k = true) : k && (w = false), s(e3, N);
                  else if (2 === y) N.name = (null === (t3 = null === (a3 = e3.match(RegExp("^".concat(r2.name.replace(/[.*+?^${}()|[\]\\]/g, "\\$&"), "\\s*(.+)")))) || void 0 === a3 ? void 0 : a3[1]) || void 0 === t3 ? void 0 : t3.trim()) || e3.trim(), N.chapterNumber || s(e3, N);
              ...
              } }), S.write(i2), S.end(), q.length && ((null === (C = this.options) || void 0 === C ? void 0 : C.reverseChapters) && q.reverse(), r2.chapters = q), r2.summary = r2.summary.trim(), [2, r2];
          }
        }));
      }));
