...
var LNReaderPlugin = (() => {
  ...
  var a = (init_browser(), __toCommonJS(browser_exports)), l = require_lib9(), s = (init_fetch2(), __toCommonJS(fetch_exports)), r = (init_novelStatus(), __toCommonJS(novelStatus_exports)), i = (init_defaultCover(), __toCommonJS(defaultCover_exports)), n = (init_storage2(), __toCommonJS(storage_exports));
  function o(e2, t2) {
    var a2 = e2.match(/(\d+)$/);
    ...
    return u2.prototype.getHostname = function(e2) {
      ...
      return (e2.match(/<article([^]*?)<\/article>/g) || []).forEach((function(e3) {
        ...
        if (r2 && s2) {
          ...
          l2.push({ name: r2, cover: n2[2] || n2[1] || i.defaultCover, path: o2 });
        }
      })), l2;
    }, u2.prototype.popularNovels = function(a2, l2) {
      return e(this, arguments, void 0, (function(e2, a3) {
        var l3, s2, r2, i2, n2, o2, u3, c, v, h = a3.filters, p = a3.showLatestNovels;
        return t(this, (function(t2) {
          switch (t2.label) {
            case 0:
              for (r2 in l3 = null !== (v = null === (c = this.options) || void 0 === c ? void 0 : c.seriesPath) && void 0 !== v ? v : "/series/", s2 = this.site + l3 + "?page=" + e2, h || (h = this.filters || {}), p && (s2 += "&order=latest"), h) if ("object" == typeof h[r2].value) for (i2 = 0, n2 = h[r2].value; i2 < n2.length; i2++) o2 = n2[i2], s2 += "&".concat(r2, "=").concat(o2);
      ...
      return e(this, void 0, void 0, (function() {
        var e2, s2, n2, u3, c, v, h, p, d, f, b, m, g, y, w, k, N, C, S, L, x;
        return t(this, (function(t2) {
          switch (t2.label) {
            case 0:
              return e2 = this.site, [4, this.safeFecth(e2 + a2, false)];
            case 1:
              return s2 = t2.sent(), n2 = { path: a2, name: "", genres: "", summary: "", author: "", artist: "", status: "", chapters: [] }, u3 = false, c = false, v = 0, h = false, p = false, d = false, f = false, b = false, m = false, g = false, y = 0, w = false, k = false, N = [], C = {}, S = this.hideLocked, L = new l.Parser({ onopentag: function(t3, a3) {
                var l2;
                !n2.cover && (null === (l2 = a3.class) || void 0 === l2 ? void 0 : l2.includes("ts-post-image")) ? (n2.name = a3.title, n2.cover = a3["data-src"] || a3.src || i.defaultCover) : "genxed" === a3.class || "sertogenre" === a3.class ? u3 = true : u3 && "a" === t3 ? c = true : "div" !== t3 || "entry-content" !== a3.class && "description" !== a3.itemprop ? "spe" === a3.class || "serl" === a3.class ? h = true : h && "span" === t3 ? p = true : "div" === t3 && "sertostat" === a3.class ? (h = true, p = true, b = true) : a3.class && a3.class.includes("eplister") ? m = true : m && "li" === t3 ? g = true : g ? "a" === t3 && void 0 === C.path ? C.path = a3.href.replace(e2, "").trim() : "epl-num" === a3.class ? y = 1 : "epl-title" === a3.class ? y = 2 : "epl-date" === a3.class ? y = 3 : "epl-price" === a3.class && (y = 4) : !v || "div" !== t3 && "script" !== t3 || v++ : v++;
              }, ontext: function(e3) {
                var t3, a3;
