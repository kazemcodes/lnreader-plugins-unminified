...
var LNReaderPlugin = (() => {
  ...
  // .js/plugins/english/KnoxT[lightnovelwp].js
  var e = function(e2, a2, l2, t2) {
    ...
    var l2, t2, i2, o2 = { label: 0, sent: function() {
  ...
  var l = (init_browser(), __toCommonJS(browser_exports)), t = require_lib9(), i = (init_fetch2(), __toCommonJS(fetch_exports)), o = (init_novelStatus(), __toCommonJS(novelStatus_exports)), r = (init_defaultCover(), __toCommonJS(defaultCover_exports)), s = (init_storage2(), __toCommonJS(storage_exports));
  function n(e2, a2) {
    var l2 = e2.match(/(\d+)$/);
  ...
  var u = new ((function() {
    function u2(e2) {
      ...
      this.version = "1.1.".concat(9 + i2), this.options = null !== (l2 = e2.options) && void 0 !== l2 ? l2 : {}, this.filters = e2.filters, (null === (t2 = this.options) || void 0 === t2 ? void 0 : t2.hasLocked) && (this.pluginSettings = { hideLocked: { value: "", label: "Hide locked chapters", type: "Switch" } });
    }
    return u2.prototype.getHostname = function(e2) {
        ...
        return a(this, (function(a2) {
          switch (a2.label) {
            ...
            case 1:
              ...
              return [4, s2.text()];
            case 2:
              if (n2 = a2.sent(), u3 = null === (c = null === (v = n2.match(/<title>(.*?)<\/title>/)) || void 0 === v ? void 0 : v[1]) || void 0 === c ? void 0 : c.trim(), this.getHostname(l2) != this.getHostname(s2.url) || u3 && ("Bot Verification" == u3 || "You are being redirected..." == u3 || "Un instant..." == u3 || "Just a moment..." == u3 || "Redirecting..." == u3)) throw new Error("Captcha error, please open in webview (or the website has changed url)");
              return [2, n2];
          }
        }));
      }));
      ...
      return (e2.match(/<article([^]*?)<\/article>/g) || []).forEach((function(e3) {
        ...
        if (o2 && i2) {
          var s2 = e3.match(/<img [^>]*?src="([^\"]*)"[^>]*?(?: data-src="([^\"]*)")?[^>]*>/) || [], n2 = void 0;
          if (i2.includes(a2.site)) n2 = i2.replace(a2.site, "");
          else {
            var u3 = i2.split("/");
            u3.shift(), u3.shift(), u3.shift(), n2 = u3.join("/");
          }
          t2.push({ name: o2, cover: s2[2] || s2[1] || r.defaultCover, path: n2 });
        }
      })), t2;
    }, u2.prototype.popularNovels = function(l2, t2) {
      return e(this, arguments, void 0, (function(e2, l3) {
        var t3, i2, o2, r2, s2, n2, u3, v, c, b = l3.filters, d = l3.showLatestNovels;
        return a(this, (function(a2) {
          switch (a2.label) {
            case 0:
              for (o2 in t3 = null !== (c = null === (v = this.options) || void 0 === v ? void 0 : v.seriesPath) && void 0 !== c ? c : "/series/", i2 = this.site + t3 + "?page=" + e2, b || (b = this.filters || {}), d && (i2 += "&order=latest"), b) if ("object" == typeof b[o2].value) for (r2 = 0, s2 = b[o2].value; r2 < s2.length; r2++) n2 = s2[r2], i2 += "&".concat(o2, "=").concat(n2);
      ...
      return e(this, void 0, void 0, (function() {
        var e2, i2, s2, u3, v, c, b, d, h, p, m, g, f, y, w, C, k, S, L, P, N;
        return a(this, (function(a2) {
          switch (a2.label) {
            case 0:
              return e2 = this.site, [4, this.safeFecth(e2 + l2, false)];
            case 1:
              return i2 = a2.sent(), s2 = { path: l2, name: "", genres: "", summary: "", author: "", artist: "", status: "", chapters: [] }, u3 = false, v = false, c = 0, b = false, d = false, h = false, p = false, m = false, g = false, f = false, y = 0, w = false, C = false, k = [], S = {}, L = this.hideLocked, P = new t.Parser({ onopentag: function(a3, l3) {
                var t2;
                !s2.cover && (null === (t2 = l3.class) || void 0 === t2 ? void 0 : t2.includes("ts-post-image")) ? (s2.name = l3.title, s2.cover = l3["data-src"] || l3.src || r.defaultCover) : "genxed" === l3.class || "sertogenre" === l3.class ? u3 = true : u3 && "a" === a3 ? v = true : "div" !== a3 || "entry-content" !== l3.class && "description" !== l3.itemprop ? "spe" === l3.class || "serl" === l3.class ? b = true : b && "span" === a3 ? d = true : "div" === a3 && "sertostat" === l3.class ? (b = true, d = true, m = true) : l3.class && l3.class.includes("eplister") ? g = true : g && "li" === a3 ? f = true : f ? "a" === a3 && void 0 === S.path ? S.path = l3.href.replace(e2, "").trim() : "epl-num" === l3.class ? y = 1 : "epl-title" === l3.class ? y = 2 : "epl-date" === l3.class ? y = 3 : "epl-price" === l3.class && (y = 4) : !c || "div" !== a3 && "script" !== a3 || c++ : c++;
              }, ontext: function(e3) {
                var a3, l3;
                if (u3) v && (s2.genres += e3 + ", ");
                  ...
                  if (1 === y) e3.includes("\u{1F512}") ? (w = true, C = true) : C && (w = false), n(e3, S);
                  else if (2 === y) S.name = (null === (l3 = null === (a3 = e3.match(RegExp("^".concat(s2.name.replace(/[.*+?^${}()|[\]\\]/g, "\\$&"), "\\s*(.+)")))) || void 0 === a3 ? void 0 : a3[1]) || void 0 === l3 ? void 0 : l3.trim()) || e3.trim(), S.chapterNumber || n(e3, S);
                ...
                var a3, l3, t2;
                u3 ? v ? v = false : (u3 = false, s2.genres = null === (a3 = s2.genres) || void 0 === a3 ? void 0 : a3.slice(0, -2)) : c ? "p" === e3 ? s2.summary += "\n\n" : "br" === e3 ? s2.summary += "\n" : "div" !== e3 && "script" !== e3 || c-- : b ? d ? "span" === e3 && (d = false, h && s2.author ? h = false : p && s2.artist ? p = false : m && "" !== s2.status && (m = false)) : "div" === e3 && (b = false, s2.author = null === (l3 = s2.author) || void 0 === l3 ? void 0 : l3.trim(), s2.artist = null === (t2 = s2.artist) || void 0 === t2 ? void 0 : t2.trim()) : g && (f ? 1 === y || 2 === y || 3 === y || 4 === y ? y = 0 : "li" === e3 && (f = false, S.chapterNumber || (S.chapterNumber = 0), w && (S.name = "\u{1F512} " + S.name), L && w || k.push(S), S = {}) : "ul" === e3 && (g = false));
              } }), P.write(i2), P.end(), k.length && ((null === (N = this.options) || void 0 === N ? void 0 : N.reverseChapters) && k.reverse(), s2.chapters = k), s2.summary = s2.summary.trim(), [2, s2];
          }
        }));
      }));
