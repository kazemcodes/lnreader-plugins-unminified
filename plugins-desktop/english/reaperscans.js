...
var LNReaderPlugin = (() => {
  ...
  // .js/plugins/english/reaperscans.js
  ...
  var n = (init_fetch2(), __toCommonJS(fetch_exports)), r = "https://api.reaperscans.com", a = "https://media.reaperscans.com/file/4SRBHm/", i = (function() {
    function i2() {
      this.id = "reaperscans.com", this.name = "Reaper Scans", this.version = "1.0.0", this.icon = "src/en/reaperscans/icon.png", this.site = "https://reaperscans.com";
    }
    return i2.prototype.popularNovels = function(n2) {
      return t(this, void 0, void 0, (function() {
        return e(this, (function(t2) {
          return [2, this.query(n2)];
        }));
      }));
    }, i2.prototype.parseNovel = function(a2) {
      return t(this, void 0, void 0, (function() {
        var t2, i3;
        return e(this, (function(e2) {
          switch (e2.label) {
            case 0:
              return [4, (0, n.fetchApi)("".concat(r, "/series/").concat(a2))];
            case 1:
              return [4, e2.sent().json()];
            case 2:
              return t2 = e2.sent(), [4, (0, n.fetchApi)("".concat(r, "/chapters/").concat(a2, "?perPage=").concat(Number.MAX_SAFE_INTEGER))];
            case 3:
              return [4, e2.sent().json()];
            case 4:
              return i3 = e2.sent().data, [2, { name: t2.title, cover: this.getCoverUrl(t2.thumbnail), author: t2.author, artist: t2.studio, status: t2.status, rating: t2.rating, summary: t2.description, genres: t2.tags.join(","), path: a2, chapters: i3.reverse().map((function(t3) {
                return { path: "".concat(a2, "/").concat(t3.chapter_slug), name: t3.chapter_name, chapterNumber: Number.parseFloat(t3.index), releaseTime: t3.created_at.substring(0, 10) };
              })) }];
          }
        }));
      }));
      ...
      return t(this, void 0, void 0, (function() {
        ...
        return e(this, (function(e2) {
          switch (e2.label) {
            case 0:
              return [4, (0, n.fetchApi)("".concat(this.site, "/series/").concat(r2), { headers: { RSC: "1" } })];
            case 1:
              return [4, e2.sent().text()];
            case 2:
              return t2 = e2.sent(), [2, this.extractChapterContent(t2)];
          }
        }));
      }));
    }, i2.prototype.extractChapterContent = function(t2) {
      var e2 = t2.split("\n"), n2 = e2.findIndex((function(t3) {
        return t3.includes("<p");
      })), r2 = e2[n2].substring(0, e2[n2].indexOf("<")), a2 = r2.substring(r2.indexOf(":"), r2.indexOf(",")), i3 = e2.lastIndexOf(a2), s = e2.slice(n2, i3).join("\n").split(a2)[1];
      return s.substring(s.indexOf("<"), s.lastIndexOf(">") + 1);
    }, i2.prototype.searchNovels = function(n2) {
      return t(this, void 0, void 0, (function() {
        return e(this, (function(t2) {
          return [2, this.query(1, n2)];
        }));
      }));
    }, i2.prototype.query = function() {
      return t(this, arguments, void 0, (function(t2, i3) {
        var s;
        return void 0 === t2 && (t2 = 1), void 0 === i3 && (i3 = ""), e(this, (function(e2) {
          switch (e2.label) {
            case 0:
              return s = "".concat(r, "/query?page=").concat(t2, "&perPage=20&series_type=Novel&query_string=").concat(i3, "&order=desc&orderBy=created_at&adult=true&status=All&tags_ids=[]"), [4, (0, n.fetchApi)(s)];
            case 1:
              return [4, e2.sent().json()];
            case 2:
              return [2, e2.sent().data.map((function(t3) {
                return { name: t3.title, cover: t3.thumbnail.startsWith("novels/") ? a + t3.thumbnail : t3.thumbnail, path: t3.series_slug };
              }))];
          }
        }));
      }));
    }, i2.prototype.getCoverUrl = function(t2) {
      return t2.startsWith("novels/") ? a + t2 : t2;
    }, i2;
  })();
