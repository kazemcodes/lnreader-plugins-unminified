...
var LNReaderPlugin = (() => {
  ...
  // .js/plugins/english/SrankManga[madara].js
          ...
          switch (t2.label) {
            ...
            case 5:
              return "0" !== c2 && (e2 = (0, r.load)(c2)), d = e2(".wp-manga-chapter").length, e2(".wp-manga-chapter").each((function(t3, a4) {
                ...
                !l2 || "#" == l2 || r2 && v.hideLocked || u2.push({ name: n2, path: l2.replace(/https?:\/\/.*?\//, "/"), releaseTime: i2 || null, chapterNumber: d - t3 });
