...
var LNReaderPlugin = (() => {
  ...
  // .js/plugins/english/HiraethTranslation[madara].js
          ...
          switch (t2.label) {
            ...
            case 5:
              return "0" !== c2 && (e2 = (0, n.load)(c2)), v = e2(".wp-manga-chapter").length, e2(".wp-manga-chapter").each((function(t3, a4) {
                ...
                !o2 || "#" == o2 || n2 && m.hideLocked || u2.push({ name: r2, path: o2.replace(/https?:\/\/.*?\//, "/"), releaseTime: i2 || null, chapterNumber: v - t3 });
