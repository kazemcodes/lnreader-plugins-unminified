...
var LNReaderPlugin = (() => {
  ...
  // .js/plugins/english/LazyGirlTranslations[lightnovelwp].js
  var e = function(e2, t2, a2, s2) {
    ...
    var a2, s2, l2, r2 = { label: 0, sent: function() {
      ...
      return function(n2) {
        return (function(o4) {
          ...
          for (; i2 && (i2 = 0, o4[0] && (r2 = 0)), r2; ) try {
            if (a2 = 1, s2 && (l2 = 2 & o4[0] ? s2.return : o4[0] ? s2.throw || ((l2 = s2.return) && l2.call(s2), 0) : s2.next) && !(l2 = l2.call(s2, o4[1])).done) return l2;
            switch (s2 = 0, l2 && (o4 = [2 & o4[0], l2.value]), o4[0]) {
              case 0:
              case 1:
                l2 = o4;
                break;
  ...
  var a = (init_browser(), __toCommonJS(browser_exports)), s = require_lib9(), l = (init_fetch2(), __toCommonJS(fetch_exports)), r = (init_novelStatus(), __toCommonJS(novelStatus_exports)), i = (init_defaultCover(), __toCommonJS(defaultCover_exports)), o = (init_storage2(), __toCommonJS(storage_exports));
  function n(e2, t2) {
    var a2 = e2.match(/(\d+)$/);
  ...
  var u = new ((function() {
    function u2(e2) {
      ...
      var l2 = (null === (t2 = e2.options) || void 0 === t2 ? void 0 : t2.versionIncrements) || 0;
      this.version = "1.1.".concat(9 + l2), this.options = null !== (a2 = e2.options) && void 0 !== a2 ? a2 : {}, this.filters = e2.filters, (null === (s2 = this.options) || void 0 === s2 ? void 0 : s2.hasLocked) && (this.pluginSettings = { hideLocked: { value: "", label: "Hide locked chapters", type: "Switch" } });
    }
    return u2.prototype.getHostname = function(e2) {
      ...
      return e(this, void 0, void 0, (function() {
        var e2, r2, i2, o2, n2, u3, c, v;
        return t(this, (function(t2) {
          switch (t2.label) {
            case 0:
              return e2 = a2.split("://"), r2 = e2.shift(), i2 = e2[0].replace(/\/\//g, "/"), [4, (0, l.fetchApi)(r2 + "://" + i2)];
            case 1:
      ...
      return (e2.match(/<article([^]*?)<\/article>/g) || []).forEach((function(e3) {
        var a2 = e3.match(/<a href="([^\"]*)".*? title="([^\"]*)"/) || [], l2 = a2[1], r2 = a2[2];
        if (r2 && l2) {
          var o2 = e3.match(/<img [^>]*?src="([^\"]*)"[^>]*?(?: data-src="([^\"]*)")?[^>]*>/) || [], n2 = void 0;
          if (l2.includes(t2.site)) n2 = l2.replace(t2.site, "");
          else {
            var u3 = l2.split("/");
            u3.shift(), u3.shift(), u3.shift(), n2 = u3.join("/");
          }
          s2.push({ name: r2, cover: o2[2] || o2[1] || i.defaultCover, path: n2 });
        }
      })), s2;
    }, u2.prototype.popularNovels = function(a2, s2) {
      return e(this, arguments, void 0, (function(e2, a3) {
        var s3, l2, r2, i2, o2, n2, u3, c, v, h = a3.filters, p = a3.showLatestNovels;
        return t(this, (function(t2) {
          switch (t2.label) {
            case 0:
              for (r2 in s3 = null !== (v = null === (c = this.options) || void 0 === c ? void 0 : c.seriesPath) && void 0 !== v ? v : "/series/", l2 = this.site + s3 + "?page=" + e2, h || (h = this.filters || {}), p && (l2 += "&order=latest"), h) if ("object" == typeof h[r2].value) for (i2 = 0, o2 = h[r2].value; i2 < o2.length; i2++) n2 = o2[i2], l2 += "&".concat(r2, "=").concat(n2);
              else h[r2].value && (l2 += "&".concat(r2, "=").concat(h[r2].value));
              return [4, this.safeFecth(l2, false)];
            case 1:
      ...
      return e(this, void 0, void 0, (function() {
        var e2, l2, o2, u3, c, v, h, p, d, f, b, m, g, y, w, k, S, x, N, C, L;
        return t(this, (function(t2) {
          switch (t2.label) {
            case 0:
              return e2 = this.site, [4, this.safeFecth(e2 + a2, false)];
            case 1:
              return l2 = t2.sent(), o2 = { path: a2, name: "", genres: "", summary: "", author: "", artist: "", status: "", chapters: [] }, u3 = false, c = false, v = 0, h = false, p = false, d = false, f = false, b = false, m = false, g = false, y = 0, w = false, k = false, S = [], x = {}, N = this.hideLocked, C = new s.Parser({ onopentag: function(t3, a3) {
                var s2;
                !o2.cover && (null === (s2 = a3.class) || void 0 === s2 ? void 0 : s2.includes("ts-post-image")) ? (o2.name = a3.title, o2.cover = a3["data-src"] || a3.src || i.defaultCover) : "genxed" === a3.class || "sertogenre" === a3.class ? u3 = true : u3 && "a" === t3 ? c = true : "div" !== t3 || "entry-content" !== a3.class && "description" !== a3.itemprop ? "spe" === a3.class || "serl" === a3.class ? h = true : h && "span" === t3 ? p = true : "div" === t3 && "sertostat" === a3.class ? (h = true, p = true, b = true) : a3.class && a3.class.includes("eplister") ? m = true : m && "li" === t3 ? g = true : g ? "a" === t3 && void 0 === x.path ? x.path = a3.href.replace(e2, "").trim() : "epl-num" === a3.class ? y = 1 : "epl-title" === a3.class ? y = 2 : "epl-date" === a3.class ? y = 3 : "epl-price" === a3.class && (y = 4) : !v || "div" !== t3 && "script" !== t3 || v++ : v++;
              }, ontext: function(e3) {
                var t3, a3;
                if (u3) c && (o2.genres += e3 + ", ");
                  ...
                  else if (2 === y) x.name = (null === (a3 = null === (t3 = e3.match(RegExp("^".concat(o2.name.replace(/[.*+?^${}()|[\]\\]/g, "\\$&"), "\\s*(.+)")))) || void 0 === t3 ? void 0 : t3[1]) || void 0 === a3 ? void 0 : a3.trim()) || e3.trim(), x.chapterNumber || n(e3, x);
                ...
                var t3, a3, s2;
                u3 ? c ? c = false : (u3 = false, o2.genres = null === (t3 = o2.genres) || void 0 === t3 ? void 0 : t3.slice(0, -2)) : v ? "p" === e3 ? o2.summary += "\n\n" : "br" === e3 ? o2.summary += "\n" : "div" !== e3 && "script" !== e3 || v-- : h ? p ? "span" === e3 && (p = false, d && o2.author ? d = false : f && o2.artist ? f = false : b && "" !== o2.status && (b = false)) : "div" === e3 && (h = false, o2.author = null === (a3 = o2.author) || void 0 === a3 ? void 0 : a3.trim(), o2.artist = null === (s2 = o2.artist) || void 0 === s2 ? void 0 : s2.trim()) : m && (g ? 1 === y || 2 === y || 3 === y || 4 === y ? y = 0 : "li" === e3 && (g = false, x.chapterNumber || (x.chapterNumber = 0), w && (x.name = "\u{1F512} " + x.name), N && w || S.push(x), x = {}) : "ul" === e3 && (m = false));
              } }), C.write(l2), C.end(), S.length && ((null === (L = this.options) || void 0 === L ? void 0 : L.reverseChapters) && S.reverse(), o2.chapters = S), o2.summary = o2.summary.trim(), [2, o2];
          }
        }));
      }));
