...
var LNReaderPlugin = (() => {
  ...
  // .js/plugins/english/Ippotranslations[lightnovelwp].js
  ...
  var u = new ((function() {
    ...
    return u2.prototype.getHostname = function(e2) {
      ...
      return e(this, void 0, void 0, (function() {
        var e2, r2, o2, u3, c, v, h, p, d, b, f, m, g, y, w, k, x, N, C, S, L;
        return a(this, (function(a2) {
          switch (a2.label) {
            case 0:
              return e2 = this.site, [4, this.safeFecth(e2 + t2, false)];
            case 1:
              return r2 = a2.sent(), o2 = { path: t2, name: "", genres: "", summary: "", author: "", artist: "", status: "", chapters: [] }, u3 = false, c = false, v = 0, h = false, p = false, d = false, b = false, f = false, m = false, g = false, y = 0, w = false, k = false, x = [], N = {}, C = this.hideLocked, S = new l.Parser({ onopentag: function(a3, t3) {
                var l2;
              ...
              } }), S.write(r2), S.end(), x.length && ((null === (L = this.options) || void 0 === L ? void 0 : L.reverseChapters) && x.reverse(), o2.chapters = x), o2.summary = o2.summary.trim(), [2, o2];
          }
        }));
      }));
