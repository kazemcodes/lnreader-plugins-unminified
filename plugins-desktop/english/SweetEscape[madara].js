...
var LNReaderPlugin = (() => {
  ...
  // .js/plugins/english/SweetEscape[madara].js
          ...
          switch (t2.label) {
            ...
            case 5:
              return "0" !== c2 && (e2 = (0, r.load)(c2)), d = e2(".wp-manga-chapter").length, e2(".wp-manga-chapter").each((function(t3, a4) {
                ...
                !o2 || "#" == o2 || r2 && f.hideLocked || u2.push({ name: n2, path: o2.replace(/https?:\/\/.*?\//, "/"), releaseTime: i2 || null, chapterNumber: d - t3 });
