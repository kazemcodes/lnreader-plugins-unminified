...
var LNReaderPlugin = (() => {
  ...
  // .js/plugins/english/VandyTranslate[lightnovelwp].js
  var e = function(e2, t2, a2, l2) {
    ...
    var a2, l2, s2, r2 = { label: 0, sent: function() {
      ...
      return function(n2) {
        return (function(o4) {
          ...
          for (; i2 && (i2 = 0, o4[0] && (r2 = 0)), r2; ) try {
            if (a2 = 1, l2 && (s2 = 2 & o4[0] ? l2.return : o4[0] ? l2.throw || ((s2 = l2.return) && s2.call(l2), 0) : l2.next) && !(s2 = s2.call(l2, o4[1])).done) return s2;
  ...
  var a = (init_browser(), __toCommonJS(browser_exports)), l = require_lib9(), s = (init_fetch2(), __toCommonJS(fetch_exports)), r = (init_novelStatus(), __toCommonJS(novelStatus_exports)), i = (init_defaultCover(), __toCommonJS(defaultCover_exports)), o = (init_storage2(), __toCommonJS(storage_exports));
  function n(e2, t2) {
    var a2 = e2.match(/(\d+)$/);
  ...
  var c = new ((function() {
    ...
    return c2.prototype.getHostname = function(e2) {
    ...
    }, c2.prototype.safeFecth = function(a2, l2) {
      ...
      return (e2.match(/<article([^]*?)<\/article>/g) || []).forEach((function(e3) {
        ...
        if (r2 && s2) {
          ...
          if (s2.includes(t2.site)) n2 = s2.replace(t2.site, "");
          else {
            var c3 = s2.split("/");
            c3.shift(), c3.shift(), c3.shift(), n2 = c3.join("/");
          }
          l2.push({ name: r2, cover: o2[2] || o2[1] || i.defaultCover, path: n2 });
        }
      })), l2;
    }, c2.prototype.popularNovels = function(a2, l2) {
      return e(this, arguments, void 0, (function(e2, a3) {
        var l3, s2, r2, i2, o2, n2, c3, u, v, h = a3.filters, p = a3.showLatestNovels;
        return t(this, (function(t2) {
          switch (t2.label) {
            case 0:
              for (r2 in l3 = null !== (v = null === (u = this.options) || void 0 === u ? void 0 : u.seriesPath) && void 0 !== v ? v : "/series/", s2 = this.site + l3 + "?page=" + e2, h || (h = this.filters || {}), p && (s2 += "&order=latest"), h) if ("object" == typeof h[r2].value) for (i2 = 0, o2 = h[r2].value; i2 < o2.length; i2++) n2 = o2[i2], s2 += "&".concat(r2, "=").concat(n2);
      ...
      return e(this, void 0, void 0, (function() {
        var e2, s2, o2, c3, u, v, h, p, d, f, b, m, y, g, w, k, S, N, C, x, L;
        return t(this, (function(t2) {
          switch (t2.label) {
            case 0:
              return e2 = this.site, [4, this.safeFecth(e2 + a2, false)];
            case 1:
              return s2 = t2.sent(), o2 = { path: a2, name: "", genres: "", summary: "", author: "", artist: "", status: "", chapters: [] }, c3 = false, u = false, v = 0, h = false, p = false, d = false, f = false, b = false, m = false, y = false, g = 0, w = false, k = false, S = [], N = {}, C = this.hideLocked, x = new l.Parser({ onopentag: function(t3, a3) {
                var l2;
                !o2.cover && (null === (l2 = a3.class) || void 0 === l2 ? void 0 : l2.includes("ts-post-image")) ? (o2.name = a3.title, o2.cover = a3["data-src"] || a3.src || i.defaultCover) : "genxed" === a3.class || "sertogenre" === a3.class ? c3 = true : c3 && "a" === t3 ? u = true : "div" !== t3 || "entry-content" !== a3.class && "description" !== a3.itemprop ? "spe" === a3.class || "serl" === a3.class ? h = true : h && "span" === t3 ? p = true : "div" === t3 && "sertostat" === a3.class ? (h = true, p = true, b = true) : a3.class && a3.class.includes("eplister") ? m = true : m && "li" === t3 ? y = true : y ? "a" === t3 && void 0 === N.path ? N.path = a3.href.replace(e2, "").trim() : "epl-num" === a3.class ? g = 1 : "epl-title" === a3.class ? g = 2 : "epl-date" === a3.class ? g = 3 : "epl-price" === a3.class && (g = 4) : !v || "div" !== t3 && "script" !== t3 || v++ : v++;
              }, ontext: function(e3) {
                var t3, a3;
                if (c3) u && (o2.genres += e3 + ", ");
                  ...
                  if (1 === g) e3.includes("\u{1F512}") ? (w = true, k = true) : k && (w = false), n(e3, N);
                  else if (2 === g) N.name = (null === (a3 = null === (t3 = e3.match(RegExp("^".concat(o2.name.replace(/[.*+?^${}()|[\]\\]/g, "\\$&"), "\\s*(.+)")))) || void 0 === t3 ? void 0 : t3[1]) || void 0 === a3 ? void 0 : a3.trim()) || e3.trim(), N.chapterNumber || n(e3, N);
                ...
                var t3, a3, l2;
                c3 ? u ? u = false : (c3 = false, o2.genres = null === (t3 = o2.genres) || void 0 === t3 ? void 0 : t3.slice(0, -2)) : v ? "p" === e3 ? o2.summary += "\n\n" : "br" === e3 ? o2.summary += "\n" : "div" !== e3 && "script" !== e3 || v-- : h ? p ? "span" === e3 && (p = false, d && o2.author ? d = false : f && o2.artist ? f = false : b && "" !== o2.status && (b = false)) : "div" === e3 && (h = false, o2.author = null === (a3 = o2.author) || void 0 === a3 ? void 0 : a3.trim(), o2.artist = null === (l2 = o2.artist) || void 0 === l2 ? void 0 : l2.trim()) : m && (y ? 1 === g || 2 === g || 3 === g || 4 === g ? g = 0 : "li" === e3 && (y = false, N.chapterNumber || (N.chapterNumber = 0), w && (N.name = "\u{1F512} " + N.name), C && w || S.push(N), N = {}) : "ul" === e3 && (m = false));
              } }), x.write(s2), x.end(), S.length && ((null === (L = this.options) || void 0 === L ? void 0 : L.reverseChapters) && S.reverse(), o2.chapters = S), o2.summary = o2.summary.trim(), [2, o2];
          }
        }));
      }));
    }, c2.prototype.parseChapter = function(l2) {
      return e(this, void 0, void 0, (function() {
        var e2, s2, r2, i2, o2;
        return t(this, (function(t2) {
          switch (t2.label) {
    ...
    }, c2.prototype.searchNovels = function(a2, l2) {
      return e(this, void 0, void 0, (function() {
        var e2, s2;
        return t(this, (function(t2) {
          switch (t2.label) {
