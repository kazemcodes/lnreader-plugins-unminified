...
var LNReaderPlugin = (() => {
  ...
  // .js/plugins/english/KeopiTranslations[lightnovelwp].js
  ...
  var a = (init_browser(), __toCommonJS(browser_exports)), s = require_lib9(), r = (init_fetch2(), __toCommonJS(fetch_exports)), i = (init_novelStatus(), __toCommonJS(novelStatus_exports)), o = (init_defaultCover(), __toCommonJS(defaultCover_exports)), n = (init_storage2(), __toCommonJS(storage_exports));
  function l(e2, t2) {
    var a2 = e2.match(/(\d+)$/);
  ...
  var c = new ((function() {
    ...
    return c2.prototype.getHostname = function(e2) {
      ...
      return e(this, void 0, void 0, (function() {
        var e2, i2, o2, n2, l2, c3, u, p;
        return t(this, (function(t2) {
          switch (t2.label) {
            case 0:
              return e2 = a2.split("://"), i2 = e2.shift(), o2 = e2[0].replace(/\/\//g, "/"), [4, (0, r.fetchApi)(i2 + "://" + o2)];
            case 1:
              if (!(n2 = t2.sent()).ok && 1 != s2) throw new Error("Could not reach site (" + n2.status + ") try to open in webview.");
              return [4, n2.text()];
            case 2:
              if (l2 = t2.sent(), c3 = null === (p = null === (u = l2.match(/<title>(.*?)<\/title>/)) || void 0 === u ? void 0 : u[1]) || void 0 === p ? void 0 : p.trim(), this.getHostname(a2) != this.getHostname(n2.url) || c3 && ("Bot Verification" == c3 || "You are being redirected..." == c3 || "Un instant..." == c3 || "Just a moment..." == c3 || "Redirecting..." == c3)) throw new Error("Captcha error, please open in webview (or the website has changed url)");
              return [2, l2];
          }
        }));
      }));
      ...
      return (e2.match(/<article([^]*?)<\/article>/g) || []).forEach((function(e3) {
        ...
        if (i2 && r2) {
          var n2 = e3.match(/<img [^>]*?src="([^\"]*)"[^>]*?(?: data-src="([^\"]*)")?[^>]*>/) || [], l2 = void 0;
          if (r2.includes(t2.site)) l2 = r2.replace(t2.site, "");
          else {
            var c3 = r2.split("/");
            c3.shift(), c3.shift(), c3.shift(), l2 = c3.join("/");
          }
          s2.push({ name: i2, cover: n2[2] || n2[1] || o.defaultCover, path: l2 });
        }
      })), s2;
    }, c2.prototype.popularNovels = function(a2, s2) {
      return e(this, arguments, void 0, (function(e2, a3) {
        var s3, r2, i2, o2, n2, l2, c3, u, p, h = a3.filters, v = a3.showLatestNovels;
        return t(this, (function(t2) {
          switch (t2.label) {
            case 0:
              for (i2 in s3 = null !== (p = null === (u = this.options) || void 0 === u ? void 0 : u.seriesPath) && void 0 !== p ? p : "/series/", r2 = this.site + s3 + "?page=" + e2, h || (h = this.filters || {}), v && (r2 += "&order=latest"), h) if ("object" == typeof h[i2].value) for (o2 = 0, n2 = h[i2].value; o2 < n2.length; o2++) l2 = n2[o2], r2 += "&".concat(i2, "=").concat(l2);
      ...
      return e(this, void 0, void 0, (function() {
        var e2, r2, n2, c3, u, p, h, v, d, f, m, b, g, y, w, k, N, C, x, S, L;
        return t(this, (function(t2) {
          switch (t2.label) {
            case 0:
              return e2 = this.site, [4, this.safeFecth(e2 + a2, false)];
            case 1:
              return r2 = t2.sent(), n2 = { path: a2, name: "", genres: "", summary: "", author: "", artist: "", status: "", chapters: [] }, c3 = false, u = false, p = 0, h = false, v = false, d = false, f = false, m = false, b = false, g = false, y = 0, w = false, k = false, N = [], C = {}, x = this.hideLocked, S = new s.Parser({ onopentag: function(t3, a3) {
                var s2;
                !n2.cover && (null === (s2 = a3.class) || void 0 === s2 ? void 0 : s2.includes("ts-post-image")) ? (n2.name = a3.title, n2.cover = a3["data-src"] || a3.src || o.defaultCover) : "genxed" === a3.class || "sertogenre" === a3.class ? c3 = true : c3 && "a" === t3 ? u = true : "div" !== t3 || "entry-content" !== a3.class && "description" !== a3.itemprop ? "spe" === a3.class || "serl" === a3.class ? h = true : h && "span" === t3 ? v = true : "div" === t3 && "sertostat" === a3.class ? (h = true, v = true, m = true) : a3.class && a3.class.includes("eplister") ? b = true : b && "li" === t3 ? g = true : g ? "a" === t3 && void 0 === C.path ? C.path = a3.href.replace(e2, "").trim() : "epl-num" === a3.class ? y = 1 : "epl-title" === a3.class ? y = 2 : "epl-date" === a3.class ? y = 3 : "epl-price" === a3.class && (y = 4) : !p || "div" !== t3 && "script" !== t3 || p++ : p++;
              }, ontext: function(e3) {
                var t3, a3;
                if (c3) u && (n2.genres += e3 + ", ");
                  ...
                  if (1 === y) e3.includes("\u{1F512}") ? (w = true, k = true) : k && (w = false), l(e3, C);
                  else if (2 === y) C.name = (null === (a3 = null === (t3 = e3.match(RegExp("^".concat(n2.name.replace(/[.*+?^${}()|[\]\\]/g, "\\$&"), "\\s*(.+)")))) || void 0 === t3 ? void 0 : t3[1]) || void 0 === a3 ? void 0 : a3.trim()) || e3.trim(), C.chapterNumber || l(e3, C);
                ...
                var t3, a3, s2;
                c3 ? u ? u = false : (c3 = false, n2.genres = null === (t3 = n2.genres) || void 0 === t3 ? void 0 : t3.slice(0, -2)) : p ? "p" === e3 ? n2.summary += "\n\n" : "br" === e3 ? n2.summary += "\n" : "div" !== e3 && "script" !== e3 || p-- : h ? v ? "span" === e3 && (v = false, d && n2.author ? d = false : f && n2.artist ? f = false : m && "" !== n2.status && (m = false)) : "div" === e3 && (h = false, n2.author = null === (a3 = n2.author) || void 0 === a3 ? void 0 : a3.trim(), n2.artist = null === (s2 = n2.artist) || void 0 === s2 ? void 0 : s2.trim()) : b && (g ? 1 === y || 2 === y || 3 === y || 4 === y ? y = 0 : "li" === e3 && (g = false, C.chapterNumber || (C.chapterNumber = 0), w && (C.name = "\u{1F512} " + C.name), x && w || N.push(C), C = {}) : "ul" === e3 && (b = false));
              } }), S.write(r2), S.end(), N.length && ((null === (L = this.options) || void 0 === L ? void 0 : L.reverseChapters) && N.reverse(), n2.chapters = N), n2.summary = n2.summary.trim(), [2, n2];
          }
        }));
      }));
