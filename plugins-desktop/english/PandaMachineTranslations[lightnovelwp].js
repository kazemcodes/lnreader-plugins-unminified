...
var LNReaderPlugin = (() => {
  ...
  // .js/plugins/english/PandaMachineTranslations[lightnovelwp].js
  ...
  var c = new ((function() {
    ...
    return c2.prototype.getHostname = function(e2) {
      ...
      return e(this, void 0, void 0, (function() {
        var e2, s2, o2, c3, u, v, h, p, d, f, b, m, g, y, w, k, N, S, C, L, x;
        return t(this, (function(t2) {
          switch (t2.label) {
            case 0:
              return e2 = this.site, [4, this.safeFecth(e2 + a2, false)];
            case 1:
              return s2 = t2.sent(), o2 = { path: a2, name: "", genres: "", summary: "", author: "", artist: "", status: "", chapters: [] }, c3 = false, u = false, v = 0, h = false, p = false, d = false, f = false, b = false, m = false, g = false, y = 0, w = false, k = false, N = [], S = {}, C = this.hideLocked, L = new l.Parser({ onopentag: function(t3, a3) {
                var l2;
              ...
              } }), L.write(s2), L.end(), N.length && ((null === (x = this.options) || void 0 === x ? void 0 : x.reverseChapters) && N.reverse(), o2.chapters = N), o2.summary = o2.summary.trim(), [2, o2];
          }
        }));
      }));
