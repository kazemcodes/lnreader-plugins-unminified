...
var LNReaderPlugin = (() => {
  ...
  // .js/plugins/english/CPUnovel[lightnovelwp].js
  var e = function(e2, a2, t2, l2) {
    ...
    var t2, l2, r2, i2 = { label: 0, sent: function() {
  ...
  var t = (init_browser(), __toCommonJS(browser_exports)), l = require_lib9(), r = (init_fetch2(), __toCommonJS(fetch_exports)), i = (init_novelStatus(), __toCommonJS(novelStatus_exports)), s = (init_defaultCover(), __toCommonJS(defaultCover_exports)), o = (init_storage2(), __toCommonJS(storage_exports));
  function n(e2, a2) {
    var t2 = e2.match(/(\d+)$/);
  ...
  var u = new ((function() {
    ...
    return u2.prototype.getHostname = function(e2) {
      ...
      return e(this, void 0, void 0, (function() {
        var e2, i2, s2, o2, n2, u3, c, v;
        return a(this, (function(a2) {
          switch (a2.label) {
            case 0:
              return e2 = t2.split("://"), i2 = e2.shift(), s2 = e2[0].replace(/\/\//g, "/"), [4, (0, r.fetchApi)(i2 + "://" + s2)];
            case 1:
      ...
      return (e2.match(/<article([^]*?)<\/article>/g) || []).forEach((function(e3) {
        var t2 = e3.match(/<a href="([^\"]*)".*? title="([^\"]*)"/) || [], r2 = t2[1], i2 = t2[2];
        if (i2 && r2) {
          ...
          l2.push({ name: i2, cover: o2[2] || o2[1] || s.defaultCover, path: n2 });
        }
      })), l2;
    }, u2.prototype.popularNovels = function(t2, l2) {
      return e(this, arguments, void 0, (function(e2, t3) {
        var l3, r2, i2, s2, o2, n2, u3, c, v, h = t3.filters, p = t3.showLatestNovels;
        return a(this, (function(a2) {
          switch (a2.label) {
            case 0:
              for (i2 in l3 = null !== (v = null === (c = this.options) || void 0 === c ? void 0 : c.seriesPath) && void 0 !== v ? v : "/series/", r2 = this.site + l3 + "?page=" + e2, h || (h = this.filters || {}), p && (r2 += "&order=latest"), h) if ("object" == typeof h[i2].value) for (s2 = 0, o2 = h[i2].value; s2 < o2.length; s2++) n2 = o2[s2], r2 += "&".concat(i2, "=").concat(n2);
      ...
      return e(this, void 0, void 0, (function() {
        var e2, r2, o2, u3, c, v, h, p, d, b, f, m, g, y, w, k, S, N, x, C, L;
        return a(this, (function(a2) {
          switch (a2.label) {
            case 0:
              return e2 = this.site, [4, this.safeFecth(e2 + t2, false)];
            case 1:
              return r2 = a2.sent(), o2 = { path: t2, name: "", genres: "", summary: "", author: "", artist: "", status: "", chapters: [] }, u3 = false, c = false, v = 0, h = false, p = false, d = false, b = false, f = false, m = false, g = false, y = 0, w = false, k = false, S = [], N = {}, x = this.hideLocked, C = new l.Parser({ onopentag: function(a3, t3) {
                var l2;
                ...
                if (u3) c && (o2.genres += e3 + ", ");
                  ...
                  if (p) {
                    ...
                    else if (b) o2.artist += e3 || "Unknown";
                    else if (f) switch (l2) {
                      case "\u0645\u0643\u062A\u0645\u0644\u0629":
                      case "completed":
                      case "compl\xE9t\xE9":
                  ...
                  else if (2 === y) N.name = (null === (t3 = null === (a3 = e3.match(RegExp("^".concat(o2.name.replace(/[.*+?^${}()|[\]\\]/g, "\\$&"), "\\s*(.+)")))) || void 0 === a3 ? void 0 : a3[1]) || void 0 === t3 ? void 0 : t3.trim()) || e3.trim(), N.chapterNumber || n(e3, N);
                ...
                var a3, t3, l2;
                u3 ? c ? c = false : (u3 = false, o2.genres = null === (a3 = o2.genres) || void 0 === a3 ? void 0 : a3.slice(0, -2)) : v ? "p" === e3 ? o2.summary += "\n\n" : "br" === e3 ? o2.summary += "\n" : "div" !== e3 && "script" !== e3 || v-- : h ? p ? "span" === e3 && (p = false, d && o2.author ? d = false : b && o2.artist ? b = false : f && "" !== o2.status && (f = false)) : "div" === e3 && (h = false, o2.author = null === (t3 = o2.author) || void 0 === t3 ? void 0 : t3.trim(), o2.artist = null === (l2 = o2.artist) || void 0 === l2 ? void 0 : l2.trim()) : m && (g ? 1 === y || 2 === y || 3 === y || 4 === y ? y = 0 : "li" === e3 && (g = false, N.chapterNumber || (N.chapterNumber = 0), w && (N.name = "\u{1F512} " + N.name), x && w || S.push(N), N = {}) : "ul" === e3 && (m = false));
              } }), C.write(r2), C.end(), S.length && ((null === (L = this.options) || void 0 === L ? void 0 : L.reverseChapters) && S.reverse(), o2.chapters = S), o2.summary = o2.summary.trim(), [2, o2];
          }
        }));
      }));
