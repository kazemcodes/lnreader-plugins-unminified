...
var LNReaderPlugin = (() => {
  ...
  var l = (init_browser(), __toCommonJS(browser_exports)), t = require_lib9(), r = (init_fetch2(), __toCommonJS(fetch_exports)), n = (init_novelStatus(), __toCommonJS(novelStatus_exports)), s = (init_defaultCover(), __toCommonJS(defaultCover_exports)), i = (init_storage2(), __toCommonJS(storage_exports));
  function o(e2, a2) {
    var l2 = e2.match(/(\d+)$/);
  ...
  var u = new ((function() {
    function u2(e2) {
      ...
      this.version = "1.1.".concat(9 + r2), this.options = null !== (l2 = e2.options) && void 0 !== l2 ? l2 : {}, this.filters = e2.filters, (null === (t2 = this.options) || void 0 === t2 ? void 0 : t2.hasLocked) && (this.pluginSettings = { hideLocked: { value: "", label: "Hide locked chapters", type: "Switch" } });
    }
    return u2.prototype.getHostname = function(e2) {
        ...
        return a(this, (function(a2) {
          switch (a2.label) {
            ...
            case 1:
              ...
              return [4, i2.text()];
            case 2:
              if (o2 = a2.sent(), u3 = null === (v = null === (c = o2.match(/<title>(.*?)<\/title>/)) || void 0 === c ? void 0 : c[1]) || void 0 === v ? void 0 : v.trim(), this.getHostname(l2) != this.getHostname(i2.url) || u3 && ("Bot Verification" == u3 || "You are being redirected..." == u3 || "Un instant..." == u3 || "Just a moment..." == u3 || "Redirecting..." == u3)) throw new Error("Captcha error, please open in webview (or the website has changed url)");
              return [2, o2];
          }
        }));
      }));
      ...
      return (e2.match(/<article([^]*?)<\/article>/g) || []).forEach((function(e3) {
        ...
        if (n2 && r2) {
          var i2 = e3.match(/<img [^>]*?src="([^\"]*)"[^>]*?(?: data-src="([^\"]*)")?[^>]*>/) || [], o2 = void 0;
          if (r2.includes(a2.site)) o2 = r2.replace(a2.site, "");
          else {
            var u3 = r2.split("/");
            u3.shift(), u3.shift(), u3.shift(), o2 = u3.join("/");
          }
          t2.push({ name: n2, cover: i2[2] || i2[1] || s.defaultCover, path: o2 });
        }
      })), t2;
    }, u2.prototype.popularNovels = function(l2, t2) {
      return e(this, arguments, void 0, (function(e2, l3) {
        var t3, r2, n2, s2, i2, o2, u3, c, v, b = l3.filters, h = l3.showLatestNovels;
        return a(this, (function(a2) {
          switch (a2.label) {
            case 0:
              for (n2 in t3 = null !== (v = null === (c = this.options) || void 0 === c ? void 0 : c.seriesPath) && void 0 !== v ? v : "/series/", r2 = this.site + t3 + "?page=" + e2, b || (b = this.filters || {}), h && (r2 += "&order=latest"), b) if ("object" == typeof b[n2].value) for (s2 = 0, i2 = b[n2].value; s2 < i2.length; s2++) o2 = i2[s2], r2 += "&".concat(n2, "=").concat(o2);
              else b[n2].value && (r2 += "&".concat(n2, "=").concat(b[n2].value));
      ...
      return e(this, void 0, void 0, (function() {
        var e2, r2, i2, u3, c, v, b, h, d, p, m, f, g, y, w, k, S, N, L, x, C;
        return a(this, (function(a2) {
          switch (a2.label) {
            case 0:
              return e2 = this.site, [4, this.safeFecth(e2 + l2, false)];
            case 1:
              return r2 = a2.sent(), i2 = { path: l2, name: "", genres: "", summary: "", author: "", artist: "", status: "", chapters: [] }, u3 = false, c = false, v = 0, b = false, h = false, d = false, p = false, m = false, f = false, g = false, y = 0, w = false, k = false, S = [], N = {}, L = this.hideLocked, x = new t.Parser({ onopentag: function(a3, l3) {
                var t2;
                !i2.cover && (null === (t2 = l3.class) || void 0 === t2 ? void 0 : t2.includes("ts-post-image")) ? (i2.name = l3.title, i2.cover = l3["data-src"] || l3.src || s.defaultCover) : "genxed" === l3.class || "sertogenre" === l3.class ? u3 = true : u3 && "a" === a3 ? c = true : "div" !== a3 || "entry-content" !== l3.class && "description" !== l3.itemprop ? "spe" === l3.class || "serl" === l3.class ? b = true : b && "span" === a3 ? h = true : "div" === a3 && "sertostat" === l3.class ? (b = true, h = true, m = true) : l3.class && l3.class.includes("eplister") ? f = true : f && "li" === a3 ? g = true : g ? "a" === a3 && void 0 === N.path ? N.path = l3.href.replace(e2, "").trim() : "epl-num" === l3.class ? y = 1 : "epl-title" === l3.class ? y = 2 : "epl-date" === l3.class ? y = 3 : "epl-price" === l3.class && (y = 4) : !v || "div" !== a3 && "script" !== a3 || v++ : v++;
              }, ontext: function(e3) {
                var a3, l3;
                if (u3) c && (i2.genres += e3 + ", ");
                  ...
                  if (1 === y) e3.includes("\u{1F512}") ? (w = true, k = true) : k && (w = false), o(e3, N);
                  else if (2 === y) N.name = (null === (l3 = null === (a3 = e3.match(RegExp("^".concat(i2.name.replace(/[.*+?^${}()|[\]\\]/g, "\\$&"), "\\s*(.+)")))) || void 0 === a3 ? void 0 : a3[1]) || void 0 === l3 ? void 0 : l3.trim()) || e3.trim(), N.chapterNumber || o(e3, N);
                ...
                var a3, l3, t2;
                u3 ? c ? c = false : (u3 = false, i2.genres = null === (a3 = i2.genres) || void 0 === a3 ? void 0 : a3.slice(0, -2)) : v ? "p" === e3 ? i2.summary += "\n\n" : "br" === e3 ? i2.summary += "\n" : "div" !== e3 && "script" !== e3 || v-- : b ? h ? "span" === e3 && (h = false, d && i2.author ? d = false : p && i2.artist ? p = false : m && "" !== i2.status && (m = false)) : "div" === e3 && (b = false, i2.author = null === (l3 = i2.author) || void 0 === l3 ? void 0 : l3.trim(), i2.artist = null === (t2 = i2.artist) || void 0 === t2 ? void 0 : t2.trim()) : f && (g ? 1 === y || 2 === y || 3 === y || 4 === y ? y = 0 : "li" === e3 && (g = false, N.chapterNumber || (N.chapterNumber = 0), w && (N.name = "\u{1F512} " + N.name), L && w || S.push(N), N = {}) : "ul" === e3 && (f = false));
              } }), x.write(r2), x.end(), S.length && ((null === (C = this.options) || void 0 === C ? void 0 : C.reverseChapters) && S.reverse(), i2.chapters = S), i2.summary = i2.summary.trim(), [2, i2];
          }
        }));
      }));
