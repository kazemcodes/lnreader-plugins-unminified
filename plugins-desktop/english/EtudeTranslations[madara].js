...
var LNReaderPlugin = (() => {
  ...
  // .js/plugins/english/EtudeTranslations[madara].js
  ...
  var n = (init_fetch2(), __toCommonJS(fetch_exports)), r = (init_browser(), __toCommonJS(browser_exports)), i = (init_defaultCover(), __toCommonJS(defaultCover_exports)), o = (init_novelStatus(), __toCommonJS(novelStatus_exports)), s = a(require_dayjs_min()), l = (init_storage2(), __toCommonJS(storage_exports)), u = function(t2, e2) {
    ...
    function a2(t2) {
      ...
      this.version = "1.0.".concat(8 + n2), this.options = t2.options, this.filters = t2.filters, (null === (a3 = this.options) || void 0 === a3 ? void 0 : a3.hasLocked) && (this.pluginSettings = { hideLocked: { value: "", label: "Hide locked chapters", type: "Switch" } });
    }
    return a2.prototype.translateDragontea = function(t2) {
      ...
      return t(this, void 0, void 0, (function() {
        var t2, l2, u2, c2, h, p, d, m, f = this;
        return e(this, (function(e2) {
          switch (e2.label) {
            case 0:
