...
var LNReaderPlugin = (() => {
  ...
  // .js/plugins/english/Ranovel[madara].js
          ...
          switch (t2.label) {
            ...
            case 5:
              return "0" !== c2 && (e2 = (0, n.load)(c2)), d = e2(".wp-manga-chapter").length, e2(".wp-manga-chapter").each((function(t3, a4) {
                ...
                !o2 || "#" == o2 || n2 && v.hideLocked || u2.push({ name: r2, path: o2.replace(/https?:\/\/.*?\//, "/"), releaseTime: i2 || null, chapterNumber: d - t3 });
        ...
        return t(this, (function(t2) {
          switch (t2.label) {
            case 0:
              return [4, this.getCheerio(this.site + a3, false)];
            case 1:
              if (e2 = t2.sent(), r2 = e2(".text-left") || e2(".text-right") || e2(".entry-content") || e2(".c-blog-post > div > div:nth-child(2)"), null === (n2 = this.options) || void 0 === n2 ? void 0 : n2.customJs) try {
                e2('img[alt="Buy Me a Coffee at ko-fi.com"]').parent().remove(), e2("*").contents().each((function() {
                  if ("comment" === this.type && "Text Ranovel" === this.data.trim()) for (var t3 = this.next, a4 = 0; a4 < 2 && t3; a4++) {
                    var r3 = t3.next;
                    e2(t3).remove(), t3 = r3;
                  }
                }));
              ...
              return [2, this.translateDragontea(r2).html() || ""];
          }
        }));
      }));
