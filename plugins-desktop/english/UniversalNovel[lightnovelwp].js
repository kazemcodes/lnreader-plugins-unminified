...
var LNReaderPlugin = (() => {
  ...
  // .js/plugins/english/UniversalNovel[lightnovelwp].js
  var e = function(e2, a2, t2, l2) {
    ...
    var t2, l2, i2, s2 = { label: 0, sent: function() {
  ...
  var t = (init_browser(), __toCommonJS(browser_exports)), l = require_lib9(), i = (init_fetch2(), __toCommonJS(fetch_exports)), s = (init_novelStatus(), __toCommonJS(novelStatus_exports)), r = (init_defaultCover(), __toCommonJS(defaultCover_exports)), o = (init_storage2(), __toCommonJS(storage_exports));
  function n(e2, a2) {
    var t2 = e2.match(/(\d+)$/);
    ...
    return u2.prototype.getHostname = function(e2) {
      ...
      return (e2.match(/<article([^]*?)<\/article>/g) || []).forEach((function(e3) {
        ...
        if (s2 && i2) {
          ...
          l2.push({ name: s2, cover: o2[2] || o2[1] || r.defaultCover, path: n2 });
        }
      })), l2;
    }, u2.prototype.popularNovels = function(t2, l2) {
      return e(this, arguments, void 0, (function(e2, t3) {
        var l3, i2, s2, r2, o2, n2, u3, c, v, h = t3.filters, p = t3.showLatestNovels;
        return a(this, (function(a2) {
          switch (a2.label) {
            case 0:
              for (s2 in l3 = null !== (v = null === (c = this.options) || void 0 === c ? void 0 : c.seriesPath) && void 0 !== v ? v : "/series/", i2 = this.site + l3 + "?page=" + e2, h || (h = this.filters || {}), p && (i2 += "&order=latest"), h) if ("object" == typeof h[s2].value) for (r2 = 0, o2 = h[s2].value; r2 < o2.length; r2++) n2 = o2[r2], i2 += "&".concat(s2, "=").concat(n2);
            ...
            case 1:
              return i2 = a2.sent(), o2 = { path: t2, name: "", genres: "", summary: "", author: "", artist: "", status: "", chapters: [] }, u3 = false, c = false, v = 0, h = false, p = false, d = false, b = false, f = false, m = false, g = false, y = 0, w = false, k = false, N = [], S = {}, x = this.hideLocked, C = new l.Parser({ onopentag: function(a3, t3) {
                ...
                if (u3) c && (o2.genres += e3 + ", ");
                  ...
                  else if (2 === y) S.name = (null === (t3 = null === (a3 = e3.match(RegExp("^".concat(o2.name.replace(/[.*+?^${}()|[\]\\]/g, "\\$&"), "\\s*(.+)")))) || void 0 === a3 ? void 0 : a3[1]) || void 0 === t3 ? void 0 : t3.trim()) || e3.trim(), S.chapterNumber || n(e3, S);
