...
var LNReaderPlugin = (() => {
  ...
  var e = function(e2, t2, a2, r2) {
    ...
    var a2, r2, l2, n2 = { label: 0, sent: function() {
  ...
  var r = (init_fetch2(), __toCommonJS(fetch_exports)), l = (init_browser(), __toCommonJS(browser_exports)), n = (init_defaultCover(), __toCommonJS(defaultCover_exports)), i = (init_novelStatus(), __toCommonJS(novelStatus_exports)), o = a(require_dayjs_min()), s = (init_storage2(), __toCommonJS(storage_exports)), u = function(e2, t2) {
