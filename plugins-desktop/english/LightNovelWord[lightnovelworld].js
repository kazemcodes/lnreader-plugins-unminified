...
var LNReaderPlugin = (() => {
      ...
      !(function(t2, e2) {
        ...
        var _ = (function() {
          ...
          return m2.parse = function(t3) {
            ...
            var r3 = t3 || "YYYY-MM-DDTHH:mm:ssZ", i3 = b.z(this), s2 = this.$H, u2 = this.$m, a3 = this.$M, o3 = n3.weekdays, c2 = n3.months, f2 = n3.meridiem, h2 = function(t4, n4, i4, s3) {
  ...
  // .js/plugins/english/LightNovelWord[lightnovelworld].js
  ...
  var l = (init_browser(), __toCommonJS(browser_exports)), n = (init_fetch2(), __toCommonJS(fetch_exports)), r = (init_filterInputs(), __toCommonJS(filterInputs_exports)), i = a(require_dayjs_min()), o = new ((function() {
    function a2(e2) {
      var t2;
      this.headers = { Accept: "application/json", "Content-Type": "application/json" }, this.imageRequestInit = { headers: this.headers }, this.filters = { order: { value: "popular", label: "Order by", options: [{ label: "New", value: "new" }, { label: "Popular", value: "popular" }, { label: "Updates", value: "updated" }], type: r.FilterTypes.Picker }, status: { value: "all", label: "Status", options: [{ label: "All", value: "all" }, { label: "Completed", value: "completed" }, { label: "Ongoing", value: "ongoing" }], type: r.FilterTypes.Picker }, genres: { value: "all", label: "Genre", options: [{ label: "All", value: "all" }, { label: "Action", value: "action" }, { label: "Adventure", value: "adventure" }, { label: "Drama", value: "drama" }, { label: "Fantasy", value: "fantasy" }, { label: "Harem", value: "harem" }, { label: "Martial Arts", value: "martial-arts" }, { label: "Mature", value: "mature" }, { label: "Romance", value: "romance" }, { label: "Tragedy", value: "tragedy" }, { label: "Xuanhuan", value: "xuanhuan" }, { label: "Ecchi", value: "ecchi" }, { label: "Comedy", value: "comedy" }, { label: "Slice of Life", value: "slice-of-life" }, { label: "Mystery", value: "mystery" }, { label: "Supernatural", value: "supernatural" }, { label: "Psychological", value: "psychological" }, { label: "Sci-fi", value: "sci-fi" }, { label: "Xianxia", value: "xianxia" }, { label: "School Life", value: "school-life" }, { label: "Josei", value: "josei" }, { label: "Wuxia", value: "wuxia" }, { label: "Shounen", value: "shounen" }, { label: "Horror", value: "horror" }, { label: "Mecha", value: "mecha" }, { label: "Historical", value: "historical" }, { label: "Shoujo", value: "shoujo" }, { label: "Adult", value: "adult" }, { label: "Seinen", value: "seinen" }, { label: "Sports", value: "sports" }, { label: "Lolicon", value: "lolicon" }, { label: "Gender Bender", value: "gender-bender" }, { label: "Shounen Ai", value: "shounen-ai" }, { label: "Yaoi", value: "yaoi" }, { label: "Video Games", value: "video-games" }, { label: "Smut", value: "smut" }, { label: "Magical Realism", value: "magical-realism" }, { label: "Eastern Fantasy", value: "eastern-fantasy" }, { label: "Contemporary Romance", value: "contemporary-romance" }, { label: "Fantasy Romance", value: "fantasy-romance" }, { label: "Shoujo Ai", value: "shoujo-ai" }, { label: "Yuri", value: "yuri" }], type: r.FilterTypes.Picker } }, this.id = e2.id, this.name = e2.sourceName, this.icon = "multisrc/lightnovelworld/".concat(e2.id.toLowerCase(), "/icon.png"), this.site = e2.sourceSite;
      var a3 = (null === (t2 = e2.options) || void 0 === t2 ? void 0 : t2.versionIncrements) || 0;
      this.version = "1.0.".concat(1 + a3), this.options = e2.options;
    }
    return a2.prototype.popularNovels = function(a3, r2) {
      return e(this, arguments, void 0, (function(e2, a4) {
        var r3, i2, o2, u, s = a4.filters;
        return t(this, (function(t2) {
          switch (t2.label) {
            case 0:
              return r3 = "".concat(this.site, "browse/"), r3 += "".concat(s.genres.value, "/"), r3 += "".concat(s.order.value, "/"), r3 += "".concat(s.status.value, "/"), r3 += e2, [4, (0, n.fetchApi)(r3).then((function(e3) {
                return e3.text();
              }))];
            case 1:
              return i2 = t2.sent(), o2 = (0, l.load)(i2), u = [], o2(".novel-item.ads").remove(), o2(".novel-item").each((function(e3, t3) {
                var a5, l2 = o2(t3).find(".novel-title").text().trim(), n2 = o2(t3).find("img").attr("data-src"), r4 = null === (a5 = o2(t3).find(".novel-title > a").attr("href")) || void 0 === a5 ? void 0 : a5.substring(1);
                if (r4) {
                  var i3 = { name: l2, cover: n2, path: r4 };
                  u.push(i3);
                }
              })), [2, u];
          }
      ...
      return e(this, void 0, void 0, (function() {
        ...
        return t(this, (function(t2) {
          switch (t2.label) {
            case 0:
              return [4, (0, n.fetchApi)(this.site + a3).then((function(e3) {
                return e3.text();
              }))];
            case 1:
              return e2 = t2.sent(), r2 = (0, l.load)(e2), i2 = parseInt(r2(".header-stats span:first strong").text(), 10), (o2 = { path: a3, name: r2("h1.novel-title").text().trim() || "Untitled", cover: r2("figure.cover > img").attr("data-src"), author: r2(".author > a > span").text(), summary: r2(".summary > .content").text().trim(), status: r2(".header-stats span:last strong").text(), totalPages: Math.ceil(i2 / 100), chapters: [] }).genres = r2(".categories ul li").map((function(e3, t3) {
      ...
      return e(this, void 0, void 0, (function() {
        ...
        return t(this, (function(t2) {
          switch (t2.label) {
            case 0:
              return e2 = this.site + a3 + "/chapters/page-" + r2, [4, (0, n.fetchApi)(e2).then((function(e3) {
                return e3.text();
              }))];
            case 1:
              return o2 = t2.sent(), u = (0, l.load)(o2), s = [], u(".chapter-list li").each((function() {
                var e3, t3 = "Chapter " + u(this).find(".chapter-no").text().trim() + " - " + u(this).find(".chapter-title").text().trim(), a4 = u(this).find(".chapter-update").attr("datetime"), l2 = null === (e3 = u(this).find("a").attr("href")) || void 0 === e3 ? void 0 : e3.substring(1);
                l2 && s.push({ name: t3, path: l2, releaseTime: (0, i.default)(a4).toISOString() });
              })), [2, { chapters: s }];
          }
        }));
      }));
      ...
      return e(this, void 0, void 0, (function() {
        ...
        return t(this, (function(t2) {
          switch (t2.label) {
            ...
            case 1:
              return e2 = t2.sent(), r2 = (0, l.load)(e2), [2, r2("#chapter-container").html() || ""];
          }
        }));
      }));
    }, a2.prototype.searchNovels = function(a3) {
      return e(this, void 0, void 0, (function() {
        var e2, r2, i2, o2, u, s, c, h, v;
        return t(this, (function(t2) {
          switch (t2.label) {
            case 0:
              return e2 = "".concat(this.site, "lnsearchlive"), r2 = "".concat(this.site, "search"), [4, (0, n.fetchApi)(r2).then((function(e3) {
                return e3.text();
              }))];
            case 1:
              return i2 = t2.sent(), o2 = (0, l.load)(i2), u = o2("#novelSearchForm > input").attr("value"), (s = new FormData()).append("inputContent", a3), [4, (0, n.fetchApi)(e2, { method: "POST", headers: { LNRequestVerifyToken: u }, body: s }).then((function(e3) {
                return e3.json();
              }))];
            case 2:
              return c = t2.sent(), h = [], (v = (0, l.load)(c.resultview))(".novel-item").each((function(e3, t3) {
                var a4, l2 = v(t3).find("h4.novel-title").text().trim(), n2 = v(t3).find("img").attr("src"), r3 = null === (a4 = v(t3).find("a").attr("href")) || void 0 === a4 ? void 0 : a4.substring(1);
                r3 && h.push({ name: l2, path: r3, cover: n2 });
              })), [2, h];
          }
        }));
      }));
    }, a2;
  })())({ id: "lightnovelworld", sourceName: "LightNovelWord", sourceSite: "https://www.lightnovelworld.com/" });
  exports.default = o;
})();
