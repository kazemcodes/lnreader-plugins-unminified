...
var LNReaderPlugin = (() => {
  ...
  var t = function(t2, e2, r2, i2) {
    ...
    var r2, i2, n2, o2 = { label: 0, sent: function() {
  ...
  var r = (init_browser(), __toCommonJS(browser_exports)), i = (init_fetch2(), __toCommonJS(fetch_exports)), n = (init_defaultCover(), __toCommonJS(defaultCover_exports)), o = (init_novelStatus(), __toCommonJS(novelStatus_exports)), a = function(t2, e2) {
    if (t2) try {
