...
var LNReaderPlugin = (() => {
  ...
  var t = function() {
    ...
    var n2, r2, a2, i2 = { label: 0, sent: function() {
  ...
  var r = (init_filterInputs(), __toCommonJS(filterInputs_exports)), a = (init_fetch2(), __toCommonJS(fetch_exports)), i = (init_novelStatus(), __toCommonJS(novelStatus_exports)), o = (init_browser(), __toCommonJS(browser_exports)), l = (init_defaultCover(), __toCommonJS(defaultCover_exports)), s = function(t2) {
    if (t2) try {
