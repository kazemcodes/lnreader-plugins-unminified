  ...
  function () {
    function novelOvh2() {
        ...
        json.forEach(function (element) {
          ...
          switch (element.type) {
            ...
            case "delimiter":
              ...
              break;
            case "paragraph":
              html += "<p>" + (element.content ? _this.jsonToHtml(element.content, image) : "<br>") + "</p>";
              break;
            case "orderedList":
              html += "<ol>" + (element.content ? _this.jsonToHtml(element.content, image) : "<br>") + "</ol>";
              break;
            case "listItem":
              html += "<li>" + (element.content ? _this.jsonToHtml(element.content, image) : "<br>") + "</li>";
              break;
            case "blockquote":
              html += "<blockquote>" + (element.content ? _this.jsonToHtml(element.content, image) : "<br>") + "</blockquote>";
              break;
            case "italic":
              html += "<i>" + (element.content ? _this.jsonToHtml(element.content, image) : "<br>") + "</i>";
              break;
            case "bold":
              html += "<b>" + (element.content ? _this.jsonToHtml(element.content, image) : "<br>") + "</b>";
              break;
            case "underline":
              html += "<u>" + (element.content ? _this.jsonToHtml(element.content, image) : "<br>") + "</u>";
              break;
            case "heading":
              html += "<h2>" + (element.content ? _this.jsonToHtml(element.content, image) : "<br>") + "</h2>";
              break;
            case "text":
              html += element.text;
              break;
      ...
      this.resolveUrl = function (path) {
        return _this.site + "/content/" + path;
      };
      this.filters = {
        sort: {
          label: "\u0421\u043E\u0440\u0442\u0438\u0440\u043E\u0432\u043A\u0430",
    ...
    __name(novelOvh2, "novelOvh");
    novelOvh2.prototype.popularNovels = function (pageNo_1, _a) {
        ...
        return __generator(this, function (_d) {
          switch (_d.label) {
            case 0:
              ...
              url += "&sort=" + (showLatestNovels ? "updatedAt" : ((_c = filters === null || filters === void 0 ? void 0 : filters.sort) === null || _c === void 0 ? void 0 : _c.value) || "averageRating") + ",desc";
    ...
    novelOvh2.prototype.parseNovel = function (novelPath) {
      return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_e) {
          switch (_e.label) {
            case 0:
              return [4, (0, fetch_1.fetchApi)(this.site + "/content/" + novelPath + "?_data=routes/reader/book/$slug/index").then(function (res) {
                return res.json();
              })];
            case 1:
              ...
              novel = {
                ...
                name: book.name.ru,
                cover: book.poster,
                genres: (_c = (_b = book.labels) === null || _b === void 0 ? void 0 : _b.map) === null || _c === void 0 ? void 0 : _c.call(_b, function (label) {
                  return label.name;
                }).join(","),
              ...
              branch_name = {};
              if (branches.length) {
                branches.forEach(function (_a2) {
                  var id = _a2.id,
                    publishers = _a2.publishers;
                  if (id && (publishers === null || publishers === void 0 ? void 0 : publishers.length)) branch_name[id] = publishers[0].name || "\u041D\u0435\u0438\u0437\u0432\u0435\u0441\u0442\u043D\u044B\u0439";
                });
              }
              chaptersRes = [];
              chapters.forEach(function (chapter, chapterIndex) {
                return chaptersRes.push({
                  name: chapter.title || "\u0422\u043E\u043C " + (chapter.volume || 0) + " " + (chapter.name || "\u0413\u043B\u0430\u0432\u0430 " + (chapter.number || chapters.length - chapterIndex)),
    ...
    novelOvh2.prototype.parseChapter = function (chapterPath) {
      return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
          switch (_b.label) {
            case 0:
              return [4, (0, fetch_1.fetchApi)(this.apiSite + "chapters/" + chapterPath.split("/")[1]).then(function (res) {
                return res.json();
              })];
            case 1:
              book = _b.sent();
              image = Object.fromEntries(((_a = book === null || book === void 0 ? void 0 : book.pages) === null || _a === void 0 ? void 0 : _a.map(function (_a2) {
                var id = _a2.id,
                  image2 = _a2.image;
                return [id, image2];
              })) || []);
    ...
    novelOvh2.prototype.searchNovels = function (searchTerm) {
      return __awaiter(this, void 0, void 0, function () {
        var url, books, novels;
