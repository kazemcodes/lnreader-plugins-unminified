...
var LNReaderPlugin = (() => {
    ...
    function l(l2) {
      return function(s) {
        return (function(l3) {
          ...
          for (; i && (i = 0, l3[0] && (o2 = 0)), o2; ) try {
            if (a2 = 1, n2 && (r2 = 2 & l3[0] ? n2.return : l3[0] ? n2.throw || ((r2 = n2.return) && r2.call(n2), 0) : n2.next) && !(r2 = r2.call(n2, l3[1])).done) return r2;
            switch (n2 = 0, r2 && (l3 = [2 & l3[0], r2.value]), l3[0]) {
              case 0:
              case 1:
                r2 = l3;
                break;
              ...
              case 7:
                ...
                continue;
              default:
                if (!(r2 = o2.trys, (r2 = r2.length > 0 && r2[r2.length - 1]) || 6 !== l3[0] && 2 !== l3[0])) {
                  o2 = 0;
                  continue;
                }
                ...
                if (6 === l3[0] && o2.label < r2[1]) {
                  o2.label = r2[1], r2 = l3;
                  break;
                }
                if (r2 && o2.label < r2[2]) {
                  o2.label = r2[2], o2.ops.push(l3);
                  break;
                }
  ...
  var a = (init_fetch2(), __toCommonJS(fetch_exports)), n = (init_filterInputs(), __toCommonJS(filterInputs_exports)), r = (init_novelStatus(), __toCommonJS(novelStatus_exports)), o = new ((function() {
    function n2(e2) {
      var t2, a2 = this;
    ...
    return n2.prototype.popularNovels = function(n3, r2) {
      return e(this, arguments, void 0, (function(e2, n4) {
        var r3, o2, i, l, s, u, c = this, h = n4.filters, p = n4.showLatestNovels;
        return t(this, (function(t2) {
          switch (t2.label) {
            case 0:
              return r3 = this.apiSite + "/books/", r3 += p ? "new" : (null === (l = null == h ? void 0 : h.sort) || void 0 === l ? void 0 : l.value) || "hot", (null === (s = null == h ? void 0 : h.category) || void 0 === s ? void 0 : s.value) && (r3 = this.apiSite + "/category/" + h.category.value), r3 += "/?page=" + (e2 - 1) + "&limit=20", [4, (0, a.fetchApi)(r3, { headers: { lang: this.lang } }).then((function(e3) {
                return e3.json();
              }))];
            case 1:
              return o2 = t2.sent(), i = [], o2.status && (null === (u = o2.data.books.data) || void 0 === u ? void 0 : u.length) && o2.data.books.data.forEach((function(e3) {
      ...
      return e(this, void 0, void 0, (function() {
        ...
        return t(this, (function(t2) {
          switch (t2.label) {
            ...
            case 1:
              return e2 = t2.sent(), o2 = { name: e2.data.book.name, path: n3, cover: this.site + e2.data.book.image, summary: e2.data.book.authorize.description, author: e2.data.book.authorize.name, status: "updating" === e2.data.book.status ? r.NovelStatus.Ongoing : r.NovelStatus.Completed }, (null === (l = e2.data.tags.tags_name) || void 0 === l ? void 0 : l.length) && (o2.genres = e2.data.tags.tags_name.join(",")), (null === (s = e2.data.chapters) || void 0 === s ? void 0 : s.length) && (i = [], e2.data.chapters.forEach((function(e3, t3) {
      ...
      return e(this, void 0, void 0, (function() {
        ...
        return t(this, (function(t2) {
          switch (t2.label) {
            ...
            case 1:
              return e2 = t2.sent(), (r2 = (null === (i = e2.match(/<div id="content-item" ([\s\S]*?)<\/div>/)) || void 0 === i ? void 0 : i[0]) || "") ? [4, (0, a.fetchApi)(this.site + "/server/getContent?slug=" + n3)] : [3, 4];
            case 2:
              return [4, t2.sent().json()];
            case 3:
              (o2 = t2.sent()).data && (r2 += o2.data.map((function(e3) {
                return "<p>" + e3 + "</p>";
              })).join("").replace(/\n/g, "</p><p>").replace(/\s/g, " ")), t2.label = 4;
            case 4:
              return [2, r2.replace(/\.copy right hot novel pub/g, "")];
          }
        }));
      }));
      ...
      return e(this, void 0, void 0, (function() {
        ...
        return t(this, (function(t2) {
          switch (t2.label) {
            ...
            case 1:
              return e2 = t2.sent(), r2 = [], e2.status && (null === (o2 = e2.data.books) || void 0 === o2 ? void 0 : o2.length) && e2.data.books.forEach((function(e3) {
                return r2.push({ name: e3.name, path: e3.slug });
              })), [2, r2];
          }
        }));
      }));
