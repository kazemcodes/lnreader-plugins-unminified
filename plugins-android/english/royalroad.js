...
var LNReaderPlugin = (() => {
  ...
  var e = function(e2, a2, l2, t2) {
    ...
    var l2, t2, n2, r3 = { label: 0, sent: function() {
  ...
  var l, t = require_lib6(), n = (init_fetch2(), __toCommonJS(fetch_exports)), r2 = (init_filterInputs(), __toCommonJS(filterInputs_exports)), i = (init_novelStatus(), __toCommonJS(novelStatus_exports)), s = (init_isAbsoluteUrl(), __toCommonJS(isAbsoluteUrl_exports)), o = (function() {
    ...
    return o2.prototype.parseNovels = function(e2) {
      var a2 = this.site, n2 = [], r3 = {}, i2 = l.Idle, o3 = new t.Parser({ onopentag: function(e3, t2) {
        var n3;
      ...
      return e(this, void 0, void 0, (function() {
        ...
        return a(this, (function(a2) {
          switch (a2.label) {
            ...
            case 2:
              return e2 = a2.sent(), o3 = { path: r3 }, u = this.site, c = l.Idle, p = "", v = 0, d = [], b = [], h = [], f = [], g = [], y = [], I = new t.Parser({ onopentag: function(e3, a3) {
                var t2, n2, r4, i2;
                switch (e3) {
                  case "h1":
                    c = l.InTitle;
        ...
        return a(this, (function(a2) {
          switch (a2.label) {
            ...
            case 1:
              return [4, a2.sent().text()];
            case 2:
              return e2 = a2.sent(), i2 = l.Idle, s2 = 0, o3 = 0, u = [], c = [], p = [], v = [], d = true, b = e2.match(/<style>\n\s+.(.+?){[^{]+?display: none;/), h = null === (S = null == b ? void 0 : b[1]) || void 0 === S ? void 0 : S.trim(), f = null, g = /[&<>"']/g, y = { "&": "&amp;", "<": "&lt;", ">": "&gt;", '"': "&quot;", "'": "&#39;" }, I = function(e3) {
                return g.test(e3) ? (g.lastIndex = 0, e3.replace(g, (function(e4) {
                  return y[e4];
                }))) : e3;
              }, (m = new t.Parser({ onopentag: function(e3, a3) {
                o3++;
                var t2 = a3.class || "";
                ...
                o3--;
              } })).write(e2), m.end(), [2, [p.length > 0 ? p.join("") : null, u.length > 0 ? u.join("").trim() : null, v.length > 0 ? v.join("") : null].filter(Boolean).join('\n<hr class="notes-separator">\n')];
          }
        }));
      }));
