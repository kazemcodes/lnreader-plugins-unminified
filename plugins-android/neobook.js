...
var LNReaderPlugin = function () {
  ...
  function () {
    ...
    __name(Neobook2, "Neobook");
    Neobook2.prototype.fetchNovels = function (page_1, _a, searchTerm_1) {
        ...
        return __generator(this, function (_j) {
          switch (_j.label) {
            case 0:
              ...
              return [4, (0, fetch_1.fetchApi)(this.apiSite, {
                method: "post",
                body: formData,
                referrer: this.site
              }).then(function (res) {
            ...
            case 1:
              ...
              if ((_g = bundle_books.feed) === null || _g === void 0 ? void 0 : _g.length) {
                (_h = bundle_books.feed) === null || _h === void 0 ? void 0 : _h.forEach(function (novel) {
                  ...
                  return novels.push({
                    name: novel.title,
                    cover: ((_b2 = (_a2 = novel === null || novel === void 0 ? void 0 : novel.attachment) === null || _a2 === void 0 ? void 0 : _a2.image) === null || _b2 === void 0 ? void 0 : _b2.m) || defaultCover_1.defaultCover,
                    path: novel.token + "/"
                  });
                });
              }
    ...
    Neobook2.prototype.searchNovels = function (searchTerm, page) {
    ...
    Neobook2.prototype.parseNovel = function (novelPath) {
      return __awaiter(this, void 0, void 0, function () {
          ...
          switch (_h.label) {
            ...
            case 1:
              ...
              if (bookRaw instanceof Array && bookRaw[1]) {
                ...
                novel.author = book_1.user && book_1.user.firstname && book_1.user.lastname ? book_1.user.firstname + " " + book_1.user.lastname : ((_c = book_1.user) === null || _c === void 0 ? void 0 : _c.initials) || "";
                novel.status = statusKey[book_1.status || "0"] || novelStatus_1.NovelStatus.Unknown;
                if ((_e = (_d = book_1.attachment) === null || _d === void 0 ? void 0 : _d.image) === null || _e === void 0 ? void 0 : _e.m) novel.cover = book_1.attachment.image.m;
                if ((_f = book_1.tags) === null || _f === void 0 ? void 0 : _f.length) novel.genres = book_1.tags.join(",");
                chapters_1 = [];
    ...
    Neobook2.prototype.parseChapter = function (chapterPath) {
      return __awaiter(this, void 0, void 0, function () {
          ...
          switch (_d.label) {
            ...
            case 1:
              ...
              if (bookRaw instanceof Array && bookRaw[1]) {
                ...
                chapter = (_b = (_a = book.chapters) === null || _a === void 0 ? void 0 : _a.find) === null || _b === void 0 ? void 0 : _b.call(_a, function (chapter2) {
                  return chapter2.token == token_1;
                });
