...
var LNReaderPlugin = function () {
  ...
  // .js/plugins/english/BoxNovel[readnovelfull].js
  init_dirname();
  init_buffer2();
  init_process2();
  ...
  var ReadNovelFullPlugin = /** @class */
  function () {
    function ReadNovelFullPlugin2(metadata) {
      var _a;
    ...
    __name(ReadNovelFullPlugin2, "ReadNovelFullPlugin");
    ReadNovelFullPlugin2.prototype.sleep = function (ms) {
    ...
    ReadNovelFullPlugin2.prototype.parseNovels = function (html) {
      var _this = this;
      var novels = [];
      var tempNovel = {};
      var depth;
      var stateStack = [ParsingState.Idle];
      var currentState = /* @__PURE__ */__name(function () {
        return stateStack[stateStack.length - 1];
      }, "currentState");
      var pushState = /* @__PURE__ */__name(function (state) {
        return stateStack.push(state);
      }, "pushState");
      var popState = /* @__PURE__ */__name(function () {
      ...
      var parser = new htmlparser2_1.Parser({
        onopentag: /* @__PURE__ */__name(function (name, attribs) {
          ...
          if (((_a = attribs["class"]) === null || _a === void 0 ? void 0 : _a.includes("archive")) || attribs["class"] === "col-content") {
            pushState(ParsingState.NovelList);
            depth = 0;
          }
          if (state !== ParsingState.NovelList && state !== ParsingState.NovelName) return;
          switch (name) {
            case "img":
    ...
    ReadNovelFullPlugin2.prototype.popularNovels = function (pageNo_1, _a) {
        ...
        return __generator(this, function (_k) {
          switch (_k.label) {
            case 0:
              ...
              if (pageNo !== 1 && !showLatestNovels && !filters.genres.value.length && noPages.length > 0 && noPages.includes(filters.type.value)) {
                return [2, []];
              }
              url = "";
              if (novelListing) {
                ...
                basePage = showLatestNovels ? latestPage : filters.genres.value.length ? filters.genres.value : filters.type.value;
                if (pageAsPath) {
                  if (pageNo > 1) {
    ...
    ReadNovelFullPlugin2.prototype.parseNovel = function (novelPath) {
      return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
          switch (_b.label) {
            ...
            case 2:
              ...
              currentState = /* @__PURE__ */__name(function () {
                return stateStack[stateStack.length - 1];
              }, "currentState");
              pushState = /* @__PURE__ */__name(function (state) {
                return stateStack.push(state);
              }, "pushState");
                  ...
                  switch (name) {
                    ...
                    case "img":
                      if (state === ParsingState.Cover) {
                        var cover = (_b2 = (_a2 = attribs.src) !== null && _a2 !== void 0 ? _a2 : attribs["data-cfsrc"]) !== null && _b2 !== void 0 ? _b2 : attribs["data-src"];
                    ...
                    case "a":
                      if (state === ParsingState.ChapterList) {
                        ...
                        tempChapter.path = (href === null || href === void 0 ? void 0 : href.substring(1)) || novelPath.replace(".html", "/chapter-".concat(i, ".html"));
                      }
                      break;
                  }
                }, "onopentag"),
                ontext: /* @__PURE__ */__name(function (data) {
                  var text = data.trim();
                  if (!text) return;
                  switch (currentState()) {
                    ...
                    case "a":
                      if (state === ParsingState.Chapter) {
                        if (tempChapter.name && tempChapter.path) {
                          chapters.push(_assign({}, tempChapter));
                        }
                        tempChapter = {};
                        popState();
                      }
                ...
                onend: /* @__PURE__ */__name(function () {
                  if (infoParts.length) {
                    infoParts.join("").split("\n").map(function (line) {
                      ...
                      var detail = parts[1].split(",").map(function (g) {
                        return g.trim();
                      }).join(", ");
                      switch (detailName) {
                        case "author":
                        ...
                        case "status":
                          ...
                          novel.status = (_a2 = map[detail.toLowerCase()]) !== null && _a2 !== void 0 ? _a2 : novelStatus_1.NovelStatus.Unknown;
                          break;
                        default:
                          return;
                      }
                    ...
                    novel.status = statusParts.join("").toLowerCase().replace(/\b\w/g, function (_char7) {
                      return _char7.toUpperCase();
                    });
                  }
              ...
              parser.write(body);
              parser.end();
              if (!(this.options.noAjax && chapters.length > 0)) return [3, 3];
              novel.chapters = chapters;
              return [3, 7];
            case 3:
              if (!(novelId !== null)) return [3, 7];
              ...
              return [4, (0, fetch_1.fetchApi)(chaptersUrl)];
            case 4:
              ajaxResult = _b.sent();
              if (!!ajaxResult.ok) return [3, 5];
              console.error("Failed to fetch chapters: ".concat(ajaxResult.status));
              novel.chapters = [];
              return [3, 7];
            case 5:
              return [4, ajaxResult.text()];
            case 6:
              ajaxBody = _b.sent();
              ajaxChapters_1 = [];
              tempAjaxChapter_1 = {};
              ajaxParser = new htmlparser2_1.Parser({
                ...
                ontext: /* @__PURE__ */__name(function (data) {
                  var text = data.trim();
                  if (currentState() === ParsingState.Chapter && !tempAjaxChapter_1.name && text) {
                    tempAjaxChapter_1.name += text;
                  }
                }, "ontext"),
                onclosetag: /* @__PURE__ */__name(function (name) {
                  if ((name === "a" || name === "option") && currentState() === ParsingState.Chapter) {
                    if (tempAjaxChapter_1.name && tempAjaxChapter_1.path) {
                      ...
                      ajaxChapters_1.push(_assign({}, tempAjaxChapter_1));
                    }
                    tempAjaxChapter_1 = {};
                    popState();
                  }
    ...
    ReadNovelFullPlugin2.prototype.parseChapter = function (chapterPath) {
      return __awaiter(this, void 0, void 0, function () {
          ...
          switch (_a.label) {
            ...
            case 2:
              ...
              escapeHtml = /* @__PURE__ */__name(function (text) {
                return text.replace(escapeRegex, function (_char8) {
                  return escapeMap[_char8];
                });
              }, "escapeHtml");
              parser = new htmlparser2_1.Parser({
                onopentag: /* @__PURE__ */__name(function (name, attribs) {
                  var _a2;
                  var state = currentState();
                  var attrib = (_a2 = attribs["class"]) === null || _a2 === void 0 ? void 0 : _a2.trim();
                  switch (state) {
                    case ParsingState.Idle:
                      if (attrib === "txt" || attribs.id === "chr-content" || attribs.id === "chapter-content") {
                        pushState(ParsingState.Chapter);
                        depth = 0;
                      }
                      break;
                    case ParsingState.Chapter:
                      if (name === "sub") {
                        ...
                        depth++;
                        if ((attrib === null || attrib === void 0 ? void 0 : attrib.includes("unlock-buttons")) || (attrib === null || attrib === void 0 ? void 0 : attrib.includes("ads"))) {
                          pushState(ParsingState.Hidden);
                          depthHide = 0;
                        }
                      }
                  ...
                  if (currentState() === ParsingState.Chapter) {
                    ...
                    } else if (attrKeys.every(function (key) {
                      return attribs[key].trim() === "";
                    })) {
                      skipClosingTag = true;
                      currentTagToSkip = name;
                      var uppercaseName = name.replace(/\b\w/g, function (_char9) {
                        return _char9.toUpperCase();
                      });
                      chapterHtml.push(escapeHtml("<".concat(uppercaseName, " ").concat(attrKeys.join(" "), ">")));
                    } else {
                      var attrString = attrKeys.map(function (key) {
                        return " ".concat(key, '="').concat(attribs[key].replace(/"/g, "&quot;"), '"');
                      }).join("");
              ...
              parser.write(html);
              parser.end();
              return [2, chapterHtml.join("")];
          }
        });
      });
    };
    ReadNovelFullPlugin2.prototype.searchNovels = function (searchTerm, page) {
      return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_h) {
          switch (_h.label) {
            case 0:
              now = Date.now();
              if (!(this.lastSearch && now - this.lastSearch <= this.searchInterval)) return [3, 2];
              return [4, this.sleep(this.searchInterval)];
            case 1:
              _h.sent();
              _h.label = 2;
            case 2:
              ...
              params = new URLSearchParams(_assign(_assign((_d = {}, _d[searchKey] = searchTerm, _d), langParam && urlLangCode && (_e = {}, _e[langParam] = urlLangCode, _e)), !postSearch && (_f = {}, _f[pageParam] = page.toString(), _f)));
              ...
              return [4, (0, fetch_1.fetchApi)(url, fetchOptions)];
            case 3:
              result = _h.sent();
    ...
    return ReadNovelFullPlugin2;
  }();
  var ParsingState;
  (function (ParsingState2) {
    ParsingState2[ParsingState2["Idle"] = 0] = "Idle";
    ParsingState2[ParsingState2["Info"] = 1] = "Info";
    ParsingState2[ParsingState2["Cover"] = 2] = "Cover";
    ParsingState2[ParsingState2["Author"] = 3] = "Author";
    ParsingState2[ParsingState2["Genres"] = 4] = "Genres";
    ParsingState2[ParsingState2["Status"] = 5] = "Status";
    ParsingState2[ParsingState2["Hidden"] = 6] = "Hidden";
    ParsingState2[ParsingState2["Summary"] = 7] = "Summary";
    ParsingState2[ParsingState2["Stopped"] = 8] = "Stopped";
    ParsingState2[ParsingState2["Chapter"] = 9] = "Chapter";
    ParsingState2[ParsingState2["ChapterList"] = 10] = "ChapterList";
    ParsingState2[ParsingState2["NovelName"] = 11] = "NovelName";
    ParsingState2[ParsingState2["NovelList"] = 12] = "NovelList";
  })(ParsingState || (ParsingState = {}));
  var plugin = new ReadNovelFullPlugin({
    "id": "boxnovel",
    "sourceSite": "https://novlove.com/",
    "sourceName": "BoxNovel",
    "options": {
    ...
    "filters": {
      "type": {
        "type": "Picker",
        "label": "Novel Listing",
        "value": "sort/nov-love-popular",
        "options": [{
          "label": "Hot Novel",
          "value": "sort/nov-love-hot"
        }, {
          "label": "Completed Novel",
          "value": "sort/nov-love-complete"
        }, {
          "label": "Most Popular",
          "value": "sort/nov-love-popular"
        }]
      ...
      "genres": {
        ...
        "options": [{
          "label": "Action",
          "value": "nov-love-genres/action"
        }, {
          "label": "Adventure",
          "value": "nov-love-genres/adventure"
        }, {
          "label": "Anime & comics",
          "value": "nov-love-genres/anime-&-comics"
        }, {
          "label": "Comedy",
          "value": "nov-love-genres/comedy"
        }, {
          "label": "Drama",
          "value": "nov-love-genres/drama"
        }, {
          "label": "Eastern",
          "value": "nov-love-genres/eastern"
        }, {
          "label": "Fan-fiction",
          "value": "nov-love-genres/fan-fiction"
        }, {
          "label": "Fanfiction",
          "value": "nov-love-genres/fanfiction"
        }, {
          "label": "Fantasy",
          "value": "nov-love-genres/fantasy"
        }, {
          "label": "Game",
          "value": "nov-love-genres/game"
        }, {
          "label": "Games",
          "value": "nov-love-genres/games"
        }, {
          "label": "Gender bender",
          "value": "nov-love-genres/gender-bender"
        }, {
          "label": "General",
          "value": "nov-love-genres/general"
        }, {
          "label": "Harem",
          "value": "nov-love-genres/harem"
        }, {
          "label": "Historical",
          "value": "nov-love-genres/historical"
        }, {
          "label": "Horror",
          "value": "nov-love-genres/horror"
        }, {
          "label": "Isekai",
          "value": "nov-love-genres/isekai"
        }, {
          "label": "Josei",
          "value": "nov-love-genres/josei"
        }, {
          "label": "Litrpg",
          "value": "nov-love-genres/litrpg"
        }, {
          "label": "Magic",
          "value": "nov-love-genres/magic"
        }, {
          "label": "Magical realism",
          "value": "nov-love-genres/magical-realism"
        }, {
          "label": "Martial arts",
          "value": "nov-love-genres/martial-arts"
        }, {
          "label": "Mature",
          "value": "nov-love-genres/mature"
        }, {
          "label": "Mecha",
          "value": "nov-love-genres/mecha"
        }, {
          "label": "Modern life",
          "value": "nov-love-genres/modern-life"
        }, {
          "label": "Myster",
          "value": "nov-love-genres/myster"
        }, {
          "label": "Mystery",
          "value": "nov-love-genres/mystery"
        }, {
          "label": "Other",
          "value": "nov-love-genres/other"
        }, {
          "label": "Psychological",
          "value": "nov-love-genres/psychological"
        }, {
          "label": "Reincarnation",
          "value": "nov-love-genres/reincarnation"
        }, {
          "label": "Report story",
          "value": "nov-love-genres/report-story"
        }, {
          "label": "Romance",
          "value": "nov-love-genres/romance"
        }, {
          "label": "Romance.smut",
          "value": "nov-love-genres/romance.smut"
        }, {
          "label": "School life",
          "value": "nov-love-genres/school-life"
        }, {
          "label": "Sci-fi",
          "value": "nov-love-genres/sci-fi"
        }, {
          "label": "Seinen",
          "value": "nov-love-genres/seinen"
        }, {
          "label": "Shoujo",
          "value": "nov-love-genres/shoujo"
        }, {
          "label": "Shoujo ai",
          "value": "nov-love-genres/shoujo-ai"
        }, {
          "label": "Shounen",
          "value": "nov-love-genres/shounen"
        }, {
          "label": "Shounen ai",
          "value": "nov-love-genres/shounen-ai"
        }, {
          "label": "Slice of life",
          "value": "nov-love-genres/slice-of-life"
        }, {
          "label": "Smut",
          "value": "nov-love-genres/smut"
        }, {
          "label": "Sports",
          "value": "nov-love-genres/sports"
        }, {
          "label": "Supernatural",
          "value": "nov-love-genres/supernatural"
        }, {
          "label": "System",
          "value": "nov-love-genres/system"
        }, {
          "label": "Thriller",
          "value": "nov-love-genres/thriller"
        }, {
          "label": "Tragedy",
          "value": "nov-love-genres/tragedy"
        }, {
          "label": "Urban",
          "value": "nov-love-genres/urban"
        }, {
          "label": "Urban life",
          "value": "nov-love-genres/urban-life"
        }, {
          "label": "Video games",
          "value": "nov-love-genres/video-games"
        }, {
          "label": "War",
          "value": "nov-love-genres/war"
        }, {
          "label": "Wuxia",
          "value": "nov-love-genres/wuxia"
        }, {
          "label": "Xianxia",
          "value": "nov-love-genres/xianxia"
        }, {
          "label": "Xuanhuan",
          "value": "nov-love-genres/xuanhuan"
        }, {
          "label": "Yaoi",
          "value": "nov-love-genres/yaoi"
        }, {
          "label": "Yuri",
          "value": "nov-love-genres/yuri"
        }]
      }
    }
  });
