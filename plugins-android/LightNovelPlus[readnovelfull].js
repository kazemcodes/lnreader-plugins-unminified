...
var LNReaderPlugin = function () {
  ...
  // .js/plugins/english/LightNovelPlus[readnovelfull].js
  init_dirname();
  init_buffer2();
  init_process2();
  ...
  var plugin = new ReadNovelFullPlugin({
    "id": "lightnovelplus",
    "sourceSite": "https://lightnovelplus.com/",
    "sourceName": "LightNovelPlus",
    "options": {
      "novelListing": "book/bookclass.html",
      "searchPage": "book/search.html",
      "chapterListing": "get_chapter_list",
      "chapterParam": "bookId",
      "latestPage": "last_release",
      "pageParam": "page_num",
      "langParam": "language",
      "urlLangCode": "en"
    },
    "filters": {
      "type": {
        ...
        "options": [{
          ...
          "label": "Novel Completed",
          "value": "completed_novel"
        }]
      },
      "genres": {
        "type": "Picker",
