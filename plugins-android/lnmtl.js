...
var LNReaderPlugin = function () {
  ...
  var LnMTLPlugin = /** @class */
  function () {
    function LnMTLPlugin2() {
      this.id = "lnmtl";
      this.name = "LnMTL";
    ...
    __name(LnMTLPlugin2, "LnMTLPlugin");
    LnMTLPlugin2.prototype.sleep = function (ms) {
    ...
    LnMTLPlugin2.prototype.popularNovels = function (page_1, _a) {
        ...
        return __generator(this, function (_c) {
          switch (_c.label) {
            case 0:
              ...
              return [4, (0, fetch_1.fetchApi)(link)];
            case 1:
              response = _c.sent();
            ...
            case 2:
              ...
              parser = new htmlparser2_1.Parser({
                onopentag: /* @__PURE__ */__name(function (name, attribs) {
                  var _a2;
                  if ((_a2 = attribs["class"]) === null || _a2 === void 0 ? void 0 : _a2.includes("media-left")) {
    ...
    LnMTLPlugin2.prototype.parseNovel = function (novelPath) {
      return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            ...
            case 1:
              body = _a.sent();
              return [4, body.text().then(function (r) {
            ...
            case 2:
              ...
              parser = new htmlparser2_1.Parser({
                onopentag: /* @__PURE__ */__name(function (name, attribs) {
                  ...
                  switch (name) {
                    case "img":
                      if ((_a2 = attribs["class"]) === null || _a2 === void 0 ? void 0 : _a2.includes("img-rounded")) {
    ...
    LnMTLPlugin2.prototype.parsePage = function (novelPath, page) {
      return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            ...
            case 1:
              result = _a.sent();
              return [4, result.text().then(function (r) {
                return r.replace(/>\s+</g, "><");
              })];
            case 2:
              html = _a.sent();
              ...
              parser.end();
              chapter = [];
              return [4, this.sleep(1e3)];
            case 3:
              _a.sent();
              return [4, (0, fetch_1.fetchApi)("".concat(this.site, "chapter?volumeId=").concat(volume.id))];
            case 4:
              volumeData = _a.sent();
              return [4, volumeData.json()];
            case 5:
              volumePage = _a.sent();
              firstPage = volumePage.data.map(function (chapter2) {
                return {
                  name: "#".concat(chapter2.number, " - ").concat(chapter2.title),
                  path: "chapter/".concat(chapter2.slug),
                  releaseTime: new Date(chapter2.created_at).toISOString()
                  //converts time obtained to UTC +0, TODO: Make it not convert
                };
              });
              ...
              _a.label = 6;
            case 6:
              if (!(i <= volumePage.last_page)) return [3, 11];
              return [4, this.sleep(1e3)];
            case 7:
              _a.sent();
              return [4, (0, fetch_1.fetchApi)("".concat(this.site, "chapter?page=").concat(i, "&volumeId=").concat(volume.id))];
            case 8:
              chapterData = _a.sent();
              return [4, chapterData.json()];
            case 9:
              chapterInfo = _a.sent();
              chapterDetails = chapterInfo.data.map(function (chapter2) {
                return {
                  name: "#".concat(chapter2.number, " ").concat(chapter2.title),
                  path: "chapter/".concat(chapter2.slug),
                  releaseTime: new Date(chapter2.created_at).toISOString()
    ...
    LnMTLPlugin2.prototype.parseChapter = function (chapterPath) {
      return __awaiter(this, void 0, void 0, function () {
          ...
          switch (_a.label) {
            ...
            case 2:
              ...
              parser = new htmlparser2_1.Parser({
                onopentag: /* @__PURE__ */__name(function (name, attribs) {
                  var _a2;
                  if (name === "sentence" && ((_a2 = attribs["class"]) === null || _a2 === void 0 ? void 0 : _a2.includes("translated"))) {
                    state = ParsingState.Chapter;
                    chapterTextParts.push("<p>");
                  }
                }, "onopentag"),
                onopentagname: /* @__PURE__ */__name(function (name) {
                  if (name === "nav") {
                    state = ParsingState.Idle;
                  }
                }, "onopentagname"),
              ...
              return [2, chapterText.replace(/„/g, "\u201C")];
          }
        });
      });
    };
    LnMTLPlugin2.prototype.searchNovels = function (searchTerm) {
      return __awaiter(this, void 0, void 0, function () {
        var html, state, listPart, parser, search, data, nov, novels;
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              return [4, (0, fetch_1.fetchApi)(this.site).then(function (b) {
                return b.text();
              }).then(function (r) {
                return r.replace(/>\s+</g, "><");
              })];
            case 1:
              html = _a.sent();
              state = ParsingState.Idle;
              listPart = /* @__PURE__ */new Set();
              parser = new htmlparser2_1.Parser({
                onopentag: /* @__PURE__ */__name(function (name, attribs) {
                  var _a2;
                  if (state === ParsingState.InFooter && name === "script" && ((_a2 = attribs["type"]) === null || _a2 === void 0 ? void 0 : _a2.includes("application/javascript"))) {
                    state = ParsingState.InScript;
                  }
                }, "onopentag"),
                ontext: /* @__PURE__ */__name(function (data2) {
                  if (state === ParsingState.InScript) {
                    var match = data2.match(/prefetch: '\/(.*?\.json)/);
                    if (match) {
              ...
              parser.write(html);
              parser.end();
              return [4, (0, fetch_1.fetchApi)("".concat(this.site).concat(Array.from(listPart).join("")))];
            case 2:
              search = _a.sent();
              return [4, search.json()];
            case 3:
              data = _a.sent();
  ...
  (function (ParsingState2) {
    ...
    ParsingState2[ParsingState2["InFooter"] = 1] = "InFooter";
    ParsingState2[ParsingState2["InScript"] = 2] = "InScript";
    ParsingState2[ParsingState2["InDescription"] = 3] = "InDescription";
    ParsingState2[ParsingState2["InSource"] = 4] = "InSource";
    ParsingState2[ParsingState2["InPanelKey"] = 5] = "InPanelKey";
    ParsingState2[ParsingState2["InPanelValue"] = 6] = "InPanelValue";
    ParsingState2[ParsingState2["InGenres"] = 7] = "InGenres";
    ParsingState2[ParsingState2["Novel"] = 8] = "Novel";
