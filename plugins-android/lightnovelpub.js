...
var LNReaderPlugin = function () {
  ...
  // .js/plugins/english/lightnovelpub.js
  init_dirname();
  init_buffer2();
  init_process2();
  ...
  var LightNovelPub = /** @class */
  function () {
    function LightNovelPub2() {
    ...
    __name(LightNovelPub2, "LightNovelPub");
    LightNovelPub2.prototype.parseNovels = function (html) {
      var novels = [];
      var tempNovel = {};
    ...
    LightNovelPub2.prototype.popularNovels = function (page_1, _a) {
      return __awaiter(this, arguments, void 0, function (page, _b) {
        ...
        return __generator(this, function (_c) {
          switch (_c.label) {
            case 0:
              linkParts = [this.site + "browse", filters.genres.value, filters.order.value, filters.status.value, page.toString()];
              return [4, (0, fetch_1.fetchApi)(linkParts.join("/")).then(function (r) {
                return r.text();
              })];
            case 1:
              body = _c.sent();
    ...
    LightNovelPub2.prototype.parseNovel = function (novelPath) {
      return __awaiter(this, void 0, void 0, function () {
        var body, novel, state, summaryParts, genreArray, parser;
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              return [4, (0, fetch_1.fetchApi)(this.site + novelPath).then(function (r) {
                return r.text();
              })];
            case 1:
              body = _a.sent();
              ...
              parser = new htmlparser2_1.Parser({
                onopentag: /* @__PURE__ */__name(function (name, attribs) {
                  ...
                  switch (name) {
                    case "h1":
                      if ((_a2 = attribs["class"]) === null || _a2 === void 0 ? void 0 : _a2.includes("novel-title")) {
                ...
                onclosetag: /* @__PURE__ */__name(function (name) {
                  switch (name) {
                    ...
                    case "span":
                      ...
                      break;
                    case "div":
                      if (state === ParsingState.Summary || state === ParsingState.Genres) {
                        state = ParsingState.Idle;
                      }
                      break;
                    case "a":
                ...
                onend: /* @__PURE__ */__name(function () {
                  var text = summaryParts.join("").replace(/<PARAGRAPH_BREAK>/g, "\n\n").replace(/<LINE_BREAK>/g, "\n").replace(/\r\n/g, "\n").replace(/&nbsp;/g, " ");
    ...
    LightNovelPub2.prototype.parsePage = function (novelPath, page) {
      return __awaiter(this, void 0, void 0, function () {
              ...
              parser = new htmlparser2_1.Parser({
                    ...
                    case ParsingState.ChapterItem:
                      switch (name) {
                        case "a":
                          ...
                          tempChapter.path = (_a2 = attribs["href"]) === null || _a2 === void 0 ? void 0 : _a2.slice(1);
                          break;
                        case "time":
                ...
                onclosetag: /* @__PURE__ */__name(function (name) {
                  switch (state) {
                    case ParsingState.ChapterItem:
                      if (name === "li") {
                        if (tempChapter.chapterNumber !== void 0 && tempChapter.path && tempChapter.releaseTime) {
    ...
    LightNovelPub2.prototype.parseChapter = function (chapterPath) {
      return __awaiter(this, void 0, void 0, function () {
        var html, depth, state, chapterHtml, escapeRegex, escapeMap, escapeHtml, parser;
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              return [4, (0, fetch_1.fetchApi)(this.site + chapterPath).then(function (r) {
                return r.text();
              })];
            case 1:
              html = _a.sent();
              ...
              escapeHtml = /* @__PURE__ */__name(function (text) {
                return text.replace(escapeRegex, function (_char7) {
    ...
    LightNovelPub2.prototype.searchNovels = function (searchTerm) {
      return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              ...
              return [4, (0, fetch_1.fetchApi)(link).then(function (r) {
                return r.text();
              })];
            case 1:
              response = _a.sent();
              ...
              parser = new htmlparser2_1.Parser({
                onopentag: /* @__PURE__ */__name(function (name, attribs) {
                  var _a2;
                  if (name === "input" && ((_a2 = attribs["name"]) === null || _a2 === void 0 ? void 0 : _a2.includes("LNRequestVerifyToken"))) {
            ...
            case 2:
              body = _a.sent();
              return [2, this.parseNovels(body.resultview)];
          }
        });
      });
    };
    return LightNovelPub2;
  }();
  exports["default"] = new LightNovelPub();
  var ParsingState;
  (function (ParsingState2) {
    ParsingState2[ParsingState2["Idle"] = 0] = "Idle";
    ParsingState2[ParsingState2["Novel"] = 1] = "Novel";
    ParsingState2[ParsingState2["HeaderStats"] = 2] = "HeaderStats";
    ParsingState2[ParsingState2["Status"] = 3] = "Status";
    ParsingState2[ParsingState2["Stopped"] = 4] = "Stopped";
    ParsingState2[ParsingState2["Chapter"] = 5] = "Chapter";
    ParsingState2[ParsingState2["ChapterItem"] = 6] = "ChapterItem";
    ParsingState2[ParsingState2["ChapterList"] = 7] = "ChapterList";
    ParsingState2[ParsingState2["TotalChapters"] = 8] = "TotalChapters";
    ParsingState2[ParsingState2["NovelName"] = 9] = "NovelName";
    ParsingState2[ParsingState2["AuthorName"] = 10] = "AuthorName";
    ParsingState2[ParsingState2["Summary"] = 11] = "Summary";
    ParsingState2[ParsingState2["Genres"] = 12] = "Genres";
    ParsingState2[ParsingState2["Tags"] = 13] = "Tags";
    ParsingState2[ParsingState2["Cover"] = 14] = "Cover";
